...
declare const getDefaultConfig: () => {
    ...
    readonly classGroups: {
        ...
        readonly 'container-type': readonly [{
            readonly '@container': readonly ["", "normal", "size", (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Container Name
        ...
        readonly 'tab-size': readonly [{
            readonly tab: readonly [(value: string) => boolean, (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Vertical Alignment
        ...
        readonly zoom: readonly [{
            readonly zoom: readonly [(value: string) => boolean, (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Accent Color
        ...
        readonly 'scrollbar-thumb-color': readonly [{
            readonly 'scrollbar-thumb': readonly [ThemeGetter, (value: string) => boolean, (value: string) => boolean];
        }];
        /**
        ...
        readonly 'scrollbar-track-color': readonly [{
            readonly 'scrollbar-track': readonly [ThemeGetter, (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Scrollbar Gutter
