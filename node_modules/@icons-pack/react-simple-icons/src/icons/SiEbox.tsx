    ...
    type SiEboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEbox: IconType = React.forwardRef<SVGSVGElement, SiEboxProps>(function SiEbox({title = 'EBOX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
