    ...
    type SiNativescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#65ADF1';

    const SiNativescript: IconType = React.forwardRef<SVGSVGElement, SiNativescriptProps>(function SiNativescript({title = 'NativeScript', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNativescript as default, defaultColor };
