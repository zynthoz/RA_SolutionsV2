    ...
    type SiCucumberProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCucumber: IconType = React.forwardRef<SVGSVGElement, SiCucumberProps>(function SiCucumber({title = 'Cucumber', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCucumber as default, defaultColor };
