    ...
    type SiCaldotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaldotcom: IconType = React.forwardRef<SVGSVGElement, SiCaldotcomProps>(function SiCaldotcom({title = 'Cal.com', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
