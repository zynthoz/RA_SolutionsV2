    ...
    type SiAllegroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAllegro: IconType = React.forwardRef<SVGSVGElement, SiAllegroProps>(function SiAllegro({title = 'Allegro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
