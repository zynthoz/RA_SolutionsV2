    ...
    type SiCarrdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCarrd: IconType = React.forwardRef<SVGSVGElement, SiCarrdProps>(function SiCarrd({title = 'Carrd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCarrd as default, defaultColor };
