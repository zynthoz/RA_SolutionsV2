    ...
    type SiHomepageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009BD5';

    const SiHomepage: IconType = React.forwardRef<SVGSVGElement, SiHomepageProps>(function SiHomepage({title = 'Homepage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHomepage as default, defaultColor };
