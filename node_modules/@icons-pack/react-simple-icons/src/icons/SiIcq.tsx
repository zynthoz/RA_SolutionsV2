    ...
    type SiIcqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIcq: IconType = React.forwardRef<SVGSVGElement, SiIcqProps>(function SiIcq({title = 'ICQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
