    ...
    type SiDbeaverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDbeaver: IconType = React.forwardRef<SVGSVGElement, SiDbeaverProps>(function SiDbeaver({title = 'DBeaver', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
