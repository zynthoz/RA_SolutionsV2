    ...
    type SiTalendProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTalend: IconType = React.forwardRef<SVGSVGElement, SiTalendProps>(function SiTalend({title = 'Talend', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
