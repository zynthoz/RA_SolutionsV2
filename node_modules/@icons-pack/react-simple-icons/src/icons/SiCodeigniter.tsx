    ...
    type SiCodeigniterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EF4223';

    const SiCodeigniter: IconType = React.forwardRef<SVGSVGElement, SiCodeigniterProps>(function SiCodeigniter({title = 'CodeIgniter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodeigniter as default, defaultColor };
