    ...
    type SiDlnaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDlna: IconType = React.forwardRef<SVGSVGElement, SiDlnaProps>(function SiDlna({title = 'DLNA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
