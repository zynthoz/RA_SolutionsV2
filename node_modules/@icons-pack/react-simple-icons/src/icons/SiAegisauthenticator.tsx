    ...
    type SiAegisauthenticatorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAegisauthenticator: IconType = React.forwardRef<SVGSVGElement, SiAegisauthenticatorProps>(function SiAegisauthenticator({title = 'Aegis Authenticator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
