    ...
    type SiLichessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLichess: IconType = React.forwardRef<SVGSVGElement, SiLichessProps>(function SiLichess({title = 'Lichess', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
