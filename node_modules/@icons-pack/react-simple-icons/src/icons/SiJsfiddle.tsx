    ...
    type SiJsfiddleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJsfiddle: IconType = React.forwardRef<SVGSVGElement, SiJsfiddleProps>(function SiJsfiddle({title = 'JSFiddle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJsfiddle as default, defaultColor };
