    ...
    type SiMagasinsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E71B34';

    const SiMagasinsu: IconType = React.forwardRef<SVGSVGElement, SiMagasinsuProps>(function SiMagasinsu({title = 'Magasins U', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMagasinsu as default, defaultColor };
