    ...
    type SiOctaveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOctave: IconType = React.forwardRef<SVGSVGElement, SiOctaveProps>(function SiOctave({title = 'Octave', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
