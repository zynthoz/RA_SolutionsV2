    ...
    type SiCodeceptjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodeceptjs: IconType = React.forwardRef<SVGSVGElement, SiCodeceptjsProps>(function SiCodeceptjs({title = 'CodeceptJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodeceptjs as default, defaultColor };
