    ...
    type SiEjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B4CA65';

    const SiEjs: IconType = React.forwardRef<SVGSVGElement, SiEjsProps>(function SiEjs({title = 'EJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEjs as default, defaultColor };
