    ...
    type SiPreactProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#673AB8';

    const SiPreact: IconType = React.forwardRef<SVGSVGElement, SiPreactProps>(function SiPreact({title = 'Preact', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPreact as default, defaultColor };
