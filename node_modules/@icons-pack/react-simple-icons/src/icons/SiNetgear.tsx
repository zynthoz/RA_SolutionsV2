    ...
    type SiNetgearProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2C262D';

    const SiNetgear: IconType = React.forwardRef<SVGSVGElement, SiNetgearProps>(function SiNetgear({title = 'NETGEAR', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNetgear as default, defaultColor };
