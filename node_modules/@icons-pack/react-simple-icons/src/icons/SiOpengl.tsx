    ...
    type SiOpenglProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpengl: IconType = React.forwardRef<SVGSVGElement, SiOpenglProps>(function SiOpengl({title = 'OpenGL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
