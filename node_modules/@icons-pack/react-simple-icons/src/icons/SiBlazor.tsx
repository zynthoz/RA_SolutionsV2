    ...
    type SiBlazorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlazor: IconType = React.forwardRef<SVGSVGElement, SiBlazorProps>(function SiBlazor({title = 'Blazor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
