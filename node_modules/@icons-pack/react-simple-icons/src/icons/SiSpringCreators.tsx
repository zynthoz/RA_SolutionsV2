    ...
    type SiSpringCreatorsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSpringCreators: IconType = React.forwardRef<SVGSVGElement, SiSpringCreatorsProps>(function SiSpringCreators({title = 'Spring', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpringCreators as default, defaultColor };
