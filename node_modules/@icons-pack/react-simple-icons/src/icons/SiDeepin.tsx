    ...
    type SiDeepinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeepin: IconType = React.forwardRef<SVGSVGElement, SiDeepinProps>(function SiDeepin({title = 'deepin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDeepin as default, defaultColor };
