    ...
    type SiTestinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#007DD7';

    const SiTestin: IconType = React.forwardRef<SVGSVGElement, SiTestinProps>(function SiTestin({title = 'Testin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTestin as default, defaultColor };
