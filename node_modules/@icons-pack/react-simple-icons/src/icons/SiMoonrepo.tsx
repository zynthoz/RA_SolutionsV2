    ...
    type SiMoonrepoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMoonrepo: IconType = React.forwardRef<SVGSVGElement, SiMoonrepoProps>(function SiMoonrepo({title = 'Moonrepo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMoonrepo as default, defaultColor };
