    ...
    type SiMailtrapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMailtrap: IconType = React.forwardRef<SVGSVGElement, SiMailtrapProps>(function SiMailtrap({title = 'Mailtrap', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMailtrap as default, defaultColor };
