    ...
    type SiWagtailProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWagtail: IconType = React.forwardRef<SVGSVGElement, SiWagtailProps>(function SiWagtail({title = 'Wagtail', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWagtail as default, defaultColor };
