    ...
    type SiAkiflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAkiflow: IconType = React.forwardRef<SVGSVGElement, SiAkiflowProps>(function SiAkiflow({title = 'Akiflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
