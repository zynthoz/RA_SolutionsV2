    ...
    type SiInstacartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInstacart: IconType = React.forwardRef<SVGSVGElement, SiInstacartProps>(function SiInstacart({title = 'Instacart', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
