    ...
    type SiPypiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3775A9';

    const SiPypi: IconType = React.forwardRef<SVGSVGElement, SiPypiProps>(function SiPypi({title = 'PyPI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPypi as default, defaultColor };
