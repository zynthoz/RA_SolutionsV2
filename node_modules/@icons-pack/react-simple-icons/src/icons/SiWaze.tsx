    ...
    type SiWazeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWaze: IconType = React.forwardRef<SVGSVGElement, SiWazeProps>(function SiWaze({title = 'Waze', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
