    ...
    type SiAparatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED145B';

    const SiAparat: IconType = React.forwardRef<SVGSVGElement, SiAparatProps>(function SiAparat({title = 'Aparat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAparat as default, defaultColor };
