    ...
    type SiMacpawProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMacpaw: IconType = React.forwardRef<SVGSVGElement, SiMacpawProps>(function SiMacpaw({title = 'MacPaw', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
