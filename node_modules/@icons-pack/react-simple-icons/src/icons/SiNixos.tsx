    ...
    type SiNixosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNixos: IconType = React.forwardRef<SVGSVGElement, SiNixosProps>(function SiNixos({title = 'NixOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
