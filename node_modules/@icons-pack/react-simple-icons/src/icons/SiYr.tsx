    ...
    type SiYrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYr: IconType = React.forwardRef<SVGSVGElement, SiYrProps>(function SiYr({title = 'Yr', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYr as default, defaultColor };
