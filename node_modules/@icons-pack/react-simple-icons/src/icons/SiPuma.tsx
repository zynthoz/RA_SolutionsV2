    ...
    type SiPumaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPuma: IconType = React.forwardRef<SVGSVGElement, SiPumaProps>(function SiPuma({title = 'Puma', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
