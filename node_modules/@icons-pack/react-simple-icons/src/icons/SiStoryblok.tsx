    ...
    type SiStoryblokProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#09B3AF';

    const SiStoryblok: IconType = React.forwardRef<SVGSVGElement, SiStoryblokProps>(function SiStoryblok({title = 'Storyblok', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStoryblok as default, defaultColor };
