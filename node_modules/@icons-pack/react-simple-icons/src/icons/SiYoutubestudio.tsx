    ...
    type SiYoutubestudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYoutubestudio: IconType = React.forwardRef<SVGSVGElement, SiYoutubestudioProps>(function SiYoutubestudio({title = 'YouTube Studio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
