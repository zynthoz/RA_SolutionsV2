    ...
    type SiDwavesystemsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDwavesystems: IconType = React.forwardRef<SVGSVGElement, SiDwavesystemsProps>(function SiDwavesystems({title = 'D-Wave Systems', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDwavesystems as default, defaultColor };
