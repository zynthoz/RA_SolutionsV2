    ...
    type SiS7airlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiS7airlines: IconType = React.forwardRef<SVGSVGElement, SiS7airlinesProps>(function SiS7airlines({title = 'S7 Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiS7airlines as default, defaultColor };
