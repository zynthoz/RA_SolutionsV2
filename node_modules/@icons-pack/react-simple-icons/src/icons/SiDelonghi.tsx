    ...
    type SiDelonghiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#072240';

    const SiDelonghi: IconType = React.forwardRef<SVGSVGElement, SiDelonghiProps>(function SiDelonghi({title = 'DeLonghi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDelonghi as default, defaultColor };
