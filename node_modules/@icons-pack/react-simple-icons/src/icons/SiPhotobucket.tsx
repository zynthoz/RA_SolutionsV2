    ...
    type SiPhotobucketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhotobucket: IconType = React.forwardRef<SVGSVGElement, SiPhotobucketProps>(function SiPhotobucket({title = 'Photobucket', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
