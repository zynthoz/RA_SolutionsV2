    ...
    type SiArgosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArgos: IconType = React.forwardRef<SVGSVGElement, SiArgosProps>(function SiArgos({title = 'Argos', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArgos as default, defaultColor };
