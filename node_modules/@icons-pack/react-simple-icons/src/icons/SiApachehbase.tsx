    ...
    type SiApachehbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BE160C';

    const SiApachehbase: IconType = React.forwardRef<SVGSVGElement, SiApachehbaseProps>(function SiApachehbase({title = 'Apache HBase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
