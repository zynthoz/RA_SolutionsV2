    ...
    type SiAirserbiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirserbia: IconType = React.forwardRef<SVGSVGElement, SiAirserbiaProps>(function SiAirserbia({title = 'Air Serbia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
