    ...
    type SiTursoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTurso: IconType = React.forwardRef<SVGSVGElement, SiTursoProps>(function SiTurso({title = 'Turso', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
