    ...
    type SiCommonlispProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCommonlisp: IconType = React.forwardRef<SVGSVGElement, SiCommonlispProps>(function SiCommonlisp({title = 'Common Lisp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
