    ...
    type SiEclipsevertdotxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEclipsevertdotx: IconType = React.forwardRef<SVGSVGElement, SiEclipsevertdotxProps>(function SiEclipsevertdotx({title = 'Eclipse Vert.x', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
