    ...
    type SiBricksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBricks: IconType = React.forwardRef<SVGSVGElement, SiBricksProps>(function SiBricks({title = 'Bricks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBricks as default, defaultColor };
