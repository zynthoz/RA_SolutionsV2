    ...
    type SiAureliaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAurelia: IconType = React.forwardRef<SVGSVGElement, SiAureliaProps>(function SiAurelia({title = 'Aurelia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
