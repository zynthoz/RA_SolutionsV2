    ...
    type SiSessionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSession: IconType = React.forwardRef<SVGSVGElement, SiSessionProps>(function SiSession({title = 'Session', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
