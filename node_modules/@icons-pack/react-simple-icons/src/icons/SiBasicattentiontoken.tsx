    ...
    type SiBasicattentiontokenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBasicattentiontoken: IconType = React.forwardRef<SVGSVGElement, SiBasicattentiontokenProps>(function SiBasicattentiontoken({title = 'Basic Attention Token', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
