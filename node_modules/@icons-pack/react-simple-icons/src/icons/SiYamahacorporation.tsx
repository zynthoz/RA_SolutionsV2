    ...
    type SiYamahacorporationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYamahacorporation: IconType = React.forwardRef<SVGSVGElement, SiYamahacorporationProps>(function SiYamahacorporation({title = 'Yamaha Corporation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
