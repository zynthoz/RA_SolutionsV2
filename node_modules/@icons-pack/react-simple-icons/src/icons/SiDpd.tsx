    ...
    type SiDpdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDpd: IconType = React.forwardRef<SVGSVGElement, SiDpdProps>(function SiDpd({title = 'DPD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDpd as default, defaultColor };
