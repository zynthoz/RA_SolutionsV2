    ...
    type SiSlidesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E4637C';

    const SiSlides: IconType = React.forwardRef<SVGSVGElement, SiSlidesProps>(function SiSlides({title = 'Slides', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSlides as default, defaultColor };
