    ...
    type SiFlydotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#24175B';

    const SiFlydotio: IconType = React.forwardRef<SVGSVGElement, SiFlydotioProps>(function SiFlydotio({title = 'Fly.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFlydotio as default, defaultColor };
