    ...
    type SiLinkerdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2BEDA7';

    const SiLinkerd: IconType = React.forwardRef<SVGSVGElement, SiLinkerdProps>(function SiLinkerd({title = 'Linkerd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
