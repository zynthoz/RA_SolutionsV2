    ...
    type SiInstructablesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FABF15';

    const SiInstructables: IconType = React.forwardRef<SVGSVGElement, SiInstructablesProps>(function SiInstructables({title = 'Instructables', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
