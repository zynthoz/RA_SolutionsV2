    ...
    type SiCirrusciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCirrusci: IconType = React.forwardRef<SVGSVGElement, SiCirrusciProps>(function SiCirrusci({title = 'Cirrus CI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCirrusci as default, defaultColor };
