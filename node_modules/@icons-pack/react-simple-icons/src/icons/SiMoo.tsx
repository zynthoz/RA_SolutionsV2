    ...
    type SiMooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMoo: IconType = React.forwardRef<SVGSVGElement, SiMooProps>(function SiMoo({title = 'Moo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
