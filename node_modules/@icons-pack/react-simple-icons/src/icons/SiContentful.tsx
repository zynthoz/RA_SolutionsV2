    ...
    type SiContentfulProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiContentful: IconType = React.forwardRef<SVGSVGElement, SiContentfulProps>(function SiContentful({title = 'Contentful', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiContentful as default, defaultColor };
