    ...
    type SiNrwlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNrwl: IconType = React.forwardRef<SVGSVGElement, SiNrwlProps>(function SiNrwl({title = 'Nrwl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNrwl as default, defaultColor };
