    ...
    type SiSegaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSega: IconType = React.forwardRef<SVGSVGElement, SiSegaProps>(function SiSega({title = 'Sega', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
