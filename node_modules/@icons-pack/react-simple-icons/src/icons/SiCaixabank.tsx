    ...
    type SiCaixabankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaixabank: IconType = React.forwardRef<SVGSVGElement, SiCaixabankProps>(function SiCaixabank({title = 'CaixaBank', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
