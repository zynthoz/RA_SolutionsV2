    ...
    type SiBurgerkingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D62300';

    const SiBurgerking: IconType = React.forwardRef<SVGSVGElement, SiBurgerkingProps>(function SiBurgerking({title = 'Burger King', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBurgerking as default, defaultColor };
