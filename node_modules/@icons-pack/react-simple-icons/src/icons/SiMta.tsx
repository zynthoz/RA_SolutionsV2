    ...
    type SiMtaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMta: IconType = React.forwardRef<SVGSVGElement, SiMtaProps>(function SiMta({title = 'MTA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
