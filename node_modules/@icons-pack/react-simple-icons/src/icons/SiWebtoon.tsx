    ...
    type SiWebtoonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00D564';

    const SiWebtoon: IconType = React.forwardRef<SVGSVGElement, SiWebtoonProps>(function SiWebtoon({title = 'WEBTOON', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebtoon as default, defaultColor };
