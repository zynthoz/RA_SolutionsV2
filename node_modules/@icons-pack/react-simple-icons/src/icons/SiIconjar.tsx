    ...
    type SiIconjarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#16A5F3';

    const SiIconjar: IconType = React.forwardRef<SVGSVGElement, SiIconjarProps>(function SiIconjar({title = 'IconJar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIconjar as default, defaultColor };
