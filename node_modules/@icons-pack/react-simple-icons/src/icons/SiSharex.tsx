    ...
    type SiSharexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2885F1';

    const SiSharex: IconType = React.forwardRef<SVGSVGElement, SiSharexProps>(function SiSharex({title = 'ShareX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSharex as default, defaultColor };
