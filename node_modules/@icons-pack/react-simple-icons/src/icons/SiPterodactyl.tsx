    ...
    type SiPterodactylProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPterodactyl: IconType = React.forwardRef<SVGSVGElement, SiPterodactylProps>(function SiPterodactyl({title = 'Pterodactyl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPterodactyl as default, defaultColor };
