    ...
    type SiSrgssrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSrgssr: IconType = React.forwardRef<SVGSVGElement, SiSrgssrProps>(function SiSrgssr({title = 'SRG SSR', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
