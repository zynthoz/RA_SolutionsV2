    ...
    type SiOclcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#007DBA';

    const SiOclc: IconType = React.forwardRef<SVGSVGElement, SiOclcProps>(function SiOclc({title = 'OCLC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOclc as default, defaultColor };
