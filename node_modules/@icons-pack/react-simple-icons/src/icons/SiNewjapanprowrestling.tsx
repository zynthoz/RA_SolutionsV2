    ...
    type SiNewjapanprowrestlingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF160B';

    const SiNewjapanprowrestling: IconType = React.forwardRef<SVGSVGElement, SiNewjapanprowrestlingProps>(function SiNewjapanprowrestling({title = 'New Japan Pro-Wrestling', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
