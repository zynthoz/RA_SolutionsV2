    ...
    type SiGroupmeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGroupme: IconType = React.forwardRef<SVGSVGElement, SiGroupmeProps>(function SiGroupme({title = 'GroupMe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGroupme as default, defaultColor };
