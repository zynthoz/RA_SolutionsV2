    ...
    type SiRubysinatraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRubysinatra: IconType = React.forwardRef<SVGSVGElement, SiRubysinatraProps>(function SiRubysinatra({title = 'Ruby Sinatra', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
