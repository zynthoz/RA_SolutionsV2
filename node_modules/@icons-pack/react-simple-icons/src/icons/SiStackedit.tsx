    ...
    type SiStackeditProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStackedit: IconType = React.forwardRef<SVGSVGElement, SiStackeditProps>(function SiStackedit({title = 'StackEdit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
