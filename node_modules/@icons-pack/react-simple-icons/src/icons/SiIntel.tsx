    ...
    type SiIntelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIntel: IconType = React.forwardRef<SVGSVGElement, SiIntelProps>(function SiIntel({title = 'Intel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIntel as default, defaultColor };
