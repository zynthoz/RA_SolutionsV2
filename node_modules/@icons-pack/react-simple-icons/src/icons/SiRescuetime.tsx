    ...
    type SiRescuetimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRescuetime: IconType = React.forwardRef<SVGSVGElement, SiRescuetimeProps>(function SiRescuetime({title = 'RescueTime', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
