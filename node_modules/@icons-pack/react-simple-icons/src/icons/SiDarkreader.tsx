    ...
    type SiDarkreaderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDarkreader: IconType = React.forwardRef<SVGSVGElement, SiDarkreaderProps>(function SiDarkreader({title = 'Dark Reader', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
