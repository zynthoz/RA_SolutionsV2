    ...
    type SiCoolermasterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoolermaster: IconType = React.forwardRef<SVGSVGElement, SiCoolermasterProps>(function SiCoolermaster({title = 'Cooler Master', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoolermaster as default, defaultColor };
