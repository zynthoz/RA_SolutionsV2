    ...
    type SiKnimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FDD800';

    const SiKnime: IconType = React.forwardRef<SVGSVGElement, SiKnimeProps>(function SiKnime({title = 'KNIME', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
