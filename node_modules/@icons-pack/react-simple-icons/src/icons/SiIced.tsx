    ...
    type SiIcedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIced: IconType = React.forwardRef<SVGSVGElement, SiIcedProps>(function SiIced({title = 'Iced', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
