    ...
    type SiAccusoftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAccusoft: IconType = React.forwardRef<SVGSVGElement, SiAccusoftProps>(function SiAccusoft({title = 'Accusoft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAccusoft as default, defaultColor };
