    ...
    type SiDovecotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#54BCAB';

    const SiDovecot: IconType = React.forwardRef<SVGSVGElement, SiDovecotProps>(function SiDovecot({title = 'Dovecot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDovecot as default, defaultColor };
