    ...
    type SiLinphoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLinphone: IconType = React.forwardRef<SVGSVGElement, SiLinphoneProps>(function SiLinphone({title = 'Linphone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
