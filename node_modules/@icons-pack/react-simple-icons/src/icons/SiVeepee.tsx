    ...
    type SiVeepeeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVeepee: IconType = React.forwardRef<SVGSVGElement, SiVeepeeProps>(function SiVeepee({title = 'Veepee', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
