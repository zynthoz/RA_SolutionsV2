    ...
    type SiCrowdsourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCrowdsource: IconType = React.forwardRef<SVGSVGElement, SiCrowdsourceProps>(function SiCrowdsource({title = 'Crowdsource', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
