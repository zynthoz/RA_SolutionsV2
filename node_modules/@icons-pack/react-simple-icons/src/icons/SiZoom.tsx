    ...
    type SiZoomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZoom: IconType = React.forwardRef<SVGSVGElement, SiZoomProps>(function SiZoom({title = 'Zoom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
