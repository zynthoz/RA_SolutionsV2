    ...
    type SiGltfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGltf: IconType = React.forwardRef<SVGSVGElement, SiGltfProps>(function SiGltf({title = 'glTF', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
