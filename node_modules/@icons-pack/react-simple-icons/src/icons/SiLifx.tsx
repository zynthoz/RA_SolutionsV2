    ...
    type SiLifxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLifx: IconType = React.forwardRef<SVGSVGElement, SiLifxProps>(function SiLifx({title = 'LIFX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
