    ...
    type SiLtspiceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#900028';

    const SiLtspice: IconType = React.forwardRef<SVGSVGElement, SiLtspiceProps>(function SiLtspice({title = 'LTspice', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
