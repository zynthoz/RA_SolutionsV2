    ...
    type SiExpensifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0185FF';

    const SiExpensify: IconType = React.forwardRef<SVGSVGElement, SiExpensifyProps>(function SiExpensify({title = 'Expensify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
