    ...
    type SiYelpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYelp: IconType = React.forwardRef<SVGSVGElement, SiYelpProps>(function SiYelp({title = 'Yelp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYelp as default, defaultColor };
