    ...
    type SiGnuprivacyguardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGnuprivacyguard: IconType = React.forwardRef<SVGSVGElement, SiGnuprivacyguardProps>(function SiGnuprivacyguard({title = 'GNU Privacy Guard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGnuprivacyguard as default, defaultColor };
