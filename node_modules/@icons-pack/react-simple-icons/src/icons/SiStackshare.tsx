    ...
    type SiStackshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0690FA';

    const SiStackshare: IconType = React.forwardRef<SVGSVGElement, SiStackshareProps>(function SiStackshare({title = 'StackShare', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStackshare as default, defaultColor };
