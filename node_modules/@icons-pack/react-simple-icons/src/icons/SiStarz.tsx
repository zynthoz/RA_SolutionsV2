    ...
    type SiStarzProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStarz: IconType = React.forwardRef<SVGSVGElement, SiStarzProps>(function SiStarz({title = 'STARZ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
