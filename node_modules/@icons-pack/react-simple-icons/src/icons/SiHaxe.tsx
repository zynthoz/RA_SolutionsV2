    ...
    type SiHaxeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EA8220';

    const SiHaxe: IconType = React.forwardRef<SVGSVGElement, SiHaxeProps>(function SiHaxe({title = 'Haxe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
