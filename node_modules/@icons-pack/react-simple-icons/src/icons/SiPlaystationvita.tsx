    ...
    type SiPlaystationvitaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlaystationvita: IconType = React.forwardRef<SVGSVGElement, SiPlaystationvitaProps>(function SiPlaystationvita({title = 'PlayStation Vita', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
