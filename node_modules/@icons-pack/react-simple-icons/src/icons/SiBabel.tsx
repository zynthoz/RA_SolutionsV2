    ...
    type SiBabelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBabel: IconType = React.forwardRef<SVGSVGElement, SiBabelProps>(function SiBabel({title = 'Babel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
