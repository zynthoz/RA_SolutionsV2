    ...
    type SiFingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFing: IconType = React.forwardRef<SVGSVGElement, SiFingProps>(function SiFing({title = 'Fing', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFing as default, defaultColor };
