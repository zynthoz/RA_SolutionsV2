    ...
    type SiWeblateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWeblate: IconType = React.forwardRef<SVGSVGElement, SiWeblateProps>(function SiWeblate({title = 'Weblate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
