    ...
    type SiBvgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBvg: IconType = React.forwardRef<SVGSVGElement, SiBvgProps>(function SiBvg({title = 'BVG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
