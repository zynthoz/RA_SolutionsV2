    ...
    type SiCoronarendererProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E6502A';

    const SiCoronarenderer: IconType = React.forwardRef<SVGSVGElement, SiCoronarendererProps>(function SiCoronarenderer({title = 'Corona Renderer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoronarenderer as default, defaultColor };
