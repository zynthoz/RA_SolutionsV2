    ...
    type SiLatexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLatex: IconType = React.forwardRef<SVGSVGElement, SiLatexProps>(function SiLatex({title = 'LaTeX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
