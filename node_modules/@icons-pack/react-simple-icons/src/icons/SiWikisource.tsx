    ...
    type SiWikisourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikisource: IconType = React.forwardRef<SVGSVGElement, SiWikisourceProps>(function SiWikisource({title = 'Wikisource', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
