    ...
    type SiDiorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDior: IconType = React.forwardRef<SVGSVGElement, SiDiorProps>(function SiDior({title = 'Dior', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDior as default, defaultColor };
