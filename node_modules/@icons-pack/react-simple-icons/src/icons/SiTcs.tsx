    ...
    type SiTcsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTcs: IconType = React.forwardRef<SVGSVGElement, SiTcsProps>(function SiTcs({title = 'Tata Consultancy Services', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
