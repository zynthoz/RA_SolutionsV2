    ...
    type SiFlywayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFlyway: IconType = React.forwardRef<SVGSVGElement, SiFlywayProps>(function SiFlyway({title = 'Flyway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFlyway as default, defaultColor };
