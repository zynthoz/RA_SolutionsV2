    ...
    type SiQualysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQualys: IconType = React.forwardRef<SVGSVGElement, SiQualysProps>(function SiQualys({title = 'Qualys', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
