    ...
    type SiSapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSap: IconType = React.forwardRef<SVGSVGElement, SiSapProps>(function SiSap({title = 'SAP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
