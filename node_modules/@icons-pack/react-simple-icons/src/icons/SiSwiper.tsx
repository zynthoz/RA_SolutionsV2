    ...
    type SiSwiperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSwiper: IconType = React.forwardRef<SVGSVGElement, SiSwiperProps>(function SiSwiper({title = 'Swiper', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
