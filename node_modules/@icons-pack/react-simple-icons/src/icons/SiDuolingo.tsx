    ...
    type SiDuolingoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDuolingo: IconType = React.forwardRef<SVGSVGElement, SiDuolingoProps>(function SiDuolingo({title = 'Duolingo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
