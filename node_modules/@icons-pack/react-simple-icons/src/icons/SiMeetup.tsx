    ...
    type SiMeetupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED1C40';

    const SiMeetup: IconType = React.forwardRef<SVGSVGElement, SiMeetupProps>(function SiMeetup({title = 'Meetup', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMeetup as default, defaultColor };
