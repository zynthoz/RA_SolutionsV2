    ...
    type SiImmerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImmer: IconType = React.forwardRef<SVGSVGElement, SiImmerProps>(function SiImmer({title = 'Immer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
