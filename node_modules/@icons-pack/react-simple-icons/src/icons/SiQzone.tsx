    ...
    type SiQzoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQzone: IconType = React.forwardRef<SVGSVGElement, SiQzoneProps>(function SiQzone({title = 'Qzone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
