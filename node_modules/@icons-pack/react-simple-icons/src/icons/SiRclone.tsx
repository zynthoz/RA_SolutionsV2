    ...
    type SiRcloneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3F79AD';

    const SiRclone: IconType = React.forwardRef<SVGSVGElement, SiRcloneProps>(function SiRclone({title = 'Rclone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
