    ...
    type SiPagespeedinsightsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPagespeedinsights: IconType = React.forwardRef<SVGSVGElement, SiPagespeedinsightsProps>(function SiPagespeedinsights({title = 'PageSpeed Insights', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
