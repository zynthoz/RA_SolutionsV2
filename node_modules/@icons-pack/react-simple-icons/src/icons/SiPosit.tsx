    ...
    type SiPositProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#447099';

    const SiPosit: IconType = React.forwardRef<SVGSVGElement, SiPositProps>(function SiPosit({title = 'Posit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPosit as default, defaultColor };
