    ...
    type SiFampayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFampay: IconType = React.forwardRef<SVGSVGElement, SiFampayProps>(function SiFampay({title = 'FamPay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
