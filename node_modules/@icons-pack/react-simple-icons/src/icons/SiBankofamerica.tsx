    ...
    type SiBankofamericaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBankofamerica: IconType = React.forwardRef<SVGSVGElement, SiBankofamericaProps>(function SiBankofamerica({title = 'Bank of America', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
