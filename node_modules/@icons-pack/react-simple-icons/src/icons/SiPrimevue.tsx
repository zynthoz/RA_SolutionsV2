    ...
    type SiPrimevueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrimevue: IconType = React.forwardRef<SVGSVGElement, SiPrimevueProps>(function SiPrimevue({title = 'PrimeVue', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
