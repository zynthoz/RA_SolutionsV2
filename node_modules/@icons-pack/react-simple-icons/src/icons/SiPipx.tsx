    ...
    type SiPipxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2CFFAA';

    const SiPipx: IconType = React.forwardRef<SVGSVGElement, SiPipxProps>(function SiPipx({title = 'pipx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPipx as default, defaultColor };
