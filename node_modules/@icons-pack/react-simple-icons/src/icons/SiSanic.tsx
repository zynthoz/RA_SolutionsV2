    ...
    type SiSanicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSanic: IconType = React.forwardRef<SVGSVGElement, SiSanicProps>(function SiSanic({title = 'Sanic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
