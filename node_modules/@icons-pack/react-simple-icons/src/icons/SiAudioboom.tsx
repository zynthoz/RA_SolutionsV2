    ...
    type SiAudioboomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#007CE2';

    const SiAudioboom: IconType = React.forwardRef<SVGSVGElement, SiAudioboomProps>(function SiAudioboom({title = 'Audioboom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAudioboom as default, defaultColor };
