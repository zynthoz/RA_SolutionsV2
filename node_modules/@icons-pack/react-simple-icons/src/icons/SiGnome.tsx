    ...
    type SiGnomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4A86CF';

    const SiGnome: IconType = React.forwardRef<SVGSVGElement, SiGnomeProps>(function SiGnome({title = 'GNOME', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGnome as default, defaultColor };
