    ...
    type SiSouthwestairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSouthwestairlines: IconType = React.forwardRef<SVGSVGElement, SiSouthwestairlinesProps>(function SiSouthwestairlines({title = 'Southwest Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
