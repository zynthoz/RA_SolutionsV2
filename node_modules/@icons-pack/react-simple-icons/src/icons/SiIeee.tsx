    ...
    type SiIeeeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIeee: IconType = React.forwardRef<SVGSVGElement, SiIeeeProps>(function SiIeee({title = 'IEEE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIeee as default, defaultColor };
