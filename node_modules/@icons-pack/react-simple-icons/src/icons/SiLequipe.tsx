    ...
    type SiLequipeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E42829';

    const SiLequipe: IconType = React.forwardRef<SVGSVGElement, SiLequipeProps>(function SiLequipe({title = 'LÉquipe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLequipe as default, defaultColor };
