    ...
    type SiPrivateinternetaccessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrivateinternetaccess: IconType = React.forwardRef<SVGSVGElement, SiPrivateinternetaccessProps>(function SiPrivateinternetaccess({title = 'Private Internet Access', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
