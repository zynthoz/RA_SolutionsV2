    ...
    type SiRacketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#9F1D20';

    const SiRacket: IconType = React.forwardRef<SVGSVGElement, SiRacketProps>(function SiRacket({title = 'Racket', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRacket as default, defaultColor };
