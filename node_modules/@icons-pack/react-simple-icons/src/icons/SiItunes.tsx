    ...
    type SiItunesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FB5BC5';

    const SiItunes: IconType = React.forwardRef<SVGSVGElement, SiItunesProps>(function SiItunes({title = 'iTunes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiItunes as default, defaultColor };
