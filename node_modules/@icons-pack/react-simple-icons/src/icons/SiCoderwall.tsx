    ...
    type SiCoderwallProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoderwall: IconType = React.forwardRef<SVGSVGElement, SiCoderwallProps>(function SiCoderwall({title = 'Coderwall', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
