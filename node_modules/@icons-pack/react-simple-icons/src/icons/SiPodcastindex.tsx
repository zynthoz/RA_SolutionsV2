    ...
    type SiPodcastindexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F90000';

    const SiPodcastindex: IconType = React.forwardRef<SVGSVGElement, SiPodcastindexProps>(function SiPodcastindex({title = 'Podcast Index', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPodcastindex as default, defaultColor };
