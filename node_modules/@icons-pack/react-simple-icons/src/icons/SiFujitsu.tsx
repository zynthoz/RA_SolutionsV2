    ...
    type SiFujitsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFujitsu: IconType = React.forwardRef<SVGSVGElement, SiFujitsuProps>(function SiFujitsu({title = 'Fujitsu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
