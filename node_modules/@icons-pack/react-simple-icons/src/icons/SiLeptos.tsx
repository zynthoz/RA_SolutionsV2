    ...
    type SiLeptosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLeptos: IconType = React.forwardRef<SVGSVGElement, SiLeptosProps>(function SiLeptos({title = 'Leptos', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLeptos as default, defaultColor };
