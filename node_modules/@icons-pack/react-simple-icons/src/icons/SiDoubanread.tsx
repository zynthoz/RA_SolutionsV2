    ...
    type SiDoubanreadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDoubanread: IconType = React.forwardRef<SVGSVGElement, SiDoubanreadProps>(function SiDoubanread({title = 'Douban Read', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
