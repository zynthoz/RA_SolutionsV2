    ...
    type SiNextflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0DC09D';

    const SiNextflow: IconType = React.forwardRef<SVGSVGElement, SiNextflowProps>(function SiNextflow({title = 'Nextflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNextflow as default, defaultColor };
