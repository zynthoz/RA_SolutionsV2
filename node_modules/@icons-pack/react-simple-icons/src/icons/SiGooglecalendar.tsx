    ...
    type SiGooglecalendarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglecalendar: IconType = React.forwardRef<SVGSVGElement, SiGooglecalendarProps>(function SiGooglecalendar({title = 'Google Calendar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
