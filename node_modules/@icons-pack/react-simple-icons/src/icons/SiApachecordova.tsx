    ...
    type SiApachecordovaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachecordova: IconType = React.forwardRef<SVGSVGElement, SiApachecordovaProps>(function SiApachecordova({title = 'Apache Cordova', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachecordova as default, defaultColor };
