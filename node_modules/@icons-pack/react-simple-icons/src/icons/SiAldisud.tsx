    ...
    type SiAldisudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAldisud: IconType = React.forwardRef<SVGSVGElement, SiAldisudProps>(function SiAldisud({title = 'Aldi Süd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAldisud as default, defaultColor };
