    ...
    type SiParadoxinteractiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiParadoxinteractive: IconType = React.forwardRef<SVGSVGElement, SiParadoxinteractiveProps>(function SiParadoxinteractive({title = 'Paradox Interactive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiParadoxinteractive as default, defaultColor };
