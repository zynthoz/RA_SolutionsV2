    ...
    type SiSonarqubeforideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonarqubeforide: IconType = React.forwardRef<SVGSVGElement, SiSonarqubeforideProps>(function SiSonarqubeforide({title = 'SonarQube for IDE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonarqubeforide as default, defaultColor };
