    ...
    type SiPhabricatorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhabricator: IconType = React.forwardRef<SVGSVGElement, SiPhabricatorProps>(function SiPhabricator({title = 'Phabricator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
