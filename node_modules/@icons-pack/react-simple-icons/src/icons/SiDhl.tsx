    ...
    type SiDhlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDhl: IconType = React.forwardRef<SVGSVGElement, SiDhlProps>(function SiDhl({title = 'DHL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDhl as default, defaultColor };
