    ...
    type SiPysyftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPysyft: IconType = React.forwardRef<SVGSVGElement, SiPysyftProps>(function SiPysyft({title = 'PySyft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
