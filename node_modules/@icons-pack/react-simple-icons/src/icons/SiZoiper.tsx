    ...
    type SiZoiperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F47920';

    const SiZoiper: IconType = React.forwardRef<SVGSVGElement, SiZoiperProps>(function SiZoiper({title = 'Zoiper', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZoiper as default, defaultColor };
