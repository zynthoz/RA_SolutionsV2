    ...
    type SiPremierleagueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#360D3A';

    const SiPremierleague: IconType = React.forwardRef<SVGSVGElement, SiPremierleagueProps>(function SiPremierleague({title = 'Premier League', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPremierleague as default, defaultColor };
