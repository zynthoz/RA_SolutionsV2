    ...
    type SiAlamyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00FF7B';

    const SiAlamy: IconType = React.forwardRef<SVGSVGElement, SiAlamyProps>(function SiAlamy({title = 'Alamy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlamy as default, defaultColor };
