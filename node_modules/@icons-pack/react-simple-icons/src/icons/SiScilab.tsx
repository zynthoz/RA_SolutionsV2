    ...
    type SiScilabProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CD1925';

    const SiScilab: IconType = React.forwardRef<SVGSVGElement, SiScilabProps>(function SiScilab({title = 'Scilab', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
