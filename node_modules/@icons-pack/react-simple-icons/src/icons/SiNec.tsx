    ...
    type SiNecProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNec: IconType = React.forwardRef<SVGSVGElement, SiNecProps>(function SiNec({title = 'NEC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
