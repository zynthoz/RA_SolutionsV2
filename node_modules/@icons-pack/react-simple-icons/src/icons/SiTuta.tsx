    ...
    type SiTutaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTuta: IconType = React.forwardRef<SVGSVGElement, SiTutaProps>(function SiTuta({title = 'Tuta', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
