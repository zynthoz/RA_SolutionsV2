    ...
    type SiTorbrowserProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7D4698';

    const SiTorbrowser: IconType = React.forwardRef<SVGSVGElement, SiTorbrowserProps>(function SiTorbrowser({title = 'Tor Browser', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTorbrowser as default, defaultColor };
