    ...
    type SiXamppProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FB7A24';

    const SiXampp: IconType = React.forwardRef<SVGSVGElement, SiXamppProps>(function SiXampp({title = 'XAMPP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiXampp as default, defaultColor };
