    ...
    type SiTubiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7408FF';

    const SiTubi: IconType = React.forwardRef<SVGSVGElement, SiTubiProps>(function SiTubi({title = 'Tubi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTubi as default, defaultColor };
