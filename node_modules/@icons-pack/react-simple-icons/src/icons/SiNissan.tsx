    ...
    type SiNissanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNissan: IconType = React.forwardRef<SVGSVGElement, SiNissanProps>(function SiNissan({title = 'Nissan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
