    ...
    type SiAcuraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAcura: IconType = React.forwardRef<SVGSVGElement, SiAcuraProps>(function SiAcura({title = 'Acura', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAcura as default, defaultColor };
