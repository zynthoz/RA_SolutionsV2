    ...
    type SiTeepublicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4E64DF';

    const SiTeepublic: IconType = React.forwardRef<SVGSVGElement, SiTeepublicProps>(function SiTeepublic({title = 'TeePublic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
