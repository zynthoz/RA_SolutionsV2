    ...
    type SiInfuseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfuse: IconType = React.forwardRef<SVGSVGElement, SiInfuseProps>(function SiInfuse({title = 'Infuse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
