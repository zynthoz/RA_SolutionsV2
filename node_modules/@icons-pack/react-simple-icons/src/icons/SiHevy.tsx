    ...
    type SiHevyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHevy: IconType = React.forwardRef<SVGSVGElement, SiHevyProps>(function SiHevy({title = 'Hevy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
