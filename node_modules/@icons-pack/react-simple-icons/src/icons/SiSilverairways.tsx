    ...
    type SiSilverairwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D0006F';

    const SiSilverairways: IconType = React.forwardRef<SVGSVGElement, SiSilverairwaysProps>(function SiSilverairways({title = 'Silver Airways', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
