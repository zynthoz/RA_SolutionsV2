    ...
    type SiBitriseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBitrise: IconType = React.forwardRef<SVGSVGElement, SiBitriseProps>(function SiBitrise({title = 'Bitrise', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBitrise as default, defaultColor };
