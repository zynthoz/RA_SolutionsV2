    ...
    type SiWemoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWemo: IconType = React.forwardRef<SVGSVGElement, SiWemoProps>(function SiWemo({title = 'WEMO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWemo as default, defaultColor };
