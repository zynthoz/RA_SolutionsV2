    ...
    type SiRainmeterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRainmeter: IconType = React.forwardRef<SVGSVGElement, SiRainmeterProps>(function SiRainmeter({title = 'Rainmeter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
