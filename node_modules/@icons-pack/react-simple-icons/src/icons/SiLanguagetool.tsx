    ...
    type SiLanguagetoolProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLanguagetool: IconType = React.forwardRef<SVGSVGElement, SiLanguagetoolProps>(function SiLanguagetool({title = 'LanguageTool', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
