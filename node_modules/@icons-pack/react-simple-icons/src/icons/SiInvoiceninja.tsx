    ...
    type SiInvoiceninjaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInvoiceninja: IconType = React.forwardRef<SVGSVGElement, SiInvoiceninjaProps>(function SiInvoiceninja({title = 'Invoice Ninja', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInvoiceninja as default, defaultColor };
