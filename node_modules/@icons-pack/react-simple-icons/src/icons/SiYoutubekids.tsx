    ...
    type SiYoutubekidsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYoutubekids: IconType = React.forwardRef<SVGSVGElement, SiYoutubekidsProps>(function SiYoutubekids({title = 'YouTube Kids', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYoutubekids as default, defaultColor };
