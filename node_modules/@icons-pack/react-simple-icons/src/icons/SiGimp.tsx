    ...
    type SiGimpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGimp: IconType = React.forwardRef<SVGSVGElement, SiGimpProps>(function SiGimp({title = 'GIMP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
