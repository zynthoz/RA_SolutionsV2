    ...
    type SiDocusaurusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3ECC5F';

    const SiDocusaurus: IconType = React.forwardRef<SVGSVGElement, SiDocusaurusProps>(function SiDocusaurus({title = 'Docusaurus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDocusaurus as default, defaultColor };
