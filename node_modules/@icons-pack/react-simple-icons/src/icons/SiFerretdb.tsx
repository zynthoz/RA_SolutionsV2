    ...
    type SiFerretdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#042133';

    const SiFerretdb: IconType = React.forwardRef<SVGSVGElement, SiFerretdbProps>(function SiFerretdb({title = 'FerretDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFerretdb as default, defaultColor };
