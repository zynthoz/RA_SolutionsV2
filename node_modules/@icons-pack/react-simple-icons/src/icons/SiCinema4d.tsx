    ...
    type SiCinema4dProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCinema4d: IconType = React.forwardRef<SVGSVGElement, SiCinema4dProps>(function SiCinema4d({title = 'Cinema 4D', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCinema4d as default, defaultColor };
