    ...
    type SiHitachiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHitachi: IconType = React.forwardRef<SVGSVGElement, SiHitachiProps>(function SiHitachi({title = 'Hitachi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
