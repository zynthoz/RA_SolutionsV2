    ...
    type SiEmberdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E04E39';

    const SiEmberdotjs: IconType = React.forwardRef<SVGSVGElement, SiEmberdotjsProps>(function SiEmberdotjs({title = 'Ember.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEmberdotjs as default, defaultColor };
