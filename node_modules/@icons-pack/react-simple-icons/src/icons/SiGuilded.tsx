    ...
    type SiGuildedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGuilded: IconType = React.forwardRef<SVGSVGElement, SiGuildedProps>(function SiGuilded({title = 'Guilded', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
