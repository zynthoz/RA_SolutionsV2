    ...
    type SiChupachupsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CF103E';

    const SiChupachups: IconType = React.forwardRef<SVGSVGElement, SiChupachupsProps>(function SiChupachups({title = 'Chupa Chups', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
