    ...
    type SiTypeformProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTypeform: IconType = React.forwardRef<SVGSVGElement, SiTypeformProps>(function SiTypeform({title = 'Typeform', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
