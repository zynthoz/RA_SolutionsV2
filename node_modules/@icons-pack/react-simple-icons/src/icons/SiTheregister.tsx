    ...
    type SiTheregisterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTheregister: IconType = React.forwardRef<SVGSVGElement, SiTheregisterProps>(function SiTheregister({title = 'The Register', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTheregister as default, defaultColor };
