    ...
    type SiWritedotasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5AC4EE';

    const SiWritedotas: IconType = React.forwardRef<SVGSVGElement, SiWritedotasProps>(function SiWritedotas({title = 'Write.as', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWritedotas as default, defaultColor };
