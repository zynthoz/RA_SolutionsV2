    ...
    type SiLegacygamesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#144B9E';

    const SiLegacygames: IconType = React.forwardRef<SVGSVGElement, SiLegacygamesProps>(function SiLegacygames({title = 'Legacy Games', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLegacygames as default, defaultColor };
