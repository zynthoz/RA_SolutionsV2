    ...
    type SiFerrariProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFerrari: IconType = React.forwardRef<SVGSVGElement, SiFerrariProps>(function SiFerrari({title = 'Ferrari', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
