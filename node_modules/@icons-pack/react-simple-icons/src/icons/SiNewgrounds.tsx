    ...
    type SiNewgroundsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FDA238';

    const SiNewgrounds: IconType = React.forwardRef<SVGSVGElement, SiNewgroundsProps>(function SiNewgrounds({title = 'Newgrounds', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNewgrounds as default, defaultColor };
