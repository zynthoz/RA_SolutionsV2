    ...
    type SiCarlsberggroupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00321E';

    const SiCarlsberggroup: IconType = React.forwardRef<SVGSVGElement, SiCarlsberggroupProps>(function SiCarlsberggroup({title = 'Carlsberg Group', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
