    ...
    type SiEspressifProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEspressif: IconType = React.forwardRef<SVGSVGElement, SiEspressifProps>(function SiEspressif({title = 'Espressif', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
