    ...
    type SiLotpolishairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLotpolishairlines: IconType = React.forwardRef<SVGSVGElement, SiLotpolishairlinesProps>(function SiLotpolishairlines({title = 'LOT Polish Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
