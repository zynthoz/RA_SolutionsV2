    ...
    type SiFreecodecampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0A0A23';

    const SiFreecodecamp: IconType = React.forwardRef<SVGSVGElement, SiFreecodecampProps>(function SiFreecodecamp({title = 'freeCodeCamp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFreecodecamp as default, defaultColor };
