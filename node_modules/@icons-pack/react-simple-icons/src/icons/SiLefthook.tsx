    ...
    type SiLefthookProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLefthook: IconType = React.forwardRef<SVGSVGElement, SiLefthookProps>(function SiLefthook({title = 'Lefthook', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
