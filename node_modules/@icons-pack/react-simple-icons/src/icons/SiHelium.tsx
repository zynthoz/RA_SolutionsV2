    ...
    type SiHeliumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHelium: IconType = React.forwardRef<SVGSVGElement, SiHeliumProps>(function SiHelium({title = 'Helium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
