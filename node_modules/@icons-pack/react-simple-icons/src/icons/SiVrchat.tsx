    ...
    type SiVrchatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVrchat: IconType = React.forwardRef<SVGSVGElement, SiVrchatProps>(function SiVrchat({title = 'VRChat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVrchat as default, defaultColor };
