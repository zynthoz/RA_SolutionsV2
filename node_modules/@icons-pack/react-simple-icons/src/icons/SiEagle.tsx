    ...
    type SiEagleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEagle: IconType = React.forwardRef<SVGSVGElement, SiEagleProps>(function SiEagle({title = 'Eagle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
