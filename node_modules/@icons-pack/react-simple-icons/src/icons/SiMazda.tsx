    ...
    type SiMazdaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMazda: IconType = React.forwardRef<SVGSVGElement, SiMazdaProps>(function SiMazda({title = 'Mazda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
