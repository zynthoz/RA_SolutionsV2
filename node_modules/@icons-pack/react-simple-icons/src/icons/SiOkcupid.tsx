    ...
    type SiOkcupidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0500BE';

    const SiOkcupid: IconType = React.forwardRef<SVGSVGElement, SiOkcupidProps>(function SiOkcupid({title = 'okcupid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOkcupid as default, defaultColor };
