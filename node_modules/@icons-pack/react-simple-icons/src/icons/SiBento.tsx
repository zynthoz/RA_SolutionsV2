    ...
    type SiBentoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBento: IconType = React.forwardRef<SVGSVGElement, SiBentoProps>(function SiBento({title = 'Bento', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBento as default, defaultColor };
