    ...
    type SiCentosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCentos: IconType = React.forwardRef<SVGSVGElement, SiCentosProps>(function SiCentos({title = 'CentOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
