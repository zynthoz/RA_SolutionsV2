    ...
    type SiRossmannProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRossmann: IconType = React.forwardRef<SVGSVGElement, SiRossmannProps>(function SiRossmann({title = 'Rossmann', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
