    ...
    type SiTrivagoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E32851';

    const SiTrivago: IconType = React.forwardRef<SVGSVGElement, SiTrivagoProps>(function SiTrivago({title = 'trivago', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
