    ...
    type SiCockroachlabsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6933FF';

    const SiCockroachlabs: IconType = React.forwardRef<SVGSVGElement, SiCockroachlabsProps>(function SiCockroachlabs({title = 'Cockroach Labs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCockroachlabs as default, defaultColor };
