    ...
    type SiIcelandProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIceland: IconType = React.forwardRef<SVGSVGElement, SiIcelandProps>(function SiIceland({title = 'Iceland', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIceland as default, defaultColor };
