    ...
    type SiXubuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiXubuntu: IconType = React.forwardRef<SVGSVGElement, SiXubuntuProps>(function SiXubuntu({title = 'Xubuntu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
