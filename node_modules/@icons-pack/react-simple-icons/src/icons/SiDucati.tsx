    ...
    type SiDucatiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDucati: IconType = React.forwardRef<SVGSVGElement, SiDucatiProps>(function SiDucati({title = 'Ducati', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
