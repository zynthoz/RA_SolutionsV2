    ...
    type SiWebmoneyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#036CB5';

    const SiWebmoney: IconType = React.forwardRef<SVGSVGElement, SiWebmoneyProps>(function SiWebmoney({title = 'WebMoney', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebmoney as default, defaultColor };
