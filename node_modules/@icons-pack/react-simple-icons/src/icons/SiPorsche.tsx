    ...
    type SiPorscheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B12B28';

    const SiPorsche: IconType = React.forwardRef<SVGSVGElement, SiPorscheProps>(function SiPorsche({title = 'Porsche', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPorsche as default, defaultColor };
