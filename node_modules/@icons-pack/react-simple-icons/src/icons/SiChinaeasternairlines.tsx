    ...
    type SiChinaeasternairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChinaeasternairlines: IconType = React.forwardRef<SVGSVGElement, SiChinaeasternairlinesProps>(function SiChinaeasternairlines({title = 'China Eastern Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
