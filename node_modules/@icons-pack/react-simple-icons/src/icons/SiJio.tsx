    ...
    type SiJioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJio: IconType = React.forwardRef<SVGSVGElement, SiJioProps>(function SiJio({title = 'Jio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
