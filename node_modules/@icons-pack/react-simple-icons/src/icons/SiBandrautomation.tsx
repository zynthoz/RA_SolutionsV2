    ...
    type SiBandrautomationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBandrautomation: IconType = React.forwardRef<SVGSVGElement, SiBandrautomationProps>(function SiBandrautomation({title = 'B&R Automation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
