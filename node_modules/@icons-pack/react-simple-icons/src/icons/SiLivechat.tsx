    ...
    type SiLivechatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLivechat: IconType = React.forwardRef<SVGSVGElement, SiLivechatProps>(function SiLivechat({title = 'LiveChat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLivechat as default, defaultColor };
