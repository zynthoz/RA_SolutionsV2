    ...
    type SiBlenderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlender: IconType = React.forwardRef<SVGSVGElement, SiBlenderProps>(function SiBlender({title = 'Blender', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBlender as default, defaultColor };
