    ...
    type SiExpressdotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiExpressdotcom: IconType = React.forwardRef<SVGSVGElement, SiExpressdotcomProps>(function SiExpressdotcom({title = 'Express.com', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiExpressdotcom as default, defaultColor };
