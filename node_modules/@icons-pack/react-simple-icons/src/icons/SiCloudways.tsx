    ...
    type SiCloudwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2C39BD';

    const SiCloudways: IconType = React.forwardRef<SVGSVGElement, SiCloudwaysProps>(function SiCloudways({title = 'Cloudways', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCloudways as default, defaultColor };
