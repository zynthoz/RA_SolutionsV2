    ...
    type SiSemanticreleaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSemanticrelease: IconType = React.forwardRef<SVGSVGElement, SiSemanticreleaseProps>(function SiSemanticrelease({title = 'semantic-release', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSemanticrelease as default, defaultColor };
