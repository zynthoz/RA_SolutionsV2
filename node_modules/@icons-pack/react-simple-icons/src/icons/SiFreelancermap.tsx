    ...
    type SiFreelancermapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00CFD6';

    const SiFreelancermap: IconType = React.forwardRef<SVGSVGElement, SiFreelancermapProps>(function SiFreelancermap({title = 'freelancermap', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFreelancermap as default, defaultColor };
