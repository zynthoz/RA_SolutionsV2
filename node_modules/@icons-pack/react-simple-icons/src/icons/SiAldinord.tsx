    ...
    type SiAldinordProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2490D7';

    const SiAldinord: IconType = React.forwardRef<SVGSVGElement, SiAldinordProps>(function SiAldinord({title = 'Aldi Nord', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAldinord as default, defaultColor };
