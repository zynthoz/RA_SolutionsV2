    ...
    type SiGunicornProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#499848';

    const SiGunicorn: IconType = React.forwardRef<SVGSVGElement, SiGunicornProps>(function SiGunicorn({title = 'Gunicorn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGunicorn as default, defaultColor };
