    ...
    type SiConektaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConekta: IconType = React.forwardRef<SVGSVGElement, SiConektaProps>(function SiConekta({title = 'Conekta', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiConekta as default, defaultColor };
