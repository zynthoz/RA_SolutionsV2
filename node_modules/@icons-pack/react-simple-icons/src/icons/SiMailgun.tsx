    ...
    type SiMailgunProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F06B66';

    const SiMailgun: IconType = React.forwardRef<SVGSVGElement, SiMailgunProps>(function SiMailgun({title = 'Mailgun', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMailgun as default, defaultColor };
