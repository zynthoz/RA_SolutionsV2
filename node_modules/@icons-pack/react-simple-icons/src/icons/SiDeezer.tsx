    ...
    type SiDeezerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#A238FF';

    const SiDeezer: IconType = React.forwardRef<SVGSVGElement, SiDeezerProps>(function SiDeezer({title = 'Deezer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDeezer as default, defaultColor };
