    ...
    type SiSonicwallProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonicwall: IconType = React.forwardRef<SVGSVGElement, SiSonicwallProps>(function SiSonicwall({title = 'SonicWall', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonicwall as default, defaultColor };
