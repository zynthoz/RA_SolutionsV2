    ...
    type SiSellfyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#21B352';

    const SiSellfy: IconType = React.forwardRef<SVGSVGElement, SiSellfyProps>(function SiSellfy({title = 'Sellfy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
