    ...
    type SiDoxygenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2C4AA8';

    const SiDoxygen: IconType = React.forwardRef<SVGSVGElement, SiDoxygenProps>(function SiDoxygen({title = 'Doxygen', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDoxygen as default, defaultColor };
