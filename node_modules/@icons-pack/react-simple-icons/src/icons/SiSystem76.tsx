    ...
    type SiSystem76Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSystem76: IconType = React.forwardRef<SVGSVGElement, SiSystem76Props>(function SiSystem76({title = 'System76', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
