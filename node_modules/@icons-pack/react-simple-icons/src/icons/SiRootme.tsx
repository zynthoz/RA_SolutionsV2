    ...
    type SiRootmeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRootme: IconType = React.forwardRef<SVGSVGElement, SiRootmeProps>(function SiRootme({title = 'Root Me', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRootme as default, defaultColor };
