    ...
    type SiKagiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFB319';

    const SiKagi: IconType = React.forwardRef<SVGSVGElement, SiKagiProps>(function SiKagi({title = 'Kagi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
