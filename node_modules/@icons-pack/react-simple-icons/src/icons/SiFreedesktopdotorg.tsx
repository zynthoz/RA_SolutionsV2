    ...
    type SiFreedesktopdotorgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFreedesktopdotorg: IconType = React.forwardRef<SVGSVGElement, SiFreedesktopdotorgProps>(function SiFreedesktopdotorg({title = 'freedesktop.org', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
