    ...
    type SiAppsignalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#21375A';

    const SiAppsignal: IconType = React.forwardRef<SVGSVGElement, SiAppsignalProps>(function SiAppsignal({title = 'AppSignal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppsignal as default, defaultColor };
