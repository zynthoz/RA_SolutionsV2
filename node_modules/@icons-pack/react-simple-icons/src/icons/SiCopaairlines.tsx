    ...
    type SiCopaairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCopaairlines: IconType = React.forwardRef<SVGSVGElement, SiCopaairlinesProps>(function SiCopaairlines({title = 'Copa Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCopaairlines as default, defaultColor };
