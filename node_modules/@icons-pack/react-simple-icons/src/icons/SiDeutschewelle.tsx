    ...
    type SiDeutschewelleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeutschewelle: IconType = React.forwardRef<SVGSVGElement, SiDeutschewelleProps>(function SiDeutschewelle({title = 'Deutsche Welle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDeutschewelle as default, defaultColor };
