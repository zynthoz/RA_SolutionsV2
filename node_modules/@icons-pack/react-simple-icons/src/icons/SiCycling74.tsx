    ...
    type SiCycling74Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCycling74: IconType = React.forwardRef<SVGSVGElement, SiCycling74Props>(function SiCycling74({title = 'Cycling 74', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
