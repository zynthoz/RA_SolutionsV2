    ...
    type SiGumtreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#72EF36';

    const SiGumtree: IconType = React.forwardRef<SVGSVGElement, SiGumtreeProps>(function SiGumtree({title = 'Gumtree', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGumtree as default, defaultColor };
