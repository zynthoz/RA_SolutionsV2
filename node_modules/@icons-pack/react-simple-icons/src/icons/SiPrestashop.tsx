    ...
    type SiPrestashopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrestashop: IconType = React.forwardRef<SVGSVGElement, SiPrestashopProps>(function SiPrestashop({title = 'PrestaShop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
