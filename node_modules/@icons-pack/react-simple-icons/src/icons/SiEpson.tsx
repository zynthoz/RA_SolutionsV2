    ...
    type SiEpsonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEpson: IconType = React.forwardRef<SVGSVGElement, SiEpsonProps>(function SiEpson({title = 'Epson', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEpson as default, defaultColor };
