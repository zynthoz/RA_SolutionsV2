    ...
    type SiCryengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCryengine: IconType = React.forwardRef<SVGSVGElement, SiCryengineProps>(function SiCryengine({title = 'CRYENGINE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
