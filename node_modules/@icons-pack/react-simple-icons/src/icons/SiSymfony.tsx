    ...
    type SiSymfonyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSymfony: IconType = React.forwardRef<SVGSVGElement, SiSymfonyProps>(function SiSymfony({title = 'Symfony', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
