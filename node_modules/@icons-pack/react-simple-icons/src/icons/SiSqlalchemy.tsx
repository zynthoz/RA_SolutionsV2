    ...
    type SiSqlalchemyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D71F00';

    const SiSqlalchemy: IconType = React.forwardRef<SVGSVGElement, SiSqlalchemyProps>(function SiSqlalchemy({title = 'SQLAlchemy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSqlalchemy as default, defaultColor };
