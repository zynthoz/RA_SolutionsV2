    ...
    type SiVauxhallProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVauxhall: IconType = React.forwardRef<SVGSVGElement, SiVauxhallProps>(function SiVauxhall({title = 'Vauxhall', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
