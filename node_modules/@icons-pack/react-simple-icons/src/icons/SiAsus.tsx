    ...
    type SiAsusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAsus: IconType = React.forwardRef<SVGSVGElement, SiAsusProps>(function SiAsus({title = 'ASUS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
