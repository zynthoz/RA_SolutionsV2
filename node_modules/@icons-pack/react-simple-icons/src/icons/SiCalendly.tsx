    ...
    type SiCalendlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCalendly: IconType = React.forwardRef<SVGSVGElement, SiCalendlyProps>(function SiCalendly({title = 'Calendly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
