    ...
    type SiQiitaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQiita: IconType = React.forwardRef<SVGSVGElement, SiQiitaProps>(function SiQiita({title = 'Qiita', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQiita as default, defaultColor };
