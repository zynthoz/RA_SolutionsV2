    ...
    type SiNamuwikiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNamuwiki: IconType = React.forwardRef<SVGSVGElement, SiNamuwikiProps>(function SiNamuwiki({title = 'Namu Wiki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
