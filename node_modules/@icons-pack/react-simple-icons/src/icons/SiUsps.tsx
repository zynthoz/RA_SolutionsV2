    ...
    type SiUspsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#333366';

    const SiUsps: IconType = React.forwardRef<SVGSVGElement, SiUspsProps>(function SiUsps({title = 'USPS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUsps as default, defaultColor };
