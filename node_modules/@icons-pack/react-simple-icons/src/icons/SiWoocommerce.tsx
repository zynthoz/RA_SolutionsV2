    ...
    type SiWoocommerceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#96588A';

    const SiWoocommerce: IconType = React.forwardRef<SVGSVGElement, SiWoocommerceProps>(function SiWoocommerce({title = 'WooCommerce', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWoocommerce as default, defaultColor };
