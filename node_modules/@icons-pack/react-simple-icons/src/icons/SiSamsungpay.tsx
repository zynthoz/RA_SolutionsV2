    ...
    type SiSamsungpayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSamsungpay: IconType = React.forwardRef<SVGSVGElement, SiSamsungpayProps>(function SiSamsungpay({title = 'Samsung Pay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSamsungpay as default, defaultColor };
