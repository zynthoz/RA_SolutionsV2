    ...
    type SiWykopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWykop: IconType = React.forwardRef<SVGSVGElement, SiWykopProps>(function SiWykop({title = 'Wykop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
