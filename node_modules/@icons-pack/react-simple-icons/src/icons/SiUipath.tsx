    ...
    type SiUipathProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FA4616';

    const SiUipath: IconType = React.forwardRef<SVGSVGElement, SiUipathProps>(function SiUipath({title = 'UiPath', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUipath as default, defaultColor };
