    ...
    type SiIndeedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIndeed: IconType = React.forwardRef<SVGSVGElement, SiIndeedProps>(function SiIndeed({title = 'Indeed', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
