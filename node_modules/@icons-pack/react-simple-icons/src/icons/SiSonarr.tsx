    ...
    type SiSonarrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonarr: IconType = React.forwardRef<SVGSVGElement, SiSonarrProps>(function SiSonarr({title = 'sonarr', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonarr as default, defaultColor };
