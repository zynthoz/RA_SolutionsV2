    ...
    type SiFireflyiiiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFireflyiii: IconType = React.forwardRef<SVGSVGElement, SiFireflyiiiProps>(function SiFireflyiii({title = 'Firefly III', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFireflyiii as default, defaultColor };
