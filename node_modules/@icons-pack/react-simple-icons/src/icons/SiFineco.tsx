    ...
    type SiFinecoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFineco: IconType = React.forwardRef<SVGSVGElement, SiFinecoProps>(function SiFineco({title = 'Fineco', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFineco as default, defaultColor };
