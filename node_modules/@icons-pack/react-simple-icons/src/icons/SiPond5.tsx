    ...
    type SiPond5Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPond5: IconType = React.forwardRef<SVGSVGElement, SiPond5Props>(function SiPond5({title = 'Pond5', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
