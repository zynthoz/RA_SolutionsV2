    ...
    type SiBookbubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBookbub: IconType = React.forwardRef<SVGSVGElement, SiBookbubProps>(function SiBookbub({title = 'BookBub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
