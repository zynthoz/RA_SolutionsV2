    ...
    type SiKubuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKubuntu: IconType = React.forwardRef<SVGSVGElement, SiKubuntuProps>(function SiKubuntu({title = 'Kubuntu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
