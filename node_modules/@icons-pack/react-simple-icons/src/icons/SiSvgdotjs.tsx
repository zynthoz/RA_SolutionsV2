    ...
    type SiSvgdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSvgdotjs: IconType = React.forwardRef<SVGSVGElement, SiSvgdotjsProps>(function SiSvgdotjs({title = 'SVG.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSvgdotjs as default, defaultColor };
