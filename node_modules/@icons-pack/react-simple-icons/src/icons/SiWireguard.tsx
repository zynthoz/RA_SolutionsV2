    ...
    type SiWireguardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWireguard: IconType = React.forwardRef<SVGSVGElement, SiWireguardProps>(function SiWireguard({title = 'WireGuard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWireguard as default, defaultColor };
