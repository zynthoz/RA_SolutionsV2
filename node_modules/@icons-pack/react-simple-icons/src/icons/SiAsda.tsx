    ...
    type SiAsdaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAsda: IconType = React.forwardRef<SVGSVGElement, SiAsdaProps>(function SiAsda({title = 'ASDA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAsda as default, defaultColor };
