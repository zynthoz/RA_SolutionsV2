    ...
    type SiKhronosgroupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKhronosgroup: IconType = React.forwardRef<SVGSVGElement, SiKhronosgroupProps>(function SiKhronosgroup({title = 'Khronos Group', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKhronosgroup as default, defaultColor };
