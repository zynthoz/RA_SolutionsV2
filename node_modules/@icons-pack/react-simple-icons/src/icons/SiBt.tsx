    ...
    type SiBtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBt: IconType = React.forwardRef<SVGSVGElement, SiBtProps>(function SiBt({title = 'BT', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBt as default, defaultColor };
