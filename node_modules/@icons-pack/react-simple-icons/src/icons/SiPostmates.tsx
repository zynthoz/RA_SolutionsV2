    ...
    type SiPostmatesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFDF18';

    const SiPostmates: IconType = React.forwardRef<SVGSVGElement, SiPostmatesProps>(function SiPostmates({title = 'Postmates', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPostmates as default, defaultColor };
