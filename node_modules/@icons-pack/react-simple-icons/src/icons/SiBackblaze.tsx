    ...
    type SiBackblazeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBackblaze: IconType = React.forwardRef<SVGSVGElement, SiBackblazeProps>(function SiBackblaze({title = 'Backblaze', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
