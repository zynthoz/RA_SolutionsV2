    ...
    type SiRobotframeworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRobotframework: IconType = React.forwardRef<SVGSVGElement, SiRobotframeworkProps>(function SiRobotframework({title = 'Robot Framework', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRobotframework as default, defaultColor };
