    ...
    type SiGhostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGhost: IconType = React.forwardRef<SVGSVGElement, SiGhostProps>(function SiGhost({title = 'Ghost', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGhost as default, defaultColor };
