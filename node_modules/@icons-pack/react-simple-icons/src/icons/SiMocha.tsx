    ...
    type SiMochaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMocha: IconType = React.forwardRef<SVGSVGElement, SiMochaProps>(function SiMocha({title = 'Mocha', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
