    ...
    type SiRunrundotitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#DB3729';

    const SiRunrundotit: IconType = React.forwardRef<SVGSVGElement, SiRunrundotitProps>(function SiRunrundotit({title = 'Runrun.it', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRunrundotit as default, defaultColor };
