    ...
    type SiFanfouProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFanfou: IconType = React.forwardRef<SVGSVGElement, SiFanfouProps>(function SiFanfou({title = 'Fanfou', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
