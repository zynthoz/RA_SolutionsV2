    ...
    type SiNationalgridProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00148C';

    const SiNationalgrid: IconType = React.forwardRef<SVGSVGElement, SiNationalgridProps>(function SiNationalgrid({title = 'National Grid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNationalgrid as default, defaultColor };
