    ...
    type SiChatbotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChatbot: IconType = React.forwardRef<SVGSVGElement, SiChatbotProps>(function SiChatbot({title = 'ChatBot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
