    ...
    type SiRancherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRancher: IconType = React.forwardRef<SVGSVGElement, SiRancherProps>(function SiRancher({title = 'Rancher', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
