    ...
    type SiTheirishtimesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTheirishtimes: IconType = React.forwardRef<SVGSVGElement, SiTheirishtimesProps>(function SiTheirishtimes({title = 'The Irish Times', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
