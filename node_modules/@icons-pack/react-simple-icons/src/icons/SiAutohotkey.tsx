    ...
    type SiAutohotkeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#334455';

    const SiAutohotkey: IconType = React.forwardRef<SVGSVGElement, SiAutohotkeyProps>(function SiAutohotkey({title = 'AutoHotkey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAutohotkey as default, defaultColor };
