    ...
    type SiChryslerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChrysler: IconType = React.forwardRef<SVGSVGElement, SiChryslerProps>(function SiChrysler({title = 'Chrysler', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChrysler as default, defaultColor };
