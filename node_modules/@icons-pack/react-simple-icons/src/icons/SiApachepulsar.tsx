    ...
    type SiApachepulsarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachepulsar: IconType = React.forwardRef<SVGSVGElement, SiApachepulsarProps>(function SiApachepulsar({title = 'Apache Pulsar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachepulsar as default, defaultColor };
