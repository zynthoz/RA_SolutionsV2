    ...
    type SiApacheantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#A81C7D';

    const SiApacheant: IconType = React.forwardRef<SVGSVGElement, SiApacheantProps>(function SiApacheant({title = 'Apache Ant', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
