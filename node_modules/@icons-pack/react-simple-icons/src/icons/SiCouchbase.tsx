    ...
    type SiCouchbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCouchbase: IconType = React.forwardRef<SVGSVGElement, SiCouchbaseProps>(function SiCouchbase({title = 'Couchbase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCouchbase as default, defaultColor };
