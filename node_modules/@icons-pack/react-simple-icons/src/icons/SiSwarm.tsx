    ...
    type SiSwarmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSwarm: IconType = React.forwardRef<SVGSVGElement, SiSwarmProps>(function SiSwarm({title = 'Swarm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSwarm as default, defaultColor };
