    ...
    type SiMakerbotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF1E0D';

    const SiMakerbot: IconType = React.forwardRef<SVGSVGElement, SiMakerbotProps>(function SiMakerbot({title = 'MakerBot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMakerbot as default, defaultColor };
