    ...
    type SiKeepachangelogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E05735';

    const SiKeepachangelog: IconType = React.forwardRef<SVGSVGElement, SiKeepachangelogProps>(function SiKeepachangelog({title = 'Keep a Changelog', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKeepachangelog as default, defaultColor };
