    ...
    type SiTablecheckProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7935D2';

    const SiTablecheck: IconType = React.forwardRef<SVGSVGElement, SiTablecheckProps>(function SiTablecheck({title = 'TableCheck', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTablecheck as default, defaultColor };
