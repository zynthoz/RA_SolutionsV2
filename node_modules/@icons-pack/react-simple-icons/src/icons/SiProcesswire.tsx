    ...
    type SiProcesswireProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProcesswire: IconType = React.forwardRef<SVGSVGElement, SiProcesswireProps>(function SiProcesswire({title = 'ProcessWire', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiProcesswire as default, defaultColor };
