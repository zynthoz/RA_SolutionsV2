    ...
    type SiClarivateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiClarivate: IconType = React.forwardRef<SVGSVGElement, SiClarivateProps>(function SiClarivate({title = 'Clarivate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiClarivate as default, defaultColor };
