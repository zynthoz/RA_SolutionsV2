    ...
    type SiPostcssProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPostcss: IconType = React.forwardRef<SVGSVGElement, SiPostcssProps>(function SiPostcss({title = 'PostCSS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPostcss as default, defaultColor };
