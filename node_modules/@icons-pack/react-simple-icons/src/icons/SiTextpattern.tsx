    ...
    type SiTextpatternProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFDA44';

    const SiTextpattern: IconType = React.forwardRef<SVGSVGElement, SiTextpatternProps>(function SiTextpattern({title = 'Textpattern', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTextpattern as default, defaultColor };
