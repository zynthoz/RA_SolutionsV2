    ...
    type SiFreenasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFreenas: IconType = React.forwardRef<SVGSVGElement, SiFreenasProps>(function SiFreenas({title = 'FreeNAS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFreenas as default, defaultColor };
