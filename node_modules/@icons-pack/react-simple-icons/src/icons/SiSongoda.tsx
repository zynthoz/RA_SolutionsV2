    ...
    type SiSongodaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSongoda: IconType = React.forwardRef<SVGSVGElement, SiSongodaProps>(function SiSongoda({title = 'Songoda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
