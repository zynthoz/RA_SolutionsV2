    ...
    type SiGeeksforgeeksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGeeksforgeeks: IconType = React.forwardRef<SVGSVGElement, SiGeeksforgeeksProps>(function SiGeeksforgeeks({title = 'GeeksforGeeks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
