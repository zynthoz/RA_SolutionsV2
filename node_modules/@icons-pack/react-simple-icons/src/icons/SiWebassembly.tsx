    ...
    type SiWebassemblyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#654FF0';

    const SiWebassembly: IconType = React.forwardRef<SVGSVGElement, SiWebassemblyProps>(function SiWebassembly({title = 'WebAssembly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebassembly as default, defaultColor };
