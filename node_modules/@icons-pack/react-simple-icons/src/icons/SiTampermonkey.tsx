    ...
    type SiTampermonkeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTampermonkey: IconType = React.forwardRef<SVGSVGElement, SiTampermonkeyProps>(function SiTampermonkey({title = 'Tampermonkey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
