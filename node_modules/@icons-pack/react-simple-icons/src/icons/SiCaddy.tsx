    ...
    type SiCaddyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaddy: IconType = React.forwardRef<SVGSVGElement, SiCaddyProps>(function SiCaddy({title = 'Caddy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCaddy as default, defaultColor };
