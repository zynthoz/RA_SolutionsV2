    ...
    type SiWistiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWistia: IconType = React.forwardRef<SVGSVGElement, SiWistiaProps>(function SiWistia({title = 'Wistia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
