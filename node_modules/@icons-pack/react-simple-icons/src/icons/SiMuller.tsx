    ...
    type SiMullerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMuller: IconType = React.forwardRef<SVGSVGElement, SiMullerProps>(function SiMuller({title = 'Müller', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMuller as default, defaultColor };
