    ...
    type SiLiberadotchatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF55DD';

    const SiLiberadotchat: IconType = React.forwardRef<SVGSVGElement, SiLiberadotchatProps>(function SiLiberadotchat({title = 'Libera.Chat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLiberadotchat as default, defaultColor };
