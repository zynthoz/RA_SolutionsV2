    ...
    type SiRayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#028CF0';

    const SiRay: IconType = React.forwardRef<SVGSVGElement, SiRayProps>(function SiRay({title = 'Ray', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRay as default, defaultColor };
