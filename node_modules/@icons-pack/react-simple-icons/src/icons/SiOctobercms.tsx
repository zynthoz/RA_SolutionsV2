    ...
    type SiOctobercmsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#DB6A26';

    const SiOctobercms: IconType = React.forwardRef<SVGSVGElement, SiOctobercmsProps>(function SiOctobercms({title = 'October CMS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOctobercms as default, defaultColor };
