    ...
    type SiLinkfireProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLinkfire: IconType = React.forwardRef<SVGSVGElement, SiLinkfireProps>(function SiLinkfire({title = 'Linkfire', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
