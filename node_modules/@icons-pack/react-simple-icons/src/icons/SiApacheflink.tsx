    ...
    type SiApacheflinkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E6526F';

    const SiApacheflink: IconType = React.forwardRef<SVGSVGElement, SiApacheflinkProps>(function SiApacheflink({title = 'Apache Flink', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
