    ...
    type SiGoogleearthengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleearthengine: IconType = React.forwardRef<SVGSVGElement, SiGoogleearthengineProps>(function SiGoogleearthengine({title = 'Google Earth Engine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogleearthengine as default, defaultColor };
