    ...
    type SiBreakerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#003DAD';

    const SiBreaker: IconType = React.forwardRef<SVGSVGElement, SiBreakerProps>(function SiBreaker({title = 'Breaker', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBreaker as default, defaultColor };
