    ...
    type SiEdotleclercProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEdotleclerc: IconType = React.forwardRef<SVGSVGElement, SiEdotleclercProps>(function SiEdotleclerc({title = 'E.Leclerc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
