    ...
    type SiCcleanerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCcleaner: IconType = React.forwardRef<SVGSVGElement, SiCcleanerProps>(function SiCcleaner({title = 'CCleaner', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCcleaner as default, defaultColor };
