    ...
    type SiQuarkusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4695EB';

    const SiQuarkus: IconType = React.forwardRef<SVGSVGElement, SiQuarkusProps>(function SiQuarkus({title = 'Quarkus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
