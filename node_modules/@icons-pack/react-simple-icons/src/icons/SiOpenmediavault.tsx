    ...
    type SiOpenmediavaultProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenmediavault: IconType = React.forwardRef<SVGSVGElement, SiOpenmediavaultProps>(function SiOpenmediavault({title = 'openmediavault', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
