    ...
    type SiDependabotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDependabot: IconType = React.forwardRef<SVGSVGElement, SiDependabotProps>(function SiDependabot({title = 'Dependabot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDependabot as default, defaultColor };
