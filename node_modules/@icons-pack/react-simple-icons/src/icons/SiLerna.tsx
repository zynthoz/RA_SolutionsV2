    ...
    type SiLernaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLerna: IconType = React.forwardRef<SVGSVGElement, SiLernaProps>(function SiLerna({title = 'Lerna', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLerna as default, defaultColor };
