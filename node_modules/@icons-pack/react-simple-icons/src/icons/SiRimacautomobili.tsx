    ...
    type SiRimacautomobiliProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRimacautomobili: IconType = React.forwardRef<SVGSVGElement, SiRimacautomobiliProps>(function SiRimacautomobili({title = 'Rimac Automobili', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
