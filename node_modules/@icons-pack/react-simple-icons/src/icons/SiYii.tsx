    ...
    type SiYiiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#40B3D8';

    const SiYii: IconType = React.forwardRef<SVGSVGElement, SiYiiProps>(function SiYii({title = 'Yii', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
