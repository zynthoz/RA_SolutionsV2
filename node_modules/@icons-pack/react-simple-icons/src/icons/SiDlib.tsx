    ...
    type SiDlibProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDlib: IconType = React.forwardRef<SVGSVGElement, SiDlibProps>(function SiDlib({title = 'Dlib', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDlib as default, defaultColor };
