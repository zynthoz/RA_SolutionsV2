    ...
    type SiArcgisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArcgis: IconType = React.forwardRef<SVGSVGElement, SiArcgisProps>(function SiArcgis({title = 'ArcGIS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArcgis as default, defaultColor };
