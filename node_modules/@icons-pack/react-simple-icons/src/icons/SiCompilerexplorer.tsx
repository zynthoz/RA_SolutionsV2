    ...
    type SiCompilerexplorerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCompilerexplorer: IconType = React.forwardRef<SVGSVGElement, SiCompilerexplorerProps>(function SiCompilerexplorer({title = 'Compiler Explorer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
