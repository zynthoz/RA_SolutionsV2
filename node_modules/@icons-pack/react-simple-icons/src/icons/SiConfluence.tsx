    ...
    type SiConfluenceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConfluence: IconType = React.forwardRef<SVGSVGElement, SiConfluenceProps>(function SiConfluence({title = 'Confluence', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiConfluence as default, defaultColor };
