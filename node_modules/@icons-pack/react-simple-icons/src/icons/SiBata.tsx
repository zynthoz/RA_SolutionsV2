    ...
    type SiBataProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBata: IconType = React.forwardRef<SVGSVGElement, SiBataProps>(function SiBata({title = 'Bata', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
