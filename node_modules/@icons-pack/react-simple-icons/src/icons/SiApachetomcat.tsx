    ...
    type SiApachetomcatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachetomcat: IconType = React.forwardRef<SVGSVGElement, SiApachetomcatProps>(function SiApachetomcat({title = 'Apache Tomcat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
