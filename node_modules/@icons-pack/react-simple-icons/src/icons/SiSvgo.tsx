    ...
    type SiSvgoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSvgo: IconType = React.forwardRef<SVGSVGElement, SiSvgoProps>(function SiSvgo({title = 'SVGO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
