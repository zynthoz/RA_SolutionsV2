    ...
    type SiLibretubeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLibretube: IconType = React.forwardRef<SVGSVGElement, SiLibretubeProps>(function SiLibretube({title = 'LibreTube', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
