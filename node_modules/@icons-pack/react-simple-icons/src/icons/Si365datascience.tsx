    ...
    type Si365datascienceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si365datascience: IconType = React.forwardRef<SVGSVGElement, Si365datascienceProps>(function Si365datascience({title = '365 Data Science', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
