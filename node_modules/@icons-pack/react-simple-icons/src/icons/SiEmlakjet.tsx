    ...
    type SiEmlakjetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEmlakjet: IconType = React.forwardRef<SVGSVGElement, SiEmlakjetProps>(function SiEmlakjet({title = 'Emlakjet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEmlakjet as default, defaultColor };
