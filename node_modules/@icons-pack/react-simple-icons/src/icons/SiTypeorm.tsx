    ...
    type SiTypeormProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTypeorm: IconType = React.forwardRef<SVGSVGElement, SiTypeormProps>(function SiTypeorm({title = 'TypeORM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
