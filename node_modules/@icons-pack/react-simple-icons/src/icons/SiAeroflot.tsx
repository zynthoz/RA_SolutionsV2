    ...
    type SiAeroflotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAeroflot: IconType = React.forwardRef<SVGSVGElement, SiAeroflotProps>(function SiAeroflot({title = 'Aeroflot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAeroflot as default, defaultColor };
