    ...
    type SiMuoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMuo: IconType = React.forwardRef<SVGSVGElement, SiMuoProps>(function SiMuo({title = 'MUO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
