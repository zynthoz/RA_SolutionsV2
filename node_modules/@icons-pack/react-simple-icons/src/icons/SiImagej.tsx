    ...
    type SiImagejProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImagej: IconType = React.forwardRef<SVGSVGElement, SiImagejProps>(function SiImagej({title = 'ImageJ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
