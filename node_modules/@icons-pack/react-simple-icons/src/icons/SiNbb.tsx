    ...
    type SiNbbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNbb: IconType = React.forwardRef<SVGSVGElement, SiNbbProps>(function SiNbb({title = 'NBB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
