    ...
    type SiMetroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMetro: IconType = React.forwardRef<SVGSVGElement, SiMetroProps>(function SiMetro({title = 'Metro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
