    ...
    type SiApacherocketmqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApacherocketmq: IconType = React.forwardRef<SVGSVGElement, SiApacherocketmqProps>(function SiApacherocketmq({title = 'Apache RocketMQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApacherocketmq as default, defaultColor };
