    ...
    type SiPycharmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPycharm: IconType = React.forwardRef<SVGSVGElement, SiPycharmProps>(function SiPycharm({title = 'PyCharm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
