    ...
    type SiSogouProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSogou: IconType = React.forwardRef<SVGSVGElement, SiSogouProps>(function SiSogou({title = 'Sogou', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
