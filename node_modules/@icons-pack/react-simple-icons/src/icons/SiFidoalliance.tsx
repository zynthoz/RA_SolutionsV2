    ...
    type SiFidoallianceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFidoalliance: IconType = React.forwardRef<SVGSVGElement, SiFidoallianceProps>(function SiFidoalliance({title = 'Fido Alliance', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFidoalliance as default, defaultColor };
