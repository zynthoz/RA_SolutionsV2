    ...
    type SiBitcoinsvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBitcoinsv: IconType = React.forwardRef<SVGSVGElement, SiBitcoinsvProps>(function SiBitcoinsv({title = 'Bitcoin SV', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
