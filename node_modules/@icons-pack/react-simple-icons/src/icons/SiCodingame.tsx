    ...
    type SiCodingameProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F2BB13';

    const SiCodingame: IconType = React.forwardRef<SVGSVGElement, SiCodingameProps>(function SiCodingame({title = 'CodinGame', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodingame as default, defaultColor };
