    ...
    type SiEgnyteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00968F';

    const SiEgnyte: IconType = React.forwardRef<SVGSVGElement, SiEgnyteProps>(function SiEgnyte({title = 'Egnyte', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEgnyte as default, defaultColor };
