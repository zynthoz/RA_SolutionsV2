    ...
    type SiRyanairProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#073590';

    const SiRyanair: IconType = React.forwardRef<SVGSVGElement, SiRyanairProps>(function SiRyanair({title = 'Ryanair', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRyanair as default, defaultColor };
