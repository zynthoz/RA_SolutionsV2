    ...
    type SiRescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E6484F';

    const SiRescript: IconType = React.forwardRef<SVGSVGElement, SiRescriptProps>(function SiRescript({title = 'ReScript', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRescript as default, defaultColor };
