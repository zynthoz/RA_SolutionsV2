    ...
    type SiVirginProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E10A0A';

    const SiVirgin: IconType = React.forwardRef<SVGSVGElement, SiVirginProps>(function SiVirgin({title = 'Virgin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
