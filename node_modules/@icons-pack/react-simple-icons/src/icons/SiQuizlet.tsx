    ...
    type SiQuizletProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQuizlet: IconType = React.forwardRef<SVGSVGElement, SiQuizletProps>(function SiQuizlet({title = 'Quizlet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
