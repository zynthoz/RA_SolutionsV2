    ...
    type SiMattermostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMattermost: IconType = React.forwardRef<SVGSVGElement, SiMattermostProps>(function SiMattermost({title = 'Mattermost', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
