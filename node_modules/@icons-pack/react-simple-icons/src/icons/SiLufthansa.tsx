    ...
    type SiLufthansaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLufthansa: IconType = React.forwardRef<SVGSVGElement, SiLufthansaProps>(function SiLufthansa({title = 'Lufthansa', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLufthansa as default, defaultColor };
