    ...
    type SiTorprojectProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTorproject: IconType = React.forwardRef<SVGSVGElement, SiTorprojectProps>(function SiTorproject({title = 'Tor Project', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
