    ...
    type SiVowpalwabbitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF81F9';

    const SiVowpalwabbit: IconType = React.forwardRef<SVGSVGElement, SiVowpalwabbitProps>(function SiVowpalwabbit({title = 'Vowpal Wabbit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
