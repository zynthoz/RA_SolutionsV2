    ...
    type SiDiasporaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDiaspora: IconType = React.forwardRef<SVGSVGElement, SiDiasporaProps>(function SiDiaspora({title = 'Diaspora', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
