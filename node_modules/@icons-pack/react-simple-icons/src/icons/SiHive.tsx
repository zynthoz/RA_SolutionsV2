    ...
    type SiHiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF7A00';

    const SiHive: IconType = React.forwardRef<SVGSVGElement, SiHiveProps>(function SiHive({title = 'Hive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHive as default, defaultColor };
