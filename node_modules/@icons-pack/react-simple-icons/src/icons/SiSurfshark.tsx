    ...
    type SiSurfsharkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1EBFBF';

    const SiSurfshark: IconType = React.forwardRef<SVGSVGElement, SiSurfsharkProps>(function SiSurfshark({title = 'Surfshark', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSurfshark as default, defaultColor };
