    ...
    type SiRailwayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRailway: IconType = React.forwardRef<SVGSVGElement, SiRailwayProps>(function SiRailway({title = 'Railway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
