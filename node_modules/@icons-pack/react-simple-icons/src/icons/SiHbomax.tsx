    ...
    type SiHbomaxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHbomax: IconType = React.forwardRef<SVGSVGElement, SiHbomaxProps>(function SiHbomax({title = 'HBO Max', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHbomax as default, defaultColor };
