    ...
    type SiInfracostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfracost: IconType = React.forwardRef<SVGSVGElement, SiInfracostProps>(function SiInfracost({title = 'Infracost', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
