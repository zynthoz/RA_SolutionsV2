    ...
    type SiYoloProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYolo: IconType = React.forwardRef<SVGSVGElement, SiYoloProps>(function SiYolo({title = 'YOLO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYolo as default, defaultColor };
