    ...
    type SiTravisciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTravisci: IconType = React.forwardRef<SVGSVGElement, SiTravisciProps>(function SiTravisci({title = 'Travis CI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
