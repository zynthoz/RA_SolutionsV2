    ...
    type SiAudiomackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAudiomack: IconType = React.forwardRef<SVGSVGElement, SiAudiomackProps>(function SiAudiomack({title = 'Audiomack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAudiomack as default, defaultColor };
