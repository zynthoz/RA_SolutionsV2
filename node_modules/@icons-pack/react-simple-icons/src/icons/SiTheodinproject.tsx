    ...
    type SiTheodinprojectProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#A9792B';

    const SiTheodinproject: IconType = React.forwardRef<SVGSVGElement, SiTheodinprojectProps>(function SiTheodinproject({title = 'The Odin Project', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
