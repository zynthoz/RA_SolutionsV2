    ...
    type SiIonosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIonos: IconType = React.forwardRef<SVGSVGElement, SiIonosProps>(function SiIonos({title = 'Ionos', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIonos as default, defaultColor };
