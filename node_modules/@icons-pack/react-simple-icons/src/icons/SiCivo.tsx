    ...
    type SiCivoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#239DFF';

    const SiCivo: IconType = React.forwardRef<SVGSVGElement, SiCivoProps>(function SiCivo({title = 'Civo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCivo as default, defaultColor };
