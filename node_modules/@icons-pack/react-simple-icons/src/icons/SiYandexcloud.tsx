    ...
    type SiYandexcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYandexcloud: IconType = React.forwardRef<SVGSVGElement, SiYandexcloudProps>(function SiYandexcloud({title = 'Yandex Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
