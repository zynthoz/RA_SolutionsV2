    ...
    type SiSepaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2350A9';

    const SiSepa: IconType = React.forwardRef<SVGSVGElement, SiSepaProps>(function SiSepa({title = 'SEPA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSepa as default, defaultColor };
