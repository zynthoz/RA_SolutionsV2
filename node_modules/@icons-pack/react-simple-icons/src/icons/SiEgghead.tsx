    ...
    type SiEggheadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FCFBFA';

    const SiEgghead: IconType = React.forwardRef<SVGSVGElement, SiEggheadProps>(function SiEgghead({title = 'egghead', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEgghead as default, defaultColor };
