    ...
    type SiPleskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#52BBE6';

    const SiPlesk: IconType = React.forwardRef<SVGSVGElement, SiPleskProps>(function SiPlesk({title = 'Plesk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlesk as default, defaultColor };
