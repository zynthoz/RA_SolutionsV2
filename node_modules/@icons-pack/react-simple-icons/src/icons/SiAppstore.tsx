    ...
    type SiAppstoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAppstore: IconType = React.forwardRef<SVGSVGElement, SiAppstoreProps>(function SiAppstore({title = 'App Store', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppstore as default, defaultColor };
