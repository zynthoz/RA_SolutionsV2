    ...
    type SiGeneralmotorsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0170CE';

    const SiGeneralmotors: IconType = React.forwardRef<SVGSVGElement, SiGeneralmotorsProps>(function SiGeneralmotors({title = 'General Motors', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGeneralmotors as default, defaultColor };
