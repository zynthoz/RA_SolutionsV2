    ...
    type SiPoposProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#48B9C7';

    const SiPopos: IconType = React.forwardRef<SVGSVGElement, SiPoposProps>(function SiPopos({title = 'Pop!_OS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPopos as default, defaultColor };
