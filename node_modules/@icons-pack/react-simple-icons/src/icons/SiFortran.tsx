    ...
    type SiFortranProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#734F96';

    const SiFortran: IconType = React.forwardRef<SVGSVGElement, SiFortranProps>(function SiFortran({title = 'Fortran', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFortran as default, defaultColor };
