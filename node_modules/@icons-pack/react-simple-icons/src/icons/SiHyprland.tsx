    ...
    type SiHyprlandProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#58E1FF';

    const SiHyprland: IconType = React.forwardRef<SVGSVGElement, SiHyprlandProps>(function SiHyprland({title = 'Hyprland', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHyprland as default, defaultColor };
