    ...
    type SiScaniaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScania: IconType = React.forwardRef<SVGSVGElement, SiScaniaProps>(function SiScania({title = 'Scania', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
