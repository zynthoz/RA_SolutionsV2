    ...
    type SiCpanelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCpanel: IconType = React.forwardRef<SVGSVGElement, SiCpanelProps>(function SiCpanel({title = 'cPanel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCpanel as default, defaultColor };
