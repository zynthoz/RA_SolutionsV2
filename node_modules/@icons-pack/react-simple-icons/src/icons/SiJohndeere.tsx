    ...
    type SiJohndeereProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#367C2B';

    const SiJohndeere: IconType = React.forwardRef<SVGSVGElement, SiJohndeereProps>(function SiJohndeere({title = 'John Deere', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJohndeere as default, defaultColor };
