    ...
    type SiBentleyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBentley: IconType = React.forwardRef<SVGSVGElement, SiBentleyProps>(function SiBentley({title = 'Bentley', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBentley as default, defaultColor };
