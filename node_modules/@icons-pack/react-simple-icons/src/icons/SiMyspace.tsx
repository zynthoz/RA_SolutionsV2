    ...
    type SiMyspaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMyspace: IconType = React.forwardRef<SVGSVGElement, SiMyspaceProps>(function SiMyspace({title = 'Myspace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMyspace as default, defaultColor };
