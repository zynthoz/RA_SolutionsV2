    ...
    type SiPm2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPm2: IconType = React.forwardRef<SVGSVGElement, SiPm2Props>(function SiPm2({title = 'PM2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
