    ...
    type SiLabviewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLabview: IconType = React.forwardRef<SVGSVGElement, SiLabviewProps>(function SiLabview({title = 'LabVIEW', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLabview as default, defaultColor };
