    ...
    type SiYoutubetvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYoutubetv: IconType = React.forwardRef<SVGSVGElement, SiYoutubetvProps>(function SiYoutubetv({title = 'YouTube TV', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYoutubetv as default, defaultColor };
