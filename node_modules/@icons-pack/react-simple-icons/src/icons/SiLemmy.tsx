    ...
    type SiLemmyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLemmy: IconType = React.forwardRef<SVGSVGElement, SiLemmyProps>(function SiLemmy({title = 'Lemmy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
