    ...
    type SiOpenfaasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3B5EE9';

    const SiOpenfaas: IconType = React.forwardRef<SVGSVGElement, SiOpenfaasProps>(function SiOpenfaas({title = 'OpenFaaS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpenfaas as default, defaultColor };
