    ...
    type SiWegameProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWegame: IconType = React.forwardRef<SVGSVGElement, SiWegameProps>(function SiWegame({title = 'WeGame', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWegame as default, defaultColor };
