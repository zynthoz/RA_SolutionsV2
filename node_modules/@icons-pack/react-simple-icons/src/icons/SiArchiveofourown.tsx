    ...
    type SiArchiveofourownProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArchiveofourown: IconType = React.forwardRef<SVGSVGElement, SiArchiveofourownProps>(function SiArchiveofourown({title = 'Archive of Our Own', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArchiveofourown as default, defaultColor };
