    ...
    type SiOpentextProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpentext: IconType = React.forwardRef<SVGSVGElement, SiOpentextProps>(function SiOpentext({title = 'OpenText', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpentext as default, defaultColor };
