    ...
    type SiGooglecampaignmanager360Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglecampaignmanager360: IconType = React.forwardRef<SVGSVGElement, SiGooglecampaignmanager360Props>(function SiGooglecampaignmanager360({title = 'Google Campaign Manager 360', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
