    ...
    type SiTestinglibraryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTestinglibrary: IconType = React.forwardRef<SVGSVGElement, SiTestinglibraryProps>(function SiTestinglibrary({title = 'Testing Library', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
