    ...
    type SiApacheopenofficeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0E85CD';

    const SiApacheopenoffice: IconType = React.forwardRef<SVGSVGElement, SiApacheopenofficeProps>(function SiApacheopenoffice({title = 'Apache OpenOffice', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApacheopenoffice as default, defaultColor };
