    ...
    type SiVimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVim: IconType = React.forwardRef<SVGSVGElement, SiVimProps>(function SiVim({title = 'Vim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVim as default, defaultColor };
