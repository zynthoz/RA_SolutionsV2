    ...
    type SiNettoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFE500';

    const SiNetto: IconType = React.forwardRef<SVGSVGElement, SiNettoProps>(function SiNetto({title = 'Netto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
