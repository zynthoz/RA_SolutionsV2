    ...
    type SiSetappProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSetapp: IconType = React.forwardRef<SVGSVGElement, SiSetappProps>(function SiSetapp({title = 'Setapp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
