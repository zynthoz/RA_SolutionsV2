    ...
    type SiAmgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmg: IconType = React.forwardRef<SVGSVGElement, SiAmgProps>(function SiAmg({title = 'AMG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
