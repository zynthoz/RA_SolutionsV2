    ...
    type SiSnykProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSnyk: IconType = React.forwardRef<SVGSVGElement, SiSnykProps>(function SiSnyk({title = 'Snyk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSnyk as default, defaultColor };
