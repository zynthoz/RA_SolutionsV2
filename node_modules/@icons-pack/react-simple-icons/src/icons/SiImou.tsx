    ...
    type SiImouProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImou: IconType = React.forwardRef<SVGSVGElement, SiImouProps>(function SiImou({title = 'Imou', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
