    ...
    type SiGolandProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoland: IconType = React.forwardRef<SVGSVGElement, SiGolandProps>(function SiGoland({title = 'GoLand', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
