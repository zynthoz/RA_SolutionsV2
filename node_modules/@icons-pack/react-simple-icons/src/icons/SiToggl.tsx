    ...
    type SiTogglProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFDE91';

    const SiToggl: IconType = React.forwardRef<SVGSVGElement, SiTogglProps>(function SiToggl({title = 'Toggl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiToggl as default, defaultColor };
