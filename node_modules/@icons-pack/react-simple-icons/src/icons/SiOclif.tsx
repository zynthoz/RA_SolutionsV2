    ...
    type SiOclifProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOclif: IconType = React.forwardRef<SVGSVGElement, SiOclifProps>(function SiOclif({title = 'oclif', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
