    ...
    type SiAdpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdp: IconType = React.forwardRef<SVGSVGElement, SiAdpProps>(function SiAdp({title = 'ADP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdp as default, defaultColor };
