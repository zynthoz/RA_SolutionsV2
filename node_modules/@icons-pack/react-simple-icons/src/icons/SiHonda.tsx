    ...
    type SiHondaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E40521';

    const SiHonda: IconType = React.forwardRef<SVGSVGElement, SiHondaProps>(function SiHonda({title = 'Honda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHonda as default, defaultColor };
