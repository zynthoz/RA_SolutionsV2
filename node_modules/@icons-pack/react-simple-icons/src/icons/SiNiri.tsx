    ...
    type SiNiriProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D55C44';

    const SiNiri: IconType = React.forwardRef<SVGSVGElement, SiNiriProps>(function SiNiri({title = 'niri', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
