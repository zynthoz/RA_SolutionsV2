    ...
    type Si500pxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si500px: IconType = React.forwardRef<SVGSVGElement, Si500pxProps>(function Si500px({title = '500px', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
