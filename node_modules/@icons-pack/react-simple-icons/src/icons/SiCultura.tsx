    ...
    type SiCulturaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCultura: IconType = React.forwardRef<SVGSVGElement, SiCulturaProps>(function SiCultura({title = 'Cultura', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCultura as default, defaultColor };
