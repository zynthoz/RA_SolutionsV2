    ...
    type SiReactivexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReactivex: IconType = React.forwardRef<SVGSVGElement, SiReactivexProps>(function SiReactivex({title = 'ReactiveX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiReactivex as default, defaultColor };
