    ...
    type SiDungeonsanddragonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDungeonsanddragons: IconType = React.forwardRef<SVGSVGElement, SiDungeonsanddragonsProps>(function SiDungeonsanddragons({title = 'Dungeons & Dragons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
