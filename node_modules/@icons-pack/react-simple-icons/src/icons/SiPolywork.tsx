    ...
    type SiPolyworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPolywork: IconType = React.forwardRef<SVGSVGElement, SiPolyworkProps>(function SiPolywork({title = 'Polywork', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
