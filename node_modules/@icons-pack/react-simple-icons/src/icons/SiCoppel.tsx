    ...
    type SiCoppelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoppel: IconType = React.forwardRef<SVGSVGElement, SiCoppelProps>(function SiCoppel({title = 'Coppel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoppel as default, defaultColor };
