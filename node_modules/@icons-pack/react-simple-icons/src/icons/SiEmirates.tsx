    ...
    type SiEmiratesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEmirates: IconType = React.forwardRef<SVGSVGElement, SiEmiratesProps>(function SiEmirates({title = 'Emirates', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEmirates as default, defaultColor };
