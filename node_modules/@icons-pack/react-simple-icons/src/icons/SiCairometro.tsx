    ...
    type SiCairometroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCairometro: IconType = React.forwardRef<SVGSVGElement, SiCairometroProps>(function SiCairometro({title = 'Cairo Metro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
