    ...
    type SiPlaystation5Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlaystation5: IconType = React.forwardRef<SVGSVGElement, SiPlaystation5Props>(function SiPlaystation5({title = 'PlayStation 5', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
