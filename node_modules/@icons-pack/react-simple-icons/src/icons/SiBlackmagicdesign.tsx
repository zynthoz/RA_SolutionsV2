    ...
    type SiBlackmagicdesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlackmagicdesign: IconType = React.forwardRef<SVGSVGElement, SiBlackmagicdesignProps>(function SiBlackmagicdesign({title = 'Blackmagic Design', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
