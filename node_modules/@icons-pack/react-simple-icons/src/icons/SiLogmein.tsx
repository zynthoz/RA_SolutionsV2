    ...
    type SiLogmeinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLogmein: IconType = React.forwardRef<SVGSVGElement, SiLogmeinProps>(function SiLogmein({title = 'LogMeIn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLogmein as default, defaultColor };
