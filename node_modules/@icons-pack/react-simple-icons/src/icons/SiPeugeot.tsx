    ...
    type SiPeugeotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPeugeot: IconType = React.forwardRef<SVGSVGElement, SiPeugeotProps>(function SiPeugeot({title = 'Peugeot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
