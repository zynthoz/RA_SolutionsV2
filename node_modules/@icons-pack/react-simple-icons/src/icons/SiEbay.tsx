    ...
    type SiEbayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEbay: IconType = React.forwardRef<SVGSVGElement, SiEbayProps>(function SiEbay({title = 'eBay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEbay as default, defaultColor };
