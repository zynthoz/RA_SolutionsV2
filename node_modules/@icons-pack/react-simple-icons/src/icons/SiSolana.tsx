    ...
    type SiSolanaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSolana: IconType = React.forwardRef<SVGSVGElement, SiSolanaProps>(function SiSolana({title = 'Solana', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
