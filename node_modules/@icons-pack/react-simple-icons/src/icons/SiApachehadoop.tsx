    ...
    type SiApachehadoopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachehadoop: IconType = React.forwardRef<SVGSVGElement, SiApachehadoopProps>(function SiApachehadoop({title = 'Apache Hadoop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachehadoop as default, defaultColor };
