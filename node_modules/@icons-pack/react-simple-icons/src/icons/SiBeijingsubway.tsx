    ...
    type SiBeijingsubwayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBeijingsubway: IconType = React.forwardRef<SVGSVGElement, SiBeijingsubwayProps>(function SiBeijingsubway({title = 'Beijing Subway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
