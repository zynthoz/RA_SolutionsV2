    ...
    type SiNextdoorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNextdoor: IconType = React.forwardRef<SVGSVGElement, SiNextdoorProps>(function SiNextdoor({title = 'Nextdoor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNextdoor as default, defaultColor };
