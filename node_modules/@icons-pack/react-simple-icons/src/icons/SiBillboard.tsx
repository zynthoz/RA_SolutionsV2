    ...
    type SiBillboardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBillboard: IconType = React.forwardRef<SVGSVGElement, SiBillboardProps>(function SiBillboard({title = 'Billboard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
