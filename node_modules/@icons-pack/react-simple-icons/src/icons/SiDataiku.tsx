    ...
    type SiDataikuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDataiku: IconType = React.forwardRef<SVGSVGElement, SiDataikuProps>(function SiDataiku({title = 'Dataiku', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
