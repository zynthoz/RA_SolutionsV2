    ...
    type SiBerealProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBereal: IconType = React.forwardRef<SVGSVGElement, SiBerealProps>(function SiBereal({title = 'BeReal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBereal as default, defaultColor };
