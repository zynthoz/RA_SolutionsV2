    ...
    type SiWetransferProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWetransfer: IconType = React.forwardRef<SVGSVGElement, SiWetransferProps>(function SiWetransfer({title = 'WeTransfer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
