    ...
    type SiUberProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUber: IconType = React.forwardRef<SVGSVGElement, SiUberProps>(function SiUber({title = 'Uber', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
