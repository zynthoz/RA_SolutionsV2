    ...
    type SiApacheluceneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachelucene: IconType = React.forwardRef<SVGSVGElement, SiApacheluceneProps>(function SiApachelucene({title = 'Apache Lucene', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
