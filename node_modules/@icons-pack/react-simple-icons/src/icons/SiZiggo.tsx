    ...
    type SiZiggoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F48C00';

    const SiZiggo: IconType = React.forwardRef<SVGSVGElement, SiZiggoProps>(function SiZiggo({title = 'Ziggo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZiggo as default, defaultColor };
