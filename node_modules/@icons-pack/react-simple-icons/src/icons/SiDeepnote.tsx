    ...
    type SiDeepnoteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeepnote: IconType = React.forwardRef<SVGSVGElement, SiDeepnoteProps>(function SiDeepnote({title = 'Deepnote', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
