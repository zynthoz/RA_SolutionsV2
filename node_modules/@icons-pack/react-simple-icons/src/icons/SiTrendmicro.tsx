    ...
    type SiTrendmicroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrendmicro: IconType = React.forwardRef<SVGSVGElement, SiTrendmicroProps>(function SiTrendmicro({title = 'Trend Micro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
