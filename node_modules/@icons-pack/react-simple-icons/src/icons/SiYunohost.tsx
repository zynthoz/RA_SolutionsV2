    ...
    type SiYunohostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYunohost: IconType = React.forwardRef<SVGSVGElement, SiYunohostProps>(function SiYunohost({title = 'YunoHost', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
