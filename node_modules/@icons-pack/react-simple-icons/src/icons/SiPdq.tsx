    ...
    type SiPdqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPdq: IconType = React.forwardRef<SVGSVGElement, SiPdqProps>(function SiPdq({title = 'PDQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPdq as default, defaultColor };
