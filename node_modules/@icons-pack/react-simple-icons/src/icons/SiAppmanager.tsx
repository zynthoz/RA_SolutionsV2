    ...
    type SiAppmanagerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#DCAF74';

    const SiAppmanager: IconType = React.forwardRef<SVGSVGElement, SiAppmanagerProps>(function SiAppmanager({title = 'AppManager', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppmanager as default, defaultColor };
