    ...
    type SiSoundchartsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0C1528';

    const SiSoundcharts: IconType = React.forwardRef<SVGSVGElement, SiSoundchartsProps>(function SiSoundcharts({title = 'Soundcharts', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSoundcharts as default, defaultColor };
