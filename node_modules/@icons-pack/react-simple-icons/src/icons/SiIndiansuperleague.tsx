    ...
    type SiIndiansuperleagueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED2F21';

    const SiIndiansuperleague: IconType = React.forwardRef<SVGSVGElement, SiIndiansuperleagueProps>(function SiIndiansuperleague({title = 'Indian Super League', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
