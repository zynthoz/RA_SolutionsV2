    ...
    type SiThestorygraphProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThestorygraph: IconType = React.forwardRef<SVGSVGElement, SiThestorygraphProps>(function SiThestorygraph({title = 'The StoryGraph', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
