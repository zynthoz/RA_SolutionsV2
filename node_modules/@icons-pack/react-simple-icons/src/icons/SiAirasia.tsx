    ...
    type SiAirasiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirasia: IconType = React.forwardRef<SVGSVGElement, SiAirasiaProps>(function SiAirasia({title = 'AirAsia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
