    ...
    type SiIgnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIgn: IconType = React.forwardRef<SVGSVGElement, SiIgnProps>(function SiIgn({title = 'IGN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
