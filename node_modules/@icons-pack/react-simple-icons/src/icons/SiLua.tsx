    ...
    type SiLuaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLua: IconType = React.forwardRef<SVGSVGElement, SiLuaProps>(function SiLua({title = 'Lua', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
