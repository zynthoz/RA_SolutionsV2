    ...
    type SiTiddlywikiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTiddlywiki: IconType = React.forwardRef<SVGSVGElement, SiTiddlywikiProps>(function SiTiddlywiki({title = 'TiddlyWiki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTiddlywiki as default, defaultColor };
