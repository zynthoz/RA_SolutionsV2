    ...
    type SiActixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiActix: IconType = React.forwardRef<SVGSVGElement, SiActixProps>(function SiActix({title = 'Actix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
