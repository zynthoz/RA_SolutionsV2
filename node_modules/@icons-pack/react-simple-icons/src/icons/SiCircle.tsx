    ...
    type SiCircleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCircle: IconType = React.forwardRef<SVGSVGElement, SiCircleProps>(function SiCircle({title = 'Circle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCircle as default, defaultColor };
