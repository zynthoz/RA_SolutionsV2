    ...
    type SiPhpstormProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhpstorm: IconType = React.forwardRef<SVGSVGElement, SiPhpstormProps>(function SiPhpstorm({title = 'PhpStorm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPhpstorm as default, defaultColor };
