    ...
    type SiSfmlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#8CC445';

    const SiSfml: IconType = React.forwardRef<SVGSVGElement, SiSfmlProps>(function SiSfml({title = 'SFML', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
