    ...
    type SiReduxsagaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReduxsaga: IconType = React.forwardRef<SVGSVGElement, SiReduxsagaProps>(function SiReduxsaga({title = 'Redux-Saga', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
