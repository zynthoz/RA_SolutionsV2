    ...
    type SiEsphomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEsphome: IconType = React.forwardRef<SVGSVGElement, SiEsphomeProps>(function SiEsphome({title = 'ESPHome', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEsphome as default, defaultColor };
