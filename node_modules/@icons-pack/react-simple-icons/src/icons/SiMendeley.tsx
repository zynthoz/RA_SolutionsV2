    ...
    type SiMendeleyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#9D1620';

    const SiMendeley: IconType = React.forwardRef<SVGSVGElement, SiMendeleyProps>(function SiMendeley({title = 'Mendeley', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMendeley as default, defaultColor };
