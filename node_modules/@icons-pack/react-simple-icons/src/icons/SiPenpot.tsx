    ...
    type SiPenpotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPenpot: IconType = React.forwardRef<SVGSVGElement, SiPenpotProps>(function SiPenpot({title = 'Penpot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPenpot as default, defaultColor };
