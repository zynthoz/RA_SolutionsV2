    ...
    type SiGodaddyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGodaddy: IconType = React.forwardRef<SVGSVGElement, SiGodaddyProps>(function SiGodaddy({title = 'GoDaddy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
