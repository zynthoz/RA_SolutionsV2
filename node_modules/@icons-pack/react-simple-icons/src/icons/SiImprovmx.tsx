    ...
    type SiImprovmxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImprovmx: IconType = React.forwardRef<SVGSVGElement, SiImprovmxProps>(function SiImprovmx({title = 'ImprovMX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiImprovmx as default, defaultColor };
