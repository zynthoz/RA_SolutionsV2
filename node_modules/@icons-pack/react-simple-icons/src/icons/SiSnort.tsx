    ...
    type SiSnortProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F6A7AA';

    const SiSnort: IconType = React.forwardRef<SVGSVGElement, SiSnortProps>(function SiSnort({title = 'Snort', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSnort as default, defaultColor };
