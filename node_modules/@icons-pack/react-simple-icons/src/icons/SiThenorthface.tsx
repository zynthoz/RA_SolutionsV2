    ...
    type SiThenorthfaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThenorthface: IconType = React.forwardRef<SVGSVGElement, SiThenorthfaceProps>(function SiThenorthface({title = 'The North Face', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
