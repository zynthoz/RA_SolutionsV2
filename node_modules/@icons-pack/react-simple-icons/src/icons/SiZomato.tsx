    ...
    type SiZomatoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZomato: IconType = React.forwardRef<SVGSVGElement, SiZomatoProps>(function SiZomato({title = 'Zomato', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZomato as default, defaultColor };
