    ...
    type SiEnpassProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEnpass: IconType = React.forwardRef<SVGSVGElement, SiEnpassProps>(function SiEnpass({title = 'Enpass', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
