    ...
    type SiCodecraftersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodecrafters: IconType = React.forwardRef<SVGSVGElement, SiCodecraftersProps>(function SiCodecrafters({title = 'CodeCrafters', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodecrafters as default, defaultColor };
