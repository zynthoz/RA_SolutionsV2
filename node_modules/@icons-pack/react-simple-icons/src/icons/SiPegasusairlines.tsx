    ...
    type SiPegasusairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FDC43E';

    const SiPegasusairlines: IconType = React.forwardRef<SVGSVGElement, SiPegasusairlinesProps>(function SiPegasusairlines({title = 'Pegasus Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
