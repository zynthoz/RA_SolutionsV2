    ...
    type SiApachenetbeansideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachenetbeanside: IconType = React.forwardRef<SVGSVGElement, SiApachenetbeansideProps>(function SiApachenetbeanside({title = 'Apache NetBeans IDE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
