    ...
    type SiEcovacsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEcovacs: IconType = React.forwardRef<SVGSVGElement, SiEcovacsProps>(function SiEcovacs({title = 'Ecovacs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
