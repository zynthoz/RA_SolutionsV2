    ...
    type SiEdgeimpulseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEdgeimpulse: IconType = React.forwardRef<SVGSVGElement, SiEdgeimpulseProps>(function SiEdgeimpulse({title = 'Edge Impulse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEdgeimpulse as default, defaultColor };
