    ...
    type SiZebpayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZebpay: IconType = React.forwardRef<SVGSVGElement, SiZebpayProps>(function SiZebpay({title = 'ZebPay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
