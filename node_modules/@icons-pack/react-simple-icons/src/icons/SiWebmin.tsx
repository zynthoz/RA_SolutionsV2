    ...
    type SiWebminProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7DA0D0';

    const SiWebmin: IconType = React.forwardRef<SVGSVGElement, SiWebminProps>(function SiWebmin({title = 'Webmin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
