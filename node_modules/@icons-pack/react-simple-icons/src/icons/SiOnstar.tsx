    ...
    type SiOnstarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#003D7D';

    const SiOnstar: IconType = React.forwardRef<SVGSVGElement, SiOnstarProps>(function SiOnstar({title = 'OnStar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
