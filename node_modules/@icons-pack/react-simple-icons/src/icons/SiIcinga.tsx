    ...
    type SiIcingaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIcinga: IconType = React.forwardRef<SVGSVGElement, SiIcingaProps>(function SiIcinga({title = 'Icinga', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
