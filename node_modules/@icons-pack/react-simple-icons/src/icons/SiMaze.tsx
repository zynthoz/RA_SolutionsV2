    ...
    type SiMazeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMaze: IconType = React.forwardRef<SVGSVGElement, SiMazeProps>(function SiMaze({title = 'Maze', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
