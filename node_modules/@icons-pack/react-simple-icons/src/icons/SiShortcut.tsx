    ...
    type SiShortcutProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#58B1E4';

    const SiShortcut: IconType = React.forwardRef<SVGSVGElement, SiShortcutProps>(function SiShortcut({title = 'Shortcut', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShortcut as default, defaultColor };
