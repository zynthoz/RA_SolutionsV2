    ...
    type SiRapidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRapid: IconType = React.forwardRef<SVGSVGElement, SiRapidProps>(function SiRapid({title = 'Rapid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
