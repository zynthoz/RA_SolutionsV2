    ...
    type SiSociety6Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSociety6: IconType = React.forwardRef<SVGSVGElement, SiSociety6Props>(function SiSociety6({title = 'Society6', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSociety6 as default, defaultColor };
