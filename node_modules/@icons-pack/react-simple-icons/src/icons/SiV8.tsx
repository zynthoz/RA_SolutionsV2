    ...
    type SiV8Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4B8BF5';

    const SiV8: IconType = React.forwardRef<SVGSVGElement, SiV8Props>(function SiV8({title = 'V8', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiV8 as default, defaultColor };
