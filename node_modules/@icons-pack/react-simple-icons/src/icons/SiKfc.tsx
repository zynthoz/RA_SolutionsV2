    ...
    type SiKfcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKfc: IconType = React.forwardRef<SVGSVGElement, SiKfcProps>(function SiKfc({title = 'KFC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
