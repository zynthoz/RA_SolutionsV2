    ...
    type SiGustoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGusto: IconType = React.forwardRef<SVGSVGElement, SiGustoProps>(function SiGusto({title = 'Gusto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
