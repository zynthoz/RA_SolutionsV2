    ...
    type SiFnacProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFnac: IconType = React.forwardRef<SVGSVGElement, SiFnacProps>(function SiFnac({title = 'Fnac', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFnac as default, defaultColor };
