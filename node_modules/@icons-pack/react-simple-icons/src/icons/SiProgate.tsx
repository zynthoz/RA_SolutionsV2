    ...
    type SiProgateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProgate: IconType = React.forwardRef<SVGSVGElement, SiProgateProps>(function SiProgate({title = 'Progate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
