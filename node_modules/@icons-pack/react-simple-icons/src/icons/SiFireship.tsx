    ...
    type SiFireshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFireship: IconType = React.forwardRef<SVGSVGElement, SiFireshipProps>(function SiFireship({title = 'Fireship', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
