    ...
    type SiSquareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSquare: IconType = React.forwardRef<SVGSVGElement, SiSquareProps>(function SiSquare({title = 'Square', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSquare as default, defaultColor };
