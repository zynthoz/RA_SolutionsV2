    ...
    type SiPowersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E74536';

    const SiPowers: IconType = React.forwardRef<SVGSVGElement, SiPowersProps>(function SiPowers({title = 'POWERS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPowers as default, defaultColor };
