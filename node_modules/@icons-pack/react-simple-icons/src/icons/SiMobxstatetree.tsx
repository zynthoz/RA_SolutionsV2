    ...
    type SiMobxstatetreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF7102';

    const SiMobxstatetree: IconType = React.forwardRef<SVGSVGElement, SiMobxstatetreeProps>(function SiMobxstatetree({title = 'MobX-State-Tree', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMobxstatetree as default, defaultColor };
