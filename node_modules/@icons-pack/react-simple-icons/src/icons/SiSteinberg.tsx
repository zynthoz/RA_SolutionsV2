    ...
    type SiSteinbergProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSteinberg: IconType = React.forwardRef<SVGSVGElement, SiSteinbergProps>(function SiSteinberg({title = 'Steinberg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
