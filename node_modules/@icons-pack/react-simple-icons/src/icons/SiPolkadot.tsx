    ...
    type SiPolkadotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPolkadot: IconType = React.forwardRef<SVGSVGElement, SiPolkadotProps>(function SiPolkadot({title = 'Polkadot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPolkadot as default, defaultColor };
