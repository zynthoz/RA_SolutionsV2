    ...
    type SiPacktProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F37143';

    const SiPackt: IconType = React.forwardRef<SVGSVGElement, SiPacktProps>(function SiPackt({title = 'Packt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPackt as default, defaultColor };
