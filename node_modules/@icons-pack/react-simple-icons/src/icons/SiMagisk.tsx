    ...
    type SiMagiskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMagisk: IconType = React.forwardRef<SVGSVGElement, SiMagiskProps>(function SiMagisk({title = 'Magisk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMagisk as default, defaultColor };
