    ...
    type SiLunacyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLunacy: IconType = React.forwardRef<SVGSVGElement, SiLunacyProps>(function SiLunacy({title = 'Lunacy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
