    ...
    type SiInfluxdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfluxdb: IconType = React.forwardRef<SVGSVGElement, SiInfluxdbProps>(function SiInfluxdb({title = 'InfluxDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
