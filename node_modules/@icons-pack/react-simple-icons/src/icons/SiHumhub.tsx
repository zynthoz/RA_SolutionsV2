    ...
    type SiHumhubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1B8291';

    const SiHumhub: IconType = React.forwardRef<SVGSVGElement, SiHumhubProps>(function SiHumhub({title = 'HumHub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHumhub as default, defaultColor };
