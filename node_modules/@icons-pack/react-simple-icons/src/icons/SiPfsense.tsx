    ...
    type SiPfsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPfsense: IconType = React.forwardRef<SVGSVGElement, SiPfsenseProps>(function SiPfsense({title = 'pfSense', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPfsense as default, defaultColor };
