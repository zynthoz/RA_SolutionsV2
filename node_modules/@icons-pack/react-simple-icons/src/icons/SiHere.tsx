    ...
    type SiHereProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHere: IconType = React.forwardRef<SVGSVGElement, SiHereProps>(function SiHere({title = 'HERE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHere as default, defaultColor };
