    ...
    type SiRockwellautomationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CD163F';

    const SiRockwellautomation: IconType = React.forwardRef<SVGSVGElement, SiRockwellautomationProps>(function SiRockwellautomation({title = 'Rockwell Automation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRockwellautomation as default, defaultColor };
