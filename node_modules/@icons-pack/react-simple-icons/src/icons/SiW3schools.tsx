    ...
    type SiW3schoolsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiW3schools: IconType = React.forwardRef<SVGSVGElement, SiW3schoolsProps>(function SiW3schools({title = 'W3Schools', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiW3schools as default, defaultColor };
