    ...
    type SiRedragonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedragon: IconType = React.forwardRef<SVGSVGElement, SiRedragonProps>(function SiRedragon({title = 'Redragon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
