    ...
    type SiSaudiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#026938';

    const SiSaudia: IconType = React.forwardRef<SVGSVGElement, SiSaudiaProps>(function SiSaudia({title = 'Saudia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSaudia as default, defaultColor };
