    ...
    type SiNotebooklmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNotebooklm: IconType = React.forwardRef<SVGSVGElement, SiNotebooklmProps>(function SiNotebooklm({title = 'NotebookLM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
