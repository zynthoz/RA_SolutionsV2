    ...
    type SiChromewebstoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChromewebstore: IconType = React.forwardRef<SVGSVGElement, SiChromewebstoreProps>(function SiChromewebstore({title = 'Chrome Web Store', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
