    ...
    type SiNumbaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNumba: IconType = React.forwardRef<SVGSVGElement, SiNumbaProps>(function SiNumba({title = 'Numba', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
