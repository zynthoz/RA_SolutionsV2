    ...
    type SiChromaticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChromatic: IconType = React.forwardRef<SVGSVGElement, SiChromaticProps>(function SiChromatic({title = 'Chromatic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
