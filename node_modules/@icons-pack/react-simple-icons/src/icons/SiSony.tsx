    ...
    type SiSonyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSony: IconType = React.forwardRef<SVGSVGElement, SiSonyProps>(function SiSony({title = 'Sony', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
