    ...
    type SiAuchanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAuchan: IconType = React.forwardRef<SVGSVGElement, SiAuchanProps>(function SiAuchan({title = 'Auchan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAuchan as default, defaultColor };
