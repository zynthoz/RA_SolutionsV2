    ...
    type SiMaseratiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMaserati: IconType = React.forwardRef<SVGSVGElement, SiMaseratiProps>(function SiMaserati({title = 'Maserati', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
