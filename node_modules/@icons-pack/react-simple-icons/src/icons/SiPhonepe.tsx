    ...
    type SiPhonepeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhonepe: IconType = React.forwardRef<SVGSVGElement, SiPhonepeProps>(function SiPhonepe({title = 'PhonePe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
