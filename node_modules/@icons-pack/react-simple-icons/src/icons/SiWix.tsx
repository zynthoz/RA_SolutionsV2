    ...
    type SiWixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWix: IconType = React.forwardRef<SVGSVGElement, SiWixProps>(function SiWix({title = 'Wix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
