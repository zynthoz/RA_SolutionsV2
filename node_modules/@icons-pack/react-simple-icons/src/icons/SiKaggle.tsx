    ...
    type SiKaggleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKaggle: IconType = React.forwardRef<SVGSVGElement, SiKaggleProps>(function SiKaggle({title = 'Kaggle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
