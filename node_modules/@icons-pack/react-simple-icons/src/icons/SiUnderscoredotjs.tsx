    ...
    type SiUnderscoredotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnderscoredotjs: IconType = React.forwardRef<SVGSVGElement, SiUnderscoredotjsProps>(function SiUnderscoredotjs({title = 'Underscore.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUnderscoredotjs as default, defaultColor };
