    ...
    type SiSonosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonos: IconType = React.forwardRef<SVGSVGElement, SiSonosProps>(function SiSonos({title = 'Sonos', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonos as default, defaultColor };
