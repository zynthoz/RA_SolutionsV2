    ...
    type SiSurveymonkeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00BF6F';

    const SiSurveymonkey: IconType = React.forwardRef<SVGSVGElement, SiSurveymonkeyProps>(function SiSurveymonkey({title = 'SurveyMonkey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSurveymonkey as default, defaultColor };
