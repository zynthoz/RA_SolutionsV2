    ...
    type SiCodacyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#222F29';

    const SiCodacy: IconType = React.forwardRef<SVGSVGElement, SiCodacyProps>(function SiCodacy({title = 'Codacy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodacy as default, defaultColor };
