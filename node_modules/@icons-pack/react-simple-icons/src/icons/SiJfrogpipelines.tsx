    ...
    type SiJfrogpipelinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#40BE46';

    const SiJfrogpipelines: IconType = React.forwardRef<SVGSVGElement, SiJfrogpipelinesProps>(function SiJfrogpipelines({title = 'JFrog Pipelines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJfrogpipelines as default, defaultColor };
