    ...
    type SiHusqvarnaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#273A60';

    const SiHusqvarna: IconType = React.forwardRef<SVGSVGElement, SiHusqvarnaProps>(function SiHusqvarna({title = 'Husqvarna', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHusqvarna as default, defaultColor };
