    ...
    type SiRokuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#662D91';

    const SiRoku: IconType = React.forwardRef<SVGSVGElement, SiRokuProps>(function SiRoku({title = 'Roku', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRoku as default, defaultColor };
