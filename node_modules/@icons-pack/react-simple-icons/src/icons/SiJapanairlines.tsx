    ...
    type SiJapanairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJapanairlines: IconType = React.forwardRef<SVGSVGElement, SiJapanairlinesProps>(function SiJapanairlines({title = 'Japan Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJapanairlines as default, defaultColor };
