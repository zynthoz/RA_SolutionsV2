    ...
    type SiStandardjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStandardjs: IconType = React.forwardRef<SVGSVGElement, SiStandardjsProps>(function SiStandardjs({title = 'StandardJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStandardjs as default, defaultColor };
