    ...
    type SiAffineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAffine: IconType = React.forwardRef<SVGSVGElement, SiAffineProps>(function SiAffine({title = 'AFFiNE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAffine as default, defaultColor };
