    ...
    type SiRedwoodjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedwoodjs: IconType = React.forwardRef<SVGSVGElement, SiRedwoodjsProps>(function SiRedwoodjs({title = 'RedwoodJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRedwoodjs as default, defaultColor };
