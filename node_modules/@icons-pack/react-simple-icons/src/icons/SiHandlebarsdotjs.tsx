    ...
    type SiHandlebarsdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHandlebarsdotjs: IconType = React.forwardRef<SVGSVGElement, SiHandlebarsdotjsProps>(function SiHandlebarsdotjs({title = 'Handlebars.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHandlebarsdotjs as default, defaultColor };
