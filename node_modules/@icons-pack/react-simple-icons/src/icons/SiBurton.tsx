    ...
    type SiBurtonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBurton: IconType = React.forwardRef<SVGSVGElement, SiBurtonProps>(function SiBurton({title = 'Burton', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBurton as default, defaultColor };
