    ...
    type SiDeutschebahnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeutschebahn: IconType = React.forwardRef<SVGSVGElement, SiDeutschebahnProps>(function SiDeutschebahn({title = 'Deutsche Bahn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
