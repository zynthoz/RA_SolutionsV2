    ...
    type SiLabexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2E7EEE';

    const SiLabex: IconType = React.forwardRef<SVGSVGElement, SiLabexProps>(function SiLabex({title = 'LabEx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
