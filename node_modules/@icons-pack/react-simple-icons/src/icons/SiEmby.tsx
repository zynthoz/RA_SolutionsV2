    ...
    type SiEmbyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEmby: IconType = React.forwardRef<SVGSVGElement, SiEmbyProps>(function SiEmby({title = 'Emby', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
