    ...
    type SiVirtualboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2F61B4';

    const SiVirtualbox: IconType = React.forwardRef<SVGSVGElement, SiVirtualboxProps>(function SiVirtualbox({title = 'VirtualBox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVirtualbox as default, defaultColor };
