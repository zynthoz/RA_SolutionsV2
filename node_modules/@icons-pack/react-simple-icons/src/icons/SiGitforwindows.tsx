    ...
    type SiGitforwindowsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#80B3FF';

    const SiGitforwindows: IconType = React.forwardRef<SVGSVGElement, SiGitforwindowsProps>(function SiGitforwindows({title = 'Git for Windows', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGitforwindows as default, defaultColor };
