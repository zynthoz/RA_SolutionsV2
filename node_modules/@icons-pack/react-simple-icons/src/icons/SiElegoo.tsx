    ...
    type SiElegooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2C3A83';

    const SiElegoo: IconType = React.forwardRef<SVGSVGElement, SiElegooProps>(function SiElegoo({title = 'Elegoo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiElegoo as default, defaultColor };
