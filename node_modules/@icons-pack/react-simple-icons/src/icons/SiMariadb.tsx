    ...
    type SiMariadbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#003545';

    const SiMariadb: IconType = React.forwardRef<SVGSVGElement, SiMariadbProps>(function SiMariadb({title = 'MariaDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMariadb as default, defaultColor };
