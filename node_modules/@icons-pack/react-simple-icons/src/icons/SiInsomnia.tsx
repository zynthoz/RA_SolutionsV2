    ...
    type SiInsomniaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4000BF';

    const SiInsomnia: IconType = React.forwardRef<SVGSVGElement, SiInsomniaProps>(function SiInsomnia({title = 'Insomnia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInsomnia as default, defaultColor };
