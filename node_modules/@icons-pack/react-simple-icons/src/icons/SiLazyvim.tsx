    ...
    type SiLazyvimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLazyvim: IconType = React.forwardRef<SVGSVGElement, SiLazyvimProps>(function SiLazyvim({title = 'LazyVim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLazyvim as default, defaultColor };
