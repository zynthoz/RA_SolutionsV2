    ...
    type SiSourceforgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSourceforge: IconType = React.forwardRef<SVGSVGElement, SiSourceforgeProps>(function SiSourceforge({title = 'SourceForge', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
