    ...
    type SiTetherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTether: IconType = React.forwardRef<SVGSVGElement, SiTetherProps>(function SiTether({title = 'Tether', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
