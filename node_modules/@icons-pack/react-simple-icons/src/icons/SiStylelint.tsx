    ...
    type SiStylelintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStylelint: IconType = React.forwardRef<SVGSVGElement, SiStylelintProps>(function SiStylelint({title = 'stylelint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
