    ...
    type SiTanstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTanstack: IconType = React.forwardRef<SVGSVGElement, SiTanstackProps>(function SiTanstack({title = 'TanStack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTanstack as default, defaultColor };
