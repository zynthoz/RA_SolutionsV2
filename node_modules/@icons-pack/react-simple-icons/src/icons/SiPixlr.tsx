    ...
    type SiPixlrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3EBBDF';

    const SiPixlr: IconType = React.forwardRef<SVGSVGElement, SiPixlrProps>(function SiPixlr({title = 'Pixlr', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPixlr as default, defaultColor };
