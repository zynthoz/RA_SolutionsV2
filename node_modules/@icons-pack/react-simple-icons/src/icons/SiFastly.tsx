    ...
    type SiFastlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF282D';

    const SiFastly: IconType = React.forwardRef<SVGSVGElement, SiFastlyProps>(function SiFastly({title = 'Fastly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFastly as default, defaultColor };
