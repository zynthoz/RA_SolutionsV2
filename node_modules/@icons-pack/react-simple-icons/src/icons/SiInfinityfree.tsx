    ...
    type SiInfinityfreeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfinityfree: IconType = React.forwardRef<SVGSVGElement, SiInfinityfreeProps>(function SiInfinityfree({title = 'InfinityFree', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInfinityfree as default, defaultColor };
