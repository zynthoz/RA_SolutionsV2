    ...
    type SiZapierProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZapier: IconType = React.forwardRef<SVGSVGElement, SiZapierProps>(function SiZapier({title = 'Zapier', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
