    ...
    type SiContaboProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiContabo: IconType = React.forwardRef<SVGSVGElement, SiContaboProps>(function SiContabo({title = 'Contabo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiContabo as default, defaultColor };
