    ...
    type SiPaperspaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaperspace: IconType = React.forwardRef<SVGSVGElement, SiPaperspaceProps>(function SiPaperspace({title = 'Paperspace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPaperspace as default, defaultColor };
