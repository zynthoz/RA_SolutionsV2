    ...
    type SiDailymotionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDailymotion: IconType = React.forwardRef<SVGSVGElement, SiDailymotionProps>(function SiDailymotion({title = 'Dailymotion', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
