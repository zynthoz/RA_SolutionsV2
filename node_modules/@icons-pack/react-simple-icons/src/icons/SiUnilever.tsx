    ...
    type SiUnileverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnilever: IconType = React.forwardRef<SVGSVGElement, SiUnileverProps>(function SiUnilever({title = 'Unilever', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUnilever as default, defaultColor };
