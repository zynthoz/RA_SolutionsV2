    ...
    type SiAlliedmoddersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlliedmodders: IconType = React.forwardRef<SVGSVGElement, SiAlliedmoddersProps>(function SiAlliedmodders({title = 'AlliedModders', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlliedmodders as default, defaultColor };
