    ...
    type SiSkypackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSkypack: IconType = React.forwardRef<SVGSVGElement, SiSkypackProps>(function SiSkypack({title = 'Skypack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
