    ...
    type SiTheguardianProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTheguardian: IconType = React.forwardRef<SVGSVGElement, SiTheguardianProps>(function SiTheguardian({title = 'The Guardian', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
