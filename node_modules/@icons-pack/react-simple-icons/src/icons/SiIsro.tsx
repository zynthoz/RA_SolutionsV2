    ...
    type SiIsroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIsro: IconType = React.forwardRef<SVGSVGElement, SiIsroProps>(function SiIsro({title = 'ISRO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
