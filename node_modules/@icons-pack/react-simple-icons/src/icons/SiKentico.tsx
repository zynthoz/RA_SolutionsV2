    ...
    type SiKenticoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F05A22';

    const SiKentico: IconType = React.forwardRef<SVGSVGElement, SiKenticoProps>(function SiKentico({title = 'Kentico', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
