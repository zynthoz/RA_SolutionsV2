    ...
    type SiWikivoyageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikivoyage: IconType = React.forwardRef<SVGSVGElement, SiWikivoyageProps>(function SiWikivoyage({title = 'Wikivoyage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
