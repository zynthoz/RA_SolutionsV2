    ...
    type SiDellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#007DB8';

    const SiDell: IconType = React.forwardRef<SVGSVGElement, SiDellProps>(function SiDell({title = 'Dell', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDell as default, defaultColor };
