    ...
    type SiAppiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAppium: IconType = React.forwardRef<SVGSVGElement, SiAppiumProps>(function SiAppium({title = 'Appium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppium as default, defaultColor };
