    ...
    type SiCiscoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCisco: IconType = React.forwardRef<SVGSVGElement, SiCiscoProps>(function SiCisco({title = 'Cisco', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCisco as default, defaultColor };
