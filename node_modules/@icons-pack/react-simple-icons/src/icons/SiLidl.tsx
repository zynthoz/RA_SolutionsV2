    ...
    type SiLidlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0050AA';

    const SiLidl: IconType = React.forwardRef<SVGSVGElement, SiLidlProps>(function SiLidl({title = 'Lidl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
