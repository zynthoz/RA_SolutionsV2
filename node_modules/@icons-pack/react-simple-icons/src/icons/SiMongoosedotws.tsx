    ...
    type SiMongoosedotwsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMongoosedotws: IconType = React.forwardRef<SVGSVGElement, SiMongoosedotwsProps>(function SiMongoosedotws({title = 'Mongoose', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
