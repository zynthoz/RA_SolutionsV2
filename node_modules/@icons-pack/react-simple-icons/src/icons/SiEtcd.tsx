    ...
    type SiEtcdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEtcd: IconType = React.forwardRef<SVGSVGElement, SiEtcdProps>(function SiEtcd({title = 'etcd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
