    ...
    type SiAliexpressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAliexpress: IconType = React.forwardRef<SVGSVGElement, SiAliexpressProps>(function SiAliexpress({title = 'AliExpress', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAliexpress as default, defaultColor };
