    ...
    type SiPhpmyadminProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhpmyadmin: IconType = React.forwardRef<SVGSVGElement, SiPhpmyadminProps>(function SiPhpmyadmin({title = 'phpMyAdmin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPhpmyadmin as default, defaultColor };
