    ...
    type SiRetroachievementsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRetroachievements: IconType = React.forwardRef<SVGSVGElement, SiRetroachievementsProps>(function SiRetroachievements({title = 'Retro Achievements', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
