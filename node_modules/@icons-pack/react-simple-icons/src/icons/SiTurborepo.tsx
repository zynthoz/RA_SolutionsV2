    ...
    type SiTurborepoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF1E56';

    const SiTurborepo: IconType = React.forwardRef<SVGSVGElement, SiTurborepoProps>(function SiTurborepo({title = 'Turborepo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTurborepo as default, defaultColor };
