    ...
    type SiUpsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUps: IconType = React.forwardRef<SVGSVGElement, SiUpsProps>(function SiUps({title = 'UPS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUps as default, defaultColor };
