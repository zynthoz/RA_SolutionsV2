    ...
    type SiWeightsandbiasesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWeightsandbiases: IconType = React.forwardRef<SVGSVGElement, SiWeightsandbiasesProps>(function SiWeightsandbiases({title = 'Weights & Biases', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
