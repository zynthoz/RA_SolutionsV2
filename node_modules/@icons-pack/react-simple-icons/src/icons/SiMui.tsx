    ...
    type SiMuiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMui: IconType = React.forwardRef<SVGSVGElement, SiMuiProps>(function SiMui({title = 'MUI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
