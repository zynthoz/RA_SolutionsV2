    ...
    type SiWolframlanguageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWolframlanguage: IconType = React.forwardRef<SVGSVGElement, SiWolframlanguageProps>(function SiWolframlanguage({title = 'Wolfram Language', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWolframlanguage as default, defaultColor };
