    ...
    type SiDjiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDji: IconType = React.forwardRef<SVGSVGElement, SiDjiProps>(function SiDji({title = 'DJI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDji as default, defaultColor };
