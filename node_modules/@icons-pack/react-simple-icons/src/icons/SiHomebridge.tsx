    ...
    type SiHomebridgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHomebridge: IconType = React.forwardRef<SVGSVGElement, SiHomebridgeProps>(function SiHomebridge({title = 'Homebridge', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHomebridge as default, defaultColor };
