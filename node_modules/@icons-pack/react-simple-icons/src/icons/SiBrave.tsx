    ...
    type SiBraveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBrave: IconType = React.forwardRef<SVGSVGElement, SiBraveProps>(function SiBrave({title = 'Brave', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBrave as default, defaultColor };
