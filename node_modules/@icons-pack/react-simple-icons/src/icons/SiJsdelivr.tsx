    ...
    type SiJsdelivrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E84D3D';

    const SiJsdelivr: IconType = React.forwardRef<SVGSVGElement, SiJsdelivrProps>(function SiJsdelivr({title = 'jsDelivr', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJsdelivr as default, defaultColor };
