    ...
    type SiProxmoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProxmox: IconType = React.forwardRef<SVGSVGElement, SiProxmoxProps>(function SiProxmox({title = 'Proxmox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
