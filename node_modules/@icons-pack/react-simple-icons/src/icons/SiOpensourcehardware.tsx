    ...
    type SiOpensourcehardwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0099B0';

    const SiOpensourcehardware: IconType = React.forwardRef<SVGSVGElement, SiOpensourcehardwareProps>(function SiOpensourcehardware({title = 'Open Source Hardware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpensourcehardware as default, defaultColor };
