    ...
    type SiSteemProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#171FC9';

    const SiSteem: IconType = React.forwardRef<SVGSVGElement, SiSteemProps>(function SiSteem({title = 'Steem', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSteem as default, defaultColor };
