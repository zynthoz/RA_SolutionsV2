    ...
    type SiHelixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#281733';

    const SiHelix: IconType = React.forwardRef<SVGSVGElement, SiHelixProps>(function SiHelix({title = 'Helix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHelix as default, defaultColor };
