    ...
    type SiRubyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CC342D';

    const SiRuby: IconType = React.forwardRef<SVGSVGElement, SiRubyProps>(function SiRuby({title = 'Ruby', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRuby as default, defaultColor };
