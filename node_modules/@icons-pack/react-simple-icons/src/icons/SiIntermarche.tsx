    ...
    type SiIntermarcheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIntermarche: IconType = React.forwardRef<SVGSVGElement, SiIntermarcheProps>(function SiIntermarche({title = 'Intermarche', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIntermarche as default, defaultColor };
