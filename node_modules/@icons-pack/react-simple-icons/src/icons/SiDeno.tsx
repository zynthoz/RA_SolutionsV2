    ...
    type SiDenoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeno: IconType = React.forwardRef<SVGSVGElement, SiDenoProps>(function SiDeno({title = 'Deno', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
