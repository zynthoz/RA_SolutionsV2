    ...
    type SiNorwegianProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D81939';

    const SiNorwegian: IconType = React.forwardRef<SVGSVGElement, SiNorwegianProps>(function SiNorwegian({title = 'Norwegian', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNorwegian as default, defaultColor };
