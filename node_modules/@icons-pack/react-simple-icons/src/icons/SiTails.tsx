    ...
    type SiTailsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#56347C';

    const SiTails: IconType = React.forwardRef<SVGSVGElement, SiTailsProps>(function SiTails({title = 'Tails', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTails as default, defaultColor };
