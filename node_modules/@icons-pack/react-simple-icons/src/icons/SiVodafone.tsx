    ...
    type SiVodafoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVodafone: IconType = React.forwardRef<SVGSVGElement, SiVodafoneProps>(function SiVodafone({title = 'Vodafone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
