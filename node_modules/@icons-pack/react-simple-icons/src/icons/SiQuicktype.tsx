    ...
    type SiQuicktypeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#159588';

    const SiQuicktype: IconType = React.forwardRef<SVGSVGElement, SiQuicktypeProps>(function SiQuicktype({title = 'quicktype', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQuicktype as default, defaultColor };
