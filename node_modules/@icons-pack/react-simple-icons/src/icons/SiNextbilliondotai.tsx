    ...
    type SiNextbilliondotaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNextbilliondotai: IconType = React.forwardRef<SVGSVGElement, SiNextbilliondotaiProps>(function SiNextbilliondotai({title = 'NextBillion.ai', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
