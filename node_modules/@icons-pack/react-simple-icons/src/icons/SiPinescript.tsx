    ...
    type SiPinescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPinescript: IconType = React.forwardRef<SVGSVGElement, SiPinescriptProps>(function SiPinescript({title = 'Pine Script', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
