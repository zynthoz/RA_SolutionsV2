    ...
    type SiCiliumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCilium: IconType = React.forwardRef<SVGSVGElement, SiCiliumProps>(function SiCilium({title = 'Cilium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCilium as default, defaultColor };
