    ...
    type SiJunit5Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#25A162';

    const SiJunit5: IconType = React.forwardRef<SVGSVGElement, SiJunit5Props>(function SiJunit5({title = 'JUnit5', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJunit5 as default, defaultColor };
