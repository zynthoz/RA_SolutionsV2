    ...
    type SiBungieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0075BB';

    const SiBungie: IconType = React.forwardRef<SVGSVGElement, SiBungieProps>(function SiBungie({title = 'Bungie', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
