    ...
    type SiTelequebecProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1343FB';

    const SiTelequebec: IconType = React.forwardRef<SVGSVGElement, SiTelequebecProps>(function SiTelequebec({title = 'Télé-Québec', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTelequebec as default, defaultColor };
