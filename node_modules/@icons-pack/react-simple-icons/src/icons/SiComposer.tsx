    ...
    type SiComposerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#885630';

    const SiComposer: IconType = React.forwardRef<SVGSVGElement, SiComposerProps>(function SiComposer({title = 'Composer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
