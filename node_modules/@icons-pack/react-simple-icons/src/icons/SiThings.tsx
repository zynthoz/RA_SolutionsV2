    ...
    type SiThingsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2473E7';

    const SiThings: IconType = React.forwardRef<SVGSVGElement, SiThingsProps>(function SiThings({title = 'Things', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiThings as default, defaultColor };
