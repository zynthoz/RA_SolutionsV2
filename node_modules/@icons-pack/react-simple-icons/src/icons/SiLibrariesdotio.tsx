    ...
    type SiLibrariesdotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLibrariesdotio: IconType = React.forwardRef<SVGSVGElement, SiLibrariesdotioProps>(function SiLibrariesdotio({title = 'Libraries.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLibrariesdotio as default, defaultColor };
