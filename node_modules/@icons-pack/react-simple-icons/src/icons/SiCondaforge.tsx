    ...
    type SiCondaforgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCondaforge: IconType = React.forwardRef<SVGSVGElement, SiCondaforgeProps>(function SiCondaforge({title = 'Conda-Forge', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCondaforge as default, defaultColor };
