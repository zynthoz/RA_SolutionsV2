    ...
    type SiBatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBat: IconType = React.forwardRef<SVGSVGElement, SiBatProps>(function SiBat({title = 'bat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
