    ...
    type SiMclarenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMclaren: IconType = React.forwardRef<SVGSVGElement, SiMclarenProps>(function SiMclaren({title = 'McLaren', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMclaren as default, defaultColor };
