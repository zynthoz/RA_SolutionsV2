    ...
    type SiDotnetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDotnet: IconType = React.forwardRef<SVGSVGElement, SiDotnetProps>(function SiDotnet({title = '.NET', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
