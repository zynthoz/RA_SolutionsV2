    ...
    type SiB4xProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiB4x: IconType = React.forwardRef<SVGSVGElement, SiB4xProps>(function SiB4x({title = 'B4X', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
