    ...
    type SiVtexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVtex: IconType = React.forwardRef<SVGSVGElement, SiVtexProps>(function SiVtex({title = 'VTEX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVtex as default, defaultColor };
