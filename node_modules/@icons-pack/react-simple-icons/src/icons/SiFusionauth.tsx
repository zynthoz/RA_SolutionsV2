    ...
    type SiFusionauthProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F58320';

    const SiFusionauth: IconType = React.forwardRef<SVGSVGElement, SiFusionauthProps>(function SiFusionauth({title = 'FusionAuth', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFusionauth as default, defaultColor };
