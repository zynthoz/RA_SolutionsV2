    ...
    type SiEclipsejettyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FC390E';

    const SiEclipsejetty: IconType = React.forwardRef<SVGSVGElement, SiEclipsejettyProps>(function SiEclipsejetty({title = 'Eclipse Jetty', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEclipsejetty as default, defaultColor };
