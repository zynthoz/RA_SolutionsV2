    ...
    type SiTrpcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrpc: IconType = React.forwardRef<SVGSVGElement, SiTrpcProps>(function SiTrpc({title = 'tRPC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTrpc as default, defaultColor };
