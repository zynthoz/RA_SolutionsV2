    ...
    type SiVolkswagenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVolkswagen: IconType = React.forwardRef<SVGSVGElement, SiVolkswagenProps>(function SiVolkswagen({title = 'Volkswagen', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVolkswagen as default, defaultColor };
