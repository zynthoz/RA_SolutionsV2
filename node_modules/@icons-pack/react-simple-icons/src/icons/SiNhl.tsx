    ...
    type SiNhlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNhl: IconType = React.forwardRef<SVGSVGElement, SiNhlProps>(function SiNhl({title = 'NHL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNhl as default, defaultColor };
