    ...
    type SiOdyseeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOdysee: IconType = React.forwardRef<SVGSVGElement, SiOdyseeProps>(function SiOdysee({title = 'Odysee', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOdysee as default, defaultColor };
