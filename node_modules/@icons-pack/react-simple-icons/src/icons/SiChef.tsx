    ...
    type SiChefProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChef: IconType = React.forwardRef<SVGSVGElement, SiChefProps>(function SiChef({title = 'Chef', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChef as default, defaultColor };
