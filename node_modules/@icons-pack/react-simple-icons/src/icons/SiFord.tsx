    ...
    type SiFordProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00274E';

    const SiFord: IconType = React.forwardRef<SVGSVGElement, SiFordProps>(function SiFord({title = 'Ford', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFord as default, defaultColor };
