    ...
    type SiMetrodeparisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#003E95';

    const SiMetrodeparis: IconType = React.forwardRef<SVGSVGElement, SiMetrodeparisProps>(function SiMetrodeparis({title = 'Métro de Paris', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMetrodeparis as default, defaultColor };
