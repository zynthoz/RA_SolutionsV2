    ...
    type SiPandasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPandas: IconType = React.forwardRef<SVGSVGElement, SiPandasProps>(function SiPandas({title = 'pandas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
