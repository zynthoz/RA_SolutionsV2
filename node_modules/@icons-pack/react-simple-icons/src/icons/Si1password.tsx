    ...
    type Si1passwordProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si1password: IconType = React.forwardRef<SVGSVGElement, Si1passwordProps>(function Si1password({title = '1Password', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { Si1password as default, defaultColor };
