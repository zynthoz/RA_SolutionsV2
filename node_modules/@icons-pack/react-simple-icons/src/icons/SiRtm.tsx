    ...
    type SiRtmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#36474F';

    const SiRtm: IconType = React.forwardRef<SVGSVGElement, SiRtmProps>(function SiRtm({title = 'RTM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
