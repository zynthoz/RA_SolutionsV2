    ...
    type SiMiniProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMini: IconType = React.forwardRef<SVGSVGElement, SiMiniProps>(function SiMini({title = 'Mini', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMini as default, defaultColor };
