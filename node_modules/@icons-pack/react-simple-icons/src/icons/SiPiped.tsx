    ...
    type SiPipedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F84330';

    const SiPiped: IconType = React.forwardRef<SVGSVGElement, SiPipedProps>(function SiPiped({title = 'Piped', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPiped as default, defaultColor };
