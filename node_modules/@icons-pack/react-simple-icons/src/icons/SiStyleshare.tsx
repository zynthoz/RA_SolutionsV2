    ...
    type SiStyleshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStyleshare: IconType = React.forwardRef<SVGSVGElement, SiStyleshareProps>(function SiStyleshare({title = 'StyleShare', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStyleshare as default, defaultColor };
