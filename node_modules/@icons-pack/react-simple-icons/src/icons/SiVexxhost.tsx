    ...
    type SiVexxhostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2A1659';

    const SiVexxhost: IconType = React.forwardRef<SVGSVGElement, SiVexxhostProps>(function SiVexxhost({title = 'VEXXHOST', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVexxhost as default, defaultColor };
