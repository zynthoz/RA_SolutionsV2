    ...
    type SiCypressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCypress: IconType = React.forwardRef<SVGSVGElement, SiCypressProps>(function SiCypress({title = 'Cypress', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
