    ...
    type SiScalarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScalar: IconType = React.forwardRef<SVGSVGElement, SiScalarProps>(function SiScalar({title = 'Scalar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScalar as default, defaultColor };
