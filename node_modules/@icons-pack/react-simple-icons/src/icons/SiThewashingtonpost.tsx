    ...
    type SiThewashingtonpostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThewashingtonpost: IconType = React.forwardRef<SVGSVGElement, SiThewashingtonpostProps>(function SiThewashingtonpost({title = 'The Washington Post', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiThewashingtonpost as default, defaultColor };
