    ...
    type SiArmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArm: IconType = React.forwardRef<SVGSVGElement, SiArmProps>(function SiArm({title = 'Arm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
