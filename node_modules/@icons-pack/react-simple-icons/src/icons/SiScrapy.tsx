    ...
    type SiScrapyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScrapy: IconType = React.forwardRef<SVGSVGElement, SiScrapyProps>(function SiScrapy({title = 'Scrapy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScrapy as default, defaultColor };
