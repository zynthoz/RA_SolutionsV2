    ...
    type SiCurlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCurl: IconType = React.forwardRef<SVGSVGElement, SiCurlProps>(function SiCurl({title = 'curl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCurl as default, defaultColor };
