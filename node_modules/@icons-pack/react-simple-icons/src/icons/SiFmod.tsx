    ...
    type SiFmodProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFmod: IconType = React.forwardRef<SVGSVGElement, SiFmodProps>(function SiFmod({title = 'FMOD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
