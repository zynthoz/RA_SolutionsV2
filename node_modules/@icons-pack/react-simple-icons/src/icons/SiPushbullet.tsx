    ...
    type SiPushbulletProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPushbullet: IconType = React.forwardRef<SVGSVGElement, SiPushbulletProps>(function SiPushbullet({title = 'Pushbullet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
