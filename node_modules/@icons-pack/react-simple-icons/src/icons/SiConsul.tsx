    ...
    type SiConsulProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConsul: IconType = React.forwardRef<SVGSVGElement, SiConsulProps>(function SiConsul({title = 'Consul', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
