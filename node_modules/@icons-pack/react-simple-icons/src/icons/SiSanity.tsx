    ...
    type SiSanityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSanity: IconType = React.forwardRef<SVGSVGElement, SiSanityProps>(function SiSanity({title = 'Sanity', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
