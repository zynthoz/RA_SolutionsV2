    ...
    type SiUbisoftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUbisoft: IconType = React.forwardRef<SVGSVGElement, SiUbisoftProps>(function SiUbisoft({title = 'Ubisoft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
