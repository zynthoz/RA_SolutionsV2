    ...
    type SiShowtimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiShowtime: IconType = React.forwardRef<SVGSVGElement, SiShowtimeProps>(function SiShowtime({title = 'Showtime', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShowtime as default, defaultColor };
