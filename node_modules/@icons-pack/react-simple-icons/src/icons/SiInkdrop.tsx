    ...
    type SiInkdropProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7A78D7';

    const SiInkdrop: IconType = React.forwardRef<SVGSVGElement, SiInkdropProps>(function SiInkdrop({title = 'Inkdrop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInkdrop as default, defaultColor };
