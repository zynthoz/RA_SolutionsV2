    ...
    type SiLetsencryptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#003A70';

    const SiLetsencrypt: IconType = React.forwardRef<SVGSVGElement, SiLetsencryptProps>(function SiLetsencrypt({title = 'Lets Encrypt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLetsencrypt as default, defaultColor };
