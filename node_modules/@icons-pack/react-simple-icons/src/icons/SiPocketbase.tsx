    ...
    type SiPocketbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B8DBE4';

    const SiPocketbase: IconType = React.forwardRef<SVGSVGElement, SiPocketbaseProps>(function SiPocketbase({title = 'PocketBase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPocketbase as default, defaultColor };
