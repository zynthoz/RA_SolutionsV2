    ...
    type SiMomenteoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5A6AB1';

    const SiMomenteo: IconType = React.forwardRef<SVGSVGElement, SiMomenteoProps>(function SiMomenteo({title = 'Momenteo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMomenteo as default, defaultColor };
