    ...
    type SiFranprixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFranprix: IconType = React.forwardRef<SVGSVGElement, SiFranprixProps>(function SiFranprix({title = 'Franprix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
