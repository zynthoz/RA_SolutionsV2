    ...
    type SiLeaderpriceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLeaderprice: IconType = React.forwardRef<SVGSVGElement, SiLeaderpriceProps>(function SiLeaderprice({title = 'Leader Price', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
