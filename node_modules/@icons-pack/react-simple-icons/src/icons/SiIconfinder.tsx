    ...
    type SiIconfinderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIconfinder: IconType = React.forwardRef<SVGSVGElement, SiIconfinderProps>(function SiIconfinder({title = 'Iconfinder', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIconfinder as default, defaultColor };
