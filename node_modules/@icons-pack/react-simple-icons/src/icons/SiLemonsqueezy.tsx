    ...
    type SiLemonsqueezyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFC233';

    const SiLemonsqueezy: IconType = React.forwardRef<SVGSVGElement, SiLemonsqueezyProps>(function SiLemonsqueezy({title = 'Lemon Squeezy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLemonsqueezy as default, defaultColor };
