    ...
    type SiBitcoincashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBitcoincash: IconType = React.forwardRef<SVGSVGElement, SiBitcoincashProps>(function SiBitcoincash({title = 'Bitcoin Cash', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBitcoincash as default, defaultColor };
