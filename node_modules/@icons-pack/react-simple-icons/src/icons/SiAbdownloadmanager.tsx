    ...
    type SiAbdownloadmanagerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAbdownloadmanager: IconType = React.forwardRef<SVGSVGElement, SiAbdownloadmanagerProps>(function SiAbdownloadmanager({title = 'AB Download Manager', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
