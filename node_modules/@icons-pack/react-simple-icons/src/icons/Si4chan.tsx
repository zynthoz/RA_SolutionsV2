    ...
    type Si4chanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si4chan: IconType = React.forwardRef<SVGSVGElement, Si4chanProps>(function Si4chan({title = '4chan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
