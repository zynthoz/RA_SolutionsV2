    ...
    type SiRefinedgithubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#9E95B7';

    const SiRefinedgithub: IconType = React.forwardRef<SVGSVGElement, SiRefinedgithubProps>(function SiRefinedgithub({title = 'Refined GitHub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRefinedgithub as default, defaultColor };
