    ...
    type SiOnlyofficeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOnlyoffice: IconType = React.forwardRef<SVGSVGElement, SiOnlyofficeProps>(function SiOnlyoffice({title = 'ONLYOFFICE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
