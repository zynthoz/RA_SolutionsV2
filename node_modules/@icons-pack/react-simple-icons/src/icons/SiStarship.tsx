    ...
    type SiStarshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStarship: IconType = React.forwardRef<SVGSVGElement, SiStarshipProps>(function SiStarship({title = 'Starship', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
