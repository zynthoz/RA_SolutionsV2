    ...
    type SiAboutdotmeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAboutdotme: IconType = React.forwardRef<SVGSVGElement, SiAboutdotmeProps>(function SiAboutdotme({title = 'about.me', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAboutdotme as default, defaultColor };
