    ...
    type SiOperaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpera: IconType = React.forwardRef<SVGSVGElement, SiOperaProps>(function SiOpera({title = 'Opera', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpera as default, defaultColor };
