    ...
    type SiParitysubstrateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiParitysubstrate: IconType = React.forwardRef<SVGSVGElement, SiParitysubstrateProps>(function SiParitysubstrate({title = 'Parity Substrate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
