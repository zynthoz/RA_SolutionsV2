    ...
    type SiVaultwardenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVaultwarden: IconType = React.forwardRef<SVGSVGElement, SiVaultwardenProps>(function SiVaultwarden({title = 'Vaultwarden', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
