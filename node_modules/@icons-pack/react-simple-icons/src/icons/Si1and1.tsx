    ...
    type Si1and1Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si1and1: IconType = React.forwardRef<SVGSVGElement, Si1and1Props>(function Si1and1({title = '1&1', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
