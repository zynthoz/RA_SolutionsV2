    ...
    type SiSoftcatalaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSoftcatala: IconType = React.forwardRef<SVGSVGElement, SiSoftcatalaProps>(function SiSoftcatala({title = 'Softcatalà', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
