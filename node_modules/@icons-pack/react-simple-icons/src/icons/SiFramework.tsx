    ...
    type SiFrameworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFramework: IconType = React.forwardRef<SVGSVGElement, SiFrameworkProps>(function SiFramework({title = 'Framework', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
