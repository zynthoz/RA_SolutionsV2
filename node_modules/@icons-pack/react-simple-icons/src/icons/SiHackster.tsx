    ...
    type SiHacksterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHackster: IconType = React.forwardRef<SVGSVGElement, SiHacksterProps>(function SiHackster({title = 'Hackster', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHackster as default, defaultColor };
