    ...
    type SiChannel4Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChannel4: IconType = React.forwardRef<SVGSVGElement, SiChannel4Props>(function SiChannel4({title = 'Channel 4', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
