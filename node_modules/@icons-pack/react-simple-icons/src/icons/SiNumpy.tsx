    ...
    type SiNumpyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNumpy: IconType = React.forwardRef<SVGSVGElement, SiNumpyProps>(function SiNumpy({title = 'NumPy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
