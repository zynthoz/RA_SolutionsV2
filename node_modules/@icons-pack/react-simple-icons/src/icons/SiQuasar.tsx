    ...
    type SiQuasarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#050A14';

    const SiQuasar: IconType = React.forwardRef<SVGSVGElement, SiQuasarProps>(function SiQuasar({title = 'Quasar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQuasar as default, defaultColor };
