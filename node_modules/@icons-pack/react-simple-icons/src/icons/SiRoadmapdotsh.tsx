    ...
    type SiRoadmapdotshProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRoadmapdotsh: IconType = React.forwardRef<SVGSVGElement, SiRoadmapdotshProps>(function SiRoadmapdotsh({title = 'roadmap.sh', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
