    ...
    type SiIkeaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIkea: IconType = React.forwardRef<SVGSVGElement, SiIkeaProps>(function SiIkea({title = 'IKEA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
