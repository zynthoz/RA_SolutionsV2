    ...
    type SiPlangridProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlangrid: IconType = React.forwardRef<SVGSVGElement, SiPlangridProps>(function SiPlangrid({title = 'PlanGrid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlangrid as default, defaultColor };
