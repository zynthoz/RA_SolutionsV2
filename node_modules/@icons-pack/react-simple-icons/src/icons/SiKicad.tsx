    ...
    type SiKicadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKicad: IconType = React.forwardRef<SVGSVGElement, SiKicadProps>(function SiKicad({title = 'KiCad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKicad as default, defaultColor };
