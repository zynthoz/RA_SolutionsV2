    ...
    type SiKakaotalkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKakaotalk: IconType = React.forwardRef<SVGSVGElement, SiKakaotalkProps>(function SiKakaotalk({title = 'KakaoTalk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
