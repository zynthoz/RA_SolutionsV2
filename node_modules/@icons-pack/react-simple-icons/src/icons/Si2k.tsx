    ...
    type Si2kProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si2k: IconType = React.forwardRef<SVGSVGElement, Si2kProps>(function Si2k({title = '2K', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
