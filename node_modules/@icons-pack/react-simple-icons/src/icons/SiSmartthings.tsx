    ...
    type SiSmartthingsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#15BFFF';

    const SiSmartthings: IconType = React.forwardRef<SVGSVGElement, SiSmartthingsProps>(function SiSmartthings({title = 'SmartThings', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSmartthings as default, defaultColor };
