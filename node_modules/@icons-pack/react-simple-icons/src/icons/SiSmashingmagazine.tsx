    ...
    type SiSmashingmagazineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E85C33';

    const SiSmashingmagazine: IconType = React.forwardRef<SVGSVGElement, SiSmashingmagazineProps>(function SiSmashingmagazine({title = 'Smashing Magazine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSmashingmagazine as default, defaultColor };
