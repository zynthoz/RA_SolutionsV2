    ...
    type SiZcoolProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZcool: IconType = React.forwardRef<SVGSVGElement, SiZcoolProps>(function SiZcool({title = 'ZCOOL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZcool as default, defaultColor };
