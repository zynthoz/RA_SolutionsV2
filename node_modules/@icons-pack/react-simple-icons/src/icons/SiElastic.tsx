    ...
    type SiElasticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElastic: IconType = React.forwardRef<SVGSVGElement, SiElasticProps>(function SiElastic({title = 'Elastic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
