    ...
    type SiAftershipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAftership: IconType = React.forwardRef<SVGSVGElement, SiAftershipProps>(function SiAftership({title = 'AfterShip', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
