    ...
    type SiHoneyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF6801';

    const SiHoney: IconType = React.forwardRef<SVGSVGElement, SiHoneyProps>(function SiHoney({title = 'Honey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHoney as default, defaultColor };
