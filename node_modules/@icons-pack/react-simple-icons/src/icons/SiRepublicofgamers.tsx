    ...
    type SiRepublicofgamersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF0029';

    const SiRepublicofgamers: IconType = React.forwardRef<SVGSVGElement, SiRepublicofgamersProps>(function SiRepublicofgamers({title = 'Republic of Gamers', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
