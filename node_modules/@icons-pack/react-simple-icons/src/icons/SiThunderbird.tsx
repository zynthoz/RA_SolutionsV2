    ...
    type SiThunderbirdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThunderbird: IconType = React.forwardRef<SVGSVGElement, SiThunderbirdProps>(function SiThunderbird({title = 'Thunderbird', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
