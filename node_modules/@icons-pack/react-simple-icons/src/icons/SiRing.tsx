    ...
    type SiRingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRing: IconType = React.forwardRef<SVGSVGElement, SiRingProps>(function SiRing({title = 'Ring', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRing as default, defaultColor };
