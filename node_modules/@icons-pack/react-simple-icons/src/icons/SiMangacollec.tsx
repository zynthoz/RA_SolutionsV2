    ...
    type SiMangacollecProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMangacollec: IconType = React.forwardRef<SVGSVGElement, SiMangacollecProps>(function SiMangacollec({title = 'Mangacollec', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMangacollec as default, defaultColor };
