    ...
    type SiDaisyuiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDaisyui: IconType = React.forwardRef<SVGSVGElement, SiDaisyuiProps>(function SiDaisyui({title = 'daisyUI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
