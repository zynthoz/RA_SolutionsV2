    ...
    type SiAccuweatherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAccuweather: IconType = React.forwardRef<SVGSVGElement, SiAccuweatherProps>(function SiAccuweather({title = 'AccuWeather', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAccuweather as default, defaultColor };
