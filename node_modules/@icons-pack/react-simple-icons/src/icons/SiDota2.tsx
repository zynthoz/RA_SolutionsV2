    ...
    type SiDota2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BF2E1A';

    const SiDota2: IconType = React.forwardRef<SVGSVGElement, SiDota2Props>(function SiDota2({title = 'Dota 2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
