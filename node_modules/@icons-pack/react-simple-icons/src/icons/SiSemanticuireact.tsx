    ...
    type SiSemanticuireactProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#35BDB2';

    const SiSemanticuireact: IconType = React.forwardRef<SVGSVGElement, SiSemanticuireactProps>(function SiSemanticuireact({title = 'Semantic UI React', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSemanticuireact as default, defaultColor };
