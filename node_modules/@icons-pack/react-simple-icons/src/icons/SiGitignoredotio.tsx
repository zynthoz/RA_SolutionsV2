    ...
    type SiGitignoredotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGitignoredotio: IconType = React.forwardRef<SVGSVGElement, SiGitignoredotioProps>(function SiGitignoredotio({title = 'gitignore.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
