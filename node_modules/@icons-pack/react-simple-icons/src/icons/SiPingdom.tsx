    ...
    type SiPingdomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPingdom: IconType = React.forwardRef<SVGSVGElement, SiPingdomProps>(function SiPingdom({title = 'Pingdom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPingdom as default, defaultColor };
