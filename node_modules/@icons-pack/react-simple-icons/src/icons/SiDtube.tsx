    ...
    type SiDtubeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDtube: IconType = React.forwardRef<SVGSVGElement, SiDtubeProps>(function SiDtube({title = 'DTube', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
