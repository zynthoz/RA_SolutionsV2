    ...
    type SiAlienwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlienware: IconType = React.forwardRef<SVGSVGElement, SiAlienwareProps>(function SiAlienware({title = 'Alienware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlienware as default, defaultColor };
