    ...
    type SiDerspiegelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E64415';

    const SiDerspiegel: IconType = React.forwardRef<SVGSVGElement, SiDerspiegelProps>(function SiDerspiegel({title = 'Der Spiegel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDerspiegel as default, defaultColor };
