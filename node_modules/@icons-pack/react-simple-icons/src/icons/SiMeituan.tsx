    ...
    type SiMeituanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMeituan: IconType = React.forwardRef<SVGSVGElement, SiMeituanProps>(function SiMeituan({title = 'Meituan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
