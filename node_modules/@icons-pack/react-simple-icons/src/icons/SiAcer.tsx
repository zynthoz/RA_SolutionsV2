    ...
    type SiAcerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAcer: IconType = React.forwardRef<SVGSVGElement, SiAcerProps>(function SiAcer({title = 'Acer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAcer as default, defaultColor };
