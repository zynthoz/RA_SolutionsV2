    ...
    type SiCsdnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCsdn: IconType = React.forwardRef<SVGSVGElement, SiCsdnProps>(function SiCsdn({title = 'CSDN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
