    ...
    type SiScratchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScratch: IconType = React.forwardRef<SVGSVGElement, SiScratchProps>(function SiScratch({title = 'Scratch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
