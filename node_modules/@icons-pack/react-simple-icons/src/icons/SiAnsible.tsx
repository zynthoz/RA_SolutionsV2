    ...
    type SiAnsibleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAnsible: IconType = React.forwardRef<SVGSVGElement, SiAnsibleProps>(function SiAnsible({title = 'Ansible', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
