    ...
    type SiVivaldiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVivaldi: IconType = React.forwardRef<SVGSVGElement, SiVivaldiProps>(function SiVivaldi({title = 'Vivaldi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
