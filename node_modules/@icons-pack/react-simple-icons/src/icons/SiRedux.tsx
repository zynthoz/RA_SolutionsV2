    ...
    type SiReduxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedux: IconType = React.forwardRef<SVGSVGElement, SiReduxProps>(function SiRedux({title = 'Redux', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
