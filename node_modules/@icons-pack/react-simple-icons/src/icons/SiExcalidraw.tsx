    ...
    type SiExcalidrawProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiExcalidraw: IconType = React.forwardRef<SVGSVGElement, SiExcalidrawProps>(function SiExcalidraw({title = 'Excalidraw', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
