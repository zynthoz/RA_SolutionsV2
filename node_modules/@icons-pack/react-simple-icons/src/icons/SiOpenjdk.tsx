    ...
    type SiOpenjdkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenjdk: IconType = React.forwardRef<SVGSVGElement, SiOpenjdkProps>(function SiOpenjdk({title = 'OpenJDK', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
