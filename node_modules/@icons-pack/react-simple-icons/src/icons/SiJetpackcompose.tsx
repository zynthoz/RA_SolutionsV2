    ...
    type SiJetpackcomposeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJetpackcompose: IconType = React.forwardRef<SVGSVGElement, SiJetpackcomposeProps>(function SiJetpackcompose({title = 'Jetpack Compose', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJetpackcompose as default, defaultColor };
