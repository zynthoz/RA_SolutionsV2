    ...
    type SiGoogleclassroomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleclassroom: IconType = React.forwardRef<SVGSVGElement, SiGoogleclassroomProps>(function SiGoogleclassroom({title = 'Google Classroom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
