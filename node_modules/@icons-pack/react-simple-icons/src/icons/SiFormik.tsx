    ...
    type SiFormikProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFormik: IconType = React.forwardRef<SVGSVGElement, SiFormikProps>(function SiFormik({title = 'Formik', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
