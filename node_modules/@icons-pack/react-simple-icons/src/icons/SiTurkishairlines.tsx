    ...
    type SiTurkishairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTurkishairlines: IconType = React.forwardRef<SVGSVGElement, SiTurkishairlinesProps>(function SiTurkishairlines({title = 'Turkish Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
