    ...
    type SiG2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiG2: IconType = React.forwardRef<SVGSVGElement, SiG2Props>(function SiG2({title = 'G2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
