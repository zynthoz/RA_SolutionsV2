    ...
    type SiAiohttpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAiohttp: IconType = React.forwardRef<SVGSVGElement, SiAiohttpProps>(function SiAiohttp({title = 'AIOHTTP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
