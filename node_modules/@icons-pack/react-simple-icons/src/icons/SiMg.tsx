    ...
    type SiMgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMg: IconType = React.forwardRef<SVGSVGElement, SiMgProps>(function SiMg({title = 'MG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
