    ...
    type SiPastebinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#02456C';

    const SiPastebin: IconType = React.forwardRef<SVGSVGElement, SiPastebinProps>(function SiPastebin({title = 'Pastebin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPastebin as default, defaultColor };
