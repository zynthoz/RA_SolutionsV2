    ...
    type SiSidekiqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B1003E';

    const SiSidekiq: IconType = React.forwardRef<SVGSVGElement, SiSidekiqProps>(function SiSidekiq({title = 'Sidekiq', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSidekiq as default, defaultColor };
