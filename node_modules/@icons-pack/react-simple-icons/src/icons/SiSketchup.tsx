    ...
    type SiSketchupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#005F9E';

    const SiSketchup: IconType = React.forwardRef<SVGSVGElement, SiSketchupProps>(function SiSketchup({title = 'SketchUp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSketchup as default, defaultColor };
