    ...
    type SiJcbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0B4EA2';

    const SiJcb: IconType = React.forwardRef<SVGSVGElement, SiJcbProps>(function SiJcb({title = 'JCB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJcb as default, defaultColor };
