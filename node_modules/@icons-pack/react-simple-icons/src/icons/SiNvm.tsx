    ...
    type SiNvmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F4DD4B';

    const SiNvm: IconType = React.forwardRef<SVGSVGElement, SiNvmProps>(function SiNvm({title = 'nvm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
