    ...
    type SiChianetworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5ECE71';

    const SiChianetwork: IconType = React.forwardRef<SVGSVGElement, SiChianetworkProps>(function SiChianetwork({title = 'Chia Network', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChianetwork as default, defaultColor };
