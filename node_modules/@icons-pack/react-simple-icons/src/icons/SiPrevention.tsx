    ...
    type SiPreventionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrevention: IconType = React.forwardRef<SVGSVGElement, SiPreventionProps>(function SiPrevention({title = 'Prevention', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
