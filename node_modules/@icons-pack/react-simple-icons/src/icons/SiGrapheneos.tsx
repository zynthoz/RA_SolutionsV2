    ...
    type SiGrapheneosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0053A3';

    const SiGrapheneos: IconType = React.forwardRef<SVGSVGElement, SiGrapheneosProps>(function SiGrapheneos({title = 'GrapheneOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGrapheneos as default, defaultColor };
