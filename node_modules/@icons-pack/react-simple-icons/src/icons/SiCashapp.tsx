    ...
    type SiCashappProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCashapp: IconType = React.forwardRef<SVGSVGElement, SiCashappProps>(function SiCashapp({title = 'Cash App', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCashapp as default, defaultColor };
