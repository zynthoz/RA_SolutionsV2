    ...
    type SiMaltProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMalt: IconType = React.forwardRef<SVGSVGElement, SiMaltProps>(function SiMalt({title = 'Malt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
