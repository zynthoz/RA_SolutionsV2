    ...
    type SiElkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElk: IconType = React.forwardRef<SVGSVGElement, SiElkProps>(function SiElk({title = 'Elk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
