    ...
    type SiKdeneonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKdeneon: IconType = React.forwardRef<SVGSVGElement, SiKdeneonProps>(function SiKdeneon({title = 'KDE neon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
