    ...
    type SiTokyometroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTokyometro: IconType = React.forwardRef<SVGSVGElement, SiTokyometroProps>(function SiTokyometro({title = 'Tokyo Metro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
