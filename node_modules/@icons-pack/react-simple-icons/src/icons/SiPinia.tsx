    ...
    type SiPiniaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPinia: IconType = React.forwardRef<SVGSVGElement, SiPiniaProps>(function SiPinia({title = 'Pinia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
