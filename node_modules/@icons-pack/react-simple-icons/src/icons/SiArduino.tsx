    ...
    type SiArduinoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArduino: IconType = React.forwardRef<SVGSVGElement, SiArduinoProps>(function SiArduino({title = 'Arduino', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
