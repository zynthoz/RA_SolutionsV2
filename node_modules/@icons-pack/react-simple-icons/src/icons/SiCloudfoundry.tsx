    ...
    type SiCloudfoundryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCloudfoundry: IconType = React.forwardRef<SVGSVGElement, SiCloudfoundryProps>(function SiCloudfoundry({title = 'Cloud Foundry', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
