    ...
    type SiHootsuiteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF4C46';

    const SiHootsuite: IconType = React.forwardRef<SVGSVGElement, SiHootsuiteProps>(function SiHootsuite({title = 'Hootsuite', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHootsuite as default, defaultColor };
