    ...
    type SiHeadlessuiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHeadlessui: IconType = React.forwardRef<SVGSVGElement, SiHeadlessuiProps>(function SiHeadlessui({title = 'Headless UI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
