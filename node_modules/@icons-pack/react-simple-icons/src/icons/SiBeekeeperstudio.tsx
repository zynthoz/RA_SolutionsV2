    ...
    type SiBeekeeperstudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBeekeeperstudio: IconType = React.forwardRef<SVGSVGElement, SiBeekeeperstudioProps>(function SiBeekeeperstudio({title = 'Beekeeper Studio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
