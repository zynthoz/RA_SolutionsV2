    ...
    type SiDreamstimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDreamstime: IconType = React.forwardRef<SVGSVGElement, SiDreamstimeProps>(function SiDreamstime({title = 'Dreamstime', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
