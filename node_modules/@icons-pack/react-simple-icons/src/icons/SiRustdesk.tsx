    ...
    type SiRustdeskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#024EFF';

    const SiRustdesk: IconType = React.forwardRef<SVGSVGElement, SiRustdeskProps>(function SiRustdesk({title = 'RustDesk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRustdesk as default, defaultColor };
