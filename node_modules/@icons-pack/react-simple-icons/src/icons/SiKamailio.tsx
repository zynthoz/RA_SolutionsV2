    ...
    type SiKamailioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKamailio: IconType = React.forwardRef<SVGSVGElement, SiKamailioProps>(function SiKamailio({title = 'Kamailio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKamailio as default, defaultColor };
