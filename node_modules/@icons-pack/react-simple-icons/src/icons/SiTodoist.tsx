    ...
    type SiTodoistProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E44332';

    const SiTodoist: IconType = React.forwardRef<SVGSVGElement, SiTodoistProps>(function SiTodoist({title = 'Todoist', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTodoist as default, defaultColor };
