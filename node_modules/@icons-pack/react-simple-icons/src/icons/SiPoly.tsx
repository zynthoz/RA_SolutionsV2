    ...
    type SiPolyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB3C00';

    const SiPoly: IconType = React.forwardRef<SVGSVGElement, SiPolyProps>(function SiPoly({title = 'Poly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPoly as default, defaultColor };
