    ...
    type SiSchneiderelectricProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSchneiderelectric: IconType = React.forwardRef<SVGSVGElement, SiSchneiderelectricProps>(function SiSchneiderelectric({title = 'Schneider Electric', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
