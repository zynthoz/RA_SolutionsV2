    ...
    type SiSiemensProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSiemens: IconType = React.forwardRef<SVGSVGElement, SiSiemensProps>(function SiSiemens({title = 'Siemens', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSiemens as default, defaultColor };
