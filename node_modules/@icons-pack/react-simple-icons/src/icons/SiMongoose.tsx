    ...
    type SiMongooseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMongoose: IconType = React.forwardRef<SVGSVGElement, SiMongooseProps>(function SiMongoose({title = 'Mongoose', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
