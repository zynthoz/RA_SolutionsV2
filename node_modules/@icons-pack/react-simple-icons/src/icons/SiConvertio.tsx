    ...
    type SiConvertioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConvertio: IconType = React.forwardRef<SVGSVGElement, SiConvertioProps>(function SiConvertio({title = 'Convertio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiConvertio as default, defaultColor };
