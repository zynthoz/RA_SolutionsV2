    ...
    type SiIheartradioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIheartradio: IconType = React.forwardRef<SVGSVGElement, SiIheartradioProps>(function SiIheartradio({title = 'iHeartRadio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIheartradio as default, defaultColor };
