    ...
    type SiArdourProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArdour: IconType = React.forwardRef<SVGSVGElement, SiArdourProps>(function SiArdour({title = 'Ardour', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
