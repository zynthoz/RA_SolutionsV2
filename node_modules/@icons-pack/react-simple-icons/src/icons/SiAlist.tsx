    ...
    type SiAlistProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlist: IconType = React.forwardRef<SVGSVGElement, SiAlistProps>(function SiAlist({title = 'AList', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlist as default, defaultColor };
