    ...
    type SiAgoraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAgora: IconType = React.forwardRef<SVGSVGElement, SiAgoraProps>(function SiAgora({title = 'Agora', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAgora as default, defaultColor };
