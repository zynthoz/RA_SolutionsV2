    ...
    type SiHibobProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHibob: IconType = React.forwardRef<SVGSVGElement, SiHibobProps>(function SiHibob({title = 'Hi Bob', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
