    ...
    type SiConstruct3Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConstruct3: IconType = React.forwardRef<SVGSVGElement, SiConstruct3Props>(function SiConstruct3({title = 'Construct 3', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
