    ...
    type SiHiltonhotelsandresortsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1E4380';

    const SiHiltonhotelsandresorts: IconType = React.forwardRef<SVGSVGElement, SiHiltonhotelsandresortsProps>(function SiHiltonhotelsandresorts({title = 'Hilton Hotels & Resorts', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
