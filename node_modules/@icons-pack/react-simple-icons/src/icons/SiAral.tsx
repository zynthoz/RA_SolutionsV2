    ...
    type SiAralProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAral: IconType = React.forwardRef<SVGSVGElement, SiAralProps>(function SiAral({title = 'ARAL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAral as default, defaultColor };
