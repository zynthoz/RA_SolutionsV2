    ...
    type SiTraccarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTraccar: IconType = React.forwardRef<SVGSVGElement, SiTraccarProps>(function SiTraccar({title = 'Traccar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
