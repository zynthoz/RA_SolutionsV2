    ...
    type SiFoobar2000Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFoobar2000: IconType = React.forwardRef<SVGSVGElement, SiFoobar2000Props>(function SiFoobar2000({title = 'foobar2000', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
