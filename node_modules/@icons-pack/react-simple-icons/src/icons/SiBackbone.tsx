    ...
    type SiBackboneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBackbone: IconType = React.forwardRef<SVGSVGElement, SiBackboneProps>(function SiBackbone({title = 'Backbone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
