    ...
    type Si4dProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si4d: IconType = React.forwardRef<SVGSVGElement, Si4dProps>(function Si4d({title = '4D', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { Si4d as default, defaultColor };
