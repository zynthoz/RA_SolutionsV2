    ...
    type SiNotepadplusplusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#90E59A';

    const SiNotepadplusplus: IconType = React.forwardRef<SVGSVGElement, SiNotepadplusplusProps>(function SiNotepadplusplus({title = 'Notepad++', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNotepadplusplus as default, defaultColor };
