    ...
    type SiCreatereactappProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#09D3AC';

    const SiCreatereactapp: IconType = React.forwardRef<SVGSVGElement, SiCreatereactappProps>(function SiCreatereactapp({title = 'Create React App', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCreatereactapp as default, defaultColor };
