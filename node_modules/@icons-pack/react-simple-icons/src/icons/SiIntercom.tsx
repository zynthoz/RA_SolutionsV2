    ...
    type SiIntercomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIntercom: IconType = React.forwardRef<SVGSVGElement, SiIntercomProps>(function SiIntercom({title = 'Intercom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
