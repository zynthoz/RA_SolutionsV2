    ...
    type SiTqdmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTqdm: IconType = React.forwardRef<SVGSVGElement, SiTqdmProps>(function SiTqdm({title = 'tqdm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
