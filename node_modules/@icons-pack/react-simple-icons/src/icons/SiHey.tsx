    ...
    type SiHeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5522FA';

    const SiHey: IconType = React.forwardRef<SVGSVGElement, SiHeyProps>(function SiHey({title = 'HEY', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHey as default, defaultColor };
