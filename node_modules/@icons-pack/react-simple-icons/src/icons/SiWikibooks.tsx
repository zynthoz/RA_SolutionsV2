    ...
    type SiWikibooksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikibooks: IconType = React.forwardRef<SVGSVGElement, SiWikibooksProps>(function SiWikibooks({title = 'Wikibooks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWikibooks as default, defaultColor };
