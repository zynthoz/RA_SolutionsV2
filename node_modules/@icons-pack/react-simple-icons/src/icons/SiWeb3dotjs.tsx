    ...
    type SiWeb3dotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWeb3dotjs: IconType = React.forwardRef<SVGSVGElement, SiWeb3dotjsProps>(function SiWeb3dotjs({title = 'Web3.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
