    ...
    type SiTopcoderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTopcoder: IconType = React.forwardRef<SVGSVGElement, SiTopcoderProps>(function SiTopcoder({title = 'Topcoder', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTopcoder as default, defaultColor };
