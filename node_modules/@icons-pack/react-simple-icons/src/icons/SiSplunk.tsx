    ...
    type SiSplunkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSplunk: IconType = React.forwardRef<SVGSVGElement, SiSplunkProps>(function SiSplunk({title = 'Splunk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSplunk as default, defaultColor };
