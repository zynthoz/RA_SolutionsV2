    ...
    type SiOpentofuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFDA18';

    const SiOpentofu: IconType = React.forwardRef<SVGSVGElement, SiOpentofuProps>(function SiOpentofu({title = 'OpenTofu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
