    ...
    type SiXfceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiXfce: IconType = React.forwardRef<SVGSVGElement, SiXfceProps>(function SiXfce({title = 'XFCE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
