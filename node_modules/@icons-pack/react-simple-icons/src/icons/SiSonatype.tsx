    ...
    type SiSonatypeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonatype: IconType = React.forwardRef<SVGSVGElement, SiSonatypeProps>(function SiSonatype({title = 'Sonatype', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonatype as default, defaultColor };
