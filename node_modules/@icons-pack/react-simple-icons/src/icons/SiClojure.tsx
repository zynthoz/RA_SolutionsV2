    ...
    type SiClojureProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiClojure: IconType = React.forwardRef<SVGSVGElement, SiClojureProps>(function SiClojure({title = 'Clojure', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiClojure as default, defaultColor };
