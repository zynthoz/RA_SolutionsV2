    ...
    type SiLuoguProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5B9BD5';

    const SiLuogu: IconType = React.forwardRef<SVGSVGElement, SiLuoguProps>(function SiLuogu({title = 'Luogu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLuogu as default, defaultColor };
