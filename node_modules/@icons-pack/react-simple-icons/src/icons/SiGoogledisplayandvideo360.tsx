    ...
    type SiGoogledisplayandvideo360Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledisplayandvideo360: IconType = React.forwardRef<SVGSVGElement, SiGoogledisplayandvideo360Props>(function SiGoogledisplayandvideo360({title = 'Google Display & Video 360', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
