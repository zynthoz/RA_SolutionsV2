    ...
    type SiRavelryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EE6E62';

    const SiRavelry: IconType = React.forwardRef<SVGSVGElement, SiRavelryProps>(function SiRavelry({title = 'Ravelry', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRavelry as default, defaultColor };
