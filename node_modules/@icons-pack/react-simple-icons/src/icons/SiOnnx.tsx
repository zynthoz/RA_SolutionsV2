    ...
    type SiOnnxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#005CED';

    const SiOnnx: IconType = React.forwardRef<SVGSVGElement, SiOnnxProps>(function SiOnnx({title = 'ONNX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOnnx as default, defaultColor };
