    ...
    type SiGooglecastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglecast: IconType = React.forwardRef<SVGSVGElement, SiGooglecastProps>(function SiGooglecast({title = 'Google Cast', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
