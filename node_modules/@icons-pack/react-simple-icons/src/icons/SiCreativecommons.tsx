    ...
    type SiCreativecommonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCreativecommons: IconType = React.forwardRef<SVGSVGElement, SiCreativecommonsProps>(function SiCreativecommons({title = 'Creative Commons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCreativecommons as default, defaultColor };
