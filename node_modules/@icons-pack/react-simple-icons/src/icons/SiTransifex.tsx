    ...
    type SiTransifexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTransifex: IconType = React.forwardRef<SVGSVGElement, SiTransifexProps>(function SiTransifex({title = 'Transifex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
