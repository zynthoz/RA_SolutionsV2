    ...
    type SiFloatplaneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFloatplane: IconType = React.forwardRef<SVGSVGElement, SiFloatplaneProps>(function SiFloatplane({title = 'Floatplane', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
