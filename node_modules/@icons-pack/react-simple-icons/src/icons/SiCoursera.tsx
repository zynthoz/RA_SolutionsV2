    ...
    type SiCourseraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoursera: IconType = React.forwardRef<SVGSVGElement, SiCourseraProps>(function SiCoursera({title = 'Coursera', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
