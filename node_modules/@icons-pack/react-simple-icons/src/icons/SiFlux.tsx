    ...
    type SiFluxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5468FF';

    const SiFlux: IconType = React.forwardRef<SVGSVGElement, SiFluxProps>(function SiFlux({title = 'Flux', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFlux as default, defaultColor };
