    ...
    type SiObtainiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiObtainium: IconType = React.forwardRef<SVGSVGElement, SiObtainiumProps>(function SiObtainium({title = 'Obtainium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
