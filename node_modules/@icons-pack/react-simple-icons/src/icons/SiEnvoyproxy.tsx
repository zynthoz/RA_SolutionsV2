    ...
    type SiEnvoyproxyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEnvoyproxy: IconType = React.forwardRef<SVGSVGElement, SiEnvoyproxyProps>(function SiEnvoyproxy({title = 'Envoy Proxy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEnvoyproxy as default, defaultColor };
