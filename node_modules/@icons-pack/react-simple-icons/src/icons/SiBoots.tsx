    ...
    type SiBootsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#05054B';

    const SiBoots: IconType = React.forwardRef<SVGSVGElement, SiBootsProps>(function SiBoots({title = 'Boots', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBoots as default, defaultColor };
