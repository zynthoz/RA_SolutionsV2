    ...
    type SiLocalxposeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6023C0';

    const SiLocalxpose: IconType = React.forwardRef<SVGSVGElement, SiLocalxposeProps>(function SiLocalxpose({title = 'LocalXpose', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLocalxpose as default, defaultColor };
