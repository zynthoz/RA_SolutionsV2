    ...
    type SiI18nextProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiI18next: IconType = React.forwardRef<SVGSVGElement, SiI18nextProps>(function SiI18next({title = 'i18next', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
