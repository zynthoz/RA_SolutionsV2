    ...
    type SiGoogledocsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledocs: IconType = React.forwardRef<SVGSVGElement, SiGoogledocsProps>(function SiGoogledocs({title = 'Google Docs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogledocs as default, defaultColor };
