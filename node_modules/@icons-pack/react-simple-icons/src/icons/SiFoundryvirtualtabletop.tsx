    ...
    type SiFoundryvirtualtabletopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFoundryvirtualtabletop: IconType = React.forwardRef<SVGSVGElement, SiFoundryvirtualtabletopProps>(function SiFoundryvirtualtabletop({title = 'Foundry Virtual Tabletop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
