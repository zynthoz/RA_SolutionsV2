    ...
    type SiIfoodProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EA1D2C';

    const SiIfood: IconType = React.forwardRef<SVGSVGElement, SiIfoodProps>(function SiIfood({title = 'iFood', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIfood as default, defaultColor };
