    ...
    type SiMisskeyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#A1CA03';

    const SiMisskey: IconType = React.forwardRef<SVGSVGElement, SiMisskeyProps>(function SiMisskey({title = 'Misskey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMisskey as default, defaultColor };
