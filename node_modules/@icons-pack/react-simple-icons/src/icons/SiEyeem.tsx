    ...
    type SiEyeemProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEyeem: IconType = React.forwardRef<SVGSVGElement, SiEyeemProps>(function SiEyeem({title = 'EyeEm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEyeem as default, defaultColor };
