    ...
    type SiEsriProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEsri: IconType = React.forwardRef<SVGSVGElement, SiEsriProps>(function SiEsri({title = 'ESRI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
