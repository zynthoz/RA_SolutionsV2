    ...
    type SiPhotonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#004480';

    const SiPhoton: IconType = React.forwardRef<SVGSVGElement, SiPhotonProps>(function SiPhoton({title = 'Photon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPhoton as default, defaultColor };
