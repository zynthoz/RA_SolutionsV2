    ...
    type SiFilloutProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFillout: IconType = React.forwardRef<SVGSVGElement, SiFilloutProps>(function SiFillout({title = 'Fillout', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
