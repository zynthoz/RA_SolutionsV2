    ...
    type SiHyundaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHyundai: IconType = React.forwardRef<SVGSVGElement, SiHyundaiProps>(function SiHyundai({title = 'Hyundai', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHyundai as default, defaultColor };
