    ...
    type SiSuperuserProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#38A1CE';

    const SiSuperuser: IconType = React.forwardRef<SVGSVGElement, SiSuperuserProps>(function SiSuperuser({title = 'Super User', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
