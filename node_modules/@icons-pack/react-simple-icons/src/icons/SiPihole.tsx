    ...
    type SiPiholeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPihole: IconType = React.forwardRef<SVGSVGElement, SiPiholeProps>(function SiPihole({title = 'Pi-hole', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPihole as default, defaultColor };
