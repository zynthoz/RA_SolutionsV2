    ...
    type SiNubankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#820AD1';

    const SiNubank: IconType = React.forwardRef<SVGSVGElement, SiNubankProps>(function SiNubank({title = 'Nubank', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNubank as default, defaultColor };
