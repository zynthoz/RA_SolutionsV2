    ...
    type SiImagetoolboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImagetoolbox: IconType = React.forwardRef<SVGSVGElement, SiImagetoolboxProps>(function SiImagetoolbox({title = 'Image Toolbox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
