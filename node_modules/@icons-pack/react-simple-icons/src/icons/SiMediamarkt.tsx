    ...
    type SiMediamarktProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMediamarkt: IconType = React.forwardRef<SVGSVGElement, SiMediamarktProps>(function SiMediamarkt({title = 'MediaMarkt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMediamarkt as default, defaultColor };
