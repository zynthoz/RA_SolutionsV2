    ...
    type SiTealProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#005149';

    const SiTeal: IconType = React.forwardRef<SVGSVGElement, SiTealProps>(function SiTeal({title = 'Teal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTeal as default, defaultColor };
