    ...
    type SiPeerlistProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPeerlist: IconType = React.forwardRef<SVGSVGElement, SiPeerlistProps>(function SiPeerlist({title = 'Peerlist', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
