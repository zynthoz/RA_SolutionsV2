    ...
    type SiMeweProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMewe: IconType = React.forwardRef<SVGSVGElement, SiMeweProps>(function SiMewe({title = 'MeWe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMewe as default, defaultColor };
