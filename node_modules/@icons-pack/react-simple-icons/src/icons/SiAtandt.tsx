    ...
    type SiAtandtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAtandt: IconType = React.forwardRef<SVGSVGElement, SiAtandtProps>(function SiAtandt({title = 'AT&T', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAtandt as default, defaultColor };
