    ...
    type SiSolidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSolid: IconType = React.forwardRef<SVGSVGElement, SiSolidProps>(function SiSolid({title = 'Solid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
