    ...
    type SiDisrootProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#50162D';

    const SiDisroot: IconType = React.forwardRef<SVGSVGElement, SiDisrootProps>(function SiDisroot({title = 'Disroot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDisroot as default, defaultColor };
