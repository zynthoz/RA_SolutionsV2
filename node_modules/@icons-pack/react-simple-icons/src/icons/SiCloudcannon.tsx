    ...
    type SiCloudcannonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCloudcannon: IconType = React.forwardRef<SVGSVGElement, SiCloudcannonProps>(function SiCloudcannon({title = 'CloudCannon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
