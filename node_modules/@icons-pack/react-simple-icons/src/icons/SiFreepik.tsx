    ...
    type SiFreepikProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFreepik: IconType = React.forwardRef<SVGSVGElement, SiFreepikProps>(function SiFreepik({title = 'Freepik', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
