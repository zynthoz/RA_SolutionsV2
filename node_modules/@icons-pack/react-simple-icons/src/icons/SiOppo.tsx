    ...
    type SiOppoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOppo: IconType = React.forwardRef<SVGSVGElement, SiOppoProps>(function SiOppo({title = 'OPPO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
