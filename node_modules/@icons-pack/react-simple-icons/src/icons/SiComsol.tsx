    ...
    type SiComsolProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#368CCB';

    const SiComsol: IconType = React.forwardRef<SVGSVGElement, SiComsolProps>(function SiComsol({title = 'Comsol', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiComsol as default, defaultColor };
