    ...
    type SiBsdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBsd: IconType = React.forwardRef<SVGSVGElement, SiBsdProps>(function SiBsd({title = 'BSD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
