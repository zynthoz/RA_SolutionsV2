    ...
    type SiCheckioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCheckio: IconType = React.forwardRef<SVGSVGElement, SiCheckioProps>(function SiCheckio({title = 'CheckiO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
