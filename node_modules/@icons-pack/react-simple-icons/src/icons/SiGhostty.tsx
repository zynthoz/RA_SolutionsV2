    ...
    type SiGhosttyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGhostty: IconType = React.forwardRef<SVGSVGElement, SiGhosttyProps>(function SiGhostty({title = 'Ghostty', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGhostty as default, defaultColor };
