    ...
    type Si99designsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si99designs: IconType = React.forwardRef<SVGSVGElement, Si99designsProps>(function Si99designs({title = '99designs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
