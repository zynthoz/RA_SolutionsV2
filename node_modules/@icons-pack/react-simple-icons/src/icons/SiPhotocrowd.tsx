    ...
    type SiPhotocrowdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3DAD4B';

    const SiPhotocrowd: IconType = React.forwardRef<SVGSVGElement, SiPhotocrowdProps>(function SiPhotocrowd({title = 'Photocrowd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
