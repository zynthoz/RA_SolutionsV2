    ...
    type SiCookiecutterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCookiecutter: IconType = React.forwardRef<SVGSVGElement, SiCookiecutterProps>(function SiCookiecutter({title = 'Cookiecutter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
