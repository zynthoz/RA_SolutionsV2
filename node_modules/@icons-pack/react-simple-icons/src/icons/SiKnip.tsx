    ...
    type SiKnipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKnip: IconType = React.forwardRef<SVGSVGElement, SiKnipProps>(function SiKnip({title = 'Knip', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
