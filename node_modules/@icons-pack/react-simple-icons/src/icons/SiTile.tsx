    ...
    type SiTileProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTile: IconType = React.forwardRef<SVGSVGElement, SiTileProps>(function SiTile({title = 'Tile', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
