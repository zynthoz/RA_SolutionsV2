    ...
    type SiSongkickProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSongkick: IconType = React.forwardRef<SVGSVGElement, SiSongkickProps>(function SiSongkick({title = 'Songkick', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
