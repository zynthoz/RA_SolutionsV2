    ...
    type SiTermiusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTermius: IconType = React.forwardRef<SVGSVGElement, SiTermiusProps>(function SiTermius({title = 'Termius', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
