    ...
    type SiCodebergProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodeberg: IconType = React.forwardRef<SVGSVGElement, SiCodebergProps>(function SiCodeberg({title = 'Codeberg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
