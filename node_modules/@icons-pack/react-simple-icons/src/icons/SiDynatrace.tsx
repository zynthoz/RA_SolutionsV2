    ...
    type SiDynatraceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDynatrace: IconType = React.forwardRef<SVGSVGElement, SiDynatraceProps>(function SiDynatrace({title = 'Dynatrace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
