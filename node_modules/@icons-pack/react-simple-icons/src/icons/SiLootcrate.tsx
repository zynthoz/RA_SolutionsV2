    ...
    type SiLootcrateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLootcrate: IconType = React.forwardRef<SVGSVGElement, SiLootcrateProps>(function SiLootcrate({title = 'Loot Crate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLootcrate as default, defaultColor };
