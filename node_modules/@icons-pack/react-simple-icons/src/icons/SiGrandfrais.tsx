    ...
    type SiGrandfraisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED2D2F';

    const SiGrandfrais: IconType = React.forwardRef<SVGSVGElement, SiGrandfraisProps>(function SiGrandfrais({title = 'Grand Frais', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGrandfrais as default, defaultColor };
