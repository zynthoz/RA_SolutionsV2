    ...
    type SiZazzleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZazzle: IconType = React.forwardRef<SVGSVGElement, SiZazzleProps>(function SiZazzle({title = 'Zazzle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
