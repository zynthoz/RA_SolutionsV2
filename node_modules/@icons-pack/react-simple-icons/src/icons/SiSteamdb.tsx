    ...
    type SiSteamdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSteamdb: IconType = React.forwardRef<SVGSVGElement, SiSteamdbProps>(function SiSteamdb({title = 'SteamDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
