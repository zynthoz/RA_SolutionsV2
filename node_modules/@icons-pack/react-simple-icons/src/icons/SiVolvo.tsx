    ...
    type SiVolvoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVolvo: IconType = React.forwardRef<SVGSVGElement, SiVolvoProps>(function SiVolvo({title = 'Volvo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVolvo as default, defaultColor };
