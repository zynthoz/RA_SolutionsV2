    ...
    type SiSat1Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSat1: IconType = React.forwardRef<SVGSVGElement, SiSat1Props>(function SiSat1({title = 'Sat.1', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
