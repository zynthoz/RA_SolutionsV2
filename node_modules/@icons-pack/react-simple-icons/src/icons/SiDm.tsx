    ...
    type SiDmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDm: IconType = React.forwardRef<SVGSVGElement, SiDmProps>(function SiDm({title = 'dm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
