    ...
    type SiKalilinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKalilinux: IconType = React.forwardRef<SVGSVGElement, SiKalilinuxProps>(function SiKalilinux({title = 'Kali Linux', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKalilinux as default, defaultColor };
