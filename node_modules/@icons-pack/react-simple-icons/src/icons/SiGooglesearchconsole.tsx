    ...
    type SiGooglesearchconsoleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#458CF5';

    const SiGooglesearchconsole: IconType = React.forwardRef<SVGSVGElement, SiGooglesearchconsoleProps>(function SiGooglesearchconsole({title = 'Google Search Console', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGooglesearchconsole as default, defaultColor };
