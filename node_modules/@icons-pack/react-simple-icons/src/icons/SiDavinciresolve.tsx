    ...
    type SiDavinciresolveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDavinciresolve: IconType = React.forwardRef<SVGSVGElement, SiDavinciresolveProps>(function SiDavinciresolve({title = 'DaVinci Resolve', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDavinciresolve as default, defaultColor };
