    ...
    type SiApachegroovyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachegroovy: IconType = React.forwardRef<SVGSVGElement, SiApachegroovyProps>(function SiApachegroovy({title = 'Apache Groovy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
