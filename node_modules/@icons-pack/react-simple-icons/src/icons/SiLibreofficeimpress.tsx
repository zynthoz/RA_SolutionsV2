    ...
    type SiLibreofficeimpressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLibreofficeimpress: IconType = React.forwardRef<SVGSVGElement, SiLibreofficeimpressProps>(function SiLibreofficeimpress({title = 'LibreOffice Impress', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
