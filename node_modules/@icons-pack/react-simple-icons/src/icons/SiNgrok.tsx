    ...
    type SiNgrokProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNgrok: IconType = React.forwardRef<SVGSVGElement, SiNgrokProps>(function SiNgrok({title = 'ngrok', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
