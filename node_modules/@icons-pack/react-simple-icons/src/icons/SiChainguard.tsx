    ...
    type SiChainguardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChainguard: IconType = React.forwardRef<SVGSVGElement, SiChainguardProps>(function SiChainguard({title = 'Chainguard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
