    ...
    type SiBiolinkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBiolink: IconType = React.forwardRef<SVGSVGElement, SiBiolinkProps>(function SiBiolink({title = 'Bio Link', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
