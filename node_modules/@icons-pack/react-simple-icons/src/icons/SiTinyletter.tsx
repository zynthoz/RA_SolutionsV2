    ...
    type SiTinyletterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTinyletter: IconType = React.forwardRef<SVGSVGElement, SiTinyletterProps>(function SiTinyletter({title = 'TinyLetter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
