    ...
    type SiRubocopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRubocop: IconType = React.forwardRef<SVGSVGElement, SiRubocopProps>(function SiRubocop({title = 'RuboCop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
