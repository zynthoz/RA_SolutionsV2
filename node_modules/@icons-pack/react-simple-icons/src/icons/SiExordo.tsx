    ...
    type SiExordoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiExordo: IconType = React.forwardRef<SVGSVGElement, SiExordoProps>(function SiExordo({title = 'Exordo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
