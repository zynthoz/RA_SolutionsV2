    ...
    type SiYamahamotorcorporationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYamahamotorcorporation: IconType = React.forwardRef<SVGSVGElement, SiYamahamotorcorporationProps>(function SiYamahamotorcorporation({title = 'Yamaha Motor Corporation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
