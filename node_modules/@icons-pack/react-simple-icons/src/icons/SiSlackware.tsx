    ...
    type SiSlackwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSlackware: IconType = React.forwardRef<SVGSVGElement, SiSlackwareProps>(function SiSlackware({title = 'Slackware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
