    ...
    type SiWellsfargoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D71E28';

    const SiWellsfargo: IconType = React.forwardRef<SVGSVGElement, SiWellsfargoProps>(function SiWellsfargo({title = 'Wells Fargo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWellsfargo as default, defaultColor };
