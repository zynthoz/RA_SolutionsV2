    ...
    type SiThesoundsresourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThesoundsresource: IconType = React.forwardRef<SVGSVGElement, SiThesoundsresourceProps>(function SiThesoundsresource({title = 'The Sounds Resource', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
