    ...
    type SiScrumallianceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009FDA';

    const SiScrumalliance: IconType = React.forwardRef<SVGSVGElement, SiScrumallianceProps>(function SiScrumalliance({title = 'Scrum Alliance', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
