    ...
    type SiIndigoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#09009B';

    const SiIndigo: IconType = React.forwardRef<SVGSVGElement, SiIndigoProps>(function SiIndigo({title = 'IndiGo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
