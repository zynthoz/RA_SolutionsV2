    ...
    type SiMampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#02749C';

    const SiMamp: IconType = React.forwardRef<SVGSVGElement, SiMampProps>(function SiMamp({title = 'MAMP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
