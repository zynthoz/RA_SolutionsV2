    ...
    type SiGuitarproProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#569FFF';

    const SiGuitarpro: IconType = React.forwardRef<SVGSVGElement, SiGuitarproProps>(function SiGuitarpro({title = 'Guitar Pro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGuitarpro as default, defaultColor };
