    ...
    type SiSamsungProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSamsung: IconType = React.forwardRef<SVGSVGElement, SiSamsungProps>(function SiSamsung({title = 'Samsung', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSamsung as default, defaultColor };
