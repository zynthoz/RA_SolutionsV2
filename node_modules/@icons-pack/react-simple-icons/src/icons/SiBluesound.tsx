    ...
    type SiBluesoundProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBluesound: IconType = React.forwardRef<SVGSVGElement, SiBluesoundProps>(function SiBluesound({title = 'Bluesound', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBluesound as default, defaultColor };
