    ...
    type SiRoboflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRoboflow: IconType = React.forwardRef<SVGSVGElement, SiRoboflowProps>(function SiRoboflow({title = 'Roboflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
