    ...
    type SiLeicaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLeica: IconType = React.forwardRef<SVGSVGElement, SiLeicaProps>(function SiLeica({title = 'Leica', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLeica as default, defaultColor };
