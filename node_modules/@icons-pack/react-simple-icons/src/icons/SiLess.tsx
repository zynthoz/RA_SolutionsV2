    ...
    type SiLessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLess: IconType = React.forwardRef<SVGSVGElement, SiLessProps>(function SiLess({title = 'Less', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLess as default, defaultColor };
