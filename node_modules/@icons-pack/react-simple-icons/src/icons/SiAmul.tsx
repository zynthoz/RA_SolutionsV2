    ...
    type SiAmulProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED1D24';

    const SiAmul: IconType = React.forwardRef<SVGSVGElement, SiAmulProps>(function SiAmul({title = 'Amul', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
