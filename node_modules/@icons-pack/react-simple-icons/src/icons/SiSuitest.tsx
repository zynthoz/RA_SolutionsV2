    ...
    type SiSuitestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F06060';

    const SiSuitest: IconType = React.forwardRef<SVGSVGElement, SiSuitestProps>(function SiSuitest({title = 'Suitest', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSuitest as default, defaultColor };
