    ...
    type SiPaddlepaddleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaddlepaddle: IconType = React.forwardRef<SVGSVGElement, SiPaddlepaddleProps>(function SiPaddlepaddle({title = 'PaddlePaddle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPaddlepaddle as default, defaultColor };
