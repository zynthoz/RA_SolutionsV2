    ...
    type SiRocksdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRocksdb: IconType = React.forwardRef<SVGSVGElement, SiRocksdbProps>(function SiRocksdb({title = 'RocksDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
