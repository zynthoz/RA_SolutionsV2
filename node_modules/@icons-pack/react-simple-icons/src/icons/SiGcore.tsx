    ...
    type SiGcoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF4C00';

    const SiGcore: IconType = React.forwardRef<SVGSVGElement, SiGcoreProps>(function SiGcore({title = 'Gcore', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGcore as default, defaultColor };
