    ...
    type SiFortinetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFortinet: IconType = React.forwardRef<SVGSVGElement, SiFortinetProps>(function SiFortinet({title = 'Fortinet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
