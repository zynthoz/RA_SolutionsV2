    ...
    type SiCommaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiComma: IconType = React.forwardRef<SVGSVGElement, SiCommaProps>(function SiComma({title = 'comma', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiComma as default, defaultColor };
