    ...
    type SiMicroeditorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicroeditor: IconType = React.forwardRef<SVGSVGElement, SiMicroeditorProps>(function SiMicroeditor({title = 'Micro Editor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicroeditor as default, defaultColor };
