    ...
    type SiNeptuneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNeptune: IconType = React.forwardRef<SVGSVGElement, SiNeptuneProps>(function SiNeptune({title = 'Neptune', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
