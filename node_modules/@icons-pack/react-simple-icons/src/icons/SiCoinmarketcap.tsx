    ...
    type SiCoinmarketcapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoinmarketcap: IconType = React.forwardRef<SVGSVGElement, SiCoinmarketcapProps>(function SiCoinmarketcap({title = 'CoinMarketCap', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
