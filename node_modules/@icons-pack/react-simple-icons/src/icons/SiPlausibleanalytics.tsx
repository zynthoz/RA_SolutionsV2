    ...
    type SiPlausibleanalyticsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5850EC';

    const SiPlausibleanalytics: IconType = React.forwardRef<SVGSVGElement, SiPlausibleanalyticsProps>(function SiPlausibleanalytics({title = 'Plausible Analytics', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlausibleanalytics as default, defaultColor };
