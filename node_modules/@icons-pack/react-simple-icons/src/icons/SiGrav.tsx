    ...
    type SiGravProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGrav: IconType = React.forwardRef<SVGSVGElement, SiGravProps>(function SiGrav({title = 'Grav', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGrav as default, defaultColor };
