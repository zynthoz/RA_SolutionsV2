    ...
    type SiRaycastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF6363';

    const SiRaycast: IconType = React.forwardRef<SVGSVGElement, SiRaycastProps>(function SiRaycast({title = 'Raycast', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRaycast as default, defaultColor };
