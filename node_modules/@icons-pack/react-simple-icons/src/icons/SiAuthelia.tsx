    ...
    type SiAutheliaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAuthelia: IconType = React.forwardRef<SVGSVGElement, SiAutheliaProps>(function SiAuthelia({title = 'Authelia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
