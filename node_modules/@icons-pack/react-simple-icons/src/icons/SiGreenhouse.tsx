    ...
    type SiGreenhouseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGreenhouse: IconType = React.forwardRef<SVGSVGElement, SiGreenhouseProps>(function SiGreenhouse({title = 'Greenhouse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGreenhouse as default, defaultColor };
