    ...
    type SiDblpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDblp: IconType = React.forwardRef<SVGSVGElement, SiDblpProps>(function SiDblp({title = 'dblp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
