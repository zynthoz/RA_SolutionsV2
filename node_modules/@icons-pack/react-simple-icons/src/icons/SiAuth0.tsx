    ...
    type SiAuth0Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAuth0: IconType = React.forwardRef<SVGSVGElement, SiAuth0Props>(function SiAuth0({title = 'Auth0', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
