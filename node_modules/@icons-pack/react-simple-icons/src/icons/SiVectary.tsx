    ...
    type SiVectaryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6100FF';

    const SiVectary: IconType = React.forwardRef<SVGSVGElement, SiVectaryProps>(function SiVectary({title = 'Vectary', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVectary as default, defaultColor };
