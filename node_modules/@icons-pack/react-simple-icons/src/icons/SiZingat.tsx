    ...
    type SiZingatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009CFB';

    const SiZingat: IconType = React.forwardRef<SVGSVGElement, SiZingatProps>(function SiZingat({title = 'Zingat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZingat as default, defaultColor };
