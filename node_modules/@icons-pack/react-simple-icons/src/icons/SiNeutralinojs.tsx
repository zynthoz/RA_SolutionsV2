    ...
    type SiNeutralinojsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F89901';

    const SiNeutralinojs: IconType = React.forwardRef<SVGSVGElement, SiNeutralinojsProps>(function SiNeutralinojs({title = 'Neutralinojs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
