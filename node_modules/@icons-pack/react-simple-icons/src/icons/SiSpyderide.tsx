    ...
    type SiSpyderideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#8C0000';

    const SiSpyderide: IconType = React.forwardRef<SVGSVGElement, SiSpyderideProps>(function SiSpyderide({title = 'Spyder IDE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpyderide as default, defaultColor };
