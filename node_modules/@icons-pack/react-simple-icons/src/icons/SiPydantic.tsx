    ...
    type SiPydanticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E92063';

    const SiPydantic: IconType = React.forwardRef<SVGSVGElement, SiPydanticProps>(function SiPydantic({title = 'Pydantic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPydantic as default, defaultColor };
