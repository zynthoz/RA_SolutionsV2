    ...
    type SiOdooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#714B67';

    const SiOdoo: IconType = React.forwardRef<SVGSVGElement, SiOdooProps>(function SiOdoo({title = 'Odoo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOdoo as default, defaultColor };
