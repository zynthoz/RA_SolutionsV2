    ...
    type SiFalconProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F0AD4E';

    const SiFalcon: IconType = React.forwardRef<SVGSVGElement, SiFalconProps>(function SiFalcon({title = 'Falcon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFalcon as default, defaultColor };
