    ...
    type SiApachefreemarkerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachefreemarker: IconType = React.forwardRef<SVGSVGElement, SiApachefreemarkerProps>(function SiApachefreemarker({title = 'Apache FreeMarker', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
