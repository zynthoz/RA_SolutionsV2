    ...
    type SiLiberapayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLiberapay: IconType = React.forwardRef<SVGSVGElement, SiLiberapayProps>(function SiLiberapay({title = 'Liberapay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
