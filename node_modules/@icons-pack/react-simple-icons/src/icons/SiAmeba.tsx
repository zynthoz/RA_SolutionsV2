    ...
    type SiAmebaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmeba: IconType = React.forwardRef<SVGSVGElement, SiAmebaProps>(function SiAmeba({title = 'Ameba', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
