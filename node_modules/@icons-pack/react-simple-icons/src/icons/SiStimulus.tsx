    ...
    type SiStimulusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStimulus: IconType = React.forwardRef<SVGSVGElement, SiStimulusProps>(function SiStimulus({title = 'Stimulus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
