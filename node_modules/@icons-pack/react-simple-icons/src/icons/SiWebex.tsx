    ...
    type SiWebexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebex: IconType = React.forwardRef<SVGSVGElement, SiWebexProps>(function SiWebex({title = 'Webex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebex as default, defaultColor };
