    ...
    type SiHpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHp: IconType = React.forwardRef<SVGSVGElement, SiHpProps>(function SiHp({title = 'HP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHp as default, defaultColor };
