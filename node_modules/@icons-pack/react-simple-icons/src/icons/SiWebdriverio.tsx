    ...
    type SiWebdriverioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebdriverio: IconType = React.forwardRef<SVGSVGElement, SiWebdriverioProps>(function SiWebdriverio({title = 'WebdriverIO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
