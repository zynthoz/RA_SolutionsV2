    ...
    type SiOsfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOsf: IconType = React.forwardRef<SVGSVGElement, SiOsfProps>(function SiOsf({title = 'OSF', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
