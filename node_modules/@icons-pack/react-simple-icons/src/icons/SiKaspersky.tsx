    ...
    type SiKasperskyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKaspersky: IconType = React.forwardRef<SVGSVGElement, SiKasperskyProps>(function SiKaspersky({title = 'Kaspersky', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
