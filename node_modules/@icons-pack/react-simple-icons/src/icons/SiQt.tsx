    ...
    type SiQtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#41CD52';

    const SiQt: IconType = React.forwardRef<SVGSVGElement, SiQtProps>(function SiQt({title = 'Qt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQt as default, defaultColor };
