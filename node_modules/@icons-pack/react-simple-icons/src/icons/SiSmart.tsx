    ...
    type SiSmartProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D7E600';

    const SiSmart: IconType = React.forwardRef<SVGSVGElement, SiSmartProps>(function SiSmart({title = 'smart', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
