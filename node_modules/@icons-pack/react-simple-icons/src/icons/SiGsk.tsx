    ...
    type SiGskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F36633';

    const SiGsk: IconType = React.forwardRef<SVGSVGElement, SiGskProps>(function SiGsk({title = 'GSK', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGsk as default, defaultColor };
