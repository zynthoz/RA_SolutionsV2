    ...
    type SiPearsonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPearson: IconType = React.forwardRef<SVGSVGElement, SiPearsonProps>(function SiPearson({title = 'Pearson', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
