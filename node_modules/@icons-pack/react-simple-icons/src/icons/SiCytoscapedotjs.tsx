    ...
    type SiCytoscapedotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCytoscapedotjs: IconType = React.forwardRef<SVGSVGElement, SiCytoscapedotjsProps>(function SiCytoscapedotjs({title = 'Cytoscape.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCytoscapedotjs as default, defaultColor };
