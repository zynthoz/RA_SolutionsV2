    ...
    type SiZapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZap: IconType = React.forwardRef<SVGSVGElement, SiZapProps>(function SiZap({title = 'ZAP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
