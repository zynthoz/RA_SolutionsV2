    ...
    type SiFairphoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFairphone: IconType = React.forwardRef<SVGSVGElement, SiFairphoneProps>(function SiFairphone({title = 'Fairphone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFairphone as default, defaultColor };
