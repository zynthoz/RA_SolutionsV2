    ...
    type SiThespritersresourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BE3939';

    const SiThespritersresource: IconType = React.forwardRef<SVGSVGElement, SiThespritersresourceProps>(function SiThespritersresource({title = 'The Spriters Resource', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiThespritersresource as default, defaultColor };
