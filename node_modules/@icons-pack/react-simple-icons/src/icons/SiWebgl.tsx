    ...
    type SiWebglProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebgl: IconType = React.forwardRef<SVGSVGElement, SiWebglProps>(function SiWebgl({title = 'WebGL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
