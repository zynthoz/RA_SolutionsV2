    ...
    type SiJordanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJordan: IconType = React.forwardRef<SVGSVGElement, SiJordanProps>(function SiJordan({title = 'Jordan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
