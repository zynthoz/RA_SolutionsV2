    ...
    type SiNapsterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2259FF';

    const SiNapster: IconType = React.forwardRef<SVGSVGElement, SiNapsterProps>(function SiNapster({title = 'Napster', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNapster as default, defaultColor };
