    ...
    type SiHalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHal: IconType = React.forwardRef<SVGSVGElement, SiHalProps>(function SiHal({title = 'HAL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
