    ...
    type SiHumblebundleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CC2929';

    const SiHumblebundle: IconType = React.forwardRef<SVGSVGElement, SiHumblebundleProps>(function SiHumblebundle({title = 'Humble Bundle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHumblebundle as default, defaultColor };
