    ...
    type SiYabaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00364B';

    const SiYabai: IconType = React.forwardRef<SVGSVGElement, SiYabaiProps>(function SiYabai({title = 'yabai', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
