    ...
    type SiCraftcmsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCraftcms: IconType = React.forwardRef<SVGSVGElement, SiCraftcmsProps>(function SiCraftcms({title = 'Craft CMS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
