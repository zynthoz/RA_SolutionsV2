    ...
    type SiGotomeetingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGotomeeting: IconType = React.forwardRef<SVGSVGElement, SiGotomeetingProps>(function SiGotomeeting({title = 'GoToMeeting', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
