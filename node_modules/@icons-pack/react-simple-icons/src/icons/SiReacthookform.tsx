    ...
    type SiReacthookformProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReacthookform: IconType = React.forwardRef<SVGSVGElement, SiReacthookformProps>(function SiReacthookform({title = 'React Hook Form', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
