    ...
    type SiCounterstrikeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCounterstrike: IconType = React.forwardRef<SVGSVGElement, SiCounterstrikeProps>(function SiCounterstrike({title = 'Counter-Strike', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
