    ...
    type SiAutodeskmayaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutodeskmaya: IconType = React.forwardRef<SVGSVGElement, SiAutodeskmayaProps>(function SiAutodeskmaya({title = 'Autodesk Maya', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAutodeskmaya as default, defaultColor };
