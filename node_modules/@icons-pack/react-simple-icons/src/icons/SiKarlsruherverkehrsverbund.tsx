    ...
    type SiKarlsruherverkehrsverbundProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#9B2321';

    const SiKarlsruherverkehrsverbund: IconType = React.forwardRef<SVGSVGElement, SiKarlsruherverkehrsverbundProps>(function SiKarlsruherverkehrsverbund({title = 'Karlsruher Verkehrsverbund', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKarlsruherverkehrsverbund as default, defaultColor };
