    ...
    type SiReaddotcvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReaddotcv: IconType = React.forwardRef<SVGSVGElement, SiReaddotcvProps>(function SiReaddotcv({title = 'Read.cv', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiReaddotcv as default, defaultColor };
