    ...
    type SiMdxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMdx: IconType = React.forwardRef<SVGSVGElement, SiMdxProps>(function SiMdx({title = 'MDX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
