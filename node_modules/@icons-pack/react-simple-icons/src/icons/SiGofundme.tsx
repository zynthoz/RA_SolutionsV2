    ...
    type SiGofundmeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGofundme: IconType = React.forwardRef<SVGSVGElement, SiGofundmeProps>(function SiGofundme({title = 'GoFundMe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
