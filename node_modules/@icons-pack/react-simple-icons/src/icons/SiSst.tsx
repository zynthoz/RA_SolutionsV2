    ...
    type SiSstProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E27152';

    const SiSst: IconType = React.forwardRef<SVGSVGElement, SiSstProps>(function SiSst({title = 'SST', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSst as default, defaultColor };
