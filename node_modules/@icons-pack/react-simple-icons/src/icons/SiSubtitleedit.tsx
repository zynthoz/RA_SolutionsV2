    ...
    type SiSubtitleeditProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CC2424';

    const SiSubtitleedit: IconType = React.forwardRef<SVGSVGElement, SiSubtitleeditProps>(function SiSubtitleedit({title = 'Subtitle Edit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
