    ...
    type SiOrgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOrg: IconType = React.forwardRef<SVGSVGElement, SiOrgProps>(function SiOrg({title = 'Org', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
