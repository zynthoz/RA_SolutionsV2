    ...
    type SiOneplusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOneplus: IconType = React.forwardRef<SVGSVGElement, SiOneplusProps>(function SiOneplus({title = 'OnePlus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
