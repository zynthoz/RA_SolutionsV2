    ...
    type SiSphinxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSphinx: IconType = React.forwardRef<SVGSVGElement, SiSphinxProps>(function SiSphinx({title = 'Sphinx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSphinx as default, defaultColor };
