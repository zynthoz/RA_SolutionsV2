    ...
    type SiGoogleformsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleforms: IconType = React.forwardRef<SVGSVGElement, SiGoogleformsProps>(function SiGoogleforms({title = 'Google Forms', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogleforms as default, defaultColor };
