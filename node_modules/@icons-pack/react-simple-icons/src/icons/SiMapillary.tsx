    ...
    type SiMapillaryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMapillary: IconType = React.forwardRef<SVGSVGElement, SiMapillaryProps>(function SiMapillary({title = 'Mapillary', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
