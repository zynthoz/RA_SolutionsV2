    ...
    type SiEsotericsoftwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEsotericsoftware: IconType = React.forwardRef<SVGSVGElement, SiEsotericsoftwareProps>(function SiEsotericsoftware({title = 'Esoteric Software', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
