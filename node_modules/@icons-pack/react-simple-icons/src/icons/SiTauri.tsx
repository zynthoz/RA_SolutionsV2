    ...
    type SiTauriProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#24C8D8';

    const SiTauri: IconType = React.forwardRef<SVGSVGElement, SiTauriProps>(function SiTauri({title = 'Tauri', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTauri as default, defaultColor };
