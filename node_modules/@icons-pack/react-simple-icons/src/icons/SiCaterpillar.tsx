    ...
    type SiCaterpillarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaterpillar: IconType = React.forwardRef<SVGSVGElement, SiCaterpillarProps>(function SiCaterpillar({title = 'Caterpillar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
