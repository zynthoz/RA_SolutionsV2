    ...
    type SiJaegerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#66CFE3';

    const SiJaeger: IconType = React.forwardRef<SVGSVGElement, SiJaegerProps>(function SiJaeger({title = 'Jaeger', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
