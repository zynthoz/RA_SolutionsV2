    ...
    type SiKodiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKodi: IconType = React.forwardRef<SVGSVGElement, SiKodiProps>(function SiKodi({title = 'Kodi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
