    ...
    type SiOkxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOkx: IconType = React.forwardRef<SVGSVGElement, SiOkxProps>(function SiOkx({title = 'OKX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
