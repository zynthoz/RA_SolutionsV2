    ...
    type SiRedmineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedmine: IconType = React.forwardRef<SVGSVGElement, SiRedmineProps>(function SiRedmine({title = 'Redmine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
