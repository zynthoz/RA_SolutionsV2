    ...
    type SiTinaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTina: IconType = React.forwardRef<SVGSVGElement, SiTinaProps>(function SiTina({title = 'Tina', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
