    ...
    type SiBudibaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBudibase: IconType = React.forwardRef<SVGSVGElement, SiBudibaseProps>(function SiBudibase({title = 'Budibase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
