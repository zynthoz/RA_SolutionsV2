    ...
    type SiThymeleafProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThymeleaf: IconType = React.forwardRef<SVGSVGElement, SiThymeleafProps>(function SiThymeleaf({title = 'Thymeleaf', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
