    ...
    type SiUbuntumateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#84A454';

    const SiUbuntumate: IconType = React.forwardRef<SVGSVGElement, SiUbuntumateProps>(function SiUbuntumate({title = 'Ubuntu MATE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUbuntumate as default, defaultColor };
