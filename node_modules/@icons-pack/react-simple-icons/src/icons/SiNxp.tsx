    ...
    type SiNxpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNxp: IconType = React.forwardRef<SVGSVGElement, SiNxpProps>(function SiNxp({title = 'NXP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
