    ...
    type SiAcmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAcm: IconType = React.forwardRef<SVGSVGElement, SiAcmProps>(function SiAcm({title = 'ACM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAcm as default, defaultColor };
