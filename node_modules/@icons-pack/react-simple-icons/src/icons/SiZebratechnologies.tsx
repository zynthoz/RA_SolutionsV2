    ...
    type SiZebratechnologiesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZebratechnologies: IconType = React.forwardRef<SVGSVGElement, SiZebratechnologiesProps>(function SiZebratechnologies({title = 'Zebra Technologies', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
