    ...
    type SiImdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImdb: IconType = React.forwardRef<SVGSVGElement, SiImdbProps>(function SiImdb({title = 'IMDb', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiImdb as default, defaultColor };
