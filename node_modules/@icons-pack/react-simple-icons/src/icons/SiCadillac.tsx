    ...
    type SiCadillacProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCadillac: IconType = React.forwardRef<SVGSVGElement, SiCadillacProps>(function SiCadillac({title = 'Cadillac', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
