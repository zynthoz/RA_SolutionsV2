    ...
    type SiHiveBlockchainProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHiveBlockchain: IconType = React.forwardRef<SVGSVGElement, SiHiveBlockchainProps>(function SiHiveBlockchain({title = 'Hive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
