    ...
    type SiGoogleadsenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleadsense: IconType = React.forwardRef<SVGSVGElement, SiGoogleadsenseProps>(function SiGoogleadsense({title = 'Google AdSense', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
