    ...
    type SiVivinoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVivino: IconType = React.forwardRef<SVGSVGElement, SiVivinoProps>(function SiVivino({title = 'Vivino', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
