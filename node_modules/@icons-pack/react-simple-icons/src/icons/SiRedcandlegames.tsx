    ...
    type SiRedcandlegamesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D23735';

    const SiRedcandlegames: IconType = React.forwardRef<SVGSVGElement, SiRedcandlegamesProps>(function SiRedcandlegames({title = 'Red Candle Games', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRedcandlegames as default, defaultColor };
