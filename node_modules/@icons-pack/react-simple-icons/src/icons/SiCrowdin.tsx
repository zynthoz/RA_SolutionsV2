    ...
    type SiCrowdinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCrowdin: IconType = React.forwardRef<SVGSVGElement, SiCrowdinProps>(function SiCrowdin({title = 'Crowdin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
