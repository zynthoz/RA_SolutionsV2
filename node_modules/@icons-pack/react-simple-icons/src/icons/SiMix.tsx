    ...
    type SiMixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF8126';

    const SiMix: IconType = React.forwardRef<SVGSVGElement, SiMixProps>(function SiMix({title = 'Mix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMix as default, defaultColor };
