    ...
    type SiApifoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApifox: IconType = React.forwardRef<SVGSVGElement, SiApifoxProps>(function SiApifox({title = 'Apifox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApifox as default, defaultColor };
