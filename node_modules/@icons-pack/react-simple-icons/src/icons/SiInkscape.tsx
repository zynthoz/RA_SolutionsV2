    ...
    type SiInkscapeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInkscape: IconType = React.forwardRef<SVGSVGElement, SiInkscapeProps>(function SiInkscape({title = 'Inkscape', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInkscape as default, defaultColor };
