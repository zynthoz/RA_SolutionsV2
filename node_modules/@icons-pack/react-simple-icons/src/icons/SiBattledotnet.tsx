    ...
    type SiBattledotnetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBattledotnet: IconType = React.forwardRef<SVGSVGElement, SiBattledotnetProps>(function SiBattledotnet({title = 'Battle.net', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
