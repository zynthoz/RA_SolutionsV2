    ...
    type SiLlvmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#262D3A';

    const SiLlvm: IconType = React.forwardRef<SVGSVGElement, SiLlvmProps>(function SiLlvm({title = 'LLVM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
