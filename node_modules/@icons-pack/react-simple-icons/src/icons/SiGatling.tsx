    ...
    type SiGatlingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGatling: IconType = React.forwardRef<SVGSVGElement, SiGatlingProps>(function SiGatling({title = 'Gatling', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
