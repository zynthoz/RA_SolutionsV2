    ...
    type SiZdfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FA7D19';

    const SiZdf: IconType = React.forwardRef<SVGSVGElement, SiZdfProps>(function SiZdf({title = 'ZDF', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZdf as default, defaultColor };
