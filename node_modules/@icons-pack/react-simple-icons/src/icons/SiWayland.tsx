    ...
    type SiWaylandProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWayland: IconType = React.forwardRef<SVGSVGElement, SiWaylandProps>(function SiWayland({title = 'Wayland', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWayland as default, defaultColor };
