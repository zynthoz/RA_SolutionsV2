    ...
    type SiSparkasseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSparkasse: IconType = React.forwardRef<SVGSVGElement, SiSparkasseProps>(function SiSparkasse({title = 'Sparkasse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
