    ...
    type SiGeocachingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00874D';

    const SiGeocaching: IconType = React.forwardRef<SVGSVGElement, SiGeocachingProps>(function SiGeocaching({title = 'Geocaching', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGeocaching as default, defaultColor };
