    ...
    type SiOpsgenieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpsgenie: IconType = React.forwardRef<SVGSVGElement, SiOpsgenieProps>(function SiOpsgenie({title = 'Opsgenie', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
