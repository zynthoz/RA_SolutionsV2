    ...
    type SiSpotlightProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#352A71';

    const SiSpotlight: IconType = React.forwardRef<SVGSVGElement, SiSpotlightProps>(function SiSpotlight({title = 'Spotlight', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
