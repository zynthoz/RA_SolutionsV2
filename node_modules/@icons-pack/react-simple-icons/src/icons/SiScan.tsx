    ...
    type SiScanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScan: IconType = React.forwardRef<SVGSVGElement, SiScanProps>(function SiScan({title = 'Scan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
