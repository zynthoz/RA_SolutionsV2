    ...
    type SiUnacademyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#08BD80';

    const SiUnacademy: IconType = React.forwardRef<SVGSVGElement, SiUnacademyProps>(function SiUnacademy({title = 'Unacademy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUnacademy as default, defaultColor };
