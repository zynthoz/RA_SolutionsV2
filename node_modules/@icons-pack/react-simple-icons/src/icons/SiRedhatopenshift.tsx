    ...
    type SiRedhatopenshiftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedhatopenshift: IconType = React.forwardRef<SVGSVGElement, SiRedhatopenshiftProps>(function SiRedhatopenshift({title = 'Red Hat Open Shift', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRedhatopenshift as default, defaultColor };
