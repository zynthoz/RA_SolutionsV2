    ...
    type SiSaucelabsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSaucelabs: IconType = React.forwardRef<SVGSVGElement, SiSaucelabsProps>(function SiSaucelabs({title = 'Sauce Labs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
