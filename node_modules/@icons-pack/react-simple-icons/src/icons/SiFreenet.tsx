    ...
    type SiFreenetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFreenet: IconType = React.forwardRef<SVGSVGElement, SiFreenetProps>(function SiFreenet({title = 'freenet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
