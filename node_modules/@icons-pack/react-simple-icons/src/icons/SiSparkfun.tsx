    ...
    type SiSparkfunProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSparkfun: IconType = React.forwardRef<SVGSVGElement, SiSparkfunProps>(function SiSparkfun({title = 'SparkFun', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
