    ...
    type SiOttoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOtto: IconType = React.forwardRef<SVGSVGElement, SiOttoProps>(function SiOtto({title = 'Otto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOtto as default, defaultColor };
