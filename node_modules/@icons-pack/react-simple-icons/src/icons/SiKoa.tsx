    ...
    type SiKoaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKoa: IconType = React.forwardRef<SVGSVGElement, SiKoaProps>(function SiKoa({title = 'Koa', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
