    ...
    type SiXeroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiXero: IconType = React.forwardRef<SVGSVGElement, SiXeroProps>(function SiXero({title = 'Xero', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiXero as default, defaultColor };
