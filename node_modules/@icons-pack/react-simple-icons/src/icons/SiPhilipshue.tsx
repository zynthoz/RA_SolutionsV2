    ...
    type SiPhilipshueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhilipshue: IconType = React.forwardRef<SVGSVGElement, SiPhilipshueProps>(function SiPhilipshue({title = 'Philips Hue', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
