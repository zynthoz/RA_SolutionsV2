    ...
    type SiBoseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBose: IconType = React.forwardRef<SVGSVGElement, SiBoseProps>(function SiBose({title = 'Bose', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBose as default, defaultColor };
