    ...
    type SiOptunaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOptuna: IconType = React.forwardRef<SVGSVGElement, SiOptunaProps>(function SiOptuna({title = 'Optuna', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOptuna as default, defaultColor };
