    ...
    type SiSimpleiconsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSimpleicons: IconType = React.forwardRef<SVGSVGElement, SiSimpleiconsProps>(function SiSimpleicons({title = 'Simple Icons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSimpleicons as default, defaultColor };
