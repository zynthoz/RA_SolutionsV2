    ...
    type SiElgatoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElgato: IconType = React.forwardRef<SVGSVGElement, SiElgatoProps>(function SiElgato({title = 'Elgato', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiElgato as default, defaultColor };
