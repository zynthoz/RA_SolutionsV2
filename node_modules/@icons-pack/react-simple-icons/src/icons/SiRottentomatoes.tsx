    ...
    type SiRottentomatoesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FA320A';

    const SiRottentomatoes: IconType = React.forwardRef<SVGSVGElement, SiRottentomatoesProps>(function SiRottentomatoes({title = 'Rotten Tomatoes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRottentomatoes as default, defaultColor };
