    ...
    type SiLivewireProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4E56A6';

    const SiLivewire: IconType = React.forwardRef<SVGSVGElement, SiLivewireProps>(function SiLivewire({title = 'Livewire', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLivewire as default, defaultColor };
