    ...
    type SiBarmeniaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBarmenia: IconType = React.forwardRef<SVGSVGElement, SiBarmeniaProps>(function SiBarmenia({title = 'Barmenia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
