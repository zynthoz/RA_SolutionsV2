    ...
    type SiFluentbitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFluentbit: IconType = React.forwardRef<SVGSVGElement, SiFluentbitProps>(function SiFluentbit({title = 'Fluent Bit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFluentbit as default, defaultColor };
