    ...
    type SiSocketdotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSocketdotio: IconType = React.forwardRef<SVGSVGElement, SiSocketdotioProps>(function SiSocketdotio({title = 'Socket.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
