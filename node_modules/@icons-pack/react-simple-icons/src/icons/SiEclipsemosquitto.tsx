    ...
    type SiEclipsemosquittoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEclipsemosquitto: IconType = React.forwardRef<SVGSVGElement, SiEclipsemosquittoProps>(function SiEclipsemosquitto({title = 'Eclipse Mosquitto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEclipsemosquitto as default, defaultColor };
