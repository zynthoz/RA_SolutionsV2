    ...
    type SiGoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGo: IconType = React.forwardRef<SVGSVGElement, SiGoProps>(function SiGo({title = 'Go', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGo as default, defaultColor };
