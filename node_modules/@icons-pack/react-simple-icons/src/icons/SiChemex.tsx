    ...
    type SiChemexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4D2B1A';

    const SiChemex: IconType = React.forwardRef<SVGSVGElement, SiChemexProps>(function SiChemex({title = 'Chemex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChemex as default, defaultColor };
