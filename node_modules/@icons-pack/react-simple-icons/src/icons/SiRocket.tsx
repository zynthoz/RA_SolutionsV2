    ...
    type SiRocketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D33847';

    const SiRocket: IconType = React.forwardRef<SVGSVGElement, SiRocketProps>(function SiRocket({title = 'Rocket', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRocket as default, defaultColor };
