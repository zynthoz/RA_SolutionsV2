    ...
    type SiAsteriskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAsterisk: IconType = React.forwardRef<SVGSVGElement, SiAsteriskProps>(function SiAsterisk({title = 'Asterisk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
