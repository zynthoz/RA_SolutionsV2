    ...
    type SiThangsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThangs: IconType = React.forwardRef<SVGSVGElement, SiThangsProps>(function SiThangs({title = 'Thangs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
