    ...
    type SiBrandfolderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBrandfolder: IconType = React.forwardRef<SVGSVGElement, SiBrandfolderProps>(function SiBrandfolder({title = 'Brandfolder', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBrandfolder as default, defaultColor };
