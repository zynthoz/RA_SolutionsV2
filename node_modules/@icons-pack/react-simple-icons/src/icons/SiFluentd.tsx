    ...
    type SiFluentdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0E83C8';

    const SiFluentd: IconType = React.forwardRef<SVGSVGElement, SiFluentdProps>(function SiFluentd({title = 'Fluentd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFluentd as default, defaultColor };
