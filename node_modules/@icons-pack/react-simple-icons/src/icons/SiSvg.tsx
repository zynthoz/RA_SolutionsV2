    ...
    type SiSvgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSvg: IconType = React.forwardRef<SVGSVGElement, SiSvgProps>(function SiSvg({title = 'SVG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
