    ...
    type SiUpstashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00E9A3';

    const SiUpstash: IconType = React.forwardRef<SVGSVGElement, SiUpstashProps>(function SiUpstash({title = 'Upstash', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUpstash as default, defaultColor };
