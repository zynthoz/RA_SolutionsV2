    ...
    type SiPrepbytesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5A87C6';

    const SiPrepbytes: IconType = React.forwardRef<SVGSVGElement, SiPrepbytesProps>(function SiPrepbytes({title = 'PrepBytes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPrepbytes as default, defaultColor };
