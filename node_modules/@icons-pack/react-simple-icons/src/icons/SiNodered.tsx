    ...
    type SiNoderedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNodered: IconType = React.forwardRef<SVGSVGElement, SiNoderedProps>(function SiNodered({title = 'Node-RED', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNodered as default, defaultColor };
