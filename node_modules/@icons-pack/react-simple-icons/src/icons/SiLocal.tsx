    ...
    type SiLocalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLocal: IconType = React.forwardRef<SVGSVGElement, SiLocalProps>(function SiLocal({title = 'Local', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLocal as default, defaultColor };
