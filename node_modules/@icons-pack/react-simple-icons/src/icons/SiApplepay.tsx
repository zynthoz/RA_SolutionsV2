    ...
    type SiApplepayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApplepay: IconType = React.forwardRef<SVGSVGElement, SiApplepayProps>(function SiApplepay({title = 'Apple Pay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApplepay as default, defaultColor };
