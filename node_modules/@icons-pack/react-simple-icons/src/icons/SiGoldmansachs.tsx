    ...
    type SiGoldmansachsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoldmansachs: IconType = React.forwardRef<SVGSVGElement, SiGoldmansachsProps>(function SiGoldmansachs({title = 'Goldman Sachs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
