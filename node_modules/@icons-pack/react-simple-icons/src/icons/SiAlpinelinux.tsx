    ...
    type SiAlpinelinuxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0D597F';

    const SiAlpinelinux: IconType = React.forwardRef<SVGSVGElement, SiAlpinelinuxProps>(function SiAlpinelinux({title = 'Alpine Linux', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlpinelinux as default, defaultColor };
