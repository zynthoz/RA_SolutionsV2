    ...
    type SiHelpdeskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2FC774';

    const SiHelpdesk: IconType = React.forwardRef<SVGSVGElement, SiHelpdeskProps>(function SiHelpdesk({title = 'HelpDesk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHelpdesk as default, defaultColor };
