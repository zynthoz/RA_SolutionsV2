    ...
    type SiStreamlabsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStreamlabs: IconType = React.forwardRef<SVGSVGElement, SiStreamlabsProps>(function SiStreamlabs({title = 'Streamlabs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
