    ...
    type SiScrollrevealProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFCB36';

    const SiScrollreveal: IconType = React.forwardRef<SVGSVGElement, SiScrollrevealProps>(function SiScrollreveal({title = 'ScrollReveal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScrollreveal as default, defaultColor };
