    ...
    type SiQualcommProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3253DC';

    const SiQualcomm: IconType = React.forwardRef<SVGSVGElement, SiQualcommProps>(function SiQualcomm({title = 'Qualcomm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQualcomm as default, defaultColor };
