    ...
    type SiProteusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1C79B3';

    const SiProteus: IconType = React.forwardRef<SVGSVGElement, SiProteusProps>(function SiProteus({title = 'Proteus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
