    ...
    type SiOyoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOyo: IconType = React.forwardRef<SVGSVGElement, SiOyoProps>(function SiOyo({title = 'OYO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
