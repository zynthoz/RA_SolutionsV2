    ...
    type SiOpenaigymProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenaigym: IconType = React.forwardRef<SVGSVGElement, SiOpenaigymProps>(function SiOpenaigym({title = 'OpenAI Gym', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
