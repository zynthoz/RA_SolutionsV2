    ...
    type SiGalaxusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGalaxus: IconType = React.forwardRef<SVGSVGElement, SiGalaxusProps>(function SiGalaxus({title = 'Galaxus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
