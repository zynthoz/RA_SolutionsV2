    ...
    type SiVeritasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVeritas: IconType = React.forwardRef<SVGSVGElement, SiVeritasProps>(function SiVeritas({title = 'Veritas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVeritas as default, defaultColor };
