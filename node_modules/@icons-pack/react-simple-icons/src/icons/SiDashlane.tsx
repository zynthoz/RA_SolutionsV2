    ...
    type SiDashlaneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDashlane: IconType = React.forwardRef<SVGSVGElement, SiDashlaneProps>(function SiDashlane({title = 'Dashlane', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
