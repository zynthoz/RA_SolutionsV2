    ...
    type SiWikimediafoundationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikimediafoundation: IconType = React.forwardRef<SVGSVGElement, SiWikimediafoundationProps>(function SiWikimediafoundation({title = 'Wikimedia Foundation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWikimediafoundation as default, defaultColor };
