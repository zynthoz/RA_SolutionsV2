    ...
    type SiLeroymerlinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#78BE20';

    const SiLeroymerlin: IconType = React.forwardRef<SVGSVGElement, SiLeroymerlinProps>(function SiLeroymerlin({title = 'Leroy Merlin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLeroymerlin as default, defaultColor };
