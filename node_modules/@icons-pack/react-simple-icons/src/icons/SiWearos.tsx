    ...
    type SiWearosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWearos: IconType = React.forwardRef<SVGSVGElement, SiWearosProps>(function SiWearos({title = 'Wear OS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWearos as default, defaultColor };
