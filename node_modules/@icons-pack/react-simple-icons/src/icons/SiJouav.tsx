    ...
    type SiJouavProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJouav: IconType = React.forwardRef<SVGSVGElement, SiJouavProps>(function SiJouav({title = 'JOUAV', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
