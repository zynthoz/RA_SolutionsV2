    ...
    type SiPiaggiogroupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPiaggiogroup: IconType = React.forwardRef<SVGSVGElement, SiPiaggiogroupProps>(function SiPiaggiogroup({title = 'Piaggio Group', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
