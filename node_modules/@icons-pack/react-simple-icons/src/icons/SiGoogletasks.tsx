    ...
    type SiGoogletasksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2684FC';

    const SiGoogletasks: IconType = React.forwardRef<SVGSVGElement, SiGoogletasksProps>(function SiGoogletasks({title = 'Google Tasks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogletasks as default, defaultColor };
