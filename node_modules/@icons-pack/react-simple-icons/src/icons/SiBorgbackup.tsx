    ...
    type SiBorgbackupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBorgbackup: IconType = React.forwardRef<SVGSVGElement, SiBorgbackupProps>(function SiBorgbackup({title = 'BorgBackup', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
