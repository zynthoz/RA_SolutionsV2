    ...
    type SiHedgedocProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B51F08';

    const SiHedgedoc: IconType = React.forwardRef<SVGSVGElement, SiHedgedocProps>(function SiHedgedoc({title = 'HedgeDoc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHedgedoc as default, defaultColor };
