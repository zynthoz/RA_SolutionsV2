    ...
    type SiUntappdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUntappd: IconType = React.forwardRef<SVGSVGElement, SiUntappdProps>(function SiUntappd({title = 'Untappd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
