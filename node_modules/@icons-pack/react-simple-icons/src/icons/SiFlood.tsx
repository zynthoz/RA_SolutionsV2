    ...
    type SiFloodProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFlood: IconType = React.forwardRef<SVGSVGElement, SiFloodProps>(function SiFlood({title = 'Flood', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
