    ...
    type SiKoenigseggProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKoenigsegg: IconType = React.forwardRef<SVGSVGElement, SiKoenigseggProps>(function SiKoenigsegg({title = 'Koenigsegg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKoenigsegg as default, defaultColor };
