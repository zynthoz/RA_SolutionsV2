    ...
    type SiEtsyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEtsy: IconType = React.forwardRef<SVGSVGElement, SiEtsyProps>(function SiEtsy({title = 'Etsy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
