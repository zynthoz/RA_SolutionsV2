    ...
    type SiNginxproxymanagerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F15833';

    const SiNginxproxymanager: IconType = React.forwardRef<SVGSVGElement, SiNginxproxymanagerProps>(function SiNginxproxymanager({title = 'Nginx Proxy Manager', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNginxproxymanager as default, defaultColor };
