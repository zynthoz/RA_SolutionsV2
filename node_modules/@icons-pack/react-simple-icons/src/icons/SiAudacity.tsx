    ...
    type SiAudacityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAudacity: IconType = React.forwardRef<SVGSVGElement, SiAudacityProps>(function SiAudacity({title = 'Audacity', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAudacity as default, defaultColor };
