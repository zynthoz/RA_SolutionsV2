    ...
    type SiOpensourceinitiativeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpensourceinitiative: IconType = React.forwardRef<SVGSVGElement, SiOpensourceinitiativeProps>(function SiOpensourceinitiative({title = 'Open Source Initiative', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpensourceinitiative as default, defaultColor };
