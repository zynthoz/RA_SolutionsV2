    ...
    type SiNikonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNikon: IconType = React.forwardRef<SVGSVGElement, SiNikonProps>(function SiNikon({title = 'Nikon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
