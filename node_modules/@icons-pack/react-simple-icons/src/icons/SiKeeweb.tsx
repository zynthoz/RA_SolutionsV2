    ...
    type SiKeewebProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKeeweb: IconType = React.forwardRef<SVGSVGElement, SiKeewebProps>(function SiKeeweb({title = 'KeeWeb', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
