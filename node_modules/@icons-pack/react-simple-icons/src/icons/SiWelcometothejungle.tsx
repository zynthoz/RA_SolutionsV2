    ...
    type SiWelcometothejungleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWelcometothejungle: IconType = React.forwardRef<SVGSVGElement, SiWelcometothejungleProps>(function SiWelcometothejungle({title = 'Welcome to the Jungle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
