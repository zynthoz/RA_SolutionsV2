    ...
    type SiImagedotscProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImagedotsc: IconType = React.forwardRef<SVGSVGElement, SiImagedotscProps>(function SiImagedotsc({title = 'Image.sc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
