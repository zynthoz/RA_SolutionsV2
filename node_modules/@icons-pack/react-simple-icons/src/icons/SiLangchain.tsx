    ...
    type SiLangchainProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLangchain: IconType = React.forwardRef<SVGSVGElement, SiLangchainProps>(function SiLangchain({title = 'LangChain', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
