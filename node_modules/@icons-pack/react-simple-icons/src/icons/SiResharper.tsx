    ...
    type SiResharperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiResharper: IconType = React.forwardRef<SVGSVGElement, SiResharperProps>(function SiResharper({title = 'ReSharper', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiResharper as default, defaultColor };
