    ...
    type SiMovistarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#019DF4';

    const SiMovistar: IconType = React.forwardRef<SVGSVGElement, SiMovistarProps>(function SiMovistar({title = 'Movistar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMovistar as default, defaultColor };
