    ...
    type SiWooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#873EFF';

    const SiWoo: IconType = React.forwardRef<SVGSVGElement, SiWooProps>(function SiWoo({title = 'Woo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWoo as default, defaultColor };
