    ...
    type SiSymbolabProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSymbolab: IconType = React.forwardRef<SVGSVGElement, SiSymbolabProps>(function SiSymbolab({title = 'Symbolab', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
