    ...
    type SiPaddleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaddle: IconType = React.forwardRef<SVGSVGElement, SiPaddleProps>(function SiPaddle({title = 'Paddle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
