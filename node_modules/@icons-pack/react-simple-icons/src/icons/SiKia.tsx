    ...
    type SiKiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#05141F';

    const SiKia: IconType = React.forwardRef<SVGSVGElement, SiKiaProps>(function SiKia({title = 'Kia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKia as default, defaultColor };
