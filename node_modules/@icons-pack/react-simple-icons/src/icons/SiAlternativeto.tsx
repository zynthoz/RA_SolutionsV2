    ...
    type SiAlternativetoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlternativeto: IconType = React.forwardRef<SVGSVGElement, SiAlternativetoProps>(function SiAlternativeto({title = 'AlternativeTo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlternativeto as default, defaultColor };
