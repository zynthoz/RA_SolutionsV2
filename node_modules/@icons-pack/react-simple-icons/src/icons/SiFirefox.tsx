    ...
    type SiFirefoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFirefox: IconType = React.forwardRef<SVGSVGElement, SiFirefoxProps>(function SiFirefox({title = 'Firefox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFirefox as default, defaultColor };
