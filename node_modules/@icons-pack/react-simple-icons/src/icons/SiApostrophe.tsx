    ...
    type SiApostropheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApostrophe: IconType = React.forwardRef<SVGSVGElement, SiApostropheProps>(function SiApostrophe({title = 'Apostrophe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
