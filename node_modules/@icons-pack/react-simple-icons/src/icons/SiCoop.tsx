    ...
    type SiCoopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoop: IconType = React.forwardRef<SVGSVGElement, SiCoopProps>(function SiCoop({title = 'Co-op', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoop as default, defaultColor };
