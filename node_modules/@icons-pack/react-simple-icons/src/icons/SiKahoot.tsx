    ...
    type SiKahootProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKahoot: IconType = React.forwardRef<SVGSVGElement, SiKahootProps>(function SiKahoot({title = 'Kahoot!', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
