    ...
    type SiIvecoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1554FF';

    const SiIveco: IconType = React.forwardRef<SVGSVGElement, SiIvecoProps>(function SiIveco({title = 'IVECO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIveco as default, defaultColor };
