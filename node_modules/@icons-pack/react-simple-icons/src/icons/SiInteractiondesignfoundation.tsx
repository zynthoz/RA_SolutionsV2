    ...
    type SiInteractiondesignfoundationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInteractiondesignfoundation: IconType = React.forwardRef<SVGSVGElement, SiInteractiondesignfoundationProps>(function SiInteractiondesignfoundation({title = 'Interaction Design Foundation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
