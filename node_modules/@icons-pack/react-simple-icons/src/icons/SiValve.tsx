    ...
    type SiValveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiValve: IconType = React.forwardRef<SVGSVGElement, SiValveProps>(function SiValve({title = 'Valve', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
