    ...
    type SiDartyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDarty: IconType = React.forwardRef<SVGSVGElement, SiDartyProps>(function SiDarty({title = 'Darty', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
