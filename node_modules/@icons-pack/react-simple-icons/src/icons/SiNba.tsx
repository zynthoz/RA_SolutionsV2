    ...
    type SiNbaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNba: IconType = React.forwardRef<SVGSVGElement, SiNbaProps>(function SiNba({title = 'NBA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
