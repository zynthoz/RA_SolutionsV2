    ...
    type SiSnowflakeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSnowflake: IconType = React.forwardRef<SVGSVGElement, SiSnowflakeProps>(function SiSnowflake({title = 'Snowflake', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSnowflake as default, defaultColor };
