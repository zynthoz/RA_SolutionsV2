    ...
    type SiSupermicroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSupermicro: IconType = React.forwardRef<SVGSVGElement, SiSupermicroProps>(function SiSupermicro({title = 'Supermicro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
