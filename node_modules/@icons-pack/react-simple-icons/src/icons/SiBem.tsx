    ...
    type SiBemProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBem: IconType = React.forwardRef<SVGSVGElement, SiBemProps>(function SiBem({title = 'BEM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
