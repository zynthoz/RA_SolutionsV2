    ...
    type SiVscodiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVscodium: IconType = React.forwardRef<SVGSVGElement, SiVscodiumProps>(function SiVscodium({title = 'VSCodium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVscodium as default, defaultColor };
