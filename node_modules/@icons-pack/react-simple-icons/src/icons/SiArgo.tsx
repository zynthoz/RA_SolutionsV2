    ...
    type SiArgoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EF7B4D';

    const SiArgo: IconType = React.forwardRef<SVGSVGElement, SiArgoProps>(function SiArgo({title = 'Argo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArgo as default, defaultColor };
