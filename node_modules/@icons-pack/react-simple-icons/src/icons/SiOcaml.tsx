    ...
    type SiOcamlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EC6813';

    const SiOcaml: IconType = React.forwardRef<SVGSVGElement, SiOcamlProps>(function SiOcaml({title = 'OCaml', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOcaml as default, defaultColor };
