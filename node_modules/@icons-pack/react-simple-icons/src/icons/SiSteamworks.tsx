    ...
    type SiSteamworksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSteamworks: IconType = React.forwardRef<SVGSVGElement, SiSteamworksProps>(function SiSteamworks({title = 'Steamworks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
