    ...
    type SiFerrarinvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB2E2C';

    const SiFerrarinv: IconType = React.forwardRef<SVGSVGElement, SiFerrarinvProps>(function SiFerrarinv({title = 'Ferrari N.V.', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFerrarinv as default, defaultColor };
