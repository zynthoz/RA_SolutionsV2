    ...
    type SiBackendlessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBackendless: IconType = React.forwardRef<SVGSVGElement, SiBackendlessProps>(function SiBackendless({title = 'Backendless', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBackendless as default, defaultColor };
