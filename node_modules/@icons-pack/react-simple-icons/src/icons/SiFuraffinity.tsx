    ...
    const defaultColor = '#36566F';

    const SiFuraffinity: IconType = React.forwardRef<SVGSVGElement, SiFuraffinityProps>(function SiFuraffinity({title = 'Fur Affinity', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
