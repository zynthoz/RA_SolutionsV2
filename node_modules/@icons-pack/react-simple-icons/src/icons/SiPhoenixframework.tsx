    ...
    type SiPhoenixframeworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPhoenixframework: IconType = React.forwardRef<SVGSVGElement, SiPhoenixframeworkProps>(function SiPhoenixframework({title = 'Phoenix Framework', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
