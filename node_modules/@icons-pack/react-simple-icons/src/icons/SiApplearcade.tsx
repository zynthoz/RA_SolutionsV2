    ...
    type SiApplearcadeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApplearcade: IconType = React.forwardRef<SVGSVGElement, SiApplearcadeProps>(function SiApplearcade({title = 'Apple Arcade', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApplearcade as default, defaultColor };
