    ...
    type SiBigbasketProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBigbasket: IconType = React.forwardRef<SVGSVGElement, SiBigbasketProps>(function SiBigbasket({title = 'bigbasket', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
