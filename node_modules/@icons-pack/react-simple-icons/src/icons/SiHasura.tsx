    ...
    type SiHasuraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1EB4D4';

    const SiHasura: IconType = React.forwardRef<SVGSVGElement, SiHasuraProps>(function SiHasura({title = 'Hasura', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHasura as default, defaultColor };
