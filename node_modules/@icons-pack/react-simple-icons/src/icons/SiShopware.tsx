    ...
    type SiShopwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#189EFF';

    const SiShopware: IconType = React.forwardRef<SVGSVGElement, SiShopwareProps>(function SiShopware({title = 'Shopware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShopware as default, defaultColor };
