    ...
    type SiAlchemyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlchemy: IconType = React.forwardRef<SVGSVGElement, SiAlchemyProps>(function SiAlchemy({title = 'Alchemy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
