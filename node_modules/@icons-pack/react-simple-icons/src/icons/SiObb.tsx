    ...
    type SiObbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E40327';

    const SiObb: IconType = React.forwardRef<SVGSVGElement, SiObbProps>(function SiObb({title = 'ÖBB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiObb as default, defaultColor };
