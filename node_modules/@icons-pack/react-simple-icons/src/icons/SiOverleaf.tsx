    ...
    type SiOverleafProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOverleaf: IconType = React.forwardRef<SVGSVGElement, SiOverleafProps>(function SiOverleaf({title = 'Overleaf', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
