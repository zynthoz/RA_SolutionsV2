    ...
    type SiGnuicecatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#002F5B';

    const SiGnuicecat: IconType = React.forwardRef<SVGSVGElement, SiGnuicecatProps>(function SiGnuicecat({title = 'GNU IceCat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
