    ...
    type SiMauticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMautic: IconType = React.forwardRef<SVGSVGElement, SiMauticProps>(function SiMautic({title = 'Mautic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
