    ...
    type SiQmkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQmk: IconType = React.forwardRef<SVGSVGElement, SiQmkProps>(function SiQmk({title = 'QMK', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
