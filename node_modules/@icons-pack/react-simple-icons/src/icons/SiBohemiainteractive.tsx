    ...
    type SiBohemiainteractiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBohemiainteractive: IconType = React.forwardRef<SVGSVGElement, SiBohemiainteractiveProps>(function SiBohemiainteractive({title = 'Bohemia Interactive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
