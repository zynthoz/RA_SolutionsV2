    ...
    type SiApachekafkaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachekafka: IconType = React.forwardRef<SVGSVGElement, SiApachekafkaProps>(function SiApachekafka({title = 'Apache Kafka', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachekafka as default, defaultColor };
