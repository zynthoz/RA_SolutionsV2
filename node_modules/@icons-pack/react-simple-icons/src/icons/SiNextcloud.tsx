    ...
    type SiNextcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNextcloud: IconType = React.forwardRef<SVGSVGElement, SiNextcloudProps>(function SiNextcloud({title = 'Nextcloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
