    ...
    type SiChartdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF6384';

    const SiChartdotjs: IconType = React.forwardRef<SVGSVGElement, SiChartdotjsProps>(function SiChartdotjs({title = 'Chart.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChartdotjs as default, defaultColor };
