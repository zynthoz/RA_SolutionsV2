    ...
    type SiUpcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUpcloud: IconType = React.forwardRef<SVGSVGElement, SiUpcloudProps>(function SiUpcloud({title = 'UpCloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUpcloud as default, defaultColor };
