    ...
    type SiUnlicenseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnlicense: IconType = React.forwardRef<SVGSVGElement, SiUnlicenseProps>(function SiUnlicense({title = 'Unlicense', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
