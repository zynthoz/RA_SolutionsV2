    ...
    type SiMajorleaguehackingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#265A8F';

    const SiMajorleaguehacking: IconType = React.forwardRef<SVGSVGElement, SiMajorleaguehackingProps>(function SiMajorleaguehacking({title = 'Major League Hacking', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMajorleaguehacking as default, defaultColor };
