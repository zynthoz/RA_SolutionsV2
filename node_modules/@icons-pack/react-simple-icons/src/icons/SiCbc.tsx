    ...
    type SiCbcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E60505';

    const SiCbc: IconType = React.forwardRef<SVGSVGElement, SiCbcProps>(function SiCbc({title = 'CBC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCbc as default, defaultColor };
