    ...
    type SiThemightyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThemighty: IconType = React.forwardRef<SVGSVGElement, SiThemightyProps>(function SiThemighty({title = 'The Mighty', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
