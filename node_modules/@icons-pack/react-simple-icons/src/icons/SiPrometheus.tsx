    ...
    type SiPrometheusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E6522C';

    const SiPrometheus: IconType = React.forwardRef<SVGSVGElement, SiPrometheusProps>(function SiPrometheus({title = 'Prometheus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPrometheus as default, defaultColor };
