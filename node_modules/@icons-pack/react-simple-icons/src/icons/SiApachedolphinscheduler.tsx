    ...
    type SiApachedolphinschedulerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachedolphinscheduler: IconType = React.forwardRef<SVGSVGElement, SiApachedolphinschedulerProps>(function SiApachedolphinscheduler({title = 'Apache DolphinScheduler', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
