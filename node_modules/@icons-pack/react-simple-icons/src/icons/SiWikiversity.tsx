    ...
    type SiWikiversityProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00649A';

    const SiWikiversity: IconType = React.forwardRef<SVGSVGElement, SiWikiversityProps>(function SiWikiversity({title = 'Wikiversity', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWikiversity as default, defaultColor };
