    ...
    type SiFiledotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFiledotio: IconType = React.forwardRef<SVGSVGElement, SiFiledotioProps>(function SiFiledotio({title = 'File.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
