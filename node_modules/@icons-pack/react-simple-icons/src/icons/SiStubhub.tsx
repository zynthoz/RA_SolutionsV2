    ...
    type SiStubhubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStubhub: IconType = React.forwardRef<SVGSVGElement, SiStubhubProps>(function SiStubhub({title = 'StubHub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStubhub as default, defaultColor };
