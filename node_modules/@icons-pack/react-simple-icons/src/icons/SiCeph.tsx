    ...
    type SiCephProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCeph: IconType = React.forwardRef<SVGSVGElement, SiCephProps>(function SiCeph({title = 'Ceph', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCeph as default, defaultColor };
