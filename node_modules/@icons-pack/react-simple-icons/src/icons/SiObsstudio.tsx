    ...
    type SiObsstudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#302E31';

    const SiObsstudio: IconType = React.forwardRef<SVGSVGElement, SiObsstudioProps>(function SiObsstudio({title = 'OBS Studio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiObsstudio as default, defaultColor };
