    ...
    type SiGentooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#54487A';

    const SiGentoo: IconType = React.forwardRef<SVGSVGElement, SiGentooProps>(function SiGentoo({title = 'Gentoo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGentoo as default, defaultColor };
