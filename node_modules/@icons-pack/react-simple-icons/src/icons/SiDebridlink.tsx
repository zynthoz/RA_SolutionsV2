    ...
    type SiDebridlinkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDebridlink: IconType = React.forwardRef<SVGSVGElement, SiDebridlinkProps>(function SiDebridlink({title = 'Debrid-Link', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
