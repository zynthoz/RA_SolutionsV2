    ...
    type SiElsevierProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF6C00';

    const SiElsevier: IconType = React.forwardRef<SVGSVGElement, SiElsevierProps>(function SiElsevier({title = 'Elsevier', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
