    ...
    type SiHungryjacksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D0021B';

    const SiHungryjacks: IconType = React.forwardRef<SVGSVGElement, SiHungryjacksProps>(function SiHungryjacks({title = 'Hungry Jacks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHungryjacks as default, defaultColor };
