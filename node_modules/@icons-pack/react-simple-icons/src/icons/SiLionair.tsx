    ...
    type SiLionairProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLionair: IconType = React.forwardRef<SVGSVGElement, SiLionairProps>(function SiLionair({title = 'Lion Air', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
