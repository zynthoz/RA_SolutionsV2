    ...
    type Si3mProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si3m: IconType = React.forwardRef<SVGSVGElement, Si3mProps>(function Si3m({title = '3M', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
