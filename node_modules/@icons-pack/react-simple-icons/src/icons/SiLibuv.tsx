    ...
    type SiLibuvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#403C3D';

    const SiLibuv: IconType = React.forwardRef<SVGSVGElement, SiLibuvProps>(function SiLibuv({title = 'libuv', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLibuv as default, defaultColor };
