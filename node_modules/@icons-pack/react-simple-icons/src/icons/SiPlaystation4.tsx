    ...
    type SiPlaystation4Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlaystation4: IconType = React.forwardRef<SVGSVGElement, SiPlaystation4Props>(function SiPlaystation4({title = 'PlayStation 4', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlaystation4 as default, defaultColor };
