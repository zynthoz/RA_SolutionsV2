    ...
    type SiBigcommerceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBigcommerce: IconType = React.forwardRef<SVGSVGElement, SiBigcommerceProps>(function SiBigcommerce({title = 'BigCommerce', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
