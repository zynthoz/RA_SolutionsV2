    ...
    type SiPelicanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPelican: IconType = React.forwardRef<SVGSVGElement, SiPelicanProps>(function SiPelican({title = 'Pelican', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
