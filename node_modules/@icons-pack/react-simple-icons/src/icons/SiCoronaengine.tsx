    ...
    type SiCoronaengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoronaengine: IconType = React.forwardRef<SVGSVGElement, SiCoronaengineProps>(function SiCoronaengine({title = 'Corona Engine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
