    ...
    type SiNestjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNestjs: IconType = React.forwardRef<SVGSVGElement, SiNestjsProps>(function SiNestjs({title = 'NestJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
