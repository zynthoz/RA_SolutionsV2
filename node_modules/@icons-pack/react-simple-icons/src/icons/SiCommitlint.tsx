    ...
    type SiCommitlintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCommitlint: IconType = React.forwardRef<SVGSVGElement, SiCommitlintProps>(function SiCommitlint({title = 'commitlint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
