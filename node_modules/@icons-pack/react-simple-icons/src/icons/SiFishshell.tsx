    ...
    type SiFishshellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#34C534';

    const SiFishshell: IconType = React.forwardRef<SVGSVGElement, SiFishshellProps>(function SiFishshell({title = 'fish shell', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFishshell as default, defaultColor };
