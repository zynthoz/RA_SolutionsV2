    ...
    type SiLgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLg: IconType = React.forwardRef<SVGSVGElement, SiLgProps>(function SiLg({title = 'LG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
