    ...
    type SiKumaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#290B53';

    const SiKuma: IconType = React.forwardRef<SVGSVGElement, SiKumaProps>(function SiKuma({title = 'Kuma', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKuma as default, defaultColor };
