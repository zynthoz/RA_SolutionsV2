    ...
    type SiLumenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E74430';

    const SiLumen: IconType = React.forwardRef<SVGSVGElement, SiLumenProps>(function SiLumen({title = 'Lumen', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLumen as default, defaultColor };
