    ...
    type SiBritishairwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2E5C99';

    const SiBritishairways: IconType = React.forwardRef<SVGSVGElement, SiBritishairwaysProps>(function SiBritishairways({title = 'British Airways', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBritishairways as default, defaultColor };
