    ...
    type SiMullvadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMullvad: IconType = React.forwardRef<SVGSVGElement, SiMullvadProps>(function SiMullvad({title = 'Mullvad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
