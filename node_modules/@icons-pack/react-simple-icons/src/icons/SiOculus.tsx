    ...
    type SiOculusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1C1E20';

    const SiOculus: IconType = React.forwardRef<SVGSVGElement, SiOculusProps>(function SiOculus({title = 'Oculus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOculus as default, defaultColor };
