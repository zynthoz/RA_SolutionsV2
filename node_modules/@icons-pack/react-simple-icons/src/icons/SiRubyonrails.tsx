    ...
    type SiRubyonrailsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRubyonrails: IconType = React.forwardRef<SVGSVGElement, SiRubyonrailsProps>(function SiRubyonrails({title = 'Ruby on Rails', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRubyonrails as default, defaultColor };
