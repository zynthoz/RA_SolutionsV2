    ...
    type SiScopusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScopus: IconType = React.forwardRef<SVGSVGElement, SiScopusProps>(function SiScopus({title = 'Scopus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
