    ...
    type SiHivemqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHivemq: IconType = React.forwardRef<SVGSVGElement, SiHivemqProps>(function SiHivemq({title = 'HiveMQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
