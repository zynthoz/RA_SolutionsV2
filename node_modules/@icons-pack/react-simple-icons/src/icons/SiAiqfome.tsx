    ...
    type SiAiqfomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAiqfome: IconType = React.forwardRef<SVGSVGElement, SiAiqfomeProps>(function SiAiqfome({title = 'Aiqfome', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
