    ...
    type SiDiscoverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDiscover: IconType = React.forwardRef<SVGSVGElement, SiDiscoverProps>(function SiDiscover({title = 'Discover', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
