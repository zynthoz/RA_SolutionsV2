    ...
    type SiVitepressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVitepress: IconType = React.forwardRef<SVGSVGElement, SiVitepressProps>(function SiVitepress({title = 'VitePress', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
