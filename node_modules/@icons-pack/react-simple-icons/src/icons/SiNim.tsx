    ...
    type SiNimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFE953';

    const SiNim: IconType = React.forwardRef<SVGSVGElement, SiNimProps>(function SiNim({title = 'Nim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNim as default, defaultColor };
