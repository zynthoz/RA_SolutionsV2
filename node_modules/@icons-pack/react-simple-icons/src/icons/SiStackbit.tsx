    ...
    type SiStackbitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStackbit: IconType = React.forwardRef<SVGSVGElement, SiStackbitProps>(function SiStackbit({title = 'Stackbit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
