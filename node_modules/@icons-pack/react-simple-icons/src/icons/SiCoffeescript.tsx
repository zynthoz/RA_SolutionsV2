    ...
    type SiCoffeescriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoffeescript: IconType = React.forwardRef<SVGSVGElement, SiCoffeescriptProps>(function SiCoffeescript({title = 'CoffeeScript', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoffeescript as default, defaultColor };
