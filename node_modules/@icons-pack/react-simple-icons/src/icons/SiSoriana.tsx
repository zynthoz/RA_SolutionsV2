    ...
    type SiSorianaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSoriana: IconType = React.forwardRef<SVGSVGElement, SiSorianaProps>(function SiSoriana({title = 'Soriana', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
