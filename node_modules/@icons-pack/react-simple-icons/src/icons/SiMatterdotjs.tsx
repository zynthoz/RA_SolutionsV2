    ...
    type SiMatterdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4B5562';

    const SiMatterdotjs: IconType = React.forwardRef<SVGSVGElement, SiMatterdotjsProps>(function SiMatterdotjs({title = 'Matter.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMatterdotjs as default, defaultColor };
