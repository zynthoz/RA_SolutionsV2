    ...
    type SiFigProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFig: IconType = React.forwardRef<SVGSVGElement, SiFigProps>(function SiFig({title = 'Fig', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFig as default, defaultColor };
