    ...
    type SiMangaupdatesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMangaupdates: IconType = React.forwardRef<SVGSVGElement, SiMangaupdatesProps>(function SiMangaupdates({title = 'MangaUpdates', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
