    ...
    type SiShellyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4495D1';

    const SiShelly: IconType = React.forwardRef<SVGSVGElement, SiShellyProps>(function SiShelly({title = 'Shelly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShelly as default, defaultColor };
