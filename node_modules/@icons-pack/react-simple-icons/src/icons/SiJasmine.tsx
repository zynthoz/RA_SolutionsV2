    ...
    type SiJasmineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJasmine: IconType = React.forwardRef<SVGSVGElement, SiJasmineProps>(function SiJasmine({title = 'Jasmine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJasmine as default, defaultColor };
