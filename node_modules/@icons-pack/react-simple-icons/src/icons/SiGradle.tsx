    ...
    type SiGradleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGradle: IconType = React.forwardRef<SVGSVGElement, SiGradleProps>(function SiGradle({title = 'Gradle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGradle as default, defaultColor };
