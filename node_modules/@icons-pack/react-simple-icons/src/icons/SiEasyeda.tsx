    ...
    type SiEasyedaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEasyeda: IconType = React.forwardRef<SVGSVGElement, SiEasyedaProps>(function SiEasyeda({title = 'EasyEDA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEasyeda as default, defaultColor };
