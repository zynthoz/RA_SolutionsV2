    ...
    type SiCoinbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoinbase: IconType = React.forwardRef<SVGSVGElement, SiCoinbaseProps>(function SiCoinbase({title = 'Coinbase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoinbase as default, defaultColor };
