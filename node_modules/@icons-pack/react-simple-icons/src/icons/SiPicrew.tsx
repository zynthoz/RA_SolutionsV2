    ...
    type SiPicrewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFBD16';

    const SiPicrew: IconType = React.forwardRef<SVGSVGElement, SiPicrewProps>(function SiPicrew({title = 'Picrew', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
