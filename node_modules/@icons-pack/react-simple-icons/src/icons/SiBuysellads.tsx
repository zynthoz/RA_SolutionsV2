    ...
    type SiBuyselladsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBuysellads: IconType = React.forwardRef<SVGSVGElement, SiBuyselladsProps>(function SiBuysellads({title = 'BuySellAds', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBuysellads as default, defaultColor };
