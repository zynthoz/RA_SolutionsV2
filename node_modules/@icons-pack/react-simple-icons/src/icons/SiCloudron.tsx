    ...
    type SiCloudronProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCloudron: IconType = React.forwardRef<SVGSVGElement, SiCloudronProps>(function SiCloudron({title = 'Cloudron', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCloudron as default, defaultColor };
