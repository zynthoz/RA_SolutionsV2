    ...
    type SiLogseqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLogseq: IconType = React.forwardRef<SVGSVGElement, SiLogseqProps>(function SiLogseq({title = 'Logseq', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
