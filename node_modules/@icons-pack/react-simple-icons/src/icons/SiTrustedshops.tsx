    ...
    type SiTrustedshopsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrustedshops: IconType = React.forwardRef<SVGSVGElement, SiTrustedshopsProps>(function SiTrustedshops({title = 'Trusted Shops', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
