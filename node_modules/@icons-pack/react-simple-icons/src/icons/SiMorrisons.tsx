    ...
    type SiMorrisonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#007531';

    const SiMorrisons: IconType = React.forwardRef<SVGSVGElement, SiMorrisonsProps>(function SiMorrisons({title = 'Morrisons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMorrisons as default, defaultColor };
