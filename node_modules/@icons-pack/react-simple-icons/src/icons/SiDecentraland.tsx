    ...
    type SiDecentralandProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDecentraland: IconType = React.forwardRef<SVGSVGElement, SiDecentralandProps>(function SiDecentraland({title = 'Decentraland', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
