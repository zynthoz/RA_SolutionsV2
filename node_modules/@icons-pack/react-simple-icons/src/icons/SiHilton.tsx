    ...
    type SiHiltonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHilton: IconType = React.forwardRef<SVGSVGElement, SiHiltonProps>(function SiHilton({title = 'Hilton', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
