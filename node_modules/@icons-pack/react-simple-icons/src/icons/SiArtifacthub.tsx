    ...
    type SiArtifacthubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArtifacthub: IconType = React.forwardRef<SVGSVGElement, SiArtifacthubProps>(function SiArtifacthub({title = 'Artifact Hub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
