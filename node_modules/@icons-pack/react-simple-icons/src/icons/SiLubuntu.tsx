    ...
    type SiLubuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0068C8';

    const SiLubuntu: IconType = React.forwardRef<SVGSVGElement, SiLubuntuProps>(function SiLubuntu({title = 'Lubuntu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLubuntu as default, defaultColor };
