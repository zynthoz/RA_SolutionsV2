    ...
    type SiCartoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCarto: IconType = React.forwardRef<SVGSVGElement, SiCartoProps>(function SiCarto({title = 'Carto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCarto as default, defaultColor };
