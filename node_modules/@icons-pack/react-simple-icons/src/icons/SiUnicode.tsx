    ...
    type SiUnicodeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnicode: IconType = React.forwardRef<SVGSVGElement, SiUnicodeProps>(function SiUnicode({title = 'Unicode', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
