    ...
    type SiSemverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSemver: IconType = React.forwardRef<SVGSVGElement, SiSemverProps>(function SiSemver({title = 'SemVer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
