    ...
    type SiSmugmugProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSmugmug: IconType = React.forwardRef<SVGSVGElement, SiSmugmugProps>(function SiSmugmug({title = 'SmugMug', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
