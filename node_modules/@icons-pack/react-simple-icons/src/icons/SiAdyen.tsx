    ...
    type SiAdyenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdyen: IconType = React.forwardRef<SVGSVGElement, SiAdyenProps>(function SiAdyen({title = 'Adyen', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdyen as default, defaultColor };
