    ...
    type SiFalcoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00AEC7';

    const SiFalco: IconType = React.forwardRef<SVGSVGElement, SiFalcoProps>(function SiFalco({title = 'Falco', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFalco as default, defaultColor };
