    ...
    type SiAfterpayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAfterpay: IconType = React.forwardRef<SVGSVGElement, SiAfterpayProps>(function SiAfterpay({title = 'Afterpay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAfterpay as default, defaultColor };
