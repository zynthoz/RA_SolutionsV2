    ...
    type SiDaznProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDazn: IconType = React.forwardRef<SVGSVGElement, SiDaznProps>(function SiDazn({title = 'DAZN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDazn as default, defaultColor };
