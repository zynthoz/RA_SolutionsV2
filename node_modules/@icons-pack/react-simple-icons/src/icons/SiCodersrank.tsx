    ...
    type SiCodersrankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodersrank: IconType = React.forwardRef<SVGSVGElement, SiCodersrankProps>(function SiCodersrank({title = 'CodersRank', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
