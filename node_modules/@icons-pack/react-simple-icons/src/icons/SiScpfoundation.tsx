    ...
    type SiScpfoundationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScpfoundation: IconType = React.forwardRef<SVGSVGElement, SiScpfoundationProps>(function SiScpfoundation({title = 'SCP Foundation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
