    ...
    type SiStackhawkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStackhawk: IconType = React.forwardRef<SVGSVGElement, SiStackhawkProps>(function SiStackhawk({title = 'StackHawk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
