    ...
    type SiWalletconnectProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3B99FC';

    const SiWalletconnect: IconType = React.forwardRef<SVGSVGElement, SiWalletconnectProps>(function SiWalletconnect({title = 'WalletConnect', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWalletconnect as default, defaultColor };
