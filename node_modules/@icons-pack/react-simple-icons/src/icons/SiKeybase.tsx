    ...
    type SiKeybaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKeybase: IconType = React.forwardRef<SVGSVGElement, SiKeybaseProps>(function SiKeybase({title = 'Keybase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKeybase as default, defaultColor };
