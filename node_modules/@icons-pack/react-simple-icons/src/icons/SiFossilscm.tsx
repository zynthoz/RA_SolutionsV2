    ...
    type SiFossilscmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#548294';

    const SiFossilscm: IconType = React.forwardRef<SVGSVGElement, SiFossilscmProps>(function SiFossilscm({title = 'Fossil SCM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
