    ...
    type SiF5Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiF5: IconType = React.forwardRef<SVGSVGElement, SiF5Props>(function SiF5({title = 'F5', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiF5 as default, defaultColor };
