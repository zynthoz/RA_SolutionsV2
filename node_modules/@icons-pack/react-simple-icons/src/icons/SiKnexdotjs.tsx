    ...
    type SiKnexdotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKnexdotjs: IconType = React.forwardRef<SVGSVGElement, SiKnexdotjsProps>(function SiKnexdotjs({title = 'Knex.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
