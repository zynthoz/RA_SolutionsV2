    ...
    type SiContentstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E74C3D';

    const SiContentstack: IconType = React.forwardRef<SVGSVGElement, SiContentstackProps>(function SiContentstack({title = 'Contentstack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiContentstack as default, defaultColor };
