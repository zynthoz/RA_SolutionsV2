    ...
    type SiPortainerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#13BEF9';

    const SiPortainer: IconType = React.forwardRef<SVGSVGElement, SiPortainerProps>(function SiPortainer({title = 'Portainer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
