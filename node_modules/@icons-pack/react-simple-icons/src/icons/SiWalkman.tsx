    ...
    type SiWalkmanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWalkman: IconType = React.forwardRef<SVGSVGElement, SiWalkmanProps>(function SiWalkman({title = 'WALKMAN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWalkman as default, defaultColor };
