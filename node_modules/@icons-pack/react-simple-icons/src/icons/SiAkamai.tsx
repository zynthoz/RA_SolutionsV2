    ...
    type SiAkamaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAkamai: IconType = React.forwardRef<SVGSVGElement, SiAkamaiProps>(function SiAkamai({title = 'Akamai', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAkamai as default, defaultColor };
