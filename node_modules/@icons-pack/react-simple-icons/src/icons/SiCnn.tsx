    ...
    type SiCnnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCnn: IconType = React.forwardRef<SVGSVGElement, SiCnnProps>(function SiCnn({title = 'CNN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
