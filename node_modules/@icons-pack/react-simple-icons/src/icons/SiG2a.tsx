    ...
    type SiG2aProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F05F00';

    const SiG2a: IconType = React.forwardRef<SVGSVGElement, SiG2aProps>(function SiG2a({title = 'G2A', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
