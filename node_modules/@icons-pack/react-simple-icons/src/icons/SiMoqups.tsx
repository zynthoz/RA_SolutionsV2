    ...
    type SiMoqupsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#006BE5';

    const SiMoqups: IconType = React.forwardRef<SVGSVGElement, SiMoqupsProps>(function SiMoqups({title = 'Moqups', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMoqups as default, defaultColor };
