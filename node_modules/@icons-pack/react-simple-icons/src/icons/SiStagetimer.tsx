    ...
    type SiStagetimerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A66C';

    const SiStagetimer: IconType = React.forwardRef<SVGSVGElement, SiStagetimerProps>(function SiStagetimer({title = 'Stagetimer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
