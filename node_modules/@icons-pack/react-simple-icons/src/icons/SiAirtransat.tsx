    ...
    type SiAirtransatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirtransat: IconType = React.forwardRef<SVGSVGElement, SiAirtransatProps>(function SiAirtransat({title = 'Air Transat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
