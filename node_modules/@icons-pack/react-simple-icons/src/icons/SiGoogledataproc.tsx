    ...
    type SiGoogledataprocProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledataproc: IconType = React.forwardRef<SVGSVGElement, SiGoogledataprocProps>(function SiGoogledataproc({title = 'Google Dataproc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogledataproc as default, defaultColor };
