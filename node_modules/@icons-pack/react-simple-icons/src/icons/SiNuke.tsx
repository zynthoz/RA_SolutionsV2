    ...
    type SiNukeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNuke: IconType = React.forwardRef<SVGSVGElement, SiNukeProps>(function SiNuke({title = 'Nuke', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNuke as default, defaultColor };
