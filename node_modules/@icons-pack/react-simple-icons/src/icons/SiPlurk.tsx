    ...
    type SiPlurkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF574D';

    const SiPlurk: IconType = React.forwardRef<SVGSVGElement, SiPlurkProps>(function SiPlurk({title = 'Plurk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlurk as default, defaultColor };
