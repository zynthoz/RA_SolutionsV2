    ...
    type SiBevyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBevy: IconType = React.forwardRef<SVGSVGElement, SiBevyProps>(function SiBevy({title = 'Bevy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBevy as default, defaultColor };
