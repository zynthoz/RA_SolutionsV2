    ...
    type SiAeromexicoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAeromexico: IconType = React.forwardRef<SVGSVGElement, SiAeromexicoProps>(function SiAeromexico({title = 'Aeroméxico', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
