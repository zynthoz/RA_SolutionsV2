    ...
    type SiXrpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#25A768';

    const SiXrp: IconType = React.forwardRef<SVGSVGElement, SiXrpProps>(function SiXrp({title = 'XRP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiXrp as default, defaultColor };
