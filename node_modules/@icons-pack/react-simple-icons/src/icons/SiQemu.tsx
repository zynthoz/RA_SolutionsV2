    ...
    type SiQemuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQemu: IconType = React.forwardRef<SVGSVGElement, SiQemuProps>(function SiQemu({title = 'QEMU', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQemu as default, defaultColor };
