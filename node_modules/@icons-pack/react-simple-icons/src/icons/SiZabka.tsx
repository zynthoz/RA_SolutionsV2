    ...
    type SiZabkaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#006420';

    const SiZabka: IconType = React.forwardRef<SVGSVGElement, SiZabkaProps>(function SiZabka({title = 'Żabka', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZabka as default, defaultColor };
