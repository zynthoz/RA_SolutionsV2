    ...
    type SiBaiduProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBaidu: IconType = React.forwardRef<SVGSVGElement, SiBaiduProps>(function SiBaidu({title = 'Baidu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
