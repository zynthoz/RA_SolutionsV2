    ...
    type SiActivisionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiActivision: IconType = React.forwardRef<SVGSVGElement, SiActivisionProps>(function SiActivision({title = 'Activision', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiActivision as default, defaultColor };
