    ...
    type SiInstatusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInstatus: IconType = React.forwardRef<SVGSVGElement, SiInstatusProps>(function SiInstatus({title = 'Instatus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
