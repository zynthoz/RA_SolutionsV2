    ...
    type SiReweProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRewe: IconType = React.forwardRef<SVGSVGElement, SiReweProps>(function SiRewe({title = 'REWE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
