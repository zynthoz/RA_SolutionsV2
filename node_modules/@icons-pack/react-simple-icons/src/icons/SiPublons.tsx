    ...
    type SiPublonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPublons: IconType = React.forwardRef<SVGSVGElement, SiPublonsProps>(function SiPublons({title = 'Publons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
