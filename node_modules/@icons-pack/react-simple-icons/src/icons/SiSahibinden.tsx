    ...
    type SiSahibindenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSahibinden: IconType = React.forwardRef<SVGSVGElement, SiSahibindenProps>(function SiSahibinden({title = 'Sahibinden', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
