    ...
    type SiFeedlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2BB24C';

    const SiFeedly: IconType = React.forwardRef<SVGSVGElement, SiFeedlyProps>(function SiFeedly({title = 'Feedly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFeedly as default, defaultColor };
