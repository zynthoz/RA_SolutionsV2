    ...
    type SiOsgeoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4CB05B';

    const SiOsgeo: IconType = React.forwardRef<SVGSVGElement, SiOsgeoProps>(function SiOsgeo({title = 'OSGeo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
