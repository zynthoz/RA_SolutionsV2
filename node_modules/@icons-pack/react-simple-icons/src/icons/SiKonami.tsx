    ...
    type SiKonamiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKonami: IconType = React.forwardRef<SVGSVGElement, SiKonamiProps>(function SiKonami({title = 'Konami', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
