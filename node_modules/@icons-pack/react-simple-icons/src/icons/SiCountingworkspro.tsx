    ...
    type SiCountingworksproProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2E3084';

    const SiCountingworkspro: IconType = React.forwardRef<SVGSVGElement, SiCountingworksproProps>(function SiCountingworkspro({title = 'CountingWorks PRO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCountingworkspro as default, defaultColor };
