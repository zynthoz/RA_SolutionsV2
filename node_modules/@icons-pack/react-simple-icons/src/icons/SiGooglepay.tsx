    ...
    type SiGooglepayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglepay: IconType = React.forwardRef<SVGSVGElement, SiGooglepayProps>(function SiGooglepay({title = 'Google Pay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
