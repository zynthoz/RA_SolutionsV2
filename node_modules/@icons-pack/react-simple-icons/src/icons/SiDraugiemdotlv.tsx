    ...
    type SiDraugiemdotlvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDraugiemdotlv: IconType = React.forwardRef<SVGSVGElement, SiDraugiemdotlvProps>(function SiDraugiemdotlv({title = 'Draugiem.lv', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDraugiemdotlv as default, defaultColor };
