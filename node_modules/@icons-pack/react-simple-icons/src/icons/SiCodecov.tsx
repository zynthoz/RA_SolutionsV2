    ...
    type SiCodecovProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodecov: IconType = React.forwardRef<SVGSVGElement, SiCodecovProps>(function SiCodecov({title = 'Codecov', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodecov as default, defaultColor };
