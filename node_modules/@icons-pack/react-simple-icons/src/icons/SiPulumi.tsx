    ...
    type SiPulumiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPulumi: IconType = React.forwardRef<SVGSVGElement, SiPulumiProps>(function SiPulumi({title = 'Pulumi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
