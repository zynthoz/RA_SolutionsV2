    ...
    type SiAlbertheijnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlbertheijn: IconType = React.forwardRef<SVGSVGElement, SiAlbertheijnProps>(function SiAlbertheijn({title = 'Albert Heijn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlbertheijn as default, defaultColor };
