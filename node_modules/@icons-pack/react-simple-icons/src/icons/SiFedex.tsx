    ...
    type SiFedexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4D148C';

    const SiFedex: IconType = React.forwardRef<SVGSVGElement, SiFedexProps>(function SiFedex({title = 'FedEx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFedex as default, defaultColor };
