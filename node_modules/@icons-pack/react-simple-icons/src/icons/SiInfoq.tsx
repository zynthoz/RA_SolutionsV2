    ...
    type SiInfoqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfoq: IconType = React.forwardRef<SVGSVGElement, SiInfoqProps>(function SiInfoq({title = 'InfoQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
