    ...
    type SiHacktheboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHackthebox: IconType = React.forwardRef<SVGSVGElement, SiHacktheboxProps>(function SiHackthebox({title = 'Hack The Box', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHackthebox as default, defaultColor };
