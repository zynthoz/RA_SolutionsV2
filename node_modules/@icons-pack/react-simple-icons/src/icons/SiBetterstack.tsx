    ...
    type SiBetterstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBetterstack: IconType = React.forwardRef<SVGSVGElement, SiBetterstackProps>(function SiBetterstack({title = 'Better Stack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBetterstack as default, defaultColor };
