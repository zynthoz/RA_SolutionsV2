    ...
    type SiSvgtraceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSvgtrace: IconType = React.forwardRef<SVGSVGElement, SiSvgtraceProps>(function SiSvgtrace({title = 'SvgTrace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
