    ...
    type SiVlcmediaplayerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVlcmediaplayer: IconType = React.forwardRef<SVGSVGElement, SiVlcmediaplayerProps>(function SiVlcmediaplayer({title = 'VLC media player', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVlcmediaplayer as default, defaultColor };
