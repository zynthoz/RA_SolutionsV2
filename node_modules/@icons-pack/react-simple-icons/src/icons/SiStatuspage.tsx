    ...
    type SiStatuspageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStatuspage: IconType = React.forwardRef<SVGSVGElement, SiStatuspageProps>(function SiStatuspage({title = 'Statuspage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
