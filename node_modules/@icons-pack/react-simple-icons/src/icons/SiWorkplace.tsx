    ...
    type SiWorkplaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4526CE';

    const SiWorkplace: IconType = React.forwardRef<SVGSVGElement, SiWorkplaceProps>(function SiWorkplace({title = 'Workplace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWorkplace as default, defaultColor };
