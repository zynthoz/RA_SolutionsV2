    ...
    type SiVivoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#415FFF';

    const SiVivo: IconType = React.forwardRef<SVGSVGElement, SiVivoProps>(function SiVivo({title = 'vivo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVivo as default, defaultColor };
