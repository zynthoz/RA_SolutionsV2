    ...
    type SiWebrtcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebrtc: IconType = React.forwardRef<SVGSVGElement, SiWebrtcProps>(function SiWebrtc({title = 'WebRTC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebrtc as default, defaultColor };
