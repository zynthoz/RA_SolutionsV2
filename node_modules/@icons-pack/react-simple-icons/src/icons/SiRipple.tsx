    ...
    type SiRippleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0085C0';

    const SiRipple: IconType = React.forwardRef<SVGSVGElement, SiRippleProps>(function SiRipple({title = 'Ripple', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRipple as default, defaultColor };
