    ...
    type SiIrisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#25313C';

    const SiIris: IconType = React.forwardRef<SVGSVGElement, SiIrisProps>(function SiIris({title = 'IRIS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIris as default, defaultColor };
