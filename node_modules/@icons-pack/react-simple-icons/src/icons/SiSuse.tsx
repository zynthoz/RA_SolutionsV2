    ...
    type SiSuseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSuse: IconType = React.forwardRef<SVGSVGElement, SiSuseProps>(function SiSuse({title = 'SUSE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSuse as default, defaultColor };
