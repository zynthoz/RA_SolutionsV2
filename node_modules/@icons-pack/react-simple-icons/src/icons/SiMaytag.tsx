    ...
    type SiMaytagProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMaytag: IconType = React.forwardRef<SVGSVGElement, SiMaytagProps>(function SiMaytag({title = 'Maytag', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
