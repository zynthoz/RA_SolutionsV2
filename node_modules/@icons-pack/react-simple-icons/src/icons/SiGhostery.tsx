    ...
    type SiGhosteryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGhostery: IconType = React.forwardRef<SVGSVGElement, SiGhosteryProps>(function SiGhostery({title = 'Ghostery', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
