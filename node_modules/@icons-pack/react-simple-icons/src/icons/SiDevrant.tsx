    ...
    type SiDevrantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDevrant: IconType = React.forwardRef<SVGSVGElement, SiDevrantProps>(function SiDevrant({title = 'devRant', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
