    ...
    type SiTacobellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTacobell: IconType = React.forwardRef<SVGSVGElement, SiTacobellProps>(function SiTacobell({title = 'Taco Bell', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTacobell as default, defaultColor };
