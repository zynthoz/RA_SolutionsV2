    ...
    type SiSubversionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSubversion: IconType = React.forwardRef<SVGSVGElement, SiSubversionProps>(function SiSubversion({title = 'Subversion', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
