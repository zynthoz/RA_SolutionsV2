    ...
    type SiQuestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FB4F14';

    const SiQuest: IconType = React.forwardRef<SVGSVGElement, SiQuestProps>(function SiQuest({title = 'Quest', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQuest as default, defaultColor };
