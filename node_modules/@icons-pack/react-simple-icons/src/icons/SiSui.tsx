    ...
    type SiSuiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSui: IconType = React.forwardRef<SVGSVGElement, SiSuiProps>(function SiSui({title = 'Sui', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
