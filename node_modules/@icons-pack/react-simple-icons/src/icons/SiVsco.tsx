    ...
    type SiVscoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVsco: IconType = React.forwardRef<SVGSVGElement, SiVscoProps>(function SiVsco({title = 'VSCO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
