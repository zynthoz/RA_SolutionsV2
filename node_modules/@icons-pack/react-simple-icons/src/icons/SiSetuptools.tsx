    ...
    type SiSetuptoolsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#336790';

    const SiSetuptools: IconType = React.forwardRef<SVGSVGElement, SiSetuptoolsProps>(function SiSetuptools({title = 'Setuptools', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
