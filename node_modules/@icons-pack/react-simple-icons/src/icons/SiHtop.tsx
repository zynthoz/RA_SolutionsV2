    ...
    type SiHtopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHtop: IconType = React.forwardRef<SVGSVGElement, SiHtopProps>(function SiHtop({title = 'htop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHtop as default, defaultColor };
