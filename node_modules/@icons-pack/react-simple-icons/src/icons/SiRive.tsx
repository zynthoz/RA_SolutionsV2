    ...
    type SiRiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRive: IconType = React.forwardRef<SVGSVGElement, SiRiveProps>(function SiRive({title = 'Rive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
