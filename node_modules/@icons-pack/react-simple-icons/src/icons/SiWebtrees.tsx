    ...
    type SiWebtreesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebtrees: IconType = React.forwardRef<SVGSVGElement, SiWebtreesProps>(function SiWebtrees({title = 'webtrees', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
