    ...
    type SiSyncthingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSyncthing: IconType = React.forwardRef<SVGSVGElement, SiSyncthingProps>(function SiSyncthing({title = 'Syncthing', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
