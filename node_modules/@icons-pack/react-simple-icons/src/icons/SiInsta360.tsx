    ...
    type SiInsta360Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFEE00';

    const SiInsta360: IconType = React.forwardRef<SVGSVGElement, SiInsta360Props>(function SiInsta360({title = 'Insta360', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiInsta360 as default, defaultColor };
