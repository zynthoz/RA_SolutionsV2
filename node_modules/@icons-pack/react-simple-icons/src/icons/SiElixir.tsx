    ...
    type SiElixirProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElixir: IconType = React.forwardRef<SVGSVGElement, SiElixirProps>(function SiElixir({title = 'Elixir', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiElixir as default, defaultColor };
