    ...
    type SiGoogleappsscriptProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleappsscript: IconType = React.forwardRef<SVGSVGElement, SiGoogleappsscriptProps>(function SiGoogleappsscript({title = 'Google Apps Script', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
