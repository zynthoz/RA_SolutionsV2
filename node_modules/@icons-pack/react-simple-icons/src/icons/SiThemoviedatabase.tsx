    ...
    type SiThemoviedatabaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#01B4E4';

    const SiThemoviedatabase: IconType = React.forwardRef<SVGSVGElement, SiThemoviedatabaseProps>(function SiThemoviedatabase({title = 'The Movie Database', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiThemoviedatabase as default, defaultColor };
