    ...
    type SiOmadacloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOmadacloud: IconType = React.forwardRef<SVGSVGElement, SiOmadacloudProps>(function SiOmadacloud({title = 'Omada Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
