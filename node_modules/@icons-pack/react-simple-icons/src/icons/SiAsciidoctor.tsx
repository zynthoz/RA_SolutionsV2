    ...
    type SiAsciidoctorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAsciidoctor: IconType = React.forwardRef<SVGSVGElement, SiAsciidoctorProps>(function SiAsciidoctor({title = 'Asciidoctor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
