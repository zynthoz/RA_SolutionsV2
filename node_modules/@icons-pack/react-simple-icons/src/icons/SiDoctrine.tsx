    ...
    type SiDoctrineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDoctrine: IconType = React.forwardRef<SVGSVGElement, SiDoctrineProps>(function SiDoctrine({title = 'Doctrine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDoctrine as default, defaultColor };
