    ...
    type SiBookmyshowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#C4242B';

    const SiBookmyshow: IconType = React.forwardRef<SVGSVGElement, SiBookmyshowProps>(function SiBookmyshow({title = 'BookMyShow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
