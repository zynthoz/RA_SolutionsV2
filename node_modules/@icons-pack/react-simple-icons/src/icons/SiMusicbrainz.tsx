    ...
    type SiMusicbrainzProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMusicbrainz: IconType = React.forwardRef<SVGSVGElement, SiMusicbrainzProps>(function SiMusicbrainz({title = 'MusicBrainz', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
