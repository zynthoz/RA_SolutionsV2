    ...
    type SiMultisimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMultisim: IconType = React.forwardRef<SVGSVGElement, SiMultisimProps>(function SiMultisim({title = 'Multisim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMultisim as default, defaultColor };
