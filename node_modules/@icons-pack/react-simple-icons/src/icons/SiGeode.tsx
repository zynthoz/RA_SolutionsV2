    ...
    type SiGeodeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#8D7ACF';

    const SiGeode: IconType = React.forwardRef<SVGSVGElement, SiGeodeProps>(function SiGeode({title = 'Geode', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
