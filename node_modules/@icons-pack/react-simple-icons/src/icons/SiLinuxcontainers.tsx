    ...
    type SiLinuxcontainersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLinuxcontainers: IconType = React.forwardRef<SVGSVGElement, SiLinuxcontainersProps>(function SiLinuxcontainers({title = 'Linux Containers', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLinuxcontainers as default, defaultColor };
