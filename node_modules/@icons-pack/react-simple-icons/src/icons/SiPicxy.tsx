    ...
    type SiPicxyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPicxy: IconType = React.forwardRef<SVGSVGElement, SiPicxyProps>(function SiPicxy({title = 'Picxy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPicxy as default, defaultColor };
