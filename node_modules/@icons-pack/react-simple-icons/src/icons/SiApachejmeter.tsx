    ...
    type SiApachejmeterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachejmeter: IconType = React.forwardRef<SVGSVGElement, SiApachejmeterProps>(function SiApachejmeter({title = 'Apache JMeter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
