    ...
    type SiDragonframeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D4911E';

    const SiDragonframe: IconType = React.forwardRef<SVGSVGElement, SiDragonframeProps>(function SiDragonframe({title = 'Dragonframe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
