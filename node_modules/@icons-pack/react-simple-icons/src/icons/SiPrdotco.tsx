    ...
    type SiPrdotcoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrdotco: IconType = React.forwardRef<SVGSVGElement, SiPrdotcoProps>(function SiPrdotco({title = 'pr.co', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
