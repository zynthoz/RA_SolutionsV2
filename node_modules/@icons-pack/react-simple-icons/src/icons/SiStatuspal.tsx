    ...
    type SiStatuspalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStatuspal: IconType = React.forwardRef<SVGSVGElement, SiStatuspalProps>(function SiStatuspal({title = 'Statuspal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
