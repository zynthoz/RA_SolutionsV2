    ...
    type SiIrobotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6CB86A';

    const SiIrobot: IconType = React.forwardRef<SVGSVGElement, SiIrobotProps>(function SiIrobot({title = 'iRobot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIrobot as default, defaultColor };
