    ...
    type SiUnitedairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnitedairlines: IconType = React.forwardRef<SVGSVGElement, SiUnitedairlinesProps>(function SiUnitedairlines({title = 'United Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUnitedairlines as default, defaultColor };
