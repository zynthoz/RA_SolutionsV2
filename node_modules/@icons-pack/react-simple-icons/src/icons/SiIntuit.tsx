    ...
    type SiIntuitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#236CFF';

    const SiIntuit: IconType = React.forwardRef<SVGSVGElement, SiIntuitProps>(function SiIntuit({title = 'Intuit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIntuit as default, defaultColor };
