    ...
    type SiShadowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiShadow: IconType = React.forwardRef<SVGSVGElement, SiShadowProps>(function SiShadow({title = 'Shadow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
