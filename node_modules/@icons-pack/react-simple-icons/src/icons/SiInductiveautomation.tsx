    ...
    type SiInductiveautomationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#445C6D';

    const SiInductiveautomation: IconType = React.forwardRef<SVGSVGElement, SiInductiveautomationProps>(function SiInductiveautomation({title = 'Inductive Automation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
