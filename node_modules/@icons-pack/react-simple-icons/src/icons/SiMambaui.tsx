    ...
    type SiMambauiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#6D28D9';

    const SiMambaui: IconType = React.forwardRef<SVGSVGElement, SiMambauiProps>(function SiMambaui({title = 'Mamba UI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMambaui as default, defaultColor };
