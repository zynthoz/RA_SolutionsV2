    ...
    type SiEventstoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEventstore: IconType = React.forwardRef<SVGSVGElement, SiEventstoreProps>(function SiEventstore({title = 'Event Store', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEventstore as default, defaultColor };
