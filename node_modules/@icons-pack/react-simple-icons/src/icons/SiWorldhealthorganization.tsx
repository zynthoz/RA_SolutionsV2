    ...
    type SiWorldhealthorganizationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0093D5';

    const SiWorldhealthorganization: IconType = React.forwardRef<SVGSVGElement, SiWorldhealthorganizationProps>(function SiWorldhealthorganization({title = 'World Health Organization', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWorldhealthorganization as default, defaultColor };
