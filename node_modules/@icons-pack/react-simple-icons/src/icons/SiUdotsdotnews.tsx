    ...
    type SiUdotsdotnewsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#005EA6';

    const SiUdotsdotnews: IconType = React.forwardRef<SVGSVGElement, SiUdotsdotnewsProps>(function SiUdotsdotnews({title = 'U.S. News', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
