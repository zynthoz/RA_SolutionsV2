    ...
    type SiFoxtelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB5205';

    const SiFoxtel: IconType = React.forwardRef<SVGSVGElement, SiFoxtelProps>(function SiFoxtel({title = 'Foxtel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFoxtel as default, defaultColor };
