    ...
    type SiGooglestreetviewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglestreetview: IconType = React.forwardRef<SVGSVGElement, SiGooglestreetviewProps>(function SiGooglestreetview({title = 'Google Street View', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
