    ...
    type SiBugattiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBugatti: IconType = React.forwardRef<SVGSVGElement, SiBugattiProps>(function SiBugatti({title = 'Bugatti', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
