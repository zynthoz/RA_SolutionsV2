    ...
    type SiFreebsdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFreebsd: IconType = React.forwardRef<SVGSVGElement, SiFreebsdProps>(function SiFreebsd({title = 'FreeBSD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
