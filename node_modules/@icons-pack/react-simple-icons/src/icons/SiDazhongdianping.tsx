    ...
    type SiDazhongdianpingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDazhongdianping: IconType = React.forwardRef<SVGSVGElement, SiDazhongdianpingProps>(function SiDazhongdianping({title = 'Dazhong Dianping', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
