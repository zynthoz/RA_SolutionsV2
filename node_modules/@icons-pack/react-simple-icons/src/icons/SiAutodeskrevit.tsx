    ...
    type SiAutodeskrevitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutodeskrevit: IconType = React.forwardRef<SVGSVGElement, SiAutodeskrevitProps>(function SiAutodeskrevit({title = 'Autodesk Revit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAutodeskrevit as default, defaultColor };
