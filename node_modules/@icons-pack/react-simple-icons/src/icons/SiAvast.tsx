    ...
    type SiAvastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAvast: IconType = React.forwardRef<SVGSVGElement, SiAvastProps>(function SiAvast({title = 'Avast', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
