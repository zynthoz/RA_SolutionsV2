    ...
    type SiMariadbfoundationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1F305F';

    const SiMariadbfoundation: IconType = React.forwardRef<SVGSVGElement, SiMariadbfoundationProps>(function SiMariadbfoundation({title = 'MariaDB Foundation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMariadbfoundation as default, defaultColor };
