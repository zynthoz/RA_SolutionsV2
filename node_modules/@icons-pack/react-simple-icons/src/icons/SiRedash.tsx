    ...
    type SiRedashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF7964';

    const SiRedash: IconType = React.forwardRef<SVGSVGElement, SiRedashProps>(function SiRedash({title = 'Redash', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRedash as default, defaultColor };
