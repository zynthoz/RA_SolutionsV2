    ...
    type SiBlockbenchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlockbench: IconType = React.forwardRef<SVGSVGElement, SiBlockbenchProps>(function SiBlockbench({title = 'Blockbench', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBlockbench as default, defaultColor };
