    ...
    type SiRemixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRemix: IconType = React.forwardRef<SVGSVGElement, SiRemixProps>(function SiRemix({title = 'Remix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
