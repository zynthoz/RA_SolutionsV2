    ...
    type SiDuckduckgoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDuckduckgo: IconType = React.forwardRef<SVGSVGElement, SiDuckduckgoProps>(function SiDuckduckgo({title = 'DuckDuckGo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
