    ...
    type SiTindieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#17AEB9';

    const SiTindie: IconType = React.forwardRef<SVGSVGElement, SiTindieProps>(function SiTindie({title = 'Tindie', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTindie as default, defaultColor };
