    ...
    type SiBarclaysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBarclays: IconType = React.forwardRef<SVGSVGElement, SiBarclaysProps>(function SiBarclays({title = 'Barclays', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBarclays as default, defaultColor };
