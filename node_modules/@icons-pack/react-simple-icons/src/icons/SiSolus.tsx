    ...
    type SiSolusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSolus: IconType = React.forwardRef<SVGSVGElement, SiSolusProps>(function SiSolus({title = 'Solus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
