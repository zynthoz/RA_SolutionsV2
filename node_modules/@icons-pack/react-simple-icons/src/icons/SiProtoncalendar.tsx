    ...
    type SiProtoncalendarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProtoncalendar: IconType = React.forwardRef<SVGSVGElement, SiProtoncalendarProps>(function SiProtoncalendar({title = 'Proton Calendar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
