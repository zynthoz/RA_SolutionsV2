    ...
    type SiTrivyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrivy: IconType = React.forwardRef<SVGSVGElement, SiTrivyProps>(function SiTrivy({title = 'Trivy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTrivy as default, defaultColor };
