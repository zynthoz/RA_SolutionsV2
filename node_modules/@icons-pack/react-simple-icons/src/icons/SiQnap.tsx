    ...
    type SiQnapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0C2E82';

    const SiQnap: IconType = React.forwardRef<SVGSVGElement, SiQnapProps>(function SiQnap({title = 'QNAP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQnap as default, defaultColor };
