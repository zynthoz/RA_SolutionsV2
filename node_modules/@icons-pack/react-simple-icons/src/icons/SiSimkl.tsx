    ...
    type SiSimklProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSimkl: IconType = React.forwardRef<SVGSVGElement, SiSimklProps>(function SiSimkl({title = 'Simkl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
