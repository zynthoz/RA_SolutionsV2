    ...
    type SiSeleniumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSelenium: IconType = React.forwardRef<SVGSVGElement, SiSeleniumProps>(function SiSelenium({title = 'Selenium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
