    ...
    type SiFastifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFastify: IconType = React.forwardRef<SVGSVGElement, SiFastifyProps>(function SiFastify({title = 'Fastify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFastify as default, defaultColor };
