    ...
    type SiVfairsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EF4678';

    const SiVfairs: IconType = React.forwardRef<SVGSVGElement, SiVfairsProps>(function SiVfairs({title = 'vFairs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVfairs as default, defaultColor };
