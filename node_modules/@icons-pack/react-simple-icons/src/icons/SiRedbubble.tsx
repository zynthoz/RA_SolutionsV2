    ...
    type SiRedbubbleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedbubble: IconType = React.forwardRef<SVGSVGElement, SiRedbubbleProps>(function SiRedbubble({title = 'Redbubble', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
