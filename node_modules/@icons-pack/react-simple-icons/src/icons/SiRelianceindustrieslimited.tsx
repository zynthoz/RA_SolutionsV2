    ...
    type SiRelianceindustrieslimitedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D1AB66';

    const SiRelianceindustrieslimited: IconType = React.forwardRef<SVGSVGElement, SiRelianceindustrieslimitedProps>(function SiRelianceindustrieslimited({title = 'Reliance Industries Limited', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRelianceindustrieslimited as default, defaultColor };
