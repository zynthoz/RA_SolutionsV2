    ...
    type SiQuickbooksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQuickbooks: IconType = React.forwardRef<SVGSVGElement, SiQuickbooksProps>(function SiQuickbooks({title = 'QuickBooks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
