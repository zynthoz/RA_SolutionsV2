    ...
    type SiGraylogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGraylog: IconType = React.forwardRef<SVGSVGElement, SiGraylogProps>(function SiGraylog({title = 'Graylog', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
