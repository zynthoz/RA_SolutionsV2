    ...
    type SiKatanaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKatana: IconType = React.forwardRef<SVGSVGElement, SiKatanaProps>(function SiKatana({title = 'Katana', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
