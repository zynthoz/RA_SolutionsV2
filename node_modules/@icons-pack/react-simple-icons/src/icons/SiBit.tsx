    ...
    type SiBitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBit: IconType = React.forwardRef<SVGSVGElement, SiBitProps>(function SiBit({title = 'Bit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBit as default, defaultColor };
