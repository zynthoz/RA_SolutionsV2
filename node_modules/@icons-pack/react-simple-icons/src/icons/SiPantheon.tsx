    ...
    type SiPantheonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPantheon: IconType = React.forwardRef<SVGSVGElement, SiPantheonProps>(function SiPantheon({title = 'Pantheon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
