    ...
    type SiAquaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAqua: IconType = React.forwardRef<SVGSVGElement, SiAquaProps>(function SiAqua({title = 'Aqua', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAqua as default, defaultColor };
