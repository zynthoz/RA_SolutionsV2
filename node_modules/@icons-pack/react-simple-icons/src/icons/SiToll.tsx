    ...
    type SiTollProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiToll: IconType = React.forwardRef<SVGSVGElement, SiTollProps>(function SiToll({title = 'Toll', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
