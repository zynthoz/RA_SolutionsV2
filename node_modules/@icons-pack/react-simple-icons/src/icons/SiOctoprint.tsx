    ...
    type SiOctoprintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOctoprint: IconType = React.forwardRef<SVGSVGElement, SiOctoprintProps>(function SiOctoprint({title = 'OctoPrint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
