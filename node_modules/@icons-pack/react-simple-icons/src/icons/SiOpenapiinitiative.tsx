    ...
    type SiOpenapiinitiativeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenapiinitiative: IconType = React.forwardRef<SVGSVGElement, SiOpenapiinitiativeProps>(function SiOpenapiinitiative({title = 'OpenAPI Initiative', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpenapiinitiative as default, defaultColor };
