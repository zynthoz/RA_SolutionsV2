    ...
    type SiArxivProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArxiv: IconType = React.forwardRef<SVGSVGElement, SiArxivProps>(function SiArxiv({title = 'arXiv', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
