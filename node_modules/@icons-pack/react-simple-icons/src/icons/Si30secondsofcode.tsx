    ...
    type Si30secondsofcodeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si30secondsofcode: IconType = React.forwardRef<SVGSVGElement, Si30secondsofcodeProps>(function Si30secondsofcode({title = '30 seconds of code', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
