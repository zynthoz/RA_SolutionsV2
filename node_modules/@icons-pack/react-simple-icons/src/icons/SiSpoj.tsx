    ...
    type SiSpojProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#337AB7';

    const SiSpoj: IconType = React.forwardRef<SVGSVGElement, SiSpojProps>(function SiSpoj({title = 'Sphere Online Judge', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpoj as default, defaultColor };
