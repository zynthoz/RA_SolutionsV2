    ...
    type SiTruliaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrulia: IconType = React.forwardRef<SVGSVGElement, SiTruliaProps>(function SiTrulia({title = 'trulia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
