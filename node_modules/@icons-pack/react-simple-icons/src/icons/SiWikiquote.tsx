    ...
    type SiWikiquoteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikiquote: IconType = React.forwardRef<SVGSVGElement, SiWikiquoteProps>(function SiWikiquote({title = 'Wikiquote', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
