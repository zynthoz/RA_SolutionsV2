    ...
    type SiNfcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNfc: IconType = React.forwardRef<SVGSVGElement, SiNfcProps>(function SiNfc({title = 'NFC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
