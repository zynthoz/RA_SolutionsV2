    ...
    type SiGnusocialProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGnusocial: IconType = React.forwardRef<SVGSVGElement, SiGnusocialProps>(function SiGnusocial({title = 'GNU social', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGnusocial as default, defaultColor };
