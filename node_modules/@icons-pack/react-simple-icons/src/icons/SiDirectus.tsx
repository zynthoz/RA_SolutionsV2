    ...
    type SiDirectusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDirectus: IconType = React.forwardRef<SVGSVGElement, SiDirectusProps>(function SiDirectus({title = 'Directus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDirectus as default, defaultColor };
