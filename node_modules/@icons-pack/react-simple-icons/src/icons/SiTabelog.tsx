    ...
    type SiTabelogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTabelog: IconType = React.forwardRef<SVGSVGElement, SiTabelogProps>(function SiTabelog({title = 'Tabelog', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
