    ...
    type SiTroveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrove: IconType = React.forwardRef<SVGSVGElement, SiTroveProps>(function SiTrove({title = 'Trove', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
