    ...
    type SiSpigotmcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED8106';

    const SiSpigotmc: IconType = React.forwardRef<SVGSVGElement, SiSpigotmcProps>(function SiSpigotmc({title = 'SpigotMC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpigotmc as default, defaultColor };
