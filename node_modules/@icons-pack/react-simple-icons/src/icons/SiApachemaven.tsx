    ...
    type SiApachemavenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#C71A36';

    const SiApachemaven: IconType = React.forwardRef<SVGSVGElement, SiApachemavenProps>(function SiApachemaven({title = 'Apache Maven', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachemaven as default, defaultColor };
