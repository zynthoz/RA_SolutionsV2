    ...
    type SiStrykerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStryker: IconType = React.forwardRef<SVGSVGElement, SiStrykerProps>(function SiStryker({title = 'Stryker', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
