    ...
    type SiQantasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E40000';

    const SiQantas: IconType = React.forwardRef<SVGSVGElement, SiQantasProps>(function SiQantas({title = 'Qantas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQantas as default, defaultColor };
