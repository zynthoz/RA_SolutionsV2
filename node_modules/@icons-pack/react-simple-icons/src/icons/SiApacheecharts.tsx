    ...
    type SiApacheechartsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApacheecharts: IconType = React.forwardRef<SVGSVGElement, SiApacheechartsProps>(function SiApacheecharts({title = 'Apache ECharts', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
