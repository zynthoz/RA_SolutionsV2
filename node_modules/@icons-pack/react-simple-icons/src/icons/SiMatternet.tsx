    ...
    type SiMatternetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#261C29';

    const SiMatternet: IconType = React.forwardRef<SVGSVGElement, SiMatternetProps>(function SiMatternet({title = 'Matternet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
