    ...
    type SiArloProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArlo: IconType = React.forwardRef<SVGSVGElement, SiArloProps>(function SiArlo({title = 'Arlo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArlo as default, defaultColor };
