    ...
    type SiBazelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBazel: IconType = React.forwardRef<SVGSVGElement, SiBazelProps>(function SiBazel({title = 'Bazel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
