    ...
    type SiMahindraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMahindra: IconType = React.forwardRef<SVGSVGElement, SiMahindraProps>(function SiMahindra({title = 'Mahindra', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
