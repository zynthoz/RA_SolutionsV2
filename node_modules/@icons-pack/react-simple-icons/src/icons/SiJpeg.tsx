    ...
    type SiJpegProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJpeg: IconType = React.forwardRef<SVGSVGElement, SiJpegProps>(function SiJpeg({title = 'JPEG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
