    ...
    type SiGnuemacsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7F5AB6';

    const SiGnuemacs: IconType = React.forwardRef<SVGSVGElement, SiGnuemacsProps>(function SiGnuemacs({title = 'GNU Emacs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGnuemacs as default, defaultColor };
