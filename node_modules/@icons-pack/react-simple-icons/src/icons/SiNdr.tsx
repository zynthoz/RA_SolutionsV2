    ...
    type SiNdrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNdr: IconType = React.forwardRef<SVGSVGElement, SiNdrProps>(function SiNdr({title = 'NDR', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
