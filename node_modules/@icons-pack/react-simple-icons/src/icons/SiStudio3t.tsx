    ...
    type SiStudio3tProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStudio3t: IconType = React.forwardRef<SVGSVGElement, SiStudio3tProps>(function SiStudio3t({title = 'Studio 3T', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
