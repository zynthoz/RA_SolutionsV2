    ...
    type SiMastercomfigProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMastercomfig: IconType = React.forwardRef<SVGSVGElement, SiMastercomfigProps>(function SiMastercomfig({title = 'mastercomfig', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMastercomfig as default, defaultColor };
