    ...
    type SiStatamicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF269E';

    const SiStatamic: IconType = React.forwardRef<SVGSVGElement, SiStatamicProps>(function SiStatamic({title = 'Statamic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStatamic as default, defaultColor };
