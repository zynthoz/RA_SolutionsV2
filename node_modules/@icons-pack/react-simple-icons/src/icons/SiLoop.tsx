    ...
    type SiLoopProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLoop: IconType = React.forwardRef<SVGSVGElement, SiLoopProps>(function SiLoop({title = 'Loop', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
