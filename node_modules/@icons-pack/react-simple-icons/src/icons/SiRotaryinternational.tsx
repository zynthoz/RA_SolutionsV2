    ...
    type SiRotaryinternationalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F7A81B';

    const SiRotaryinternational: IconType = React.forwardRef<SVGSVGElement, SiRotaryinternationalProps>(function SiRotaryinternational({title = 'Rotary International', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRotaryinternational as default, defaultColor };
