    ...
    type SiSlideshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSlideshare: IconType = React.forwardRef<SVGSVGElement, SiSlideshareProps>(function SiSlideshare({title = 'SlideShare', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
