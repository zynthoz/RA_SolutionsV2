    ...
    type SiIterm2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIterm2: IconType = React.forwardRef<SVGSVGElement, SiIterm2Props>(function SiIterm2({title = 'iTerm2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIterm2 as default, defaultColor };
