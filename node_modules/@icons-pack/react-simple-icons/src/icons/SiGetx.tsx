    ...
    type SiGetxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGetx: IconType = React.forwardRef<SVGSVGElement, SiGetxProps>(function SiGetx({title = 'GetX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
