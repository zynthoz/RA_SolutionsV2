    ...
    type SiRoonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2039F3';

    const SiRoon: IconType = React.forwardRef<SVGSVGElement, SiRoonProps>(function SiRoon({title = 'Roon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
