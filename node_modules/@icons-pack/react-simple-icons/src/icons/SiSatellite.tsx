    ...
    type SiSatelliteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSatellite: IconType = React.forwardRef<SVGSVGElement, SiSatelliteProps>(function SiSatellite({title = 'Satellite', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
