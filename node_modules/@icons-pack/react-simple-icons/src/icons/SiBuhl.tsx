    ...
    type SiBuhlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBuhl: IconType = React.forwardRef<SVGSVGElement, SiBuhlProps>(function SiBuhl({title = 'Buhl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
