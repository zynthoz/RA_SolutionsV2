    ...
    type SiEndeavourosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7F7FFF';

    const SiEndeavouros: IconType = React.forwardRef<SVGSVGElement, SiEndeavourosProps>(function SiEndeavouros({title = 'EndeavourOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEndeavouros as default, defaultColor };
