    ...
    type SiRhinocerosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#801010';

    const SiRhinoceros: IconType = React.forwardRef<SVGSVGElement, SiRhinocerosProps>(function SiRhinoceros({title = 'Rhinoceros', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
