    ...
    type SiThemodelsresourceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3A75BD';

    const SiThemodelsresource: IconType = React.forwardRef<SVGSVGElement, SiThemodelsresourceProps>(function SiThemodelsresource({title = 'The Models Resource', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
