    ...
    type SiClubhouseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiClubhouse: IconType = React.forwardRef<SVGSVGElement, SiClubhouseProps>(function SiClubhouse({title = 'Clubhouse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiClubhouse as default, defaultColor };
