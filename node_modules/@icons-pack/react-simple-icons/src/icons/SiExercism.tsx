    ...
    type SiExercismProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiExercism: IconType = React.forwardRef<SVGSVGElement, SiExercismProps>(function SiExercism({title = 'Exercism', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiExercism as default, defaultColor };
