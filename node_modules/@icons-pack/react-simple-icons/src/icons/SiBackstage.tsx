    ...
    type SiBackstageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBackstage: IconType = React.forwardRef<SVGSVGElement, SiBackstageProps>(function SiBackstage({title = 'Backstage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
