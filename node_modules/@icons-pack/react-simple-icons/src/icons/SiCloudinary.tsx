    ...
    type SiCloudinaryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCloudinary: IconType = React.forwardRef<SVGSVGElement, SiCloudinaryProps>(function SiCloudinary({title = 'Cloudinary', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCloudinary as default, defaultColor };
