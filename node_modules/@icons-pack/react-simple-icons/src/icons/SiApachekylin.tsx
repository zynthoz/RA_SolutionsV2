    ...
    type SiApachekylinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F09D13';

    const SiApachekylin: IconType = React.forwardRef<SVGSVGElement, SiApachekylinProps>(function SiApachekylin({title = 'Apache Kylin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachekylin as default, defaultColor };
