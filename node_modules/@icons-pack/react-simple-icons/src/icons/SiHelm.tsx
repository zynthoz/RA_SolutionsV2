    ...
    type SiHelmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHelm: IconType = React.forwardRef<SVGSVGElement, SiHelmProps>(function SiHelm({title = 'Helm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
