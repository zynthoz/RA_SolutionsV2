    ...
    type SiRedhatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedhat: IconType = React.forwardRef<SVGSVGElement, SiRedhatProps>(function SiRedhat({title = 'Red Hat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
