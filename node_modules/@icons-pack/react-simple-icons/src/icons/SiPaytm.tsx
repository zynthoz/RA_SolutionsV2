    ...
    type SiPaytmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaytm: IconType = React.forwardRef<SVGSVGElement, SiPaytmProps>(function SiPaytm({title = 'Paytm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
