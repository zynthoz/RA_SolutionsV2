    ...
    type SiProtoolsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProtools: IconType = React.forwardRef<SVGSVGElement, SiProtoolsProps>(function SiProtools({title = 'Pro Tools', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
