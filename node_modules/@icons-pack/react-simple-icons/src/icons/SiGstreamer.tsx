    ...
    type SiGstreamerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGstreamer: IconType = React.forwardRef<SVGSVGElement, SiGstreamerProps>(function SiGstreamer({title = 'GStreamer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
