    ...
    type SiAdminerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdminer: IconType = React.forwardRef<SVGSVGElement, SiAdminerProps>(function SiAdminer({title = 'Adminer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdminer as default, defaultColor };
