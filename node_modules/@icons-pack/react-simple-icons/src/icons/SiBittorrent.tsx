    ...
    type SiBittorrentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBittorrent: IconType = React.forwardRef<SVGSVGElement, SiBittorrentProps>(function SiBittorrent({title = 'BitTorrent', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
