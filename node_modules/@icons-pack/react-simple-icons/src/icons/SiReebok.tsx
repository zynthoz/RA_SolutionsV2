    ...
    type SiReebokProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReebok: IconType = React.forwardRef<SVGSVGElement, SiReebokProps>(function SiReebok({title = 'Reebok', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
