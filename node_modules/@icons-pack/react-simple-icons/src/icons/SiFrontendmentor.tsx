    ...
    type SiFrontendmentorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3F54A3';

    const SiFrontendmentor: IconType = React.forwardRef<SVGSVGElement, SiFrontendmentorProps>(function SiFrontendmentor({title = 'Frontend Mentor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFrontendmentor as default, defaultColor };
