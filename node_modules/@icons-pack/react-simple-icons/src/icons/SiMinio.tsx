    ...
    type SiMinioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMinio: IconType = React.forwardRef<SVGSVGElement, SiMinioProps>(function SiMinio({title = 'MinIO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
