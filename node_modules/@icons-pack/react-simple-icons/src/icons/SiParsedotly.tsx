    ...
    type SiParsedotlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5BA745';

    const SiParsedotly: IconType = React.forwardRef<SVGSVGElement, SiParsedotlyProps>(function SiParsedotly({title = 'Parse.ly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiParsedotly as default, defaultColor };
