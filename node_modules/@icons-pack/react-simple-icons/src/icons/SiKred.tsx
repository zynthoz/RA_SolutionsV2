    ...
    type SiKredProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKred: IconType = React.forwardRef<SVGSVGElement, SiKredProps>(function SiKred({title = 'Kred', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
