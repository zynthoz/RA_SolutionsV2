    ...
    type SiAlibabadotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlibabadotcom: IconType = React.forwardRef<SVGSVGElement, SiAlibabadotcomProps>(function SiAlibabadotcom({title = 'Alibaba.com', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlibabadotcom as default, defaultColor };
