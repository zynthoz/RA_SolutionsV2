    ...
    type SiDogecoinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDogecoin: IconType = React.forwardRef<SVGSVGElement, SiDogecoinProps>(function SiDogecoin({title = 'Dogecoin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
