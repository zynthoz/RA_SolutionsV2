    ...
    type SiSpondProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EE4353';

    const SiSpond: IconType = React.forwardRef<SVGSVGElement, SiSpondProps>(function SiSpond({title = 'Spond', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpond as default, defaultColor };
