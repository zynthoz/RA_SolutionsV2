    ...
    type SiIgdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIgdb: IconType = React.forwardRef<SVGSVGElement, SiIgdbProps>(function SiIgdb({title = 'IGDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIgdb as default, defaultColor };
