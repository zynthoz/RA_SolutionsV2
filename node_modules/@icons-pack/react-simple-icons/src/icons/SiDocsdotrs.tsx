    ...
    type SiDocsdotrsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDocsdotrs: IconType = React.forwardRef<SVGSVGElement, SiDocsdotrsProps>(function SiDocsdotrs({title = 'Docs.rs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
