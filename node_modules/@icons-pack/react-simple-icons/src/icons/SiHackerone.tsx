    ...
    type SiHackeroneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHackerone: IconType = React.forwardRef<SVGSVGElement, SiHackeroneProps>(function SiHackerone({title = 'HackerOne', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
