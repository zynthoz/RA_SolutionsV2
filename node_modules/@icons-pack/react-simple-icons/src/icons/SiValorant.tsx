    ...
    type SiValorantProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FA4454';

    const SiValorant: IconType = React.forwardRef<SVGSVGElement, SiValorantProps>(function SiValorant({title = 'Valorant', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiValorant as default, defaultColor };
