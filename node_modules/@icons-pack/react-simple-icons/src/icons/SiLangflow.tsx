    ...
    type SiLangflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLangflow: IconType = React.forwardRef<SVGSVGElement, SiLangflowProps>(function SiLangflow({title = 'Langflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
