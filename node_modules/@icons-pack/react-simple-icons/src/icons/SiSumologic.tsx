    ...
    type SiSumologicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSumologic: IconType = React.forwardRef<SVGSVGElement, SiSumologicProps>(function SiSumologic({title = 'Sumo Logic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSumologic as default, defaultColor };
