    ...
    type SiSkeletonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSkeleton: IconType = React.forwardRef<SVGSVGElement, SiSkeletonProps>(function SiSkeleton({title = 'Skeleton', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSkeleton as default, defaultColor };
