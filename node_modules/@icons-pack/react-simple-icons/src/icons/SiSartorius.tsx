    ...
    type SiSartoriusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSartorius: IconType = React.forwardRef<SVGSVGElement, SiSartoriusProps>(function SiSartorius({title = 'Sartorius', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
