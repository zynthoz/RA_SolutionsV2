    ...
    type SiPorkbunProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPorkbun: IconType = React.forwardRef<SVGSVGElement, SiPorkbunProps>(function SiPorkbun({title = 'Porkbun', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
