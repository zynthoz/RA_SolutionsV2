    ...
    type SiTourboxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTourbox: IconType = React.forwardRef<SVGSVGElement, SiTourboxProps>(function SiTourbox({title = 'TourBox', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTourbox as default, defaultColor };
