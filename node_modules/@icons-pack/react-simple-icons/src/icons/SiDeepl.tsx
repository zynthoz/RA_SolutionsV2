    ...
    type SiDeeplProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDeepl: IconType = React.forwardRef<SVGSVGElement, SiDeeplProps>(function SiDeepl({title = 'DeepL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
