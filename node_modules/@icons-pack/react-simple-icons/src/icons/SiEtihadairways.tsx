    ...
    type SiEtihadairwaysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEtihadairways: IconType = React.forwardRef<SVGSVGElement, SiEtihadairwaysProps>(function SiEtihadairways({title = 'Etihad Airways', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
