    ...
    type SiShenzhenmetroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiShenzhenmetro: IconType = React.forwardRef<SVGSVGElement, SiShenzhenmetroProps>(function SiShenzhenmetro({title = 'Shenzhen Metro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShenzhenmetro as default, defaultColor };
