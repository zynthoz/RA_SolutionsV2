    ...
    type SiMotorolaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E1140A';

    const SiMotorola: IconType = React.forwardRef<SVGSVGElement, SiMotorolaProps>(function SiMotorola({title = 'Motorola', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMotorola as default, defaultColor };
