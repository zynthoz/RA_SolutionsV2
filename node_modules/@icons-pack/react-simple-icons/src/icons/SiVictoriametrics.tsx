    ...
    type SiVictoriametricsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVictoriametrics: IconType = React.forwardRef<SVGSVGElement, SiVictoriametricsProps>(function SiVictoriametrics({title = 'VictoriaMetrics', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
