    ...
    type SiLaragonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0E83CD';

    const SiLaragon: IconType = React.forwardRef<SVGSVGElement, SiLaragonProps>(function SiLaragon({title = 'Laragon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLaragon as default, defaultColor };
