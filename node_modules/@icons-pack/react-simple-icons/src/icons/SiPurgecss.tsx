    ...
    type SiPurgecssProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPurgecss: IconType = React.forwardRef<SVGSVGElement, SiPurgecssProps>(function SiPurgecss({title = 'PurgeCSS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPurgecss as default, defaultColor };
