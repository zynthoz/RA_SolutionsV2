    ...
    type SiSurrealdbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSurrealdb: IconType = React.forwardRef<SVGSVGElement, SiSurrealdbProps>(function SiSurrealdb({title = 'SurrealDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSurrealdb as default, defaultColor };
