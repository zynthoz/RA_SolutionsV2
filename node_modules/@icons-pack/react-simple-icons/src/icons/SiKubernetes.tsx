    ...
    type SiKubernetesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKubernetes: IconType = React.forwardRef<SVGSVGElement, SiKubernetesProps>(function SiKubernetes({title = 'Kubernetes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKubernetes as default, defaultColor };
