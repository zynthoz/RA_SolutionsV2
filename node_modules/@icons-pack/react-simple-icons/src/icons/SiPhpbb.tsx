    ...
    type SiPhpbbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009BDF';

    const SiPhpbb: IconType = React.forwardRef<SVGSVGElement, SiPhpbbProps>(function SiPhpbb({title = 'phpBB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPhpbb as default, defaultColor };
