    ...
    type SiMumbleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMumble: IconType = React.forwardRef<SVGSVGElement, SiMumbleProps>(function SiMumble({title = 'Mumble', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMumble as default, defaultColor };
