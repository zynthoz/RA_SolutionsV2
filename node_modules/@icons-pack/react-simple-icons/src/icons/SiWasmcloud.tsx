    ...
    type SiWasmcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWasmcloud: IconType = React.forwardRef<SVGSVGElement, SiWasmcloudProps>(function SiWasmcloud({title = 'wasmCloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
