    ...
    type SiOriginProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOrigin: IconType = React.forwardRef<SVGSVGElement, SiOriginProps>(function SiOrigin({title = 'Origin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOrigin as default, defaultColor };
