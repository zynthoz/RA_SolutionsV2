    ...
    type SiDashProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDash: IconType = React.forwardRef<SVGSVGElement, SiDashProps>(function SiDash({title = 'Dash', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDash as default, defaultColor };
