    ...
    type SiJssProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJss: IconType = React.forwardRef<SVGSVGElement, SiJssProps>(function SiJss({title = 'JSS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJss as default, defaultColor };
