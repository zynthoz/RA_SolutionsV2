    ...
    type SiKnowledgebaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKnowledgebase: IconType = React.forwardRef<SVGSVGElement, SiKnowledgebaseProps>(function SiKnowledgebase({title = 'KnowledgeBase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
