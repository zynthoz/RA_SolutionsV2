    ...
    type SiFugacloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFugacloud: IconType = React.forwardRef<SVGSVGElement, SiFugacloudProps>(function SiFugacloud({title = 'Fuga Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
