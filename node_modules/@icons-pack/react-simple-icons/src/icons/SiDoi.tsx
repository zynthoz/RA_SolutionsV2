    ...
    type SiDoiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDoi: IconType = React.forwardRef<SVGSVGElement, SiDoiProps>(function SiDoi({title = 'DOI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
