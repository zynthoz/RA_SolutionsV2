    ...
    type SiScikitlearnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScikitlearn: IconType = React.forwardRef<SVGSVGElement, SiScikitlearnProps>(function SiScikitlearn({title = 'scikit-learn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScikitlearn as default, defaultColor };
