    ...
    type SiVestelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVestel: IconType = React.forwardRef<SVGSVGElement, SiVestelProps>(function SiVestel({title = 'Vestel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
