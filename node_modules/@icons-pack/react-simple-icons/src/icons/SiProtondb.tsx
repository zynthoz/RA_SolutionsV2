    ...
    type SiProtondbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProtondb: IconType = React.forwardRef<SVGSVGElement, SiProtondbProps>(function SiProtondb({title = 'ProtonDB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
