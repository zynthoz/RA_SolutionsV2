    ...
    type SiFiatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFiat: IconType = React.forwardRef<SVGSVGElement, SiFiatProps>(function SiFiat({title = 'Fiat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFiat as default, defaultColor };
