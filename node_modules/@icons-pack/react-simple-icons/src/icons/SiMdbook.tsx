    ...
    type SiMdbookProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMdbook: IconType = React.forwardRef<SVGSVGElement, SiMdbookProps>(function SiMdbook({title = 'mdBook', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMdbook as default, defaultColor };
