    ...
    type SiHyperxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHyperx: IconType = React.forwardRef<SVGSVGElement, SiHyperxProps>(function SiHyperx({title = 'HyperX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
