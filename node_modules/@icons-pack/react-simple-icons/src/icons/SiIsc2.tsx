    ...
    type SiIsc2Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIsc2: IconType = React.forwardRef<SVGSVGElement, SiIsc2Props>(function SiIsc2({title = 'ISC2', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
