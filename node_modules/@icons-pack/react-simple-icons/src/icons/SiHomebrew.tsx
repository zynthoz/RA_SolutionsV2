    ...
    type SiHomebrewProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHomebrew: IconType = React.forwardRef<SVGSVGElement, SiHomebrewProps>(function SiHomebrew({title = 'Homebrew', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
