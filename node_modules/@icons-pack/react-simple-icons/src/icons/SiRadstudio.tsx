    ...
    type SiRadstudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRadstudio: IconType = React.forwardRef<SVGSVGElement, SiRadstudioProps>(function SiRadstudio({title = 'RAD Studio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
