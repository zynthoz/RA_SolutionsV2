    ...
    type SiTaxbuzzProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTaxbuzz: IconType = React.forwardRef<SVGSVGElement, SiTaxbuzzProps>(function SiTaxbuzz({title = 'TaxBuzz', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
