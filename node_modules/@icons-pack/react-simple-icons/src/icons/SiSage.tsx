    ...
    type SiSageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00D639';

    const SiSage: IconType = React.forwardRef<SVGSVGElement, SiSageProps>(function SiSage({title = 'Sage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSage as default, defaultColor };
