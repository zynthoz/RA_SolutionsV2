    ...
    type SiZaimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZaim: IconType = React.forwardRef<SVGSVGElement, SiZaimProps>(function SiZaim({title = 'Zaim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
