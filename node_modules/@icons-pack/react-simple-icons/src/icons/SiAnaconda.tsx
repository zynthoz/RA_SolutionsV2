    ...
    type SiAnacondaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#44A833';

    const SiAnaconda: IconType = React.forwardRef<SVGSVGElement, SiAnacondaProps>(function SiAnaconda({title = 'Anaconda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAnaconda as default, defaultColor };
