    ...
    type SiPretzelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPretzel: IconType = React.forwardRef<SVGSVGElement, SiPretzelProps>(function SiPretzel({title = 'Pretzel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPretzel as default, defaultColor };
