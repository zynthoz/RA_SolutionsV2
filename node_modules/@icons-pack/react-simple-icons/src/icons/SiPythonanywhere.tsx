    ...
    type SiPythonanywhereProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1D9FD7';

    const SiPythonanywhere: IconType = React.forwardRef<SVGSVGElement, SiPythonanywhereProps>(function SiPythonanywhere({title = 'PythonAnywhere', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
