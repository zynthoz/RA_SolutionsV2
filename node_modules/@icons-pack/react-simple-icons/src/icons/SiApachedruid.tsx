    ...
    type SiApachedruidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachedruid: IconType = React.forwardRef<SVGSVGElement, SiApachedruidProps>(function SiApachedruid({title = 'Apache Druid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
