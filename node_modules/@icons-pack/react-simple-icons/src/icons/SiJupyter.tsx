    ...
    type SiJupyterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJupyter: IconType = React.forwardRef<SVGSVGElement, SiJupyterProps>(function SiJupyter({title = 'Jupyter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
