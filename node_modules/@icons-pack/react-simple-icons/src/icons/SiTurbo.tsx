    ...
    type SiTurboProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5CD8E5';

    const SiTurbo: IconType = React.forwardRef<SVGSVGElement, SiTurboProps>(function SiTurbo({title = 'Turbo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTurbo as default, defaultColor };
