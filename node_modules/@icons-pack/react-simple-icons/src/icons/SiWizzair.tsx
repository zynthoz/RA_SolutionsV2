    ...
    type SiWizzairProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWizzair: IconType = React.forwardRef<SVGSVGElement, SiWizzairProps>(function SiWizzair({title = 'Wizz Air', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
