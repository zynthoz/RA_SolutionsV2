    ...
    type SiAdonisjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5A45FF';

    const SiAdonisjs: IconType = React.forwardRef<SVGSVGElement, SiAdonisjsProps>(function SiAdonisjs({title = 'AdonisJS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdonisjs as default, defaultColor };
