    ...
    type SiFreshProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFDB1E';

    const SiFresh: IconType = React.forwardRef<SVGSVGElement, SiFreshProps>(function SiFresh({title = 'Fresh', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFresh as default, defaultColor };
