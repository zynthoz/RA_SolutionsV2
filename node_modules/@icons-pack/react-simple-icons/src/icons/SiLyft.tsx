    ...
    type SiLyftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLyft: IconType = React.forwardRef<SVGSVGElement, SiLyftProps>(function SiLyft({title = 'Lyft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
