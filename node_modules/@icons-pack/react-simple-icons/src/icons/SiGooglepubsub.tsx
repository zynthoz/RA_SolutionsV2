    ...
    type SiGooglepubsubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglepubsub: IconType = React.forwardRef<SVGSVGElement, SiGooglepubsubProps>(function SiGooglepubsub({title = 'Google Pub/Sub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGooglepubsub as default, defaultColor };
