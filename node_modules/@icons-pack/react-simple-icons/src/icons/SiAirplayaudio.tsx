    ...
    type SiAirplayaudioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirplayaudio: IconType = React.forwardRef<SVGSVGElement, SiAirplayaudioProps>(function SiAirplayaudio({title = 'AirPlay Audio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirplayaudio as default, defaultColor };
