    ...
    type SiTrillerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF0089';

    const SiTriller: IconType = React.forwardRef<SVGSVGElement, SiTrillerProps>(function SiTriller({title = 'Triller', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTriller as default, defaultColor };
