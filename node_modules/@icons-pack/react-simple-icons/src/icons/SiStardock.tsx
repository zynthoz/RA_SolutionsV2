    ...
    type SiStardockProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStardock: IconType = React.forwardRef<SVGSVGElement, SiStardockProps>(function SiStardock({title = 'Stardock', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStardock as default, defaultColor };
