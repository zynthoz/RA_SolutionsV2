    ...
    type SiKritaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKrita: IconType = React.forwardRef<SVGSVGElement, SiKritaProps>(function SiKrita({title = 'Krita', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
