    ...
    type SiDvcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDvc: IconType = React.forwardRef<SVGSVGElement, SiDvcProps>(function SiDvc({title = 'DVC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
