    ...
    type SiShowwcaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiShowwcase: IconType = React.forwardRef<SVGSVGElement, SiShowwcaseProps>(function SiShowwcase({title = 'Showwcase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShowwcase as default, defaultColor };
