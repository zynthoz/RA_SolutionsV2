    ...
    type SiHclProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHcl: IconType = React.forwardRef<SVGSVGElement, SiHclProps>(function SiHcl({title = 'HCL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
