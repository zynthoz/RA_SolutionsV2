    ...
    type SiDenonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDenon: IconType = React.forwardRef<SVGSVGElement, SiDenonProps>(function SiDenon({title = 'Denon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDenon as default, defaultColor };
