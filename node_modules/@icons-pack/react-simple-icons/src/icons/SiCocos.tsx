    ...
    type SiCocosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#55C2E1';

    const SiCocos: IconType = React.forwardRef<SVGSVGElement, SiCocosProps>(function SiCocos({title = 'Cocos', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
