    ...
    type SiJoplinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJoplin: IconType = React.forwardRef<SVGSVGElement, SiJoplinProps>(function SiJoplin({title = 'Joplin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
