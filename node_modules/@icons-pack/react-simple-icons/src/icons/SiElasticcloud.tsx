    ...
    type SiElasticcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElasticcloud: IconType = React.forwardRef<SVGSVGElement, SiElasticcloudProps>(function SiElasticcloud({title = 'Elastic Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
