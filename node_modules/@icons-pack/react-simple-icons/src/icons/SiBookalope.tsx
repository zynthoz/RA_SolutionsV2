    ...
    type SiBookalopeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBookalope: IconType = React.forwardRef<SVGSVGElement, SiBookalopeProps>(function SiBookalope({title = 'Bookalope', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBookalope as default, defaultColor };
