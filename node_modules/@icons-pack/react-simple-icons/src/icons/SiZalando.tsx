    ...
    type SiZalandoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZalando: IconType = React.forwardRef<SVGSVGElement, SiZalandoProps>(function SiZalando({title = 'Zalando', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZalando as default, defaultColor };
