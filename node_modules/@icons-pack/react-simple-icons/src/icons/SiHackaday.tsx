    ...
    type SiHackadayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHackaday: IconType = React.forwardRef<SVGSVGElement, SiHackadayProps>(function SiHackaday({title = 'Hackaday', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHackaday as default, defaultColor };
