    ...
    type SiCodenewbieProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodenewbie: IconType = React.forwardRef<SVGSVGElement, SiCodenewbieProps>(function SiCodenewbie({title = 'CodeNewbie', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
