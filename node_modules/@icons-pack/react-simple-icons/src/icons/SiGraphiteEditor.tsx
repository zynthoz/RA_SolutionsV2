    ...
    type SiGraphiteEditorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#473A3A';

    const SiGraphiteEditor: IconType = React.forwardRef<SVGSVGElement, SiGraphiteEditorProps>(function SiGraphiteEditor({title = 'Graphite', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGraphiteEditor as default, defaultColor };
