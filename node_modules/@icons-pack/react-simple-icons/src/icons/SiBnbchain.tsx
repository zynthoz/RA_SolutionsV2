    ...
    type SiBnbchainProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBnbchain: IconType = React.forwardRef<SVGSVGElement, SiBnbchainProps>(function SiBnbchain({title = 'BNB Chain', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
