    ...
    type SiObsidianProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiObsidian: IconType = React.forwardRef<SVGSVGElement, SiObsidianProps>(function SiObsidian({title = 'Obsidian', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
