    ...
    type SiMuralProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMural: IconType = React.forwardRef<SVGSVGElement, SiMuralProps>(function SiMural({title = 'Mural', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
