    ...
    type SiOdnoklassnikiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOdnoklassniki: IconType = React.forwardRef<SVGSVGElement, SiOdnoklassnikiProps>(function SiOdnoklassniki({title = 'Odnoklassniki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
