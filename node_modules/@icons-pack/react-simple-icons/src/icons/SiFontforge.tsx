    ...
    type SiFontforgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F2712B';

    const SiFontforge: IconType = React.forwardRef<SVGSVGElement, SiFontforgeProps>(function SiFontforge({title = 'FontForge', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFontforge as default, defaultColor };
