    ...
    type SiBasecampProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1D2D35';

    const SiBasecamp: IconType = React.forwardRef<SVGSVGElement, SiBasecampProps>(function SiBasecamp({title = 'Basecamp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBasecamp as default, defaultColor };
