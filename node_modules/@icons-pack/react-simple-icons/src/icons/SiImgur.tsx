    ...
    type SiImgurProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiImgur: IconType = React.forwardRef<SVGSVGElement, SiImgurProps>(function SiImgur({title = 'Imgur', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
