    ...
    type SiSimpleloginProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSimplelogin: IconType = React.forwardRef<SVGSVGElement, SiSimpleloginProps>(function SiSimplelogin({title = 'SimpleLogin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
