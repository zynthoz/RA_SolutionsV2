    ...
    type SiNewbalanceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNewbalance: IconType = React.forwardRef<SVGSVGElement, SiNewbalanceProps>(function SiNewbalance({title = 'New Balance', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
