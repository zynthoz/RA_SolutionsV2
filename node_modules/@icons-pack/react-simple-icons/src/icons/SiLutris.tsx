    ...
    type SiLutrisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLutris: IconType = React.forwardRef<SVGSVGElement, SiLutrisProps>(function SiLutris({title = 'Lutris', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLutris as default, defaultColor };
