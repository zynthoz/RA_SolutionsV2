    ...
    type SiAppgalleryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAppgallery: IconType = React.forwardRef<SVGSVGElement, SiAppgalleryProps>(function SiAppgallery({title = 'AppGallery', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppgallery as default, defaultColor };
