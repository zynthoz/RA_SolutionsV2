    ...
    type SiSinglestoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSinglestore: IconType = React.forwardRef<SVGSVGElement, SiSinglestoreProps>(function SiSinglestore({title = 'SingleStore', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
