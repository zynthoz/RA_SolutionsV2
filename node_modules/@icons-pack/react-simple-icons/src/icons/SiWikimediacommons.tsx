    ...
    type SiWikimediacommonsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#006699';

    const SiWikimediacommons: IconType = React.forwardRef<SVGSVGElement, SiWikimediacommonsProps>(function SiWikimediacommons({title = 'Wikimedia Commons', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWikimediacommons as default, defaultColor };
