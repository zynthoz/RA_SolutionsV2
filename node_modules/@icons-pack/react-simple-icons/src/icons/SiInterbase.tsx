    ...
    type SiInterbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInterbase: IconType = React.forwardRef<SVGSVGElement, SiInterbaseProps>(function SiInterbase({title = 'Interbase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
