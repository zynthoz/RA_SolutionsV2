    ...
    type SiBitcometProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBitcomet: IconType = React.forwardRef<SVGSVGElement, SiBitcometProps>(function SiBitcomet({title = 'BitComet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBitcomet as default, defaultColor };
