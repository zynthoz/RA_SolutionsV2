    ...
    type SiTaichilangProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTaichilang: IconType = React.forwardRef<SVGSVGElement, SiTaichilangProps>(function SiTaichilang({title = 'Taichi Lang', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
