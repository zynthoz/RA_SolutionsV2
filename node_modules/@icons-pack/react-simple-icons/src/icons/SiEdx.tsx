    ...
    type SiEdxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#02262B';

    const SiEdx: IconType = React.forwardRef<SVGSVGElement, SiEdxProps>(function SiEdx({title = 'edX', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEdx as default, defaultColor };
