    ...
    type SiTheweatherchannelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTheweatherchannel: IconType = React.forwardRef<SVGSVGElement, SiTheweatherchannelProps>(function SiTheweatherchannel({title = 'The Weather Channel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
