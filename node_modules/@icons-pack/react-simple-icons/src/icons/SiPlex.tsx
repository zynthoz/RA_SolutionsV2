    ...
    type SiPlexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlex: IconType = React.forwardRef<SVGSVGElement, SiPlexProps>(function SiPlex({title = 'Plex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
