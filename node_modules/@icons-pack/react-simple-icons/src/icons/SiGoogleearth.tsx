    ...
    type SiGoogleearthProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleearth: IconType = React.forwardRef<SVGSVGElement, SiGoogleearthProps>(function SiGoogleearth({title = 'Google Earth', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogleearth as default, defaultColor };
