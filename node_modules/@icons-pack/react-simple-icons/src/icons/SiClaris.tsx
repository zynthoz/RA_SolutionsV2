    ...
    type SiClarisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiClaris: IconType = React.forwardRef<SVGSVGElement, SiClarisProps>(function SiClaris({title = 'Claris', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiClaris as default, defaultColor };
