    ...
    type SiFilamentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFilament: IconType = React.forwardRef<SVGSVGElement, SiFilamentProps>(function SiFilament({title = 'Filament', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
