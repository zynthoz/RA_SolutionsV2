    ...
    type SiAlwaysdataProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#E9568E';

    const SiAlwaysdata: IconType = React.forwardRef<SVGSVGElement, SiAlwaysdataProps>(function SiAlwaysdata({title = 'Alwaysdata', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlwaysdata as default, defaultColor };
