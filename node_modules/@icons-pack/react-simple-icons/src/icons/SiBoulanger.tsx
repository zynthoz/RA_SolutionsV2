    ...
    type SiBoulangerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBoulanger: IconType = React.forwardRef<SVGSVGElement, SiBoulangerProps>(function SiBoulanger({title = 'boulanger', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
