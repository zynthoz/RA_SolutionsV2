    ...
    type SiJoomlaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJoomla: IconType = React.forwardRef<SVGSVGElement, SiJoomlaProps>(function SiJoomla({title = 'Joomla', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
