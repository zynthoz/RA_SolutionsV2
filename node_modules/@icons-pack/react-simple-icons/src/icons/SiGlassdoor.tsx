    ...
    type SiGlassdoorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGlassdoor: IconType = React.forwardRef<SVGSVGElement, SiGlassdoorProps>(function SiGlassdoor({title = 'Glassdoor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
