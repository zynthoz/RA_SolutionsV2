    ...
    type SiTgaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTga: IconType = React.forwardRef<SVGSVGElement, SiTgaProps>(function SiTga({title = 'TGA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
