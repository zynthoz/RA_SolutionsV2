    ...
    type SiQiwiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQiwi: IconType = React.forwardRef<SVGSVGElement, SiQiwiProps>(function SiQiwi({title = 'QIWI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
