    ...
    type SiZelleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZelle: IconType = React.forwardRef<SVGSVGElement, SiZelleProps>(function SiZelle({title = 'Zelle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
