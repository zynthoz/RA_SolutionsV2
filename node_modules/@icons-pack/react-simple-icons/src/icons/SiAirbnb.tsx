    ...
    type SiAirbnbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirbnb: IconType = React.forwardRef<SVGSVGElement, SiAirbnbProps>(function SiAirbnb({title = 'Airbnb', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirbnb as default, defaultColor };
