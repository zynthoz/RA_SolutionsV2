    ...
    type SiMonicaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2C2B29';

    const SiMonica: IconType = React.forwardRef<SVGSVGElement, SiMonicaProps>(function SiMonica({title = 'Monica', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
