    ...
    type SiChevroletProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChevrolet: IconType = React.forwardRef<SVGSVGElement, SiChevroletProps>(function SiChevrolet({title = 'Chevrolet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiChevrolet as default, defaultColor };
