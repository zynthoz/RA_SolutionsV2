    ...
    type SiBspwmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBspwm: IconType = React.forwardRef<SVGSVGElement, SiBspwmProps>(function SiBspwm({title = 'bspwm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBspwm as default, defaultColor };
