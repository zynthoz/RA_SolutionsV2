    ...
    type SiJenkinsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D24939';

    const SiJenkins: IconType = React.forwardRef<SVGSVGElement, SiJenkinsProps>(function SiJenkins({title = 'Jenkins', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJenkins as default, defaultColor };
