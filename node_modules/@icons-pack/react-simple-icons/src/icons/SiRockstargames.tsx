    ...
    type SiRockstargamesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FCAF17';

    const SiRockstargames: IconType = React.forwardRef<SVGSVGElement, SiRockstargamesProps>(function SiRockstargames({title = 'Rockstar Games', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRockstargames as default, defaultColor };
