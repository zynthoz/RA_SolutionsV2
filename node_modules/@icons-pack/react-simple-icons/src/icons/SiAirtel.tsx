    ...
    type SiAirtelProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirtel: IconType = React.forwardRef<SVGSVGElement, SiAirtelProps>(function SiAirtel({title = 'Airtel', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirtel as default, defaultColor };
