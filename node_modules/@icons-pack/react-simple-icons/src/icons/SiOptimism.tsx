    ...
    type SiOptimismProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF0420';

    const SiOptimism: IconType = React.forwardRef<SVGSVGElement, SiOptimismProps>(function SiOptimism({title = 'Optimism', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
