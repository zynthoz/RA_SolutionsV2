    ...
    type SiVivawalletProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1F263A';

    const SiVivawallet: IconType = React.forwardRef<SVGSVGElement, SiVivawalletProps>(function SiVivawallet({title = 'Viva Wallet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVivawallet as default, defaultColor };
