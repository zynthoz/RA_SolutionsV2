    ...
    type SiQgisProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQgis: IconType = React.forwardRef<SVGSVGElement, SiQgisProps>(function SiQgis({title = 'Qgis', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
