    ...
    type SiRollsroyceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRollsroyce: IconType = React.forwardRef<SVGSVGElement, SiRollsroyceProps>(function SiRollsroyce({title = 'Rolls-Royce', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRollsroyce as default, defaultColor };
