    ...
    type SiFitbitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFitbit: IconType = React.forwardRef<SVGSVGElement, SiFitbitProps>(function SiFitbit({title = 'Fitbit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFitbit as default, defaultColor };
