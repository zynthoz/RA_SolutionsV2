    ...
    type SiHerouiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHeroui: IconType = React.forwardRef<SVGSVGElement, SiHerouiProps>(function SiHeroui({title = 'HeroUI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHeroui as default, defaultColor };
