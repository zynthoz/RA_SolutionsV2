    ...
    type SiJitpackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJitpack: IconType = React.forwardRef<SVGSVGElement, SiJitpackProps>(function SiJitpack({title = 'JitPack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
