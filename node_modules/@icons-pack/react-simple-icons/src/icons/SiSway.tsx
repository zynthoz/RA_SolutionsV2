    ...
    type SiSwayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#68751C';

    const SiSway: IconType = React.forwardRef<SVGSVGElement, SiSwayProps>(function SiSway({title = 'Sway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSway as default, defaultColor };
