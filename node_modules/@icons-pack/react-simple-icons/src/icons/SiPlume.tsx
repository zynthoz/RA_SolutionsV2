    ...
    type SiPlumeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlume: IconType = React.forwardRef<SVGSVGElement, SiPlumeProps>(function SiPlume({title = 'Plume', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
