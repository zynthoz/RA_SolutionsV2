    ...
    type SiShellProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFD500';

    const SiShell: IconType = React.forwardRef<SVGSVGElement, SiShellProps>(function SiShell({title = 'Shell', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiShell as default, defaultColor };
