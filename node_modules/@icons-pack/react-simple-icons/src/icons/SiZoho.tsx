    ...
    type SiZohoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZoho: IconType = React.forwardRef<SVGSVGElement, SiZohoProps>(function SiZoho({title = 'Zoho', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZoho as default, defaultColor };
