    ...
    type SiCheerioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCheerio: IconType = React.forwardRef<SVGSVGElement, SiCheerioProps>(function SiCheerio({title = 'Cheerio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
