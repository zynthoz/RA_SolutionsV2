    ...
    type SiIbeaconProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIbeacon: IconType = React.forwardRef<SVGSVGElement, SiIbeaconProps>(function SiIbeacon({title = 'iBeacon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
