    ...
    type SiKlmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKlm: IconType = React.forwardRef<SVGSVGElement, SiKlmProps>(function SiKlm({title = 'KLM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
