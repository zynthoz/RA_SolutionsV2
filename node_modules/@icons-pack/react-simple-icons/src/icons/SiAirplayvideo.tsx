    ...
    type SiAirplayvideoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirplayvideo: IconType = React.forwardRef<SVGSVGElement, SiAirplayvideoProps>(function SiAirplayvideo({title = 'AirPlay Video', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirplayvideo as default, defaultColor };
