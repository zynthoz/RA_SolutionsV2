    ...
    type SiAtariProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAtari: IconType = React.forwardRef<SVGSVGElement, SiAtariProps>(function SiAtari({title = 'Atari', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
