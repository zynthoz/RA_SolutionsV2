    ...
    type SiHarborProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#60B932';

    const SiHarbor: IconType = React.forwardRef<SVGSVGElement, SiHarborProps>(function SiHarbor({title = 'Harbor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
