    ...
    type SiVictronenergyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVictronenergy: IconType = React.forwardRef<SVGSVGElement, SiVictronenergyProps>(function SiVictronenergy({title = 'Victron Energy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVictronenergy as default, defaultColor };
