    ...
    type SiHoudiniProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHoudini: IconType = React.forwardRef<SVGSVGElement, SiHoudiniProps>(function SiHoudini({title = 'Houdini', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
