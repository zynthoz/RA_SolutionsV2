    ...
    type SiSpeedtestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSpeedtest: IconType = React.forwardRef<SVGSVGElement, SiSpeedtestProps>(function SiSpeedtest({title = 'Speedtest', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
