    ...
    type SiUbuntuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUbuntu: IconType = React.forwardRef<SVGSVGElement, SiUbuntuProps>(function SiUbuntu({title = 'Ubuntu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
