    ...
    type SiOpentelemetryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpentelemetry: IconType = React.forwardRef<SVGSVGElement, SiOpentelemetryProps>(function SiOpentelemetry({title = 'OpenTelemetry', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
