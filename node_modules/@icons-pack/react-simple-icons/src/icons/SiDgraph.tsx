    ...
    type SiDgraphProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDgraph: IconType = React.forwardRef<SVGSVGElement, SiDgraphProps>(function SiDgraph({title = 'Dgraph', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
