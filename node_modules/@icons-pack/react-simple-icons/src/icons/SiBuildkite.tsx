    ...
    type SiBuildkiteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBuildkite: IconType = React.forwardRef<SVGSVGElement, SiBuildkiteProps>(function SiBuildkite({title = 'Buildkite', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
