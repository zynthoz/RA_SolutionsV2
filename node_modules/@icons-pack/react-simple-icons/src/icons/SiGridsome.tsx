    ...
    type SiGridsomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A672';

    const SiGridsome: IconType = React.forwardRef<SVGSVGElement, SiGridsomeProps>(function SiGridsome({title = 'Gridsome', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGridsome as default, defaultColor };
