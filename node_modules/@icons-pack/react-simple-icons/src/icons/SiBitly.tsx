    ...
    type SiBitlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBitly: IconType = React.forwardRef<SVGSVGElement, SiBitlyProps>(function SiBitly({title = 'Bitly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBitly as default, defaultColor };
