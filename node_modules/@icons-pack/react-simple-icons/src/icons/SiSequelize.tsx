    ...
    type SiSequelizeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#52B0E7';

    const SiSequelize: IconType = React.forwardRef<SVGSVGElement, SiSequelizeProps>(function SiSequelize({title = 'Sequelize', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSequelize as default, defaultColor };
