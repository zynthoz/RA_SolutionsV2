    ...
    type SiSailfishosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSailfishos: IconType = React.forwardRef<SVGSVGElement, SiSailfishosProps>(function SiSailfishos({title = 'Sailfish OS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
