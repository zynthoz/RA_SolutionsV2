    ...
    type SiAibProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAib: IconType = React.forwardRef<SVGSVGElement, SiAibProps>(function SiAib({title = 'AIB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAib as default, defaultColor };
