    ...
    type SiMlbProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMlb: IconType = React.forwardRef<SVGSVGElement, SiMlbProps>(function SiMlb({title = 'MLB', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
