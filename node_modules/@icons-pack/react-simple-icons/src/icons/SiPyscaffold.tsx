    ...
    type SiPyscaffoldProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPyscaffold: IconType = React.forwardRef<SVGSVGElement, SiPyscaffoldProps>(function SiPyscaffold({title = 'PyScaffold', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
