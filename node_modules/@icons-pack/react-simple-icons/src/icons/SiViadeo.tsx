    ...
    type SiViadeoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiViadeo: IconType = React.forwardRef<SVGSVGElement, SiViadeoProps>(function SiViadeo({title = 'Viadeo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
