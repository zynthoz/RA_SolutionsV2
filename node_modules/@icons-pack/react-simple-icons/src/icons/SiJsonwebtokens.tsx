    ...
    type SiJsonwebtokensProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJsonwebtokens: IconType = React.forwardRef<SVGSVGElement, SiJsonwebtokensProps>(function SiJsonwebtokens({title = 'JSON Web Tokens', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
