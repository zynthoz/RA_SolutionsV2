    ...
    type SiSpacyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSpacy: IconType = React.forwardRef<SVGSVGElement, SiSpacyProps>(function SiSpacy({title = 'spaCy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
