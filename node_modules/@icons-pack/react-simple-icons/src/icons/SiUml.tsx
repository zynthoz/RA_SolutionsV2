    ...
    type SiUmlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUml: IconType = React.forwardRef<SVGSVGElement, SiUmlProps>(function SiUml({title = 'UML', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
