    ...
    type SiFossaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#289E6D';

    const SiFossa: IconType = React.forwardRef<SVGSVGElement, SiFossaProps>(function SiFossa({title = 'Fossa', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFossa as default, defaultColor };
