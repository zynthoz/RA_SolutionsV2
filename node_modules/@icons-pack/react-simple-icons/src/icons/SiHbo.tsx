    ...
    type SiHboProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHbo: IconType = React.forwardRef<SVGSVGElement, SiHboProps>(function SiHbo({title = 'HBO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHbo as default, defaultColor };
