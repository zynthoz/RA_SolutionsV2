    ...
    type SiBoeingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBoeing: IconType = React.forwardRef<SVGSVGElement, SiBoeingProps>(function SiBoeing({title = 'Boeing', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBoeing as default, defaultColor };
