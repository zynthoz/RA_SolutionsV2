    ...
    type SiReactosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReactos: IconType = React.forwardRef<SVGSVGElement, SiReactosProps>(function SiReactos({title = 'ReactOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiReactos as default, defaultColor };
