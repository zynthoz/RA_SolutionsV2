    ...
    type SiPersonioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPersonio: IconType = React.forwardRef<SVGSVGElement, SiPersonioProps>(function SiPersonio({title = 'Personio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
