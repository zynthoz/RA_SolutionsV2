    ...
    type SiCssProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCss: IconType = React.forwardRef<SVGSVGElement, SiCssProps>(function SiCss({title = 'CSS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCss as default, defaultColor };
