    ...
    type SiByjusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiByjus: IconType = React.forwardRef<SVGSVGElement, SiByjusProps>(function SiByjus({title = 'Byjus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
