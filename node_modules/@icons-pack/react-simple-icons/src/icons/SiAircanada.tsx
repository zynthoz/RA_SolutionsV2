    ...
    type SiAircanadaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAircanada: IconType = React.forwardRef<SVGSVGElement, SiAircanadaProps>(function SiAircanada({title = 'Air Canada', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAircanada as default, defaultColor };
