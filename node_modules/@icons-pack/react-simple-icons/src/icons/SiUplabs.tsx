    ...
    type SiUplabsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3930D8';

    const SiUplabs: IconType = React.forwardRef<SVGSVGElement, SiUplabsProps>(function SiUplabs({title = 'UpLabs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUplabs as default, defaultColor };
