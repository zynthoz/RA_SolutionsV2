    ...
    type SiOpenzfsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2A667F';

    const SiOpenzfs: IconType = React.forwardRef<SVGSVGElement, SiOpenzfsProps>(function SiOpenzfs({title = 'OpenZFS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpenzfs as default, defaultColor };
