    ...
    type SiAutomatticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutomattic: IconType = React.forwardRef<SVGSVGElement, SiAutomatticProps>(function SiAutomattic({title = 'Automattic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
