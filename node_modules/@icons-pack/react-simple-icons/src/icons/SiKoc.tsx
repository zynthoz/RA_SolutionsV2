    ...
    type SiKocProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F9423A';

    const SiKoc: IconType = React.forwardRef<SVGSVGElement, SiKocProps>(function SiKoc({title = 'Koc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKoc as default, defaultColor };
