    ...
    type SiApacheairflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApacheairflow: IconType = React.forwardRef<SVGSVGElement, SiApacheairflowProps>(function SiApacheairflow({title = 'Apache Airflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApacheairflow as default, defaultColor };
