    ...
    type SiDistrokidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDistrokid: IconType = React.forwardRef<SVGSVGElement, SiDistrokidProps>(function SiDistrokid({title = 'Distrokid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDistrokid as default, defaultColor };
