    ...
    type SiJetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FBBA00';

    const SiJet: IconType = React.forwardRef<SVGSVGElement, SiJetProps>(function SiJet({title = 'JET', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJet as default, defaultColor };
