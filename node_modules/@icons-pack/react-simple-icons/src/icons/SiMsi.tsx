    ...
    type SiMsiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMsi: IconType = React.forwardRef<SVGSVGElement, SiMsiProps>(function SiMsi({title = 'MSI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
