    ...
    type SiModinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiModin: IconType = React.forwardRef<SVGSVGElement, SiModinProps>(function SiModin({title = 'Modin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
