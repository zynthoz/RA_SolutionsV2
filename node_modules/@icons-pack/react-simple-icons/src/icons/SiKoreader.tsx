    ...
    type SiKoreaderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKoreader: IconType = React.forwardRef<SVGSVGElement, SiKoreaderProps>(function SiKoreader({title = 'KOReader', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
