    ...
    type SiGrouponProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#53A318';

    const SiGroupon: IconType = React.forwardRef<SVGSVGElement, SiGrouponProps>(function SiGroupon({title = 'Groupon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGroupon as default, defaultColor };
