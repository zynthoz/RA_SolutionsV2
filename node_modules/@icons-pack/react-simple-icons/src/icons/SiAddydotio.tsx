    ...
    type SiAddydotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAddydotio: IconType = React.forwardRef<SVGSVGElement, SiAddydotioProps>(function SiAddydotio({title = 'addy.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAddydotio as default, defaultColor };
