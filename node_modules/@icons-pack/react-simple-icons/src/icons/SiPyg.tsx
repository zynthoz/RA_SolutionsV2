    ...
    type SiPygProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3C2179';

    const SiPyg: IconType = React.forwardRef<SVGSVGElement, SiPygProps>(function SiPyg({title = 'PyG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPyg as default, defaultColor };
