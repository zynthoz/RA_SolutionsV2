    ...
    type SiGooglecolabProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglecolab: IconType = React.forwardRef<SVGSVGElement, SiGooglecolabProps>(function SiGooglecolab({title = 'Google Colab', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
