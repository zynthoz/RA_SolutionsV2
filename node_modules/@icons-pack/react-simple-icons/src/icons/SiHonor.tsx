    ...
    type SiHonorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHonor: IconType = React.forwardRef<SVGSVGElement, SiHonorProps>(function SiHonor({title = 'Honor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHonor as default, defaultColor };
