    ...
    type SiWiproProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWipro: IconType = React.forwardRef<SVGSVGElement, SiWiproProps>(function SiWipro({title = 'Wipro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
