    ...
    type SiPaychexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaychex: IconType = React.forwardRef<SVGSVGElement, SiPaychexProps>(function SiPaychex({title = 'Paychex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPaychex as default, defaultColor };
