    ...
    type SiEclipseideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEclipseide: IconType = React.forwardRef<SVGSVGElement, SiEclipseideProps>(function SiEclipseide({title = 'Eclipse IDE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEclipseide as default, defaultColor };
