    ...
    type SiDassaultsystemesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDassaultsystemes: IconType = React.forwardRef<SVGSVGElement, SiDassaultsystemesProps>(function SiDassaultsystemes({title = 'Dassault Systèmes', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDassaultsystemes as default, defaultColor };
