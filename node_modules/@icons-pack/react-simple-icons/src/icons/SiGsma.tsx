    ...
    type SiGsmaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGsma: IconType = React.forwardRef<SVGSVGElement, SiGsmaProps>(function SiGsma({title = 'GSMA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
