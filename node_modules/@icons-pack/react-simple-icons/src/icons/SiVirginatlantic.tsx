    ...
    type SiVirginatlanticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVirginatlantic: IconType = React.forwardRef<SVGSVGElement, SiVirginatlanticProps>(function SiVirginatlantic({title = 'Virgin Atlantic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
