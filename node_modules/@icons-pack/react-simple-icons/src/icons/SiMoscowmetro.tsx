    ...
    type SiMoscowmetroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D9232E';

    const SiMoscowmetro: IconType = React.forwardRef<SVGSVGElement, SiMoscowmetroProps>(function SiMoscowmetro({title = 'Moscow Metro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMoscowmetro as default, defaultColor };
