    ...
    type SiMedibangpaintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMedibangpaint: IconType = React.forwardRef<SVGSVGElement, SiMedibangpaintProps>(function SiMedibangpaint({title = 'MediBang Paint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
