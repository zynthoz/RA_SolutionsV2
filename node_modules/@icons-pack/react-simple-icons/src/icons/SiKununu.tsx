    ...
    type SiKununuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKununu: IconType = React.forwardRef<SVGSVGElement, SiKununuProps>(function SiKununu({title = 'Kununu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
