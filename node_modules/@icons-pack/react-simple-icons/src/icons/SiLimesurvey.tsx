    ...
    type SiLimesurveyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLimesurvey: IconType = React.forwardRef<SVGSVGElement, SiLimesurveyProps>(function SiLimesurvey({title = 'LimeSurvey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
