    ...
    type SiWatchtowerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#416271';

    const SiWatchtower: IconType = React.forwardRef<SVGSVGElement, SiWatchtowerProps>(function SiWatchtower({title = 'Watchtower', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWatchtower as default, defaultColor };
