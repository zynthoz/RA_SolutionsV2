    ...
    type SiJekyllProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJekyll: IconType = React.forwardRef<SVGSVGElement, SiJekyllProps>(function SiJekyll({title = 'Jekyll', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJekyll as default, defaultColor };
