    ...
    type SiWappalyzerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWappalyzer: IconType = React.forwardRef<SVGSVGElement, SiWappalyzerProps>(function SiWappalyzer({title = 'Wappalyzer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
