    ...
    type SiCivicrmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCivicrm: IconType = React.forwardRef<SVGSVGElement, SiCivicrmProps>(function SiCivicrm({title = 'CiviCRM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
