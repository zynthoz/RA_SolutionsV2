    ...
    type SiJitsiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#97979A';

    const SiJitsi: IconType = React.forwardRef<SVGSVGElement, SiJitsiProps>(function SiJitsi({title = 'Jitsi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
