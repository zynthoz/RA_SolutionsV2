    ...
    type SiWeasylProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWeasyl: IconType = React.forwardRef<SVGSVGElement, SiWeasylProps>(function SiWeasyl({title = 'Weasyl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
