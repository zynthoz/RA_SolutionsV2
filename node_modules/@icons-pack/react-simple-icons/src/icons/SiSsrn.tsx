    ...
    type SiSsrnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#154881';

    const SiSsrn: IconType = React.forwardRef<SVGSVGElement, SiSsrnProps>(function SiSsrn({title = 'SSRN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSsrn as default, defaultColor };
