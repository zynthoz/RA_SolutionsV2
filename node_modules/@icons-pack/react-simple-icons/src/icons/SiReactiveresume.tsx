    ...
    type SiReactiveresumeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReactiveresume: IconType = React.forwardRef<SVGSVGElement, SiReactiveresumeProps>(function SiReactiveresume({title = 'Reactive Resume', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
