    ...
    type SiKingstontechnologyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKingstontechnology: IconType = React.forwardRef<SVGSVGElement, SiKingstontechnologyProps>(function SiKingstontechnology({title = 'Kingston Technology', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
