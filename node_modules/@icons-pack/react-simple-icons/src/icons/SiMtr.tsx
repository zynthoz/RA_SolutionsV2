    ...
    type SiMtrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#AC2E45';

    const SiMtr: IconType = React.forwardRef<SVGSVGElement, SiMtrProps>(function SiMtr({title = 'MTR', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMtr as default, defaultColor };
