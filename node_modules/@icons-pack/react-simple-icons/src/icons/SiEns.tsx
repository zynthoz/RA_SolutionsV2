    ...
    type SiEnsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEns: IconType = React.forwardRef<SVGSVGElement, SiEnsProps>(function SiEns({title = 'ENS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
