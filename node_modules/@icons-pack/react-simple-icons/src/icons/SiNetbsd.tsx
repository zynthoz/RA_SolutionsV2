    ...
    type SiNetbsdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNetbsd: IconType = React.forwardRef<SVGSVGElement, SiNetbsdProps>(function SiNetbsd({title = 'NetBSD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
