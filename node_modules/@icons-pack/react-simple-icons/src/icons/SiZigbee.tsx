    ...
    type SiZigbeeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZigbee: IconType = React.forwardRef<SVGSVGElement, SiZigbeeProps>(function SiZigbee({title = 'Zigbee', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
