    ...
    type SiWikidotggProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWikidotgg: IconType = React.forwardRef<SVGSVGElement, SiWikidotggProps>(function SiWikidotgg({title = 'wiki.gg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWikidotgg as default, defaultColor };
