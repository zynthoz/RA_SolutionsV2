    ...
    type SiFdroidProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFdroid: IconType = React.forwardRef<SVGSVGElement, SiFdroidProps>(function SiFdroid({title = 'F-Droid', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFdroid as default, defaultColor };
