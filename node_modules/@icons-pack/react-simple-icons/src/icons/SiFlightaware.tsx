    ...
    type SiFlightawareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#19315B';

    const SiFlightaware: IconType = React.forwardRef<SVGSVGElement, SiFlightawareProps>(function SiFlightaware({title = 'Flightaware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
