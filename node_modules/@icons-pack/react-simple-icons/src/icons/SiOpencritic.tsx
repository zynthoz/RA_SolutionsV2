    ...
    type SiOpencriticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpencritic: IconType = React.forwardRef<SVGSVGElement, SiOpencriticProps>(function SiOpencritic({title = 'OpenCritic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
