    ...
    type SiUpholdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#49CC68';

    const SiUphold: IconType = React.forwardRef<SVGSVGElement, SiUpholdProps>(function SiUphold({title = 'Uphold', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUphold as default, defaultColor };
