    ...
    type SiPaddypowerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPaddypower: IconType = React.forwardRef<SVGSVGElement, SiPaddypowerProps>(function SiPaddypower({title = 'Paddy Power', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPaddypower as default, defaultColor };
