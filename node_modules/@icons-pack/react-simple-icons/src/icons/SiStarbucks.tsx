    ...
    type SiStarbucksProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStarbucks: IconType = React.forwardRef<SVGSVGElement, SiStarbucksProps>(function SiStarbucks({title = 'Starbucks', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStarbucks as default, defaultColor };
