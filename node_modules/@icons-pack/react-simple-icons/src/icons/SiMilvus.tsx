    ...
    type SiMilvusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A1EA';

    const SiMilvus: IconType = React.forwardRef<SVGSVGElement, SiMilvusProps>(function SiMilvus({title = 'Milvus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMilvus as default, defaultColor };
