    ...
    type SiVirginmediaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED1A37';

    const SiVirginmedia: IconType = React.forwardRef<SVGSVGElement, SiVirginmediaProps>(function SiVirginmedia({title = 'Virgin Media', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVirginmedia as default, defaultColor };
