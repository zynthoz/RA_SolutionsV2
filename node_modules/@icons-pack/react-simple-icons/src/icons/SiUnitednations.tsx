    ...
    type SiUnitednationsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009EDB';

    const SiUnitednations: IconType = React.forwardRef<SVGSVGElement, SiUnitednationsProps>(function SiUnitednations({title = 'United Nations', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
