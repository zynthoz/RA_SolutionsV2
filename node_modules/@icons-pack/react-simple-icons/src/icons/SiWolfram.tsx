    ...
    type SiWolframProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#DD1100';

    const SiWolfram: IconType = React.forwardRef<SVGSVGElement, SiWolframProps>(function SiWolfram({title = 'Wolfram', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWolfram as default, defaultColor };
