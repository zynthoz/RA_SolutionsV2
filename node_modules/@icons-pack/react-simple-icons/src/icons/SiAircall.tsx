    ...
    type SiAircallProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAircall: IconType = React.forwardRef<SVGSVGElement, SiAircallProps>(function SiAircall({title = 'Aircall', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
