    ...
    type SiPycqaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#201B44';

    const SiPycqa: IconType = React.forwardRef<SVGSVGElement, SiPycqaProps>(function SiPycqa({title = 'PyCQA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPycqa as default, defaultColor };
