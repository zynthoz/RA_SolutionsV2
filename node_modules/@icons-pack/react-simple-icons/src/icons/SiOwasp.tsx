    ...
    type SiOwaspProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOwasp: IconType = React.forwardRef<SVGSVGElement, SiOwaspProps>(function SiOwasp({title = 'OWASP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOwasp as default, defaultColor };
