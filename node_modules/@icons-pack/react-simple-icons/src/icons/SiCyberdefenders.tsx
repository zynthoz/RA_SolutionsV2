    ...
    type SiCyberdefendersProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCyberdefenders: IconType = React.forwardRef<SVGSVGElement, SiCyberdefendersProps>(function SiCyberdefenders({title = 'CyberDefenders', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCyberdefenders as default, defaultColor };
