    ...
    type SiProtocolsdotioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProtocolsdotio: IconType = React.forwardRef<SVGSVGElement, SiProtocolsdotioProps>(function SiProtocolsdotio({title = 'protocols.io', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiProtocolsdotio as default, defaultColor };
