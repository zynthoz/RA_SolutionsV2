    ...
    type SiSubaruProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSubaru: IconType = React.forwardRef<SVGSVGElement, SiSubaruProps>(function SiSubaru({title = 'Subaru', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
