    ...
    type SiHoppscotchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHoppscotch: IconType = React.forwardRef<SVGSVGElement, SiHoppscotchProps>(function SiHoppscotch({title = 'Hoppscotch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
