    ...
    type SiBoostProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBoost: IconType = React.forwardRef<SVGSVGElement, SiBoostProps>(function SiBoost({title = 'Boost', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBoost as default, defaultColor };
