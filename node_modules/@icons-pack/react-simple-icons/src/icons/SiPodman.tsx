    ...
    type SiPodmanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#892CA0';

    const SiPodman: IconType = React.forwardRef<SVGSVGElement, SiPodmanProps>(function SiPodman({title = 'Podman', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
