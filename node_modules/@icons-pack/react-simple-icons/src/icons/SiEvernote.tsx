    ...
    type SiEvernoteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEvernote: IconType = React.forwardRef<SVGSVGElement, SiEvernoteProps>(function SiEvernote({title = 'Evernote', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEvernote as default, defaultColor };
