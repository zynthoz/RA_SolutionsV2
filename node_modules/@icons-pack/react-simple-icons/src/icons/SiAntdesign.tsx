    ...
    type SiAntdesignProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0170FE';

    const SiAntdesign: IconType = React.forwardRef<SVGSVGElement, SiAntdesignProps>(function SiAntdesign({title = 'Ant Design', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAntdesign as default, defaultColor };
