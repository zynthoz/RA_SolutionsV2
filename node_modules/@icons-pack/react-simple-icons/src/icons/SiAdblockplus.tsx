    ...
    type SiAdblockplusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdblockplus: IconType = React.forwardRef<SVGSVGElement, SiAdblockplusProps>(function SiAdblockplus({title = 'Adblock Plus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
