    ...
    type SiSteelseriesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF5200';

    const SiSteelseries: IconType = React.forwardRef<SVGSVGElement, SiSteelseriesProps>(function SiSteelseries({title = 'Steelseries', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
