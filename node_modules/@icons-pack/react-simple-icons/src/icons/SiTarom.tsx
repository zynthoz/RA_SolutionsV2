    ...
    type SiTaromProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTarom: IconType = React.forwardRef<SVGSVGElement, SiTaromProps>(function SiTarom({title = 'TAROM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTarom as default, defaultColor };
