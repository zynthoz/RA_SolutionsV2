    ...
    type SiTrimbleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0063A3';

    const SiTrimble: IconType = React.forwardRef<SVGSVGElement, SiTrimbleProps>(function SiTrimble({title = 'Trimble', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTrimble as default, defaultColor };
