    ...
    type SiBastyonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A4FF';

    const SiBastyon: IconType = React.forwardRef<SVGSVGElement, SiBastyonProps>(function SiBastyon({title = 'Bastyon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBastyon as default, defaultColor };
