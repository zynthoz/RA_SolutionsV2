    ...
    type SiTrainerroadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTrainerroad: IconType = React.forwardRef<SVGSVGElement, SiTrainerroadProps>(function SiTrainerroad({title = 'TrainerRoad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
