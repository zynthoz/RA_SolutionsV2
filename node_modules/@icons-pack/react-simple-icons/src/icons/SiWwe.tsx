    ...
    type SiWweProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWwe: IconType = React.forwardRef<SVGSVGElement, SiWweProps>(function SiWwe({title = 'WWE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWwe as default, defaultColor };
