    ...
    type SiCnetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCnet: IconType = React.forwardRef<SVGSVGElement, SiCnetProps>(function SiCnet({title = 'CNET', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
