    ...
    type SiPlatformioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F5822A';

    const SiPlatformio: IconType = React.forwardRef<SVGSVGElement, SiPlatformioProps>(function SiPlatformio({title = 'PlatformIO', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlatformio as default, defaultColor };
