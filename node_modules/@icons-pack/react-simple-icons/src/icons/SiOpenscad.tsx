    ...
    type SiOpenscadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F9D72C';

    const SiOpenscad: IconType = React.forwardRef<SVGSVGElement, SiOpenscadProps>(function SiOpenscad({title = 'OpenSCAD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpenscad as default, defaultColor };
