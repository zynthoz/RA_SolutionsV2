    ...
    type SiGlitchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGlitch: IconType = React.forwardRef<SVGSVGElement, SiGlitchProps>(function SiGlitch({title = 'Glitch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
