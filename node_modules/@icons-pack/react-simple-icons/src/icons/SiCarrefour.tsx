    ...
    type SiCarrefourProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCarrefour: IconType = React.forwardRef<SVGSVGElement, SiCarrefourProps>(function SiCarrefour({title = 'Carrefour', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCarrefour as default, defaultColor };
