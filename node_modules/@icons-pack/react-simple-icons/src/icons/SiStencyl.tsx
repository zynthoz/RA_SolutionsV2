    ...
    type SiStencylProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStencyl: IconType = React.forwardRef<SVGSVGElement, SiStencylProps>(function SiStencyl({title = 'Stencyl', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
