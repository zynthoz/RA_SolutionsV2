    ...
    type SiWebpackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebpack: IconType = React.forwardRef<SVGSVGElement, SiWebpackProps>(function SiWebpack({title = 'Webpack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebpack as default, defaultColor };
