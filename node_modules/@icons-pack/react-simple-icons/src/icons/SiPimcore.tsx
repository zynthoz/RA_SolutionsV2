    ...
    type SiPimcoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPimcore: IconType = React.forwardRef<SVGSVGElement, SiPimcoreProps>(function SiPimcore({title = 'Pimcore', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
