    ...
    type SiOpennebulaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0097C2';

    const SiOpennebula: IconType = React.forwardRef<SVGSVGElement, SiOpennebulaProps>(function SiOpennebula({title = 'OpenNebula', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpennebula as default, defaultColor };
