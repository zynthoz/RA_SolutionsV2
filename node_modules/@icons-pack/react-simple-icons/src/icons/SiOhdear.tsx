    ...
    type SiOhdearProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOhdear: IconType = React.forwardRef<SVGSVGElement, SiOhdearProps>(function SiOhdear({title = 'Oh Dear', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
