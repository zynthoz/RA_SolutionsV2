    ...
    type SiCodechefProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5B4638';

    const SiCodechef: IconType = React.forwardRef<SVGSVGElement, SiCodechefProps>(function SiCodechef({title = 'CodeChef', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodechef as default, defaultColor };
