    ...
    type SiBrevoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBrevo: IconType = React.forwardRef<SVGSVGElement, SiBrevoProps>(function SiBrevo({title = 'Brevo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBrevo as default, defaultColor };
