    ...
    type SiQiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQi: IconType = React.forwardRef<SVGSVGElement, SiQiProps>(function SiQi({title = 'Qi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
