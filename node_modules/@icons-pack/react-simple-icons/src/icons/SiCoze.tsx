    ...
    type SiCozeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoze: IconType = React.forwardRef<SVGSVGElement, SiCozeProps>(function SiCoze({title = 'Coze', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoze as default, defaultColor };
