    ...
    type SiAudiobookshelfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAudiobookshelf: IconType = React.forwardRef<SVGSVGElement, SiAudiobookshelfProps>(function SiAudiobookshelf({title = 'Audiobookshelf', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
