    ...
    type SiAbusedotchProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAbusedotch: IconType = React.forwardRef<SVGSVGElement, SiAbusedotchProps>(function SiAbusedotch({title = 'abuse.ch', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAbusedotch as default, defaultColor };
