    ...
    type SiRichProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRich: IconType = React.forwardRef<SVGSVGElement, SiRichProps>(function SiRich({title = 'Rich', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
