    ...
    type SiMoodleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMoodle: IconType = React.forwardRef<SVGSVGElement, SiMoodleProps>(function SiMoodle({title = 'Moodle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
