    ...
    type SiDrupalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDrupal: IconType = React.forwardRef<SVGSVGElement, SiDrupalProps>(function SiDrupal({title = 'Drupal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
