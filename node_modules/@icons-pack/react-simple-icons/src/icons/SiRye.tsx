    ...
    type SiRyeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRye: IconType = React.forwardRef<SVGSVGElement, SiRyeProps>(function SiRye({title = 'Rye', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
