    ...
    type SiEdekaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEdeka: IconType = React.forwardRef<SVGSVGElement, SiEdekaProps>(function SiEdeka({title = 'EDEKA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
