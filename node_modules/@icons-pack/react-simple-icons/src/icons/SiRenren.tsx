    ...
    type SiRenrenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#217DC6';

    const SiRenren: IconType = React.forwardRef<SVGSVGElement, SiRenrenProps>(function SiRenren({title = 'Renren', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRenren as default, defaultColor };
