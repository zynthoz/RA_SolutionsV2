    ...
    type SiMacosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMacos: IconType = React.forwardRef<SVGSVGElement, SiMacosProps>(function SiMacos({title = 'macOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
