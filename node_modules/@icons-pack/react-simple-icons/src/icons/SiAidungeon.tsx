    ...
    type SiAidungeonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAidungeon: IconType = React.forwardRef<SVGSVGElement, SiAidungeonProps>(function SiAidungeon({title = 'AI Dungeon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
