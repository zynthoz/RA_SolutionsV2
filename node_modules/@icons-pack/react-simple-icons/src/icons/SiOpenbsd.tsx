    ...
    type SiOpenbsdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenbsd: IconType = React.forwardRef<SVGSVGElement, SiOpenbsdProps>(function SiOpenbsd({title = 'OpenBSD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
