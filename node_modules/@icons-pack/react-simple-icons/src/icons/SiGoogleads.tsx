    ...
    type SiGoogleadsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleads: IconType = React.forwardRef<SVGSVGElement, SiGoogleadsProps>(function SiGoogleads({title = 'Google Ads', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogleads as default, defaultColor };
