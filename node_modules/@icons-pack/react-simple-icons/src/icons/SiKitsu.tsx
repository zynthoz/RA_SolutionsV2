    ...
    type SiKitsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKitsu: IconType = React.forwardRef<SVGSVGElement, SiKitsuProps>(function SiKitsu({title = 'Kitsu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
