    ...
    type SiStmicroelectronicsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#03234B';

    const SiStmicroelectronics: IconType = React.forwardRef<SVGSVGElement, SiStmicroelectronicsProps>(function SiStmicroelectronics({title = 'STMicroelectronics', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStmicroelectronics as default, defaultColor };
