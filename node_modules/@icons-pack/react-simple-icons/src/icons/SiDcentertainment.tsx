    ...
    type SiDcentertainmentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0078F0';

    const SiDcentertainment: IconType = React.forwardRef<SVGSVGElement, SiDcentertainmentProps>(function SiDcentertainment({title = 'DC Entertainment', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDcentertainment as default, defaultColor };
