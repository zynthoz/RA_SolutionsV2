    ...
    type SiIcicibankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIcicibank: IconType = React.forwardRef<SVGSVGElement, SiIcicibankProps>(function SiIcicibank({title = 'ICICI Bank', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
