    ...
    type SiSemrushProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSemrush: IconType = React.forwardRef<SVGSVGElement, SiSemrushProps>(function SiSemrush({title = 'Semrush', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
