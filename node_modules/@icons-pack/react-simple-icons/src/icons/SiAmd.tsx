    ...
    type SiAmdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAmd: IconType = React.forwardRef<SVGSVGElement, SiAmdProps>(function SiAmd({title = 'AMD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAmd as default, defaultColor };
