    ...
    type SiCommerzbankProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCommerzbank: IconType = React.forwardRef<SVGSVGElement, SiCommerzbankProps>(function SiCommerzbank({title = 'Commerzbank', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
