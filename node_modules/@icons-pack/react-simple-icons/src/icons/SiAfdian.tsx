    ...
    type SiAfdianProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAfdian: IconType = React.forwardRef<SVGSVGElement, SiAfdianProps>(function SiAfdian({title = 'AFDIAN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
