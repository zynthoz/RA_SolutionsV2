    ...
    type SiSanfranciscomunicipalrailwayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BA0C2F';

    const SiSanfranciscomunicipalrailway: IconType = React.forwardRef<SVGSVGElement, SiSanfranciscomunicipalrailwayProps>(function SiSanfranciscomunicipalrailway({title = 'San Francisco Municipal Railway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSanfranciscomunicipalrailway as default, defaultColor };
