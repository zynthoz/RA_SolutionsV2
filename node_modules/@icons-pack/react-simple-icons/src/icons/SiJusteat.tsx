    ...
    type SiJusteatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJusteat: IconType = React.forwardRef<SVGSVGElement, SiJusteatProps>(function SiJusteat({title = 'Just Eat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
