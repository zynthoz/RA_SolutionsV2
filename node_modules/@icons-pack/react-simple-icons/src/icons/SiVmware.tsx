    ...
    type SiVmwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVmware: IconType = React.forwardRef<SVGSVGElement, SiVmwareProps>(function SiVmware({title = 'VMware', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVmware as default, defaultColor };
