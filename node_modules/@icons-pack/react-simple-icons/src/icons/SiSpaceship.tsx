    ...
    type SiSpaceshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSpaceship: IconType = React.forwardRef<SVGSVGElement, SiSpaceshipProps>(function SiSpaceship({title = 'Spaceship', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSpaceship as default, defaultColor };
