    ...
    type SiQuantcastProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQuantcast: IconType = React.forwardRef<SVGSVGElement, SiQuantcastProps>(function SiQuantcast({title = 'Quantcast', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQuantcast as default, defaultColor };
