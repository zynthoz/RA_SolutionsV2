    ...
    type SiInfosysProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInfosys: IconType = React.forwardRef<SVGSVGElement, SiInfosysProps>(function SiInfosys({title = 'Infosys', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
