    ...
    type SiApacheProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D22128';

    const SiApache: IconType = React.forwardRef<SVGSVGElement, SiApacheProps>(function SiApache({title = 'Apache', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApache as default, defaultColor };
