    ...
    type SiAutocannonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutocannon: IconType = React.forwardRef<SVGSVGElement, SiAutocannonProps>(function SiAutocannon({title = 'AutoCannon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
