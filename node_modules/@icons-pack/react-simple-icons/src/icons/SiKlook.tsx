    ...
    type SiKlookProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKlook: IconType = React.forwardRef<SVGSVGElement, SiKlookProps>(function SiKlook({title = 'Klook', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
