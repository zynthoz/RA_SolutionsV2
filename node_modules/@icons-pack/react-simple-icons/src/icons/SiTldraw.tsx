    ...
    type SiTldrawProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTldraw: IconType = React.forwardRef<SVGSVGElement, SiTldrawProps>(function SiTldraw({title = 'tldraw', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
