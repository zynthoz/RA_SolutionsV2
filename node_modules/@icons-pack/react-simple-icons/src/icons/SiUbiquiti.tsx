    ...
    type SiUbiquitiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0559C9';

    const SiUbiquiti: IconType = React.forwardRef<SVGSVGElement, SiUbiquitiProps>(function SiUbiquiti({title = 'Ubiquiti', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUbiquiti as default, defaultColor };
