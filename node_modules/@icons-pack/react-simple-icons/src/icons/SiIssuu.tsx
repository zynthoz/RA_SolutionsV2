    ...
    type SiIssuuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIssuu: IconType = React.forwardRef<SVGSVGElement, SiIssuuProps>(function SiIssuu({title = 'Issuu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
