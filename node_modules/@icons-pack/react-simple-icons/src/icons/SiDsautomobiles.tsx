    ...
    type SiDsautomobilesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDsautomobiles: IconType = React.forwardRef<SVGSVGElement, SiDsautomobilesProps>(function SiDsautomobiles({title = 'DS Automobiles', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDsautomobiles as default, defaultColor };
