    ...
    type SiChangedetectionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChangedetection: IconType = React.forwardRef<SVGSVGElement, SiChangedetectionProps>(function SiChangedetection({title = 'Change Detection', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
