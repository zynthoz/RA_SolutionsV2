    ...
    type SiOpenjsfoundationProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenjsfoundation: IconType = React.forwardRef<SVGSVGElement, SiOpenjsfoundationProps>(function SiOpenjsfoundation({title = 'OpenJS Foundation', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
