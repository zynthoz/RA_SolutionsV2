    ...
    type SiFrontifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFrontify: IconType = React.forwardRef<SVGSVGElement, SiFrontifyProps>(function SiFrontify({title = 'Frontify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
