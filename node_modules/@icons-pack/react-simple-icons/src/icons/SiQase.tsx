    ...
    type SiQaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQase: IconType = React.forwardRef<SVGSVGElement, SiQaseProps>(function SiQase({title = 'Qase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
