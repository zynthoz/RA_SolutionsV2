    ...
    type SiLinuxserverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLinuxserver: IconType = React.forwardRef<SVGSVGElement, SiLinuxserverProps>(function SiLinuxserver({title = 'LinuxServer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
