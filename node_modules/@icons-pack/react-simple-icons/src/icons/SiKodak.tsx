    ...
    type SiKodakProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED0000';

    const SiKodak: IconType = React.forwardRef<SVGSVGElement, SiKodakProps>(function SiKodak({title = 'Kodak', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKodak as default, defaultColor };
