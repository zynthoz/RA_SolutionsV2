    ...
    type SiBisecthostingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBisecthosting: IconType = React.forwardRef<SVGSVGElement, SiBisecthostingProps>(function SiBisecthosting({title = 'BisectHosting', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBisecthosting as default, defaultColor };
