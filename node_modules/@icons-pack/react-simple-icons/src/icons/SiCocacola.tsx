    ...
    type SiCocacolaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCocacola: IconType = React.forwardRef<SVGSVGElement, SiCocacolaProps>(function SiCocacola({title = 'Coca-Cola', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
