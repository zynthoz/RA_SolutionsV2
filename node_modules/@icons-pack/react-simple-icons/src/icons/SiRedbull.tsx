    ...
    type SiRedbullProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRedbull: IconType = React.forwardRef<SVGSVGElement, SiRedbullProps>(function SiRedbull({title = 'Red Bull', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
