    ...
    type SiMediatekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMediatek: IconType = React.forwardRef<SVGSVGElement, SiMediatekProps>(function SiMediatek({title = 'MediaTek', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
