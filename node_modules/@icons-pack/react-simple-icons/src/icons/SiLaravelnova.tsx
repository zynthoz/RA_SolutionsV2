    ...
    type SiLaravelnovaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#252D37';

    const SiLaravelnova: IconType = React.forwardRef<SVGSVGElement, SiLaravelnovaProps>(function SiLaravelnova({title = 'Laravel Nova', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLaravelnova as default, defaultColor };
