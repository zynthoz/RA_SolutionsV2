    ...
    type SiRoll20Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRoll20: IconType = React.forwardRef<SVGSVGElement, SiRoll20Props>(function SiRoll20({title = 'Roll20', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRoll20 as default, defaultColor };
