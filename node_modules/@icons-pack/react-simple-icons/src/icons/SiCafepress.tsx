    ...
    type SiCafepressProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCafepress: IconType = React.forwardRef<SVGSVGElement, SiCafepressProps>(function SiCafepress({title = 'CafePress', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCafepress as default, defaultColor };
