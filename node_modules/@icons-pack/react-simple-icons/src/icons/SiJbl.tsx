    ...
    type SiJblProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF3300';

    const SiJbl: IconType = React.forwardRef<SVGSVGElement, SiJblProps>(function SiJbl({title = 'JBL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJbl as default, defaultColor };
