    ...
    type SiSwcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F8C457';

    const SiSwc: IconType = React.forwardRef<SVGSVGElement, SiSwcProps>(function SiSwc({title = 'SWC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSwc as default, defaultColor };
