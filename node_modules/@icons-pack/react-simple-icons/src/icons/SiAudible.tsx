    ...
    type SiAudibleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAudible: IconType = React.forwardRef<SVGSVGElement, SiAudibleProps>(function SiAudible({title = 'Audible', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
