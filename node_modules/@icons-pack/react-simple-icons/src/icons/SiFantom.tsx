    ...
    type SiFantomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFantom: IconType = React.forwardRef<SVGSVGElement, SiFantomProps>(function SiFantom({title = 'Fantom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFantom as default, defaultColor };
