    ...
    type SiOsuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF66AA';

    const SiOsu: IconType = React.forwardRef<SVGSVGElement, SiOsuProps>(function SiOsu({title = 'osu!', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOsu as default, defaultColor };
