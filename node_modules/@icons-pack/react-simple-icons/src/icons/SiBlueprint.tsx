    ...
    type SiBlueprintProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlueprint: IconType = React.forwardRef<SVGSVGElement, SiBlueprintProps>(function SiBlueprint({title = 'Blueprint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
