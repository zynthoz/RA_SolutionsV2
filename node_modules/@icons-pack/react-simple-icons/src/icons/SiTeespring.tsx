    ...
    type SiTeespringProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTeespring: IconType = React.forwardRef<SVGSVGElement, SiTeespringProps>(function SiTeespring({title = 'Teespring', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
