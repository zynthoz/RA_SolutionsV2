    ...
    type SiRezgoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRezgo: IconType = React.forwardRef<SVGSVGElement, SiRezgoProps>(function SiRezgo({title = 'Rezgo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRezgo as default, defaultColor };
