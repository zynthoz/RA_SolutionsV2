    ...
    type SiCrayonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCrayon: IconType = React.forwardRef<SVGSVGElement, SiCrayonProps>(function SiCrayon({title = 'Crayon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCrayon as default, defaultColor };
