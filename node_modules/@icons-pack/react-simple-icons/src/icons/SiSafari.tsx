    ...
    type SiSafariProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSafari: IconType = React.forwardRef<SVGSVGElement, SiSafariProps>(function SiSafari({title = 'Safari', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
