    ...
    type SiPubgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F4B942';

    const SiPubg: IconType = React.forwardRef<SVGSVGElement, SiPubgProps>(function SiPubg({title = 'PUBG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPubg as default, defaultColor };
