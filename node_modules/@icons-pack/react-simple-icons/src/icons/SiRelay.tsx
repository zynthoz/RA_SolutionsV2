    ...
    type SiRelayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F26B00';

    const SiRelay: IconType = React.forwardRef<SVGSVGElement, SiRelayProps>(function SiRelay({title = 'Relay', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
