    ...
    type SiMetasploitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2596CD';

    const SiMetasploit: IconType = React.forwardRef<SVGSVGElement, SiMetasploitProps>(function SiMetasploit({title = 'Metasploit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMetasploit as default, defaultColor };
