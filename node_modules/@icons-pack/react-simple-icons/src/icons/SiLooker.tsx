    ...
    type SiLookerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLooker: IconType = React.forwardRef<SVGSVGElement, SiLookerProps>(function SiLooker({title = 'Looker', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
