    ...
    type SiRocketdotchatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRocketdotchat: IconType = React.forwardRef<SVGSVGElement, SiRocketdotchatProps>(function SiRocketdotchat({title = 'Rocket.Chat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
