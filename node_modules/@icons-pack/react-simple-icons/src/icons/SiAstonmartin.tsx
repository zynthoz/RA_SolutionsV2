    ...
    type SiAstonmartinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00665E';

    const SiAstonmartin: IconType = React.forwardRef<SVGSVGElement, SiAstonmartinProps>(function SiAstonmartin({title = 'Aston Martin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAstonmartin as default, defaultColor };
