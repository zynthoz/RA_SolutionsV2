    ...
    type SiFoliumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#77B829';

    const SiFolium: IconType = React.forwardRef<SVGSVGElement, SiFoliumProps>(function SiFolium({title = 'Folium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
