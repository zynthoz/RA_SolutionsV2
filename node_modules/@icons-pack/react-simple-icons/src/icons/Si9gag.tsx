    ...
    type Si9gagProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const Si9gag: IconType = React.forwardRef<SVGSVGElement, Si9gagProps>(function Si9gag({title = '9GAG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
