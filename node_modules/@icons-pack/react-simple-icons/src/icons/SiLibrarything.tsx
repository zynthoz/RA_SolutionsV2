    ...
    type SiLibrarythingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#251A15';

    const SiLibrarything: IconType = React.forwardRef<SVGSVGElement, SiLibrarythingProps>(function SiLibrarything({title = 'LibraryThing', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLibrarything as default, defaultColor };
