    ...
    type SiSessionizeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSessionize: IconType = React.forwardRef<SVGSVGElement, SiSessionizeProps>(function SiSessionize({title = 'Sessionize', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
