    ...
    type SiOwncloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#041E42';

    const SiOwncloud: IconType = React.forwardRef<SVGSVGElement, SiOwncloudProps>(function SiOwncloud({title = 'ownCloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
