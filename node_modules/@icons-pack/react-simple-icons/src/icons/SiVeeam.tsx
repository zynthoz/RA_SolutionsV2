    ...
    type SiVeeamProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00B336';

    const SiVeeam: IconType = React.forwardRef<SVGSVGElement, SiVeeamProps>(function SiVeeam({title = 'Veeam', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiVeeam as default, defaultColor };
