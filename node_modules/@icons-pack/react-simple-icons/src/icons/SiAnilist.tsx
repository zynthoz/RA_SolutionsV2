    ...
    type SiAnilistProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAnilist: IconType = React.forwardRef<SVGSVGElement, SiAnilistProps>(function SiAnilist({title = 'AniList', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
