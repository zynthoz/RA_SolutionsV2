    ...
    type SiWeztermProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4E49EE';

    const SiWezterm: IconType = React.forwardRef<SVGSVGElement, SiWeztermProps>(function SiWezterm({title = 'WezTerm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWezterm as default, defaultColor };
