    ...
    type SiMaptilerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMaptiler: IconType = React.forwardRef<SVGSVGElement, SiMaptilerProps>(function SiMaptiler({title = 'MapTiler', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
