    ...
    type SiAudiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BB0A30';

    const SiAudi: IconType = React.forwardRef<SVGSVGElement, SiAudiProps>(function SiAudi({title = 'Audi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAudi as default, defaultColor };
