    ...
    type SiOpenbadgesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenbadges: IconType = React.forwardRef<SVGSVGElement, SiOpenbadgesProps>(function SiOpenbadges({title = 'Open Badges', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOpenbadges as default, defaultColor };
