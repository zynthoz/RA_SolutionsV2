    ...
    type SiSncfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CA0939';

    const SiSncf: IconType = React.forwardRef<SVGSVGElement, SiSncfProps>(function SiSncf({title = 'SNCF', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSncf as default, defaultColor };
