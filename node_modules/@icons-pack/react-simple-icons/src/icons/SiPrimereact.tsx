    ...
    type SiPrimereactProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrimereact: IconType = React.forwardRef<SVGSVGElement, SiPrimereactProps>(function SiPrimereact({title = 'PrimeReact', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
