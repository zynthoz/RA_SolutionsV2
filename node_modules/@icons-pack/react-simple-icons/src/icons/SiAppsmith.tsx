    ...
    type SiAppsmithProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAppsmith: IconType = React.forwardRef<SVGSVGElement, SiAppsmithProps>(function SiAppsmith({title = 'Appsmith', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAppsmith as default, defaultColor };
