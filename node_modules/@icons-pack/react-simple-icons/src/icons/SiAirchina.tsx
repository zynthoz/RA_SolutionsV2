    ...
    type SiAirchinaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirchina: IconType = React.forwardRef<SVGSVGElement, SiAirchinaProps>(function SiAirchina({title = 'Air China', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirchina as default, defaultColor };
