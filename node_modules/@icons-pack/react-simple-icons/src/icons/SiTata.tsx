    ...
    type SiTataProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTata: IconType = React.forwardRef<SVGSVGElement, SiTataProps>(function SiTata({title = 'Tata', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
