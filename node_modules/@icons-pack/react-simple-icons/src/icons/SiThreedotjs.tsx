    ...
    type SiThreedotjsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThreedotjs: IconType = React.forwardRef<SVGSVGElement, SiThreedotjsProps>(function SiThreedotjs({title = 'Three.js', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
