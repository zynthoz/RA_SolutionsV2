    ...
    type SiApachestormProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachestorm: IconType = React.forwardRef<SVGSVGElement, SiApachestormProps>(function SiApachestorm({title = 'Apache Storm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
