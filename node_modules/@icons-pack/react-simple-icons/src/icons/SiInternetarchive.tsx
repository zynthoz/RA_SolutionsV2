    ...
    type SiInternetarchiveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInternetarchive: IconType = React.forwardRef<SVGSVGElement, SiInternetarchiveProps>(function SiInternetarchive({title = 'Internet Archive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
