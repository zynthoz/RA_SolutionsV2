    ...
    type SiTransmissionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D70008';

    const SiTransmission: IconType = React.forwardRef<SVGSVGElement, SiTransmissionProps>(function SiTransmission({title = 'Transmission', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
