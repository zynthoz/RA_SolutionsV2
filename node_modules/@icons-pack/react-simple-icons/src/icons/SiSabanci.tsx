    ...
    type SiSabanciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSabanci: IconType = React.forwardRef<SVGSVGElement, SiSabanciProps>(function SiSabanci({title = 'Sabanci', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
