    ...
    type SiGrammarlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#027E6F';

    const SiGrammarly: IconType = React.forwardRef<SVGSVGElement, SiGrammarlyProps>(function SiGrammarly({title = 'Grammarly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGrammarly as default, defaultColor };
