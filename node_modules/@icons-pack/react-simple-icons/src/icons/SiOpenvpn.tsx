    ...
    type SiOpenvpnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenvpn: IconType = React.forwardRef<SVGSVGElement, SiOpenvpnProps>(function SiOpenvpn({title = 'OpenVPN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
