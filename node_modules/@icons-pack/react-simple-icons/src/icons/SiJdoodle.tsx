    ...
    type SiJdoodleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJdoodle: IconType = React.forwardRef<SVGSVGElement, SiJdoodleProps>(function SiJdoodle({title = 'JDoodle', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
