    ...
    type SiAntvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAntv: IconType = React.forwardRef<SVGSVGElement, SiAntvProps>(function SiAntv({title = 'AntV', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAntv as default, defaultColor };
