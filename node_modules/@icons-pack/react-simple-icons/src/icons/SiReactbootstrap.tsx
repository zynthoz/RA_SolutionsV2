    ...
    type SiReactbootstrapProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#41E0FD';

    const SiReactbootstrap: IconType = React.forwardRef<SVGSVGElement, SiReactbootstrapProps>(function SiReactbootstrap({title = 'React Bootstrap', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiReactbootstrap as default, defaultColor };
