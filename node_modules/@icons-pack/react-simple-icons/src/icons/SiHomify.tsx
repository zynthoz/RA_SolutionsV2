    ...
    type SiHomifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7DCDA3';

    const SiHomify: IconType = React.forwardRef<SVGSVGElement, SiHomifyProps>(function SiHomify({title = 'homify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHomify as default, defaultColor };
