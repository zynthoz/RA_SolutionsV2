    ...
    type SiCtsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCts: IconType = React.forwardRef<SVGSVGElement, SiCtsProps>(function SiCts({title = 'CTS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
