    ...
    type SiSmrtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSmrt: IconType = React.forwardRef<SVGSVGElement, SiSmrtProps>(function SiSmrt({title = 'SMRT', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSmrt as default, defaultColor };
