    ...
    type SiBoxysvgProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBoxysvg: IconType = React.forwardRef<SVGSVGElement, SiBoxysvgProps>(function SiBoxysvg({title = 'Boxy SVG', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBoxysvg as default, defaultColor };
