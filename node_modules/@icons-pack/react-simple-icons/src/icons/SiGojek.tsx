    ...
    type SiGojekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGojek: IconType = React.forwardRef<SVGSVGElement, SiGojekProps>(function SiGojek({title = 'Gojek', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
