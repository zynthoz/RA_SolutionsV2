    ...
    type SiLibrewolfProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLibrewolf: IconType = React.forwardRef<SVGSVGElement, SiLibrewolfProps>(function SiLibrewolf({title = 'LibreWolf', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
