    ...
    type SiUmbracoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3544B1';

    const SiUmbraco: IconType = React.forwardRef<SVGSVGElement, SiUmbracoProps>(function SiUmbraco({title = 'Umbraco', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUmbraco as default, defaultColor };
