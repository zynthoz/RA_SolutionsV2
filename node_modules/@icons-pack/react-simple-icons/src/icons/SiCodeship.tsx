    ...
    type SiCodeshipProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodeship: IconType = React.forwardRef<SVGSVGElement, SiCodeshipProps>(function SiCodeship({title = 'Codeship', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
