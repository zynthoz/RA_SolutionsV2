    ...
    type SiNeteasecloudmusicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D43C33';

    const SiNeteasecloudmusic: IconType = React.forwardRef<SVGSVGElement, SiNeteasecloudmusicProps>(function SiNeteasecloudmusic({title = 'NetEase Cloud Music', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNeteasecloudmusic as default, defaultColor };
