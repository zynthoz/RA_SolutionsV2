    ...
    type SiApachesupersetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachesuperset: IconType = React.forwardRef<SVGSVGElement, SiApachesupersetProps>(function SiApachesuperset({title = 'Apache Superset', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachesuperset as default, defaultColor };
