    ...
    type SiApacheparquetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApacheparquet: IconType = React.forwardRef<SVGSVGElement, SiApacheparquetProps>(function SiApacheparquet({title = 'Apache Parquet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApacheparquet as default, defaultColor };
