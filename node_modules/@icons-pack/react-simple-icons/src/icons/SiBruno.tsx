    ...
    type SiBrunoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBruno: IconType = React.forwardRef<SVGSVGElement, SiBrunoProps>(function SiBruno({title = 'Bruno', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBruno as default, defaultColor };
