    ...
    type SiNfcoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNfcore: IconType = React.forwardRef<SVGSVGElement, SiNfcoreProps>(function SiNfcore({title = 'nf-core', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
