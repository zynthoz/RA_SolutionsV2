    ...
    type SiManProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMan: IconType = React.forwardRef<SVGSVGElement, SiManProps>(function SiMan({title = 'MAN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
