    ...
    type SiCaproverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCaprover: IconType = React.forwardRef<SVGSVGElement, SiCaproverProps>(function SiCaprover({title = 'CapRover', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCaprover as default, defaultColor };
