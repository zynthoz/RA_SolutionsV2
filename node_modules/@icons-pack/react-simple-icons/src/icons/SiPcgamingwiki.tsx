    ...
    type SiPcgamingwikiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#556DB3';

    const SiPcgamingwiki: IconType = React.forwardRef<SVGSVGElement, SiPcgamingwikiProps>(function SiPcgamingwiki({title = 'PCGamingWiki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
