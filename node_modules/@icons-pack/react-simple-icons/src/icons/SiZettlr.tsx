    ...
    type SiZettlrProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZettlr: IconType = React.forwardRef<SVGSVGElement, SiZettlrProps>(function SiZettlr({title = 'Zettlr', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZettlr as default, defaultColor };
