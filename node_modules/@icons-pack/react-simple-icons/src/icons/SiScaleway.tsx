    ...
    type SiScalewayProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiScaleway: IconType = React.forwardRef<SVGSVGElement, SiScalewayProps>(function SiScaleway({title = 'Scaleway', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
