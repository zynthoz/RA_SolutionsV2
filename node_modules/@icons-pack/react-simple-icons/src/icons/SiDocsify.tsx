    ...
    type SiDocsifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDocsify: IconType = React.forwardRef<SVGSVGElement, SiDocsifyProps>(function SiDocsify({title = 'Docsify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
