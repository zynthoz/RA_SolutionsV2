    ...
    type SiPronounsdotpageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#C71585';

    const SiPronounsdotpage: IconType = React.forwardRef<SVGSVGElement, SiPronounsdotpageProps>(function SiPronounsdotpage({title = 'Pronouns.page', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPronounsdotpage as default, defaultColor };
