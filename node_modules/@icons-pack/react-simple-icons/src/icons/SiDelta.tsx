    ...
    type SiDeltaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDelta: IconType = React.forwardRef<SVGSVGElement, SiDeltaProps>(function SiDelta({title = 'Delta', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDelta as default, defaultColor };
