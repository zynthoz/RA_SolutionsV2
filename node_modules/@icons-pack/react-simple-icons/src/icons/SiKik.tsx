    ...
    type SiKikProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKik: IconType = React.forwardRef<SVGSVGElement, SiKikProps>(function SiKik({title = 'Kik', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
