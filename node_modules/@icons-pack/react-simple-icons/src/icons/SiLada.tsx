    ...
    type SiLadaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#ED6B21';

    const SiLada: IconType = React.forwardRef<SVGSVGElement, SiLadaProps>(function SiLada({title = 'LADA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLada as default, defaultColor };
