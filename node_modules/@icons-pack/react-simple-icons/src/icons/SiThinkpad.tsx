    ...
    type SiThinkpadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThinkpad: IconType = React.forwardRef<SVGSVGElement, SiThinkpadProps>(function SiThinkpad({title = 'ThinkPad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
