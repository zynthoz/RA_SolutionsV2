    ...
    type SiScipyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#8CAAE6';

    const SiScipy: IconType = React.forwardRef<SVGSVGElement, SiScipyProps>(function SiScipy({title = 'SciPy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScipy as default, defaultColor };
