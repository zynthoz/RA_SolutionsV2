    ...
    type SiAnimalplanetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAnimalplanet: IconType = React.forwardRef<SVGSVGElement, SiAnimalplanetProps>(function SiAnimalplanet({title = 'Animal Planet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
