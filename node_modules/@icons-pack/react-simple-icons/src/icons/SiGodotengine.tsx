    ...
    type SiGodotengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#478CBF';

    const SiGodotengine: IconType = React.forwardRef<SVGSVGElement, SiGodotengineProps>(function SiGodotengine({title = 'Godot Engine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGodotengine as default, defaultColor };
