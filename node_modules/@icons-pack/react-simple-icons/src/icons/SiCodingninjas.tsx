    ...
    type SiCodingninjasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodingninjas: IconType = React.forwardRef<SVGSVGElement, SiCodingninjasProps>(function SiCodingninjas({title = 'Coding Ninjas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodingninjas as default, defaultColor };
