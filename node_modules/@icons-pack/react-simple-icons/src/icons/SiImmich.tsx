    ...
    type SiImmichProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4250AF';

    const SiImmich: IconType = React.forwardRef<SVGSVGElement, SiImmichProps>(function SiImmich({title = 'Immich', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiImmich as default, defaultColor };
