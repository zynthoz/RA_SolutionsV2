    ...
    type SiTinderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTinder: IconType = React.forwardRef<SVGSVGElement, SiTinderProps>(function SiTinder({title = 'Tinder', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
