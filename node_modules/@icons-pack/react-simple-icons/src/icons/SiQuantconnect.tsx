    ...
    type SiQuantconnectProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F98309';

    const SiQuantconnect: IconType = React.forwardRef<SVGSVGElement, SiQuantconnectProps>(function SiQuantconnect({title = 'QuantConnect', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiQuantconnect as default, defaultColor };
