    ...
    type SiJuceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJuce: IconType = React.forwardRef<SVGSVGElement, SiJuceProps>(function SiJuce({title = 'JUCE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
