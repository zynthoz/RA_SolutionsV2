    ...
    type SiFareharborProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0A6ECE';

    const SiFareharbor: IconType = React.forwardRef<SVGSVGElement, SiFareharborProps>(function SiFareharbor({title = 'FareHarbor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
