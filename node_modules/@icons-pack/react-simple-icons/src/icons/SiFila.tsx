    ...
    type SiFilaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFila: IconType = React.forwardRef<SVGSVGElement, SiFilaProps>(function SiFila({title = 'Fila', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
