    ...
    type SiNutanixProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNutanix: IconType = React.forwardRef<SVGSVGElement, SiNutanixProps>(function SiNutanix({title = 'Nutanix', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
