    ...
    type SiGeniusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGenius: IconType = React.forwardRef<SVGSVGElement, SiGeniusProps>(function SiGenius({title = 'Genius', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGenius as default, defaultColor };
