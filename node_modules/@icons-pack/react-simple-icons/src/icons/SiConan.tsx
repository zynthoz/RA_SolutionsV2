    ...
    type SiConanProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiConan: IconType = React.forwardRef<SVGSVGElement, SiConanProps>(function SiConan({title = 'Conan', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
