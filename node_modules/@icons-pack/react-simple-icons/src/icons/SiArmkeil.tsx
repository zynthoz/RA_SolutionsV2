    ...
    type SiArmkeilProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArmkeil: IconType = React.forwardRef<SVGSVGElement, SiArmkeilProps>(function SiArmkeil({title = 'Arm Keil', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArmkeil as default, defaultColor };
