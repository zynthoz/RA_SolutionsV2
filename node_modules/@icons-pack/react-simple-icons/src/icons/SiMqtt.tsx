    ...
    type SiMqttProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMqtt: IconType = React.forwardRef<SVGSVGElement, SiMqttProps>(function SiMqtt({title = 'MQTT', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
