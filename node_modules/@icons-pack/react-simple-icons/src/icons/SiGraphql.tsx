    ...
    type SiGraphqlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGraphql: IconType = React.forwardRef<SVGSVGElement, SiGraphqlProps>(function SiGraphql({title = 'GraphQL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGraphql as default, defaultColor };
