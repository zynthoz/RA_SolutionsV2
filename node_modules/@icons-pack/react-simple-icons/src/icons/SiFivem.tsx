    ...
    type SiFivemProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F40552';

    const SiFivem: IconType = React.forwardRef<SVGSVGElement, SiFivemProps>(function SiFivem({title = 'FiveM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFivem as default, defaultColor };
