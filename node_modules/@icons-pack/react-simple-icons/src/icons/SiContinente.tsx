    ...
    type SiContinenteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiContinente: IconType = React.forwardRef<SVGSVGElement, SiContinenteProps>(function SiContinente({title = 'Continente', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
