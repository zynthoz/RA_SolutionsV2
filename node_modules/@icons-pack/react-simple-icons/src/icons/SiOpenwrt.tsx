    ...
    type SiOpenwrtProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpenwrt: IconType = React.forwardRef<SVGSVGElement, SiOpenwrtProps>(function SiOpenwrt({title = 'OpenWrt', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
