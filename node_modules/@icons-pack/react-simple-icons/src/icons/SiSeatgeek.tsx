    ...
    type SiSeatgeekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF5B49';

    const SiSeatgeek: IconType = React.forwardRef<SVGSVGElement, SiSeatgeekProps>(function SiSeatgeek({title = 'SeatGeek', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSeatgeek as default, defaultColor };
