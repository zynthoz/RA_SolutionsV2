    ...
    type SiCodefactorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodefactor: IconType = React.forwardRef<SVGSVGElement, SiCodefactorProps>(function SiCodefactor({title = 'CodeFactor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
