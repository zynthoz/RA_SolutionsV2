    ...
    type SiHepsiemlakProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHepsiemlak: IconType = React.forwardRef<SVGSVGElement, SiHepsiemlakProps>(function SiHepsiemlak({title = 'Hepsiemlak', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
