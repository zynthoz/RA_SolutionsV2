    ...
    type SiCodemagicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F45E3F';

    const SiCodemagic: IconType = React.forwardRef<SVGSVGElement, SiCodemagicProps>(function SiCodemagic({title = 'Codemagic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodemagic as default, defaultColor };
