    ...
    type SiCryptomatorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCryptomator: IconType = React.forwardRef<SVGSVGElement, SiCryptomatorProps>(function SiCryptomator({title = 'Cryptomator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCryptomator as default, defaultColor };
