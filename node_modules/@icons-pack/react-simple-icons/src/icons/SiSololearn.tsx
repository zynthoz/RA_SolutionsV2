    ...
    type SiSololearnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSololearn: IconType = React.forwardRef<SVGSVGElement, SiSololearnProps>(function SiSololearn({title = 'Sololearn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
