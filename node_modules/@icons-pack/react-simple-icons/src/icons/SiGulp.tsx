    ...
    type SiGulpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CF4647';

    const SiGulp: IconType = React.forwardRef<SVGSVGElement, SiGulpProps>(function SiGulp({title = 'gulp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
