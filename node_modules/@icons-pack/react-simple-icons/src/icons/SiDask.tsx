    ...
    type SiDaskProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDask: IconType = React.forwardRef<SVGSVGElement, SiDaskProps>(function SiDask({title = 'Dask', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDask as default, defaultColor };
