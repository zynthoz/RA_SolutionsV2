    ...
    type SiUnrealengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnrealengine: IconType = React.forwardRef<SVGSVGElement, SiUnrealengineProps>(function SiUnrealengine({title = 'Unreal Engine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
