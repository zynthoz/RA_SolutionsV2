    ...
    type SiBimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBim: IconType = React.forwardRef<SVGSVGElement, SiBimProps>(function SiBim({title = 'BIM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
