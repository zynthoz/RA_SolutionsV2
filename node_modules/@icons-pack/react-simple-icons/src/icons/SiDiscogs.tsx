    ...
    type SiDiscogsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDiscogs: IconType = React.forwardRef<SVGSVGElement, SiDiscogsProps>(function SiDiscogs({title = 'Discogs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDiscogs as default, defaultColor };
