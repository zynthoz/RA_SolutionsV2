    ...
    type SiZaraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZara: IconType = React.forwardRef<SVGSVGElement, SiZaraProps>(function SiZara({title = 'Zara', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZara as default, defaultColor };
