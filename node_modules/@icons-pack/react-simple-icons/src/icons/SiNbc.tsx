    ...
    type SiNbcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNbc: IconType = React.forwardRef<SVGSVGElement, SiNbcProps>(function SiNbc({title = 'NBC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
