    ...
    type SiFccProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFcc: IconType = React.forwardRef<SVGSVGElement, SiFccProps>(function SiFcc({title = 'FCC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
