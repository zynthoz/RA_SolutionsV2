    ...
    type SiRootssageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRootssage: IconType = React.forwardRef<SVGSVGElement, SiRootssageProps>(function SiRootssage({title = 'Roots Sage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRootssage as default, defaultColor };
