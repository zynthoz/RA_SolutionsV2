    ...
    type SiPlayerfmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#C8122A';

    const SiPlayerfm: IconType = React.forwardRef<SVGSVGElement, SiPlayerfmProps>(function SiPlayerfm({title = 'Player FM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPlayerfm as default, defaultColor };
