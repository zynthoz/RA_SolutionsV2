    ...
    type SiHomeassistantcommunitystoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#41BDF5';

    const SiHomeassistantcommunitystore: IconType = React.forwardRef<SVGSVGElement, SiHomeassistantcommunitystoreProps>(function SiHomeassistantcommunitystore({title = 'Home Assistant Community Store', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHomeassistantcommunitystore as default, defaultColor };
