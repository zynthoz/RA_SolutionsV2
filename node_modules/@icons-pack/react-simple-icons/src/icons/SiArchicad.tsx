    ...
    type SiArchicadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiArchicad: IconType = React.forwardRef<SVGSVGElement, SiArchicadProps>(function SiArchicad({title = 'Archicad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
