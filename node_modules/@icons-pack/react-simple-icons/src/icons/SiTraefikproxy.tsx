    ...
    type SiTraefikproxyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTraefikproxy: IconType = React.forwardRef<SVGSVGElement, SiTraefikproxyProps>(function SiTraefikproxy({title = 'Traefik Proxy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
