    ...
    type SiFuboProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFubo: IconType = React.forwardRef<SVGSVGElement, SiFuboProps>(function SiFubo({title = 'Fubo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
