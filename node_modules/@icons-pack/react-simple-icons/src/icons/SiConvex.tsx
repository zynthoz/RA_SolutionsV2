    ...
    type SiConvexProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EE342F';

    const SiConvex: IconType = React.forwardRef<SVGSVGElement, SiConvexProps>(function SiConvex({title = 'Convex', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiConvex as default, defaultColor };
