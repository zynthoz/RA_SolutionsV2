    ...
    type SiFujifilmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFujifilm: IconType = React.forwardRef<SVGSVGElement, SiFujifilmProps>(function SiFujifilm({title = 'Fujifilm', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
