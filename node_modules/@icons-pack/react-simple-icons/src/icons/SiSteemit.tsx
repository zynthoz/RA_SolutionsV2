    ...
    type SiSteemitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSteemit: IconType = React.forwardRef<SVGSVGElement, SiSteemitProps>(function SiSteemit({title = 'Steemit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
