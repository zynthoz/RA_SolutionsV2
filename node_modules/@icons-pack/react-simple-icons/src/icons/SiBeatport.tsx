    ...
    type SiBeatportProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBeatport: IconType = React.forwardRef<SVGSVGElement, SiBeatportProps>(function SiBeatport({title = 'Beatport', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
