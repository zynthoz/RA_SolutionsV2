    ...
    type SiTrueupProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4E71DA';

    const SiTrueup: IconType = React.forwardRef<SVGSVGElement, SiTrueupProps>(function SiTrueup({title = 'TrueUp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTrueup as default, defaultColor };
