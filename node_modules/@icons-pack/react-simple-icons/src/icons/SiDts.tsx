    ...
    type SiDtsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDts: IconType = React.forwardRef<SVGSVGElement, SiDtsProps>(function SiDts({title = 'DTS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
