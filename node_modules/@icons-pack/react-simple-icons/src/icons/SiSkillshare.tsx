    ...
    type SiSkillshareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00FF84';

    const SiSkillshare: IconType = React.forwardRef<SVGSVGElement, SiSkillshareProps>(function SiSkillshare({title = 'Skillshare', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSkillshare as default, defaultColor };
