    ...
    type SiWebdotdeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebdotde: IconType = React.forwardRef<SVGSVGElement, SiWebdotdeProps>(function SiWebdotde({title = 'WEB.DE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
