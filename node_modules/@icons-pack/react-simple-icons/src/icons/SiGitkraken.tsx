    ...
    type SiGitkrakenProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGitkraken: IconType = React.forwardRef<SVGSVGElement, SiGitkrakenProps>(function SiGitkraken({title = 'GitKraken', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGitkraken as default, defaultColor };
