    ...
    type SiBoehringeringelheimProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00E47C';

    const SiBoehringeringelheim: IconType = React.forwardRef<SVGSVGElement, SiBoehringeringelheimProps>(function SiBoehringeringelheim({title = 'Boehringer Ingelheim', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBoehringeringelheim as default, defaultColor };
