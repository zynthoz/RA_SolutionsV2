    ...
    type SiWwiseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWwise: IconType = React.forwardRef<SVGSVGElement, SiWwiseProps>(function SiWwise({title = 'Wwise', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWwise as default, defaultColor };
