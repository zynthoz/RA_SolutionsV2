    ...
    type SiCredlyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCredly: IconType = React.forwardRef<SVGSVGElement, SiCredlyProps>(function SiCredly({title = 'Credly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
