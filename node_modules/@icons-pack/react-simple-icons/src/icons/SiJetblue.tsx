    ...
    type SiJetblueProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJetblue: IconType = React.forwardRef<SVGSVGElement, SiJetblueProps>(function SiJetblue({title = 'JetBlue', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
