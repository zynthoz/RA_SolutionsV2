    ...
    type SiOshkoshProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOshkosh: IconType = React.forwardRef<SVGSVGElement, SiOshkoshProps>(function SiOshkosh({title = 'Oshkosh', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOshkosh as default, defaultColor };
