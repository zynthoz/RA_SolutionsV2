    ...
    type SiStaffbaseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00A4FD';

    const SiStaffbase: IconType = React.forwardRef<SVGSVGElement, SiStaffbaseProps>(function SiStaffbase({title = 'Staffbase', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStaffbase as default, defaultColor };
