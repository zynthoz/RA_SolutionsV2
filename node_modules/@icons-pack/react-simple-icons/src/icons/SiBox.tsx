    ...
    type SiBoxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBox: IconType = React.forwardRef<SVGSVGElement, SiBoxProps>(function SiBox({title = 'Box', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
