    ...
    type SiNetteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3484D2';

    const SiNette: IconType = React.forwardRef<SVGSVGElement, SiNetteProps>(function SiNette({title = 'Nette', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNette as default, defaultColor };
