    ...
    type SiAppletvProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAppletv: IconType = React.forwardRef<SVGSVGElement, SiAppletvProps>(function SiAppletv({title = 'Apple TV', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
