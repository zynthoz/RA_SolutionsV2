    ...
    type SiEuropeanunionProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEuropeanunion: IconType = React.forwardRef<SVGSVGElement, SiEuropeanunionProps>(function SiEuropeanunion({title = 'European Union', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiEuropeanunion as default, defaultColor };
