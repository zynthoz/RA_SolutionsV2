    ...
    type SiListenhubProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiListenhub: IconType = React.forwardRef<SVGSVGElement, SiListenhubProps>(function SiListenhub({title = 'ListenHub', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
