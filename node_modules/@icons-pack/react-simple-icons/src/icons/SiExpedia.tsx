    ...
    type SiExpediaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiExpedia: IconType = React.forwardRef<SVGSVGElement, SiExpediaProps>(function SiExpedia({title = 'Expedia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
