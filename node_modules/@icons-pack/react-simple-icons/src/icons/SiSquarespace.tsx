    ...
    type SiSquarespaceProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSquarespace: IconType = React.forwardRef<SVGSVGElement, SiSquarespaceProps>(function SiSquarespace({title = 'Squarespace', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSquarespace as default, defaultColor };
