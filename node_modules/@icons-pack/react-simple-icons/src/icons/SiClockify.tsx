    ...
    type SiClockifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiClockify: IconType = React.forwardRef<SVGSVGElement, SiClockifyProps>(function SiClockify({title = 'Clockify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
