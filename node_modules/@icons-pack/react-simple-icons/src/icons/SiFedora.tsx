    ...
    type SiFedoraProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFedora: IconType = React.forwardRef<SVGSVGElement, SiFedoraProps>(function SiFedora({title = 'Fedora', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
