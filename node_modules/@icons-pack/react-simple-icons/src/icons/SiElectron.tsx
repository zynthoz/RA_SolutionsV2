    ...
    type SiElectronProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiElectron: IconType = React.forwardRef<SVGSVGElement, SiElectronProps>(function SiElectron({title = 'Electron', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiElectron as default, defaultColor };
