    ...
    type SiAutozoneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutozone: IconType = React.forwardRef<SVGSVGElement, SiAutozoneProps>(function SiAutozone({title = 'AutoZone', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAutozone as default, defaultColor };
