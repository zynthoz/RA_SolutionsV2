    ...
    type SiTinkercadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTinkercad: IconType = React.forwardRef<SVGSVGElement, SiTinkercadProps>(function SiTinkercad({title = 'Tinkercad', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
