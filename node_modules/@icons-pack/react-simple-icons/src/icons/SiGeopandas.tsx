    ...
    type SiGeopandasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#139C5A';

    const SiGeopandas: IconType = React.forwardRef<SVGSVGElement, SiGeopandasProps>(function SiGeopandas({title = 'GeoPandas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
