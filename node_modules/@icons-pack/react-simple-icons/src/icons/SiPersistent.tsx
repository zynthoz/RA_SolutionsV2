    ...
    type SiPersistentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FD5F07';

    const SiPersistent: IconType = React.forwardRef<SVGSVGElement, SiPersistentProps>(function SiPersistent({title = 'Persistent', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPersistent as default, defaultColor };
