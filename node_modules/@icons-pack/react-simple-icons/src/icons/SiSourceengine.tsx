    ...
    type SiSourceengineProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSourceengine: IconType = React.forwardRef<SVGSVGElement, SiSourceengineProps>(function SiSourceengine({title = 'Source Engine', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
