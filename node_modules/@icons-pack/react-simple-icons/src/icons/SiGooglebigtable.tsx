    ...
    type SiGooglebigtableProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGooglebigtable: IconType = React.forwardRef<SVGSVGElement, SiGooglebigtableProps>(function SiGooglebigtable({title = 'Google Bigtable', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
