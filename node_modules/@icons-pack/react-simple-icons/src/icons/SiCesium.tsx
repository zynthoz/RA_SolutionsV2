    ...
    type SiCesiumProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCesium: IconType = React.forwardRef<SVGSVGElement, SiCesiumProps>(function SiCesium({title = 'Cesium', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
