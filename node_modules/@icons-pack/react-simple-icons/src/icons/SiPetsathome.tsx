    ...
    type SiPetsathomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00AA28';

    const SiPetsathome: IconType = React.forwardRef<SVGSVGElement, SiPetsathomeProps>(function SiPetsathome({title = 'Pets at Home', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPetsathome as default, defaultColor };
