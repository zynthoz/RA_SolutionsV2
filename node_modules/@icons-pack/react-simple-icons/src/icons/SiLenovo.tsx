    ...
    type SiLenovoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLenovo: IconType = React.forwardRef<SVGSVGElement, SiLenovoProps>(function SiLenovo({title = 'Lenovo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLenovo as default, defaultColor };
