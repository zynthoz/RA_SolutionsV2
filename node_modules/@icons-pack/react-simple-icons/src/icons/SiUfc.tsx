    ...
    type SiUfcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUfc: IconType = React.forwardRef<SVGSVGElement, SiUfcProps>(function SiUfc({title = 'UFC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
