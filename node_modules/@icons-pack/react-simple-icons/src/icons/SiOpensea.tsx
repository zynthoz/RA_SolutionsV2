    ...
    type SiOpenseaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpensea: IconType = React.forwardRef<SVGSVGElement, SiOpenseaProps>(function SiOpensea({title = 'OpenSea', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
