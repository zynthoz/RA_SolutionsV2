    ...
    type SiNeweggProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNewegg: IconType = React.forwardRef<SVGSVGElement, SiNeweggProps>(function SiNewegg({title = 'Newegg', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNewegg as default, defaultColor };
