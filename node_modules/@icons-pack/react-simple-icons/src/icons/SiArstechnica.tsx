    ...
    type SiArstechnicaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF4E00';

    const SiArstechnica: IconType = React.forwardRef<SVGSVGElement, SiArstechnicaProps>(function SiArstechnica({title = 'Ars Technica', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArstechnica as default, defaultColor };
