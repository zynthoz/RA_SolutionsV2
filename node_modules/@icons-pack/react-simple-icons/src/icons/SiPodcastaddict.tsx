    ...
    type SiPodcastaddictProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPodcastaddict: IconType = React.forwardRef<SVGSVGElement, SiPodcastaddictProps>(function SiPodcastaddict({title = 'Podcast Addict', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPodcastaddict as default, defaultColor };
