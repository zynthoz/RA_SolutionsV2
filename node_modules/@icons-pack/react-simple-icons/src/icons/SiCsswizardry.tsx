    ...
    type SiCsswizardryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCsswizardry: IconType = React.forwardRef<SVGSVGElement, SiCsswizardryProps>(function SiCsswizardry({title = 'CSS Wizardry', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
