    ...
    type SiZensarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZensar: IconType = React.forwardRef<SVGSVGElement, SiZensarProps>(function SiZensar({title = 'Zensar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
