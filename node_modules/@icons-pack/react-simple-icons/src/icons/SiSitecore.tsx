    ...
    type SiSitecoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB1F1F';

    const SiSitecore: IconType = React.forwardRef<SVGSVGElement, SiSitecoreProps>(function SiSitecore({title = 'Sitecore', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSitecore as default, defaultColor };
