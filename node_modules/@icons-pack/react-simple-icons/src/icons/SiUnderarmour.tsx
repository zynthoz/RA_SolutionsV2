    ...
    type SiUnderarmourProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUnderarmour: IconType = React.forwardRef<SVGSVGElement, SiUnderarmourProps>(function SiUnderarmour({title = 'Under Armour', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiUnderarmour as default, defaultColor };
