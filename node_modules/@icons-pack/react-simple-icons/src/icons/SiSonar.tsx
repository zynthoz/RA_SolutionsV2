    ...
    type SiSonarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonar: IconType = React.forwardRef<SVGSVGElement, SiSonarProps>(function SiSonar({title = 'Sonar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSonar as default, defaultColor };
