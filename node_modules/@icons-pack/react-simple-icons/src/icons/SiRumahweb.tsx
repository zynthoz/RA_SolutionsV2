    ...
    type SiRumahwebProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2EB4E3';

    const SiRumahweb: IconType = React.forwardRef<SVGSVGElement, SiRumahwebProps>(function SiRumahweb({title = 'Rumahweb', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
