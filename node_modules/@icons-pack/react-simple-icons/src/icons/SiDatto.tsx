    ...
    type SiDattoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#199ED9';

    const SiDatto: IconType = React.forwardRef<SVGSVGElement, SiDattoProps>(function SiDatto({title = 'Datto', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDatto as default, defaultColor };
