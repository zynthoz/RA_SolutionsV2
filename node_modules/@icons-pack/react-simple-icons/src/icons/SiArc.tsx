    ...
    type SiArcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FCBFBD';

    const SiArc: IconType = React.forwardRef<SVGSVGElement, SiArcProps>(function SiArc({title = 'Arc', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiArc as default, defaultColor };
