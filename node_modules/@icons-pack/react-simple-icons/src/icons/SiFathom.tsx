    ...
    type SiFathomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFathom: IconType = React.forwardRef<SVGSVGElement, SiFathomProps>(function SiFathom({title = 'Fathom', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
