    ...
    type SiSingaporeairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F99F1C';

    const SiSingaporeairlines: IconType = React.forwardRef<SVGSVGElement, SiSingaporeairlinesProps>(function SiSingaporeairlines({title = 'Singapore Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSingaporeairlines as default, defaultColor };
