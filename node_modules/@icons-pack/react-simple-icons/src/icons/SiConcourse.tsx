    ...
    type SiConcourseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3398DC';

    const SiConcourse: IconType = React.forwardRef<SVGSVGElement, SiConcourseProps>(function SiConcourse({title = 'Concourse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
