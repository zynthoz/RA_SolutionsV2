    ...
    type SiCodementorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodementor: IconType = React.forwardRef<SVGSVGElement, SiCodementorProps>(function SiCodementor({title = 'Codementor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
