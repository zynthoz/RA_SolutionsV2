    ...
    type SiQubesosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQubesos: IconType = React.forwardRef<SVGSVGElement, SiQubesosProps>(function SiQubesos({title = 'Qubes OS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
