    ...
    type SiJabberProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJabber: IconType = React.forwardRef<SVGSVGElement, SiJabberProps>(function SiJabber({title = 'Jabber', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJabber as default, defaultColor };
