    ...
    type SiChaiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChai: IconType = React.forwardRef<SVGSVGElement, SiChaiProps>(function SiChai({title = 'Chai', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
