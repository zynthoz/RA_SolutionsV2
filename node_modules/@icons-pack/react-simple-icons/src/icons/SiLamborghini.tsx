    ...
    type SiLamborghiniProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLamborghini: IconType = React.forwardRef<SVGSVGElement, SiLamborghiniProps>(function SiLamborghini({title = 'Lamborghini', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
