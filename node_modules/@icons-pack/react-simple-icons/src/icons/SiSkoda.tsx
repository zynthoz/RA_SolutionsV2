    ...
    type SiSkodaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSkoda: IconType = React.forwardRef<SVGSVGElement, SiSkodaProps>(function SiSkoda({title = 'ŠKODA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
