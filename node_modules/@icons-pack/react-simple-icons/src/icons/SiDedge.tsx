    ...
    type SiDedgeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDedge: IconType = React.forwardRef<SVGSVGElement, SiDedgeProps>(function SiDedge({title = 'D-EDGE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
