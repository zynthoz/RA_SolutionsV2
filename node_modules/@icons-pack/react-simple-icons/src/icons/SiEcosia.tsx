    ...
    type SiEcosiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiEcosia: IconType = React.forwardRef<SVGSVGElement, SiEcosiaProps>(function SiEcosia({title = 'Ecosia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
