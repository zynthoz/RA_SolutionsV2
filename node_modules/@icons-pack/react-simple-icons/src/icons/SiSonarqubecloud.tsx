    ...
    type SiSonarqubecloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSonarqubecloud: IconType = React.forwardRef<SVGSVGElement, SiSonarqubecloudProps>(function SiSonarqubecloud({title = 'SonarQube Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
