    ...
    type SiDependencycheckProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDependencycheck: IconType = React.forwardRef<SVGSVGElement, SiDependencycheckProps>(function SiDependencycheck({title = 'OWASP Dependency-Check', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
