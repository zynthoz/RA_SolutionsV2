    ...
    type SiHavellsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHavells: IconType = React.forwardRef<SVGSVGElement, SiHavellsProps>(function SiHavells({title = 'Havells', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHavells as default, defaultColor };
