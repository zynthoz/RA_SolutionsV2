    ...
    type SiKdeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKde: IconType = React.forwardRef<SVGSVGElement, SiKdeProps>(function SiKde({title = 'KDE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
