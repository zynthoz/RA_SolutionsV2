    ...
    type SiFavroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFavro: IconType = React.forwardRef<SVGSVGElement, SiFavroProps>(function SiFavro({title = 'Favro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
