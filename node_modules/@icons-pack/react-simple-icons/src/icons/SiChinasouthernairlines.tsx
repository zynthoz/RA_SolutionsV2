    ...
    type SiChinasouthernairlinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChinasouthernairlines: IconType = React.forwardRef<SVGSVGElement, SiChinasouthernairlinesProps>(function SiChinasouthernairlines({title = 'China Southern Airlines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
