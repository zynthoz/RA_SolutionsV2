    ...
    type SiGinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#008ECF';

    const SiGin: IconType = React.forwardRef<SVGSVGElement, SiGinProps>(function SiGin({title = 'Gin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
