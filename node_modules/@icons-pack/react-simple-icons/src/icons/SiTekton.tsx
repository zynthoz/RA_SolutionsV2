    ...
    type SiTektonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FD495C';

    const SiTekton: IconType = React.forwardRef<SVGSVGElement, SiTektonProps>(function SiTekton({title = 'Tekton', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
