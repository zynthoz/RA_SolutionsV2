    ...
    type SiOsmcProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOsmc: IconType = React.forwardRef<SVGSVGElement, SiOsmcProps>(function SiOsmc({title = 'OSMC', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
