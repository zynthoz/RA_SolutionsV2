    ...
    type SiKuaishouProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKuaishou: IconType = React.forwardRef<SVGSVGElement, SiKuaishouProps>(function SiKuaishou({title = 'Kuaishou', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
