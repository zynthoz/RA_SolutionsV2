    ...
    type SiPoeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPoe: IconType = React.forwardRef<SVGSVGElement, SiPoeProps>(function SiPoe({title = 'Poe', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
