    ...
    type SiWebauthnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWebauthn: IconType = React.forwardRef<SVGSVGElement, SiWebauthnProps>(function SiWebauthn({title = 'WebAuthn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWebauthn as default, defaultColor };
