    ...
    type SiFaunaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFauna: IconType = React.forwardRef<SVGSVGElement, SiFaunaProps>(function SiFauna({title = 'Fauna', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
