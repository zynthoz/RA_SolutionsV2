    ...
    type SiAdafruitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdafruit: IconType = React.forwardRef<SVGSVGElement, SiAdafruitProps>(function SiAdafruit({title = 'Adafruit', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAdafruit as default, defaultColor };
