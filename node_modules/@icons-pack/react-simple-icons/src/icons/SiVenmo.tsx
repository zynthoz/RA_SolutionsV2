    ...
    type SiVenmoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVenmo: IconType = React.forwardRef<SVGSVGElement, SiVenmoProps>(function SiVenmo({title = 'Venmo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
