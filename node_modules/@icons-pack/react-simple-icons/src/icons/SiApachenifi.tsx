    ...
    type SiApachenifiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachenifi: IconType = React.forwardRef<SVGSVGElement, SiApachenifiProps>(function SiApachenifi({title = 'Apache NiFi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachenifi as default, defaultColor };
