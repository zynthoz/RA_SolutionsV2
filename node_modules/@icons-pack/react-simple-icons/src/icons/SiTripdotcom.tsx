    ...
    type SiTripdotcomProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#287DFA';

    const SiTripdotcom: IconType = React.forwardRef<SVGSVGElement, SiTripdotcomProps>(function SiTripdotcom({title = 'Trip.com', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTripdotcom as default, defaultColor };
