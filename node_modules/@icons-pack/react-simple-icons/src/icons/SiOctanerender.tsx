    ...
    type SiOctanerenderProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOctanerender: IconType = React.forwardRef<SVGSVGElement, SiOctanerenderProps>(function SiOctanerender({title = 'Octane Render', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiOctanerender as default, defaultColor };
