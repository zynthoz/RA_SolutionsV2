    ...
    type SiFilezillaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFilezilla: IconType = React.forwardRef<SVGSVGElement, SiFilezillaProps>(function SiFilezilla({title = 'FileZilla', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFilezilla as default, defaultColor };
