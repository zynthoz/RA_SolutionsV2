    ...
    type SiGoogleauthenticatorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleauthenticator: IconType = React.forwardRef<SVGSVGElement, SiGoogleauthenticatorProps>(function SiGoogleauthenticator({title = 'Google Authenticator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
