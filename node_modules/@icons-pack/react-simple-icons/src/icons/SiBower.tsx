    ...
    type SiBowerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBower: IconType = React.forwardRef<SVGSVGElement, SiBowerProps>(function SiBower({title = 'Bower', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBower as default, defaultColor };
