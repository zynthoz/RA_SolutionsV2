    ...
    type SiPosthogProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPosthog: IconType = React.forwardRef<SVGSVGElement, SiPosthogProps>(function SiPosthog({title = 'PostHog', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
