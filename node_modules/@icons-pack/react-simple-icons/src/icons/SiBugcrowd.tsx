    ...
    type SiBugcrowdProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBugcrowd: IconType = React.forwardRef<SVGSVGElement, SiBugcrowdProps>(function SiBugcrowd({title = 'Bugcrowd', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
