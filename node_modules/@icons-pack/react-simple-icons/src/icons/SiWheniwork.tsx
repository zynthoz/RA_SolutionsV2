    ...
    type SiWheniworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWheniwork: IconType = React.forwardRef<SVGSVGElement, SiWheniworkProps>(function SiWheniwork({title = 'When I Work', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
