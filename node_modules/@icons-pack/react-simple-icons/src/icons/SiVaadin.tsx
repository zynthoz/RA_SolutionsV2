    ...
    type SiVaadinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVaadin: IconType = React.forwardRef<SVGSVGElement, SiVaadinProps>(function SiVaadin({title = 'Vaadin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
