    ...
    type SiRteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRte: IconType = React.forwardRef<SVGSVGElement, SiRteProps>(function SiRte({title = 'RTÉ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiRte as default, defaultColor };
