    ...
    type SiXmlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#005FAD';

    const SiXml: IconType = React.forwardRef<SVGSVGElement, SiXmlProps>(function SiXml({title = 'XML', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiXml as default, defaultColor };
