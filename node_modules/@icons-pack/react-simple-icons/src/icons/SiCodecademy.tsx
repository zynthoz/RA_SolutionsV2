    ...
    type SiCodecademyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1F4056';

    const SiCodecademy: IconType = React.forwardRef<SVGSVGElement, SiCodecademyProps>(function SiCodecademy({title = 'Codecademy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCodecademy as default, defaultColor };
