    ...
    type SiToshibaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiToshiba: IconType = React.forwardRef<SVGSVGElement, SiToshibaProps>(function SiToshiba({title = 'Toshiba', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiToshiba as default, defaultColor };
