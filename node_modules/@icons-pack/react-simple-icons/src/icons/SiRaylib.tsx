    ...
    type SiRaylibProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRaylib: IconType = React.forwardRef<SVGSVGElement, SiRaylibProps>(function SiRaylib({title = 'Raylib', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
