    ...
    type SiCircleciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCircleci: IconType = React.forwardRef<SVGSVGElement, SiCircleciProps>(function SiCircleci({title = 'CircleCI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCircleci as default, defaultColor };
