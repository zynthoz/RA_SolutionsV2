    ...
    type SiAntena3Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAntena3: IconType = React.forwardRef<SVGSVGElement, SiAntena3Props>(function SiAntena3({title = 'Antena 3', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
