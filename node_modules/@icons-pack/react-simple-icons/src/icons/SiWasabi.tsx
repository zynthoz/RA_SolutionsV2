    ...
    type SiWasabiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#01CD3E';

    const SiWasabi: IconType = React.forwardRef<SVGSVGElement, SiWasabiProps>(function SiWasabi({title = 'Wasabi', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWasabi as default, defaultColor };
