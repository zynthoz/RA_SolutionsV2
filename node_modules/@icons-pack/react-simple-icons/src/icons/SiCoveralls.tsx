    ...
    type SiCoverallsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoveralls: IconType = React.forwardRef<SVGSVGElement, SiCoverallsProps>(function SiCoveralls({title = 'Coveralls', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoveralls as default, defaultColor };
