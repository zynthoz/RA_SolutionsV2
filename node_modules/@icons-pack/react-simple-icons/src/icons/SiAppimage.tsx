    ...
    type SiAppimageProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#739FB9';

    const SiAppimage: IconType = React.forwardRef<SVGSVGElement, SiAppimageProps>(function SiAppimage({title = 'AppImage', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
