    ...
    type SiBmwProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBmw: IconType = React.forwardRef<SVGSVGElement, SiBmwProps>(function SiBmw({title = 'BMW', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBmw as default, defaultColor };
