    ...
    type SiBookstackProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBookstack: IconType = React.forwardRef<SVGSVGElement, SiBookstackProps>(function SiBookstack({title = 'BookStack', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBookstack as default, defaultColor };
