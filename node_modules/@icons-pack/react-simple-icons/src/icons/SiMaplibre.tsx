    ...
    type SiMaplibreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMaplibre: IconType = React.forwardRef<SVGSVGElement, SiMaplibreProps>(function SiMaplibre({title = 'MapLibre', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
