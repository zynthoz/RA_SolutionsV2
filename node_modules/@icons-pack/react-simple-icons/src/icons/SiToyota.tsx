    ...
    type SiToyotaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB0A1E';

    const SiToyota: IconType = React.forwardRef<SVGSVGElement, SiToyotaProps>(function SiToyota({title = 'Toyota', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiToyota as default, defaultColor };
