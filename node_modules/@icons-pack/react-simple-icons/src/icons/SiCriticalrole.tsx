    ...
    type SiCriticalroleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCriticalrole: IconType = React.forwardRef<SVGSVGElement, SiCriticalroleProps>(function SiCriticalrole({title = 'Critical Role', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
