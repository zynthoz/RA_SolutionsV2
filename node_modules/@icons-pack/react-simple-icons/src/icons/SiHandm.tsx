    ...
    type SiHandmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHandm: IconType = React.forwardRef<SVGSVGElement, SiHandmProps>(function SiHandm({title = 'H&M', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHandm as default, defaultColor };
