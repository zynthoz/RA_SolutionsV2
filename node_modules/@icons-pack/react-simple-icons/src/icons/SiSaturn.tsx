    ...
    type SiSaturnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSaturn: IconType = React.forwardRef<SVGSVGElement, SiSaturnProps>(function SiSaturn({title = 'Saturn', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
