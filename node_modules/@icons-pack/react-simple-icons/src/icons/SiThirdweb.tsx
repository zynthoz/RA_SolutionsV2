    ...
    type SiThirdwebProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiThirdweb: IconType = React.forwardRef<SVGSVGElement, SiThirdwebProps>(function SiThirdweb({title = 'thirdweb', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
