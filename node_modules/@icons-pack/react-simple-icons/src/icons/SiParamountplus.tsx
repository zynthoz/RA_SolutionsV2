    ...
    type SiParamountplusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0064FF';

    const SiParamountplus: IconType = React.forwardRef<SVGSVGElement, SiParamountplusProps>(function SiParamountplus({title = 'Paramount+', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiParamountplus as default, defaultColor };
