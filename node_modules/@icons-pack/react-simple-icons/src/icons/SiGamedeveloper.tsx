    ...
    type SiGamedeveloperProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGamedeveloper: IconType = React.forwardRef<SVGSVGElement, SiGamedeveloperProps>(function SiGamedeveloper({title = 'Game Developer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
