    ...
    type SiTemporalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTemporal: IconType = React.forwardRef<SVGSVGElement, SiTemporalProps>(function SiTemporal({title = 'Temporal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTemporal as default, defaultColor };
