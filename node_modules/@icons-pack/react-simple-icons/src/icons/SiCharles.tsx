    ...
    type SiCharlesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCharles: IconType = React.forwardRef<SVGSVGElement, SiCharlesProps>(function SiCharles({title = 'Charles', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
