    ...
    type SiSwiggyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSwiggy: IconType = React.forwardRef<SVGSVGElement, SiSwiggyProps>(function SiSwiggy({title = 'Swiggy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSwiggy as default, defaultColor };
