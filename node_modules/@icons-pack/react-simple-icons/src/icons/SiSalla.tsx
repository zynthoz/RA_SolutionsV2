    ...
    type SiSallaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BAF3E6';

    const SiSalla: IconType = React.forwardRef<SVGSVGElement, SiSallaProps>(function SiSalla({title = 'Salla', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSalla as default, defaultColor };
