    ...
    type SiUniqloProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUniqlo: IconType = React.forwardRef<SVGSVGElement, SiUniqloProps>(function SiUniqlo({title = 'Uniqlo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
