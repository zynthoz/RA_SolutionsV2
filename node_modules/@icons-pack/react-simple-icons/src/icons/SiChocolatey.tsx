    ...
    type SiChocolateyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiChocolatey: IconType = React.forwardRef<SVGSVGElement, SiChocolateyProps>(function SiChocolatey({title = 'Chocolatey', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
