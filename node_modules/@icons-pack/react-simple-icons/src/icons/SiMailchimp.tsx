    ...
    type SiMailchimpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFE01B';

    const SiMailchimp: IconType = React.forwardRef<SVGSVGElement, SiMailchimpProps>(function SiMailchimp({title = 'MailChimp', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMailchimp as default, defaultColor };
