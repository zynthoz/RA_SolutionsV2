    ...
    type SiItvxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiItvx: IconType = React.forwardRef<SVGSVGElement, SiItvxProps>(function SiItvx({title = 'ITVx', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
