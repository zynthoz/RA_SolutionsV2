    ...
    type SiReacttableProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF4154';

    const SiReacttable: IconType = React.forwardRef<SVGSVGElement, SiReacttableProps>(function SiReacttable({title = 'React Table', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiReacttable as default, defaultColor };
