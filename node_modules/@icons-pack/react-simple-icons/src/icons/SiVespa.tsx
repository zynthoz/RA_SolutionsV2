    ...
    type SiVespaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiVespa: IconType = React.forwardRef<SVGSVGElement, SiVespaProps>(function SiVespa({title = 'Vespa', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
