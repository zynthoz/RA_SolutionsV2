    ...
    type SiReadthedocsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiReadthedocs: IconType = React.forwardRef<SVGSVGElement, SiReadthedocsProps>(function SiReadthedocs({title = 'Read the Docs', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
