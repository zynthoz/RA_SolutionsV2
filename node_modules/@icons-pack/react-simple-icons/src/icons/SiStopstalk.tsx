    ...
    type SiStopstalkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStopstalk: IconType = React.forwardRef<SVGSVGElement, SiStopstalkProps>(function SiStopstalk({title = 'StopStalk', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
