    ...
    type SiGitconnectedProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#2E69AE';

    const SiGitconnected: IconType = React.forwardRef<SVGSVGElement, SiGitconnectedProps>(function SiGitconnected({title = 'Gitconnected', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGitconnected as default, defaultColor };
