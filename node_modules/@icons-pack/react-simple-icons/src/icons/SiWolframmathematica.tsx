    ...
    type SiWolframmathematicaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWolframmathematica: IconType = React.forwardRef<SVGSVGElement, SiWolframmathematicaProps>(function SiWolframmathematica({title = 'Wolfram Mathematica', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
