    ...
    type SiPwaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5A0FC8';

    const SiPwa: IconType = React.forwardRef<SVGSVGElement, SiPwaProps>(function SiPwa({title = 'PWA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPwa as default, defaultColor };
