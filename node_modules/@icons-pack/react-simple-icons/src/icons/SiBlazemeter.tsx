    ...
    type SiBlazemeterProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBlazemeter: IconType = React.forwardRef<SVGSVGElement, SiBlazemeterProps>(function SiBlazemeter({title = 'Blazemeter', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
