    ...
    type SiMaxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMax: IconType = React.forwardRef<SVGSVGElement, SiMaxProps>(function SiMax({title = 'Max', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMax as default, defaultColor };
