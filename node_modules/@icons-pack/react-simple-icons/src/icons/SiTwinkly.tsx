    ...
    type SiTwinklyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTwinkly: IconType = React.forwardRef<SVGSVGElement, SiTwinklyProps>(function SiTwinkly({title = 'Twinkly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
