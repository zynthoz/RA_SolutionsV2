    ...
    type SiNordicsemiconductorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNordicsemiconductor: IconType = React.forwardRef<SVGSVGElement, SiNordicsemiconductorProps>(function SiNordicsemiconductor({title = 'Nordic Semiconductor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNordicsemiconductor as default, defaultColor };
