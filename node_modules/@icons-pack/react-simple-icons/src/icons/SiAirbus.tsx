    ...
    type SiAirbusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirbus: IconType = React.forwardRef<SVGSVGElement, SiAirbusProps>(function SiAirbus({title = 'Airbus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
