    ...
    type SiN26Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiN26: IconType = React.forwardRef<SVGSVGElement, SiN26Props>(function SiN26({title = 'N26', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
