    ...
    type SiCoreldrawProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCoreldraw: IconType = React.forwardRef<SVGSVGElement, SiCoreldrawProps>(function SiCoreldraw({title = 'CorelDRAW', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCoreldraw as default, defaultColor };
