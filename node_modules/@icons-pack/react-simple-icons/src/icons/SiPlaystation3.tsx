    ...
    type SiPlaystation3Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPlaystation3: IconType = React.forwardRef<SVGSVGElement, SiPlaystation3Props>(function SiPlaystation3({title = 'PlayStation 3', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
