    ...
    type SiOpensuseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiOpensuse: IconType = React.forwardRef<SVGSVGElement, SiOpensuseProps>(function SiOpensuse({title = 'openSUSE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
