    ...
    type SiLvglProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#343839';

    const SiLvgl: IconType = React.forwardRef<SVGSVGElement, SiLvglProps>(function SiLvgl({title = 'LVGL', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLvgl as default, defaultColor };
