    ...
    type SiGithubpagesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGithubpages: IconType = React.forwardRef<SVGSVGElement, SiGithubpagesProps>(function SiGithubpages({title = 'GitHub Pages', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGithubpages as default, defaultColor };
