    ...
    type SiTaobaoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiTaobao: IconType = React.forwardRef<SVGSVGElement, SiTaobaoProps>(function SiTaobao({title = 'Taobao', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTaobao as default, defaultColor };
