    ...
    type SiNodemonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNodemon: IconType = React.forwardRef<SVGSVGElement, SiNodemonProps>(function SiNodemon({title = 'Nodemon', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
