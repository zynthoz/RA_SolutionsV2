    ...
    type SiAntaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAnta: IconType = React.forwardRef<SVGSVGElement, SiAntaProps>(function SiAnta({title = 'Anta', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
