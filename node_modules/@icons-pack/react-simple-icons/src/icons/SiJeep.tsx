    ...
    type SiJeepProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJeep: IconType = React.forwardRef<SVGSVGElement, SiJeepProps>(function SiJeep({title = 'Jeep', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
