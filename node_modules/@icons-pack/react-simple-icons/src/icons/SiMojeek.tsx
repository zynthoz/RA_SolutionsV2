    ...
    type SiMojeekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7AB93C';

    const SiMojeek: IconType = React.forwardRef<SVGSVGElement, SiMojeekProps>(function SiMojeek({title = 'Mojeek', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMojeek as default, defaultColor };
