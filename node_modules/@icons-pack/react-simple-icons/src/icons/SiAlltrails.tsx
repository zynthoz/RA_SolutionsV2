    ...
    type SiAlltrailsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlltrails: IconType = React.forwardRef<SVGSVGElement, SiAlltrailsProps>(function SiAlltrails({title = 'AllTrails', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAlltrails as default, defaultColor };
