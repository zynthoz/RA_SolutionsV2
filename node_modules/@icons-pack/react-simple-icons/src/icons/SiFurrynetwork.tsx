    ...
    type SiFurrynetworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFurrynetwork: IconType = React.forwardRef<SVGSVGElement, SiFurrynetworkProps>(function SiFurrynetwork({title = 'Furry Network', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
