    ...
    type SiShazamProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiShazam: IconType = React.forwardRef<SVGSVGElement, SiShazamProps>(function SiShazam({title = 'Shazam', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
