    ...
    type SiScrutinizerciProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#8A9296';

    const SiScrutinizerci: IconType = React.forwardRef<SVGSVGElement, SiScrutinizerciProps>(function SiScrutinizerci({title = 'Scrutinizer CI', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiScrutinizerci as default, defaultColor };
