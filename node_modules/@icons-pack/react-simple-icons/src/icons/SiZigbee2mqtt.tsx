    ...
    type SiZigbee2mqttProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiZigbee2mqtt: IconType = React.forwardRef<SVGSVGElement, SiZigbee2mqttProps>(function SiZigbee2mqtt({title = 'Zigbee2MQTT', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZigbee2mqtt as default, defaultColor };
