    ...
    type SiWakatimeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWakatime: IconType = React.forwardRef<SVGSVGElement, SiWakatimeProps>(function SiWakatime({title = 'WakaTime', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWakatime as default, defaultColor };
