    ...
    type SiDunzoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDunzo: IconType = React.forwardRef<SVGSVGElement, SiDunzoProps>(function SiDunzo({title = 'Dunzo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDunzo as default, defaultColor };
