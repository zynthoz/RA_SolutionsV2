    ...
    type SiGitbookProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGitbook: IconType = React.forwardRef<SVGSVGElement, SiGitbookProps>(function SiGitbook({title = 'GitBook', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
