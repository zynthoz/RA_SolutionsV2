    ...
    type SiBadooProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiBadoo: IconType = React.forwardRef<SVGSVGElement, SiBadooProps>(function SiBadoo({title = 'Badoo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiBadoo as default, defaultColor };
