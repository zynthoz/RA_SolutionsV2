    ...
    type SiOreillyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D3002D';

    const SiOreilly: IconType = React.forwardRef<SVGSVGElement, SiOreillyProps>(function SiOreilly({title = 'OReilly', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
