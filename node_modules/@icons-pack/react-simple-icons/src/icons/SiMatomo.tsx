    ...
    type SiMatomoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMatomo: IconType = React.forwardRef<SVGSVGElement, SiMatomoProps>(function SiMatomo({title = 'Matomo', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
