    ...
    type SiFoursquareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFoursquare: IconType = React.forwardRef<SVGSVGElement, SiFoursquareProps>(function SiFoursquare({title = 'Foursquare', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFoursquare as default, defaultColor };
