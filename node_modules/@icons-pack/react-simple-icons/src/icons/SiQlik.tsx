    ...
    type SiQlikProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#009848';

    const SiQlik: IconType = React.forwardRef<SVGSVGElement, SiQlikProps>(function SiQlik({title = 'Qlik', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
