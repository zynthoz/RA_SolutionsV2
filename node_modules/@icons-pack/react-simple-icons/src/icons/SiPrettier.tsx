    ...
    type SiPrettierProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPrettier: IconType = React.forwardRef<SVGSVGElement, SiPrettierProps>(function SiPrettier({title = 'Prettier', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPrettier as default, defaultColor };
