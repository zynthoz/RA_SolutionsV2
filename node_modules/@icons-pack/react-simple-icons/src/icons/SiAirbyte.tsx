    ...
    type SiAirbyteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAirbyte: IconType = React.forwardRef<SVGSVGElement, SiAirbyteProps>(function SiAirbyte({title = 'Airbyte', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAirbyte as default, defaultColor };
