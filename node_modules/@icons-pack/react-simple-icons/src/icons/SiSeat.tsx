    ...
    type SiSeatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSeat: IconType = React.forwardRef<SVGSVGElement, SiSeatProps>(function SiSeat({title = 'SEAT', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiSeat as default, defaultColor };
