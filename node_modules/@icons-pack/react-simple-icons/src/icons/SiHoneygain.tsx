    ...
    type SiHoneygainProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F9C900';

    const SiHoneygain: IconType = React.forwardRef<SVGSVGElement, SiHoneygainProps>(function SiHoneygain({title = 'Honeygain', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHoneygain as default, defaultColor };
