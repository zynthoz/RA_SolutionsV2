    ...
    type SiQbittorrentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiQbittorrent: IconType = React.forwardRef<SVGSVGElement, SiQbittorrentProps>(function SiQbittorrent({title = 'qbittorrent', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
