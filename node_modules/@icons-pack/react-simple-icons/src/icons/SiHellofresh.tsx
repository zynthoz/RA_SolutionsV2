    ...
    type SiHellofreshProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHellofresh: IconType = React.forwardRef<SVGSVGElement, SiHellofreshProps>(function SiHellofresh({title = 'HelloFresh', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiHellofresh as default, defaultColor };
