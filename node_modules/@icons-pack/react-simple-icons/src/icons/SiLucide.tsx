    ...
    type SiLucideProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#F56565';

    const SiLucide: IconType = React.forwardRef<SVGSVGElement, SiLucideProps>(function SiLucide({title = 'Lucide', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLucide as default, defaultColor };
