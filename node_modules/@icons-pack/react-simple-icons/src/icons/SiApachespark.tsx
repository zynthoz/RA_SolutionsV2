    ...
    type SiApachesparkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApachespark: IconType = React.forwardRef<SVGSVGElement, SiApachesparkProps>(function SiApachespark({title = 'Apache Spark', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApachespark as default, defaultColor };
