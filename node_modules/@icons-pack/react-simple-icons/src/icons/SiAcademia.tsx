    ...
    type SiAcademiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAcademia: IconType = React.forwardRef<SVGSVGElement, SiAcademiaProps>(function SiAcademia({title = 'Academia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAcademia as default, defaultColor };
