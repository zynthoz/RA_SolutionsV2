    ...
    type SiSuzukiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSuzuki: IconType = React.forwardRef<SVGSVGElement, SiSuzukiProps>(function SiSuzuki({title = 'Suzuki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
