    ...
    type SiNewyorktimesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNewyorktimes: IconType = React.forwardRef<SVGSVGElement, SiNewyorktimesProps>(function SiNewyorktimes({title = 'New York Times', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
