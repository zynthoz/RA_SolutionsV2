    ...
    type SiComptiaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiComptia: IconType = React.forwardRef<SVGSVGElement, SiComptiaProps>(function SiComptia({title = 'CompTIA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
