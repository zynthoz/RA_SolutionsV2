    ...
    type SiNasaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNasa: IconType = React.forwardRef<SVGSVGElement, SiNasaProps>(function SiNasa({title = 'NASA', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
