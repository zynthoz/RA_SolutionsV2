    ...
    type SiAnkiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAnki: IconType = React.forwardRef<SVGSVGElement, SiAnkiProps>(function SiAnki({title = 'Anki', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
