    ...
    type SiKeycdnProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKeycdn: IconType = React.forwardRef<SVGSVGElement, SiKeycdnProps>(function SiKeycdn({title = 'KeyCDN', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKeycdn as default, defaultColor };
