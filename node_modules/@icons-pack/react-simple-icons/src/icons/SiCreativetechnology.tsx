    ...
    type SiCreativetechnologyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCreativetechnology: IconType = React.forwardRef<SVGSVGElement, SiCreativetechnologyProps>(function SiCreativetechnology({title = 'Creative Technology', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiCreativetechnology as default, defaultColor };
