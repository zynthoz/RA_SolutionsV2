    ...
    type SiUtorrentProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiUtorrent: IconType = React.forwardRef<SVGSVGElement, SiUtorrentProps>(function SiUtorrent({title = 'uTorrent', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
