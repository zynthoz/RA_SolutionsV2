    ...
    type SiAstroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAstro: IconType = React.forwardRef<SVGSVGElement, SiAstroProps>(function SiAstro({title = 'Astro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
