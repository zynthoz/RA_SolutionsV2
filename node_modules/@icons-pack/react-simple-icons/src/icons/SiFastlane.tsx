    ...
    type SiFastlaneProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#00F200';

    const SiFastlane: IconType = React.forwardRef<SVGSVGElement, SiFastlaneProps>(function SiFastlane({title = 'Fastlane', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
