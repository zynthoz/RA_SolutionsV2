    ...
    type SiGradleplaypublisherProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGradleplaypublisher: IconType = React.forwardRef<SVGSVGElement, SiGradleplaypublisherProps>(function SiGradleplaypublisher({title = 'Gradle Play Publisher', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGradleplaypublisher as default, defaultColor };
