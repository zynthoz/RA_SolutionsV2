    ...
    type SiFoodpandaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#D70F64';

    const SiFoodpanda: IconType = React.forwardRef<SVGSVGElement, SiFoodpandaProps>(function SiFoodpanda({title = 'foodpanda', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFoodpanda as default, defaultColor };
