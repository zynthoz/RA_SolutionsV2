    ...
    type SiPagseguroProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPagseguro: IconType = React.forwardRef<SVGSVGElement, SiPagseguroProps>(function SiPagseguro({title = 'PagSeguro', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
