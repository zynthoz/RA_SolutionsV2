    ...
    type SiGnuProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#A42E2B';

    const SiGnu: IconType = React.forwardRef<SVGSVGElement, SiGnuProps>(function SiGnu({title = 'GNU', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
