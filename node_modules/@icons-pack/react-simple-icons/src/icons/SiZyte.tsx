    ...
    type SiZyteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#B02CCE';

    const SiZyte: IconType = React.forwardRef<SVGSVGElement, SiZyteProps>(function SiZyte({title = 'Zyte', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiZyte as default, defaultColor };
