    ...
    type SiProbotProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiProbot: IconType = React.forwardRef<SVGSVGElement, SiProbotProps>(function SiProbot({title = 'Probot', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
