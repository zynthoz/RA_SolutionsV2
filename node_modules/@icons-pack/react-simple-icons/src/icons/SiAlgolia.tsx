    ...
    type SiAlgoliaProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAlgolia: IconType = React.forwardRef<SVGSVGElement, SiAlgoliaProps>(function SiAlgolia({title = 'Algolia', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
