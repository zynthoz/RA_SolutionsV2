    ...
    type SiApacheguacamoleProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiApacheguacamole: IconType = React.forwardRef<SVGSVGElement, SiApacheguacamoleProps>(function SiApacheguacamole({title = 'Apache Guacamole', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiApacheguacamole as default, defaultColor };
