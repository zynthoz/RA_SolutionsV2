    ...
    type SiNodeguiProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNodegui: IconType = React.forwardRef<SVGSVGElement, SiNodeguiProps>(function SiNodegui({title = 'NodeGui', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
