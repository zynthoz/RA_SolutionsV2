    ...
    type SiAutocadProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAutocad: IconType = React.forwardRef<SVGSVGElement, SiAutocadProps>(function SiAutocad({title = 'AutoCAD', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAutocad as default, defaultColor };
