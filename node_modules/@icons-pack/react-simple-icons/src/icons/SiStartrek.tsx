    ...
    type SiStartrekProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiStartrek: IconType = React.forwardRef<SVGSVGElement, SiStartrekProps>(function SiStartrek({title = 'Star Trek', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiStartrek as default, defaultColor };
