    ...
    type SiPercyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPercy: IconType = React.forwardRef<SVGSVGElement, SiPercyProps>(function SiPercy({title = 'Percy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
