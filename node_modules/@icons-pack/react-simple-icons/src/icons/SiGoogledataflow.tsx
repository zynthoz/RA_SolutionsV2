    ...
    type SiGoogledataflowProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledataflow: IconType = React.forwardRef<SVGSVGElement, SiGoogledataflowProps>(function SiGoogledataflow({title = 'Google Dataflow', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
