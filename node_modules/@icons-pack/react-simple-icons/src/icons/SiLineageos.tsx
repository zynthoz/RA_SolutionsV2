    ...
    type SiLineageosProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#167C80';

    const SiLineageos: IconType = React.forwardRef<SVGSVGElement, SiLineageosProps>(function SiLineageos({title = 'LineageOS', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
