    ...
    type SiJirasoftwareProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJirasoftware: IconType = React.forwardRef<SVGSVGElement, SiJirasoftwareProps>(function SiJirasoftware({title = 'Jira Software', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJirasoftware as default, defaultColor };
