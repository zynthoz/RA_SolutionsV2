    ...
    type SiLazarusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiLazarus: IconType = React.forwardRef<SVGSVGElement, SiLazarusProps>(function SiLazarus({title = 'Lazarus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLazarus as default, defaultColor };
