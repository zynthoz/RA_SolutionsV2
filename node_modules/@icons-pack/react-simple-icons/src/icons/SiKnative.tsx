    ...
    type SiKnativeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiKnative: IconType = React.forwardRef<SVGSVGElement, SiKnativeProps>(function SiKnative({title = 'Knative', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiKnative as default, defaultColor };
