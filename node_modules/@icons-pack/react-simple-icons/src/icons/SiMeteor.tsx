    ...
    type SiMeteorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMeteor: IconType = React.forwardRef<SVGSVGElement, SiMeteorProps>(function SiMeteor({title = 'Meteor', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
