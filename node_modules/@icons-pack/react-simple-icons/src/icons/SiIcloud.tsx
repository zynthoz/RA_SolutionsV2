    ...
    type SiIcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3693F3';

    const SiIcloud: IconType = React.forwardRef<SVGSVGElement, SiIcloudProps>(function SiIcloud({title = 'iCloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIcloud as default, defaultColor };
