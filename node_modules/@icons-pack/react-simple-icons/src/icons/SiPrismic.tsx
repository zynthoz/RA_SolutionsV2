    ...
    type SiPrismicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#5163BA';

    const SiPrismic: IconType = React.forwardRef<SVGSVGElement, SiPrismicProps>(function SiPrismic({title = 'Prismic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiPrismic as default, defaultColor };
