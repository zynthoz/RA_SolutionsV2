    ...
    type SiPytestProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiPytest: IconType = React.forwardRef<SVGSVGElement, SiPytestProps>(function SiPytest({title = 'Pytest', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
