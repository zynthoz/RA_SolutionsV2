...
const SiLibrewolf = React__namespace.forwardRef(function SiLibrewolf2({ title = "LibreWolf", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
