...
const SiPfsense = React__namespace.forwardRef(function SiPfsense2({ title = "pfSense", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
