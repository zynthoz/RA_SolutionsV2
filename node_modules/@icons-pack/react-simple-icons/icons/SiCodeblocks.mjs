...
const SiCodeblocks = React.forwardRef(function SiCodeblocks2({ title = "Code::Blocks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
