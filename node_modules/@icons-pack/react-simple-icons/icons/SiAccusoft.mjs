...
const SiAccusoft = React.forwardRef(function SiAccusoft2({ title = "Accusoft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
