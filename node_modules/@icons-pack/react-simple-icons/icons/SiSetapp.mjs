...
const SiSetapp = React.forwardRef(function SiSetapp2({ title = "Setapp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
