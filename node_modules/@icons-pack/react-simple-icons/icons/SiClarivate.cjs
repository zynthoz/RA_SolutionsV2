...
const defaultColor = "#93FF9E";
const SiClarivate = React__namespace.forwardRef(function SiClarivate2({ title = "Clarivate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
