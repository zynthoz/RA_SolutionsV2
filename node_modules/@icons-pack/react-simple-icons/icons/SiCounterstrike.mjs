...
const SiCounterstrike = React.forwardRef(function SiCounterstrike2({ title = "Counter-Strike", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
