...
const SiThinkpad = React.forwardRef(function SiThinkpad2({ title = "ThinkPad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
