...
const SiSpaceship = React__namespace.forwardRef(function SiSpaceship2({ title = "Spaceship", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
