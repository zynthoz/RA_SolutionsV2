...
const SiZulip = React.forwardRef(function SiZulip2({ title = "Zulip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
