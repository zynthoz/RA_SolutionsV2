...
const SiCodeship = React__namespace.forwardRef(function SiCodeship2({ title = "Codeship", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
