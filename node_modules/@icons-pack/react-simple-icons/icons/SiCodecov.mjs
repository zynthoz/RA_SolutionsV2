...
const SiCodecov = React.forwardRef(function SiCodecov2({ title = "Codecov", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
