...
const SiWearos = React__namespace.forwardRef(function SiWearos2({ title = "Wear OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
