...
const defaultColor = "#7957D5";
const SiBuefy = React.forwardRef(function SiBuefy2({ title = "Buefy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
