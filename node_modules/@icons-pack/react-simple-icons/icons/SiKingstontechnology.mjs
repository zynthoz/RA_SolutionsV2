...
const SiKingstontechnology = React.forwardRef(function SiKingstontechnology2({ title = "Kingston Technology", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
