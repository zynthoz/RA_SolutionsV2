...
const SiNovu = React.forwardRef(function SiNovu2({ title = "Novu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
