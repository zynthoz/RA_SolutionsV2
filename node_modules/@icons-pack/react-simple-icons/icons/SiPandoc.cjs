...
const SiPandoc = React__namespace.forwardRef(function SiPandoc2({ title = "Pandoc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
