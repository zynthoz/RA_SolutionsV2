...
const defaultColor = "#F29400";
const SiLoop = React__namespace.forwardRef(function SiLoop2({ title = "Loop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
