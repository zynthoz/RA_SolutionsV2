...
const SiPythonanywhere = React.forwardRef(function SiPythonanywhere2({ title = "PythonAnywhere", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
