...
const SiKnexdotjs = React.forwardRef(function SiKnexdotjs2({ title = "Knex.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
