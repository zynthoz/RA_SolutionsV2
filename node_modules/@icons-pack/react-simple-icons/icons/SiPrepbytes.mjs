...
const SiPrepbytes = React.forwardRef(function SiPrepbytes2({ title = "PrepBytes", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
