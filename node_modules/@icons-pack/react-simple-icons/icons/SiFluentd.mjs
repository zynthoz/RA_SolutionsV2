...
const SiFluentd = React.forwardRef(function SiFluentd2({ title = "Fluentd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
