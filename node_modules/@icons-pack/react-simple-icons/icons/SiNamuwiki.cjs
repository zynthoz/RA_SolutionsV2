...
const defaultColor = "#008275";
const SiNamuwiki = React__namespace.forwardRef(function SiNamuwiki2({ title = "Namu Wiki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
