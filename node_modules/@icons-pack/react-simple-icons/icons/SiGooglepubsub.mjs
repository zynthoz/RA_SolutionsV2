...
const SiGooglepubsub = React.forwardRef(function SiGooglepubsub2({ title = "Google Pub/Sub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
