...
const defaultColor = "#262627";
const SiTypeform = React.forwardRef(function SiTypeform2({ title = "Typeform", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
