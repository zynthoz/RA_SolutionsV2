...
const defaultColor = "#EB1510";
const SiCarto = React__namespace.forwardRef(function SiCarto2({ title = "Carto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
