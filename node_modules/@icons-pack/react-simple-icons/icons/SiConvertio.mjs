...
const SiConvertio = React.forwardRef(function SiConvertio2({ title = "Convertio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
