...
const SiIeee = React__namespace.forwardRef(function SiIeee2({ title = "IEEE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
