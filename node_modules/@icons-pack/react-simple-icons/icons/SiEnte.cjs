...
const SiEnte = React__namespace.forwardRef(function SiEnte2({ title = "Ente", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
