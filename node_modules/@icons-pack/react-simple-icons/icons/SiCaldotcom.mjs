...
const SiCaldotcom = React.forwardRef(function SiCaldotcom2({ title = "Cal.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
