...
const SiIced = React.forwardRef(function SiIced2({ title = "Iced", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
