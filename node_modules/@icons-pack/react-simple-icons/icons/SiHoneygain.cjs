...
const SiHoneygain = React__namespace.forwardRef(function SiHoneygain2({ title = "Honeygain", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
