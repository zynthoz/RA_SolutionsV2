...
const SiFoodpanda = React__namespace.forwardRef(function SiFoodpanda2({ title = "foodpanda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
