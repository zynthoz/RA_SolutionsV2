...
const SiYabai = React__namespace.forwardRef(function SiYabai2({ title = "yabai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
