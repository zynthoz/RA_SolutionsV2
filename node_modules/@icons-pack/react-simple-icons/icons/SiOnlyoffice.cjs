...
const SiOnlyoffice = React__namespace.forwardRef(function SiOnlyoffice2({ title = "ONLYOFFICE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
