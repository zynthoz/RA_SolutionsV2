...
const SiCivo = React__namespace.forwardRef(function SiCivo2({ title = "Civo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
