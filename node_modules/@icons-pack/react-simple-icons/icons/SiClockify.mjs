...
const SiClockify = React.forwardRef(function SiClockify2({ title = "Clockify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
