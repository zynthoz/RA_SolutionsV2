...
const SiNxp = React__namespace.forwardRef(function SiNxp2({ title = "NXP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
