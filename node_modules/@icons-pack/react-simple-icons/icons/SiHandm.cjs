...
const defaultColor = "#E50010";
const SiHandm = React__namespace.forwardRef(function SiHandm2({ title = "H&M", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
