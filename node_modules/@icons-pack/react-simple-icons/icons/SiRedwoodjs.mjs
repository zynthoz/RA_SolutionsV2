...
const SiRedwoodjs = React.forwardRef(function SiRedwoodjs2({ title = "RedwoodJS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
