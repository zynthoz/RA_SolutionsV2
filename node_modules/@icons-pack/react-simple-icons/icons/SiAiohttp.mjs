...
const SiAiohttp = React.forwardRef(function SiAiohttp2({ title = "AIOHTTP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
