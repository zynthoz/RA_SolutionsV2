...
const SiKagi = React__namespace.forwardRef(function SiKagi2({ title = "Kagi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
