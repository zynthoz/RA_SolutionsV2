...
const SiLatex = React.forwardRef(function SiLatex2({ title = "LaTeX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
