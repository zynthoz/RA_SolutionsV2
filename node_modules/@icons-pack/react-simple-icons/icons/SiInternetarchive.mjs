...
const SiInternetarchive = React.forwardRef(function SiInternetarchive2({ title = "Internet Archive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
