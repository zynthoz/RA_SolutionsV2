...
const SiCodementor = React.forwardRef(function SiCodementor2({ title = "Codementor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
