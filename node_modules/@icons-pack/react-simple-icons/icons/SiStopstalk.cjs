...
const SiStopstalk = React__namespace.forwardRef(function SiStopstalk2({ title = "StopStalk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
