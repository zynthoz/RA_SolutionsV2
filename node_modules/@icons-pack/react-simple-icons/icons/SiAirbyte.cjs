...
const defaultColor = "#615EFF";
const SiAirbyte = React__namespace.forwardRef(function SiAirbyte2({ title = "Airbyte", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
