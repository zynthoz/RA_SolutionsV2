...
const SiJet = React__namespace.forwardRef(function SiJet2({ title = "JET", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
