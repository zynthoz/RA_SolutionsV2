...
const SiTether = React.forwardRef(function SiTether2({ title = "Tether", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
