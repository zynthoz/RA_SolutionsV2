...
const SiDistrokid = React__namespace.forwardRef(function SiDistrokid2({ title = "Distrokid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
