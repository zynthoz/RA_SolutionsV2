...
const defaultColor = "#82612C";
const SiAudiobookshelf = React__namespace.forwardRef(function SiAudiobookshelf2({ title = "Audiobookshelf", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
