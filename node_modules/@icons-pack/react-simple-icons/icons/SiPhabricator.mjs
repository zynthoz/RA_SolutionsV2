...
const SiPhabricator = React.forwardRef(function SiPhabricator2({ title = "Phabricator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
