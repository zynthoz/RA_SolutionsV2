...
const SiVirgin = React.forwardRef(function SiVirgin2({ title = "Virgin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
