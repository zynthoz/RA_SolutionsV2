...
const SiBata = React.forwardRef(function SiBata2({ title = "Bata", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
