...
const SiAlgolia = React.forwardRef(function SiAlgolia2({ title = "Algolia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
