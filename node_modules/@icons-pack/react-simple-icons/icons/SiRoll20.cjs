...
const defaultColor = "#E10085";
const SiRoll20 = React__namespace.forwardRef(function SiRoll202({ title = "Roll20", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
