...
const defaultColor = "#0A0D14";
const SiShowwcase = React__namespace.forwardRef(function SiShowwcase2({ title = "Showwcase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
