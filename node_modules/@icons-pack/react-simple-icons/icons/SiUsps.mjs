...
const SiUsps = React.forwardRef(function SiUsps2({ title = "USPS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
