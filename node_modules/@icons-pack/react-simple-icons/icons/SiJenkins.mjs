...
const SiJenkins = React.forwardRef(function SiJenkins2({ title = "Jenkins", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
