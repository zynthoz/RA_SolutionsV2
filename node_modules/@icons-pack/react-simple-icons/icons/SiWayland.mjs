...
const SiWayland = React.forwardRef(function SiWayland2({ title = "Wayland", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
