...
const SiEdotleclerc = React.forwardRef(function SiEdotleclerc2({ title = "E.Leclerc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiEdotleclerc as default, defaultColor };
