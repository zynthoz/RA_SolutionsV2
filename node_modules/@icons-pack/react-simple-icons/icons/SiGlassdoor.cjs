...
const defaultColor = "#00A162";
const SiGlassdoor = React__namespace.forwardRef(function SiGlassdoor2({ title = "Glassdoor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
