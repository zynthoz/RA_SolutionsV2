...
const SiFreebsd = React.forwardRef(function SiFreebsd2({ title = "FreeBSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
