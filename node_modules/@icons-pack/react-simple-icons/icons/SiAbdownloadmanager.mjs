...
const SiAbdownloadmanager = React.forwardRef(function SiAbdownloadmanager2({ title = "AB Download Manager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
