...
const defaultColor = "#E21E29";
const SiBackblaze = React__namespace.forwardRef(function SiBackblaze2({ title = "Backblaze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
