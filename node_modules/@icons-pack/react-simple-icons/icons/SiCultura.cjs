...
const defaultColor = "#1D2C54";
const SiCultura = React__namespace.forwardRef(function SiCultura2({ title = "Cultura", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
