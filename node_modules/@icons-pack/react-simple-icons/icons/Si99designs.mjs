...
const Si99designs = React.forwardRef(function Si99designs2({ title = "99designs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
