...
const defaultColor = "#486AAE";
const SiTata = React__namespace.forwardRef(function SiTata2({ title = "Tata", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
