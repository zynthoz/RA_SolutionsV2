...
const SiGsma = React__namespace.forwardRef(function SiGsma2({ title = "GSMA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
