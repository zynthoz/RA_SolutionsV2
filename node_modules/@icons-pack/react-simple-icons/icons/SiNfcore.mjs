...
const SiNfcore = React.forwardRef(function SiNfcore2({ title = "nf-core", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
