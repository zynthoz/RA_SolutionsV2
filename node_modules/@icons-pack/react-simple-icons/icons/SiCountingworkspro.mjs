...
const SiCountingworkspro = React.forwardRef(function SiCountingworkspro2({ title = "CountingWorks PRO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
