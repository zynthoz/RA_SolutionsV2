...
const SiMumble = React__namespace.forwardRef(function SiMumble2({ title = "Mumble", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
