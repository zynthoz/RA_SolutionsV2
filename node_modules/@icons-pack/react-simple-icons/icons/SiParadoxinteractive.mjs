...
const SiParadoxinteractive = React.forwardRef(function SiParadoxinteractive2({ title = "Paradox Interactive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
