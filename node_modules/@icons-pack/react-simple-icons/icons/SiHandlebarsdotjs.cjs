...
const SiHandlebarsdotjs = React__namespace.forwardRef(function SiHandlebarsdotjs2({ title = "Handlebars.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
