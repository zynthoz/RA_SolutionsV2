...
const SiRenovate = React.forwardRef(function SiRenovate2({ title = "Renovate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
