...
const SiCrowdsource = React__namespace.forwardRef(function SiCrowdsource2({ title = "Crowdsource", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
