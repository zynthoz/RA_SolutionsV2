...
const SiReadthedocs = React__namespace.forwardRef(function SiReadthedocs2({ title = "Read the Docs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
