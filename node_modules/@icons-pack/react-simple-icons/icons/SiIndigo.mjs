...
const SiIndigo = React.forwardRef(function SiIndigo2({ title = "IndiGo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
