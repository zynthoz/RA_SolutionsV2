...
const SiUnstop = React.forwardRef(function SiUnstop2({ title = "Unstop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
