...
const defaultColor = "#00BC8E";
const SiWasmcloud = React__namespace.forwardRef(function SiWasmcloud2({ title = "wasmCloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
