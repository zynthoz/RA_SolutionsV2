...
const SiQuicklook = React__namespace.forwardRef(function SiQuicklook2({ title = "QuickLook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
