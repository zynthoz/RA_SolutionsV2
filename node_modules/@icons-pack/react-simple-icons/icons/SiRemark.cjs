...
const SiRemark = React__namespace.forwardRef(function SiRemark2({ title = "remark", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
