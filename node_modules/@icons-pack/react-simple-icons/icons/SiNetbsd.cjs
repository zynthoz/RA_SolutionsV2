...
const SiNetbsd = React__namespace.forwardRef(function SiNetbsd2({ title = "NetBSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
