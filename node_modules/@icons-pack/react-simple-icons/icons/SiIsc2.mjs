...
const SiIsc2 = React.forwardRef(function SiIsc22({ title = "ISC2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
