...
const SiQiwi = React.forwardRef(function SiQiwi2({ title = "QIWI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
