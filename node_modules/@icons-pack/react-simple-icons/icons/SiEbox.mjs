...
const SiEbox = React.forwardRef(function SiEbox2({ title = "EBOX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
