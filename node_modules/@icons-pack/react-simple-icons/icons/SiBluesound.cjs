...
const defaultColor = "#0F131E";
const SiBluesound = React__namespace.forwardRef(function SiBluesound2({ title = "Bluesound", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
