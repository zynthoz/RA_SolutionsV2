...
const SiPremierleague = React__namespace.forwardRef(function SiPremierleague2({ title = "Premier League", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
