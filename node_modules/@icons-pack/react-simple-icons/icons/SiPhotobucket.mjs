...
const SiPhotobucket = React.forwardRef(function SiPhotobucket2({ title = "Photobucket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
