...
const SiVikunja = React__namespace.forwardRef(function SiVikunja2({ title = "Vikunja", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
