...
const SiApplearcade = React.forwardRef(function SiApplearcade2({ title = "Apple Arcade", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
