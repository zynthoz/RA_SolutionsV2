...
const SiOmadacloud = React.forwardRef(function SiOmadacloud2({ title = "Omada Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
