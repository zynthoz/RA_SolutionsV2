...
const SiBugcrowd = React.forwardRef(function SiBugcrowd2({ title = "Bugcrowd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
