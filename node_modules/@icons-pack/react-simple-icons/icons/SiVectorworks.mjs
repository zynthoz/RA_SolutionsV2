...
const SiVectorworks = React.forwardRef(function SiVectorworks2({ title = "Vectorworks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
