...
const SiChartdotjs = React__namespace.forwardRef(function SiChartdotjs2({ title = "Chart.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
