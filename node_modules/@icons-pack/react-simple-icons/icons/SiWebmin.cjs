...
const SiWebmin = React__namespace.forwardRef(function SiWebmin2({ title = "Webmin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
