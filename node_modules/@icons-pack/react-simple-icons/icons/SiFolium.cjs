...
const SiFolium = React__namespace.forwardRef(function SiFolium2({ title = "Folium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
