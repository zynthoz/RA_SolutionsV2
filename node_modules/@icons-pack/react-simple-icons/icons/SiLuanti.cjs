...
const SiLuanti = React__namespace.forwardRef(function SiLuanti2({ title = "Luanti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
