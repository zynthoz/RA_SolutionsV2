...
const SiNasa = React.forwardRef(function SiNasa2({ title = "NASA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
