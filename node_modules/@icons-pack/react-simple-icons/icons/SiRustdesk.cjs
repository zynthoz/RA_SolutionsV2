...
const SiRustdesk = React__namespace.forwardRef(function SiRustdesk2({ title = "RustDesk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
