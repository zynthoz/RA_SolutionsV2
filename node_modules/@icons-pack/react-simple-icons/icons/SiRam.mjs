...
const SiRam = React.forwardRef(function SiRam2({ title = "Ram", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
