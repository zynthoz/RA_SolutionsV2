...
const defaultColor = "#19A974";
const SiSemaphoreci = React.forwardRef(function SiSemaphoreci2({ title = "Semaphore CI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
