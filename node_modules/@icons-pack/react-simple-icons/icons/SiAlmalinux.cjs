...
const SiAlmalinux = React__namespace.forwardRef(function SiAlmalinux2({ title = "AlmaLinux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
