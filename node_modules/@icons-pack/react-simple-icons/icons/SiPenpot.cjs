...
const SiPenpot = React__namespace.forwardRef(function SiPenpot2({ title = "Penpot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
