...
const SiMariadb = React.forwardRef(function SiMariadb2({ title = "MariaDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
