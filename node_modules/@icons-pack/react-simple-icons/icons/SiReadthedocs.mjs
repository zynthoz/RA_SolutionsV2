...
const SiReadthedocs = React.forwardRef(function SiReadthedocs2({ title = "Read the Docs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
