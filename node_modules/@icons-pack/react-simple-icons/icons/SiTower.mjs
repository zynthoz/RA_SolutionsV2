...
const SiTower = React.forwardRef(function SiTower2({ title = "Tower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
