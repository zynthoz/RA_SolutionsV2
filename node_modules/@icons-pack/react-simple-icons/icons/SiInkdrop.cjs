...
const SiInkdrop = React__namespace.forwardRef(function SiInkdrop2({ title = "Inkdrop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
