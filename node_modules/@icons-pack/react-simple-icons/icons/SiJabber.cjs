...
const SiJabber = React__namespace.forwardRef(function SiJabber2({ title = "Jabber", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
