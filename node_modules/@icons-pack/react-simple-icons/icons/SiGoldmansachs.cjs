...
const defaultColor = "#7399C6";
const SiGoldmansachs = React__namespace.forwardRef(function SiGoldmansachs2({ title = "Goldman Sachs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
