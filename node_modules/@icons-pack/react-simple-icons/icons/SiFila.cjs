...
const defaultColor = "#002D62";
const SiFila = React__namespace.forwardRef(function SiFila2({ title = "Fila", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
