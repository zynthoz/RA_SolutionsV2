...
const SiSap = React.forwardRef(function SiSap2({ title = "SAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
