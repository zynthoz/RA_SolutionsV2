...
const SiKalilinux = React.forwardRef(function SiKalilinux2({ title = "Kali Linux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
