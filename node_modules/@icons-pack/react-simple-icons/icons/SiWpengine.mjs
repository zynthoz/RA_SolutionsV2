...
const SiWpengine = React.forwardRef(function SiWpengine2({ title = "WP Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
