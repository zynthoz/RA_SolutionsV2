...
const defaultColor = "#00DD00";
const SiBorgbackup = React__namespace.forwardRef(function SiBorgbackup2({ title = "BorgBackup", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
