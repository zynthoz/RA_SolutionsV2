...
const defaultColor = "#FFC62E";
const SiKununu = React__namespace.forwardRef(function SiKununu2({ title = "Kununu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
