...
const defaultColor = "#DC0032";
const SiDpd = React__namespace.forwardRef(function SiDpd2({ title = "DPD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
