...
const defaultColor = "#FE5000";
const SiBmcsoftware = React__namespace.forwardRef(function SiBmcsoftware2({ title = "BMC Software", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
