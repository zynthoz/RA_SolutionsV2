...
const SiFujifilm = React.forwardRef(function SiFujifilm2({ title = "Fujifilm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
