...
const defaultColor = "#0062B0";
const SiPaddlepaddle = React__namespace.forwardRef(function SiPaddlepaddle2({ title = "PaddlePaddle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
