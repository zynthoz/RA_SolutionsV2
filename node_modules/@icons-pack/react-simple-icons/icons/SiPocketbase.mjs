...
const SiPocketbase = React.forwardRef(function SiPocketbase2({ title = "PocketBase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
