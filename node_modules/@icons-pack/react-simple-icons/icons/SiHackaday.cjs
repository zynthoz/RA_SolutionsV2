...
const SiHackaday = React__namespace.forwardRef(function SiHackaday2({ title = "Hackaday", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
