...
const SiLeroymerlin = React.forwardRef(function SiLeroymerlin2({ title = "Leroy Merlin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
