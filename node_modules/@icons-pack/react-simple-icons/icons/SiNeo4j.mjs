...
const defaultColor = "#4581C3";
const SiNeo4j = React.forwardRef(function SiNeo4j2({ title = "Neo4j", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
