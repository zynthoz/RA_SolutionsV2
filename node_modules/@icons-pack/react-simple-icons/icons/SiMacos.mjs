...
const SiMacos = React.forwardRef(function SiMacos2({ title = "macOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
