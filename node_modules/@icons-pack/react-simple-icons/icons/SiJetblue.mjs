...
const defaultColor = "#001E59";
const SiJetblue = React.forwardRef(function SiJetblue2({ title = "JetBlue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
