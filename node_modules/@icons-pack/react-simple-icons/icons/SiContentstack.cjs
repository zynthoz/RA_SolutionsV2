...
const SiContentstack = React__namespace.forwardRef(function SiContentstack2({ title = "Contentstack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
