...
const SiUnitednations = React.forwardRef(function SiUnitednations2({ title = "United Nations", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
