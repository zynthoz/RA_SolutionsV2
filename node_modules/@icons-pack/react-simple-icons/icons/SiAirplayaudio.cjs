...
const SiAirplayaudio = React__namespace.forwardRef(function SiAirplayaudio2({ title = "AirPlay Audio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
