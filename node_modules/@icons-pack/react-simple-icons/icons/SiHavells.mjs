...
const SiHavells = React.forwardRef(function SiHavells2({ title = "Havells", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
