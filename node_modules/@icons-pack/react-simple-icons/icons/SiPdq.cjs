...
const SiPdq = React__namespace.forwardRef(function SiPdq2({ title = "PDQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
