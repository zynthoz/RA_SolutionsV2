...
const SiUkca = React__namespace.forwardRef(function SiUkca2({ title = "UKCA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
