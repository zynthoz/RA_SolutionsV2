...
const SiStimulus = React__namespace.forwardRef(function SiStimulus2({ title = "Stimulus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
