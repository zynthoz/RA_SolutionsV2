...
const SiClockify = React__namespace.forwardRef(function SiClockify2({ title = "Clockify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
