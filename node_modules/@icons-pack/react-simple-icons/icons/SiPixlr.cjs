...
const SiPixlr = React__namespace.forwardRef(function SiPixlr2({ title = "Pixlr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
