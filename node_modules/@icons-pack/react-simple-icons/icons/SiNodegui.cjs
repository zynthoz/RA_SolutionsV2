...
const SiNodegui = React__namespace.forwardRef(function SiNodegui2({ title = "NodeGui", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
