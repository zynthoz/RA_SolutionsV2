...
const defaultColor = "#592EC1";
const SiBit = React__namespace.forwardRef(function SiBit2({ title = "Bit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
