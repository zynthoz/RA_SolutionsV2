...
const defaultColor = "#4A5F88";
const SiPhabricator = React__namespace.forwardRef(function SiPhabricator2({ title = "Phabricator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
