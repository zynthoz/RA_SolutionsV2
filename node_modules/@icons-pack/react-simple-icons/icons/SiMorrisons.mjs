...
const SiMorrisons = React.forwardRef(function SiMorrisons2({ title = "Morrisons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
