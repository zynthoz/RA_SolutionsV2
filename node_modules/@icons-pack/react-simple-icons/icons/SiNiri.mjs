...
const SiNiri = React.forwardRef(function SiNiri2({ title = "niri", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
