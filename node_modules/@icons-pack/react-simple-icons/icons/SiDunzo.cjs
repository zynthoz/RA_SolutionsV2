...
const defaultColor = "#00D290";
const SiDunzo = React__namespace.forwardRef(function SiDunzo2({ title = "Dunzo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
