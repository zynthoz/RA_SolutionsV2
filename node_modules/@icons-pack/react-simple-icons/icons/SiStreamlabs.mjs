...
const SiStreamlabs = React.forwardRef(function SiStreamlabs2({ title = "Streamlabs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
