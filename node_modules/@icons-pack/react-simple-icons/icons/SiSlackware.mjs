...
const SiSlackware = React.forwardRef(function SiSlackware2({ title = "Slackware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
