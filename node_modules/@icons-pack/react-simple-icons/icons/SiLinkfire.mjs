...
const SiLinkfire = React.forwardRef(function SiLinkfire2({ title = "Linkfire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
