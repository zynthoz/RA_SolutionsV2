...
const SiVitepress = React.forwardRef(function SiVitepress2({ title = "VitePress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
