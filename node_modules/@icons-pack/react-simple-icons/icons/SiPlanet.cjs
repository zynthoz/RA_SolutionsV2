...
const SiPlanet = React__namespace.forwardRef(function SiPlanet2({ title = "Planet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
