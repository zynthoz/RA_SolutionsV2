...
const defaultColor = "#FFE100";
const SiNikon = React__namespace.forwardRef(function SiNikon2({ title = "Nikon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
