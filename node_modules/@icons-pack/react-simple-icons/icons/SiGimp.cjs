...
const defaultColor = "#8C8073";
const SiGimp = React__namespace.forwardRef(function SiGimp2({ title = "GIMP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
