...
const SiImdb = React.forwardRef(function SiImdb2({ title = "IMDb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
