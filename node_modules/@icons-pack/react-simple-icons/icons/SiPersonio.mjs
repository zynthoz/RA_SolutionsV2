...
const SiPersonio = React.forwardRef(function SiPersonio2({ title = "Personio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
