...
const defaultColor = "#FF7100";
const SiNbb = React__namespace.forwardRef(function SiNbb2({ title = "NBB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
