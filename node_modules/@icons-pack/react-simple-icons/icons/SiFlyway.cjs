...
const defaultColor = "#CC0200";
const SiFlyway = React__namespace.forwardRef(function SiFlyway2({ title = "Flyway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
