...
const SiOctopusdeploy = React.forwardRef(function SiOctopusdeploy2({ title = "Octopus Deploy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
