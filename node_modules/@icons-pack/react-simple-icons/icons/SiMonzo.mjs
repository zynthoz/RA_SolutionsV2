...
const defaultColor = "#14233C";
const SiMonzo = React.forwardRef(function SiMonzo2({ title = "Monzo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
