...
const SiTelenor = React.forwardRef(function SiTelenor2({ title = "Telenor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
