...
const defaultColor = "#0066B3";
const SiFirst = React.forwardRef(function SiFirst2({ title = "FIRST", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
