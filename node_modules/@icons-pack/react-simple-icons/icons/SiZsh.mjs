...
const defaultColor = "#F15A24";
const SiZsh = React.forwardRef(function SiZsh2({ title = "Zsh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiZsh as default, defaultColor };
