...
const SiSonarqubecloud = React.forwardRef(function SiSonarqubecloud2({ title = "SonarQube Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
