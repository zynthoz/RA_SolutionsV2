...
const defaultColor = "#121118";
const SiBigcommerce = React__namespace.forwardRef(function SiBigcommerce2({ title = "BigCommerce", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
