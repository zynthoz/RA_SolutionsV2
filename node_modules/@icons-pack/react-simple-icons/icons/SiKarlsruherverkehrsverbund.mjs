...
const SiKarlsruherverkehrsverbund = React.forwardRef(function SiKarlsruherverkehrsverbund2({ title = "Karlsruher Verkehrsverbund", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
