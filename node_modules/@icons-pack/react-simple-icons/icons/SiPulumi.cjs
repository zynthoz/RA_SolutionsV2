...
const defaultColor = "#8A3391";
const SiPulumi = React__namespace.forwardRef(function SiPulumi2({ title = "Pulumi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
