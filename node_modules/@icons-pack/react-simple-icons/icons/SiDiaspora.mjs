...
const SiDiaspora = React.forwardRef(function SiDiaspora2({ title = "Diaspora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
