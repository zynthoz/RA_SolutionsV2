...
const defaultColor = "#29B5E8";
const SiSnowflake = React__namespace.forwardRef(function SiSnowflake2({ title = "Snowflake", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
