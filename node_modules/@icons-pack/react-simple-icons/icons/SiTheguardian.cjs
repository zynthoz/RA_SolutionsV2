...
const defaultColor = "#052962";
const SiTheguardian = React__namespace.forwardRef(function SiTheguardian2({ title = "The Guardian", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
