...
const SiEducative = React.forwardRef(function SiEducative2({ title = "Educative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
