...
const SiSonos = React.forwardRef(function SiSonos2({ title = "Sonos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
