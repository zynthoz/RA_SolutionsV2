...
const defaultColor = "#002244";
const SiUnitedairlines = React__namespace.forwardRef(function SiUnitedairlines2({ title = "United Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
