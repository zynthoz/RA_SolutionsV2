...
const defaultColor = "#D6001C";
const SiCraftsman = React__namespace.forwardRef(function SiCraftsman2({ title = "Craftsman", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
