...
const SiSilverairways = React.forwardRef(function SiSilverairways2({ title = "Silver Airways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
