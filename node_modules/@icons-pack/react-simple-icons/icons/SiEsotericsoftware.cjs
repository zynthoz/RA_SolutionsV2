...
const defaultColor = "#3FA9F5";
const SiEsotericsoftware = React__namespace.forwardRef(function SiEsotericsoftware2({ title = "Esoteric Software", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
