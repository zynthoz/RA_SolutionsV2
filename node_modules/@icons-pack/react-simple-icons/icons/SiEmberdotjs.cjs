...
const SiEmberdotjs = React__namespace.forwardRef(function SiEmberdotjs2({ title = "Ember.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
