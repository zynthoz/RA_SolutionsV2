...
const defaultColor = "#E23744";
const SiZomato = React__namespace.forwardRef(function SiZomato2({ title = "Zomato", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
