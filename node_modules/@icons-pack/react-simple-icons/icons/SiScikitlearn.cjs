...
const SiScikitlearn = React__namespace.forwardRef(function SiScikitlearn2({ title = "scikit-learn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
