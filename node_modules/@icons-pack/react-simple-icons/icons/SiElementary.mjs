...
const SiElementary = React.forwardRef(function SiElementary2({ title = "elementary", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
