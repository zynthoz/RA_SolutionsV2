...
const defaultColor = "#3499CD";
const SiAutomattic = React__namespace.forwardRef(function SiAutomattic2({ title = "Automattic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
