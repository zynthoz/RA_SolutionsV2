...
const SiCredly = React.forwardRef(function SiCredly2({ title = "Credly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
