...
const defaultColor = "#00005F";
const SiAldisud = React__namespace.forwardRef(function SiAldisud2({ title = "Aldi Süd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
