...
const SiAftership = React.forwardRef(function SiAftership2({ title = "AfterShip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
