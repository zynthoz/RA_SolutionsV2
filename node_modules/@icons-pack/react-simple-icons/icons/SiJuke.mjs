...
const defaultColor = "#6CD74A";
const SiJuke = React.forwardRef(function SiJuke2({ title = "JUKE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
