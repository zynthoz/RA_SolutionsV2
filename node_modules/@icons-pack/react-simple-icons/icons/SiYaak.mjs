...
const SiYaak = React.forwardRef(function SiYaak2({ title = "Yaak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
