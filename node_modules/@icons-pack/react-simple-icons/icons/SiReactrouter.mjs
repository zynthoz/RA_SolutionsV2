...
const SiReactrouter = React.forwardRef(function SiReactrouter2({ title = "React Router", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiReactrouter as default, defaultColor };
