...
const SiWyze = React__namespace.forwardRef(function SiWyze2({ title = "Wyze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
