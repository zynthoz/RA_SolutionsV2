...
const SiOpencage = React.forwardRef(function SiOpencage2({ title = "OpenCage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
