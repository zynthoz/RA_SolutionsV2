...
const SiIveco = React__namespace.forwardRef(function SiIveco2({ title = "IVECO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
