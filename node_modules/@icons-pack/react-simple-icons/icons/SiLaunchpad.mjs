...
const SiLaunchpad = React.forwardRef(function SiLaunchpad2({ title = "Launchpad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
