...
const SiSouthwestairlines = React.forwardRef(function SiSouthwestairlines2({ title = "Southwest Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
