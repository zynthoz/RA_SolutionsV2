...
const defaultColor = "#C70D2C";
const SiAdblockplus = React__namespace.forwardRef(function SiAdblockplus2({ title = "Adblock Plus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
