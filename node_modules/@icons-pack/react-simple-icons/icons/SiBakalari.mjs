...
const SiBakalari = React.forwardRef(function SiBakalari2({ title = "Bakaláři", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
