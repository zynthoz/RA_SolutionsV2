...
const SiFusionauth = React__namespace.forwardRef(function SiFusionauth2({ title = "FusionAuth", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
