...
const SiCairometro = React.forwardRef(function SiCairometro2({ title = "Cairo Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiCairometro as default, defaultColor };
