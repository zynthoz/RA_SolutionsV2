...
const defaultColor = "#3F4551";
const SiSemver = React__namespace.forwardRef(function SiSemver2({ title = "SemVer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
