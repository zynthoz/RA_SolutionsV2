...
const defaultColor = "#5586A4";
const SiOpengl = React__namespace.forwardRef(function SiOpengl2({ title = "OpenGL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
