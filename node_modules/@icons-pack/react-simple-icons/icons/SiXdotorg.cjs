...
const defaultColor = "#F28834";
const SiXdotorg = React__namespace.forwardRef(function SiXdotorg2({ title = "X.Org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
