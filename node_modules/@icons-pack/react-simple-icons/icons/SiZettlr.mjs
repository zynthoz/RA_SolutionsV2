...
const SiZettlr = React.forwardRef(function SiZettlr2({ title = "Zettlr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
