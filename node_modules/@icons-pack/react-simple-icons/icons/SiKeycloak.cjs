...
const SiKeycloak = React__namespace.forwardRef(function SiKeycloak2({ title = "Keycloak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
