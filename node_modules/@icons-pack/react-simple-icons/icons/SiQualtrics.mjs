...
const SiQualtrics = React.forwardRef(function SiQualtrics2({ title = "Qualtrics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
