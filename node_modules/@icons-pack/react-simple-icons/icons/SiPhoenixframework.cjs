...
const defaultColor = "#FD4F00";
const SiPhoenixframework = React__namespace.forwardRef(function SiPhoenixframework2({ title = "Phoenix Framework", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
