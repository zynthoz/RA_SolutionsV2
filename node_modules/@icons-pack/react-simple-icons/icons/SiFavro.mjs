...
const SiFavro = React.forwardRef(function SiFavro2({ title = "Favro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
