...
const SiBetterstack = React__namespace.forwardRef(function SiBetterstack2({ title = "Better Stack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
