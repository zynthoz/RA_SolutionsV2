...
const SiRoamresearch = React.forwardRef(function SiRoamresearch2({ title = "Roam Research", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
