...
const SiAppveyor = React__namespace.forwardRef(function SiAppveyor2({ title = "AppVeyor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
