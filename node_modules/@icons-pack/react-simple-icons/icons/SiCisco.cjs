...
const defaultColor = "#1BA0D7";
const SiCisco = React__namespace.forwardRef(function SiCisco2({ title = "Cisco", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
