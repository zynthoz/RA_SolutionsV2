...
const SiActix = React.forwardRef(function SiActix2({ title = "Actix", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
