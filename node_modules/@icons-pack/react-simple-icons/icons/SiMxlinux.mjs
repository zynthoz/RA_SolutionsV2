...
const SiMxlinux = React.forwardRef(function SiMxlinux2({ title = "MX Linux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
