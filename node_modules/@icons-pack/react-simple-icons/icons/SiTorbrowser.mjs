...
const SiTorbrowser = React.forwardRef(function SiTorbrowser2({ title = "Tor Browser", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
