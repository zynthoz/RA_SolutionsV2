...
const SiPrimeng = React__namespace.forwardRef(function SiPrimeng2({ title = "PrimeNG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
