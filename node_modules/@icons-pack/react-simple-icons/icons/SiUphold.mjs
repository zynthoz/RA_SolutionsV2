...
const SiUphold = React.forwardRef(function SiUphold2({ title = "Uphold", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
