...
const SiDoctrine = React.forwardRef(function SiDoctrine2({ title = "Doctrine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
