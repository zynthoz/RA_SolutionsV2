...
const SiMg = React.forwardRef(function SiMg2({ title = "MG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
