...
const SiMautic = React.forwardRef(function SiMautic2({ title = "Mautic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
