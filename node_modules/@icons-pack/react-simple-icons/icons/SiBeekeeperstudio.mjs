...
const SiBeekeeperstudio = React.forwardRef(function SiBeekeeperstudio2({ title = "Beekeeper Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
