...
const SiDisroot = React__namespace.forwardRef(function SiDisroot2({ title = "Disroot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
