...
const SiOreilly = React__namespace.forwardRef(function SiOreilly2({ title = "OReilly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
