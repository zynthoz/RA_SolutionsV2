...
const defaultColor = "#DA3B8A";
const SiLinuxserver = React__namespace.forwardRef(function SiLinuxserver2({ title = "LinuxServer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
