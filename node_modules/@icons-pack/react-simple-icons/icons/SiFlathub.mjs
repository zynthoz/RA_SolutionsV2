...
const SiFlathub = React.forwardRef(function SiFlathub2({ title = "Flathub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
