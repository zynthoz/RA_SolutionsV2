...
const defaultColor = "#F79A10";
const SiSourceengine = React__namespace.forwardRef(function SiSourceengine2({ title = "Source Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
