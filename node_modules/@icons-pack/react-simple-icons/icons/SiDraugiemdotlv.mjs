...
const SiDraugiemdotlv = React.forwardRef(function SiDraugiemdotlv2({ title = "Draugiem.lv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
