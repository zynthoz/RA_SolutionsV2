...
const defaultColor = "#147EFB";
const SiXcode = React.forwardRef(function SiXcode2({ title = "Xcode", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
