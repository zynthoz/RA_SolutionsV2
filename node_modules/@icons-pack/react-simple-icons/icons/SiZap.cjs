...
const defaultColor = "#00549E";
const SiZap = React__namespace.forwardRef(function SiZap2({ title = "ZAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
