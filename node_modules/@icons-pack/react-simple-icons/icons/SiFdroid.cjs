...
const SiFdroid = React__namespace.forwardRef(function SiFdroid2({ title = "F-Droid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
