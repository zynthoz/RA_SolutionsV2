...
const SiVowpalwabbit = React.forwardRef(function SiVowpalwabbit2({ title = "Vowpal Wabbit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
