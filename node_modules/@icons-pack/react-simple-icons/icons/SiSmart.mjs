...
const SiSmart = React.forwardRef(function SiSmart2({ title = "smart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
