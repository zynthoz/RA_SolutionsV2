...
const defaultColor = "#B10000";
const SiShowtime = React__namespace.forwardRef(function SiShowtime2({ title = "Showtime", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
