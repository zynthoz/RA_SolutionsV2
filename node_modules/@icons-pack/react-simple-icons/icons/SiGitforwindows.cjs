...
const SiGitforwindows = React__namespace.forwardRef(function SiGitforwindows2({ title = "Git for Windows", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
