...
const defaultColor = "#3551F3";
const SiGhostty = React__namespace.forwardRef(function SiGhostty2({ title = "Ghostty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
