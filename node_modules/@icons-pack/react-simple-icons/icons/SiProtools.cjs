...
const defaultColor = "#7ACB10";
const SiProtools = React__namespace.forwardRef(function SiProtools2({ title = "Pro Tools", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
