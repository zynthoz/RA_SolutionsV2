...
const SiUps = React.forwardRef(function SiUps2({ title = "UPS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
