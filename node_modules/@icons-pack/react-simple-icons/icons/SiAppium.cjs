...
const defaultColor = "#EE376D";
const SiAppium = React__namespace.forwardRef(function SiAppium2({ title = "Appium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
