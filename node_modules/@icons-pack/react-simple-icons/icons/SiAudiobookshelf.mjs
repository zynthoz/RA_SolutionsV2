...
const SiAudiobookshelf = React.forwardRef(function SiAudiobookshelf2({ title = "Audiobookshelf", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
