...
const SiKnowledgebase = React.forwardRef(function SiKnowledgebase2({ title = "KnowledgeBase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
