...
const SiPosthog = React.forwardRef(function SiPosthog2({ title = "PostHog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
