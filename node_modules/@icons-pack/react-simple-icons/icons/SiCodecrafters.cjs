...
const defaultColor = "#171920";
const SiCodecrafters = React__namespace.forwardRef(function SiCodecrafters2({ title = "CodeCrafters", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
