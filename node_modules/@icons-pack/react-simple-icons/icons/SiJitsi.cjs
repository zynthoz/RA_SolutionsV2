...
const SiJitsi = React__namespace.forwardRef(function SiJitsi2({ title = "Jitsi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
