...
const defaultColor = "#85C8C8";
const SiLogseq = React.forwardRef(function SiLogseq2({ title = "Logseq", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiLogseq as default, defaultColor };
