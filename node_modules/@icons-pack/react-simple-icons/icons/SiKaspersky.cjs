...
const defaultColor = "#006D5C";
const SiKaspersky = React__namespace.forwardRef(function SiKaspersky2({ title = "Kaspersky", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
