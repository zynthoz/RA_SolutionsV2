...
const SiOptimism = React.forwardRef(function SiOptimism2({ title = "Optimism", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
