...
const SiHivemq = React__namespace.forwardRef(function SiHivemq2({ title = "HiveMQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
