...
const SiUbuntumate = React__namespace.forwardRef(function SiUbuntumate2({ title = "Ubuntu MATE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
