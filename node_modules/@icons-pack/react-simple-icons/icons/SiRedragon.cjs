...
const SiRedragon = React__namespace.forwardRef(function SiRedragon2({ title = "Redragon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
