...
const SiWagmi = React__namespace.forwardRef(function SiWagmi2({ title = "Wagmi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
