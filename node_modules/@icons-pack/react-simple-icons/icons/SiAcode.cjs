...
const SiAcode = React__namespace.forwardRef(function SiAcode2({ title = "Acode", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
