...
const defaultColor = "#EF7878";
const SiPorkbun = React__namespace.forwardRef(function SiPorkbun2({ title = "Porkbun", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
