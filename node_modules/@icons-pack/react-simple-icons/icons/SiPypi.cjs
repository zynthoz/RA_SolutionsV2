...
const SiPypi = React__namespace.forwardRef(function SiPypi2({ title = "PyPI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
