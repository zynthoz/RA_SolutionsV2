...
const defaultColor = "#FF4747";
const SiAliexpress = React__namespace.forwardRef(function SiAliexpress2({ title = "AliExpress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
