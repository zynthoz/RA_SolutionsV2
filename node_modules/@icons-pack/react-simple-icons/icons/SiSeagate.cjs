...
const defaultColor = "#6EBE49";
const SiSeagate = React__namespace.forwardRef(function SiSeagate2({ title = "Seagate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
