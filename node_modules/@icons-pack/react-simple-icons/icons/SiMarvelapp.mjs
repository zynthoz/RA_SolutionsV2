...
const SiMarvelapp = React.forwardRef(function SiMarvelapp2({ title = "MarvelApp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
