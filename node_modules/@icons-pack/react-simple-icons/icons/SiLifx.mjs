...
const SiLifx = React.forwardRef(function SiLifx2({ title = "LIFX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
