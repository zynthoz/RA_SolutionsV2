...
const defaultColor = "#29ABE2";
const SiWebcomponentsdotorg = React.forwardRef(function SiWebcomponentsdotorg2({ title = "webcomponents.org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiWebcomponentsdotorg as default, defaultColor };
