...
const defaultColor = "#00558C";
const SiKofax = React__namespace.forwardRef(function SiKofax2({ title = "Kofax", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
