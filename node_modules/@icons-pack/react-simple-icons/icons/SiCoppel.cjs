...
const defaultColor = "#0266AE";
const SiCoppel = React__namespace.forwardRef(function SiCoppel2({ title = "Coppel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
