...
const SiWetransfer = React__namespace.forwardRef(function SiWetransfer2({ title = "WeTransfer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
