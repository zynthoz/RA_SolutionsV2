...
const SiMaserati = React.forwardRef(function SiMaserati2({ title = "Maserati", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
