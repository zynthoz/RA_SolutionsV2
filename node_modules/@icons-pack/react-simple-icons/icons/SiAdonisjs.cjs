...
const SiAdonisjs = React__namespace.forwardRef(function SiAdonisjs2({ title = "AdonisJS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
