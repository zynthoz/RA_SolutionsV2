...
const defaultColor = "#69D3A7";
const SiCypress = React__namespace.forwardRef(function SiCypress2({ title = "Cypress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
