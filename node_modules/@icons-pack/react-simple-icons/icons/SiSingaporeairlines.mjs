...
const SiSingaporeairlines = React.forwardRef(function SiSingaporeairlines2({ title = "Singapore Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
