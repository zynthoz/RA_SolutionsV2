...
const SiMclaren = React__namespace.forwardRef(function SiMclaren2({ title = "McLaren", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
