...
const SiVirginatlantic = React.forwardRef(function SiVirginatlantic2({ title = "Virgin Atlantic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
