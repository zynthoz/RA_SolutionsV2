...
const SiActivision = React__namespace.forwardRef(function SiActivision2({ title = "Activision", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
