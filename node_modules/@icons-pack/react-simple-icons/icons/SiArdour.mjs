...
const SiArdour = React.forwardRef(function SiArdour2({ title = "Ardour", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
