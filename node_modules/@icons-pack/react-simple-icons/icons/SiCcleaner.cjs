...
const defaultColor = "#CB2D29";
const SiCcleaner = React__namespace.forwardRef(function SiCcleaner2({ title = "CCleaner", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
