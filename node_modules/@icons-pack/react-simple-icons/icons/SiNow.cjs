...
const defaultColor = "#001211";
const SiNow = React__namespace.forwardRef(function SiNow2({ title = "NOW", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
