...
const SiExpressdotcom = React__namespace.forwardRef(function SiExpressdotcom2({ title = "Express.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
