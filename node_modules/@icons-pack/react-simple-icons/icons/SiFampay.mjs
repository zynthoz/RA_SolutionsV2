...
const SiFampay = React.forwardRef(function SiFampay2({ title = "FamPay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
