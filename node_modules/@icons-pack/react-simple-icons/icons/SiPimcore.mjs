...
const SiPimcore = React.forwardRef(function SiPimcore2({ title = "Pimcore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
