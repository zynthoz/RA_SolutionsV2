...
const SiOctave = React.forwardRef(function SiOctave2({ title = "Octave", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
