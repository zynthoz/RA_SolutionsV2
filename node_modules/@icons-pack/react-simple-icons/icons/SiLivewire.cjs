...
const SiLivewire = React__namespace.forwardRef(function SiLivewire2({ title = "Livewire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
