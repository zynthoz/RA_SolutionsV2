...
const SiDts = React.forwardRef(function SiDts2({ title = "DTS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
