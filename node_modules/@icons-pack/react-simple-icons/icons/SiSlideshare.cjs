...
const defaultColor = "#008ED2";
const SiSlideshare = React__namespace.forwardRef(function SiSlideshare2({ title = "SlideShare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
