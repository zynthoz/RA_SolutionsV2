...
const SiAutozone = React.forwardRef(function SiAutozone2({ title = "AutoZone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
