...
const SiBigbasket = React.forwardRef(function SiBigbasket2({ title = "bigbasket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
