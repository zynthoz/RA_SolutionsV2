...
const SiDlib = React__namespace.forwardRef(function SiDlib2({ title = "Dlib", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
