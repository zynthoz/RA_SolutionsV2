...
const SiHackerearth = React__namespace.forwardRef(function SiHackerearth2({ title = "HackerEarth", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
