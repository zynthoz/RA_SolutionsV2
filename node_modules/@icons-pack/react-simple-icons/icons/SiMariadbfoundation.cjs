...
const SiMariadbfoundation = React__namespace.forwardRef(function SiMariadbfoundation2({ title = "MariaDB Foundation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
