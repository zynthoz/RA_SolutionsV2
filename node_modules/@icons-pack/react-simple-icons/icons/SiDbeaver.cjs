...
const defaultColor = "#382923";
const SiDbeaver = React__namespace.forwardRef(function SiDbeaver2({ title = "DBeaver", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
