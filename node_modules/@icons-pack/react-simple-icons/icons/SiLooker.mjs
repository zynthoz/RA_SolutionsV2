...
const SiLooker = React.forwardRef(function SiLooker2({ title = "Looker", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
