...
const SiOptuna = React.forwardRef(function SiOptuna2({ title = "Optuna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
