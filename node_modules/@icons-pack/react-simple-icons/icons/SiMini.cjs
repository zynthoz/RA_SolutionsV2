...
const SiMini = React__namespace.forwardRef(function SiMini2({ title = "Mini", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
