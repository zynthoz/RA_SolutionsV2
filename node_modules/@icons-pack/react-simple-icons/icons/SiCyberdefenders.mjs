...
const SiCyberdefenders = React.forwardRef(function SiCyberdefenders2({ title = "CyberDefenders", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
