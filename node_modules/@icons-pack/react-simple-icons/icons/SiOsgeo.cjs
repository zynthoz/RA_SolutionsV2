...
const SiOsgeo = React__namespace.forwardRef(function SiOsgeo2({ title = "OSGeo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
