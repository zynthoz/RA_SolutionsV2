...
const SiAppsmith = React.forwardRef(function SiAppsmith2({ title = "Appsmith", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
