...
const defaultColor = "#FFC738";
const SiFillout = React__namespace.forwardRef(function SiFillout2({ title = "Fillout", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
