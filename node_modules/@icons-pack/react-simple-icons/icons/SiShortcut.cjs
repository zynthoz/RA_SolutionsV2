...
const SiShortcut = React__namespace.forwardRef(function SiShortcut2({ title = "Shortcut", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
