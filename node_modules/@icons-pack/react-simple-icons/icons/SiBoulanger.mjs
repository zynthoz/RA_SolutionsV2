...
const SiBoulanger = React.forwardRef(function SiBoulanger2({ title = "boulanger", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
