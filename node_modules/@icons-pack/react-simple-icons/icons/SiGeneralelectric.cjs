...
const defaultColor = "#0870D8";
const SiGeneralelectric = React__namespace.forwardRef(function SiGeneralelectric2({ title = "General Electric", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
