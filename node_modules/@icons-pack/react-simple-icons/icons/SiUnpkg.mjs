...
const SiUnpkg = React.forwardRef(function SiUnpkg2({ title = "unpkg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
