...
const SiRelay = React__namespace.forwardRef(function SiRelay2({ title = "Relay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
