...
const defaultColor = "#000099";
const SiSumologic = React__namespace.forwardRef(function SiSumologic2({ title = "Sumo Logic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
