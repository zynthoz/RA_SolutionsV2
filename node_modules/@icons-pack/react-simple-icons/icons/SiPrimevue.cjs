...
const SiPrimevue = React__namespace.forwardRef(function SiPrimevue2({ title = "PrimeVue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
