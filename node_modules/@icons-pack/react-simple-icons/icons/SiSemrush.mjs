...
const defaultColor = "#FF642D";
const SiSemrush = React.forwardRef(function SiSemrush2({ title = "Semrush", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
