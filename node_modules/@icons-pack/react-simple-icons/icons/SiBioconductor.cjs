...
const SiBioconductor = React__namespace.forwardRef(function SiBioconductor2({ title = "Bioconductor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
