...
const defaultColor = "#55C500";
const SiQiita = React__namespace.forwardRef(function SiQiita2({ title = "Qiita", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
