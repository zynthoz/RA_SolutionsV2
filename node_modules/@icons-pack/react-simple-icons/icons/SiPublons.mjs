...
const SiPublons = React.forwardRef(function SiPublons2({ title = "Publons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
