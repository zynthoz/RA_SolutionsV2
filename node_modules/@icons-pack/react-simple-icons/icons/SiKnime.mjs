...
const SiKnime = React.forwardRef(function SiKnime2({ title = "KNIME", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
