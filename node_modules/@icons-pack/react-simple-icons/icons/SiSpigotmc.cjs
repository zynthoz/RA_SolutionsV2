...
const SiSpigotmc = React__namespace.forwardRef(function SiSpigotmc2({ title = "SpigotMC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
