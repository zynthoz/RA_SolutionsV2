...
const SiPinescript = React__namespace.forwardRef(function SiPinescript2({ title = "Pine Script", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
