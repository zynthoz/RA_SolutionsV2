...
const SiEmirates = React__namespace.forwardRef(function SiEmirates2({ title = "Emirates", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
