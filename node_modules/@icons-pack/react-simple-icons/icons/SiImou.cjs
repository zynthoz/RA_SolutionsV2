...
const defaultColor = "#E89313";
const SiImou = React__namespace.forwardRef(function SiImou2({ title = "Imou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
