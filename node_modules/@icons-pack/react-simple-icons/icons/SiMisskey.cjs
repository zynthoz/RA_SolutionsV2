...
const SiMisskey = React__namespace.forwardRef(function SiMisskey2({ title = "Misskey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
