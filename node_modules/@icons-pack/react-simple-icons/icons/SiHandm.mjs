...
const SiHandm = React.forwardRef(function SiHandm2({ title = "H&M", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
