...
const SiIndiansuperleague = React.forwardRef(function SiIndiansuperleague2({ title = "Indian Super League", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
