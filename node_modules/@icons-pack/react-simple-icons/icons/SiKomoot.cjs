...
const SiKomoot = React__namespace.forwardRef(function SiKomoot2({ title = "Komoot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
