...
const SiAuthelia = React.forwardRef(function SiAuthelia2({ title = "Authelia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
