...
const defaultColor = "#3C72B9";
const SiCloud66 = React__namespace.forwardRef(function SiCloud662({ title = "Cloud 66", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
