...
const SiWails = React.forwardRef(function SiWails2({ title = "Wails", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
