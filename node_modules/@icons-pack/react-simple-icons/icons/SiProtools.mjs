...
const SiProtools = React.forwardRef(function SiProtools2({ title = "Pro Tools", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
