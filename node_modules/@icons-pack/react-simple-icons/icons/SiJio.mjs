...
const SiJio = React.forwardRef(function SiJio2({ title = "Jio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
