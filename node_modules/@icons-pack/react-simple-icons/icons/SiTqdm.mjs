...
const SiTqdm = React.forwardRef(function SiTqdm2({ title = "tqdm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
