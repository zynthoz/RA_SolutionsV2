...
const SiWebrtc = React__namespace.forwardRef(function SiWebrtc2({ title = "WebRTC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
