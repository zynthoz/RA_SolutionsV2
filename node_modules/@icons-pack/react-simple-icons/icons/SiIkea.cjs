...
const SiIkea = React__namespace.forwardRef(function SiIkea2({ title = "IKEA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
