...
const defaultColor = "#1D365D";
const SiLess = React__namespace.forwardRef(function SiLess2({ title = "Less", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
