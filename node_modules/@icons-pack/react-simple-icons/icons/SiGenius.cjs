...
const defaultColor = "#FFFF64";
const SiGenius = React__namespace.forwardRef(function SiGenius2({ title = "Genius", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
