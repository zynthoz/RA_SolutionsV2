...
const SiWwe = React__namespace.forwardRef(function SiWwe2({ title = "WWE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
