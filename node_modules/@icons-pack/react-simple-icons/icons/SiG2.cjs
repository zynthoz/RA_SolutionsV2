...
const defaultColor = "#FF492C";
const SiG2 = React__namespace.forwardRef(function SiG22({ title = "G2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
