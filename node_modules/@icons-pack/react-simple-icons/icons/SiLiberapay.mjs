...
const SiLiberapay = React.forwardRef(function SiLiberapay2({ title = "Liberapay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
