...
const defaultColor = "#B03931";
const SiD = React__namespace.forwardRef(function SiD2({ title = "D", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
