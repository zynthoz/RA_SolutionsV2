...
const SiYii = React__namespace.forwardRef(function SiYii2({ title = "Yii", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
