...
const SiCytoscapedotjs = React.forwardRef(function SiCytoscapedotjs2({ title = "Cytoscape.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
