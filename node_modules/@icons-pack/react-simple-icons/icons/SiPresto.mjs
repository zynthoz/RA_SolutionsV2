...
const defaultColor = "#5890FF";
const SiPresto = React.forwardRef(function SiPresto2({ title = "Presto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
