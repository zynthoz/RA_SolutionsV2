...
const SiTeespring = React.forwardRef(function SiTeespring2({ title = "Teespring", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
