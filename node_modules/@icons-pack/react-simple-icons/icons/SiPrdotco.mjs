...
const SiPrdotco = React.forwardRef(function SiPrdotco2({ title = "pr.co", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
