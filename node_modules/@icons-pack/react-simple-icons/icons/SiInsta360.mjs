...
const SiInsta360 = React.forwardRef(function SiInsta3602({ title = "Insta360", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
