...
const defaultColor = "#323357";
const SiMaptiler = React.forwardRef(function SiMaptiler2({ title = "MapTiler", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
