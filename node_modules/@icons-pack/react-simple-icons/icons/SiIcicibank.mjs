...
const SiIcicibank = React.forwardRef(function SiIcicibank2({ title = "ICICI Bank", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
