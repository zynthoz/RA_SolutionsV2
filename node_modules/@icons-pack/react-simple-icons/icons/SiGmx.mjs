...
const SiGmx = React.forwardRef(function SiGmx2({ title = "GMX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
