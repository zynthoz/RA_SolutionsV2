...
const defaultColor = "#7F2B7B";
const SiAib = React__namespace.forwardRef(function SiAib2({ title = "AIB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
