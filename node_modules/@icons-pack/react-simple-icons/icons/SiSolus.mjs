...
const SiSolus = React.forwardRef(function SiSolus2({ title = "Solus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
