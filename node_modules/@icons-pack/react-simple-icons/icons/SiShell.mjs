...
const SiShell = React.forwardRef(function SiShell2({ title = "Shell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
