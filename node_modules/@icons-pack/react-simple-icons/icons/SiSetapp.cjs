...
const defaultColor = "#E6C3A5";
const SiSetapp = React__namespace.forwardRef(function SiSetapp2({ title = "Setapp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
