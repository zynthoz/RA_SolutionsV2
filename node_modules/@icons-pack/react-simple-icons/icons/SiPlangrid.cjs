...
const defaultColor = "#0085DE";
const SiPlangrid = React__namespace.forwardRef(function SiPlangrid2({ title = "PlanGrid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
