...
const defaultColor = "#22ADF6";
const SiInfluxdb = React__namespace.forwardRef(function SiInfluxdb2({ title = "InfluxDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
