...
const SiLiberadotchat = React.forwardRef(function SiLiberadotchat2({ title = "Libera.Chat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
