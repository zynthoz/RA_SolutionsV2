...
const defaultColor = "#3DA639";
const SiOpensourceinitiative = React__namespace.forwardRef(function SiOpensourceinitiative2({ title = "Open Source Initiative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
