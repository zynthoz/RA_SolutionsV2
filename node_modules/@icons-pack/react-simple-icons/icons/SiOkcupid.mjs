...
const SiOkcupid = React.forwardRef(function SiOkcupid2({ title = "okcupid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
