...
const SiFreebsd = React__namespace.forwardRef(function SiFreebsd2({ title = "FreeBSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
