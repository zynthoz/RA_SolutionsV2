...
const defaultColor = "#0C322C";
const SiSuse = React__namespace.forwardRef(function SiSuse2({ title = "SUSE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
