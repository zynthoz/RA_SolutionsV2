...
const SiCloudways = React__namespace.forwardRef(function SiCloudways2({ title = "Cloudways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
