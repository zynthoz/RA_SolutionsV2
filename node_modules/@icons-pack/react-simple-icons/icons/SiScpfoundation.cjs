...
const SiScpfoundation = React__namespace.forwardRef(function SiScpfoundation2({ title = "SCP Foundation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
