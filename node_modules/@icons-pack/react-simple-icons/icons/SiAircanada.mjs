...
const SiAircanada = React.forwardRef(function SiAircanada2({ title = "Air Canada", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
