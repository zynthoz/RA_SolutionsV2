...
const defaultColor = "#EF5C55";
const SiCeph = React__namespace.forwardRef(function SiCeph2({ title = "Ceph", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
