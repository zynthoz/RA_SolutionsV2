...
const SiChainguard = React.forwardRef(function SiChainguard2({ title = "Chainguard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
