...
const defaultColor = "#557C94";
const SiKalilinux = React__namespace.forwardRef(function SiKalilinux2({ title = "Kali Linux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
