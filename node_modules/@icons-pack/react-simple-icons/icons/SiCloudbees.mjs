...
const SiCloudbees = React.forwardRef(function SiCloudbees2({ title = "CloudBees", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
