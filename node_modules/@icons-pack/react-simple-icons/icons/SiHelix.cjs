...
const SiHelix = React__namespace.forwardRef(function SiHelix2({ title = "Helix", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
