...
const SiEdx = React__namespace.forwardRef(function SiEdx2({ title = "edX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
