...
const defaultColor = "#EF0092";
const SiRsocket = React__namespace.forwardRef(function SiRsocket2({ title = "RSocket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
