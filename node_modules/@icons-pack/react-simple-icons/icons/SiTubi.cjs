...
const SiTubi = React__namespace.forwardRef(function SiTubi2({ title = "Tubi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
