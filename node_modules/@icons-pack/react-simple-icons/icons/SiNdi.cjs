...
const SiNdi = React__namespace.forwardRef(function SiNdi2({ title = "NDI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
