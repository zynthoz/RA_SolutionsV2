...
const SiClubhouse = React.forwardRef(function SiClubhouse2({ title = "Clubhouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
