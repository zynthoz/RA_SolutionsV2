...
const SiThespritersresource = React.forwardRef(function SiThespritersresource2({ title = "The Spriters Resource", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
