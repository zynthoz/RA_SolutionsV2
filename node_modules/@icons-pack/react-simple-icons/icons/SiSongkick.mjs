...
const SiSongkick = React.forwardRef(function SiSongkick2({ title = "Songkick", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
