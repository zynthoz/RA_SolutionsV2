...
const SiBuhl = React.forwardRef(function SiBuhl2({ title = "Buhl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
