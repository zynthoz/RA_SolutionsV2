...
const SiAkasaair = React.forwardRef(function SiAkasaair2({ title = "Akasa Air", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
