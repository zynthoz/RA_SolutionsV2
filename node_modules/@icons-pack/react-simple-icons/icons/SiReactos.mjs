...
const SiReactos = React.forwardRef(function SiReactos2({ title = "ReactOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
