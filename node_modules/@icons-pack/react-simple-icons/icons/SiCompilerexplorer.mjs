...
const SiCompilerexplorer = React.forwardRef(function SiCompilerexplorer2({ title = "Compiler Explorer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
