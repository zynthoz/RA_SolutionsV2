...
const defaultColor = "#149DD3";
const SiTokyometro = React__namespace.forwardRef(function SiTokyometro2({ title = "Tokyo Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
