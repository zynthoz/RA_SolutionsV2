...
const SiSmartthings = React__namespace.forwardRef(function SiSmartthings2({ title = "SmartThings", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
