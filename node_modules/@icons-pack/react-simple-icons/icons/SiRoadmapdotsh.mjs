...
const SiRoadmapdotsh = React.forwardRef(function SiRoadmapdotsh2({ title = "roadmap.sh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
