...
const SiJekyll = React__namespace.forwardRef(function SiJekyll2({ title = "Jekyll", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
