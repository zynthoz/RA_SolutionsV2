...
const SiSquarespace = React.forwardRef(function SiSquarespace2({ title = "Squarespace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
