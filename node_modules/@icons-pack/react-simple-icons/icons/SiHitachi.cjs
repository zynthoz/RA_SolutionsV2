...
const defaultColor = "#E60027";
const SiHitachi = React__namespace.forwardRef(function SiHitachi2({ title = "Hitachi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
