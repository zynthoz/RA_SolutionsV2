...
const SiNationalgrid = React__namespace.forwardRef(function SiNationalgrid2({ title = "National Grid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiNationalgrid;
