...
const defaultColor = "#02458D";
const SiAeroflot = React__namespace.forwardRef(function SiAeroflot2({ title = "Aeroflot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
