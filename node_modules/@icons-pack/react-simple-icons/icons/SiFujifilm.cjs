...
const defaultColor = "#FB0020";
const SiFujifilm = React__namespace.forwardRef(function SiFujifilm2({ title = "Fujifilm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
