...
const SiBuiltbybit = React.forwardRef(function SiBuiltbybit2({ title = "BuiltByBit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
