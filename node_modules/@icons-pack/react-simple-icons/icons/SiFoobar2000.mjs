...
const SiFoobar2000 = React.forwardRef(function SiFoobar20002({ title = "foobar2000", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
