...
const SiMobxstatetree = React__namespace.forwardRef(function SiMobxstatetree2({ title = "MobX-State-Tree", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
