...
const SiCivicrm = React.forwardRef(function SiCivicrm2({ title = "CiviCRM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
