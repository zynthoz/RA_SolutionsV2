...
const SiByjus = React.forwardRef(function SiByjus2({ title = "Byjus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
