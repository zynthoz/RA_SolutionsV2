...
const SiHitachi = React.forwardRef(function SiHitachi2({ title = "Hitachi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
