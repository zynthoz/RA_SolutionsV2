...
const SiSeat = React.forwardRef(function SiSeat2({ title = "SEAT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
