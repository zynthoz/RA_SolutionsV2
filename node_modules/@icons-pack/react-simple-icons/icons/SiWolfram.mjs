...
const SiWolfram = React.forwardRef(function SiWolfram2({ title = "Wolfram", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
