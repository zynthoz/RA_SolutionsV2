...
const SiMetrodeparis = React__namespace.forwardRef(function SiMetrodeparis2({ title = "Métro de Paris", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
