...
const SiQodo = React__namespace.forwardRef(function SiQodo2({ title = "Qodo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
