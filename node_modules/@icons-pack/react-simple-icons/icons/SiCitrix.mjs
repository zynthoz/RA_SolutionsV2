...
const SiCitrix = React.forwardRef(function SiCitrix2({ title = "Citrix", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
