...
const defaultColor = "#2E75B4";
const SiFurrynetwork = React__namespace.forwardRef(function SiFurrynetwork2({ title = "Furry Network", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
