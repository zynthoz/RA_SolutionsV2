...
const SiEclipseadoptium = React.forwardRef(function SiEclipseadoptium2({ title = "Eclipse Adoptium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
