...
const defaultColor = "#0F2B46";
const SiDeepl = React__namespace.forwardRef(function SiDeepl2({ title = "DeepL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
