...
const SiNewjapanprowrestling = React__namespace.forwardRef(function SiNewjapanprowrestling2({ title = "New Japan Pro-Wrestling", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
