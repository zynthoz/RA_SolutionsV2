...
const defaultColor = "#F46519";
const SiMuller = React__namespace.forwardRef(function SiMuller2({ title = "Müller", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
