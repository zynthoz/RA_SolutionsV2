...
const SiWeb3dotjs = React.forwardRef(function SiWeb3dotjs2({ title = "Web3.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
