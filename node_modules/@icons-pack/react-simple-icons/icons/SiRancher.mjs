...
const SiRancher = React.forwardRef(function SiRancher2({ title = "Rancher", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
