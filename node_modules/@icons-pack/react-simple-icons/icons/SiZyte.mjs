...
const SiZyte = React.forwardRef(function SiZyte2({ title = "Zyte", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
