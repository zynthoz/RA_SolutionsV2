...
const defaultColor = "#AC6199";
const SiEnvoyproxy = React__namespace.forwardRef(function SiEnvoyproxy2({ title = "Envoy Proxy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
