...
const defaultColor = "#34567C";
const SiAdminer = React__namespace.forwardRef(function SiAdminer2({ title = "Adminer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
