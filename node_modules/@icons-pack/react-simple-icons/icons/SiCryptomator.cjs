...
const defaultColor = "#49B04A";
const SiCryptomator = React__namespace.forwardRef(function SiCryptomator2({ title = "Cryptomator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
