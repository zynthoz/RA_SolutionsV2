...
const SiFirefox = React__namespace.forwardRef(function SiFirefox2({ title = "Firefox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
