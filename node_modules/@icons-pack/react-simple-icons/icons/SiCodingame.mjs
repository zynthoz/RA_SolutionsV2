...
const SiCodingame = React.forwardRef(function SiCodingame2({ title = "CodinGame", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
