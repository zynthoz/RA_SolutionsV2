...
const defaultColor = "#253B73";
const SiNba = React__namespace.forwardRef(function SiNba2({ title = "NBA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
