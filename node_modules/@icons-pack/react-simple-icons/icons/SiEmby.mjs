...
const SiEmby = React.forwardRef(function SiEmby2({ title = "Emby", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
