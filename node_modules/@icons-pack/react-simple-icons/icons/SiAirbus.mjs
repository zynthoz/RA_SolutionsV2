...
const SiAirbus = React.forwardRef(function SiAirbus2({ title = "Airbus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
