...
const defaultColor = "#24FF00";
const SiIcq = React__namespace.forwardRef(function SiIcq2({ title = "ICQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
