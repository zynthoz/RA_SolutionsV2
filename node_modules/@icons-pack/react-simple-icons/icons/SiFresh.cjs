...
const SiFresh = React__namespace.forwardRef(function SiFresh2({ title = "Fresh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
