...
const SiFoursquare = React__namespace.forwardRef(function SiFoursquare2({ title = "Foursquare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
