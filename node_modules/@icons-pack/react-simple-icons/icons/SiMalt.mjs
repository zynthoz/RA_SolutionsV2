...
const SiMalt = React.forwardRef(function SiMalt2({ title = "Malt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
