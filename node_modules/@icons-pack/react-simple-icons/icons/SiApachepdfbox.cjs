...
const SiApachepdfbox = React__namespace.forwardRef(function SiApachepdfbox2({ title = "Apache PDFBox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
