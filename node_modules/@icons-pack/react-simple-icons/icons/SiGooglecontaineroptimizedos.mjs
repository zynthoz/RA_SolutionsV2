...
const SiGooglecontaineroptimizedos = React.forwardRef(function SiGooglecontaineroptimizedos2({ title = "Google Container Optimized OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiGooglecontaineroptimizedos as default, defaultColor };
