...
const SiCanonical = React.forwardRef(function SiCanonical2({ title = "Canonical", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
