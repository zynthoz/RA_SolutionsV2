...
const defaultColor = "#D30707";
const SiCodemirror = React.forwardRef(function SiCodemirror2({ title = "CodeMirror", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
