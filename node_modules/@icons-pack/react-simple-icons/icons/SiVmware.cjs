...
const defaultColor = "#607078";
const SiVmware = React__namespace.forwardRef(function SiVmware2({ title = "VMware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
