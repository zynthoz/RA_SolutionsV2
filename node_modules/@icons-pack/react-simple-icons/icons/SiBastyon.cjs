...
const SiBastyon = React__namespace.forwardRef(function SiBastyon2({ title = "Bastyon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
