...
const SiSuitest = React__namespace.forwardRef(function SiSuitest2({ title = "Suitest", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
