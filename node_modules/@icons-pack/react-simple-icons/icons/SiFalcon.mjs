...
const SiFalcon = React.forwardRef(function SiFalcon2({ title = "Falcon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
