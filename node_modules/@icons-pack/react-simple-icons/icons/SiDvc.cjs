...
const defaultColor = "#13ADC7";
const SiDvc = React__namespace.forwardRef(function SiDvc2({ title = "DVC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
