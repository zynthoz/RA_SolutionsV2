...
const defaultColor = "#FF1985";
const SiWikidotgg = React__namespace.forwardRef(function SiWikidotgg2({ title = "wiki.gg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
