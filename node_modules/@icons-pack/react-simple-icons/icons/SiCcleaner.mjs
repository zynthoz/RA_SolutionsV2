...
const SiCcleaner = React.forwardRef(function SiCcleaner2({ title = "CCleaner", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
