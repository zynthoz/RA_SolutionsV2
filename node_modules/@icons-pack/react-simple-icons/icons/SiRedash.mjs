...
const SiRedash = React.forwardRef(function SiRedash2({ title = "Redash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
