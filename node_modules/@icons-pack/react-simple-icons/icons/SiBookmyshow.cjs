...
const SiBookmyshow = React__namespace.forwardRef(function SiBookmyshow2({ title = "BookMyShow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
