...
const SiOdoo = React__namespace.forwardRef(function SiOdoo2({ title = "Odoo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
