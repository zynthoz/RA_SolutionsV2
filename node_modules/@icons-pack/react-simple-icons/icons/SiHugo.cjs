...
const defaultColor = "#FF4088";
const SiHugo = React__namespace.forwardRef(function SiHugo2({ title = "Hugo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
