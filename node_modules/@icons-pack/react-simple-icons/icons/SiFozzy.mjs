...
const SiFozzy = React.forwardRef(function SiFozzy2({ title = "Fozzy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
