...
const SiDassaultsystemes = React.forwardRef(function SiDassaultsystemes2({ title = "Dassault Systèmes", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
