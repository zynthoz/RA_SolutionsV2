...
const defaultColor = "#00AFAA";
const SiHere = React__namespace.forwardRef(function SiHere2({ title = "HERE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
