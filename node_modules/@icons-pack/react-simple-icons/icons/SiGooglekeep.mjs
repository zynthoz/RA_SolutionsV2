...
const SiGooglekeep = React.forwardRef(function SiGooglekeep2({ title = "Google Keep", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
