...
const SiRos = React.forwardRef(function SiRos2({ title = "ROS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
