...
const defaultColor = "#813588";
const SiByjus = React__namespace.forwardRef(function SiByjus2({ title = "Byjus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
