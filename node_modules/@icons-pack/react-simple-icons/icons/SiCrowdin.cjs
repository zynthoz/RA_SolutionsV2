...
const defaultColor = "#2E3340";
const SiCrowdin = React__namespace.forwardRef(function SiCrowdin2({ title = "Crowdin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
