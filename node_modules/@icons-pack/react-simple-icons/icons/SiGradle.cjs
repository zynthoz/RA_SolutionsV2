...
const defaultColor = "#02303A";
const SiGradle = React__namespace.forwardRef(function SiGradle2({ title = "Gradle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
