...
const SiImmer = React.forwardRef(function SiImmer2({ title = "Immer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
