...
const defaultColor = "#4298B8";
const SiApachegroovy = React.forwardRef(function SiApachegroovy2({ title = "Apache Groovy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
