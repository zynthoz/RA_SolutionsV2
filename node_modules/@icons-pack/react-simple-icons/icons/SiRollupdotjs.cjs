...
const SiRollupdotjs = React__namespace.forwardRef(function SiRollupdotjs2({ title = "rollup.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
