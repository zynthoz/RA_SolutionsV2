...
const SiCopaairlines = React.forwardRef(function SiCopaairlines2({ title = "Copa Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
