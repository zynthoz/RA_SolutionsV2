...
const defaultColor = "#E42527";
const SiZoho = React__namespace.forwardRef(function SiZoho2({ title = "Zoho", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
