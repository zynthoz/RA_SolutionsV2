...
const defaultColor = "#FF3633";
const SiGraylog = React.forwardRef(function SiGraylog2({ title = "Graylog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
