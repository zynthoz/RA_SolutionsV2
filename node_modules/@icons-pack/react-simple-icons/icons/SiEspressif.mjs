...
const defaultColor = "#E7352C";
const SiEspressif = React.forwardRef(function SiEspressif2({ title = "Espressif", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
