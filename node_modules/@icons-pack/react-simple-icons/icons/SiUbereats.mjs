...
const SiUbereats = React.forwardRef(function SiUbereats2({ title = "Uber Eats", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
