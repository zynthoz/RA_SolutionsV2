...
const SiLimesurvey = React.forwardRef(function SiLimesurvey2({ title = "LimeSurvey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
