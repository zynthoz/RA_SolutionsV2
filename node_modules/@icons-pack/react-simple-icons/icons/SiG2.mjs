...
const SiG2 = React.forwardRef(function SiG22({ title = "G2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
