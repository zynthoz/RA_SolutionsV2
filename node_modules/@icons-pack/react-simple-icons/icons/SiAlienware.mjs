...
const SiAlienware = React.forwardRef(function SiAlienware2({ title = "Alienware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
