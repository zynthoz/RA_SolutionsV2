...
const defaultColor = "#131F37";
const SiIota = React__namespace.forwardRef(function SiIota2({ title = "IOTA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
