...
const defaultColor = "#FFD859";
const SiPinia = React__namespace.forwardRef(function SiPinia2({ title = "Pinia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
