...
const defaultColor = "#F56E0F";
const SiKnip = React__namespace.forwardRef(function SiKnip2({ title = "Knip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
