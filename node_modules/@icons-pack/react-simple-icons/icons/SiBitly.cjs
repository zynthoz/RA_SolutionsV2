...
const defaultColor = "#EE6123";
const SiBitly = React__namespace.forwardRef(function SiBitly2({ title = "Bitly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
