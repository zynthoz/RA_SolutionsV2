...
const SiShopware = React__namespace.forwardRef(function SiShopware2({ title = "Shopware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
