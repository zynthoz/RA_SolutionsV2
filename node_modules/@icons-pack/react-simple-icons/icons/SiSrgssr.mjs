...
const SiSrgssr = React.forwardRef(function SiSrgssr2({ title = "SRG SSR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
