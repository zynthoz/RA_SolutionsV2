...
const defaultColor = "#2C7AC3";
const SiArcgis = React__namespace.forwardRef(function SiArcgis2({ title = "ArcGIS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
