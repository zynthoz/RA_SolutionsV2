...
const SiPagseguro = React.forwardRef(function SiPagseguro2({ title = "PagSeguro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
