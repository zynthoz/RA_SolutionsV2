...
const defaultColor = "#F08705";
const SiDiagramsdotnet = React__namespace.forwardRef(function SiDiagramsdotnet2({ title = "diagrams.net", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
