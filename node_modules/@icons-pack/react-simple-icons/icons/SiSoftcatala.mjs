...
const SiSoftcatala = React.forwardRef(function SiSoftcatala2({ title = "Softcatalà", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
