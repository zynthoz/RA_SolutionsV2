...
const SiHackmd = React__namespace.forwardRef(function SiHackmd2({ title = "HackMD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
