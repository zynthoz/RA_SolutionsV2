...
const defaultColor = "#80247B";
const SiBasicattentiontoken = React__namespace.forwardRef(function SiBasicattentiontoken2({ title = "Basic Attention Token", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
