...
const defaultColor = "#EE3984";
const SiTcs = React.forwardRef(function SiTcs2({ title = "Tata Consultancy Services", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
