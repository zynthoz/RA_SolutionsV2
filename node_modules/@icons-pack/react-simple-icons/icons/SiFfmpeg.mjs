...
const SiFfmpeg = React.forwardRef(function SiFfmpeg2({ title = "FFmpeg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
