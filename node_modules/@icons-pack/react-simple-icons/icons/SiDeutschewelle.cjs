...
const defaultColor = "#05B2FC";
const SiDeutschewelle = React__namespace.forwardRef(function SiDeutschewelle2({ title = "Deutsche Welle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
