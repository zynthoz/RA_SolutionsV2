...
const defaultColor = "#FC6A31";
const SiDoctrine = React__namespace.forwardRef(function SiDoctrine2({ title = "Doctrine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
