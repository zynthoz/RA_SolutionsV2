...
const SiOsmc = React.forwardRef(function SiOsmc2({ title = "OSMC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
