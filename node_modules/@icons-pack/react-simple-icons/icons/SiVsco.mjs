...
const SiVsco = React.forwardRef(function SiVsco2({ title = "VSCO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
