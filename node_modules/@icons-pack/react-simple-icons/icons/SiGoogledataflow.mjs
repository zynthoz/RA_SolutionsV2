...
const SiGoogledataflow = React.forwardRef(function SiGoogledataflow2({ title = "Google Dataflow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
