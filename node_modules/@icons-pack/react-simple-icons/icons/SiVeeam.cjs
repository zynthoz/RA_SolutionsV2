...
const SiVeeam = React__namespace.forwardRef(function SiVeeam2({ title = "Veeam", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
