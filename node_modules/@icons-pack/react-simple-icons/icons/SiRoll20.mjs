...
const SiRoll20 = React.forwardRef(function SiRoll202({ title = "Roll20", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
