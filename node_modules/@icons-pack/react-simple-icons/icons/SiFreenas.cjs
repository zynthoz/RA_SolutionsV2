...
const SiFreenas = React__namespace.forwardRef(function SiFreenas2({ title = "FreeNAS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
