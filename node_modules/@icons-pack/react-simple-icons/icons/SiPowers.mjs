...
const SiPowers = React.forwardRef(function SiPowers2({ title = "POWERS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
