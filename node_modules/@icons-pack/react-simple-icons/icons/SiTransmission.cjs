...
const SiTransmission = React__namespace.forwardRef(function SiTransmission2({ title = "Transmission", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
