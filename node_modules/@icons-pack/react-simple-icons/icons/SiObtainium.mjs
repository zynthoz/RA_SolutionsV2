...
const SiObtainium = React.forwardRef(function SiObtainium2({ title = "Obtainium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
