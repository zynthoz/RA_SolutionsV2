...
const SiBookbub = React.forwardRef(function SiBookbub2({ title = "BookBub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
