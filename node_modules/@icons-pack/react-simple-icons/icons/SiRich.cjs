...
const defaultColor = "#FAE742";
const SiRich = React__namespace.forwardRef(function SiRich2({ title = "Rich", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
