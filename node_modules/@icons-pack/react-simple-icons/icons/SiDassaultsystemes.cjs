...
const defaultColor = "#005386";
const SiDassaultsystemes = React__namespace.forwardRef(function SiDassaultsystemes2({ title = "Dassault Systèmes", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
