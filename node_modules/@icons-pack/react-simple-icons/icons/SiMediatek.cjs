...
const defaultColor = "#EC9430";
const SiMediatek = React__namespace.forwardRef(function SiMediatek2({ title = "MediaTek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
