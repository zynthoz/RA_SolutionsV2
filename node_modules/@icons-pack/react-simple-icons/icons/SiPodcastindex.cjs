...
const SiPodcastindex = React__namespace.forwardRef(function SiPodcastindex2({ title = "Podcast Index", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
