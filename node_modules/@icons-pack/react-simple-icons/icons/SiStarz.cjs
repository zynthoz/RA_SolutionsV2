...
const defaultColor = "#082125";
const SiStarz = React__namespace.forwardRef(function SiStarz2({ title = "STARZ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
