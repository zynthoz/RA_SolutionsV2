...
const defaultColor = "#00B1EA";
const SiMercadopago = React__namespace.forwardRef(function SiMercadopago2({ title = "Mercado Pago", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
