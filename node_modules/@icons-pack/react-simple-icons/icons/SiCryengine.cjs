...
const SiCryengine = React__namespace.forwardRef(function SiCryengine2({ title = "CRYENGINE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
