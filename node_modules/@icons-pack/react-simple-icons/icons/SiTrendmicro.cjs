...
const SiTrendmicro = React__namespace.forwardRef(function SiTrendmicro2({ title = "Trend Micro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
