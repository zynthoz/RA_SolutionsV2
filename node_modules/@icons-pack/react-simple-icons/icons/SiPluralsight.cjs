...
const SiPluralsight = React__namespace.forwardRef(function SiPluralsight2({ title = "Pluralsight", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
