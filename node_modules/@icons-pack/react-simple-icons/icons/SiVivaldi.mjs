...
const defaultColor = "#EF3939";
const SiVivaldi = React.forwardRef(function SiVivaldi2({ title = "Vivaldi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
