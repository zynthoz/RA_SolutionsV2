...
const SiCoze = React.forwardRef(function SiCoze2({ title = "Coze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
