...
const SiLequipe = React__namespace.forwardRef(function SiLequipe2({ title = "LÉquipe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
