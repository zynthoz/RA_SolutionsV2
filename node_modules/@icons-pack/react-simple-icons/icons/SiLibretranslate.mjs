...
const SiLibretranslate = React.forwardRef(function SiLibretranslate2({ title = "LibreTranslate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
