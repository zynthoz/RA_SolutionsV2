...
const defaultColor = "#41AD48";
const SiCodeblocks = React__namespace.forwardRef(function SiCodeblocks2({ title = "Code::Blocks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
