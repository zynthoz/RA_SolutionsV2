...
const defaultColor = "#5AB552";
const SiEventstore = React__namespace.forwardRef(function SiEventstore2({ title = "Event Store", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
