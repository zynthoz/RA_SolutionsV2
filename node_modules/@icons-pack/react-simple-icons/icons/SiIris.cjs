...
const SiIris = React__namespace.forwardRef(function SiIris2({ title = "IRIS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
