...
const SiAda = React.forwardRef(function SiAda2({ title = "Ada", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
