...
const defaultColor = "#1CB27E";
const SiZettlr = React__namespace.forwardRef(function SiZettlr2({ title = "Zettlr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
