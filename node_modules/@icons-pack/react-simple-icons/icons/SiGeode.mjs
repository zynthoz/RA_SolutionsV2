...
const SiGeode = React.forwardRef(function SiGeode2({ title = "Geode", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
