...
const SiWeasyl = React__namespace.forwardRef(function SiWeasyl2({ title = "Weasyl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
