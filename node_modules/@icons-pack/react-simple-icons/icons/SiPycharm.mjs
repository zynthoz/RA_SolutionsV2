...
const SiPycharm = React.forwardRef(function SiPycharm2({ title = "PyCharm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
