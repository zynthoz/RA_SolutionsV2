...
const SiKrita = React.forwardRef(function SiKrita2({ title = "Krita", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
