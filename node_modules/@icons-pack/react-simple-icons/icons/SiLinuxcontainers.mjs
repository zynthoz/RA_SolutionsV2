...
const SiLinuxcontainers = React.forwardRef(function SiLinuxcontainers2({ title = "Linux Containers", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
