...
const SiCreality = React__namespace.forwardRef(function SiCreality2({ title = "Creality", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
