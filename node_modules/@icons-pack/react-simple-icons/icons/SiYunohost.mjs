...
const SiYunohost = React.forwardRef(function SiYunohost2({ title = "YunoHost", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
