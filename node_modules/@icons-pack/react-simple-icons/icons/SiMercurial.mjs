...
const SiMercurial = React.forwardRef(function SiMercurial2({ title = "Mercurial", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
