...
const SiOwncloud = React.forwardRef(function SiOwncloud2({ title = "ownCloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
