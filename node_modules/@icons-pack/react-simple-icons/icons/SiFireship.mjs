...
const SiFireship = React.forwardRef(function SiFireship2({ title = "Fireship", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
