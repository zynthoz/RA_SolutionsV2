...
const SiPercy = React__namespace.forwardRef(function SiPercy2({ title = "Percy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
