...
const SiUnlicense = React.forwardRef(function SiUnlicense2({ title = "Unlicense", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiUnlicense as default, defaultColor };
