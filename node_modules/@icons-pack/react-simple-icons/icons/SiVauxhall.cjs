...
const defaultColor = "#EB001E";
const SiVauxhall = React__namespace.forwardRef(function SiVauxhall2({ title = "Vauxhall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
