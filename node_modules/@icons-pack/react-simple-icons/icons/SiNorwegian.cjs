...
const SiNorwegian = React__namespace.forwardRef(function SiNorwegian2({ title = "Norwegian", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
