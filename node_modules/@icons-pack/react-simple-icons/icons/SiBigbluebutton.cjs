...
const defaultColor = "#283274";
const SiBigbluebutton = React__namespace.forwardRef(function SiBigbluebutton2({ title = "BigBlueButton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
