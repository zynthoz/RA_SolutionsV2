...
const SiBackblaze = React.forwardRef(function SiBackblaze2({ title = "Backblaze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
