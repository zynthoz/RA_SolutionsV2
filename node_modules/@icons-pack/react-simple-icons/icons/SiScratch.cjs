...
const defaultColor = "#855CD6";
const SiScratch = React__namespace.forwardRef(function SiScratch2({ title = "Scratch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
