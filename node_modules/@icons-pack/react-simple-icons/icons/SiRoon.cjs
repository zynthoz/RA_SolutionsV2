...
const SiRoon = React__namespace.forwardRef(function SiRoon2({ title = "Roon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
