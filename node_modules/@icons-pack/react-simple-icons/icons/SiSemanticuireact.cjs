...
const SiSemanticuireact = React__namespace.forwardRef(function SiSemanticuireact2({ title = "Semantic UI React", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
