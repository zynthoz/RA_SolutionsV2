...
const SiLibuv = React__namespace.forwardRef(function SiLibuv2({ title = "libuv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
