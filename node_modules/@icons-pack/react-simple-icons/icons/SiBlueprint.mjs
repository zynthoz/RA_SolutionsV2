...
const SiBlueprint = React.forwardRef(function SiBlueprint2({ title = "Blueprint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
