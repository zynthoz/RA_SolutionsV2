...
const defaultColor = "#5091CD";
const SiJoomla = React__namespace.forwardRef(function SiJoomla2({ title = "Joomla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
