...
const SiGeopandas = React__namespace.forwardRef(function SiGeopandas2({ title = "GeoPandas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
