...
const defaultColor = "#1BB2A9";
const SiChakraui = React__namespace.forwardRef(function SiChakraui2({ title = "Chakra UI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
