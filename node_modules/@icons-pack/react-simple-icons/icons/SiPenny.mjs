...
const SiPenny = React.forwardRef(function SiPenny2({ title = "Penny", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
