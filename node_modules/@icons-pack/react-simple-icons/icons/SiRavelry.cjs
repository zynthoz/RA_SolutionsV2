...
const SiRavelry = React__namespace.forwardRef(function SiRavelry2({ title = "Ravelry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
