...
const SiMamp = React.forwardRef(function SiMamp2({ title = "MAMP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
