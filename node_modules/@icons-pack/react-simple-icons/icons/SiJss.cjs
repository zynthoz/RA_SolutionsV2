...
const SiJss = React__namespace.forwardRef(function SiJss2({ title = "JSS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
