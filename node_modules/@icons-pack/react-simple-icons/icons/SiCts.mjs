...
const SiCts = React.forwardRef(function SiCts2({ title = "CTS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
