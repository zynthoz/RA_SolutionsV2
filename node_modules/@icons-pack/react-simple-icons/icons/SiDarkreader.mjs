...
const SiDarkreader = React.forwardRef(function SiDarkreader2({ title = "Dark Reader", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
