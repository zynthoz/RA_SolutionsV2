...
const SiMetasploit = React.forwardRef(function SiMetasploit2({ title = "Metasploit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
