...
const SiPrimereact = React.forwardRef(function SiPrimereact2({ title = "PrimeReact", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
