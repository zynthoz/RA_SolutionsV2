...
const defaultColor = "#0096D6";
const SiAkamai = React__namespace.forwardRef(function SiAkamai2({ title = "Akamai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
