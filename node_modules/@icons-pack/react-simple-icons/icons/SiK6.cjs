...
const defaultColor = "#7D64FF";
const SiK6 = React__namespace.forwardRef(function SiK62({ title = "k6", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
