...
const SiHasura = React__namespace.forwardRef(function SiHasura2({ title = "Hasura", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
