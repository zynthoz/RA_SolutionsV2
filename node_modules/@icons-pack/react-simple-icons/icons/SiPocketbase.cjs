...
const SiPocketbase = React__namespace.forwardRef(function SiPocketbase2({ title = "PocketBase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
