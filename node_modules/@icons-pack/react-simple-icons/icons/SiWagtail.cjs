...
const defaultColor = "#43B1B0";
const SiWagtail = React__namespace.forwardRef(function SiWagtail2({ title = "Wagtail", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
