...
const SiYoutubestudio = React.forwardRef(function SiYoutubestudio2({ title = "YouTube Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
