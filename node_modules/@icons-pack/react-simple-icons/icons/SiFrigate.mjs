...
const SiFrigate = React.forwardRef(function SiFrigate2({ title = "Frigate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
