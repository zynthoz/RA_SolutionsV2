...
const SiStackhawk = React__namespace.forwardRef(function SiStackhawk2({ title = "StackHawk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
