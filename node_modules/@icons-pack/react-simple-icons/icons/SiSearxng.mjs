...
const SiSearxng = React.forwardRef(function SiSearxng2({ title = "SearXNG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
