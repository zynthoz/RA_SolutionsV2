...
const SiDogecoin = React.forwardRef(function SiDogecoin2({ title = "Dogecoin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
