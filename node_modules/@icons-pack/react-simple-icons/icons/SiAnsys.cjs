...
const defaultColor = "#FFB71B";
const SiAnsys = React__namespace.forwardRef(function SiAnsys2({ title = "Ansys", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
