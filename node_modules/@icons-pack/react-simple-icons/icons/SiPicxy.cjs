...
const SiPicxy = React__namespace.forwardRef(function SiPicxy2({ title = "Picxy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
