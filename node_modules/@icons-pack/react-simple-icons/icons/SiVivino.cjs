...
const SiVivino = React__namespace.forwardRef(function SiVivino2({ title = "Vivino", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
