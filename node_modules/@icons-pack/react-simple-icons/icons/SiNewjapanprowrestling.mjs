...
const SiNewjapanprowrestling = React.forwardRef(function SiNewjapanprowrestling2({ title = "New Japan Pro-Wrestling", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
