...
const SiPuma = React.forwardRef(function SiPuma2({ title = "Puma", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
