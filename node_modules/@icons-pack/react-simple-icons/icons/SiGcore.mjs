...
const SiGcore = React.forwardRef(function SiGcore2({ title = "Gcore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
