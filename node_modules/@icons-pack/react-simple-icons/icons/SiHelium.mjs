...
const SiHelium = React.forwardRef(function SiHelium2({ title = "Helium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
