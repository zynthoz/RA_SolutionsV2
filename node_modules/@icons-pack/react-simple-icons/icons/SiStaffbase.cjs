...
const SiStaffbase = React__namespace.forwardRef(function SiStaffbase2({ title = "Staffbase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
