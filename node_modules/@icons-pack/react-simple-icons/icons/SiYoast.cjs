...
const SiYoast = React__namespace.forwardRef(function SiYoast2({ title = "Yoast", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
