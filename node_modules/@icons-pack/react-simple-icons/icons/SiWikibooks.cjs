...
const SiWikibooks = React__namespace.forwardRef(function SiWikibooks2({ title = "Wikibooks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
