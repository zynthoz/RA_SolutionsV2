...
const defaultColor = "#4B1E78";
const SiYamahacorporation = React__namespace.forwardRef(function SiYamahacorporation2({ title = "Yamaha Corporation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
