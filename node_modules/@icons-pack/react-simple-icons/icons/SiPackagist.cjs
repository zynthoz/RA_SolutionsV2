...
const defaultColor = "#F28D1A";
const SiPackagist = React__namespace.forwardRef(function SiPackagist2({ title = "Packagist", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
