...
const SiHearthisdotat = React.forwardRef(function SiHearthisdotat2({ title = "hearthis.at", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
