...
const SiLogseq = React__namespace.forwardRef(function SiLogseq2({ title = "Logseq", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
