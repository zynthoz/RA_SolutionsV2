...
const Si1and1 = React.forwardRef(function Si1and12({ title = "1&1", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
