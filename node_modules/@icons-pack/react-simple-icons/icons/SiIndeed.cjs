...
const defaultColor = "#003A9B";
const SiIndeed = React__namespace.forwardRef(function SiIndeed2({ title = "Indeed", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
