...
const defaultColor = "#007EAE";
const SiCaixabank = React__namespace.forwardRef(function SiCaixabank2({ title = "CaixaBank", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
