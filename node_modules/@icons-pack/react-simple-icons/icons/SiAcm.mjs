...
const SiAcm = React.forwardRef(function SiAcm2({ title = "ACM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
