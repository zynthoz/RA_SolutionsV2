...
const defaultColor = "#317F6F";
const SiNtfy = React__namespace.forwardRef(function SiNtfy2({ title = "ntfy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
