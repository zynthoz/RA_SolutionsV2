...
const defaultColor = "#0079C1";
const SiKubuntu = React__namespace.forwardRef(function SiKubuntu2({ title = "Kubuntu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
