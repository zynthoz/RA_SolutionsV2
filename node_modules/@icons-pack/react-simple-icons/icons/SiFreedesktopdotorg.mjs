...
const defaultColor = "#3B80AE";
const SiFreedesktopdotorg = React.forwardRef(function SiFreedesktopdotorg2({ title = "freedesktop.org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
