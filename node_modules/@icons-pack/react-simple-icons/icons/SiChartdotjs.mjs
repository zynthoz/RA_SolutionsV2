...
const SiChartdotjs = React.forwardRef(function SiChartdotjs2({ title = "Chart.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
