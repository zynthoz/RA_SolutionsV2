...
const SiTsnode = React__namespace.forwardRef(function SiTsnode2({ title = "ts-node", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
