...
const SiZingat = React__namespace.forwardRef(function SiZingat2({ title = "Zingat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
