...
const SiCadillac = React__namespace.forwardRef(function SiCadillac2({ title = "Cadillac", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
