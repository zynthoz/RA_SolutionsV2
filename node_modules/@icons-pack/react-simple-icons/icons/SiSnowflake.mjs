...
const SiSnowflake = React.forwardRef(function SiSnowflake2({ title = "Snowflake", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
