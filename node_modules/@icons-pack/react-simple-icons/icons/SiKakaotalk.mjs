...
const SiKakaotalk = React.forwardRef(function SiKakaotalk2({ title = "KakaoTalk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
