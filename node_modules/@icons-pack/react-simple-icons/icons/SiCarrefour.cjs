...
const defaultColor = "#004E9F";
const SiCarrefour = React__namespace.forwardRef(function SiCarrefour2({ title = "Carrefour", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
