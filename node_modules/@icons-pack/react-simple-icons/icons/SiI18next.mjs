...
const SiI18next = React.forwardRef(function SiI18next2({ title = "i18next", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
