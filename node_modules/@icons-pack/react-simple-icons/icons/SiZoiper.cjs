...
const SiZoiper = React__namespace.forwardRef(function SiZoiper2({ title = "Zoiper", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
