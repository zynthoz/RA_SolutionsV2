...
const defaultColor = "#00AA45";
const SiPeerlist = React__namespace.forwardRef(function SiPeerlist2({ title = "Peerlist", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
