...
const SiRay = React__namespace.forwardRef(function SiRay2({ title = "Ray", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
