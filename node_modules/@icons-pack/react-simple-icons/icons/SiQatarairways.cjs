...
const defaultColor = "#5C0D34";
const SiQatarairways = React__namespace.forwardRef(function SiQatarairways2({ title = "Qatar Airways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
