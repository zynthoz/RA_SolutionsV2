...
const defaultColor = "#BA478F";
const SiMusicbrainz = React__namespace.forwardRef(function SiMusicbrainz2({ title = "MusicBrainz", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
