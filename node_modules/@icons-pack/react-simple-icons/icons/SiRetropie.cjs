...
const SiRetropie = React__namespace.forwardRef(function SiRetropie2({ title = "RetroPie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
