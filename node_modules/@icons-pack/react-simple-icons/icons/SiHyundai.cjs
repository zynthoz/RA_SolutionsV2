...
const defaultColor = "#002C5E";
const SiHyundai = React__namespace.forwardRef(function SiHyundai2({ title = "Hyundai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
