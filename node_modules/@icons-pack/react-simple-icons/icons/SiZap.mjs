...
const SiZap = React.forwardRef(function SiZap2({ title = "ZAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
