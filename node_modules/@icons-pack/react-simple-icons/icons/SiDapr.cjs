...
const defaultColor = "#0D2192";
const SiDapr = React__namespace.forwardRef(function SiDapr2({ title = "Dapr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
