...
const defaultColor = "#2AA5DC";
const SiApachecloudstack = React.forwardRef(function SiApachecloudstack2({ title = "Apache CloudStack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
