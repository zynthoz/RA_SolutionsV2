...
const SiChromatic = React.forwardRef(function SiChromatic2({ title = "Chromatic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
