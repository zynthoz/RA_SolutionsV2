...
const defaultColor = "#CA2133";
const SiBlazemeter = React__namespace.forwardRef(function SiBlazemeter2({ title = "Blazemeter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
