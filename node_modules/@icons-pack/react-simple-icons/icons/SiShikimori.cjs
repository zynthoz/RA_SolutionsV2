...
const SiShikimori = React__namespace.forwardRef(function SiShikimori2({ title = "Shikimori", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
