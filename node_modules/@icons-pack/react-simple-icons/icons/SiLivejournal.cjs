...
const defaultColor = "#00B0EA";
const SiLivejournal = React__namespace.forwardRef(function SiLivejournal2({ title = "LiveJournal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
