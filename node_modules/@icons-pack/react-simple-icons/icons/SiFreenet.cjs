...
const defaultColor = "#84BC34";
const SiFreenet = React__namespace.forwardRef(function SiFreenet2({ title = "freenet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
