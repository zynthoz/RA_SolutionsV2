...
const SiBitdefender = React__namespace.forwardRef(function SiBitdefender2({ title = "Bitdefender", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
