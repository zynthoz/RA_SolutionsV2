...
const SiLufthansa = React.forwardRef(function SiLufthansa2({ title = "Lufthansa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
