...
const SiArstechnica = React__namespace.forwardRef(function SiArstechnica2({ title = "Ars Technica", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
