...
const defaultColor = "#1071D3";
const SiJoplin = React__namespace.forwardRef(function SiJoplin2({ title = "Joplin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
