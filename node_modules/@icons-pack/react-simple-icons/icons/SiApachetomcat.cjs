...
const defaultColor = "#F8DC75";
const SiApachetomcat = React__namespace.forwardRef(function SiApachetomcat2({ title = "Apache Tomcat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
