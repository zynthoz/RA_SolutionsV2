...
const SiAboutdotme = React.forwardRef(function SiAboutdotme2({ title = "about.me", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
