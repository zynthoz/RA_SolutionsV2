...
const defaultColor = "#0B131A";
const SiDenon = React__namespace.forwardRef(function SiDenon2({ title = "Denon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
