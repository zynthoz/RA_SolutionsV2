...
const defaultColor = "#72BE50";
const SiKred = React__namespace.forwardRef(function SiKred2({ title = "Kred", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
