...
const defaultColor = "#2480E6";
const SiProcesswire = React__namespace.forwardRef(function SiProcesswire2({ title = "ProcessWire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
