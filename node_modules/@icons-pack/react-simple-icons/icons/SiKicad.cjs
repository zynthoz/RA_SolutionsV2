...
const defaultColor = "#314CB0";
const SiKicad = React__namespace.forwardRef(function SiKicad2({ title = "KiCad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
