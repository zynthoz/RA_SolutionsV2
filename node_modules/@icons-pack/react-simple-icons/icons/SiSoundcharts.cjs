...
const SiSoundcharts = React__namespace.forwardRef(function SiSoundcharts2({ title = "Soundcharts", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
