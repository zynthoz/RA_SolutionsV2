...
const SiRhinoceros = React.forwardRef(function SiRhinoceros2({ title = "Rhinoceros", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
