...
const defaultColor = "#B32024";
const SiRedmine = React__namespace.forwardRef(function SiRedmine2({ title = "Redmine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
