...
const SiCoursera = React__namespace.forwardRef(function SiCoursera2({ title = "Coursera", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
