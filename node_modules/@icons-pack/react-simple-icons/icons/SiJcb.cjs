...
const SiJcb = React__namespace.forwardRef(function SiJcb2({ title = "JCB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
