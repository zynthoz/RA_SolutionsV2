...
const defaultColor = "#2A2F3D";
const SiAppsmith = React__namespace.forwardRef(function SiAppsmith2({ title = "Appsmith", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
