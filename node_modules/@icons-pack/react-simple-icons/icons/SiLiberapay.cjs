...
const defaultColor = "#F6C915";
const SiLiberapay = React__namespace.forwardRef(function SiLiberapay2({ title = "Liberapay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
