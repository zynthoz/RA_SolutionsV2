...
const SiHono = React__namespace.forwardRef(function SiHono2({ title = "Hono", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
