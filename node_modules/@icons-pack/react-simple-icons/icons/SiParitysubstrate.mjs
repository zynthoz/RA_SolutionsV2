...
const SiParitysubstrate = React.forwardRef(function SiParitysubstrate2({ title = "Parity Substrate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
