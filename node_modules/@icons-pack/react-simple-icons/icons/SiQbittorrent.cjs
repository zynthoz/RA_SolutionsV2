...
const defaultColor = "#2F67BA";
const SiQbittorrent = React__namespace.forwardRef(function SiQbittorrent2({ title = "qbittorrent", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
