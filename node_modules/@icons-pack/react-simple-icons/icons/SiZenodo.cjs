...
const defaultColor = "#1682D4";
const SiZenodo = React__namespace.forwardRef(function SiZenodo2({ title = "Zenodo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
