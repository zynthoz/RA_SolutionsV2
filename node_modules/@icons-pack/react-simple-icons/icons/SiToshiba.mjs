...
const SiToshiba = React.forwardRef(function SiToshiba2({ title = "Toshiba", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
