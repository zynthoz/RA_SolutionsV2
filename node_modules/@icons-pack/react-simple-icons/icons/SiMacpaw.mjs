...
const SiMacpaw = React.forwardRef(function SiMacpaw2({ title = "MacPaw", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
