...
const SiWikivoyage = React__namespace.forwardRef(function SiWikivoyage2({ title = "Wikivoyage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
