...
const SiUdotsdotnews = React__namespace.forwardRef(function SiUdotsdotnews2({ title = "U.S. News", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
