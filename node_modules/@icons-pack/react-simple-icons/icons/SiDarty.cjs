...
const defaultColor = "#EB1B23";
const SiDarty = React__namespace.forwardRef(function SiDarty2({ title = "Darty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
