...
const SiQt = React__namespace.forwardRef(function SiQt2({ title = "Qt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
