...
const SiAkamai = React.forwardRef(function SiAkamai2({ title = "Akamai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
