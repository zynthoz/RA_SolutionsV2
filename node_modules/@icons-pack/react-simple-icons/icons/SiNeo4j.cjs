...
const SiNeo4j = React__namespace.forwardRef(function SiNeo4j2({ title = "Neo4j", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
