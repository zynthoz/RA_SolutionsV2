...
const SiVauxhall = React.forwardRef(function SiVauxhall2({ title = "Vauxhall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
