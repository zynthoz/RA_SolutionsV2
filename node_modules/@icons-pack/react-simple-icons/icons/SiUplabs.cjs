...
const SiUplabs = React__namespace.forwardRef(function SiUplabs2({ title = "UpLabs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
