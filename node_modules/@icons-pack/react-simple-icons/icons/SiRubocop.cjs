...
const SiRubocop = React__namespace.forwardRef(function SiRubocop2({ title = "RuboCop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
