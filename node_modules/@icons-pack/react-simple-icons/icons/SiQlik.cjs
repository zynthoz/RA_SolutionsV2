...
const SiQlik = React__namespace.forwardRef(function SiQlik2({ title = "Qlik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
