...
const defaultColor = "#5C73E7";
const SiVitepress = React__namespace.forwardRef(function SiVitepress2({ title = "VitePress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
