...
const SiWeblate = React__namespace.forwardRef(function SiWeblate2({ title = "Weblate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
