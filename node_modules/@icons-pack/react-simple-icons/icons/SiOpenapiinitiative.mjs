...
const SiOpenapiinitiative = React.forwardRef(function SiOpenapiinitiative2({ title = "OpenAPI Initiative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
