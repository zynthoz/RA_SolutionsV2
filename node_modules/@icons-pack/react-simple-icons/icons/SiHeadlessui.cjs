...
const SiHeadlessui = React__namespace.forwardRef(function SiHeadlessui2({ title = "Headless UI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
