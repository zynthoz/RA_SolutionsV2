...
const defaultColor = "#4E5E9E";
const SiMautic = React__namespace.forwardRef(function SiMautic2({ title = "Mautic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
