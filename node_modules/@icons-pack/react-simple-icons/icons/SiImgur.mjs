...
const defaultColor = "#1BB76E";
const SiImgur = React.forwardRef(function SiImgur2({ title = "Imgur", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
