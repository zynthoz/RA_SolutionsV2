...
const SiJouav = React.forwardRef(function SiJouav2({ title = "JOUAV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
