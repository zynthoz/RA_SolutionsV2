...
const SiTrilium = React.forwardRef(function SiTrilium2({ title = "Trilium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
