...
const SiElastic = React.forwardRef(function SiElastic2({ title = "Elastic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
