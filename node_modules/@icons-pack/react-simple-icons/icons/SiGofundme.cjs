...
const defaultColor = "#00B964";
const SiGofundme = React__namespace.forwardRef(function SiGofundme2({ title = "GoFundMe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
