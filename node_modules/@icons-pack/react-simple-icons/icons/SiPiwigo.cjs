...
const SiPiwigo = React__namespace.forwardRef(function SiPiwigo2({ title = "Piwigo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
