...
const SiRotaryinternational = React__namespace.forwardRef(function SiRotaryinternational2({ title = "Rotary International", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
