...
const SiPolygon = React__namespace.forwardRef(function SiPolygon2({ title = "Polygon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
