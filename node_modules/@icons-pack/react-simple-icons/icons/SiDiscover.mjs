...
const SiDiscover = React.forwardRef(function SiDiscover2({ title = "Discover", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
