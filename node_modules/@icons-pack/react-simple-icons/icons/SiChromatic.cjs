...
const defaultColor = "#FC521F";
const SiChromatic = React__namespace.forwardRef(function SiChromatic2({ title = "Chromatic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
