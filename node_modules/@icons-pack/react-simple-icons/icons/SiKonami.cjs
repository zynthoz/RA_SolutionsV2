...
const defaultColor = "#B60014";
const SiKonami = React__namespace.forwardRef(function SiKonami2({ title = "Konami", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
