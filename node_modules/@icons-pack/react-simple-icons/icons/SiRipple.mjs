...
const SiRipple = React.forwardRef(function SiRipple2({ title = "Ripple", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
