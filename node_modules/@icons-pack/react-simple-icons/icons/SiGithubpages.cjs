...
const SiGithubpages = React__namespace.forwardRef(function SiGithubpages2({ title = "GitHub Pages", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
