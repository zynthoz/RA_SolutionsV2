...
const SiLichess = React__namespace.forwardRef(function SiLichess2({ title = "Lichess", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
