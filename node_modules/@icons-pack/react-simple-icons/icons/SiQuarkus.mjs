...
const SiQuarkus = React.forwardRef(function SiQuarkus2({ title = "Quarkus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
