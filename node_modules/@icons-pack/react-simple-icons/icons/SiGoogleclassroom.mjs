...
const SiGoogleclassroom = React.forwardRef(function SiGoogleclassroom2({ title = "Google Classroom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
