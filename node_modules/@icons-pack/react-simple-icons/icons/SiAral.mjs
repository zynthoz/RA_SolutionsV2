...
const SiAral = React.forwardRef(function SiAral2({ title = "ARAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
