...
const defaultColor = "#013243";
const SiNumpy = React__namespace.forwardRef(function SiNumpy2({ title = "NumPy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
