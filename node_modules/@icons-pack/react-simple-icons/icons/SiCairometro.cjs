...
const defaultColor = "#C10C0C";
const SiCairometro = React__namespace.forwardRef(function SiCairometro2({ title = "Cairo Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
