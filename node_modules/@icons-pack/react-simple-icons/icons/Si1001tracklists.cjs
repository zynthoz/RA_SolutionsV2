...
const defaultColor = "#40AEF0";
const Si1001tracklists = React__namespace.forwardRef(function Si1001tracklists2({ title = "1001Tracklists", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
