...
const SiTeal = React.forwardRef(function SiTeal2({ title = "Teal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
