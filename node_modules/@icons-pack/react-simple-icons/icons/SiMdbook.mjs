...
const SiMdbook = React.forwardRef(function SiMdbook2({ title = "mdBook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
