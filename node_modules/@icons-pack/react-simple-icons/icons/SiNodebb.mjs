...
const SiNodebb = React.forwardRef(function SiNodebb2({ title = "NodeBB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
