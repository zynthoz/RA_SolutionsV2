...
const defaultColor = "#3EAAAF";
const SiTravisci = React.forwardRef(function SiTravisci2({ title = "Travis CI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
