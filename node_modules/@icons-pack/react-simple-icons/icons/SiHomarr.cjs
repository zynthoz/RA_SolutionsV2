...
const SiHomarr = React__namespace.forwardRef(function SiHomarr2({ title = "Homarr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
