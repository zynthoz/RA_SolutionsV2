...
const defaultColor = "#D4021D";
const SiOtto = React__namespace.forwardRef(function SiOtto2({ title = "Otto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
