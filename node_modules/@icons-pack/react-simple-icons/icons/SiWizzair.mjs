...
const SiWizzair = React.forwardRef(function SiWizzair2({ title = "Wizz Air", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
