...
const defaultColor = "#3BABFF";
const SiKrita = React__namespace.forwardRef(function SiKrita2({ title = "Krita", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
