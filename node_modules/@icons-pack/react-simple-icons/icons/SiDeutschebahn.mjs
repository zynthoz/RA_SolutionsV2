...
const SiDeutschebahn = React.forwardRef(function SiDeutschebahn2({ title = "Deutsche Bahn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
