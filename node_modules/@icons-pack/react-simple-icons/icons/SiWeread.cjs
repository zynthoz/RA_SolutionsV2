...
const SiWeread = React__namespace.forwardRef(function SiWeread2({ title = "WeRead", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
