...
const SiDazhongdianping = React.forwardRef(function SiDazhongdianping2({ title = "Dazhong Dianping", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
