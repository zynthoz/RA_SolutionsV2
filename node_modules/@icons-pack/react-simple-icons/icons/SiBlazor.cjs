...
const SiBlazor = React__namespace.forwardRef(function SiBlazor2({ title = "Blazor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
