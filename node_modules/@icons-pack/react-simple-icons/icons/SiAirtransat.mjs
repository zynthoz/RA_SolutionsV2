...
const SiAirtransat = React.forwardRef(function SiAirtransat2({ title = "Air Transat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
