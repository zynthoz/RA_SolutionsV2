...
const SiClaris = React__namespace.forwardRef(function SiClaris2({ title = "Claris", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
