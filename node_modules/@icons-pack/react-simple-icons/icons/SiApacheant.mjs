...
const SiApacheant = React.forwardRef(function SiApacheant2({ title = "Apache Ant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
