...
const SiDistrobox = React__namespace.forwardRef(function SiDistrobox2({ title = "Distrobox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
