...
const SiOpentofu = React__namespace.forwardRef(function SiOpentofu2({ title = "OpenTofu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
