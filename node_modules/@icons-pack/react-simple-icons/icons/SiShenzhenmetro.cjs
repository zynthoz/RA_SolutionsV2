...
const defaultColor = "#009943";
const SiShenzhenmetro = React__namespace.forwardRef(function SiShenzhenmetro2({ title = "Shenzhen Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
