...
const SiPlaystation3 = React__namespace.forwardRef(function SiPlaystation32({ title = "PlayStation 3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
