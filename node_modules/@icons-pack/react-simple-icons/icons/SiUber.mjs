...
const SiUber = React.forwardRef(function SiUber2({ title = "Uber", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
