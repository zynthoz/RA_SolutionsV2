...
const SiAmg = React.forwardRef(function SiAmg2({ title = "AMG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
