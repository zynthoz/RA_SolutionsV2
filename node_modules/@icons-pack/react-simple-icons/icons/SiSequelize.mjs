...
const SiSequelize = React.forwardRef(function SiSequelize2({ title = "Sequelize", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
