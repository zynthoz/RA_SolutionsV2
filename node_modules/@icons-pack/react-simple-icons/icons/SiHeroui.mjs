...
const SiHeroui = React.forwardRef(function SiHeroui2({ title = "HeroUI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
