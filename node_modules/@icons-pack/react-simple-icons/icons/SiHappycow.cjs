...
const SiHappycow = React__namespace.forwardRef(function SiHappycow2({ title = "HappyCow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
