...
const SiStartrek = React.forwardRef(function SiStartrek2({ title = "Star Trek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
