...
const SiTrimble = React.forwardRef(function SiTrimble2({ title = "Trimble", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
