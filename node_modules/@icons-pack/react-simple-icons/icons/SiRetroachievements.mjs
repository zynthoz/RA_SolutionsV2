...
const SiRetroachievements = React.forwardRef(function SiRetroachievements2({ title = "Retro Achievements", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
