...
const SiAndroidstudio = React.forwardRef(function SiAndroidstudio2({ title = "Android Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
