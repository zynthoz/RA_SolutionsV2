...
const SiIngress = React__namespace.forwardRef(function SiIngress2({ title = "Ingress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
