...
const defaultColor = "#721412";
const SiOpenssl = React__namespace.forwardRef(function SiOpenssl2({ title = "OpenSSL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
