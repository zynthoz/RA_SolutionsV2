...
const SiEgghead = React__namespace.forwardRef(function SiEgghead2({ title = "egghead", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
