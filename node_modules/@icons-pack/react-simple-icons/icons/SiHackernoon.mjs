...
const defaultColor = "#00FE00";
const SiHackernoon = React.forwardRef(function SiHackernoon2({ title = "Hacker Noon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
