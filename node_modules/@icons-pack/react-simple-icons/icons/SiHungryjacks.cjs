...
const SiHungryjacks = React__namespace.forwardRef(function SiHungryjacks2({ title = "Hungry Jacks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
