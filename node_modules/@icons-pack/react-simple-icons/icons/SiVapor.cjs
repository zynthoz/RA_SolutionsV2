...
const SiVapor = React__namespace.forwardRef(function SiVapor2({ title = "Vapor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
