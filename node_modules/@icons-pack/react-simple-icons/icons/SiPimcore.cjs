...
const defaultColor = "#6428B4";
const SiPimcore = React__namespace.forwardRef(function SiPimcore2({ title = "Pimcore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
