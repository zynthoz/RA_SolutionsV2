...
const SiTata = React.forwardRef(function SiTata2({ title = "Tata", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
