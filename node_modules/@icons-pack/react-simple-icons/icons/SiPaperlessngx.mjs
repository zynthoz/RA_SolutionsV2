...
const SiPaperlessngx = React.forwardRef(function SiPaperlessngx2({ title = "Paperless-ngx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
