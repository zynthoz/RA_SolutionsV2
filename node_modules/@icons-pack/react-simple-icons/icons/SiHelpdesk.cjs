...
const SiHelpdesk = React__namespace.forwardRef(function SiHelpdesk2({ title = "HelpDesk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
