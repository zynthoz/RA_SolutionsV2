...
const SiWire = React__namespace.forwardRef(function SiWire2({ title = "Wire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
