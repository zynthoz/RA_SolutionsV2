...
const SiDeepnote = React.forwardRef(function SiDeepnote2({ title = "Deepnote", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
