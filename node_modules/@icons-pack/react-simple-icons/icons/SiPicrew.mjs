...
const SiPicrew = React.forwardRef(function SiPicrew2({ title = "Picrew", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
