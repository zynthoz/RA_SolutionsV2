...
const SiPantheon = React.forwardRef(function SiPantheon2({ title = "Pantheon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
