...
const defaultColor = "#0FAAFF";
const SiSap = React__namespace.forwardRef(function SiSap2({ title = "SAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
