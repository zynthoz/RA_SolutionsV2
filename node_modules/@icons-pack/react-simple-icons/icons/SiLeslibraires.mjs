...
const defaultColor = "#CF4A0C";
const SiLeslibraires = React.forwardRef(function SiLeslibraires2({ title = "Les libraires", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
