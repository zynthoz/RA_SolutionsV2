...
const SiVictronenergy = React.forwardRef(function SiVictronenergy2({ title = "Victron Energy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
