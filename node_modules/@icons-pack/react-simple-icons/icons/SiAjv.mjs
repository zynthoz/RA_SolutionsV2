...
const SiAjv = React.forwardRef(function SiAjv2({ title = "Ajv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
