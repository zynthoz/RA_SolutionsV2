...
const SiBugatti = React__namespace.forwardRef(function SiBugatti2({ title = "Bugatti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
