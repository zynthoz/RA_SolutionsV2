...
const SiWasabi = React__namespace.forwardRef(function SiWasabi2({ title = "Wasabi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
