...
const defaultColor = "#F58220";
const SiIsro = React__namespace.forwardRef(function SiIsro2({ title = "ISRO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
