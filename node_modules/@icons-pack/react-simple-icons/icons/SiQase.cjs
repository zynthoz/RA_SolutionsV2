...
const defaultColor = "#4F46DC";
const SiQase = React__namespace.forwardRef(function SiQase2({ title = "Qase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
