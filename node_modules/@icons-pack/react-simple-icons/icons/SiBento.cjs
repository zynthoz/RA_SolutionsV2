...
const defaultColor = "#768CFF";
const SiBento = React__namespace.forwardRef(function SiBento2({ title = "Bento", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
