...
const SiTorproject = React__namespace.forwardRef(function SiTorproject2({ title = "Tor Project", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
