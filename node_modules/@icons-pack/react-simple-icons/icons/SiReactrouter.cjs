...
const defaultColor = "#CA4245";
const SiReactrouter = React__namespace.forwardRef(function SiReactrouter2({ title = "React Router", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
