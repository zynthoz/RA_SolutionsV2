...
const SiExordo = React.forwardRef(function SiExordo2({ title = "Exordo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
