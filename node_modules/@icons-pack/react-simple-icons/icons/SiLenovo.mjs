...
const SiLenovo = React.forwardRef(function SiLenovo2({ title = "Lenovo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
