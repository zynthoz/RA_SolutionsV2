...
const SiUml = React__namespace.forwardRef(function SiUml2({ title = "UML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
