...
const SiLineageos = React__namespace.forwardRef(function SiLineageos2({ title = "LineageOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
