...
const defaultColor = "#FD5200";
const SiJdoodle = React__namespace.forwardRef(function SiJdoodle2({ title = "JDoodle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
