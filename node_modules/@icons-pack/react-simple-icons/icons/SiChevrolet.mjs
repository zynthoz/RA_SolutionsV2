...
const SiChevrolet = React.forwardRef(function SiChevrolet2({ title = "Chevrolet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
