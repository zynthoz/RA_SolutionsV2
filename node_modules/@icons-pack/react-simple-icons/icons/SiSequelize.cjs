...
const SiSequelize = React__namespace.forwardRef(function SiSequelize2({ title = "Sequelize", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
