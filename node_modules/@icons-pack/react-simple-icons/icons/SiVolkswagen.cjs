...
const defaultColor = "#151F5D";
const SiVolkswagen = React__namespace.forwardRef(function SiVolkswagen2({ title = "Volkswagen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
