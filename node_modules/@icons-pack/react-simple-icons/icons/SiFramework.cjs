...
const SiFramework = React__namespace.forwardRef(function SiFramework2({ title = "Framework", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
