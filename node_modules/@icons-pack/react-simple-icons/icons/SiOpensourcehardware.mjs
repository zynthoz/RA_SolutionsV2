...
const SiOpensourcehardware = React.forwardRef(function SiOpensourcehardware2({ title = "Open Source Hardware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
