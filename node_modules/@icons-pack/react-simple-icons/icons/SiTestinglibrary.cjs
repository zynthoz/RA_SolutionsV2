...
const defaultColor = "#E33332";
const SiTestinglibrary = React__namespace.forwardRef(function SiTestinglibrary2({ title = "Testing Library", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
