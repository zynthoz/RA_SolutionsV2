...
const SiQuantconnect = React.forwardRef(function SiQuantconnect2({ title = "QuantConnect", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
