...
const SiThirdweb = React.forwardRef(function SiThirdweb2({ title = "thirdweb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
