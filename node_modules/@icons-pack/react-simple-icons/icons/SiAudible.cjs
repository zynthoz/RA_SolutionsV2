...
const defaultColor = "#F8991C";
const SiAudible = React__namespace.forwardRef(function SiAudible2({ title = "Audible", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
