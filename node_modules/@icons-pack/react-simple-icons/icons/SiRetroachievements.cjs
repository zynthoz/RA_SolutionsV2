...
const defaultColor = "#1065DF";
const SiRetroachievements = React__namespace.forwardRef(function SiRetroachievements2({ title = "Retro Achievements", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
