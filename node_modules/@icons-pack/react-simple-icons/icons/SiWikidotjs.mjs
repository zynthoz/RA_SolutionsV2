...
const SiWikidotjs = React.forwardRef(function SiWikidotjs2({ title = "Wiki.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
