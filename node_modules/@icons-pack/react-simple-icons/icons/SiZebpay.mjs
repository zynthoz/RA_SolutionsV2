...
const SiZebpay = React.forwardRef(function SiZebpay2({ title = "ZebPay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
