...
const defaultColor = "#149EF2";
const SiSololearn = React.forwardRef(function SiSololearn2({ title = "Sololearn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
