...
const defaultColor = "#FCC15E";
const SiTwinkly = React__namespace.forwardRef(function SiTwinkly2({ title = "Twinkly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
