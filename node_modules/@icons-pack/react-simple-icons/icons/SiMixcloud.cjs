...
const SiMixcloud = React__namespace.forwardRef(function SiMixcloud2({ title = "Mixcloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
