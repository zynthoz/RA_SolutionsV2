...
const SiHoppscotch = React.forwardRef(function SiHoppscotch2({ title = "Hoppscotch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
