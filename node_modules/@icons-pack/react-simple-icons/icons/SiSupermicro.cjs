...
const SiSupermicro = React__namespace.forwardRef(function SiSupermicro2({ title = "Supermicro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
