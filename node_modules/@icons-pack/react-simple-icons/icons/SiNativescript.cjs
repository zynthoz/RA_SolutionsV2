...
const SiNativescript = React__namespace.forwardRef(function SiNativescript2({ title = "NativeScript", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
