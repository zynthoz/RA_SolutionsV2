...
const SiAppmanager = React.forwardRef(function SiAppmanager2({ title = "AppManager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
