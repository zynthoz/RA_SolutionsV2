...
const SiQubesos = React__namespace.forwardRef(function SiQubesos2({ title = "Qubes OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
