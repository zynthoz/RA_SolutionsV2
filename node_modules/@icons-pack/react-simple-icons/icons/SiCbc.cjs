...
const SiCbc = React__namespace.forwardRef(function SiCbc2({ title = "CBC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
