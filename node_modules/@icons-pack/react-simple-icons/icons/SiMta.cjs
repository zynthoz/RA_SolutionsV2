...
const SiMta = React__namespace.forwardRef(function SiMta2({ title = "MTA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
