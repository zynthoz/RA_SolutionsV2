...
const defaultColor = "#4445E7";
const SiChainguard = React__namespace.forwardRef(function SiChainguard2({ title = "Chainguard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
