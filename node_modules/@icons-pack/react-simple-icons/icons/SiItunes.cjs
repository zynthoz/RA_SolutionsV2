...
const SiItunes = React__namespace.forwardRef(function SiItunes2({ title = "iTunes", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
