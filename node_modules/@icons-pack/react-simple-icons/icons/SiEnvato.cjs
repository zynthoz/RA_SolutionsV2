...
const defaultColor = "#87E64B";
const SiEnvato = React__namespace.forwardRef(function SiEnvato2({ title = "Envato", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
