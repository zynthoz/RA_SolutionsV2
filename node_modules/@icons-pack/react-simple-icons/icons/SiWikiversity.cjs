...
const SiWikiversity = React__namespace.forwardRef(function SiWikiversity2({ title = "Wikiversity", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
