...
const SiPulumi = React.forwardRef(function SiPulumi2({ title = "Pulumi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
