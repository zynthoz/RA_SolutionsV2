...
const SiMoonrepo = React.forwardRef(function SiMoonrepo2({ title = "Moonrepo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
