...
const defaultColor = "#0075C9";
const SiOpenjsfoundation = React__namespace.forwardRef(function SiOpenjsfoundation2({ title = "OpenJS Foundation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
