...
const SiTrivy = React__namespace.forwardRef(function SiTrivy2({ title = "Trivy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
