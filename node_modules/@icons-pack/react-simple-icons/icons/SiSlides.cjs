...
const SiSlides = React__namespace.forwardRef(function SiSlides2({ title = "Slides", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
