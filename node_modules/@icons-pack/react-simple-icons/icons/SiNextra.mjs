...
const SiNextra = React.forwardRef(function SiNextra2({ title = "Nextra", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
