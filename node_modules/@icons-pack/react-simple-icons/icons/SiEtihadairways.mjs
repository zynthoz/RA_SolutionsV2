...
const SiEtihadairways = React.forwardRef(function SiEtihadairways2({ title = "Etihad Airways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
