...
const defaultColor = "#9147FF";
const SiIgdb = React__namespace.forwardRef(function SiIgdb2({ title = "IGDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
