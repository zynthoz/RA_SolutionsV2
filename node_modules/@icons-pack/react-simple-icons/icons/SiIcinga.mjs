...
const SiIcinga = React.forwardRef(function SiIcinga2({ title = "Icinga", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
