...
const SiApacheopenoffice = React__namespace.forwardRef(function SiApacheopenoffice2({ title = "Apache OpenOffice", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
