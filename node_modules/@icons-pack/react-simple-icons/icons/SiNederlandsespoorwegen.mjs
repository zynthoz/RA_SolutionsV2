...
const SiNederlandsespoorwegen = React.forwardRef(function SiNederlandsespoorwegen2({ title = "Nederlandse Spoorwegen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
