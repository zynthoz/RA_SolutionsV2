...
const defaultColor = "#3DC08D";
const SiKdeneon = React__namespace.forwardRef(function SiKdeneon2({ title = "KDE neon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
