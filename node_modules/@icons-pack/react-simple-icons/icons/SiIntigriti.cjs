...
const defaultColor = "#161A36";
const SiIntigriti = React__namespace.forwardRef(function SiIntigriti2({ title = "Intigriti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
