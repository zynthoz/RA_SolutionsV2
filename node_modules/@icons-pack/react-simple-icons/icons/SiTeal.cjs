...
const SiTeal = React__namespace.forwardRef(function SiTeal2({ title = "Teal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
