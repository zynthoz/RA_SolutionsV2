...
const SiVexxhost = React__namespace.forwardRef(function SiVexxhost2({ title = "VEXXHOST", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
