...
const SiRevenuecat = React.forwardRef(function SiRevenuecat2({ title = "RevenueCat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
