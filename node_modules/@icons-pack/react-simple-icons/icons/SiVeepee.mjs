...
const SiVeepee = React.forwardRef(function SiVeepee2({ title = "Veepee", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
