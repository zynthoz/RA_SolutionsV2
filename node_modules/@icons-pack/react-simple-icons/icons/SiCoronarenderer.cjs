...
const SiCoronarenderer = React__namespace.forwardRef(function SiCoronarenderer2({ title = "Corona Renderer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
