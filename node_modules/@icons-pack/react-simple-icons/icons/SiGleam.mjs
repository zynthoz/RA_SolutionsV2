...
const SiGleam = React.forwardRef(function SiGleam2({ title = "Gleam", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
