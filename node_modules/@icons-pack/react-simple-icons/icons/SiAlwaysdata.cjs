...
const SiAlwaysdata = React__namespace.forwardRef(function SiAlwaysdata2({ title = "Alwaysdata", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
