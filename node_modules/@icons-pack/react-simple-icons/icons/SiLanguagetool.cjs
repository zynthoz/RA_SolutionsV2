...
const defaultColor = "#45A1FC";
const SiLanguagetool = React__namespace.forwardRef(function SiLanguagetool2({ title = "LanguageTool", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
