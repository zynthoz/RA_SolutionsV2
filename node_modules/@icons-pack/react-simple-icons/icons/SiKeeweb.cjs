...
const defaultColor = "#528BFF";
const SiKeeweb = React__namespace.forwardRef(function SiKeeweb2({ title = "KeeWeb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
