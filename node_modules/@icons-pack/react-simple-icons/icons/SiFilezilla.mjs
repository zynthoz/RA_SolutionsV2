...
const SiFilezilla = React.forwardRef(function SiFilezilla2({ title = "FileZilla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
