...
const SiPoly = React__namespace.forwardRef(function SiPoly2({ title = "Poly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
