...
const SiLinkerd = React.forwardRef(function SiLinkerd2({ title = "Linkerd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
