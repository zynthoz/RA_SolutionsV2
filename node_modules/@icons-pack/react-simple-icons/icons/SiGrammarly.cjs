...
const SiGrammarly = React__namespace.forwardRef(function SiGrammarly2({ title = "Grammarly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
