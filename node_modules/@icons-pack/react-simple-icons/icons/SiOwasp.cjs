...
const SiOwasp = React__namespace.forwardRef(function SiOwasp2({ title = "OWASP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
