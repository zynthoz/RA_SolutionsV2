...
const SiEcovacs = React.forwardRef(function SiEcovacs2({ title = "Ecovacs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
