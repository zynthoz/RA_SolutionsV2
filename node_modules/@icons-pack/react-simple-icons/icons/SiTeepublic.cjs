...
const SiTeepublic = React__namespace.forwardRef(function SiTeepublic2({ title = "TeePublic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
