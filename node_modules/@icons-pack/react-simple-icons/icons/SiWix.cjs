...
const defaultColor = "#0C6EFC";
const SiWix = React__namespace.forwardRef(function SiWix2({ title = "Wix", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
