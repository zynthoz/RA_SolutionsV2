...
const SiAvianca = React.forwardRef(function SiAvianca2({ title = "avianca", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
