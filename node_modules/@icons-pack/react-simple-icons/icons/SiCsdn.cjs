...
const defaultColor = "#FC5531";
const SiCsdn = React__namespace.forwardRef(function SiCsdn2({ title = "CSDN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
