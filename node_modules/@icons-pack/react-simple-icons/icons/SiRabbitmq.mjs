...
const SiRabbitmq = React.forwardRef(function SiRabbitmq2({ title = "RabbitMQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
