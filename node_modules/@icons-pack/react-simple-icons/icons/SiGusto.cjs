...
const defaultColor = "#F45D48";
const SiGusto = React__namespace.forwardRef(function SiGusto2({ title = "Gusto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
