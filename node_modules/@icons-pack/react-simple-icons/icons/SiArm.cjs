...
const defaultColor = "#0091BD";
const SiArm = React__namespace.forwardRef(function SiArm2({ title = "Arm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
