...
const SiTicketmaster = React.forwardRef(function SiTicketmaster2({ title = "Ticketmaster", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
