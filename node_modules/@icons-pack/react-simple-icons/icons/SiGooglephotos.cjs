...
const SiGooglephotos = React__namespace.forwardRef(function SiGooglephotos2({ title = "Google Photos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
