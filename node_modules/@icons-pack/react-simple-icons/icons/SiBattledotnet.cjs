...
const defaultColor = "#4381C3";
const SiBattledotnet = React__namespace.forwardRef(function SiBattledotnet2({ title = "Battle.net", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
