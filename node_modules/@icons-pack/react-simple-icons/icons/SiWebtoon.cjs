...
const SiWebtoon = React__namespace.forwardRef(function SiWebtoon2({ title = "WEBTOON", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
