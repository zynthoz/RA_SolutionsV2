...
const SiRedmine = React.forwardRef(function SiRedmine2({ title = "Redmine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
