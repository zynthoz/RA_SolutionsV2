...
const defaultColor = "#31369E";
const SiBat = React__namespace.forwardRef(function SiBat2({ title = "bat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
