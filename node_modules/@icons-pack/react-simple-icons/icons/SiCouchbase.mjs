...
const SiCouchbase = React.forwardRef(function SiCouchbase2({ title = "Couchbase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
