...
const defaultColor = "#E30E17";
const SiAirchina = React__namespace.forwardRef(function SiAirchina2({ title = "Air China", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
