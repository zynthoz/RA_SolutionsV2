...
const SiCloudnativebuild = React.forwardRef(function SiCloudnativebuild2({ title = "Cloud Native Build", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
