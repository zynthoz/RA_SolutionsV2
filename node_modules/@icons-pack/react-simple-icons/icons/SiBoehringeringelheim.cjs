...
const SiBoehringeringelheim = React__namespace.forwardRef(function SiBoehringeringelheim2({ title = "Boehringer Ingelheim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
