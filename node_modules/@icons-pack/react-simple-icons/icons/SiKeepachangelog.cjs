...
const SiKeepachangelog = React__namespace.forwardRef(function SiKeepachangelog2({ title = "Keep a Changelog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
