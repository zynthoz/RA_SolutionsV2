...
const defaultColor = "#FE0803";
const SiTypeorm = React__namespace.forwardRef(function SiTypeorm2({ title = "TypeORM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
