...
const defaultColor = "#003399";
const SiEpson = React__namespace.forwardRef(function SiEpson2({ title = "Epson", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
