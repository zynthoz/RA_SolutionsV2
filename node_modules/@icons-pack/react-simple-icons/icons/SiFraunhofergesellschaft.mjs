...
const SiFraunhofergesellschaft = React.forwardRef(function SiFraunhofergesellschaft2({ title = "Fraunhofer-Gesellschaft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
