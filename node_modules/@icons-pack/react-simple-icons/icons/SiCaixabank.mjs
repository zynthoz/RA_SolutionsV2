...
const SiCaixabank = React.forwardRef(function SiCaixabank2({ title = "CaixaBank", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
