...
const SiGojek = React.forwardRef(function SiGojek2({ title = "Gojek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
