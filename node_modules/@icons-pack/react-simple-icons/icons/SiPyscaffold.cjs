...
const defaultColor = "#005CA0";
const SiPyscaffold = React__namespace.forwardRef(function SiPyscaffold2({ title = "PyScaffold", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
