...
const SiSubversion = React.forwardRef(function SiSubversion2({ title = "Subversion", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
