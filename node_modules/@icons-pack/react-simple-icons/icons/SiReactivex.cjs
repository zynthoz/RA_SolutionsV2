...
const defaultColor = "#B7178C";
const SiReactivex = React__namespace.forwardRef(function SiReactivex2({ title = "ReactiveX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
