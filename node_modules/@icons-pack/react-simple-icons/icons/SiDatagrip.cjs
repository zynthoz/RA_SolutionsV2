...
const SiDatagrip = React__namespace.forwardRef(function SiDatagrip2({ title = "DataGrip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
