...
const defaultColor = "#1477D1";
const SiTinkercad = React__namespace.forwardRef(function SiTinkercad2({ title = "Tinkercad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
