...
const SiHiltonhotelsandresorts = React.forwardRef(function SiHiltonhotelsandresorts2({ title = "Hilton Hotels & Resorts", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
