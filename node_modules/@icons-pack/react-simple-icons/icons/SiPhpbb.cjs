...
const SiPhpbb = React__namespace.forwardRef(function SiPhpbb2({ title = "phpBB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
