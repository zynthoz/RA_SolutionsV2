...
const SiJetblue = React__namespace.forwardRef(function SiJetblue2({ title = "JetBlue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
