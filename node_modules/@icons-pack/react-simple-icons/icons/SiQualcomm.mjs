...
const SiQualcomm = React.forwardRef(function SiQualcomm2({ title = "Qualcomm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
