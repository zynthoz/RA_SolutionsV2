...
const SiRepublicofgamers = React.forwardRef(function SiRepublicofgamers2({ title = "Republic of Gamers", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
