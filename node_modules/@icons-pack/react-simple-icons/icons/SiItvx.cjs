...
const SiItvx = React__namespace.forwardRef(function SiItvx2({ title = "ITVx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
