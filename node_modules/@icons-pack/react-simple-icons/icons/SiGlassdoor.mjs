...
const SiGlassdoor = React.forwardRef(function SiGlassdoor2({ title = "Glassdoor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
