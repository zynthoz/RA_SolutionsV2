...
const SiPadlet = React__namespace.forwardRef(function SiPadlet2({ title = "Padlet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
