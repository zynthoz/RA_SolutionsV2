...
const defaultColor = "#039CB2";
const SiImagedotsc = React__namespace.forwardRef(function SiImagedotsc2({ title = "Image.sc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
