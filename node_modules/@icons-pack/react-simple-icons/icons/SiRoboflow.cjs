...
const defaultColor = "#6706CE";
const SiRoboflow = React__namespace.forwardRef(function SiRoboflow2({ title = "Roboflow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
