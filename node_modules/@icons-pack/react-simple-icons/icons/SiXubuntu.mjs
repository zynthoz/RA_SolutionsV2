...
const SiXubuntu = React.forwardRef(function SiXubuntu2({ title = "Xubuntu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
