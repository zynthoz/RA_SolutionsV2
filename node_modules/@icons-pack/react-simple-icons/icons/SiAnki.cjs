...
const defaultColor = "#80C2EE";
const SiAnki = React__namespace.forwardRef(function SiAnki2({ title = "Anki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
