...
const SiN26 = React.forwardRef(function SiN262({ title = "N26", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
