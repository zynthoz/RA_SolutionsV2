...
const SiTheirishtimes = React__namespace.forwardRef(function SiTheirishtimes2({ title = "The Irish Times", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
