...
const SiSemanticscholar = React.forwardRef(function SiSemanticscholar2({ title = "Semantic Scholar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
