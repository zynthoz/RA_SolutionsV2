...
const defaultColor = "#E61845";
const SiCora = React.forwardRef(function SiCora2({ title = "Cora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
