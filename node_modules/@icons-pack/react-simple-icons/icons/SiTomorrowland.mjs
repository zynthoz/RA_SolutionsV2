...
const SiTomorrowland = React.forwardRef(function SiTomorrowland2({ title = "Tomorrowland", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
