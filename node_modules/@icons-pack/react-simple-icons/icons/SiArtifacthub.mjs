...
const SiArtifacthub = React.forwardRef(function SiArtifacthub2({ title = "Artifact Hub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
