...
const defaultColor = "#006C66";
const SiMaxplanckgesellschaft = React__namespace.forwardRef(function SiMaxplanckgesellschaft2({ title = "Max-Planck-Gesellschaft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
