...
const defaultColor = "#01FF95";
const SiBeatport = React__namespace.forwardRef(function SiBeatport2({ title = "Beatport", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
