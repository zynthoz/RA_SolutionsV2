...
const SiNec = React__namespace.forwardRef(function SiNec2({ title = "NEC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
