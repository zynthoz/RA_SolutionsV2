...
const SiJoomla = React.forwardRef(function SiJoomla2({ title = "Joomla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
