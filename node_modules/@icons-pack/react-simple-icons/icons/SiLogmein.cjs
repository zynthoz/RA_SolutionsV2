...
const defaultColor = "#45B6F2";
const SiLogmein = React__namespace.forwardRef(function SiLogmein2({ title = "LogMeIn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
