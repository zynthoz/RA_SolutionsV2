...
const SiFuraffinity = React__namespace.forwardRef(function SiFuraffinity2({ title = "Fur Affinity", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
