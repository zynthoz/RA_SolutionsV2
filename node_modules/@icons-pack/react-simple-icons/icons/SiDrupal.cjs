...
const defaultColor = "#0678BE";
const SiDrupal = React__namespace.forwardRef(function SiDrupal2({ title = "Drupal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
