...
const defaultColor = "#3448C5";
const SiCloudinary = React__namespace.forwardRef(function SiCloudinary2({ title = "Cloudinary", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
