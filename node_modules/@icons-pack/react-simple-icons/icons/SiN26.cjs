...
const defaultColor = "#48AC98";
const SiN26 = React__namespace.forwardRef(function SiN262({ title = "N26", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
