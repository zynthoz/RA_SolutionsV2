...
const defaultColor = "#F04D35";
const SiMongoosedotws = React__namespace.forwardRef(function SiMongoosedotws2({ title = "Mongoose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
