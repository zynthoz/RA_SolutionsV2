...
const SiDaf = React__namespace.forwardRef(function SiDaf2({ title = "DAF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
