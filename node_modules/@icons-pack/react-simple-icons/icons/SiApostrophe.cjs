...
const defaultColor = "#6236FF";
const SiApostrophe = React__namespace.forwardRef(function SiApostrophe2({ title = "Apostrophe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
