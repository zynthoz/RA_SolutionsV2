...
const SiEtcd = React.forwardRef(function SiEtcd2({ title = "etcd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
