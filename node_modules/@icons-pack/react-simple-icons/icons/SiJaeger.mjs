...
const SiJaeger = React.forwardRef(function SiJaeger2({ title = "Jaeger", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
