...
const SiPterodactyl = React.forwardRef(function SiPterodactyl2({ title = "Pterodactyl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
