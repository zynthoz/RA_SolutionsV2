...
const SiRoot = React.forwardRef(function SiRoot2({ title = "ROOT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
