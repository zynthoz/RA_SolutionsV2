...
const SiArm = React.forwardRef(function SiArm2({ title = "Arm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
