...
const SiSepa = React__namespace.forwardRef(function SiSepa2({ title = "SEPA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
