...
const SiSetuptools = React__namespace.forwardRef(function SiSetuptools2({ title = "Setuptools", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
