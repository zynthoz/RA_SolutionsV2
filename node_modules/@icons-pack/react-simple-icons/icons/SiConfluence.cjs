...
const SiConfluence = React__namespace.forwardRef(function SiConfluence2({ title = "Confluence", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
