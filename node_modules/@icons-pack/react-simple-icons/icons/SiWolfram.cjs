...
const SiWolfram = React__namespace.forwardRef(function SiWolfram2({ title = "Wolfram", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
