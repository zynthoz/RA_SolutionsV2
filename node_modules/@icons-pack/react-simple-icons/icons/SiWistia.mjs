...
const defaultColor = "#58B7FE";
const SiWistia = React.forwardRef(function SiWistia2({ title = "Wistia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
