...
const defaultColor = "#003648";
const SiCodementor = React__namespace.forwardRef(function SiCodementor2({ title = "Codementor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
