...
const SiPagespeedinsights = React.forwardRef(function SiPagespeedinsights2({ title = "PageSpeed Insights", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
