...
const defaultColor = "#FF791A";
const SiSonicwall = React__namespace.forwardRef(function SiSonicwall2({ title = "SonicWall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
