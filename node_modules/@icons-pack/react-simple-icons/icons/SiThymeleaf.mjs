...
const defaultColor = "#005F0F";
const SiThymeleaf = React.forwardRef(function SiThymeleaf2({ title = "Thymeleaf", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
