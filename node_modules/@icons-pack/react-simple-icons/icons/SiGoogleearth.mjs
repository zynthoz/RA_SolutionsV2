...
const SiGoogleearth = React.forwardRef(function SiGoogleearth2({ title = "Google Earth", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
