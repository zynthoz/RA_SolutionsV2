...
const SiDeepmind = React.forwardRef(function SiDeepmind2({ title = "DeepMind", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
