...
const defaultColor = "#FAA918";
const SiGrunt = React.forwardRef(function SiGrunt2({ title = "Grunt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiGrunt as default, defaultColor };
