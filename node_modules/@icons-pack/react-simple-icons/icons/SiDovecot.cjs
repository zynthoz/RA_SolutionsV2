...
const SiDovecot = React__namespace.forwardRef(function SiDovecot2({ title = "Dovecot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
