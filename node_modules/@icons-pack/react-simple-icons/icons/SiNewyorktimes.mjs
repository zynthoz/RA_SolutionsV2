...
const SiNewyorktimes = React.forwardRef(function SiNewyorktimes2({ title = "New York Times", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
