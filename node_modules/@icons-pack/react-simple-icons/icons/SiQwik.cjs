...
const defaultColor = "#AC7EF4";
const SiQwik = React__namespace.forwardRef(function SiQwik2({ title = "Qwik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
