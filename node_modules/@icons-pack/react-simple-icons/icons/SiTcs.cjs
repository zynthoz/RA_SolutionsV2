...
const SiTcs = React__namespace.forwardRef(function SiTcs2({ title = "Tata Consultancy Services", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
