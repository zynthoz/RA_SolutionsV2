...
const defaultColor = "#00B4F0";
const SiVaadin = React.forwardRef(function SiVaadin2({ title = "Vaadin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
