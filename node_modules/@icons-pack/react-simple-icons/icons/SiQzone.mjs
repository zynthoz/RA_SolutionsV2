...
const SiQzone = React.forwardRef(function SiQzone2({ title = "Qzone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
