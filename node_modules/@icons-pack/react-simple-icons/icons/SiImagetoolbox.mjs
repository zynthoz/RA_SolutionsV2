...
const SiImagetoolbox = React.forwardRef(function SiImagetoolbox2({ title = "Image Toolbox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
