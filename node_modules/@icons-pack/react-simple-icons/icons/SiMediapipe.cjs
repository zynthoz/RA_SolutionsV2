...
const defaultColor = "#0097A7";
const SiMediapipe = React__namespace.forwardRef(function SiMediapipe2({ title = "MediaPipe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
