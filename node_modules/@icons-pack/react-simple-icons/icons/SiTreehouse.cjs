...
const defaultColor = "#5FCF80";
const SiTreehouse = React__namespace.forwardRef(function SiTreehouse2({ title = "Treehouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
