...
const defaultColor = "#D2BCFD";
const SiObtainium = React__namespace.forwardRef(function SiObtainium2({ title = "Obtainium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
