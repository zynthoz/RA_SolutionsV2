...
const defaultColor = "#2CB9F1";
const SiOsf = React__namespace.forwardRef(function SiOsf2({ title = "OSF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
