...
const defaultColor = "#002873";
const SiSoftpedia = React__namespace.forwardRef(function SiSoftpedia2({ title = "Softpedia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
