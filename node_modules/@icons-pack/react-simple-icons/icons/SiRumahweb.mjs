...
const SiRumahweb = React.forwardRef(function SiRumahweb2({ title = "Rumahweb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
