...
const SiFrontify = React__namespace.forwardRef(function SiFrontify2({ title = "Frontify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
