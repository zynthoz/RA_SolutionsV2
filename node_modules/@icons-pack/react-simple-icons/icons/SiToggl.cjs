...
const SiToggl = React__namespace.forwardRef(function SiToggl2({ title = "Toggl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
