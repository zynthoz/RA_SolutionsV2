...
const SiJunipernetworks = React.forwardRef(function SiJunipernetworks2({ title = "Juniper Networks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
