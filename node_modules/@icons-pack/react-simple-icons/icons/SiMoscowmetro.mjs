...
const SiMoscowmetro = React.forwardRef(function SiMoscowmetro2({ title = "Moscow Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
