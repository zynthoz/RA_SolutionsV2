...
const SiMini = React.forwardRef(function SiMini2({ title = "Mini", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
