...
const SiKasasmart = React.forwardRef(function SiKasasmart2({ title = "Kasa Smart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
