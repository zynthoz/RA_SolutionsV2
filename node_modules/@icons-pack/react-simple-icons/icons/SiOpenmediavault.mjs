...
const defaultColor = "#5DACDF";
const SiOpenmediavault = React.forwardRef(function SiOpenmediavault2({ title = "openmediavault", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
