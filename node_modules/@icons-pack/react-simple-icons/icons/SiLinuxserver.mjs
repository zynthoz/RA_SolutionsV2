...
const SiLinuxserver = React.forwardRef(function SiLinuxserver2({ title = "LinuxServer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
