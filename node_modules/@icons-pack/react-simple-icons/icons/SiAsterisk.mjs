...
const defaultColor = "#F68F1E";
const SiAsterisk = React.forwardRef(function SiAsterisk2({ title = "Asterisk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
