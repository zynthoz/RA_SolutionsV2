...
const defaultColor = "#96060C";
const SiPihole = React__namespace.forwardRef(function SiPihole2({ title = "Pi-hole", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
