...
const SiNbc = React__namespace.forwardRef(function SiNbc2({ title = "NBC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
