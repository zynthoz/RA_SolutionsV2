...
const SiCodeceptjs = React__namespace.forwardRef(function SiCodeceptjs2({ title = "CodeceptJS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
