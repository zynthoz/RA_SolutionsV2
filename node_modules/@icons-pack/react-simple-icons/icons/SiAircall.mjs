...
const SiAircall = React.forwardRef(function SiAircall2({ title = "Aircall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
