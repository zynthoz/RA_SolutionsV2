...
const defaultColor = "#44C1C5";
const SiPrevention = React__namespace.forwardRef(function SiPrevention2({ title = "Prevention", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
