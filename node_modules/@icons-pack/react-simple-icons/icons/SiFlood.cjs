...
const SiFlood = React__namespace.forwardRef(function SiFlood2({ title = "Flood", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
