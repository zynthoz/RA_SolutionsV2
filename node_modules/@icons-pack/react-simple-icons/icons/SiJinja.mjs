...
const SiJinja = React.forwardRef(function SiJinja2({ title = "Jinja", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
