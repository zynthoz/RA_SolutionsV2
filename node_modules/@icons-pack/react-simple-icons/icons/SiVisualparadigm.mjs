...
const SiVisualparadigm = React.forwardRef(function SiVisualparadigm2({ title = "Visual Paradigm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
