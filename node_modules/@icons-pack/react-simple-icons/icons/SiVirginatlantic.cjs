...
const defaultColor = "#DA0530";
const SiVirginatlantic = React__namespace.forwardRef(function SiVirginatlantic2({ title = "Virgin Atlantic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
