...
const SiCoze = React__namespace.forwardRef(function SiCoze2({ title = "Coze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
