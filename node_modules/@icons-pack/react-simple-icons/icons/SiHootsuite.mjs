...
const SiHootsuite = React.forwardRef(function SiHootsuite2({ title = "Hootsuite", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
