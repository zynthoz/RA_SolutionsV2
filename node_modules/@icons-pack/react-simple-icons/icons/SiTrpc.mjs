...
const SiTrpc = React.forwardRef(function SiTrpc2({ title = "tRPC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
