...
const SiGnu = React__namespace.forwardRef(function SiGnu2({ title = "GNU", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
