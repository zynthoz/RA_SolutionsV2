...
const SiGoogledisplayandvideo360 = React__namespace.forwardRef(function SiGoogledisplayandvideo3602({ title = "Google Display & Video 360", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
