...
const SiLazyvim = React.forwardRef(function SiLazyvim2({ title = "LazyVim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
