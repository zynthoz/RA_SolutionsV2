...
const SiRocksdb = React__namespace.forwardRef(function SiRocksdb2({ title = "RocksDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
