...
const defaultColor = "#0089CF";
const SiSega = React__namespace.forwardRef(function SiSega2({ title = "Sega", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
