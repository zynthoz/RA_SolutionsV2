...
const defaultColor = "#F01414";
const SiDeutschebahn = React__namespace.forwardRef(function SiDeutschebahn2({ title = "Deutsche Bahn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
