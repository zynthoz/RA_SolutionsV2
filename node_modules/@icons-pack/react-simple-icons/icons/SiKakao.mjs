...
const SiKakao = React.forwardRef(function SiKakao2({ title = "Kakao", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
