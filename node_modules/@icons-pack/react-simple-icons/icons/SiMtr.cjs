...
const SiMtr = React__namespace.forwardRef(function SiMtr2({ title = "MTR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
