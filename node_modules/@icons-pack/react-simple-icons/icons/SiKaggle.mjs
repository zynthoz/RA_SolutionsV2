...
const defaultColor = "#20BEFF";
const SiKaggle = React.forwardRef(function SiKaggle2({ title = "Kaggle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
