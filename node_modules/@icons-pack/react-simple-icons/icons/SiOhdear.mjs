...
const defaultColor = "#FF3900";
const SiOhdear = React.forwardRef(function SiOhdear2({ title = "Oh Dear", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
