...
const SiBreaker = React__namespace.forwardRef(function SiBreaker2({ title = "Breaker", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
