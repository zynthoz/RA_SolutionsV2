...
const SiDerspiegel = React.forwardRef(function SiDerspiegel2({ title = "Der Spiegel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
