...
const SiPysyft = React.forwardRef(function SiPysyft2({ title = "PySyft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
