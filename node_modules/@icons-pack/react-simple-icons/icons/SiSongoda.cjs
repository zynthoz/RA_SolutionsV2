...
const defaultColor = "#FC494A";
const SiSongoda = React__namespace.forwardRef(function SiSongoda2({ title = "Songoda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
