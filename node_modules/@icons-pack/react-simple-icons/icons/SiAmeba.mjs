...
const SiAmeba = React.forwardRef(function SiAmeba2({ title = "Ameba", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
