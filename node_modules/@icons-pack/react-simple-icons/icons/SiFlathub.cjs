...
const SiFlathub = React__namespace.forwardRef(function SiFlathub2({ title = "Flathub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
