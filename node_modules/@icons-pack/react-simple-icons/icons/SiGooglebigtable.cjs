...
const SiGooglebigtable = React__namespace.forwardRef(function SiGooglebigtable2({ title = "Google Bigtable", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
