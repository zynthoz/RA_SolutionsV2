...
const defaultColor = "#3423A6";
const SiWebauthn = React__namespace.forwardRef(function SiWebauthn2({ title = "WebAuthn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
