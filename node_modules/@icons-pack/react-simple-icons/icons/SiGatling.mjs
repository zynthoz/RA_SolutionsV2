...
const SiGatling = React.forwardRef(function SiGatling2({ title = "Gatling", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
