...
const SiCoreboot = React__namespace.forwardRef(function SiCoreboot2({ title = "Coreboot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
