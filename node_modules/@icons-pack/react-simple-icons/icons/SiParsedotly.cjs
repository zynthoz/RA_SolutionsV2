...
const SiParsedotly = React__namespace.forwardRef(function SiParsedotly2({ title = "Parse.ly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
