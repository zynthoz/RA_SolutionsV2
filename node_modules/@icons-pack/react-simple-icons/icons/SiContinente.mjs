...
const SiContinente = React.forwardRef(function SiContinente2({ title = "Continente", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
