...
const SiJunit5 = React.forwardRef(function SiJunit52({ title = "JUnit5", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
