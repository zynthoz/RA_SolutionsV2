...
const defaultColor = "#DB44B8";
const SiInfracost = React__namespace.forwardRef(function SiInfracost2({ title = "Infracost", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
