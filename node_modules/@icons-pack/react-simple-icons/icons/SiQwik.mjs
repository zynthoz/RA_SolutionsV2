...
const SiQwik = React.forwardRef(function SiQwik2({ title = "Qwik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
