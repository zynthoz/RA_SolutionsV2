...
const SiCaddy = React.forwardRef(function SiCaddy2({ title = "Caddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
