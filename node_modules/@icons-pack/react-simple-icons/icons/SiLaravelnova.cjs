...
const SiLaravelnova = React__namespace.forwardRef(function SiLaravelnova2({ title = "Laravel Nova", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
