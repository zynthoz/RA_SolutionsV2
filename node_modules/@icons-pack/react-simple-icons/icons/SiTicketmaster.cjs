...
const defaultColor = "#026CDF";
const SiTicketmaster = React__namespace.forwardRef(function SiTicketmaster2({ title = "Ticketmaster", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
