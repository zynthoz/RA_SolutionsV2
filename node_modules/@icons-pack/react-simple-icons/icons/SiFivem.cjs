...
const SiFivem = React__namespace.forwardRef(function SiFivem2({ title = "FiveM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
