...
const SiTeradata = React.forwardRef(function SiTeradata2({ title = "Teradata", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
