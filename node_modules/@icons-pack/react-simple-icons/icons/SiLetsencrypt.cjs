...
const SiLetsencrypt = React__namespace.forwardRef(function SiLetsencrypt2({ title = "Lets Encrypt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
