...
const SiOclc = React__namespace.forwardRef(function SiOclc2({ title = "OCLC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
