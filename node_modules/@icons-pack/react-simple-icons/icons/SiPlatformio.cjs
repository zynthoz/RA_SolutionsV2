...
const SiPlatformio = React__namespace.forwardRef(function SiPlatformio2({ title = "PlatformIO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
