...
const SiEns = React.forwardRef(function SiEns2({ title = "ENS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
