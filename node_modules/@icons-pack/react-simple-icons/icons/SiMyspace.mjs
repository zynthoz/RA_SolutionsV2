...
const SiMyspace = React.forwardRef(function SiMyspace2({ title = "Myspace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
