...
const defaultColor = "#5455FE";
const SiUnicode = React__namespace.forwardRef(function SiUnicode2({ title = "Unicode", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
