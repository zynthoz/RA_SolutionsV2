...
const defaultColor = "#BBDDE5";
const SiGitbook = React__namespace.forwardRef(function SiGitbook2({ title = "GitBook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
