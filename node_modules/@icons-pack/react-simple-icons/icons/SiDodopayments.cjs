...
const SiDodopayments = React__namespace.forwardRef(function SiDodopayments2({ title = "Dodo Payments", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiDodopayments;
