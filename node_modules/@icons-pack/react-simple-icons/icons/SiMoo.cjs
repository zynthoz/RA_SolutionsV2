...
const defaultColor = "#00945E";
const SiMoo = React__namespace.forwardRef(function SiMoo2({ title = "Moo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
