...
const defaultColor = "#006CFF";
const SiSafari = React__namespace.forwardRef(function SiSafari2({ title = "Safari", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
