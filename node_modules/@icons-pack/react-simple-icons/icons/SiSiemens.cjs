...
const defaultColor = "#009999";
const SiSiemens = React__namespace.forwardRef(function SiSiemens2({ title = "Siemens", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
