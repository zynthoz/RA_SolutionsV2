...
const defaultColor = "#C6002B";
const SiIheartradio = React__namespace.forwardRef(function SiIheartradio2({ title = "iHeartRadio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
