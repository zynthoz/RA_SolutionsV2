...
const SiKoa = React.forwardRef(function SiKoa2({ title = "Koa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
