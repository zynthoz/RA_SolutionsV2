...
const SiCsdn = React.forwardRef(function SiCsdn2({ title = "CSDN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
