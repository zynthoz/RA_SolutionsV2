...
const SiWebmoney = React.forwardRef(function SiWebmoney2({ title = "WebMoney", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
