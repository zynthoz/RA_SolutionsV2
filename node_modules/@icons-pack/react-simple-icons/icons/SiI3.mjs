...
const defaultColor = "#52C0FF";
const SiI3 = React.forwardRef(function SiI32({ title = "i3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
