...
const defaultColor = "#DC0D15";
const SiCdprojekt = React.forwardRef(function SiCdprojekt2({ title = "CD Projekt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
