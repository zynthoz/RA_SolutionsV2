...
const SiPolars = React__namespace.forwardRef(function SiPolars2({ title = "Polars", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
