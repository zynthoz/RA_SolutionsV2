...
const defaultColor = "#1FB6FF";
const SiMarvelapp = React__namespace.forwardRef(function SiMarvelapp2({ title = "MarvelApp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
