...
const SiTextpattern = React.forwardRef(function SiTextpattern2({ title = "Textpattern", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
