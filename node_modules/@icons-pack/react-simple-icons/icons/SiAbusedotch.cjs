...
const defaultColor = "#00465B";
const SiAbusedotch = React__namespace.forwardRef(function SiAbusedotch2({ title = "abuse.ch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
