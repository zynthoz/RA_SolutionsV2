...
const SiThewashingtonpost = React.forwardRef(function SiThewashingtonpost2({ title = "The Washington Post", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
