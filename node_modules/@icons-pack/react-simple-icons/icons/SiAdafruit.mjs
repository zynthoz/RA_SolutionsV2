...
const SiAdafruit = React.forwardRef(function SiAdafruit2({ title = "Adafruit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
