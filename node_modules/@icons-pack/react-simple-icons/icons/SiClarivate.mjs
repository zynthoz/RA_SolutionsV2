...
const SiClarivate = React.forwardRef(function SiClarivate2({ title = "Clarivate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
