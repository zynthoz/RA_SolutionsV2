...
const SiHaystack = React__namespace.forwardRef(function SiHaystack2({ title = "Haystack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
