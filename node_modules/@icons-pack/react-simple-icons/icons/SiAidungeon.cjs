...
const SiAidungeon = React__namespace.forwardRef(function SiAidungeon2({ title = "AI Dungeon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
