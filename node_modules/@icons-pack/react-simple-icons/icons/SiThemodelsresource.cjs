...
const SiThemodelsresource = React__namespace.forwardRef(function SiThemodelsresource2({ title = "The Models Resource", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
