...
const SiFanfou = React__namespace.forwardRef(function SiFanfou2({ title = "Fanfou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
