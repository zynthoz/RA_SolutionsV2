...
const SiFloatplane = React__namespace.forwardRef(function SiFloatplane2({ title = "Floatplane", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
