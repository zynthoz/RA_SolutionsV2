...
const SiSourceengine = React.forwardRef(function SiSourceengine2({ title = "Source Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
