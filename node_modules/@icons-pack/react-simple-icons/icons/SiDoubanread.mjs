...
const SiDoubanread = React.forwardRef(function SiDoubanread2({ title = "Douban Read", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
