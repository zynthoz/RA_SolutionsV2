...
const SiOppo = React__namespace.forwardRef(function SiOppo2({ title = "OPPO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
