...
const SiTarteaucitron = React__namespace.forwardRef(function SiTarteaucitron2({ title = "Tarteaucitron", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
