...
const defaultColor = "#4D9FE7";
const SiProtocolsdotio = React__namespace.forwardRef(function SiProtocolsdotio2({ title = "protocols.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
