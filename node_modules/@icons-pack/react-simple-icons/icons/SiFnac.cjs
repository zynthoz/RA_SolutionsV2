...
const defaultColor = "#E1A925";
const SiFnac = React__namespace.forwardRef(function SiFnac2({ title = "Fnac", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
