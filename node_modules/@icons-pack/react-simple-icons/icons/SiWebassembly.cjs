...
const SiWebassembly = React__namespace.forwardRef(function SiWebassembly2({ title = "WebAssembly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
