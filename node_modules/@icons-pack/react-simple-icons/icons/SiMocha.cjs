...
const defaultColor = "#8D6748";
const SiMocha = React__namespace.forwardRef(function SiMocha2({ title = "Mocha", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
