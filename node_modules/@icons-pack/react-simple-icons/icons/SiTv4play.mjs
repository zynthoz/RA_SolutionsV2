...
const SiTv4play = React.forwardRef(function SiTv4play2({ title = "TV4 Play", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
