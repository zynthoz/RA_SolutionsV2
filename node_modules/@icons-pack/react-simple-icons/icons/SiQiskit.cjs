...
const defaultColor = "#6929C4";
const SiQiskit = React__namespace.forwardRef(function SiQiskit2({ title = "Qiskit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
