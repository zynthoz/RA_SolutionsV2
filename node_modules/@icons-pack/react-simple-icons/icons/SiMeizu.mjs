...
const defaultColor = "#FF4132";
const SiMeizu = React.forwardRef(function SiMeizu2({ title = "Meizu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
