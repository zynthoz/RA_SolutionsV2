...
const SiProtoncalendar = React__namespace.forwardRef(function SiProtoncalendar2({ title = "Proton Calendar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
