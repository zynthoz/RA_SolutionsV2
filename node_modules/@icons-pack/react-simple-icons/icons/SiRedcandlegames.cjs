...
const SiRedcandlegames = React__namespace.forwardRef(function SiRedcandlegames2({ title = "Red Candle Games", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
