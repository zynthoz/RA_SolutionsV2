...
const SiSlideshare = React.forwardRef(function SiSlideshare2({ title = "SlideShare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
