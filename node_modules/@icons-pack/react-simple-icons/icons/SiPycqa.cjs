...
const SiPycqa = React__namespace.forwardRef(function SiPycqa2({ title = "PyCQA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
