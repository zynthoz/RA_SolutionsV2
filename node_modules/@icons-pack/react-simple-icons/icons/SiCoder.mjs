...
const SiCoder = React.forwardRef(function SiCoder2({ title = "Coder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
