...
const defaultColor = "#1A162D";
const SiTidyverse = React__namespace.forwardRef(function SiTidyverse2({ title = "Tidyverse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
