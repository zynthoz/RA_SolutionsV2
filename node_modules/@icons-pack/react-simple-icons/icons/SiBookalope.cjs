...
const defaultColor = "#DC2829";
const SiBookalope = React__namespace.forwardRef(function SiBookalope2({ title = "Bookalope", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
