...
const SiJuce = React.forwardRef(function SiJuce2({ title = "JUCE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
