...
const SiFilament = React.forwardRef(function SiFilament2({ title = "Filament", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
