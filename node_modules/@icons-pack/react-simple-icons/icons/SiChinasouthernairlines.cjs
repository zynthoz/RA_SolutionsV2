...
const defaultColor = "#008BCB";
const SiChinasouthernairlines = React__namespace.forwardRef(function SiChinasouthernairlines2({ title = "China Southern Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
