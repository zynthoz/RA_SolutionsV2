...
const defaultColor = "#0790C0";
const SiOctave = React__namespace.forwardRef(function SiOctave2({ title = "Octave", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
