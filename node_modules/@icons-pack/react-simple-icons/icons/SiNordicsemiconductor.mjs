...
const SiNordicsemiconductor = React.forwardRef(function SiNordicsemiconductor2({ title = "Nordic Semiconductor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
