...
const SiHashcat = React.forwardRef(function SiHashcat2({ title = "Hashcat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
