...
const SiAnaconda = React__namespace.forwardRef(function SiAnaconda2({ title = "Anaconda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
