...
const SiOsf = React.forwardRef(function SiOsf2({ title = "OSF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
