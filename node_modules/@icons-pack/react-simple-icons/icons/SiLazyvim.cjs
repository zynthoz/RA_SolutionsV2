...
const defaultColor = "#2E7DE9";
const SiLazyvim = React__namespace.forwardRef(function SiLazyvim2({ title = "LazyVim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
