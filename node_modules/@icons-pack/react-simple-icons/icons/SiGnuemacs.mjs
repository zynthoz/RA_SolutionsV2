...
const SiGnuemacs = React.forwardRef(function SiGnuemacs2({ title = "GNU Emacs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
