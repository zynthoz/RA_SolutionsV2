...
const SiElk = React.forwardRef(function SiElk2({ title = "Elk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
