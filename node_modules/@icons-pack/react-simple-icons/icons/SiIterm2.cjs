...
const SiIterm2 = React__namespace.forwardRef(function SiIterm22({ title = "iTerm2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
