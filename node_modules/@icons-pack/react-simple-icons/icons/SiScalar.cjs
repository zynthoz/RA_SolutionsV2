...
const SiScalar = React__namespace.forwardRef(function SiScalar2({ title = "Scalar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
