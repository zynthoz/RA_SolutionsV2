...
const defaultColor = "#C61C3E";
const SiArdour = React__namespace.forwardRef(function SiArdour2({ title = "Ardour", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
