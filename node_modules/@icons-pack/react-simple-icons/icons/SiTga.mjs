...
const defaultColor = "#0014FF";
const SiTga = React.forwardRef(function SiTga2({ title = "TGA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
