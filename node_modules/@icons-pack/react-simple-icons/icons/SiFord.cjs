...
const SiFord = React__namespace.forwardRef(function SiFord2({ title = "Ford", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
