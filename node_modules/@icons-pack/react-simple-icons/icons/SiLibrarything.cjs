...
const SiLibrarything = React__namespace.forwardRef(function SiLibrarything2({ title = "LibraryThing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
