...
const SiMaterialdesign = React.forwardRef(function SiMaterialdesign2({ title = "Material Design", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
