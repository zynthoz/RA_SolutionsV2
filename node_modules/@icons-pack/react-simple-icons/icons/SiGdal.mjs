...
const SiGdal = React.forwardRef(function SiGdal2({ title = "GDAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
