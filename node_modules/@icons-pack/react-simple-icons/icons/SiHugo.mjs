...
const SiHugo = React.forwardRef(function SiHugo2({ title = "Hugo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
