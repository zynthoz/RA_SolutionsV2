...
const SiSonarr = React__namespace.forwardRef(function SiSonarr2({ title = "sonarr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
