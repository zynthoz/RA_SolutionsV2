...
const SiHibob = React.forwardRef(function SiHibob2({ title = "Hi Bob", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
