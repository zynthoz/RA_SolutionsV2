...
const SiLangflow = React.forwardRef(function SiLangflow2({ title = "Langflow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
