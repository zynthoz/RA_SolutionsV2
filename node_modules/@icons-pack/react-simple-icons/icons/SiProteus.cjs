...
const SiProteus = React__namespace.forwardRef(function SiProteus2({ title = "Proteus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
