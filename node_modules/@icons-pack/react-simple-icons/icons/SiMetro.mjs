...
const SiMetro = React.forwardRef(function SiMetro2({ title = "Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
