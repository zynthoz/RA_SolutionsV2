...
const SiFillout = React.forwardRef(function SiFillout2({ title = "Fillout", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
