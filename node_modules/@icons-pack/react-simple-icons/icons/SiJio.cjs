...
const defaultColor = "#0A2885";
const SiJio = React__namespace.forwardRef(function SiJio2({ title = "Jio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
