...
const SiVscodium = React.forwardRef(function SiVscodium2({ title = "VSCodium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
