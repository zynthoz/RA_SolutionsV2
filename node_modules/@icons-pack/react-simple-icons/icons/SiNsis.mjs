...
const SiNsis = React.forwardRef(function SiNsis2({ title = "NSIS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
