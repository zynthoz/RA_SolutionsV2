...
const defaultColor = "#3F6184";
const SiWallabag = React__namespace.forwardRef(function SiWallabag2({ title = "Wallabag", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
