...
const SiZola = React__namespace.forwardRef(function SiZola2({ title = "Zola", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
