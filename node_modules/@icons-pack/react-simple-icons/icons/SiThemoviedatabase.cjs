...
const SiThemoviedatabase = React__namespace.forwardRef(function SiThemoviedatabase2({ title = "The Movie Database", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
