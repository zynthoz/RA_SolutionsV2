...
const SiBitcoincash = React.forwardRef(function SiBitcoincash2({ title = "Bitcoin Cash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
