...
const SiSonarqubeforide = React__namespace.forwardRef(function SiSonarqubeforide2({ title = "SonarQube for IDE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
