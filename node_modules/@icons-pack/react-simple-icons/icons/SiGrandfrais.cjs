...
const SiGrandfrais = React__namespace.forwardRef(function SiGrandfrais2({ title = "Grand Frais", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
