...
const SiBandrautomation = React.forwardRef(function SiBandrautomation2({ title = "B&R Automation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
