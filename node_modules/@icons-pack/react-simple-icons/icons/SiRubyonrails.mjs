...
const SiRubyonrails = React.forwardRef(function SiRubyonrails2({ title = "Ruby on Rails", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
