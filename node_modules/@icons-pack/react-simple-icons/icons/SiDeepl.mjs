...
const SiDeepl = React.forwardRef(function SiDeepl2({ title = "DeepL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
