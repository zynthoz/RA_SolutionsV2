...
const SiHedgedoc = React__namespace.forwardRef(function SiHedgedoc2({ title = "HedgeDoc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
