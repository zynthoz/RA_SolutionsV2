...
const defaultColor = "#00549F";
const SiWwise = React__namespace.forwardRef(function SiWwise2({ title = "Wwise", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
