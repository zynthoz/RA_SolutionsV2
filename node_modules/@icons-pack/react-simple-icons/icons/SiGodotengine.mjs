...
const SiGodotengine = React.forwardRef(function SiGodotengine2({ title = "Godot Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
