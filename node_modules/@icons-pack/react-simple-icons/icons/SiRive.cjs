...
const SiRive = React__namespace.forwardRef(function SiRive2({ title = "Rive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
