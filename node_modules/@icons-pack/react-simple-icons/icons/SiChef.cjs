...
const defaultColor = "#F09820";
const SiChef = React__namespace.forwardRef(function SiChef2({ title = "Chef", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
