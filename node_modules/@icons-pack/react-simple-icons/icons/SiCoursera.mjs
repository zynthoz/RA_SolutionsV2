...
const SiCoursera = React.forwardRef(function SiCoursera2({ title = "Coursera", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
