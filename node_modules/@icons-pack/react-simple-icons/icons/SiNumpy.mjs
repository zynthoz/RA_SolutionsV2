...
const SiNumpy = React.forwardRef(function SiNumpy2({ title = "NumPy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
