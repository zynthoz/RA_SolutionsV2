...
const SiApachedoris = React__namespace.forwardRef(function SiApachedoris2({ title = "Apache Doris", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
