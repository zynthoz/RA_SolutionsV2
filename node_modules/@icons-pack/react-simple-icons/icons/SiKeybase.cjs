...
const defaultColor = "#33A0FF";
const SiKeybase = React__namespace.forwardRef(function SiKeybase2({ title = "Keybase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
