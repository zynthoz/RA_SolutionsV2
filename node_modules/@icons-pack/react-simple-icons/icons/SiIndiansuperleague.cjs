...
const SiIndiansuperleague = React__namespace.forwardRef(function SiIndiansuperleague2({ title = "Indian Super League", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
