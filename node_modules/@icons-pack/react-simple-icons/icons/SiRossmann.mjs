...
const SiRossmann = React.forwardRef(function SiRossmann2({ title = "Rossmann", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
