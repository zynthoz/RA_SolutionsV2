...
const SiDocsdotrs = React__namespace.forwardRef(function SiDocsdotrs2({ title = "Docs.rs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
