...
const SiBlockbench = React.forwardRef(function SiBlockbench2({ title = "Blockbench", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
