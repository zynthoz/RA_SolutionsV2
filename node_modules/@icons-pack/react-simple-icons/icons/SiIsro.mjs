...
const SiIsro = React.forwardRef(function SiIsro2({ title = "ISRO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
