...
const SiFireflyiii = React.forwardRef(function SiFireflyiii2({ title = "Firefly III", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
