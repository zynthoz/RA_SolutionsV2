...
const SiSpacy = React.forwardRef(function SiSpacy2({ title = "spaCy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
