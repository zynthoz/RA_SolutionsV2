...
const SiGhostty = React.forwardRef(function SiGhostty2({ title = "Ghostty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
