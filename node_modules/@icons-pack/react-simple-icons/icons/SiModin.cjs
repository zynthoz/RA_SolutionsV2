...
const defaultColor = "#001729";
const SiModin = React__namespace.forwardRef(function SiModin2({ title = "Modin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
