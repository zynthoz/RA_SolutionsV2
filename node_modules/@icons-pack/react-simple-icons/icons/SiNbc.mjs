...
const SiNbc = React.forwardRef(function SiNbc2({ title = "NBC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
