...
const defaultColor = "#175DDC";
const SiBitwarden = React__namespace.forwardRef(function SiBitwarden2({ title = "Bitwarden", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
