...
const defaultColor = "#4EE3C2";
const SiInstatus = React.forwardRef(function SiInstatus2({ title = "Instatus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
