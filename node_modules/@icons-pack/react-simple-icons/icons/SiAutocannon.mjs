...
const SiAutocannon = React.forwardRef(function SiAutocannon2({ title = "AutoCannon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
