...
const SiMangaupdates = React.forwardRef(function SiMangaupdates2({ title = "MangaUpdates", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
