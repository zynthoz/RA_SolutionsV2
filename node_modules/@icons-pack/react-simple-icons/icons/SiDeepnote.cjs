...
const defaultColor = "#3793EF";
const SiDeepnote = React__namespace.forwardRef(function SiDeepnote2({ title = "Deepnote", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
