...
const SiJpeg = React.forwardRef(function SiJpeg2({ title = "JPEG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
