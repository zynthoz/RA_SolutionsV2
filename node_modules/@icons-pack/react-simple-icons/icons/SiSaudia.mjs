...
const SiSaudia = React.forwardRef(function SiSaudia2({ title = "Saudia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
