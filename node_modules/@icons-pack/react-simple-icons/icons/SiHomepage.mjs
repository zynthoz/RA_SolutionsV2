...
const SiHomepage = React.forwardRef(function SiHomepage2({ title = "Homepage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
