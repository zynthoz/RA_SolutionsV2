...
const SiVrchat = React__namespace.forwardRef(function SiVrchat2({ title = "VRChat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
