...
const SiTurbosquid = React__namespace.forwardRef(function SiTurbosquid2({ title = "TurboSquid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
