...
const SiDeno = React.forwardRef(function SiDeno2({ title = "Deno", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
