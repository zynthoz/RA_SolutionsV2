...
const defaultColor = "#0928FF";
const SiFantom = React__namespace.forwardRef(function SiFantom2({ title = "Fantom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
