...
const defaultColor = "#1765F6";
const SiEasyeda = React__namespace.forwardRef(function SiEasyeda2({ title = "EasyEDA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
