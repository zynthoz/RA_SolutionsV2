...
const defaultColor = "#FED12F";
const SiMinds = React__namespace.forwardRef(function SiMinds2({ title = "Minds", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
