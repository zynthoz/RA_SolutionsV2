...
const SiJsdelivr = React.forwardRef(function SiJsdelivr2({ title = "jsDelivr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
