...
const SiWellsfargo = React__namespace.forwardRef(function SiWellsfargo2({ title = "Wells Fargo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
