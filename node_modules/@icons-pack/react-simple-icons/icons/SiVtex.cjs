...
const defaultColor = "#ED125F";
const SiVtex = React__namespace.forwardRef(function SiVtex2({ title = "VTEX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
