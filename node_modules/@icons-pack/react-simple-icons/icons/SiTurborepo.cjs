...
const SiTurborepo = React__namespace.forwardRef(function SiTurborepo2({ title = "Turborepo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
