...
const SiDota2 = React.forwardRef(function SiDota22({ title = "Dota 2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
