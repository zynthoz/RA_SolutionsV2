...
const SiSanic = React.forwardRef(function SiSanic2({ title = "Sanic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
