...
const SiGltf = React.forwardRef(function SiGltf2({ title = "glTF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
