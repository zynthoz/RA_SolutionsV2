...
const SiEleventy = React__namespace.forwardRef(function SiEleventy2({ title = "Eleventy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
