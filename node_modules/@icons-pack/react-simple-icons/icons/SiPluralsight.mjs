...
const defaultColor = "#F15B2A";
const SiPluralsight = React.forwardRef(function SiPluralsight2({ title = "Pluralsight", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
