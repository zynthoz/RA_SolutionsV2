...
const defaultColor = "#031B4E";
const SiNamesilo = React.forwardRef(function SiNamesilo2({ title = "NameSilo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
