...
const SiWebex = React__namespace.forwardRef(function SiWebex2({ title = "Webex", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
