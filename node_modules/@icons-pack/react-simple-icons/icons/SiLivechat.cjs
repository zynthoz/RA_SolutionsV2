...
const defaultColor = "#FF5100";
const SiLivechat = React__namespace.forwardRef(function SiLivechat2({ title = "LiveChat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
