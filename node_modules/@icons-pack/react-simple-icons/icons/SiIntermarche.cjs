...
const SiIntermarche = React__namespace.forwardRef(function SiIntermarche2({ title = "Intermarche", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
