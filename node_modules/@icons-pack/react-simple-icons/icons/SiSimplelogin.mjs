...
const SiSimplelogin = React.forwardRef(function SiSimplelogin2({ title = "SimpleLogin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
