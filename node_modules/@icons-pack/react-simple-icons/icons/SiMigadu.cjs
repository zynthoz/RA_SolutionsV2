...
const defaultColor = "#0043CE";
const SiMigadu = React__namespace.forwardRef(function SiMigadu2({ title = "Migadu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
