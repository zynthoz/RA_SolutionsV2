...
const defaultColor = "#009AEE";
const SiFing = React__namespace.forwardRef(function SiFing2({ title = "Fing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
