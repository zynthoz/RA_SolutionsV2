...
const SiBungie = React.forwardRef(function SiBungie2({ title = "Bungie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
