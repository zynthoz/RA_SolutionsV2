...
const SiZcool = React.forwardRef(function SiZcool2({ title = "ZCOOL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
