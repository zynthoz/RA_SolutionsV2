...
const SiK6 = React.forwardRef(function SiK62({ title = "k6", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
