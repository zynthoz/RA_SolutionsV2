...
const defaultColor = "#03C4E8";
const SiPrimereact = React__namespace.forwardRef(function SiPrimereact2({ title = "PrimeReact", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
