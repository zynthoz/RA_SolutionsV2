...
const SiCreativetechnology = React__namespace.forwardRef(function SiCreativetechnology2({ title = "Creative Technology", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
