...
const SiKoenigsegg = React__namespace.forwardRef(function SiKoenigsegg2({ title = "Koenigsegg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
