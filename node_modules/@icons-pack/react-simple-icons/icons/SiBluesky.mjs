...
const defaultColor = "#1185FE";
const SiBluesky = React.forwardRef(function SiBluesky2({ title = "Bluesky", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiBluesky as default, defaultColor };
