...
const SiBt = React.forwardRef(function SiBt2({ title = "BT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
