...
const defaultColor = "#50B0E9";
const SiProtoncalendar = React.forwardRef(function SiProtoncalendar2({ title = "Proton Calendar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
