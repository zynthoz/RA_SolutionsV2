...
const SiSartorius = React.forwardRef(function SiSartorius2({ title = "Sartorius", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
