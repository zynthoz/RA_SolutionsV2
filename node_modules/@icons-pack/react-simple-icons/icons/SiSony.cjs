...
const SiSony = React__namespace.forwardRef(function SiSony2({ title = "Sony", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
