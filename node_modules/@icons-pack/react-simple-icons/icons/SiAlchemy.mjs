...
const SiAlchemy = React.forwardRef(function SiAlchemy2({ title = "Alchemy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
