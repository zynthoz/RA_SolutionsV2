...
const defaultColor = "#0D47A1";
const SiEnpass = React.forwardRef(function SiEnpass2({ title = "Enpass", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
