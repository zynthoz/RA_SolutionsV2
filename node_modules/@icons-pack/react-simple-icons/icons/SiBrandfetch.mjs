...
const SiBrandfetch = React.forwardRef(function SiBrandfetch2({ title = "Brandfetch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
