...
const SiWprocket = React.forwardRef(function SiWprocket2({ title = "WP Rocket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
