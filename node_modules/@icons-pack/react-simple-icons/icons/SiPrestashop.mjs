...
const defaultColor = "#DF0067";
const SiPrestashop = React.forwardRef(function SiPrestashop2({ title = "PrestaShop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
