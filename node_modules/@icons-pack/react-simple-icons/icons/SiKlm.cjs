...
const defaultColor = "#00A1DE";
const SiKlm = React__namespace.forwardRef(function SiKlm2({ title = "KLM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
