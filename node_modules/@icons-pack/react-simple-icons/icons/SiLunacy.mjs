...
const SiLunacy = React.forwardRef(function SiLunacy2({ title = "Lunacy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
