...
const SiDependencycheck = React.forwardRef(function SiDependencycheck2({ title = "OWASP Dependency-Check", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
