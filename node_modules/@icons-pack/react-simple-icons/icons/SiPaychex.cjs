...
const SiPaychex = React__namespace.forwardRef(function SiPaychex2({ title = "Paychex", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
