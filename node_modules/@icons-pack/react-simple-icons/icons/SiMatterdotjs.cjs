...
const SiMatterdotjs = React__namespace.forwardRef(function SiMatterdotjs2({ title = "Matter.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
