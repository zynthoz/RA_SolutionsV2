...
const SiCheerio = React.forwardRef(function SiCheerio2({ title = "Cheerio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
