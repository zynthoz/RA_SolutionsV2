...
const SiSvgdotjs = React.forwardRef(function SiSvgdotjs2({ title = "SVG.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
