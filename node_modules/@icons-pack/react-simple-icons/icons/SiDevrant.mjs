...
const SiDevrant = React.forwardRef(function SiDevrant2({ title = "devRant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
