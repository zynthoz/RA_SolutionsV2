...
const SiOpenjdk = React__namespace.forwardRef(function SiOpenjdk2({ title = "OpenJDK", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
