...
const SiFlydotio = React__namespace.forwardRef(function SiFlydotio2({ title = "Fly.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
