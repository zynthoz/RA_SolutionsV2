...
const defaultColor = "#24A1C1";
const SiTraefikproxy = React__namespace.forwardRef(function SiTraefikproxy2({ title = "Traefik Proxy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
