...
const SiApachecordova = React.forwardRef(function SiApachecordova2({ title = "Apache Cordova", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
