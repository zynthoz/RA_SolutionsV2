...
const SiSpeedypage = React__namespace.forwardRef(function SiSpeedypage2({ title = "SpeedyPage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
