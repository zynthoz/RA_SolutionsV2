...
const defaultColor = "#51BB7B";
const SiLocal = React__namespace.forwardRef(function SiLocal2({ title = "Local", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
