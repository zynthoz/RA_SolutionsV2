...
const SiImprovmx = React.forwardRef(function SiImprovmx2({ title = "ImprovMX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
