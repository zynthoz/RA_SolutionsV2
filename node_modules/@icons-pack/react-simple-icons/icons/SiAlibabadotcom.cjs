...
const SiAlibabadotcom = React__namespace.forwardRef(function SiAlibabadotcom2({ title = "Alibaba.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
