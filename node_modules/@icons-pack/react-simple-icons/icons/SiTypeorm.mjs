...
const SiTypeorm = React.forwardRef(function SiTypeorm2({ title = "TypeORM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
