...
const SiAccuweather = React.forwardRef(function SiAccuweather2({ title = "AccuWeather", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
