...
const SiB4x = React__namespace.forwardRef(function SiB4x2({ title = "B4X", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
