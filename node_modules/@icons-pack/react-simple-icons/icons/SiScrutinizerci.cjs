...
const SiScrutinizerci = React__namespace.forwardRef(function SiScrutinizerci2({ title = "Scrutinizer CI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
