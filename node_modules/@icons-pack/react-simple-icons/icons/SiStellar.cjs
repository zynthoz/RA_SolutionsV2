...
const defaultColor = "#FDDA24";
const SiStellar = React__namespace.forwardRef(function SiStellar2({ title = "Stellar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
