...
const SiMoq = React.forwardRef(function SiMoq2({ title = "Moq", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
