...
const SiConsul = React.forwardRef(function SiConsul2({ title = "Consul", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
