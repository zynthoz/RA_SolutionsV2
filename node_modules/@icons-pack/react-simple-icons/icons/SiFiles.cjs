...
const SiFiles = React__namespace.forwardRef(function SiFiles2({ title = "Files", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
