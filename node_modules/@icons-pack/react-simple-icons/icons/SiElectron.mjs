...
const SiElectron = React.forwardRef(function SiElectron2({ title = "Electron", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
