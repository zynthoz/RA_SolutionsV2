...
const SiLemmy = React.forwardRef(function SiLemmy2({ title = "Lemmy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
