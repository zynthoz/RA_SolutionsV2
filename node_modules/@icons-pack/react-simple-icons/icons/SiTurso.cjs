...
const defaultColor = "#4FF8D2";
const SiTurso = React__namespace.forwardRef(function SiTurso2({ title = "Turso", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
