...
const SiThanos = React.forwardRef(function SiThanos2({ title = "Thanos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
