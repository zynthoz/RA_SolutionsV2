...
const SiCodefresh = React.forwardRef(function SiCodefresh2({ title = "Codefresh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
