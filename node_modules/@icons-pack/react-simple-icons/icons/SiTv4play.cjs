...
const defaultColor = "#E0001C";
const SiTv4play = React__namespace.forwardRef(function SiTv4play2({ title = "TV4 Play", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
