...
const SiCalendly = React.forwardRef(function SiCalendly2({ title = "Calendly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
