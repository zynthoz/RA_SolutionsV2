...
const SiRunrundotit = React__namespace.forwardRef(function SiRunrundotit2({ title = "Runrun.it", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
