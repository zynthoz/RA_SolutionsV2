...
const defaultColor = "#E71D1D";
const SiCnet = React__namespace.forwardRef(function SiCnet2({ title = "CNET", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
