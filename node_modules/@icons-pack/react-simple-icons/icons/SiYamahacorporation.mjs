...
const SiYamahacorporation = React.forwardRef(function SiYamahacorporation2({ title = "Yamaha Corporation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
