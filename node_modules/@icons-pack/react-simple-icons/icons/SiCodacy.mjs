...
const SiCodacy = React.forwardRef(function SiCodacy2({ title = "Codacy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
