...
const defaultColor = "#E53236";
const SiCts = React__namespace.forwardRef(function SiCts2({ title = "CTS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
