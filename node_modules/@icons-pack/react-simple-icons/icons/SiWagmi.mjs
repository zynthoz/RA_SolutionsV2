...
const SiWagmi = React.forwardRef(function SiWagmi2({ title = "Wagmi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
