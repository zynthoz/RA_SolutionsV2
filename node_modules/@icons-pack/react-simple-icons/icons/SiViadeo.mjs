...
const SiViadeo = React.forwardRef(function SiViadeo2({ title = "Viadeo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
