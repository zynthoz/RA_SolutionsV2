...
const defaultColor = "#556472";
const SiFigshare = React__namespace.forwardRef(function SiFigshare2({ title = "figshare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
