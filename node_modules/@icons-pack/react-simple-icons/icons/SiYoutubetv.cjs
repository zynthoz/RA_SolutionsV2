...
const SiYoutubetv = React__namespace.forwardRef(function SiYoutubetv2({ title = "YouTube TV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
