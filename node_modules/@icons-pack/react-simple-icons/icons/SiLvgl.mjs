...
const SiLvgl = React.forwardRef(function SiLvgl2({ title = "LVGL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
