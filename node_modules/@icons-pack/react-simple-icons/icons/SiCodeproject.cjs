...
const SiCodeproject = React__namespace.forwardRef(function SiCodeproject2({ title = "CodeProject", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
