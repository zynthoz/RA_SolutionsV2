...
const SiVanillaextract = React__namespace.forwardRef(function SiVanillaextract2({ title = "Vanilla Extract", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
