...
const defaultColor = "#632CA6";
const SiDatadog = React__namespace.forwardRef(function SiDatadog2({ title = "Datadog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
