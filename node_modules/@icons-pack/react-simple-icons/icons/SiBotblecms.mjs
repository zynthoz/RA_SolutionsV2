...
const SiBotblecms = React.forwardRef(function SiBotblecms2({ title = "Botble CMS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
