...
const SiZigbee2mqtt = React.forwardRef(function SiZigbee2mqtt2({ title = "Zigbee2MQTT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
