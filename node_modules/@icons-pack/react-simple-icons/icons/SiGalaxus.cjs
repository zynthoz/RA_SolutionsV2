...
const SiGalaxus = React__namespace.forwardRef(function SiGalaxus2({ title = "Galaxus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
