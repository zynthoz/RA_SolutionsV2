...
const SiLanguagetool = React.forwardRef(function SiLanguagetool2({ title = "LanguageTool", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
