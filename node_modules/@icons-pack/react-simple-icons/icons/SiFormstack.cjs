...
const defaultColor = "#21B573";
const SiFormstack = React__namespace.forwardRef(function SiFormstack2({ title = "Formstack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
