...
const SiAnichart = React.forwardRef(function SiAnichart2({ title = "AniChart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
