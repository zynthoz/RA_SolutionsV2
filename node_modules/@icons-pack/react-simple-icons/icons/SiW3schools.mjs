...
const SiW3schools = React.forwardRef(function SiW3schools2({ title = "W3Schools", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
