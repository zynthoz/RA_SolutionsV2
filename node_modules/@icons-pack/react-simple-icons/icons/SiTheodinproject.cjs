...
const SiTheodinproject = React__namespace.forwardRef(function SiTheodinproject2({ title = "The Odin Project", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
