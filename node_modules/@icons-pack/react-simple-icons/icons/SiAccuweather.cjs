...
const SiAccuweather = React__namespace.forwardRef(function SiAccuweather2({ title = "AccuWeather", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
