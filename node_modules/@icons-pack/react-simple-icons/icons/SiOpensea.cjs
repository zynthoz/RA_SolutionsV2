...
const defaultColor = "#2081E2";
const SiOpensea = React__namespace.forwardRef(function SiOpensea2({ title = "OpenSea", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
