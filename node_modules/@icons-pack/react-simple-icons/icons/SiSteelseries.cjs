...
const SiSteelseries = React__namespace.forwardRef(function SiSteelseries2({ title = "Steelseries", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
