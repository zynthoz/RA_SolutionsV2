...
const defaultColor = "#65A3BE";
const SiHabr = React__namespace.forwardRef(function SiHabr2({ title = "Habr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
