...
const SiPcgamingwiki = React__namespace.forwardRef(function SiPcgamingwiki2({ title = "PCGamingWiki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
