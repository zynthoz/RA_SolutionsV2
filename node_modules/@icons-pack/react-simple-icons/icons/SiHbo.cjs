...
const SiHbo = React__namespace.forwardRef(function SiHbo2({ title = "HBO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
