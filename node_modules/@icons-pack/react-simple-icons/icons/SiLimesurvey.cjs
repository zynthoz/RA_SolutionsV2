...
const defaultColor = "#14AE5C";
const SiLimesurvey = React__namespace.forwardRef(function SiLimesurvey2({ title = "LimeSurvey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
