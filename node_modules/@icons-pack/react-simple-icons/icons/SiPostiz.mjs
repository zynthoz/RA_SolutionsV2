...
const SiPostiz = React.forwardRef(function SiPostiz2({ title = "Postiz", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
