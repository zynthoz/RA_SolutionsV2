...
const SiMagasinsu = React__namespace.forwardRef(function SiMagasinsu2({ title = "Magasins U", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
