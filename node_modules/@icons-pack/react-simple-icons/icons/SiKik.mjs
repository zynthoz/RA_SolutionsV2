...
const SiKik = React.forwardRef(function SiKik2({ title = "Kik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
