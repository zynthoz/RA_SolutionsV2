...
const defaultColor = "#17394A";
const SiOsmc = React__namespace.forwardRef(function SiOsmc2({ title = "OSMC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
