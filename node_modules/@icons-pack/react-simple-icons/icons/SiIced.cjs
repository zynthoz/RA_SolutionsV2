...
const defaultColor = "#3645FF";
const SiIced = React__namespace.forwardRef(function SiIced2({ title = "Iced", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
