...
const defaultColor = "#304CB2";
const SiSouthwestairlines = React__namespace.forwardRef(function SiSouthwestairlines2({ title = "Southwest Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
