...
const SiDvc = React.forwardRef(function SiDvc2({ title = "DVC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
