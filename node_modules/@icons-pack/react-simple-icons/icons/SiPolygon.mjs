...
const SiPolygon = React.forwardRef(function SiPolygon2({ title = "Polygon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
