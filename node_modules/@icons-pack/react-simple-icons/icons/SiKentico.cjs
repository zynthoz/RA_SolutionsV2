...
const SiKentico = React__namespace.forwardRef(function SiKentico2({ title = "Kentico", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
