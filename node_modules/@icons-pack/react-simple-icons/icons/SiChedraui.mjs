...
const defaultColor = "#E0832F";
const SiChedraui = React.forwardRef(function SiChedraui2({ title = "Chedraui", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
