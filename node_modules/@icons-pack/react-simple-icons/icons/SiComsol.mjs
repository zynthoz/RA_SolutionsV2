...
const SiComsol = React.forwardRef(function SiComsol2({ title = "Comsol", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
