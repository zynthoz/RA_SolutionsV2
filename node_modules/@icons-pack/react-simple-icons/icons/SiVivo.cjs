...
const SiVivo = React__namespace.forwardRef(function SiVivo2({ title = "vivo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
