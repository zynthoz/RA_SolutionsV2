...
const defaultColor = "#FF9E2A";
const SiGatling = React__namespace.forwardRef(function SiGatling2({ title = "Gatling", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
