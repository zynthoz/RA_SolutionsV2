...
const SiFiledotio = React.forwardRef(function SiFiledotio2({ title = "File.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
