...
const SiTaichilang = React__namespace.forwardRef(function SiTaichilang2({ title = "Taichi Lang", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
