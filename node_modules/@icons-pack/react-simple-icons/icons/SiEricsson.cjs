...
const defaultColor = "#0082F0";
const SiEricsson = React__namespace.forwardRef(function SiEricsson2({ title = "Ericsson", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
