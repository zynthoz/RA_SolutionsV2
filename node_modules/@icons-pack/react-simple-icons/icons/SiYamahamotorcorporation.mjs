...
const SiYamahamotorcorporation = React.forwardRef(function SiYamahamotorcorporation2({ title = "Yamaha Motor Corporation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
