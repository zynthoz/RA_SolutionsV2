...
const SiCssmodules = React.forwardRef(function SiCssmodules2({ title = "CSS Modules", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiCssmodules as default, defaultColor };
