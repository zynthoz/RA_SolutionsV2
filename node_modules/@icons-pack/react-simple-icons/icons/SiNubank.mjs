...
const SiNubank = React.forwardRef(function SiNubank2({ title = "Nubank", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
