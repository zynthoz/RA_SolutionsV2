...
const SiHusqvarna = React__namespace.forwardRef(function SiHusqvarna2({ title = "Husqvarna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
