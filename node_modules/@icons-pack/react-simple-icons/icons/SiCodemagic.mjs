...
const SiCodemagic = React.forwardRef(function SiCodemagic2({ title = "Codemagic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
