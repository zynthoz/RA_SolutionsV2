...
const SiHive = React.forwardRef(function SiHive2({ title = "Hive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
