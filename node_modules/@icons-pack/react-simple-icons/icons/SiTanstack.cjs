...
const SiTanstack = React__namespace.forwardRef(function SiTanstack2({ title = "TanStack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
