...
const defaultColor = "#1E384B";
const SiEcovacs = React__namespace.forwardRef(function SiEcovacs2({ title = "Ecovacs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
