...
const defaultColor = "#0039A6";
const SiMta = React.forwardRef(function SiMta2({ title = "MTA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
