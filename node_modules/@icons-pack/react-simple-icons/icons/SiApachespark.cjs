...
const defaultColor = "#E25A1C";
const SiApachespark = React__namespace.forwardRef(function SiApachespark2({ title = "Apache Spark", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
