...
const SiFalco = React__namespace.forwardRef(function SiFalco2({ title = "Falco", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
