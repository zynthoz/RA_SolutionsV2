...
const SiVegas = React__namespace.forwardRef(function SiVegas2({ title = "VEGAS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
