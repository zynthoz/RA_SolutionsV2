...
const SiSupercrease = React__namespace.forwardRef(function SiSupercrease2({ title = "Supercrease", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
