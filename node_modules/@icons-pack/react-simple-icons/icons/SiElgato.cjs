...
const SiElgato = React__namespace.forwardRef(function SiElgato2({ title = "Elgato", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
