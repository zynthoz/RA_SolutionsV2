...
const SiCypress = React.forwardRef(function SiCypress2({ title = "Cypress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
