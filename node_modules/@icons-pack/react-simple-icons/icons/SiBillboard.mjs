...
const SiBillboard = React.forwardRef(function SiBillboard2({ title = "Billboard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
