...
const defaultColor = "#FAD83B";
const SiBeekeeperstudio = React__namespace.forwardRef(function SiBeekeeperstudio2({ title = "Beekeeper Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
