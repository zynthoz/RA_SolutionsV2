...
const SiAlbertheijn = React.forwardRef(function SiAlbertheijn2({ title = "Albert Heijn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
