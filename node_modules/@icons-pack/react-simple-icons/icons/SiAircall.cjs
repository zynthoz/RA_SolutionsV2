...
const defaultColor = "#00B388";
const SiAircall = React__namespace.forwardRef(function SiAircall2({ title = "Aircall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
