...
const SiEndeavouros = React.forwardRef(function SiEndeavouros2({ title = "EndeavourOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
