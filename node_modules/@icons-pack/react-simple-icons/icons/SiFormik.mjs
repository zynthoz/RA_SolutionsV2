...
const SiFormik = React.forwardRef(function SiFormik2({ title = "Formik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
