...
const SiVespa = React.forwardRef(function SiVespa2({ title = "Vespa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
