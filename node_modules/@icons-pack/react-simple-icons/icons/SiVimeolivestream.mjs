...
const defaultColor = "#0A0A20";
const SiVimeolivestream = React.forwardRef(function SiVimeolivestream2({ title = "Vimeo Livestream", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
