...
const SiUipath = React__namespace.forwardRef(function SiUipath2({ title = "UiPath", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
