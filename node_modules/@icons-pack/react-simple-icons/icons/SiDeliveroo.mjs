...
const SiDeliveroo = React.forwardRef(function SiDeliveroo2({ title = "Deliveroo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
