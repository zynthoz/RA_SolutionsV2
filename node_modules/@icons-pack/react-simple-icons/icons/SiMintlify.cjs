...
const SiMintlify = React__namespace.forwardRef(function SiMintlify2({ title = "Mintlify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
