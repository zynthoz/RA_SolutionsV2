...
const SiGooglemeet = React__namespace.forwardRef(function SiGooglemeet2({ title = "Google Meet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
