...
const defaultColor = "#F44A53";
const SiApifox = React__namespace.forwardRef(function SiApifox2({ title = "Apifox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
