...
const SiGeneralmotors = React__namespace.forwardRef(function SiGeneralmotors2({ title = "General Motors", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
