...
const defaultColor = "#29A7DF";
const SiTopcoder = React__namespace.forwardRef(function SiTopcoder2({ title = "Topcoder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
