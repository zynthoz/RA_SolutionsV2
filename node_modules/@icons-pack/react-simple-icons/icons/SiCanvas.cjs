...
const defaultColor = "#E72429";
const SiCanvas = React__namespace.forwardRef(function SiCanvas2({ title = "Canvas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
