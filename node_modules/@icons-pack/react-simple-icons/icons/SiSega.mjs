...
const SiSega = React.forwardRef(function SiSega2({ title = "Sega", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
