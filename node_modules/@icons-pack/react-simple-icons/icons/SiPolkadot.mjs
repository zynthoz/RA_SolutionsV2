...
const SiPolkadot = React.forwardRef(function SiPolkadot2({ title = "Polkadot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
