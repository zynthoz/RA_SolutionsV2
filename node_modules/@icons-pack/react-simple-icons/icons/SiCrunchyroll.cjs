...
const SiCrunchyroll = React__namespace.forwardRef(function SiCrunchyroll2({ title = "Crunchyroll", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
