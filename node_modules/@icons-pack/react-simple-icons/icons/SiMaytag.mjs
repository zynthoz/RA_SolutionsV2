...
const SiMaytag = React.forwardRef(function SiMaytag2({ title = "Maytag", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
