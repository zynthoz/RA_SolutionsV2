...
const defaultColor = "#E62431";
const SiDelphi = React.forwardRef(function SiDelphi2({ title = "Delphi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
