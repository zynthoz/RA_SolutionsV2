...
const SiDarty = React.forwardRef(function SiDarty2({ title = "Darty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
