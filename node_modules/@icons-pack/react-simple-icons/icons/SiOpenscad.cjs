...
const SiOpenscad = React__namespace.forwardRef(function SiOpenscad2({ title = "OpenSCAD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
