...
const Si9gag = React__namespace.forwardRef(function Si9gag2({ title = "9GAG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
