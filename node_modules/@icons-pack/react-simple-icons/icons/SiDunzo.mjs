...
const SiDunzo = React.forwardRef(function SiDunzo2({ title = "Dunzo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
