...
const SiCentos = React.forwardRef(function SiCentos2({ title = "CentOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
