...
const defaultColor = "#D40E14";
const SiTui = React__namespace.forwardRef(function SiTui2({ title = "TUI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
