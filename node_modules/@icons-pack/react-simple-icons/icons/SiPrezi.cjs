...
const defaultColor = "#3181FF";
const SiPrezi = React__namespace.forwardRef(function SiPrezi2({ title = "Prezi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
