...
const SiQase = React.forwardRef(function SiQase2({ title = "Qase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
