...
const SiThreema = React__namespace.forwardRef(function SiThreema2({ title = "Threema", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
