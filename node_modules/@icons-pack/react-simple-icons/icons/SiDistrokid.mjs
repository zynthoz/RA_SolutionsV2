...
const SiDistrokid = React.forwardRef(function SiDistrokid2({ title = "Distrokid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
