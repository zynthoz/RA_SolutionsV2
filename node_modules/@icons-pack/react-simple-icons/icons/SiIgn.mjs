...
const SiIgn = React.forwardRef(function SiIgn2({ title = "IGN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
