...
const defaultColor = "#FFBC00";
const SiThangs = React__namespace.forwardRef(function SiThangs2({ title = "Thangs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
