...
const defaultColor = "#C60D0D";
const SiMuo = React__namespace.forwardRef(function SiMuo2({ title = "MUO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
