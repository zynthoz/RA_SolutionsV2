...
const SiIconjar = React__namespace.forwardRef(function SiIconjar2({ title = "IconJar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
