...
const defaultColor = "#4255FF";
const SiQuizlet = React__namespace.forwardRef(function SiQuizlet2({ title = "Quizlet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
