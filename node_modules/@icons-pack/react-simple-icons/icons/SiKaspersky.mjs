...
const SiKaspersky = React.forwardRef(function SiKaspersky2({ title = "Kaspersky", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
