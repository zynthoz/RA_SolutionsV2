...
const defaultColor = "#05164D";
const SiLufthansa = React__namespace.forwardRef(function SiLufthansa2({ title = "Lufthansa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
