...
const defaultColor = "#0075A8";
const SiRancher = React__namespace.forwardRef(function SiRancher2({ title = "Rancher", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
