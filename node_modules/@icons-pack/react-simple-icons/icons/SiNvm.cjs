...
const SiNvm = React__namespace.forwardRef(function SiNvm2({ title = "nvm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
