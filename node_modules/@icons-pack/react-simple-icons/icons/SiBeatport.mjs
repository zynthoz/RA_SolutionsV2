...
const SiBeatport = React.forwardRef(function SiBeatport2({ title = "Beatport", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
