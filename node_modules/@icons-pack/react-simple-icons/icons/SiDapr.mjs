...
const SiDapr = React.forwardRef(function SiDapr2({ title = "Dapr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
