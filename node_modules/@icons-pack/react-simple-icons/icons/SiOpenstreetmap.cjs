...
const defaultColor = "#7EBC6F";
const SiOpenstreetmap = React__namespace.forwardRef(function SiOpenstreetmap2({ title = "OpenStreetMap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
