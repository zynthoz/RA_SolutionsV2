...
const SiThangs = React.forwardRef(function SiThangs2({ title = "Thangs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
