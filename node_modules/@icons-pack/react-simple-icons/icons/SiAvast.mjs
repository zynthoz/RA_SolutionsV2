...
const SiAvast = React.forwardRef(function SiAvast2({ title = "Avast", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
