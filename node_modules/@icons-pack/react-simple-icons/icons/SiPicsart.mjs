...
const defaultColor = "#C209C1";
const SiPicsart = React.forwardRef(function SiPicsart2({ title = "Picsart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
