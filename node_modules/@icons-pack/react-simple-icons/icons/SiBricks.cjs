...
const defaultColor = "#FFD54D";
const SiBricks = React__namespace.forwardRef(function SiBricks2({ title = "Bricks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
