...
const SiResharper = React__namespace.forwardRef(function SiResharper2({ title = "ReSharper", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
