...
const SiOsu = React__namespace.forwardRef(function SiOsu2({ title = "osu!", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
