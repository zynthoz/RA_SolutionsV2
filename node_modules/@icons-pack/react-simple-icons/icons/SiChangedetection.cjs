...
const defaultColor = "#3056D3";
const SiChangedetection = React__namespace.forwardRef(function SiChangedetection2({ title = "Change Detection", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
