...
const SiFreelancermap = React.forwardRef(function SiFreelancermap2({ title = "freelancermap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
