...
const SiFlower = React__namespace.forwardRef(function SiFlower2({ title = "Flower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
