...
const SiOpensea = React.forwardRef(function SiOpensea2({ title = "OpenSea", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
