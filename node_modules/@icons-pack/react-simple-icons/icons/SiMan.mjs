...
const defaultColor = "#E40045";
const SiMan = React.forwardRef(function SiMan2({ title = "MAN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
