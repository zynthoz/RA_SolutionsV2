...
const defaultColor = "#2B037A";
const SiPm2 = React.forwardRef(function SiPm22({ title = "PM2", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
