...
const defaultColor = "#1496FF";
const SiDynatrace = React__namespace.forwardRef(function SiDynatrace2({ title = "Dynatrace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
