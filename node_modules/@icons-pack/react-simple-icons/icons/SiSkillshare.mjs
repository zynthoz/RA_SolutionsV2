...
const SiSkillshare = React.forwardRef(function SiSkillshare2({ title = "Skillshare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
