...
const SiSway = React__namespace.forwardRef(function SiSway2({ title = "Sway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
