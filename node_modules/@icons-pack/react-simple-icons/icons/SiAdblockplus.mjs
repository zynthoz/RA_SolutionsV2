...
const SiAdblockplus = React.forwardRef(function SiAdblockplus2({ title = "Adblock Plus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
