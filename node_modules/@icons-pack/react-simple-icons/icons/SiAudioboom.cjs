...
const SiAudioboom = React__namespace.forwardRef(function SiAudioboom2({ title = "Audioboom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
