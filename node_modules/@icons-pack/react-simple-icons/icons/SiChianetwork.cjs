...
const SiChianetwork = React__namespace.forwardRef(function SiChianetwork2({ title = "Chia Network", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
