...
const SiDenodeploy = React.forwardRef(function SiDenodeploy2({ title = "Deno Deploy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
