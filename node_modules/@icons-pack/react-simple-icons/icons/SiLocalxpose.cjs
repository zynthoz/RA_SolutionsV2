...
const SiLocalxpose = React__namespace.forwardRef(function SiLocalxpose2({ title = "LocalXpose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
