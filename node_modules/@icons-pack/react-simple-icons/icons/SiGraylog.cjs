...
const SiGraylog = React__namespace.forwardRef(function SiGraylog2({ title = "Graylog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
