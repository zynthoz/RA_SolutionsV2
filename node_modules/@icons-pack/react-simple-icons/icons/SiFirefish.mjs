...
const SiFirefish = React.forwardRef(function SiFirefish2({ title = "Firefish", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
