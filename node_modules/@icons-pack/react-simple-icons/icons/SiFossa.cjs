...
const SiFossa = React__namespace.forwardRef(function SiFossa2({ title = "Fossa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
