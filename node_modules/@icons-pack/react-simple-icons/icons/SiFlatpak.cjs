...
const SiFlatpak = React__namespace.forwardRef(function SiFlatpak2({ title = "Flatpak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
