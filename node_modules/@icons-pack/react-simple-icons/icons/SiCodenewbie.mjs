...
const SiCodenewbie = React.forwardRef(function SiCodenewbie2({ title = "CodeNewbie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
