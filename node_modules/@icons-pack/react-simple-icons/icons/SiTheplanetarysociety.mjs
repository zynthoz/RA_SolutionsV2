...
const SiTheplanetarysociety = React.forwardRef(function SiTheplanetarysociety2({ title = "The Planetary Society", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
