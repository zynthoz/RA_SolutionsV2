...
const SiLinphone = React.forwardRef(function SiLinphone2({ title = "Linphone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
