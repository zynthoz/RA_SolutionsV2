...
const defaultColor = "#E42C51";
const SiHibob = React__namespace.forwardRef(function SiHibob2({ title = "Hi Bob", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
