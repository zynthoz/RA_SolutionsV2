...
const SiDigg = React__namespace.forwardRef(function SiDigg2({ title = "Digg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
