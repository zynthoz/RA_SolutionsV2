...
const SiMyob = React__namespace.forwardRef(function SiMyob2({ title = "MYOB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
