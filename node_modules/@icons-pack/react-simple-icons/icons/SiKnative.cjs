...
const defaultColor = "#0865AD";
const SiKnative = React__namespace.forwardRef(function SiKnative2({ title = "Knative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
