...
const SiRclone = React__namespace.forwardRef(function SiRclone2({ title = "Rclone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
