...
const defaultColor = "#E1171E";
const SiPicnic = React__namespace.forwardRef(function SiPicnic2({ title = "Picnic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
