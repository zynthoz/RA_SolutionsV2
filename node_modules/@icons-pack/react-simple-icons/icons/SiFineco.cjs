...
const SiFineco = React__namespace.forwardRef(function SiFineco2({ title = "Fineco", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
