...
const defaultColor = "#1D1717";
const SiDsautomobiles = React__namespace.forwardRef(function SiDsautomobiles2({ title = "DS Automobiles", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
