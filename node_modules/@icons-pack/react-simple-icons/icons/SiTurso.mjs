...
const SiTurso = React.forwardRef(function SiTurso2({ title = "Turso", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
