...
const SiJdoodle = React.forwardRef(function SiJdoodle2({ title = "JDoodle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
