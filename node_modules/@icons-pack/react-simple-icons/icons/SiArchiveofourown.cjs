...
const SiArchiveofourown = React__namespace.forwardRef(function SiArchiveofourown2({ title = "Archive of Our Own", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
