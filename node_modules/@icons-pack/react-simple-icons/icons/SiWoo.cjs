...
const SiWoo = React__namespace.forwardRef(function SiWoo2({ title = "Woo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
