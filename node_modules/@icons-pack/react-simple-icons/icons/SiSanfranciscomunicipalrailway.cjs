...
const SiSanfranciscomunicipalrailway = React__namespace.forwardRef(function SiSanfranciscomunicipalrailway2({ title = "San Francisco Municipal Railway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
