...
const SiGooglestreetview = React__namespace.forwardRef(function SiGooglestreetview2({ title = "Google Street View", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
