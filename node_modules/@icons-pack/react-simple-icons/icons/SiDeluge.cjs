...
const SiDeluge = React__namespace.forwardRef(function SiDeluge2({ title = "Deluge", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
