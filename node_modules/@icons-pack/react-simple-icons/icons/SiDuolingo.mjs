...
const SiDuolingo = React.forwardRef(function SiDuolingo2({ title = "Duolingo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
