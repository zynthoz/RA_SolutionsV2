...
const SiZabka = React__namespace.forwardRef(function SiZabka2({ title = "Żabka", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
