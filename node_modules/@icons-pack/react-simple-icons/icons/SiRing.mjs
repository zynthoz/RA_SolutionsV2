...
const SiRing = React.forwardRef(function SiRing2({ title = "Ring", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
