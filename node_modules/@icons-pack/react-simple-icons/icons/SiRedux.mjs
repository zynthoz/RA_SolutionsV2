...
const SiRedux = React.forwardRef(function SiRedux2({ title = "Redux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
