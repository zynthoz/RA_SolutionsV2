...
const SiProton = React.forwardRef(function SiProton2({ title = "Proton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
