...
const SiDatto = React__namespace.forwardRef(function SiDatto2({ title = "Datto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
