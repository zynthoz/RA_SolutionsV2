...
const SiOpentelemetry = React__namespace.forwardRef(function SiOpentelemetry2({ title = "OpenTelemetry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
