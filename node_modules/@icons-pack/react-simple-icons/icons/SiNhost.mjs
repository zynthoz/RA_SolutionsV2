...
const SiNhost = React.forwardRef(function SiNhost2({ title = "Nhost", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
