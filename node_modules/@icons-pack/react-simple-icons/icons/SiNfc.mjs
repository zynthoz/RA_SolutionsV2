...
const SiNfc = React.forwardRef(function SiNfc2({ title = "NFC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
