...
const SiEclipsejetty = React__namespace.forwardRef(function SiEclipsejetty2({ title = "Eclipse Jetty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
