...
const defaultColor = "#C8202F";
const SiComptia = React__namespace.forwardRef(function SiComptia2({ title = "CompTIA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
