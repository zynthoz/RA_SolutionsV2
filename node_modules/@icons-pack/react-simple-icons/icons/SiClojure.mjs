...
const SiClojure = React.forwardRef(function SiClojure2({ title = "Clojure", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
