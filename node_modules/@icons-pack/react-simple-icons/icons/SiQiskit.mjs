...
const SiQiskit = React.forwardRef(function SiQiskit2({ title = "Qiskit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
