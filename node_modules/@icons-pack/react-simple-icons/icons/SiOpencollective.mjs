...
const defaultColor = "#7FADF2";
const SiOpencollective = React.forwardRef(function SiOpencollective2({ title = "Open Collective", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiOpencollective as default, defaultColor };
