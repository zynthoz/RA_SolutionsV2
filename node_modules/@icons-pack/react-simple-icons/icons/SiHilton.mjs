...
const SiHilton = React.forwardRef(function SiHilton2({ title = "Hilton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
