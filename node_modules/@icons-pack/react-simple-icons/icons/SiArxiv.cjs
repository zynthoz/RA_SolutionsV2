...
const defaultColor = "#B31B1B";
const SiArxiv = React__namespace.forwardRef(function SiArxiv2({ title = "arXiv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
