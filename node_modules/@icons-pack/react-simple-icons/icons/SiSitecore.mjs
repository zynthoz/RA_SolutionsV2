...
const SiSitecore = React.forwardRef(function SiSitecore2({ title = "Sitecore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
