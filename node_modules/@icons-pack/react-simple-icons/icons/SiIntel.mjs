...
const SiIntel = React.forwardRef(function SiIntel2({ title = "Intel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
