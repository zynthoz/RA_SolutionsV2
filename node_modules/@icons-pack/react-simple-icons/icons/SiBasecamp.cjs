...
const SiBasecamp = React__namespace.forwardRef(function SiBasecamp2({ title = "Basecamp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
