...
const SiAldinord = React__namespace.forwardRef(function SiAldinord2({ title = "Aldi Nord", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
