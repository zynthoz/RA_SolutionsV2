...
const SiAmul = React__namespace.forwardRef(function SiAmul2({ title = "Amul", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
