...
const defaultColor = "#F99A66";
const SiDevrant = React__namespace.forwardRef(function SiDevrant2({ title = "devRant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
