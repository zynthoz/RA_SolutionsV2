...
const defaultColor = "#302683";
const SiHtmlacademy = React__namespace.forwardRef(function SiHtmlacademy2({ title = "HTML Academy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
