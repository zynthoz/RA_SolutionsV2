...
const defaultColor = "#AA344D";
const SiApacheecharts = React__namespace.forwardRef(function SiApacheecharts2({ title = "Apache ECharts", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
