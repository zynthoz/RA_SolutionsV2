...
const SiOpenfaas = React.forwardRef(function SiOpenfaas2({ title = "OpenFaaS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
