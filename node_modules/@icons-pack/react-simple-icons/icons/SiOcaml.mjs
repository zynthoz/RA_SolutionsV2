...
const SiOcaml = React.forwardRef(function SiOcaml2({ title = "OCaml", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
