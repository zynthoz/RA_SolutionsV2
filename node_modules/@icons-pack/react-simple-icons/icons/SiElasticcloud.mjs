...
const SiElasticcloud = React.forwardRef(function SiElasticcloud2({ title = "Elastic Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
