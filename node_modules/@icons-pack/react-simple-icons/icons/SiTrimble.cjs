...
const SiTrimble = React__namespace.forwardRef(function SiTrimble2({ title = "Trimble", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
