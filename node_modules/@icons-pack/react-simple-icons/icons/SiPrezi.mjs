...
const SiPrezi = React.forwardRef(function SiPrezi2({ title = "Prezi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
