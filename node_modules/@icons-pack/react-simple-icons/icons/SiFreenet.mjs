...
const SiFreenet = React.forwardRef(function SiFreenet2({ title = "freenet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
