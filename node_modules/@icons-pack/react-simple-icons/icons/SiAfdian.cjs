...
const defaultColor = "#946CE6";
const SiAfdian = React__namespace.forwardRef(function SiAfdian2({ title = "AFDIAN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
