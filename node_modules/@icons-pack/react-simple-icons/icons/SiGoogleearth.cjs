...
const SiGoogleearth = React__namespace.forwardRef(function SiGoogleearth2({ title = "Google Earth", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
