...
const SiVscodium = React__namespace.forwardRef(function SiVscodium2({ title = "VSCodium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
