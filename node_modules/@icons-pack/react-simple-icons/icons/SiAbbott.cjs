...
const SiAbbott = React__namespace.forwardRef(function SiAbbott2({ title = "Abbott", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
