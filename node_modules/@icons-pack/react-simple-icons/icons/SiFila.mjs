...
const SiFila = React.forwardRef(function SiFila2({ title = "Fila", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
