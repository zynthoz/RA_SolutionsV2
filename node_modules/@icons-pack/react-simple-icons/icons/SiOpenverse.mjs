...
const defaultColor = "#FFE033";
const SiOpenverse = React.forwardRef(function SiOpenverse2({ title = "Openverse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
