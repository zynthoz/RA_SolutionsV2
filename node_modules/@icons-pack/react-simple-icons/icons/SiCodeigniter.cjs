...
const SiCodeigniter = React__namespace.forwardRef(function SiCodeigniter2({ title = "CodeIgniter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
