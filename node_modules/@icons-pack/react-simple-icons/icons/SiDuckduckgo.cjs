...
const defaultColor = "#DE5833";
const SiDuckduckgo = React__namespace.forwardRef(function SiDuckduckgo2({ title = "DuckDuckGo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
