...
const SiBackbonedotjs = React.forwardRef(function SiBackbonedotjs2({ title = "Backbone.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
