...
const SiPlesk = React__namespace.forwardRef(function SiPlesk2({ title = "Plesk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
