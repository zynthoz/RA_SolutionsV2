...
const defaultColor = "#0088CC";
const SiReactos = React__namespace.forwardRef(function SiReactos2({ title = "ReactOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
