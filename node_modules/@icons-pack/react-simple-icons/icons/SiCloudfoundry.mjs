...
const SiCloudfoundry = React.forwardRef(function SiCloudfoundry2({ title = "Cloud Foundry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
