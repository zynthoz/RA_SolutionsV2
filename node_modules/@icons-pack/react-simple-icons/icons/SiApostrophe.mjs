...
const SiApostrophe = React.forwardRef(function SiApostrophe2({ title = "Apostrophe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
