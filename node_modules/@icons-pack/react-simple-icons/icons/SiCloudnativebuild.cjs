...
const SiCloudnativebuild = React__namespace.forwardRef(function SiCloudnativebuild2({ title = "Cloud Native Build", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
