...
const SiSynology = React.forwardRef(function SiSynology2({ title = "Synology", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
