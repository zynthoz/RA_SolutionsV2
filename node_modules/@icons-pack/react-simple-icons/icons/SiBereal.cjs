...
const SiBereal = React__namespace.forwardRef(function SiBereal2({ title = "BeReal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
