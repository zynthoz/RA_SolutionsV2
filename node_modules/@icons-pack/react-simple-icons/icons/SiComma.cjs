...
const defaultColor = "#51FF00";
const SiComma = React__namespace.forwardRef(function SiComma2({ title = "comma", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
