...
const defaultColor = "#419EDA";
const SiEtcd = React__namespace.forwardRef(function SiEtcd2({ title = "etcd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
