...
const SiSwr = React__namespace.forwardRef(function SiSwr2({ title = "SWR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
