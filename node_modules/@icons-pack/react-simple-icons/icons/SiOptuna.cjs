...
const defaultColor = "#002C76";
const SiOptuna = React__namespace.forwardRef(function SiOptuna2({ title = "Optuna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
