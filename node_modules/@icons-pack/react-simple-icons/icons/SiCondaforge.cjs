...
const SiCondaforge = React__namespace.forwardRef(function SiCondaforge2({ title = "Conda-Forge", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
