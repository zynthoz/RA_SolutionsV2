...
const SiSiemens = React.forwardRef(function SiSiemens2({ title = "Siemens", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
