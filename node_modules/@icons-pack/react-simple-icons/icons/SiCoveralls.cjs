...
const defaultColor = "#3F5767";
const SiCoveralls = React__namespace.forwardRef(function SiCoveralls2({ title = "Coveralls", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
