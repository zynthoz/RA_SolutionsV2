...
const SiInstatus = React__namespace.forwardRef(function SiInstatus2({ title = "Instatus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
