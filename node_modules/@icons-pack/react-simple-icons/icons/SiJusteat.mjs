...
const SiJusteat = React.forwardRef(function SiJusteat2({ title = "Just Eat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
