...
const SiAlpinelinux = React__namespace.forwardRef(function SiAlpinelinux2({ title = "Alpine Linux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
