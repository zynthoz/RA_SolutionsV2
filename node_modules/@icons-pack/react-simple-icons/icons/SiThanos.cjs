...
const defaultColor = "#6D41FF";
const SiThanos = React__namespace.forwardRef(function SiThanos2({ title = "Thanos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
