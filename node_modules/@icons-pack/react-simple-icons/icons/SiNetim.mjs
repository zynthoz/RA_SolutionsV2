...
const SiNetim = React.forwardRef(function SiNetim2({ title = "Netim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
