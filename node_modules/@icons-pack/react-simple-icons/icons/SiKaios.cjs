...
const SiKaios = React__namespace.forwardRef(function SiKaios2({ title = "KaiOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
