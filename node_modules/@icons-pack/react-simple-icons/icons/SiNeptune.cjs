...
const defaultColor = "#5B69C2";
const SiNeptune = React__namespace.forwardRef(function SiNeptune2({ title = "Neptune", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
