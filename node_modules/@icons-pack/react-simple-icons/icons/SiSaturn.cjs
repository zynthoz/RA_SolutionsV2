...
const defaultColor = "#EB680B";
const SiSaturn = React__namespace.forwardRef(function SiSaturn2({ title = "Saturn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
