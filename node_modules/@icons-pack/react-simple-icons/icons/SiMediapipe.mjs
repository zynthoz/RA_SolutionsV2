...
const SiMediapipe = React.forwardRef(function SiMediapipe2({ title = "MediaPipe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
