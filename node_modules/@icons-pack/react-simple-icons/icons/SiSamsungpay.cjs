...
const SiSamsungpay = React__namespace.forwardRef(function SiSamsungpay2({ title = "Samsung Pay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
