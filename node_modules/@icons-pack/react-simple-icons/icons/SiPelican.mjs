...
const SiPelican = React.forwardRef(function SiPelican2({ title = "Pelican", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
