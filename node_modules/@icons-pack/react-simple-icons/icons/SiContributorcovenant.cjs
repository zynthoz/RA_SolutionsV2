...
const defaultColor = "#5E0D73";
const SiContributorcovenant = React__namespace.forwardRef(function SiContributorcovenant2({ title = "Contributor Covenant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
