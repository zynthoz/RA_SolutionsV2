...
const defaultColor = "#3152A0";
const SiMatomo = React.forwardRef(function SiMatomo2({ title = "Matomo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
