...
const defaultColor = "#193440";
const SiPypy = React__namespace.forwardRef(function SiPypy2({ title = "PyPy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
