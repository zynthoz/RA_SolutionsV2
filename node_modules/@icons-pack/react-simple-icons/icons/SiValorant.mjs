...
const SiValorant = React.forwardRef(function SiValorant2({ title = "Valorant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
