...
const SiSellfy = React.forwardRef(function SiSellfy2({ title = "Sellfy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
