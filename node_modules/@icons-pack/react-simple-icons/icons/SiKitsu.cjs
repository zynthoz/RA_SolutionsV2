...
const defaultColor = "#FD755C";
const SiKitsu = React__namespace.forwardRef(function SiKitsu2({ title = "Kitsu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
