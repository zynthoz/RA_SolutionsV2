...
const SiCodingninjas = React.forwardRef(function SiCodingninjas2({ title = "Coding Ninjas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
