...
const defaultColor = "#8669AE";
const SiCircle = React__namespace.forwardRef(function SiCircle2({ title = "Circle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
