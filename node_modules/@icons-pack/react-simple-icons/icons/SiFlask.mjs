...
const SiFlask = React.forwardRef(function SiFlask2({ title = "Flask", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
