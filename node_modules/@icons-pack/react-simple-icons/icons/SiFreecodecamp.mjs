...
const SiFreecodecamp = React.forwardRef(function SiFreecodecamp2({ title = "freeCodeCamp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
