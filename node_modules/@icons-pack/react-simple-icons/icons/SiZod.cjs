...
const SiZod = React__namespace.forwardRef(function SiZod2({ title = "Zod", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
