...
const defaultColor = "#006BFF";
const SiCalendly = React__namespace.forwardRef(function SiCalendly2({ title = "Calendly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
