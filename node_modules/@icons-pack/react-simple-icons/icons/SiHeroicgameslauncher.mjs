...
const SiHeroicgameslauncher = React.forwardRef(function SiHeroicgameslauncher2({ title = "Heroic Games Launcher", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
