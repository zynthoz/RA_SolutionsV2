...
const SiWorkplace = React__namespace.forwardRef(function SiWorkplace2({ title = "Workplace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
