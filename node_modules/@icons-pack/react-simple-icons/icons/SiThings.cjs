...
const SiThings = React__namespace.forwardRef(function SiThings2({ title = "Things", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
