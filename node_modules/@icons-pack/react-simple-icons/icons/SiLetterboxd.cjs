...
const SiLetterboxd = React__namespace.forwardRef(function SiLetterboxd2({ title = "Letterboxd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
