...
const defaultColor = "#4B69B6";
const SiTeamspeak = React__namespace.forwardRef(function SiTeamspeak2({ title = "TeamSpeak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
