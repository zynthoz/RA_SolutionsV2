...
const SiObb = React__namespace.forwardRef(function SiObb2({ title = "ÖBB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
