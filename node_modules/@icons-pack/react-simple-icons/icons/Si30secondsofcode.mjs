...
const Si30secondsofcode = React.forwardRef(function Si30secondsofcode2({ title = "30 seconds of code", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
