...
const SiNeutralinojs = React__namespace.forwardRef(function SiNeutralinojs2({ title = "Neutralinojs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
