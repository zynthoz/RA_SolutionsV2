...
const SiPayhip = React__namespace.forwardRef(function SiPayhip2({ title = "Payhip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
