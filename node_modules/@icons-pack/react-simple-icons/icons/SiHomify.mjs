...
const SiHomify = React.forwardRef(function SiHomify2({ title = "homify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
