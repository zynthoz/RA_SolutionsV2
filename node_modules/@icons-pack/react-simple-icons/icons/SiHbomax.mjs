...
const SiHbomax = React.forwardRef(function SiHbomax2({ title = "HBO Max", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
