...
const SiPearson = React.forwardRef(function SiPearson2({ title = "Pearson", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
