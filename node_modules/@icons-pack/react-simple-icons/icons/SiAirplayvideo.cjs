...
const SiAirplayvideo = React__namespace.forwardRef(function SiAirplayvideo2({ title = "AirPlay Video", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
