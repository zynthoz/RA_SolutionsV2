...
const SiDask = React.forwardRef(function SiDask2({ title = "Dask", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
