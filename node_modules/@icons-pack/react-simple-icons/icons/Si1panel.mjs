...
const Si1panel = React.forwardRef(function Si1panel2({ title = "1Panel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
