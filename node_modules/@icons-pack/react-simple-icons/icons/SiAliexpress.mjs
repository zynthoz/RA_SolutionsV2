...
const SiAliexpress = React.forwardRef(function SiAliexpress2({ title = "AliExpress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
