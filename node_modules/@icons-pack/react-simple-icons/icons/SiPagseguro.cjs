...
const defaultColor = "#FFC801";
const SiPagseguro = React__namespace.forwardRef(function SiPagseguro2({ title = "PagSeguro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
