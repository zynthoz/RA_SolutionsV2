...
const SiEasyjet = React.forwardRef(function SiEasyjet2({ title = "easyJet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
