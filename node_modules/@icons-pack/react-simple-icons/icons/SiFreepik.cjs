...
const SiFreepik = React__namespace.forwardRef(function SiFreepik2({ title = "Freepik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
