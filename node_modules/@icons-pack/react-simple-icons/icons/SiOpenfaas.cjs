...
const SiOpenfaas = React__namespace.forwardRef(function SiOpenfaas2({ title = "OpenFaaS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
