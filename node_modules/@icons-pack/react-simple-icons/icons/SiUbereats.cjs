...
const defaultColor = "#06C167";
const SiUbereats = React__namespace.forwardRef(function SiUbereats2({ title = "Uber Eats", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
