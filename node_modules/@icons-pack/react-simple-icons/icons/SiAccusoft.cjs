...
const defaultColor = "#A9225C";
const SiAccusoft = React__namespace.forwardRef(function SiAccusoft2({ title = "Accusoft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
