...
const SiYaml = React__namespace.forwardRef(function SiYaml2({ title = "YAML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
