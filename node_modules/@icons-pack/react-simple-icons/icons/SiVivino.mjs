...
const defaultColor = "#A61A30";
const SiVivino = React.forwardRef(function SiVivino2({ title = "Vivino", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
