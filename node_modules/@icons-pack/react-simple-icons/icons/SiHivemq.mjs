...
const SiHivemq = React.forwardRef(function SiHivemq2({ title = "HiveMQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
