...
const defaultColor = "#207BEA";
const SiStackbit = React__namespace.forwardRef(function SiStackbit2({ title = "Stackbit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
