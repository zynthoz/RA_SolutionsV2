...
const SiChai = React.forwardRef(function SiChai2({ title = "Chai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
