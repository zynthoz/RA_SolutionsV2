...
const SiGraphiteEditor = React__namespace.forwardRef(function SiGraphiteEditor2({ title = "Graphite", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
