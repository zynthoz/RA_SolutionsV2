...
const SiLazarus = React__namespace.forwardRef(function SiLazarus2({ title = "Lazarus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
