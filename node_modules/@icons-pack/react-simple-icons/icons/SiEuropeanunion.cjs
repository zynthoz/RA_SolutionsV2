...
const SiEuropeanunion = React__namespace.forwardRef(function SiEuropeanunion2({ title = "European Union", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
