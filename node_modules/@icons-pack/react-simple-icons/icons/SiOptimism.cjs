...
const SiOptimism = React__namespace.forwardRef(function SiOptimism2({ title = "Optimism", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
