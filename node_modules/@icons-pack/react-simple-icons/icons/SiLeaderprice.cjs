...
const defaultColor = "#E50005";
const SiLeaderprice = React__namespace.forwardRef(function SiLeaderprice2({ title = "Leader Price", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
