...
const SiSpringCreators = React.forwardRef(function SiSpringCreators2({ title = "Spring", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
