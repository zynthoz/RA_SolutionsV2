...
const SiPlausibleanalytics = React.forwardRef(function SiPlausibleanalytics2({ title = "Plausible Analytics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
