...
const defaultColor = "#009FDB";
const SiAtandt = React__namespace.forwardRef(function SiAtandt2({ title = "AT&T", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
