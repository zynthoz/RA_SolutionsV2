...
const SiMonkeytie = React.forwardRef(function SiMonkeytie2({ title = "monkey tie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
