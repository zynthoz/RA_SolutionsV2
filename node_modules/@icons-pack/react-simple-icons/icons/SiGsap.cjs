...
const SiGsap = React__namespace.forwardRef(function SiGsap2({ title = "GSAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
