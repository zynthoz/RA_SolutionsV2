...
const SiSaucelabs = React.forwardRef(function SiSaucelabs2({ title = "Sauce Labs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
