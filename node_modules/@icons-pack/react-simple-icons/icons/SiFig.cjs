...
const SiFig = React__namespace.forwardRef(function SiFig2({ title = "Fig", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
