...
const SiBuddy = React.forwardRef(function SiBuddy2({ title = "Buddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
