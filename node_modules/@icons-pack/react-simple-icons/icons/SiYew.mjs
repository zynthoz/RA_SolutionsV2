...
const SiYew = React.forwardRef(function SiYew2({ title = "Yew", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
