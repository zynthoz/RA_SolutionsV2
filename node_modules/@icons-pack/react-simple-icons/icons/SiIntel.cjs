...
const defaultColor = "#0071C5";
const SiIntel = React__namespace.forwardRef(function SiIntel2({ title = "Intel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
