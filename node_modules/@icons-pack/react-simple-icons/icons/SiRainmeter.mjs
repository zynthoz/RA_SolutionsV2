...
const SiRainmeter = React.forwardRef(function SiRainmeter2({ title = "Rainmeter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
