...
const SiAudacity = React.forwardRef(function SiAudacity2({ title = "Audacity", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
