...
const defaultColor = "#F26822";
const SiBugcrowd = React__namespace.forwardRef(function SiBugcrowd2({ title = "Bugcrowd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
