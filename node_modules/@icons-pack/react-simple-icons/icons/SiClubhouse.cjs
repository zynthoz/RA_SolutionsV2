...
const defaultColor = "#FFE450";
const SiClubhouse = React__namespace.forwardRef(function SiClubhouse2({ title = "Clubhouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
