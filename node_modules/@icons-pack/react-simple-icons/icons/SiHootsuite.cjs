...
const SiHootsuite = React__namespace.forwardRef(function SiHootsuite2({ title = "Hootsuite", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
