...
const defaultColor = "#660066";
const SiMqtt = React.forwardRef(function SiMqtt2({ title = "MQTT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
