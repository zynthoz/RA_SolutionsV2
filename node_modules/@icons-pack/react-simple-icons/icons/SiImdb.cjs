...
const SiImdb = React__namespace.forwardRef(function SiImdb2({ title = "IMDb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
