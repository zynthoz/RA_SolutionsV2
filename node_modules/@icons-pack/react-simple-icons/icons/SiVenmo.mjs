...
const defaultColor = "#008CFF";
const SiVenmo = React.forwardRef(function SiVenmo2({ title = "Venmo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
