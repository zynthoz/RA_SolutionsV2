...
const SiHonda = React.forwardRef(function SiHonda2({ title = "Honda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
