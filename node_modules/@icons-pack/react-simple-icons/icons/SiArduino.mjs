...
const SiArduino = React.forwardRef(function SiArduino2({ title = "Arduino", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
