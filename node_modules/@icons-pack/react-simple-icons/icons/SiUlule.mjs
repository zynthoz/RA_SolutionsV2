...
const SiUlule = React.forwardRef(function SiUlule2({ title = "Ulule", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
