...
const SiFigshare = React.forwardRef(function SiFigshare2({ title = "figshare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
