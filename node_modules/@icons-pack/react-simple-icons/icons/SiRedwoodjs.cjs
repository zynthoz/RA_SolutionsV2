...
const defaultColor = "#BF4722";
const SiRedwoodjs = React__namespace.forwardRef(function SiRedwoodjs2({ title = "RedwoodJS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
