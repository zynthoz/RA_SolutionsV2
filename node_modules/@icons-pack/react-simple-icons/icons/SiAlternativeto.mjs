...
const SiAlternativeto = React.forwardRef(function SiAlternativeto2({ title = "AlternativeTo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
