...
const SiVfairs = React__namespace.forwardRef(function SiVfairs2({ title = "vFairs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
