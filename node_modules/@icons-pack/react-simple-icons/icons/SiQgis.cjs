...
const defaultColor = "#589632";
const SiQgis = React__namespace.forwardRef(function SiQgis2({ title = "Qgis", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
