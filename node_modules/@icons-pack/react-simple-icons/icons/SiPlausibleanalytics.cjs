...
const SiPlausibleanalytics = React__namespace.forwardRef(function SiPlausibleanalytics2({ title = "Plausible Analytics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
