...
const SiTriller = React.forwardRef(function SiTriller2({ title = "Triller", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
