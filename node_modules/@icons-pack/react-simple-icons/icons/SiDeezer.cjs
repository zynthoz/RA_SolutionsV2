...
const SiDeezer = React__namespace.forwardRef(function SiDeezer2({ title = "Deezer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
