...
const SiRedbull = React.forwardRef(function SiRedbull2({ title = "Red Bull", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
