...
const SiPydantic = React.forwardRef(function SiPydantic2({ title = "Pydantic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
