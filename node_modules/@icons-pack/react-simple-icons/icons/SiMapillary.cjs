...
const defaultColor = "#00AF66";
const SiMapillary = React__namespace.forwardRef(function SiMapillary2({ title = "Mapillary", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
