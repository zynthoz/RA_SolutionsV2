...
const SiGutenberg = React__namespace.forwardRef(function SiGutenberg2({ title = "Gutenberg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
