...
const defaultColor = "#0072EF";
const SiEagle = React__namespace.forwardRef(function SiEagle2({ title = "Eagle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
