...
const SiKeycdn = React.forwardRef(function SiKeycdn2({ title = "KeyCDN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
