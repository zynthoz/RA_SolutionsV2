...
const defaultColor = "#596CAF";
const SiCarrd = React__namespace.forwardRef(function SiCarrd2({ title = "Carrd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
