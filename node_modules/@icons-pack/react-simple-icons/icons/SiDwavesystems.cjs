...
const defaultColor = "#008CD7";
const SiDwavesystems = React__namespace.forwardRef(function SiDwavesystems2({ title = "D-Wave Systems", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
