...
const SiHepsiemlak = React.forwardRef(function SiHepsiemlak2({ title = "Hepsiemlak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
