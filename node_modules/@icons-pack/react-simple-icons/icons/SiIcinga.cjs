...
const defaultColor = "#06062C";
const SiIcinga = React__namespace.forwardRef(function SiIcinga2({ title = "Icinga", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
