...
const SiOnstar = React.forwardRef(function SiOnstar2({ title = "OnStar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
