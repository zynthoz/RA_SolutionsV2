...
const SiContributorcovenant = React.forwardRef(function SiContributorcovenant2({ title = "Contributor Covenant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
