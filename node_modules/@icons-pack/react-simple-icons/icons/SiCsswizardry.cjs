...
const defaultColor = "#F43059";
const SiCsswizardry = React__namespace.forwardRef(function SiCsswizardry2({ title = "CSS Wizardry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
