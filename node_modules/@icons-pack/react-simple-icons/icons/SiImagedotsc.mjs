...
const SiImagedotsc = React.forwardRef(function SiImagedotsc2({ title = "Image.sc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
