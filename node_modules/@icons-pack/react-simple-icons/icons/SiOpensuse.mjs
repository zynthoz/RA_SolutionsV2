...
const defaultColor = "#73BA25";
const SiOpensuse = React.forwardRef(function SiOpensuse2({ title = "openSUSE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
