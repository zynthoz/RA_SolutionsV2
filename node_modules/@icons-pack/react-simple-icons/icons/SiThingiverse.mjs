...
const SiThingiverse = React.forwardRef(function SiThingiverse2({ title = "Thingiverse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
