...
const defaultColor = "#9013FE";
const SiCodenewbie = React__namespace.forwardRef(function SiCodenewbie2({ title = "CodeNewbie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
