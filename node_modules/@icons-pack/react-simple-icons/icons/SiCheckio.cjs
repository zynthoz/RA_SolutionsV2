...
const defaultColor = "#008DB6";
const SiCheckio = React__namespace.forwardRef(function SiCheckio2({ title = "CheckiO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
