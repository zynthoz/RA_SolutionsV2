...
const SiCoolermaster = React.forwardRef(function SiCoolermaster2({ title = "Cooler Master", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
