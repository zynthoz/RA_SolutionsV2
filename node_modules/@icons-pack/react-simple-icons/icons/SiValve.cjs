...
const SiValve = React__namespace.forwardRef(function SiValve2({ title = "Valve", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
