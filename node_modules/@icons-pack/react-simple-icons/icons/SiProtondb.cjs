...
const defaultColor = "#F50057";
const SiProtondb = React__namespace.forwardRef(function SiProtondb2({ title = "ProtonDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
