...
const SiLobsters = React__namespace.forwardRef(function SiLobsters2({ title = "Lobsters", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
