...
const defaultColor = "#DD052B";
const SiMahindra = React__namespace.forwardRef(function SiMahindra2({ title = "Mahindra", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
