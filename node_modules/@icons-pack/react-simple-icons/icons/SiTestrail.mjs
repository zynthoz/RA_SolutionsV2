...
const SiTestrail = React.forwardRef(function SiTestrail2({ title = "TestRail", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
