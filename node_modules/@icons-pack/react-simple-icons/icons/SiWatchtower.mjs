...
const SiWatchtower = React.forwardRef(function SiWatchtower2({ title = "Watchtower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
