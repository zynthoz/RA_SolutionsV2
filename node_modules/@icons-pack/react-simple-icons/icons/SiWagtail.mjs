...
const SiWagtail = React.forwardRef(function SiWagtail2({ title = "Wagtail", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
