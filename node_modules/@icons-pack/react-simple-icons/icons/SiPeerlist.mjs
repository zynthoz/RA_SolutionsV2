...
const SiPeerlist = React.forwardRef(function SiPeerlist2({ title = "Peerlist", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
