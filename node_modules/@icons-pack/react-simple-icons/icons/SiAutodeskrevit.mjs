...
const SiAutodeskrevit = React.forwardRef(function SiAutodeskrevit2({ title = "Autodesk Revit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
