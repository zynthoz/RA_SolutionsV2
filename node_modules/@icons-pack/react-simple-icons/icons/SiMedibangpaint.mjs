...
const SiMedibangpaint = React.forwardRef(function SiMedibangpaint2({ title = "MediBang Paint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
