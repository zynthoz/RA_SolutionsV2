...
const SiKfc = React__namespace.forwardRef(function SiKfc2({ title = "KFC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
