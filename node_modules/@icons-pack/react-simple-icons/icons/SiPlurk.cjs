...
const SiPlurk = React__namespace.forwardRef(function SiPlurk2({ title = "Plurk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
