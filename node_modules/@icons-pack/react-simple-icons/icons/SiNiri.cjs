...
const SiNiri = React__namespace.forwardRef(function SiNiri2({ title = "niri", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
