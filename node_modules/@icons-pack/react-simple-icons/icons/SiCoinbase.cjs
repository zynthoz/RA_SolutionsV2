...
const defaultColor = "#0052FF";
const SiCoinbase = React__namespace.forwardRef(function SiCoinbase2({ title = "Coinbase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
