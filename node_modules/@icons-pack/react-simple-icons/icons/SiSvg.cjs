...
const SiSvg = React__namespace.forwardRef(function SiSvg2({ title = "SVG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
