...
const SiNapster = React__namespace.forwardRef(function SiNapster2({ title = "Napster", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
