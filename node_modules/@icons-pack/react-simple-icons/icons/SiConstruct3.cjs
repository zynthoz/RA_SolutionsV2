...
const defaultColor = "#00FFDA";
const SiConstruct3 = React__namespace.forwardRef(function SiConstruct32({ title = "Construct 3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
