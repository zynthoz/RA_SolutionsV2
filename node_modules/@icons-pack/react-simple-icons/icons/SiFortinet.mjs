...
const SiFortinet = React.forwardRef(function SiFortinet2({ title = "Fortinet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
