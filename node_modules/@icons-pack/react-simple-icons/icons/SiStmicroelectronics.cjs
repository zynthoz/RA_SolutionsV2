...
const SiStmicroelectronics = React__namespace.forwardRef(function SiStmicroelectronics2({ title = "STMicroelectronics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
