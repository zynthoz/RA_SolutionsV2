...
const defaultColor = "#ED225D";
const SiP5dotjs = React__namespace.forwardRef(function SiP5dotjs2({ title = "p5.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
