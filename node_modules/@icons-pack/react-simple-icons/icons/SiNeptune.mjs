...
const SiNeptune = React.forwardRef(function SiNeptune2({ title = "Neptune", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
