...
const defaultColor = "#0133AD";
const SiCardano = React.forwardRef(function SiCardano2({ title = "Cardano", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
