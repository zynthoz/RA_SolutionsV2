...
const SiDashlane = React.forwardRef(function SiDashlane2({ title = "Dashlane", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
