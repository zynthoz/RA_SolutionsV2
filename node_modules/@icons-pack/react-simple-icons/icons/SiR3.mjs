...
const SiR3 = React.forwardRef(function SiR32({ title = "R3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
