...
const SiCloudron = React__namespace.forwardRef(function SiCloudron2({ title = "Cloudron", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
