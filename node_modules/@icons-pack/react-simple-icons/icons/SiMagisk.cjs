...
const defaultColor = "#00AF9C";
const SiMagisk = React__namespace.forwardRef(function SiMagisk2({ title = "Magisk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
