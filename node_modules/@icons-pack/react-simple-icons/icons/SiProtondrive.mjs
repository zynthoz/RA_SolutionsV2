...
const defaultColor = "#EB508D";
const SiProtondrive = React.forwardRef(function SiProtondrive2({ title = "Proton Drive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
