...
const defaultColor = "#DE3723";
const SiNamecheap = React.forwardRef(function SiNamecheap2({ title = "Namecheap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
