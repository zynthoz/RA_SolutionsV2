...
const SiSitecore = React__namespace.forwardRef(function SiSitecore2({ title = "Sitecore", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
