...
const SiPhotocrowd = React__namespace.forwardRef(function SiPhotocrowd2({ title = "Photocrowd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
