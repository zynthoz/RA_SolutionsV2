...
const defaultColor = "#EB4714";
const SiBuysellads = React__namespace.forwardRef(function SiBuysellads2({ title = "BuySellAds", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
