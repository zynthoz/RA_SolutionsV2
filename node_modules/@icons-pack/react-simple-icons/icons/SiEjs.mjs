...
const SiEjs = React.forwardRef(function SiEjs2({ title = "EJS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
