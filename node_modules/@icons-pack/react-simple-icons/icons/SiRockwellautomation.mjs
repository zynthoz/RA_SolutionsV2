...
const SiRockwellautomation = React.forwardRef(function SiRockwellautomation2({ title = "Rockwell Automation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
