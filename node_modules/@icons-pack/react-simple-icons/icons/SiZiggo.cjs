...
const SiZiggo = React__namespace.forwardRef(function SiZiggo2({ title = "Ziggo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
