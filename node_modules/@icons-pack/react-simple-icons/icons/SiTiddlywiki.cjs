...
const SiTiddlywiki = React__namespace.forwardRef(function SiTiddlywiki2({ title = "TiddlyWiki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
