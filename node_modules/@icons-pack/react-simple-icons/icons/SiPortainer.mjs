...
const SiPortainer = React.forwardRef(function SiPortainer2({ title = "Portainer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
