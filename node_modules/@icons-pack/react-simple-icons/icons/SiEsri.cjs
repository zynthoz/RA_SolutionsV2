...
const SiEsri = React__namespace.forwardRef(function SiEsri2({ title = "ESRI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
