...
const SiPinetwork = React__namespace.forwardRef(function SiPinetwork2({ title = "Pi Network", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
