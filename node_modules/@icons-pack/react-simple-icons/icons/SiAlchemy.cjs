...
const defaultColor = "#0C0C0E";
const SiAlchemy = React__namespace.forwardRef(function SiAlchemy2({ title = "Alchemy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
