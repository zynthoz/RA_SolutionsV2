...
const defaultColor = "#1578D3";
const SiAlliedmodders = React__namespace.forwardRef(function SiAlliedmodders2({ title = "AlliedModders", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
