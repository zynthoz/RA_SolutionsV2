...
const defaultColor = "#E31E24";
const SiContinente = React__namespace.forwardRef(function SiContinente2({ title = "Continente", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
