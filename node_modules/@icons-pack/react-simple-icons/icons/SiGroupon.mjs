...
const SiGroupon = React.forwardRef(function SiGroupon2({ title = "Groupon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
