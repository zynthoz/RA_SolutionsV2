...
const SiKleinanzeigen = React.forwardRef(function SiKleinanzeigen2({ title = "Kleinanzeigen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
