...
const SiDirectus = React__namespace.forwardRef(function SiDirectus2({ title = "Directus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
