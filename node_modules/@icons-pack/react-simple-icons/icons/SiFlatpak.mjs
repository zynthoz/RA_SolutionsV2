...
const SiFlatpak = React.forwardRef(function SiFlatpak2({ title = "Flatpak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
