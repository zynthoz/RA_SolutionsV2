...
const defaultColor = "#AECBFA";
const SiGooglepubsub = React__namespace.forwardRef(function SiGooglepubsub2({ title = "Google Pub/Sub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
