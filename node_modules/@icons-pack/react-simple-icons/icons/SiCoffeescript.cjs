...
const defaultColor = "#2F2625";
const SiCoffeescript = React__namespace.forwardRef(function SiCoffeescript2({ title = "CoffeeScript", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
