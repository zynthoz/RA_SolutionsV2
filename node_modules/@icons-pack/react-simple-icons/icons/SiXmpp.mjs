...
const defaultColor = "#002B5C";
const SiXmpp = React.forwardRef(function SiXmpp2({ title = "XMPP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
