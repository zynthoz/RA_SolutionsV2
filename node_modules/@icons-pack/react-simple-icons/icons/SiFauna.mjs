...
const SiFauna = React.forwardRef(function SiFauna2({ title = "Fauna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
