...
const SiGeopandas = React.forwardRef(function SiGeopandas2({ title = "GeoPandas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
