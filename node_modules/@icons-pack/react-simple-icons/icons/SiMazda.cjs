...
const SiMazda = React__namespace.forwardRef(function SiMazda2({ title = "Mazda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
