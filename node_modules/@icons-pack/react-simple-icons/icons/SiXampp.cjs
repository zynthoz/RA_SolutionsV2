...
const SiXampp = React__namespace.forwardRef(function SiXampp2({ title = "XAMPP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
