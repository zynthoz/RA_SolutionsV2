...
const SiQemu = React__namespace.forwardRef(function SiQemu2({ title = "QEMU", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
