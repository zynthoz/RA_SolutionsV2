...
const defaultColor = "#00E7C3";
const SiImmer = React__namespace.forwardRef(function SiImmer2({ title = "Immer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
