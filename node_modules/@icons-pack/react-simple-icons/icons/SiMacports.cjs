...
const SiMacports = React__namespace.forwardRef(function SiMacports2({ title = "MacPorts", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
