...
const defaultColor = "#683D87";
const SiBitrise = React__namespace.forwardRef(function SiBitrise2({ title = "Bitrise", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
