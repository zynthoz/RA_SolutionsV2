...
const SiOpenwrt = React__namespace.forwardRef(function SiOpenwrt2({ title = "OpenWrt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
