...
const SiRedhatopenshift = React__namespace.forwardRef(function SiRedhatopenshift2({ title = "Red Hat Open Shift", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
