...
const SiGrapheneos = React__namespace.forwardRef(function SiGrapheneos2({ title = "GrapheneOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
