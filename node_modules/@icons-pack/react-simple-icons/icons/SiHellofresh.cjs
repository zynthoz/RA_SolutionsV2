...
const SiHellofresh = React__namespace.forwardRef(function SiHellofresh2({ title = "HelloFresh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
