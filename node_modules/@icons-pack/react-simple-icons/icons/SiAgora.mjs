...
const SiAgora = React.forwardRef(function SiAgora2({ title = "Agora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
