...
const SiMusicbrainz = React.forwardRef(function SiMusicbrainz2({ title = "MusicBrainz", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
