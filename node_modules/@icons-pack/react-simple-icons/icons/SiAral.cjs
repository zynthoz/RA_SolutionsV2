...
const defaultColor = "#0063CB";
const SiAral = React__namespace.forwardRef(function SiAral2({ title = "ARAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
