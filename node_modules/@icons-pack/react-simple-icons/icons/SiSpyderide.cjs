...
const SiSpyderide = React__namespace.forwardRef(function SiSpyderide2({ title = "Spyder IDE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
