...
const SiNbb = React.forwardRef(function SiNbb2({ title = "NBB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
