...
const defaultColor = "#142800";
const SiAlltrails = React__namespace.forwardRef(function SiAlltrails2({ title = "AllTrails", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
