...
const SiBluesound = React.forwardRef(function SiBluesound2({ title = "Bluesound", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
