...
const SiVyond = React__namespace.forwardRef(function SiVyond2({ title = "Vyond", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
