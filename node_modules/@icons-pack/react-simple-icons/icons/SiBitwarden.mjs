...
const SiBitwarden = React.forwardRef(function SiBitwarden2({ title = "Bitwarden", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
