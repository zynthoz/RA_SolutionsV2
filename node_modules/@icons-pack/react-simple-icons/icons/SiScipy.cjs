...
const SiScipy = React__namespace.forwardRef(function SiScipy2({ title = "SciPy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
