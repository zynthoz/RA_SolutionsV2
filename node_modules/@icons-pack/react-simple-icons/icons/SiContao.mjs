...
const SiContao = React.forwardRef(function SiContao2({ title = "Contao", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
