...
const SiMatomo = React__namespace.forwardRef(function SiMatomo2({ title = "Matomo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
