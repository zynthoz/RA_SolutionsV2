...
const SiHarmonyos = React.forwardRef(function SiHarmonyos2({ title = "HarmonyOS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
