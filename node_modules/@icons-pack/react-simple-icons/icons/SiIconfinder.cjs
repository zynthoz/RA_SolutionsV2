...
const defaultColor = "#1A1B1F";
const SiIconfinder = React__namespace.forwardRef(function SiIconfinder2({ title = "Iconfinder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
