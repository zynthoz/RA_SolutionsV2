...
const SiSkeleton = React__namespace.forwardRef(function SiSkeleton2({ title = "Skeleton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
