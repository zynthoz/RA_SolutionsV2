...
const defaultColor = "#8DC63F";
const SiJuce = React__namespace.forwardRef(function SiJuce2({ title = "JUCE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
