...
const SiYamahamotorcorporation = React__namespace.forwardRef(function SiYamahamotorcorporation2({ title = "Yamaha Motor Corporation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
