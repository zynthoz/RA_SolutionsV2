...
const SiMediatek = React.forwardRef(function SiMediatek2({ title = "MediaTek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
