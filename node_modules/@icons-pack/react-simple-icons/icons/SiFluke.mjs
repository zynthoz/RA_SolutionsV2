...
const SiFluke = React.forwardRef(function SiFluke2({ title = "Fluke", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
