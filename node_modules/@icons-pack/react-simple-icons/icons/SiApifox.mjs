...
const SiApifox = React.forwardRef(function SiApifox2({ title = "Apifox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
