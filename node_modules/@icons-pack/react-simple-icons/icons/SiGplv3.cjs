...
const SiGplv3 = React__namespace.forwardRef(function SiGplv32({ title = "GPLv3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
