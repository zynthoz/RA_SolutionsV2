...
const SiOutline = React.forwardRef(function SiOutline2({ title = "Outline", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
