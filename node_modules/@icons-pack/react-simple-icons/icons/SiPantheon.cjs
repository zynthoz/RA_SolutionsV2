...
const defaultColor = "#FFDC28";
const SiPantheon = React__namespace.forwardRef(function SiPantheon2({ title = "Pantheon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
