...
const SiTodoist = React.forwardRef(function SiTodoist2({ title = "Todoist", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
