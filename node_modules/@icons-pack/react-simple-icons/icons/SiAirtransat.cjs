...
const defaultColor = "#172B54";
const SiAirtransat = React__namespace.forwardRef(function SiAirtransat2({ title = "Air Transat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
