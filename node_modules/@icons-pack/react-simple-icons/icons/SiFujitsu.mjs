...
const SiFujitsu = React.forwardRef(function SiFujitsu2({ title = "Fujitsu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
