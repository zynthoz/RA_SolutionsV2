...
const defaultColor = "#728E9B";
const SiApachenifi = React__namespace.forwardRef(function SiApachenifi2({ title = "Apache NiFi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
