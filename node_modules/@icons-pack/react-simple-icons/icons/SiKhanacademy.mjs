...
const SiKhanacademy = React.forwardRef(function SiKhanacademy2({ title = "Khan Academy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
