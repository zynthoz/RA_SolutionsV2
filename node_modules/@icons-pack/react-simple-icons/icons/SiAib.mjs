...
const SiAib = React.forwardRef(function SiAib2({ title = "AIB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
