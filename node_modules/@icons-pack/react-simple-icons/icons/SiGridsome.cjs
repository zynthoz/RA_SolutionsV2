...
const SiGridsome = React__namespace.forwardRef(function SiGridsome2({ title = "Gridsome", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
