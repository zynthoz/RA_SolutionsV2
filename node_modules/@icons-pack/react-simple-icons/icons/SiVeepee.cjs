...
const defaultColor = "#EC008C";
const SiVeepee = React__namespace.forwardRef(function SiVeepee2({ title = "Veepee", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
