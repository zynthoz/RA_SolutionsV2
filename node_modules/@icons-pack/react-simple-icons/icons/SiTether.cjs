...
const defaultColor = "#50AF95";
const SiTether = React__namespace.forwardRef(function SiTether2({ title = "Tether", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
