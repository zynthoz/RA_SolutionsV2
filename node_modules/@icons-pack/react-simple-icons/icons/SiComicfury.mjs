...
const SiComicfury = React.forwardRef(function SiComicfury2({ title = "ComicFury", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
