...
const defaultColor = "#7C5CDF";
const SiPlume = React__namespace.forwardRef(function SiPlume2({ title = "Plume", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
