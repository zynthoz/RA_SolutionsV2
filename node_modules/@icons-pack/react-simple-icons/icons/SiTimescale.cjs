...
const defaultColor = "#FDB515";
const SiTimescale = React__namespace.forwardRef(function SiTimescale2({ title = "Timescale", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
