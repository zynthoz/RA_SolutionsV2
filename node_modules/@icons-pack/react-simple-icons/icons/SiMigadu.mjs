...
const SiMigadu = React.forwardRef(function SiMigadu2({ title = "Migadu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
