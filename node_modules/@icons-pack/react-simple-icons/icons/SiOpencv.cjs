...
const defaultColor = "#5C3EE8";
const SiOpencv = React__namespace.forwardRef(function SiOpencv2({ title = "OpenCV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
