...
const defaultColor = "#3492FF";
const SiLodash = React__namespace.forwardRef(function SiLodash2({ title = "Lodash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
