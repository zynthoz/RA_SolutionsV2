...
const SiAegisauthenticator = React.forwardRef(function SiAegisauthenticator2({ title = "Aegis Authenticator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
