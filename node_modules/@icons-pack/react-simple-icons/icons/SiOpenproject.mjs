...
const defaultColor = "#0770B8";
const SiOpenproject = React.forwardRef(function SiOpenproject2({ title = "OpenProject", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
