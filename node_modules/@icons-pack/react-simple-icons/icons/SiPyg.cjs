...
const SiPyg = React__namespace.forwardRef(function SiPyg2({ title = "PyG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
