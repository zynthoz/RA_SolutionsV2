...
const SiQbittorrent = React.forwardRef(function SiQbittorrent2({ title = "qbittorrent", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
