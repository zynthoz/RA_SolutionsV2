...
const SiTripdotcom = React__namespace.forwardRef(function SiTripdotcom2({ title = "Trip.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
