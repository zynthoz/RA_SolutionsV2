...
const defaultColor = "#073551";
const SiCurl = React__namespace.forwardRef(function SiCurl2({ title = "curl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
