...
const SiQuest = React__namespace.forwardRef(function SiQuest2({ title = "Quest", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
