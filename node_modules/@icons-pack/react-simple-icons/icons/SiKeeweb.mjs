...
const SiKeeweb = React.forwardRef(function SiKeeweb2({ title = "KeeWeb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
