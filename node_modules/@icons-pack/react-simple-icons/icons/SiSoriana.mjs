...
const defaultColor = "#D52B1E";
const SiSoriana = React.forwardRef(function SiSoriana2({ title = "Soriana", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
