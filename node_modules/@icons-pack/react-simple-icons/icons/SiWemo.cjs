...
const defaultColor = "#72D44C";
const SiWemo = React__namespace.forwardRef(function SiWemo2({ title = "WEMO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
