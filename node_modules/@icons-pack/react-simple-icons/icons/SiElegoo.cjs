...
const SiElegoo = React__namespace.forwardRef(function SiElegoo2({ title = "Elegoo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
