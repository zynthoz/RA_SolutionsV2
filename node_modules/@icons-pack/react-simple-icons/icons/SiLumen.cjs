...
const SiLumen = React__namespace.forwardRef(function SiLumen2({ title = "Lumen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
