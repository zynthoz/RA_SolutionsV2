...
const SiIonos = React__namespace.forwardRef(function SiIonos2({ title = "Ionos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
