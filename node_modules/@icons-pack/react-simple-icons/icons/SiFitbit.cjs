...
const defaultColor = "#00B0B9";
const SiFitbit = React__namespace.forwardRef(function SiFitbit2({ title = "Fitbit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
