...
const SiPrivateinternetaccess = React.forwardRef(function SiPrivateinternetaccess2({ title = "Private Internet Access", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
