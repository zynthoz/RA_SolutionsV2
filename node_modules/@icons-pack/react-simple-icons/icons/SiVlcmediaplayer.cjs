...
const SiVlcmediaplayer = React__namespace.forwardRef(function SiVlcmediaplayer2({ title = "VLC media player", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
