...
const SiSemver = React.forwardRef(function SiSemver2({ title = "SemVer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
