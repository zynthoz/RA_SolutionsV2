...
const SiInkscape = React__namespace.forwardRef(function SiInkscape2({ title = "Inkscape", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
