...
const SiNodered = React.forwardRef(function SiNodered2({ title = "Node-RED", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
