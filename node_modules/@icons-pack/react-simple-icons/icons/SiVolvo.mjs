...
const SiVolvo = React.forwardRef(function SiVolvo2({ title = "Volvo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
