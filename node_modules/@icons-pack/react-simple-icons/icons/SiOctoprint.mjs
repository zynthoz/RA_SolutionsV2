...
const SiOctoprint = React.forwardRef(function SiOctoprint2({ title = "OctoPrint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
