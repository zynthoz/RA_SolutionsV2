...
const SiCarlsberggroup = React.forwardRef(function SiCarlsberggroup2({ title = "Carlsberg Group", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
