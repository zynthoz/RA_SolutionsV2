...
const defaultColor = "#FBB040";
const SiHomebrew = React__namespace.forwardRef(function SiHomebrew2({ title = "Homebrew", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
