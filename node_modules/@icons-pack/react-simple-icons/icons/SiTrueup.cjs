...
const SiTrueup = React__namespace.forwardRef(function SiTrueup2({ title = "TrueUp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
