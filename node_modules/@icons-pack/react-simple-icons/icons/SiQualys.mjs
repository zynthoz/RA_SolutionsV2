...
const defaultColor = "#ED2E26";
const SiQualys = React.forwardRef(function SiQualys2({ title = "Qualys", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
