...
const SiJbl = React__namespace.forwardRef(function SiJbl2({ title = "JBL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
