...
const defaultColor = "#ED2761";
const SiTeespring = React__namespace.forwardRef(function SiTeespring2({ title = "Teespring", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
