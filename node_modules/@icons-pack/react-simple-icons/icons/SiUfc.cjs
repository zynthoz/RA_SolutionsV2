...
const defaultColor = "#D20A0A";
const SiUfc = React__namespace.forwardRef(function SiUfc2({ title = "UFC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
