...
const SiApollographql = React.forwardRef(function SiApollographql2({ title = "Apollo GraphQL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
