...
const SiConan = React.forwardRef(function SiConan2({ title = "Conan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
