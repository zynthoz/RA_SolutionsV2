...
const defaultColor = "#E20612";
const SiLeica = React__namespace.forwardRef(function SiLeica2({ title = "Leica", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
