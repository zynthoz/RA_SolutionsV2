...
const SiKasasmart = React__namespace.forwardRef(function SiKasasmart2({ title = "Kasa Smart", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
