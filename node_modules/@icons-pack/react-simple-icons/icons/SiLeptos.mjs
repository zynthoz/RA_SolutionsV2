...
const SiLeptos = React.forwardRef(function SiLeptos2({ title = "Leptos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
