...
const SiSogou = React.forwardRef(function SiSogou2({ title = "Sogou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
