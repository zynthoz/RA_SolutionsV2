...
const SiSeagate = React.forwardRef(function SiSeagate2({ title = "Seagate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
