...
const SiDaisyui = React.forwardRef(function SiDaisyui2({ title = "daisyUI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
