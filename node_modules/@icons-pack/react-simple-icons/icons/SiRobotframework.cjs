...
const SiRobotframework = React__namespace.forwardRef(function SiRobotframework2({ title = "Robot Framework", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
