...
const defaultColor = "#6CADDF";
const SiCesium = React__namespace.forwardRef(function SiCesium2({ title = "Cesium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
