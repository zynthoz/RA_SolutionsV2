...
const SiMoqups = React__namespace.forwardRef(function SiMoqups2({ title = "Moqups", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
