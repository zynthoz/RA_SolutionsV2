...
const SiKoc = React__namespace.forwardRef(function SiKoc2({ title = "Koc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
