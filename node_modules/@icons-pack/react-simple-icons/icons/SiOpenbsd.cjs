...
const defaultColor = "#F2CA30";
const SiOpenbsd = React__namespace.forwardRef(function SiOpenbsd2({ title = "OpenBSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
