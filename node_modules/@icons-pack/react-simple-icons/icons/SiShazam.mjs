...
const defaultColor = "#0088FF";
const SiShazam = React.forwardRef(function SiShazam2({ title = "Shazam", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
