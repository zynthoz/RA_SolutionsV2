...
const SiJetpackcompose = React__namespace.forwardRef(function SiJetpackcompose2({ title = "Jetpack Compose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
