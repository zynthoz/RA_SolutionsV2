...
const defaultColor = "#00A9CE";
const SiNordicsemiconductor = React__namespace.forwardRef(function SiNordicsemiconductor2({ title = "Nordic Semiconductor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
