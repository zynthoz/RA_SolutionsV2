...
const defaultColor = "#0061D5";
const SiBox = React__namespace.forwardRef(function SiBox2({ title = "Box", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
