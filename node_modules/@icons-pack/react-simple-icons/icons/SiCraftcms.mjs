...
const SiCraftcms = React.forwardRef(function SiCraftcms2({ title = "Craft CMS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
