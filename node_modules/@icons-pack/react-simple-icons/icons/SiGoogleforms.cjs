...
const defaultColor = "#7248B9";
const SiGoogleforms = React__namespace.forwardRef(function SiGoogleforms2({ title = "Google Forms", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
