...
const SiCockroachlabs = React__namespace.forwardRef(function SiCockroachlabs2({ title = "Cockroach Labs", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
