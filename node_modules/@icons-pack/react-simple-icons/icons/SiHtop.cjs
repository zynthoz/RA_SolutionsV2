...
const defaultColor = "#009020";
const SiHtop = React__namespace.forwardRef(function SiHtop2({ title = "htop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
