...
const defaultColor = "#880000";
const SiMongoose = React__namespace.forwardRef(function SiMongoose2({ title = "Mongoose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
