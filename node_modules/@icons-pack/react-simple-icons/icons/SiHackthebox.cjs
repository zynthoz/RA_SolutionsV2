...
const defaultColor = "#9FEF00";
const SiHackthebox = React__namespace.forwardRef(function SiHackthebox2({ title = "Hack The Box", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
