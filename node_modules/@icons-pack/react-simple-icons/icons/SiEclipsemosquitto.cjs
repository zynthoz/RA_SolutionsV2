...
const defaultColor = "#3C5280";
const SiEclipsemosquitto = React__namespace.forwardRef(function SiEclipsemosquitto2({ title = "Eclipse Mosquitto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
