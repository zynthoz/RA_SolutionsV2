...
const defaultColor = "#B2FCE4";
const SiAfterpay = React__namespace.forwardRef(function SiAfterpay2({ title = "Afterpay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
