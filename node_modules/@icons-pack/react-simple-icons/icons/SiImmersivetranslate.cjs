...
const SiImmersivetranslate = React__namespace.forwardRef(function SiImmersivetranslate2({ title = "Immersive Translate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
