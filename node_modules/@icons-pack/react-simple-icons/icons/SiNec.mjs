...
const defaultColor = "#1414A0";
const SiNec = React.forwardRef(function SiNec2({ title = "NEC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
