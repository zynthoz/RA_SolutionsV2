...
const SiMyshows = React__namespace.forwardRef(function SiMyshows2({ title = "MyShows", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
