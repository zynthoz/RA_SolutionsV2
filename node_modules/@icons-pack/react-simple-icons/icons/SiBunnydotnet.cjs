...
const SiBunnydotnet = React__namespace.forwardRef(function SiBunnydotnet2({ title = "bunny.net", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
