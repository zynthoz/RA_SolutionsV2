...
const defaultColor = "#00B0D8";
const SiProbot = React__namespace.forwardRef(function SiProbot2({ title = "Probot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
