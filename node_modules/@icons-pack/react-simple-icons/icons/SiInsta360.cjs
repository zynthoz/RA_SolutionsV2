...
const SiInsta360 = React__namespace.forwardRef(function SiInsta3602({ title = "Insta360", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
