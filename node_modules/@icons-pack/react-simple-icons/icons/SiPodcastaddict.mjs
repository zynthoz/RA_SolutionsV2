...
const SiPodcastaddict = React.forwardRef(function SiPodcastaddict2({ title = "Podcast Addict", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
