...
const SiQuasar = React__namespace.forwardRef(function SiQuasar2({ title = "Quasar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
