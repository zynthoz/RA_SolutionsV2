...
const SiAdyen = React.forwardRef(function SiAdyen2({ title = "Adyen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
