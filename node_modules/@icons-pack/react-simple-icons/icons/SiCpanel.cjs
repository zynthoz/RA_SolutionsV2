...
const defaultColor = "#FF6C2C";
const SiCpanel = React__namespace.forwardRef(function SiCpanel2({ title = "cPanel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
