...
const SiPassbolt = React__namespace.forwardRef(function SiPassbolt2({ title = "Passbolt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
