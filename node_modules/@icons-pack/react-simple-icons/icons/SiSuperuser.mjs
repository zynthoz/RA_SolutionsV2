...
const SiSuperuser = React.forwardRef(function SiSuperuser2({ title = "Super User", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
