...
const defaultColor = "#CF0A2C";
const SiNewbalance = React.forwardRef(function SiNewbalance2({ title = "New Balance", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
