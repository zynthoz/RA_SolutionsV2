...
const SiListenhub = React__namespace.forwardRef(function SiListenhub2({ title = "ListenHub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
