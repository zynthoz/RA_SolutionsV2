...
const defaultColor = "#336699";
const SiPublons = React__namespace.forwardRef(function SiPublons2({ title = "Publons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
