...
const SiEdeka = React.forwardRef(function SiEdeka2({ title = "EDEKA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
