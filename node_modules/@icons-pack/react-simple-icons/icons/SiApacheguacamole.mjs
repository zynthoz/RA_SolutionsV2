...
const SiApacheguacamole = React.forwardRef(function SiApacheguacamole2({ title = "Apache Guacamole", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
