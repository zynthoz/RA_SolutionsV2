...
const SiGusto = React.forwardRef(function SiGusto2({ title = "Gusto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
