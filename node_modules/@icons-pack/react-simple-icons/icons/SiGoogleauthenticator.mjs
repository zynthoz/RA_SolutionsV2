...
const SiGoogleauthenticator = React.forwardRef(function SiGoogleauthenticator2({ title = "Google Authenticator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
