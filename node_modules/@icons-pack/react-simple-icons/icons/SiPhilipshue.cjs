...
const defaultColor = "#0065D3";
const SiPhilipshue = React__namespace.forwardRef(function SiPhilipshue2({ title = "Philips Hue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
