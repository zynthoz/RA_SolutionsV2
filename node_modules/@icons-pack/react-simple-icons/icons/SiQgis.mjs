...
const SiQgis = React.forwardRef(function SiQgis2({ title = "Qgis", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
