...
const defaultColor = "#2F93E0";
const SiOctopusdeploy = React__namespace.forwardRef(function SiOctopusdeploy2({ title = "Octopus Deploy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
