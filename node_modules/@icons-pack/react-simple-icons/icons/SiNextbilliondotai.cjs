...
const defaultColor = "#8D5A9E";
const SiNextbilliondotai = React__namespace.forwardRef(function SiNextbilliondotai2({ title = "NextBillion.ai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
