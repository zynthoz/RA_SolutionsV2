...
const defaultColor = "#047DA3";
const SiSat1 = React__namespace.forwardRef(function SiSat12({ title = "Sat.1", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
