...
const SiApachesuperset = React.forwardRef(function SiApachesuperset2({ title = "Apache Superset", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
