...
const defaultColor = "#F16822";
const SiWeb3dotjs = React__namespace.forwardRef(function SiWeb3dotjs2({ title = "Web3.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
