...
const SiVenmo = React__namespace.forwardRef(function SiVenmo2({ title = "Venmo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
