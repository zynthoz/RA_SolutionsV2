...
const SiRubocop = React.forwardRef(function SiRubocop2({ title = "RuboCop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
