...
const defaultColor = "#017CEE";
const SiApacheairflow = React__namespace.forwardRef(function SiApacheairflow2({ title = "Apache Airflow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
