...
const SiFedex = React__namespace.forwardRef(function SiFedex2({ title = "FedEx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
