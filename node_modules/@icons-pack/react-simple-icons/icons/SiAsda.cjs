...
const defaultColor = "#68A51C";
const SiAsda = React__namespace.forwardRef(function SiAsda2({ title = "ASDA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
