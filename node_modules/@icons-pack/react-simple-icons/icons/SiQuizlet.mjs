...
const SiQuizlet = React.forwardRef(function SiQuizlet2({ title = "Quizlet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
