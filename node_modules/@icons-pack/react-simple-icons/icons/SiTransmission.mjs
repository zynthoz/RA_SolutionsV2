...
const SiTransmission = React.forwardRef(function SiTransmission2({ title = "Transmission", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
