...
const SiJsfiddle = React.forwardRef(function SiJsfiddle2({ title = "JSFiddle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
