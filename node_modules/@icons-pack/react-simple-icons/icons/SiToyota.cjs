...
const SiToyota = React__namespace.forwardRef(function SiToyota2({ title = "Toyota", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
