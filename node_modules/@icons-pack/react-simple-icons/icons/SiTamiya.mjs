...
const SiTamiya = React.forwardRef(function SiTamiya2({ title = "Tamiya", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
