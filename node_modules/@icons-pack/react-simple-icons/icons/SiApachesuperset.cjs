...
const defaultColor = "#20A6C9";
const SiApachesuperset = React__namespace.forwardRef(function SiApachesuperset2({ title = "Apache Superset", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
