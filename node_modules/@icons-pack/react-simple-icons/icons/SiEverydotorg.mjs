...
const SiEverydotorg = React.forwardRef(function SiEverydotorg2({ title = "Every.org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
