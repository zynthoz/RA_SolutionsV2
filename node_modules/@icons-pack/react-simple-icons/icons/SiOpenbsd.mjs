...
const SiOpenbsd = React.forwardRef(function SiOpenbsd2({ title = "OpenBSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
