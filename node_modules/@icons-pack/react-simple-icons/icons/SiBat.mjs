...
const SiBat = React.forwardRef(function SiBat2({ title = "bat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
