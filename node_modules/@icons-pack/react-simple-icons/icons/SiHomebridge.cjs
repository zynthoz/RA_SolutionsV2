...
const defaultColor = "#491F59";
const SiHomebridge = React__namespace.forwardRef(function SiHomebridge2({ title = "Homebridge", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
