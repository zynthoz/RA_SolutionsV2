...
const SiBitcoinsv = React.forwardRef(function SiBitcoinsv2({ title = "Bitcoin SV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
