...
const SiAsciidoctor = React.forwardRef(function SiAsciidoctor2({ title = "Asciidoctor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
