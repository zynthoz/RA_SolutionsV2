...
const SiTheguardian = React.forwardRef(function SiTheguardian2({ title = "The Guardian", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
