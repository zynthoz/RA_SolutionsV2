...
const SiTraefikproxy = React.forwardRef(function SiTraefikproxy2({ title = "Traefik Proxy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
