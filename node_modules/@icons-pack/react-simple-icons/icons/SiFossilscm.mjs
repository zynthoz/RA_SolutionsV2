...
const SiFossilscm = React.forwardRef(function SiFossilscm2({ title = "Fossil SCM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
