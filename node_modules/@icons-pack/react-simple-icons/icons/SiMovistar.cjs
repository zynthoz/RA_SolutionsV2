...
const SiMovistar = React__namespace.forwardRef(function SiMovistar2({ title = "Movistar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
