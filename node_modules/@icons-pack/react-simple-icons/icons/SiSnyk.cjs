...
const defaultColor = "#4C4A73";
const SiSnyk = React__namespace.forwardRef(function SiSnyk2({ title = "Snyk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
