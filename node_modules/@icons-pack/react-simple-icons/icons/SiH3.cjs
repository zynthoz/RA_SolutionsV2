...
const defaultColor = "#1E54B7";
const SiH3 = React__namespace.forwardRef(function SiH32({ title = "H3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
