...
const defaultColor = "#3874D8";
const SiQubesos = React.forwardRef(function SiQubesos2({ title = "Qubes OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
