...
const defaultColor = "#F7B93E";
const SiPrettier = React__namespace.forwardRef(function SiPrettier2({ title = "Prettier", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
