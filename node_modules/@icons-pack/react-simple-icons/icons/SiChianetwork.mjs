...
const SiChianetwork = React.forwardRef(function SiChianetwork2({ title = "Chia Network", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
