...
const defaultColor = "#E40046";
const SiAsciidoctor = React__namespace.forwardRef(function SiAsciidoctor2({ title = "Asciidoctor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
