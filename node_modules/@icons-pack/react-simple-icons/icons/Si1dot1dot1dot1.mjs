...
const Si1dot1dot1dot1 = React.forwardRef(function Si1dot1dot1dot12({ title = "1.1.1.1", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
