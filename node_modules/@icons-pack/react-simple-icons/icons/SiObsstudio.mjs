...
const SiObsstudio = React.forwardRef(function SiObsstudio2({ title = "OBS Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
