...
const SiEclipsemosquitto = React.forwardRef(function SiEclipsemosquitto2({ title = "Eclipse Mosquitto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
