...
const SiBattledotnet = React.forwardRef(function SiBattledotnet2({ title = "Battle.net", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
