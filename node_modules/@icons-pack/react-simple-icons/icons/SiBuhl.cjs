...
const defaultColor = "#023E84";
const SiBuhl = React__namespace.forwardRef(function SiBuhl2({ title = "Buhl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
