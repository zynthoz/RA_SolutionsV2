...
const defaultColor = "#3D7EBB";
const SiIbeacon = React.forwardRef(function SiIbeacon2({ title = "iBeacon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
