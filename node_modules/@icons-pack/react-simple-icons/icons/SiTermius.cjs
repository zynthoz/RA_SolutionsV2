...
const SiTermius = React__namespace.forwardRef(function SiTermius2({ title = "Termius", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
