...
const SiSelenium = React__namespace.forwardRef(function SiSelenium2({ title = "Selenium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
