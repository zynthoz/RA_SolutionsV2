...
const defaultColor = "#66E3FF";
const SiHeadlessui = React.forwardRef(function SiHeadlessui2({ title = "Headless UI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
