...
const defaultColor = "#3D3C9D";
const SiFiledotio = React__namespace.forwardRef(function SiFiledotio2({ title = "File.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
