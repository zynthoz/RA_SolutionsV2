...
const SiFishshell = React__namespace.forwardRef(function SiFishshell2({ title = "fish shell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
