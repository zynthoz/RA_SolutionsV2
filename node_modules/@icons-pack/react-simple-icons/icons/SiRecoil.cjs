...
const defaultColor = "#3578E5";
const SiRecoil = React__namespace.forwardRef(function SiRecoil2({ title = "Recoil", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
