...
const SiGoogledataproc = React__namespace.forwardRef(function SiGoogledataproc2({ title = "Google Dataproc", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
