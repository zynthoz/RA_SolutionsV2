...
const SiScrutinizerci = React.forwardRef(function SiScrutinizerci2({ title = "Scrutinizer CI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
