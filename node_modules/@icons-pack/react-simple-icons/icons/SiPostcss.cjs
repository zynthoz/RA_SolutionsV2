...
const defaultColor = "#DD3A0A";
const SiPostcss = React__namespace.forwardRef(function SiPostcss2({ title = "PostCSS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
