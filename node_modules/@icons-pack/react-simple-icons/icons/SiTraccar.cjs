...
const SiTraccar = React__namespace.forwardRef(function SiTraccar2({ title = "Traccar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
