...
const SiProbot = React.forwardRef(function SiProbot2({ title = "Probot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
