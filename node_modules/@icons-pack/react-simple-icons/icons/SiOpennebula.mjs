...
const SiOpennebula = React.forwardRef(function SiOpennebula2({ title = "OpenNebula", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
