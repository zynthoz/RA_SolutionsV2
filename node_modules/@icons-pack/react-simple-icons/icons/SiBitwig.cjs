...
const SiBitwig = React__namespace.forwardRef(function SiBitwig2({ title = "Bitwig", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
