...
const SiHelm = React.forwardRef(function SiHelm2({ title = "Helm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
