...
const defaultColor = "#C8332D";
const SiFirewalla = React__namespace.forwardRef(function SiFirewalla2({ title = "Firewalla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
