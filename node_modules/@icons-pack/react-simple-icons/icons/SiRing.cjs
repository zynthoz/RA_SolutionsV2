...
const defaultColor = "#1C9AD6";
const SiRing = React__namespace.forwardRef(function SiRing2({ title = "Ring", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
