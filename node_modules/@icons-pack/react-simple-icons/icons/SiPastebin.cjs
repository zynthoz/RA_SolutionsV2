...
const SiPastebin = React__namespace.forwardRef(function SiPastebin2({ title = "Pastebin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
