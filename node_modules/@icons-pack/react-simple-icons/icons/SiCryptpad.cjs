...
const SiCryptpad = React__namespace.forwardRef(function SiCryptpad2({ title = "CryptPad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
