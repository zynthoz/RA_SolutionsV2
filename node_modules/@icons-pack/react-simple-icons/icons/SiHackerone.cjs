...
const defaultColor = "#494649";
const SiHackerone = React__namespace.forwardRef(function SiHackerone2({ title = "HackerOne", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
