...
const SiRecoil = React.forwardRef(function SiRecoil2({ title = "Recoil", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
