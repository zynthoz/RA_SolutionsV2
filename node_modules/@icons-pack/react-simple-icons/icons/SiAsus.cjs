...
const SiAsus = React__namespace.forwardRef(function SiAsus2({ title = "ASUS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
