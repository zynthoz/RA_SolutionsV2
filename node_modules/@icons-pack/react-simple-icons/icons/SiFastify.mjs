...
const SiFastify = React.forwardRef(function SiFastify2({ title = "Fastify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
