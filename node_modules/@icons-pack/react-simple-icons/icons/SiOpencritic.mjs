...
const SiOpencritic = React.forwardRef(function SiOpencritic2({ title = "OpenCritic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
