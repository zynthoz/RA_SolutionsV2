...
const defaultColor = "#49BDA5";
const SiFluentbit = React__namespace.forwardRef(function SiFluentbit2({ title = "Fluent Bit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
