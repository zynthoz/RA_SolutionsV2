...
const SiDell = React__namespace.forwardRef(function SiDell2({ title = "Dell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
