...
const defaultColor = "#D70010";
const SiAnta = React__namespace.forwardRef(function SiAnta2({ title = "Anta", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
