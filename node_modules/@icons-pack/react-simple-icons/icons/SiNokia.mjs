...
const SiNokia = React.forwardRef(function SiNokia2({ title = "Nokia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
