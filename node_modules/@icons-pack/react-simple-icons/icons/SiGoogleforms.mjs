...
const SiGoogleforms = React.forwardRef(function SiGoogleforms2({ title = "Google Forms", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
