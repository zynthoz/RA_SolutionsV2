...
const SiOrganicmaps = React__namespace.forwardRef(function SiOrganicmaps2({ title = "Organic Maps", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
