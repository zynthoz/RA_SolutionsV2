...
const SiLamborghini = React.forwardRef(function SiLamborghini2({ title = "Lamborghini", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
