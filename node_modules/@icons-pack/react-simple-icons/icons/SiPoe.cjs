...
const defaultColor = "#5D5CDE";
const SiPoe = React__namespace.forwardRef(function SiPoe2({ title = "Poe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
