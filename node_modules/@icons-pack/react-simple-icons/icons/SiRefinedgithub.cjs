...
const SiRefinedgithub = React__namespace.forwardRef(function SiRefinedgithub2({ title = "Refined GitHub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
