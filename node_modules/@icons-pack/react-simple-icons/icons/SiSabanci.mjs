...
const SiSabanci = React.forwardRef(function SiSabanci2({ title = "Sabanci", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
