...
const SiDeluge = React.forwardRef(function SiDeluge2({ title = "Deluge", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
