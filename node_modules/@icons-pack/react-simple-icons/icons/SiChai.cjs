...
const defaultColor = "#A30701";
const SiChai = React__namespace.forwardRef(function SiChai2({ title = "Chai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
