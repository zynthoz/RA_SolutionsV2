...
const defaultColor = "#2D2E83";
const SiShowpad = React__namespace.forwardRef(function SiShowpad2({ title = "Showpad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
