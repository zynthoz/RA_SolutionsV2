...
const defaultColor = "#1273EB";
const SiFreepik = React.forwardRef(function SiFreepik2({ title = "Freepik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiFreepik as default, defaultColor };
