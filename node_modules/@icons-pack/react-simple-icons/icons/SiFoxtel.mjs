...
const SiFoxtel = React.forwardRef(function SiFoxtel2({ title = "Foxtel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
