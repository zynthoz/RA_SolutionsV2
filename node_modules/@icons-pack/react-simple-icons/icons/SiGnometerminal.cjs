...
const SiGnometerminal = React__namespace.forwardRef(function SiGnometerminal2({ title = "GNOME Terminal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
