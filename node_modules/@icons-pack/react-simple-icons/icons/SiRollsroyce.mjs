...
const SiRollsroyce = React.forwardRef(function SiRollsroyce2({ title = "Rolls-Royce", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
