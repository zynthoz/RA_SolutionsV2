...
const defaultColor = "#B1361E";
const SiCodewars = React.forwardRef(function SiCodewars2({ title = "Codewars", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
