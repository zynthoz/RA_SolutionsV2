...
const defaultColor = "#FF7700";
const SiPiwigo = React.forwardRef(function SiPiwigo2({ title = "Piwigo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
