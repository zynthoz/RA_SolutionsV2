...
const defaultColor = "#232326";
const SiBevy = React__namespace.forwardRef(function SiBevy2({ title = "Bevy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
