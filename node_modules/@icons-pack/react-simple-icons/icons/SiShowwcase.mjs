...
const SiShowwcase = React.forwardRef(function SiShowwcase2({ title = "Showwcase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
