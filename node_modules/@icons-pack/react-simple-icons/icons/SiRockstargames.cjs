...
const SiRockstargames = React__namespace.forwardRef(function SiRockstargames2({ title = "Rockstar Games", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
