...
const SiCommitlint = React__namespace.forwardRef(function SiCommitlint2({ title = "commitlint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
