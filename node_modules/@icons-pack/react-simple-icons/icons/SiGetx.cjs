...
const SiGetx = React__namespace.forwardRef(function SiGetx2({ title = "GetX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
