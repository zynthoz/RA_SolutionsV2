...
const SiLibrariesdotio = React__namespace.forwardRef(function SiLibrariesdotio2({ title = "Libraries.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
