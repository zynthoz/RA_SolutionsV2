...
const SiGin = React.forwardRef(function SiGin2({ title = "Gin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
