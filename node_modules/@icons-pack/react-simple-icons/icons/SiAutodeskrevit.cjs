...
const defaultColor = "#186BFF";
const SiAutodeskrevit = React__namespace.forwardRef(function SiAutodeskrevit2({ title = "Autodesk Revit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
