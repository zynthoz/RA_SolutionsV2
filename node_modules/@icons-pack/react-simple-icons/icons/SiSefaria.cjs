...
const SiSefaria = React__namespace.forwardRef(function SiSefaria2({ title = "Sefaria", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
