...
const SiYabai = React.forwardRef(function SiYabai2({ title = "yabai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
