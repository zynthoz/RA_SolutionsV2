...
const defaultColor = "#F46A54";
const SiCoda = React.forwardRef(function SiCoda2({ title = "Coda", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
