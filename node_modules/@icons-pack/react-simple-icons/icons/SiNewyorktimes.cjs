...
const SiNewyorktimes = React__namespace.forwardRef(function SiNewyorktimes2({ title = "New York Times", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
