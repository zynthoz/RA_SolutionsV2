...
const SiRaycast = React.forwardRef(function SiRaycast2({ title = "Raycast", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
