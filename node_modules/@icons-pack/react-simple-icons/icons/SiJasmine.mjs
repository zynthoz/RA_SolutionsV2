...
const SiJasmine = React.forwardRef(function SiJasmine2({ title = "Jasmine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
