...
const SiMonkeytype = React.forwardRef(function SiMonkeytype2({ title = "Monkeytype", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
