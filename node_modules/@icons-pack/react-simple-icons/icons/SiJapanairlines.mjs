...
const SiJapanairlines = React.forwardRef(function SiJapanairlines2({ title = "Japan Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
