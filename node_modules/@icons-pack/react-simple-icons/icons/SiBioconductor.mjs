...
const SiBioconductor = React.forwardRef(function SiBioconductor2({ title = "Bioconductor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
