...
const SiFedora = React.forwardRef(function SiFedora2({ title = "Fedora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
