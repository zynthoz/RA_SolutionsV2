...
const SiMojeek = React.forwardRef(function SiMojeek2({ title = "Mojeek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
