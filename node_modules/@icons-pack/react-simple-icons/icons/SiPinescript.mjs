...
const defaultColor = "#00B453";
const SiPinescript = React.forwardRef(function SiPinescript2({ title = "Pine Script", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
