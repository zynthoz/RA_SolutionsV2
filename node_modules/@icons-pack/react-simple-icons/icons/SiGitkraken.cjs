...
const defaultColor = "#179287";
const SiGitkraken = React__namespace.forwardRef(function SiGitkraken2({ title = "GitKraken", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
