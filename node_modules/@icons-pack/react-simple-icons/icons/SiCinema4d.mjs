...
const SiCinema4d = React.forwardRef(function SiCinema4d2({ title = "Cinema 4D", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
