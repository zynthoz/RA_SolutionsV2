...
const SiCookiecutter = React.forwardRef(function SiCookiecutter2({ title = "Cookiecutter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
