...
const defaultColor = "#96D7E8";
const SiNrwl = React__namespace.forwardRef(function SiNrwl2({ title = "Nrwl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
