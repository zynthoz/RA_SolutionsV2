...
const defaultColor = "#FF9955";
const SiMobx = React.forwardRef(function SiMobx2({ title = "MobX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
