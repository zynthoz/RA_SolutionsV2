...
const SiEsotericsoftware = React.forwardRef(function SiEsotericsoftware2({ title = "Esoteric Software", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
