...
const SiBackendless = React.forwardRef(function SiBackendless2({ title = "Backendless", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
