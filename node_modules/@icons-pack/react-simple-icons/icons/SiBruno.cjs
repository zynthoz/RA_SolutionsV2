...
const defaultColor = "#F4AA41";
const SiBruno = React__namespace.forwardRef(function SiBruno2({ title = "Bruno", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
