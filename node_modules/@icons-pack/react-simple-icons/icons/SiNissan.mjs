...
const SiNissan = React.forwardRef(function SiNissan2({ title = "Nissan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
