...
const defaultColor = "#DC682E";
const SiCinnamon = React__namespace.forwardRef(function SiCinnamon2({ title = "Cinnamon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
