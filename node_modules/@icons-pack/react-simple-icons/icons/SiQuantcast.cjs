...
const SiQuantcast = React__namespace.forwardRef(function SiQuantcast2({ title = "Quantcast", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
