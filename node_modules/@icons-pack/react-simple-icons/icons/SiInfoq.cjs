...
const defaultColor = "#2C6CAF";
const SiInfoq = React__namespace.forwardRef(function SiInfoq2({ title = "InfoQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
