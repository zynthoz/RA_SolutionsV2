...
const SiDwavesystems = React.forwardRef(function SiDwavesystems2({ title = "D-Wave Systems", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
