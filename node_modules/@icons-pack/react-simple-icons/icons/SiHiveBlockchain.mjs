...
const defaultColor = "#E31337";
const SiHiveBlockchain = React.forwardRef(function SiHiveBlockchain2({ title = "Hive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
