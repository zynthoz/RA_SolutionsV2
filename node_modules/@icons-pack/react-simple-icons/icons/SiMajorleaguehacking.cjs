...
const SiMajorleaguehacking = React__namespace.forwardRef(function SiMajorleaguehacking2({ title = "Major League Hacking", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
