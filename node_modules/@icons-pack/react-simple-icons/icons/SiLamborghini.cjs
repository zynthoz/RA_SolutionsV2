...
const defaultColor = "#B6A272";
const SiLamborghini = React__namespace.forwardRef(function SiLamborghini2({ title = "Lamborghini", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
