...
const SiJfrogpipelines = React.forwardRef(function SiJfrogpipelines2({ title = "JFrog Pipelines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
