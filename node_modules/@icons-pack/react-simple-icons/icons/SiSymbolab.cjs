...
const defaultColor = "#DB3F59";
const SiSymbolab = React__namespace.forwardRef(function SiSymbolab2({ title = "Symbolab", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
