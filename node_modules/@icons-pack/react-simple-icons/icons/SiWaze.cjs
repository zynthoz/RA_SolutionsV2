...
const SiWaze = React__namespace.forwardRef(function SiWaze2({ title = "Waze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
