...
const SiAsus = React.forwardRef(function SiAsus2({ title = "ASUS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
