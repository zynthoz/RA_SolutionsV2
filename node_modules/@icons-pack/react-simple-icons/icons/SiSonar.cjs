...
const defaultColor = "#FD3456";
const SiSonar = React__namespace.forwardRef(function SiSonar2({ title = "Sonar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
