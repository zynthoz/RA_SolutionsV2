...
const SiStyleshare = React__namespace.forwardRef(function SiStyleshare2({ title = "StyleShare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
