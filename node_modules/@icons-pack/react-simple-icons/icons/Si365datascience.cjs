...
const defaultColor = "#000C1F";
const Si365datascience = React__namespace.forwardRef(function Si365datascience2({ title = "365 Data Science", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
