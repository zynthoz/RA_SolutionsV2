...
const SiAlamy = React__namespace.forwardRef(function SiAlamy2({ title = "Alamy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
