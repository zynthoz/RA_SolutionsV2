...
const SiEclipsejetty = React.forwardRef(function SiEclipsejetty2({ title = "Eclipse Jetty", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
