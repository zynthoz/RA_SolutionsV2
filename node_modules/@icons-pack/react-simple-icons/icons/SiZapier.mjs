...
const SiZapier = React.forwardRef(function SiZapier2({ title = "Zapier", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
