...
const defaultColor = "#409FFF";
const SiWetransfer = React.forwardRef(function SiWetransfer2({ title = "WeTransfer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
