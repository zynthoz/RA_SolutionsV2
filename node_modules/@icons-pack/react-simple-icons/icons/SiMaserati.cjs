...
const defaultColor = "#0C2340";
const SiMaserati = React__namespace.forwardRef(function SiMaserati2({ title = "Maserati", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
