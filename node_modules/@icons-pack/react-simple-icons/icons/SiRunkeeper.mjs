...
const SiRunkeeper = React.forwardRef(function SiRunkeeper2({ title = "Runkeeper", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
