...
const SiBlazemeter = React.forwardRef(function SiBlazemeter2({ title = "Blazemeter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
