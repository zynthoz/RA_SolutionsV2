...
const defaultColor = "#00A2E2";
const SiBakalari = React__namespace.forwardRef(function SiBakalari2({ title = "Bakaláři", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
