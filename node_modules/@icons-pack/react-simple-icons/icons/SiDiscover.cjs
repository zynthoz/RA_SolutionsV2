...
const defaultColor = "#FF6000";
const SiDiscover = React__namespace.forwardRef(function SiDiscover2({ title = "Discover", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
