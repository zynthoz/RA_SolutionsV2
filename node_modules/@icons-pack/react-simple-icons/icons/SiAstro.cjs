...
const defaultColor = "#BC52EE";
const SiAstro = React__namespace.forwardRef(function SiAstro2({ title = "Astro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
