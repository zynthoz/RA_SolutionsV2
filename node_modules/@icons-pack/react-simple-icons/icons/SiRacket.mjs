...
const SiRacket = React.forwardRef(function SiRacket2({ title = "Racket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
