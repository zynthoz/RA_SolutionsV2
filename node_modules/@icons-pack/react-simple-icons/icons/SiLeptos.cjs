...
const SiLeptos = React__namespace.forwardRef(function SiLeptos2({ title = "Leptos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
