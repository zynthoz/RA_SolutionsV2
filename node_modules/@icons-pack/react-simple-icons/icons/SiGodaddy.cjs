...
const defaultColor = "#1BDBDB";
const SiGodaddy = React__namespace.forwardRef(function SiGodaddy2({ title = "GoDaddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
