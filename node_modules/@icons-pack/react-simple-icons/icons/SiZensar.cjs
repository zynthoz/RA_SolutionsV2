...
const SiZensar = React__namespace.forwardRef(function SiZensar2({ title = "Zensar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
