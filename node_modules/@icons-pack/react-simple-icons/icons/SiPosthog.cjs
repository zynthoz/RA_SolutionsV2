...
const SiPosthog = React__namespace.forwardRef(function SiPosthog2({ title = "PostHog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
