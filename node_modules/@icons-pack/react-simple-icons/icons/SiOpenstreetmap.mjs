...
const SiOpenstreetmap = React.forwardRef(function SiOpenstreetmap2({ title = "OpenStreetMap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
