...
const SiNewgrounds = React.forwardRef(function SiNewgrounds2({ title = "Newgrounds", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
