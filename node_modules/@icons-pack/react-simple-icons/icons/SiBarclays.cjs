...
const SiBarclays = React__namespace.forwardRef(function SiBarclays2({ title = "Barclays", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
