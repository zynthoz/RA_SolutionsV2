...
const defaultColor = "#57182D";
const SiLightburn = React__namespace.forwardRef(function SiLightburn2({ title = "LightBurn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
