...
const defaultColor = "#7A1FA2";
const SiAiqfome = React__namespace.forwardRef(function SiAiqfome2({ title = "Aiqfome", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
