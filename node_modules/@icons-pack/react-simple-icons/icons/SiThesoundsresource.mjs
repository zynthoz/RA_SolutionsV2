...
const defaultColor = "#39BE6B";
const SiThesoundsresource = React.forwardRef(function SiThesoundsresource2({ title = "The Sounds Resource", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
