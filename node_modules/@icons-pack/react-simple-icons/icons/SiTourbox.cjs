...
const SiTourbox = React__namespace.forwardRef(function SiTourbox2({ title = "TourBox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
