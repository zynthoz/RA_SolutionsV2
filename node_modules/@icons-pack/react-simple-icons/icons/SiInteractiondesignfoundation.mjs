...
const SiInteractiondesignfoundation = React.forwardRef(function SiInteractiondesignfoundation2({ title = "Interaction Design Foundation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
