...
const defaultColor = "#242B2F";
const SiPuma = React__namespace.forwardRef(function SiPuma2({ title = "Puma", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
