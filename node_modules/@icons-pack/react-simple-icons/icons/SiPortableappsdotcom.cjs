...
const SiPortableappsdotcom = React__namespace.forwardRef(function SiPortableappsdotcom2({ title = "PortableApps.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
