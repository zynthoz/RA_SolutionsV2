...
const SiBricks = React.forwardRef(function SiBricks2({ title = "Bricks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
