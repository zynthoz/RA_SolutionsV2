...
const SiSyncthing = React.forwardRef(function SiSyncthing2({ title = "Syncthing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
