...
const SiSmashingmagazine = React__namespace.forwardRef(function SiSmashingmagazine2({ title = "Smashing Magazine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
