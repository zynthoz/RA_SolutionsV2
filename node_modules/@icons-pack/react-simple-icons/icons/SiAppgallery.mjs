...
const SiAppgallery = React.forwardRef(function SiAppgallery2({ title = "AppGallery", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
