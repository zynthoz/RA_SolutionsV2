...
const defaultColor = "#AB2B28";
const SiBsd = React__namespace.forwardRef(function SiBsd2({ title = "BSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
