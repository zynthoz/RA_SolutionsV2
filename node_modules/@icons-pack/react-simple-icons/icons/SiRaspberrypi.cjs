...
const defaultColor = "#A22846";
const SiRaspberrypi = React__namespace.forwardRef(function SiRaspberrypi2({ title = "Raspberry Pi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
