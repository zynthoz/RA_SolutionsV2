...
const SiTheweatherchannel = React.forwardRef(function SiTheweatherchannel2({ title = "The Weather Channel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
