...
const SiIcon = React__namespace.forwardRef(function SiIcon2({ title = "ICON", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
