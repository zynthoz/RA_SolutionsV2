...
const SiZara = React__namespace.forwardRef(function SiZara2({ title = "Zara", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
