...
const SiCycling74 = React__namespace.forwardRef(function SiCycling742({ title = "Cycling 74", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
