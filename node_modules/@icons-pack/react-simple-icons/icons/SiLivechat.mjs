...
const SiLivechat = React.forwardRef(function SiLivechat2({ title = "LiveChat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
