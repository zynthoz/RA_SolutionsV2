...
const defaultColor = "#1B66B3";
const SiEdeka = React__namespace.forwardRef(function SiEdeka2({ title = "EDEKA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
