...
const SiValorant = React__namespace.forwardRef(function SiValorant2({ title = "Valorant", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
