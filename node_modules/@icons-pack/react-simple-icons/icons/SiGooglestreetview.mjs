...
const defaultColor = "#FEC111";
const SiGooglestreetview = React.forwardRef(function SiGooglestreetview2({ title = "Google Street View", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
