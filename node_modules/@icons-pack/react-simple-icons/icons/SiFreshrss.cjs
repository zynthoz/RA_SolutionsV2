...
const SiFreshrss = React__namespace.forwardRef(function SiFreshrss2({ title = "FreshRSS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
