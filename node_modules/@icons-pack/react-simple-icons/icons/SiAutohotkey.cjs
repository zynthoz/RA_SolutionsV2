...
const SiAutohotkey = React__namespace.forwardRef(function SiAutohotkey2({ title = "AutoHotkey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
