...
const SiSncf = React__namespace.forwardRef(function SiSncf2({ title = "SNCF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
