...
const defaultColor = "#ED5B26";
const SiCaprover = React__namespace.forwardRef(function SiCaprover2({ title = "CapRover", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
