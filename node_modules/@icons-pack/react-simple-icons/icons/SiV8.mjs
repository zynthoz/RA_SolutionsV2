...
const SiV8 = React.forwardRef(function SiV82({ title = "V8", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
