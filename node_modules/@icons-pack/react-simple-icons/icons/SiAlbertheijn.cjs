...
const defaultColor = "#04ACE6";
const SiAlbertheijn = React__namespace.forwardRef(function SiAlbertheijn2({ title = "Albert Heijn", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
