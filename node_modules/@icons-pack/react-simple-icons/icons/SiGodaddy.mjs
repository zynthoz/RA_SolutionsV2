...
const SiGodaddy = React.forwardRef(function SiGodaddy2({ title = "GoDaddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
