...
const defaultColor = "#1E1E28";
const SiCoolermaster = React__namespace.forwardRef(function SiCoolermaster2({ title = "Cooler Master", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
