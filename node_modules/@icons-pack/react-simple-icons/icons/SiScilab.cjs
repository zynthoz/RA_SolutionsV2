...
const SiScilab = React__namespace.forwardRef(function SiScilab2({ title = "Scilab", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
