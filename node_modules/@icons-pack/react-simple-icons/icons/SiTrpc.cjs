...
const SiTrpc = React__namespace.forwardRef(function SiTrpc2({ title = "tRPC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
