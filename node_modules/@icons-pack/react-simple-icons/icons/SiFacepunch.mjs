...
const SiFacepunch = React.forwardRef(function SiFacepunch2({ title = "Facepunch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
