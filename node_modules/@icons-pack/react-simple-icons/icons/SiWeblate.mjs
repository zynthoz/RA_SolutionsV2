...
const defaultColor = "#2ECCAA";
const SiWeblate = React.forwardRef(function SiWeblate2({ title = "Weblate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
