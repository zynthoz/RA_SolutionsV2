...
const SiKlm = React.forwardRef(function SiKlm2({ title = "KLM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
