...
const SiOpenapiinitiative = React__namespace.forwardRef(function SiOpenapiinitiative2({ title = "OpenAPI Initiative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
