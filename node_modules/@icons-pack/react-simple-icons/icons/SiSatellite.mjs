...
const SiSatellite = React.forwardRef(function SiSatellite2({ title = "Satellite", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
