...
const SiSkoda = React.forwardRef(function SiSkoda2({ title = "ŠKODA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
