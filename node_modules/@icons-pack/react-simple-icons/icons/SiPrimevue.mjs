...
const SiPrimevue = React.forwardRef(function SiPrimevue2({ title = "PrimeVue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
