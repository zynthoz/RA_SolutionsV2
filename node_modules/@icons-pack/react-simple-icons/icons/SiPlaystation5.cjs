...
const SiPlaystation5 = React__namespace.forwardRef(function SiPlaystation52({ title = "PlayStation 5", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
