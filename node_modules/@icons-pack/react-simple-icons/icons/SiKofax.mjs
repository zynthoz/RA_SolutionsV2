...
const SiKofax = React.forwardRef(function SiKofax2({ title = "Kofax", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
