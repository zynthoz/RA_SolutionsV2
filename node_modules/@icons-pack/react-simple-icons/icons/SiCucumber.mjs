...
const SiCucumber = React.forwardRef(function SiCucumber2({ title = "Cucumber", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
