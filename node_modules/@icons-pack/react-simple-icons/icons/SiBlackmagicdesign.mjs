...
const SiBlackmagicdesign = React.forwardRef(function SiBlackmagicdesign2({ title = "Blackmagic Design", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
