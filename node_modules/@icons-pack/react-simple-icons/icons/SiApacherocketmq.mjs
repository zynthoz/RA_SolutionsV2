...
const SiApacherocketmq = React.forwardRef(function SiApacherocketmq2({ title = "Apache RocketMQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
