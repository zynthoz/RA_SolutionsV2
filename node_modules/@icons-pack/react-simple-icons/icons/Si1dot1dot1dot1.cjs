...
const defaultColor = "#221E68";
const Si1dot1dot1dot1 = React__namespace.forwardRef(function Si1dot1dot1dot12({ title = "1.1.1.1", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
