...
const defaultColor = "#003168";
const SiStubhub = React__namespace.forwardRef(function SiStubhub2({ title = "StubHub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
