...
const defaultColor = "#011A6A";
const SiCinema4d = React__namespace.forwardRef(function SiCinema4d2({ title = "Cinema 4D", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
