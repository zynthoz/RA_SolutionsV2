...
const SiGreenhouse = React.forwardRef(function SiGreenhouse2({ title = "Greenhouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
