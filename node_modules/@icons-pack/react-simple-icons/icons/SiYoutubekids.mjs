...
const SiYoutubekids = React.forwardRef(function SiYoutubekids2({ title = "YouTube Kids", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
