...
const SiMeetup = React.forwardRef(function SiMeetup2({ title = "Meetup", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
