...
const SiKubuntu = React.forwardRef(function SiKubuntu2({ title = "Kubuntu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
