...
const SiInfluxdb = React.forwardRef(function SiInfluxdb2({ title = "InfluxDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
