...
const defaultColor = "#6699CB";
const SiConan = React__namespace.forwardRef(function SiConan2({ title = "Conan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
