...
const SiAnsys = React.forwardRef(function SiAnsys2({ title = "Ansys", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
