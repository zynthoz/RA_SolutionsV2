...
const SiInspire = React__namespace.forwardRef(function SiInspire2({ title = "INSPIRE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
