...
const defaultColor = "#3B5526";
const SiSympy = React__namespace.forwardRef(function SiSympy2({ title = "SymPy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
