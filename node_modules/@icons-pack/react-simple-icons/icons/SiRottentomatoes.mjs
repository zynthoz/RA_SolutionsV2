...
const SiRottentomatoes = React.forwardRef(function SiRottentomatoes2({ title = "Rotten Tomatoes", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
