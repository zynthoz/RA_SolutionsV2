...
const SiAcura = React.forwardRef(function SiAcura2({ title = "Acura", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
