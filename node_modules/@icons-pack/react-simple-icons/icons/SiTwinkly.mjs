...
const SiTwinkly = React.forwardRef(function SiTwinkly2({ title = "Twinkly", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
