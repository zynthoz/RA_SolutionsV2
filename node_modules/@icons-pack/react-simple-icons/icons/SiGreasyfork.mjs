...
const SiGreasyfork = React.forwardRef(function SiGreasyfork2({ title = "Greasy Fork", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
