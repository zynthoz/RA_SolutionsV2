...
const SiMoo = React.forwardRef(function SiMoo2({ title = "Moo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
