...
const SiHaxe = React.forwardRef(function SiHaxe2({ title = "Haxe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
