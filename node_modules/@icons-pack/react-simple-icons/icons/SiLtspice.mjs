...
const SiLtspice = React.forwardRef(function SiLtspice2({ title = "LTspice", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
