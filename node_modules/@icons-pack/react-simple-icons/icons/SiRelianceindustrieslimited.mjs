...
const SiRelianceindustrieslimited = React.forwardRef(function SiRelianceindustrieslimited2({ title = "Reliance Industries Limited", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
