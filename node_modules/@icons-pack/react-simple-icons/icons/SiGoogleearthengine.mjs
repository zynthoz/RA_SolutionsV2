...
const SiGoogleearthengine = React.forwardRef(function SiGoogleearthengine2({ title = "Google Earth Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
