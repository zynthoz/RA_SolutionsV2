...
const SiWasmcloud = React.forwardRef(function SiWasmcloud2({ title = "wasmCloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiWasmcloud as default, defaultColor };
