...
const defaultColor = "#2D4999";
const SiPicardsurgeles = React.forwardRef(function SiPicardsurgeles2({ title = "Picard Surgelés", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
