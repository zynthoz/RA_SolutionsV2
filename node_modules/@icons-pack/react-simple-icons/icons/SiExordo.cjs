...
const defaultColor = "#DAA449";
const SiExordo = React__namespace.forwardRef(function SiExordo2({ title = "Exordo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
