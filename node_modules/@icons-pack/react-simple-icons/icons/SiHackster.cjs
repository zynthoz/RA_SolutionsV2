...
const defaultColor = "#2E9FE6";
const SiHackster = React__namespace.forwardRef(function SiHackster2({ title = "Hackster", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
