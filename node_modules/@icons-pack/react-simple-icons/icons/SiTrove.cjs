...
const defaultColor = "#2D004B";
const SiTrove = React__namespace.forwardRef(function SiTrove2({ title = "Trove", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
