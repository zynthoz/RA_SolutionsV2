...
const SiDungeonsanddragons = React.forwardRef(function SiDungeonsanddragons2({ title = "Dungeons & Dragons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
