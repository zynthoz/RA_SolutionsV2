...
const defaultColor = "#A70023";
const SiMarriott = React.forwardRef(function SiMarriott2({ title = "Marriott", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
