...
const defaultColor = "#009CAB";
const SiExercism = React__namespace.forwardRef(function SiExercism2({ title = "Exercism", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
