...
const SiFairphone = React__namespace.forwardRef(function SiFairphone2({ title = "Fairphone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
