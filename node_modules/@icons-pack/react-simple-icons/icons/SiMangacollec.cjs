...
const defaultColor = "#DA1F05";
const SiMangacollec = React__namespace.forwardRef(function SiMangacollec2({ title = "Mangacollec", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
