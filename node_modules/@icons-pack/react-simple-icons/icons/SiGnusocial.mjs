...
const SiGnusocial = React.forwardRef(function SiGnusocial2({ title = "GNU social", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
