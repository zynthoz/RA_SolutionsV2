...
const SiLuogu = React__namespace.forwardRef(function SiLuogu2({ title = "Luogu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
