...
const Si4chan = React.forwardRef(function Si4chan2({ title = "4chan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
