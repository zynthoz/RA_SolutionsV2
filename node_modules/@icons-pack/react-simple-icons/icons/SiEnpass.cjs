...
const SiEnpass = React__namespace.forwardRef(function SiEnpass2({ title = "Enpass", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
