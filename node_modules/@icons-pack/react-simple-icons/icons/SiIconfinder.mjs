...
const SiIconfinder = React.forwardRef(function SiIconfinder2({ title = "Iconfinder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
