...
const SiKong = React.forwardRef(function SiKong2({ title = "Kong", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
