...
const SiParamountplus = React__namespace.forwardRef(function SiParamountplus2({ title = "Paramount+", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
