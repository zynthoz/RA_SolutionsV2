...
const SiG2a = React__namespace.forwardRef(function SiG2a2({ title = "G2A", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
