...
const SiArxiv = React.forwardRef(function SiArxiv2({ title = "arXiv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
