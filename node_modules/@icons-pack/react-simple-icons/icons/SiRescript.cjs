...
const SiRescript = React__namespace.forwardRef(function SiRescript2({ title = "ReScript", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
