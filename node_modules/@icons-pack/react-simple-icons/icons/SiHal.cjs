...
const SiHal = React__namespace.forwardRef(function SiHal2({ title = "HAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
