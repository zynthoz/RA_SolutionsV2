...
const defaultColor = "#8ED500";
const SiNextdoor = React__namespace.forwardRef(function SiNextdoor2({ title = "Nextdoor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
