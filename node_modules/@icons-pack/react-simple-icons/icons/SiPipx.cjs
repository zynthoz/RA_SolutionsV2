...
const SiPipx = React__namespace.forwardRef(function SiPipx2({ title = "pipx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
