...
const SiLutris = React__namespace.forwardRef(function SiLutris2({ title = "Lutris", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
