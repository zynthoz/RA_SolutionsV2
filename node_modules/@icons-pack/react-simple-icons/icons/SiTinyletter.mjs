...
const SiTinyletter = React.forwardRef(function SiTinyletter2({ title = "TinyLetter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
