...
const defaultColor = "#F96F29";
const SiCoronaengine = React__namespace.forwardRef(function SiCoronaengine2({ title = "Corona Engine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
