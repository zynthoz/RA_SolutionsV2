...
const SiCodecademy = React__namespace.forwardRef(function SiCodecademy2({ title = "Codecademy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
