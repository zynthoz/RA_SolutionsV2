...
const SiMicroeditor = React__namespace.forwardRef(function SiMicroeditor2({ title = "Micro Editor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
