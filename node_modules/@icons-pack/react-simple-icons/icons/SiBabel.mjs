...
const defaultColor = "#F9DC3E";
const SiBabel = React.forwardRef(function SiBabel2({ title = "Babel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
