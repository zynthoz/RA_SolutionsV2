...
const defaultColor = "#006600";
const Si4chan = React__namespace.forwardRef(function Si4chan2({ title = "4chan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
