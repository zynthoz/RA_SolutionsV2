...
const SiSphinx = React__namespace.forwardRef(function SiSphinx2({ title = "Sphinx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
