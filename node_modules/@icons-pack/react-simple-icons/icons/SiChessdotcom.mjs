...
const SiChessdotcom = React.forwardRef(function SiChessdotcom2({ title = "Chess.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
