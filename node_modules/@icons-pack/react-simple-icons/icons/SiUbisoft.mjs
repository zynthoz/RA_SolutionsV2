...
const SiUbisoft = React.forwardRef(function SiUbisoft2({ title = "Ubisoft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
