...
const SiPinia = React.forwardRef(function SiPinia2({ title = "Pinia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
