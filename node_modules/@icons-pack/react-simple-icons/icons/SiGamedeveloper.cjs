...
const SiGamedeveloper = React__namespace.forwardRef(function SiGamedeveloper2({ title = "Game Developer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
