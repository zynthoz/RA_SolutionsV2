...
const defaultColor = "#00B9F1";
const SiYr = React__namespace.forwardRef(function SiYr2({ title = "Yr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
