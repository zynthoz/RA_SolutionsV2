...
const SiGlitch = React__namespace.forwardRef(function SiGlitch2({ title = "Glitch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
