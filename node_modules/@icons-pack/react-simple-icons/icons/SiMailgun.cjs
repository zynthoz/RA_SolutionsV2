...
const SiMailgun = React__namespace.forwardRef(function SiMailgun2({ title = "Mailgun", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
