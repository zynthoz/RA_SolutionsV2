...
const SiGooglemarketingplatform = React.forwardRef(function SiGooglemarketingplatform2({ title = "Google Marketing Platform", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
