...
const SiIntigriti = React.forwardRef(function SiIntigriti2({ title = "Intigriti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
