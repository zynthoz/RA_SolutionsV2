...
const SiShowpad = React.forwardRef(function SiShowpad2({ title = "Showpad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
