...
const SiGooglecardboard = React.forwardRef(function SiGooglecardboard2({ title = "Google Cardboard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
