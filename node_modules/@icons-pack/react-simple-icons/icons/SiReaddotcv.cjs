...
const SiReaddotcv = React__namespace.forwardRef(function SiReaddotcv2({ title = "Read.cv", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
