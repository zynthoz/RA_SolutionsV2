...
const defaultColor = "#C3002D";
const SiRossmann = React__namespace.forwardRef(function SiRossmann2({ title = "Rossmann", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
