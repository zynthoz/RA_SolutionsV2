...
const defaultColor = "#CC092F";
const SiIceland = React__namespace.forwardRef(function SiIceland2({ title = "Iceland", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
