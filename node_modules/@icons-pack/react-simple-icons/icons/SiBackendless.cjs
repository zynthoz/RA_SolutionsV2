...
const defaultColor = "#1D77BD";
const SiBackendless = React__namespace.forwardRef(function SiBackendless2({ title = "Backendless", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
