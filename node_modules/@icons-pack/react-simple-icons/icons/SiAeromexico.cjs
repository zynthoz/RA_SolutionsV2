...
const defaultColor = "#0B2343";
const SiAeromexico = React__namespace.forwardRef(function SiAeromexico2({ title = "Aeroméxico", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
