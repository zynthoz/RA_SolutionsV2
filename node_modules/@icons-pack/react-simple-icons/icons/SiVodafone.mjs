...
const SiVodafone = React.forwardRef(function SiVodafone2({ title = "Vodafone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
