...
const SiChangedetection = React.forwardRef(function SiChangedetection2({ title = "Change Detection", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
