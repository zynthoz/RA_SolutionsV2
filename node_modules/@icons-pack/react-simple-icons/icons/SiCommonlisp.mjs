...
const SiCommonlisp = React.forwardRef(function SiCommonlisp2({ title = "Common Lisp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
