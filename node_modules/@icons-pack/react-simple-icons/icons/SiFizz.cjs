...
const defaultColor = "#00D672";
const SiFizz = React__namespace.forwardRef(function SiFizz2({ title = "Fizz", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
