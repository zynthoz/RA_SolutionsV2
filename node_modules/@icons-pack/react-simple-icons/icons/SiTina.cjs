...
const defaultColor = "#EC4815";
const SiTina = React__namespace.forwardRef(function SiTina2({ title = "Tina", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
