...
const SiPhoenixframework = React.forwardRef(function SiPhoenixframework2({ title = "Phoenix Framework", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
