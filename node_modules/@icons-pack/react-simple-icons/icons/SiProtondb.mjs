...
const SiProtondb = React.forwardRef(function SiProtondb2({ title = "ProtonDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
