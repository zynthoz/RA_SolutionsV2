...
const SiHey = React__namespace.forwardRef(function SiHey2({ title = "HEY", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
