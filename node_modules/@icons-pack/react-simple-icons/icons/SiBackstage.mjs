...
const defaultColor = "#9BF0E1";
const SiBackstage = React.forwardRef(function SiBackstage2({ title = "Backstage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
