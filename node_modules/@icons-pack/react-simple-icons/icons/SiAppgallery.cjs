...
const SiAppgallery = React__namespace.forwardRef(function SiAppgallery2({ title = "AppGallery", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
