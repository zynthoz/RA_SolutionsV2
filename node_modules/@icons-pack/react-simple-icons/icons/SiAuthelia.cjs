...
const defaultColor = "#113155";
const SiAuthelia = React__namespace.forwardRef(function SiAuthelia2({ title = "Authelia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
