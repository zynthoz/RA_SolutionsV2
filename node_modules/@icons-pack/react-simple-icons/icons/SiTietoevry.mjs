...
const SiTietoevry = React.forwardRef(function SiTietoevry2({ title = "TietoEVRY", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
