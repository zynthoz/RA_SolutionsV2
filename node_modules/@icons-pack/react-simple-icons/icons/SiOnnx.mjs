...
const SiOnnx = React.forwardRef(function SiOnnx2({ title = "ONNX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
