...
const SiBackbone = React__namespace.forwardRef(function SiBackbone2({ title = "Backbone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
