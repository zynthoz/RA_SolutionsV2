...
const SiHyprland = React__namespace.forwardRef(function SiHyprland2({ title = "Hyprland", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
