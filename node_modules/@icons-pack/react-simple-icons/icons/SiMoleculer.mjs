...
const defaultColor = "#3CAFCE";
const SiMoleculer = React.forwardRef(function SiMoleculer2({ title = "Moleculer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
