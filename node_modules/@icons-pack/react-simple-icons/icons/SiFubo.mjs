...
const SiFubo = React.forwardRef(function SiFubo2({ title = "Fubo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
