...
const SiAppmanager = React__namespace.forwardRef(function SiAppmanager2({ title = "AppManager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
