...
const SiBsd = React.forwardRef(function SiBsd2({ title = "BSD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
