...
const SiStryker = React.forwardRef(function SiStryker2({ title = "Stryker", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
