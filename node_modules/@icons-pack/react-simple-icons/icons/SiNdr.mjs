...
const defaultColor = "#0C1754";
const SiNdr = React.forwardRef(function SiNdr2({ title = "NDR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
