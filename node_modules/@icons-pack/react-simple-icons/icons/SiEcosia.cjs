...
const defaultColor = "#008009";
const SiEcosia = React__namespace.forwardRef(function SiEcosia2({ title = "Ecosia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
