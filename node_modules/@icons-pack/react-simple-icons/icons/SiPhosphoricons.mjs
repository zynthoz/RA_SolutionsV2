...
const SiPhosphoricons = React.forwardRef(function SiPhosphoricons2({ title = "Phosphor Icons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
