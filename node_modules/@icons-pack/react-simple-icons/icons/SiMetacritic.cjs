...
const SiMetacritic = React__namespace.forwardRef(function SiMetacritic2({ title = "Metacritic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
