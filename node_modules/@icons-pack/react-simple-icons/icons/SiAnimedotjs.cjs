...
const SiAnimedotjs = React__namespace.forwardRef(function SiAnimedotjs2({ title = "Anime.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
