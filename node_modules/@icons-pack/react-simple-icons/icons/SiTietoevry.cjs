...
const defaultColor = "#063752";
const SiTietoevry = React__namespace.forwardRef(function SiTietoevry2({ title = "TietoEVRY", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
