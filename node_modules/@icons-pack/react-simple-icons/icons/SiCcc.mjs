...
const SiCcc = React.forwardRef(function SiCcc2({ title = "CCC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
