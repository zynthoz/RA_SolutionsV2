...
const SiFreetube = React__namespace.forwardRef(function SiFreetube2({ title = "FreeTube", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
