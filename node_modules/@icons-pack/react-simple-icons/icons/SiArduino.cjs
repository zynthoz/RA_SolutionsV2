...
const defaultColor = "#00878F";
const SiArduino = React__namespace.forwardRef(function SiArduino2({ title = "Arduino", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
