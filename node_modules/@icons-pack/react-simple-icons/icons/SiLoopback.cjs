...
const SiLoopback = React__namespace.forwardRef(function SiLoopback2({ title = "LoopBack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
