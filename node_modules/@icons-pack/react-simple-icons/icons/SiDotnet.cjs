...
const SiDotnet = React__namespace.forwardRef(function SiDotnet2({ title = ".NET", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
