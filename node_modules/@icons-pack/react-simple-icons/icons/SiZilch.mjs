...
const SiZilch = React.forwardRef(function SiZilch2({ title = "Zilch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
