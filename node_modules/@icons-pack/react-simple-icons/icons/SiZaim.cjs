...
const defaultColor = "#50A135";
const SiZaim = React__namespace.forwardRef(function SiZaim2({ title = "Zaim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
