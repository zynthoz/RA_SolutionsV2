...
const defaultColor = "#17B2E7";
const SiKodi = React__namespace.forwardRef(function SiKodi2({ title = "Kodi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
