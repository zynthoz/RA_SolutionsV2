...
const SiApachehbase = React.forwardRef(function SiApachehbase2({ title = "Apache HBase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
