...
const SiCloudcannon = React.forwardRef(function SiCloudcannon2({ title = "CloudCannon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
