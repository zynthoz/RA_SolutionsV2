...
const SiGlovo = React__namespace.forwardRef(function SiGlovo2({ title = "Glovo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
