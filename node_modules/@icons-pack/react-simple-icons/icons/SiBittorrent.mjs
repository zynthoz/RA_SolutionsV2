...
const SiBittorrent = React.forwardRef(function SiBittorrent2({ title = "BitTorrent", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
