...
const SiWemo = React.forwardRef(function SiWemo2({ title = "WEMO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
