...
const defaultColor = "#09A3D5";
const SiSpacy = React__namespace.forwardRef(function SiSpacy2({ title = "spaCy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
