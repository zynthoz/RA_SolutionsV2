...
const defaultColor = "#0081A5";
const SiOpenaigym = React.forwardRef(function SiOpenaigym2({ title = "OpenAI Gym", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
