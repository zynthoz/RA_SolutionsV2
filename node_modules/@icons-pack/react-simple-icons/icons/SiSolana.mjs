...
const SiSolana = React.forwardRef(function SiSolana2({ title = "Solana", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
