...
const SiRubysinatra = React.forwardRef(function SiRubysinatra2({ title = "Ruby Sinatra", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
