...
const defaultColor = "#FF6B2B";
const SiAftership = React__namespace.forwardRef(function SiAftership2({ title = "AfterShip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
