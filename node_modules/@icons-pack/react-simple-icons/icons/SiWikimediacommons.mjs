...
const SiWikimediacommons = React.forwardRef(function SiWikimediacommons2({ title = "Wikimedia Commons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
