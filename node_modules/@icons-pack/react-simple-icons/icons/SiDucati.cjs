...
const SiDucati = React__namespace.forwardRef(function SiDucati2({ title = "Ducati", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
