...
const defaultColor = "#1C47CB";
const SiPhotobucket = React__namespace.forwardRef(function SiPhotobucket2({ title = "Photobucket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
