...
const defaultColor = "#60A839";
const SiScrapy = React__namespace.forwardRef(function SiScrapy2({ title = "Scrapy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
