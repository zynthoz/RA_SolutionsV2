...
const defaultColor = "#83B81A";
const SiAcer = React__namespace.forwardRef(function SiAcer2({ title = "Acer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
