...
const SiTurbo = React__namespace.forwardRef(function SiTurbo2({ title = "Turbo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
