...
const SiOshkosh = React.forwardRef(function SiOshkosh2({ title = "Oshkosh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
