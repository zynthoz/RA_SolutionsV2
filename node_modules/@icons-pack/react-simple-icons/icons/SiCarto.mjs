...
const SiCarto = React.forwardRef(function SiCarto2({ title = "Carto", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
