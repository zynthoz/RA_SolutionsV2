...
const SiStardock = React__namespace.forwardRef(function SiStardock2({ title = "Stardock", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
