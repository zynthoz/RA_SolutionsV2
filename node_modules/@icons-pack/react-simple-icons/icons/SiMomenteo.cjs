...
const SiMomenteo = React__namespace.forwardRef(function SiMomenteo2({ title = "Momenteo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
