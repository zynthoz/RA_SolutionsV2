...
const defaultColor = "#099DFD";
const SiAgora = React__namespace.forwardRef(function SiAgora2({ title = "Agora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
