...
const SiEthiopianairlines = React.forwardRef(function SiEthiopianairlines2({ title = "Ethiopian Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
