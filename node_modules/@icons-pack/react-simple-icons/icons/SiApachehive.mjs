...
const defaultColor = "#FDEE21";
const SiApachehive = React.forwardRef(function SiApachehive2({ title = "Apache Hive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
