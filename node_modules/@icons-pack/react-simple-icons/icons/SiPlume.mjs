...
const SiPlume = React.forwardRef(function SiPlume2({ title = "Plume", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
