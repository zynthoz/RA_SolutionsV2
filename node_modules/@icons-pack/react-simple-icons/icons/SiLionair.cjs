...
const SiLionair = React__namespace.forwardRef(function SiLionair2({ title = "Lion Air", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
