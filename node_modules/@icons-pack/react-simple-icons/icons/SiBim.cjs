...
const defaultColor = "#EB1928";
const SiBim = React__namespace.forwardRef(function SiBim2({ title = "BIM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
