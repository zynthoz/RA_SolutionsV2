...
const defaultColor = "#007CC3";
const SiInfosys = React.forwardRef(function SiInfosys2({ title = "Infosys", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
