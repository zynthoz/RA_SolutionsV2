...
const defaultColor = "#3584E3";
const SiBoxysvg = React__namespace.forwardRef(function SiBoxysvg2({ title = "Boxy SVG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
