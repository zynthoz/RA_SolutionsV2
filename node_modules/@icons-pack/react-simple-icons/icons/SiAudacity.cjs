...
const defaultColor = "#0000CC";
const SiAudacity = React__namespace.forwardRef(function SiAudacity2({ title = "Audacity", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
