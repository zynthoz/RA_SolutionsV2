...
const SiHomebrew = React.forwardRef(function SiHomebrew2({ title = "Homebrew", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
