...
const defaultColor = "#FF3131";
const SiGstreamer = React__namespace.forwardRef(function SiGstreamer2({ title = "GStreamer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
