...
const SiNextbike = React__namespace.forwardRef(function SiNextbike2({ title = "nextbike", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
