...
const defaultColor = "#E1251B";
const SiHepsiemlak = React__namespace.forwardRef(function SiHepsiemlak2({ title = "Hepsiemlak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
