...
const defaultColor = "#49B48A";
const SiArlo = React__namespace.forwardRef(function SiArlo2({ title = "Arlo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
