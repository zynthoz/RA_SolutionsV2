...
const SiRyanair = React__namespace.forwardRef(function SiRyanair2({ title = "Ryanair", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
