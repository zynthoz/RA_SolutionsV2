...
const defaultColor = "#002878";
const SiDm = React__namespace.forwardRef(function SiDm2({ title = "dm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
