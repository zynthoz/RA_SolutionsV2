...
const SiAqua = React.forwardRef(function SiAqua2({ title = "Aqua", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
