...
const defaultColor = "#FB6022";
const SiSogou = React__namespace.forwardRef(function SiSogou2({ title = "Sogou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
