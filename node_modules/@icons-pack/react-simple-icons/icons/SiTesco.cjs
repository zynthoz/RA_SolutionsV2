...
const defaultColor = "#00539F";
const SiTesco = React__namespace.forwardRef(function SiTesco2({ title = "Tesco", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
