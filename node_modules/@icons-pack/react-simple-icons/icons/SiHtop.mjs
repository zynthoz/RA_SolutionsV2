...
const SiHtop = React.forwardRef(function SiHtop2({ title = "htop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
