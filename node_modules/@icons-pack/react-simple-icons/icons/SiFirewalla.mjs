...
const SiFirewalla = React.forwardRef(function SiFirewalla2({ title = "Firewalla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
