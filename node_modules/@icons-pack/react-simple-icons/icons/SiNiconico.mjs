...
const defaultColor = "#231815";
const SiNiconico = React.forwardRef(function SiNiconico2({ title = "niconico", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
