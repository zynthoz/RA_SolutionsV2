...
const defaultColor = "#D26B38";
const SiKnexdotjs = React__namespace.forwardRef(function SiKnexdotjs2({ title = "Knex.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
