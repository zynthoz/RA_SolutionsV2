...
const SiNginxproxymanager = React.forwardRef(function SiNginxproxymanager2({ title = "Nginx Proxy Manager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
