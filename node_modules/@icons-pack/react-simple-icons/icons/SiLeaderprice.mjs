...
const SiLeaderprice = React.forwardRef(function SiLeaderprice2({ title = "Leader Price", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
