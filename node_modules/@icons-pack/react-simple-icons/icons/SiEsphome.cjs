...
const SiEsphome = React__namespace.forwardRef(function SiEsphome2({ title = "ESPHome", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
