...
const defaultColor = "#1BB3A4";
const SiPretzel = React__namespace.forwardRef(function SiPretzel2({ title = "Pretzel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
