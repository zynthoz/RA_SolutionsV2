...
const defaultColor = "#004788";
const SiMaildotcom = React.forwardRef(function SiMaildotcom2({ title = "mail.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
