...
const SiGoogleappsscript = React__namespace.forwardRef(function SiGoogleappsscript2({ title = "Google Apps Script", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
