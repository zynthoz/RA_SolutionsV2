...
const defaultColor = "#B03532";
const SiHal = React.forwardRef(function SiHal2({ title = "HAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
