...
const SiKeybase = React.forwardRef(function SiKeybase2({ title = "Keybase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
