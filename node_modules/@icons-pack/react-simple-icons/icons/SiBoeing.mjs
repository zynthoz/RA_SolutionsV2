...
const SiBoeing = React.forwardRef(function SiBoeing2({ title = "Boeing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
