...
const SiCreatereactapp = React.forwardRef(function SiCreatereactapp2({ title = "Create React App", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
