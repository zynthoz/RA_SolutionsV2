...
const SiPipecat = React.forwardRef(function SiPipecat2({ title = "Pipecat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
