...
const defaultColor = "#43B02A";
const SiSelenium = React.forwardRef(function SiSelenium2({ title = "Selenium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
