...
const SiWine = React__namespace.forwardRef(function SiWine2({ title = "Wine", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
