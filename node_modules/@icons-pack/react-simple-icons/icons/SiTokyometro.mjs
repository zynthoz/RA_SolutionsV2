...
const SiTokyometro = React.forwardRef(function SiTokyometro2({ title = "Tokyo Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
