...
const SiAntdesign = React.forwardRef(function SiAntdesign2({ title = "Ant Design", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
