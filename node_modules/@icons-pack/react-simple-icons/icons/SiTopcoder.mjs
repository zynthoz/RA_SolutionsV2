...
const SiTopcoder = React.forwardRef(function SiTopcoder2({ title = "Topcoder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
