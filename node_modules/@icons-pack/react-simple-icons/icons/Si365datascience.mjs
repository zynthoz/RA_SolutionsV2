...
const Si365datascience = React.forwardRef(function Si365datascience2({ title = "365 Data Science", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
