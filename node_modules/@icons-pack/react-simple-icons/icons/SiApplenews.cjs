...
const defaultColor = "#FD415E";
const SiApplenews = React__namespace.forwardRef(function SiApplenews2({ title = "Apple News", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
