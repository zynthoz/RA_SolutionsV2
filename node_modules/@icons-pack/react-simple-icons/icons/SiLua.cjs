...
const SiLua = React__namespace.forwardRef(function SiLua2({ title = "Lua", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
