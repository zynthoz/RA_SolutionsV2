...
const defaultColor = "#506365";
const SiKamailio = React__namespace.forwardRef(function SiKamailio2({ title = "Kamailio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
