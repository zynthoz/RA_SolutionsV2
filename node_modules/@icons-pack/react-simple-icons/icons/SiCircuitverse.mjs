...
const defaultColor = "#42B883";
const SiCircuitverse = React.forwardRef(function SiCircuitverse2({ title = "CircuitVerse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
