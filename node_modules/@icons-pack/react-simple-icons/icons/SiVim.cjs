...
const defaultColor = "#019733";
const SiVim = React__namespace.forwardRef(function SiVim2({ title = "Vim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
