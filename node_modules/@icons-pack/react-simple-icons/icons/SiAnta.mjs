...
const SiAnta = React.forwardRef(function SiAnta2({ title = "Anta", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
