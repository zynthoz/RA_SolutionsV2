...
const SiBlibli = React.forwardRef(function SiBlibli2({ title = "Blibli", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
