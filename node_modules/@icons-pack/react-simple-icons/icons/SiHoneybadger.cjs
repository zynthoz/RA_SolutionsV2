...
const SiHoneybadger = React__namespace.forwardRef(function SiHoneybadger2({ title = "Honeybadger", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
