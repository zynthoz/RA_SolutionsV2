...
const defaultColor = "#E2231A";
const SiLenovo = React__namespace.forwardRef(function SiLenovo2({ title = "Lenovo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
