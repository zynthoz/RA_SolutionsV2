...
const SiCoreldraw = React__namespace.forwardRef(function SiCoreldraw2({ title = "CorelDRAW", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
