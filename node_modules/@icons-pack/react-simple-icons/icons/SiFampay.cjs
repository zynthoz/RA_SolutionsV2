...
const defaultColor = "#FFAD00";
const SiFampay = React__namespace.forwardRef(function SiFampay2({ title = "FamPay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
