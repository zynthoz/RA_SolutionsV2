...
const SiWebmoney = React__namespace.forwardRef(function SiWebmoney2({ title = "WebMoney", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
