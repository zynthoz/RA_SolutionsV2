...
const SiHiveBlockchain = React__namespace.forwardRef(function SiHiveBlockchain2({ title = "Hive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
