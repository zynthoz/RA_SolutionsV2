...
const SiYr = React.forwardRef(function SiYr2({ title = "Yr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
