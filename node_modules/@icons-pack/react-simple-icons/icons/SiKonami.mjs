...
const SiKonami = React.forwardRef(function SiKonami2({ title = "Konami", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
