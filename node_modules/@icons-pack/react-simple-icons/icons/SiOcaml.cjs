...
const SiOcaml = React__namespace.forwardRef(function SiOcaml2({ title = "OCaml", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
