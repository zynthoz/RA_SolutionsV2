...
const SiOpensourceinitiative = React.forwardRef(function SiOpensourceinitiative2({ title = "Open Source Initiative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
