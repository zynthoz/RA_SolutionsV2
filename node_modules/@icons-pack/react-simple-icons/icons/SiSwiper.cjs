...
const defaultColor = "#6332F6";
const SiSwiper = React__namespace.forwardRef(function SiSwiper2({ title = "Swiper", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
