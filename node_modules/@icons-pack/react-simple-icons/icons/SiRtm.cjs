...
const SiRtm = React__namespace.forwardRef(function SiRtm2({ title = "RTM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
