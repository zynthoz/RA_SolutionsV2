...
const defaultColor = "#233A51";
const SiDavinciresolve = React__namespace.forwardRef(function SiDavinciresolve2({ title = "DaVinci Resolve", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
