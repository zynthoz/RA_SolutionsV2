...
const SiGoogleappsscript = React.forwardRef(function SiGoogleappsscript2({ title = "Google Apps Script", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
