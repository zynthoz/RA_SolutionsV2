...
const defaultColor = "#88171A";
const SiWireguard = React__namespace.forwardRef(function SiWireguard2({ title = "WireGuard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
