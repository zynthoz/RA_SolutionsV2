...
const defaultColor = "#5309E8";
const SiFloorp = React__namespace.forwardRef(function SiFloorp2({ title = "Floorp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
