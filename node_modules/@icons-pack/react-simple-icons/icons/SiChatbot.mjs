...
const SiChatbot = React.forwardRef(function SiChatbot2({ title = "ChatBot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
