...
const defaultColor = "#38096C";
const SiTacobell = React__namespace.forwardRef(function SiTacobell2({ title = "Taco Bell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
