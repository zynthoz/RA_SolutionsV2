...
const SiThestorygraph = React.forwardRef(function SiThestorygraph2({ title = "The StoryGraph", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
