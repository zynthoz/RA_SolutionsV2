...
const defaultColor = "#EF5734";
const SiBower = React__namespace.forwardRef(function SiBower2({ title = "Bower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
