...
const SiReduxsaga = React.forwardRef(function SiReduxsaga2({ title = "Redux-Saga", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
