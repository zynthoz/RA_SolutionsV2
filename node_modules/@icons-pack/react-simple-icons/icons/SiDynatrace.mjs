...
const SiDynatrace = React.forwardRef(function SiDynatrace2({ title = "Dynatrace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
