...
const defaultColor = "#5395FD";
const Si30secondsofcode = React__namespace.forwardRef(function Si30secondsofcode2({ title = "30 seconds of code", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
