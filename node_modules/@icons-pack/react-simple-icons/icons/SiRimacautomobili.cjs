...
const SiRimacautomobili = React__namespace.forwardRef(function SiRimacautomobili2({ title = "Rimac Automobili", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
