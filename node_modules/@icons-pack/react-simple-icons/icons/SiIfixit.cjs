...
const defaultColor = "#0071CE";
const SiIfixit = React__namespace.forwardRef(function SiIfixit2({ title = "iFixit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
