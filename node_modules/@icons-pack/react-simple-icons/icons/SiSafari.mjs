...
const SiSafari = React.forwardRef(function SiSafari2({ title = "Safari", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
