...
const defaultColor = "#85B09A";
const SiVespa = React__namespace.forwardRef(function SiVespa2({ title = "Vespa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
