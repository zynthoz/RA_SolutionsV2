...
const SiYolo = React__namespace.forwardRef(function SiYolo2({ title = "YOLO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
