...
const SiSnort = React__namespace.forwardRef(function SiSnort2({ title = "Snort", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
