...
const SiCircleci = React__namespace.forwardRef(function SiCircleci2({ title = "CircleCI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
