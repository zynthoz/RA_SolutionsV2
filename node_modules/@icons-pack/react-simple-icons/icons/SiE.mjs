...
const SiE = React.forwardRef(function SiE2({ title = "/e/", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
