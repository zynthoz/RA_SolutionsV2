...
const defaultColor = "#37A5CC";
const SiAutodeskmaya = React__namespace.forwardRef(function SiAutodeskmaya2({ title = "Autodesk Maya", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
