...
const defaultColor = "#10C1D0";
const SiOmadacloud = React__namespace.forwardRef(function SiOmadacloud2({ title = "Omada Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
