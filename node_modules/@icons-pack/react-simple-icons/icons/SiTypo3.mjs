...
const SiTypo3 = React.forwardRef(function SiTypo32({ title = "TYPO3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
