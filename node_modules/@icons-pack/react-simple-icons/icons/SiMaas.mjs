...
const SiMaas = React.forwardRef(function SiMaas2({ title = "MAAS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
