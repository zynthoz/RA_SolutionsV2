...
const SiEgnyte = React__namespace.forwardRef(function SiEgnyte2({ title = "Egnyte", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
