...
const SiPostiz = React__namespace.forwardRef(function SiPostiz2({ title = "Postiz", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
