...
const defaultColor = "#33333D";
const SiKoa = React__namespace.forwardRef(function SiKoa2({ title = "Koa", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
