...
const SiNeteasecloudmusic = React__namespace.forwardRef(function SiNeteasecloudmusic2({ title = "NetEase Cloud Music", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
