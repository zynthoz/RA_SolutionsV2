...
const SiTheboringcompany = React.forwardRef(function SiTheboringcompany2({ title = "The Boring Company", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
