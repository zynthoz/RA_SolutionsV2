...
const defaultColor = "#D95E26";
const SiVyond = React.forwardRef(function SiVyond2({ title = "Vyond", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
