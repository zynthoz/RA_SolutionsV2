...
const SiLada = React__namespace.forwardRef(function SiLada2({ title = "LADA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
