...
const defaultColor = "#00CAF4";
const SiTower = React__namespace.forwardRef(function SiTower2({ title = "Tower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
