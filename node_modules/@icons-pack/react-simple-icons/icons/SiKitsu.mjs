...
const SiKitsu = React.forwardRef(function SiKitsu2({ title = "Kitsu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
