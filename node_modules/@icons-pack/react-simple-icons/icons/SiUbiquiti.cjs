...
const SiUbiquiti = React__namespace.forwardRef(function SiUbiquiti2({ title = "Ubiquiti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
