...
const defaultColor = "#417598";
const SiArtifacthub = React__namespace.forwardRef(function SiArtifacthub2({ title = "Artifact Hub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
