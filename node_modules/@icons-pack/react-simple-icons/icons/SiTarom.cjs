...
const SiTarom = React__namespace.forwardRef(function SiTarom2({ title = "TAROM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
