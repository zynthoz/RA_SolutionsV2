...
const SiGitbook = React.forwardRef(function SiGitbook2({ title = "GitBook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
