...
const SiFmod = React__namespace.forwardRef(function SiFmod2({ title = "FMOD", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
