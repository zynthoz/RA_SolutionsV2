...
const SiVectary = React__namespace.forwardRef(function SiVectary2({ title = "Vectary", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
