...
const defaultColor = "#81C459";
const SiCivicrm = React__namespace.forwardRef(function SiCivicrm2({ title = "CiviCRM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
