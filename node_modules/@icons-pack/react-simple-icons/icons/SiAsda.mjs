...
const SiAsda = React.forwardRef(function SiAsda2({ title = "ASDA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
