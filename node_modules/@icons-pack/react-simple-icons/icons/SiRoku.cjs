...
const SiRoku = React__namespace.forwardRef(function SiRoku2({ title = "Roku", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
