...
const SiPaddlepaddle = React.forwardRef(function SiPaddlepaddle2({ title = "PaddlePaddle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
