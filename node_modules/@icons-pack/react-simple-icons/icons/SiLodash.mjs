...
const SiLodash = React.forwardRef(function SiLodash2({ title = "Lodash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
