...
const SiLibrariesdotio = React.forwardRef(function SiLibrariesdotio2({ title = "Libraries.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
