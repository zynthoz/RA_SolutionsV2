...
const SiTldraw = React.forwardRef(function SiTldraw2({ title = "tldraw", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
