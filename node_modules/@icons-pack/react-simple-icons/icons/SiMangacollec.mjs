...
const SiMangacollec = React.forwardRef(function SiMangacollec2({ title = "Mangacollec", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
