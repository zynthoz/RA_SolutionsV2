...
const defaultColor = "#006241";
const SiStarbucks = React__namespace.forwardRef(function SiStarbucks2({ title = "Starbucks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
