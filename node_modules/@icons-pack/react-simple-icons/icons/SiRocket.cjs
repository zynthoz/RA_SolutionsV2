...
const SiRocket = React__namespace.forwardRef(function SiRocket2({ title = "Rocket", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
