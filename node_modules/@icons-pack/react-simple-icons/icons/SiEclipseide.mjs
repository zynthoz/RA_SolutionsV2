...
const SiEclipseide = React.forwardRef(function SiEclipseide2({ title = "Eclipse IDE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
