...
const SiTelequebec = React__namespace.forwardRef(function SiTelequebec2({ title = "Télé-Québec", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
