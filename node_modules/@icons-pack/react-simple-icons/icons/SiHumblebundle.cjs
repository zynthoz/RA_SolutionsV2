...
const SiHumblebundle = React__namespace.forwardRef(function SiHumblebundle2({ title = "Humble Bundle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
