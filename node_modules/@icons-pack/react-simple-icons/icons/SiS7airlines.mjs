...
const SiS7airlines = React.forwardRef(function SiS7airlines2({ title = "S7 Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
