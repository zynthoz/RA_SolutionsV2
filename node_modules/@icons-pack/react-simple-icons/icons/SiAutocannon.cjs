...
const defaultColor = "#3BA4B7";
const SiAutocannon = React__namespace.forwardRef(function SiAutocannon2({ title = "AutoCannon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
