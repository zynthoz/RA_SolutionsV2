...
const SiEmlakjet = React.forwardRef(function SiEmlakjet2({ title = "Emlakjet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
