...
const SiIntuit = React.forwardRef(function SiIntuit2({ title = "Intuit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
