...
const SiEspressif = React__namespace.forwardRef(function SiEspressif2({ title = "Espressif", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
