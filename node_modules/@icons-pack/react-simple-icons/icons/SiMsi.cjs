...
const SiMsi = React__namespace.forwardRef(function SiMsi2({ title = "MSI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
