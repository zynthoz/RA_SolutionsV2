...
const SiFortran = React__namespace.forwardRef(function SiFortran2({ title = "Fortran", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
