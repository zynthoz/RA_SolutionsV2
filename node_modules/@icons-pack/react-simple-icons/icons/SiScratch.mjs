...
const SiScratch = React.forwardRef(function SiScratch2({ title = "Scratch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
