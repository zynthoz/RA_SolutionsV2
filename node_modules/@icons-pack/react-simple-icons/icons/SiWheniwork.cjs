...
const defaultColor = "#51A33D";
const SiWheniwork = React__namespace.forwardRef(function SiWheniwork2({ title = "When I Work", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
