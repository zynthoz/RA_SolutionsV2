...
const SiFandom = React.forwardRef(function SiFandom2({ title = "Fandom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
