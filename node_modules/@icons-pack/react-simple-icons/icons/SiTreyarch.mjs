...
const SiTreyarch = React.forwardRef(function SiTreyarch2({ title = "Treyarch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
