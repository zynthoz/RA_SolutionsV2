...
const SiMendeley = React__namespace.forwardRef(function SiMendeley2({ title = "Mendeley", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
