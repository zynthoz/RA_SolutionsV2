...
const SiLemonsqueezy = React__namespace.forwardRef(function SiLemonsqueezy2({ title = "Lemon Squeezy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
