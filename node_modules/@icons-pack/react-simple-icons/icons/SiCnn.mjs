...
const SiCnn = React.forwardRef(function SiCnn2({ title = "CNN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
