...
const SiSimplenote = React__namespace.forwardRef(function SiSimplenote2({ title = "Simplenote", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
