...
const defaultColor = "#1F88C0";
const SiCaddy = React__namespace.forwardRef(function SiCaddy2({ title = "Caddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
