...
const SiGarmin = React__namespace.forwardRef(function SiGarmin2({ title = "Garmin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
