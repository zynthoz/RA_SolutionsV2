...
const SiExcalidraw = React.forwardRef(function SiExcalidraw2({ title = "Excalidraw", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
