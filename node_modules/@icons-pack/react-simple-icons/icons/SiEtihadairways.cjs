...
const defaultColor = "#BD8B13";
const SiEtihadairways = React__namespace.forwardRef(function SiEtihadairways2({ title = "Etihad Airways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
