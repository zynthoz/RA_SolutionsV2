...
const defaultColor = "#FF4F00";
const SiZapier = React__namespace.forwardRef(function SiZapier2({ title = "Zapier", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
