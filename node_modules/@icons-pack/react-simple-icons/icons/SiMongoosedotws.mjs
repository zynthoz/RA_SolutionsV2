...
const SiMongoosedotws = React.forwardRef(function SiMongoosedotws2({ title = "Mongoose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
