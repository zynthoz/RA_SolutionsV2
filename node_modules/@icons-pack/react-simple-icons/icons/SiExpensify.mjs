...
const SiExpensify = React.forwardRef(function SiExpensify2({ title = "Expensify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
