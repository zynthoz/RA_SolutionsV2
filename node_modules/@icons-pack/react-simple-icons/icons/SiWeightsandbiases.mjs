...
const SiWeightsandbiases = React.forwardRef(function SiWeightsandbiases2({ title = "Weights & Biases", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
