...
const SiCraftsman = React.forwardRef(function SiCraftsman2({ title = "Craftsman", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
