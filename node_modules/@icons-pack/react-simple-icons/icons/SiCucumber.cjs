...
const defaultColor = "#23D96C";
const SiCucumber = React__namespace.forwardRef(function SiCucumber2({ title = "Cucumber", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
