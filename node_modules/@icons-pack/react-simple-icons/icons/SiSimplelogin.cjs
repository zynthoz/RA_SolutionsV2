...
const defaultColor = "#EA319F";
const SiSimplelogin = React__namespace.forwardRef(function SiSimplelogin2({ title = "SimpleLogin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
