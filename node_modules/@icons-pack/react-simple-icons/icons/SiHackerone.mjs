...
const SiHackerone = React.forwardRef(function SiHackerone2({ title = "HackerOne", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
