...
const SiPrecommit = React.forwardRef(function SiPrecommit2({ title = "pre-commit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
