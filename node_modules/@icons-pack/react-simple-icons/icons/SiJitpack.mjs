...
const SiJitpack = React.forwardRef(function SiJitpack2({ title = "JitPack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
