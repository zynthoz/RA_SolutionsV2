...
const SiJfrog = React__namespace.forwardRef(function SiJfrog2({ title = "JFrog", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
