...
const defaultColor = "#0ACF83";
const SiHelium = React__namespace.forwardRef(function SiHelium2({ title = "Helium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
