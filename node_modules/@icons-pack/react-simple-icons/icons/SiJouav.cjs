...
const defaultColor = "#E1B133";
const SiJouav = React__namespace.forwardRef(function SiJouav2({ title = "JOUAV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
