...
const SiZebratechnologies = React.forwardRef(function SiZebratechnologies2({ title = "Zebra Technologies", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
