...
const SiWebcomponentsdotorg = React__namespace.forwardRef(function SiWebcomponentsdotorg2({ title = "webcomponents.org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
