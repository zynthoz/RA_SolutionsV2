...
const defaultColor = "#3B66BC";
const Si1password = React__namespace.forwardRef(function Si1password2({ title = "1Password", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
