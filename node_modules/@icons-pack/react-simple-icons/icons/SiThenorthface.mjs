...
const SiThenorthface = React.forwardRef(function SiThenorthface2({ title = "The North Face", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
