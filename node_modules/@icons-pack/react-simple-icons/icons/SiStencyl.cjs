...
const defaultColor = "#8E1C04";
const SiStencyl = React__namespace.forwardRef(function SiStencyl2({ title = "Stencyl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
