...
const defaultColor = "#003057";
const SiVolvo = React__namespace.forwardRef(function SiVolvo2({ title = "Volvo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
