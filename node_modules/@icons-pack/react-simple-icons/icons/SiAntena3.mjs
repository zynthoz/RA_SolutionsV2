...
const SiAntena3 = React.forwardRef(function SiAntena32({ title = "Antena 3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
