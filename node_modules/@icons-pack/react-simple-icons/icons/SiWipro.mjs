...
const defaultColor = "#341C53";
const SiWipro = React.forwardRef(function SiWipro2({ title = "Wipro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
