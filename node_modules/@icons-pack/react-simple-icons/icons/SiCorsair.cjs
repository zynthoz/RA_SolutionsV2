...
const SiCorsair = React__namespace.forwardRef(function SiCorsair2({ title = "Corsair", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
