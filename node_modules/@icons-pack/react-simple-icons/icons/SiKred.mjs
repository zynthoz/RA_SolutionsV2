...
const SiKred = React.forwardRef(function SiKred2({ title = "Kred", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
