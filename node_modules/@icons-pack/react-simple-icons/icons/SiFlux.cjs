...
const SiFlux = React__namespace.forwardRef(function SiFlux2({ title = "Flux", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
