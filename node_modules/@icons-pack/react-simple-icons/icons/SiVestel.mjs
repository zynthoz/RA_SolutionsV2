...
const SiVestel = React.forwardRef(function SiVestel2({ title = "Vestel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
