...
const defaultColor = "#51A2DA";
const SiFedora = React__namespace.forwardRef(function SiFedora2({ title = "Fedora", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
