...
const SiSennheiser = React.forwardRef(function SiSennheiser2({ title = "Sennheiser", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
