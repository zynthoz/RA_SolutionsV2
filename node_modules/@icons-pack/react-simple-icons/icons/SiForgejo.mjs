...
const SiForgejo = React.forwardRef(function SiForgejo2({ title = "Forgejo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
