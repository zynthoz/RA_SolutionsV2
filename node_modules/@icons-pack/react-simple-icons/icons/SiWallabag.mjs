...
const SiWallabag = React.forwardRef(function SiWallabag2({ title = "Wallabag", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
