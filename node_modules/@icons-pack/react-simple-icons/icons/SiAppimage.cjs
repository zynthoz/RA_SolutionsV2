...
const SiAppimage = React__namespace.forwardRef(function SiAppimage2({ title = "AppImage", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
