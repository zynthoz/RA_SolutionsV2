...
const SiDiscorddotjs = React__namespace.forwardRef(function SiDiscorddotjs2({ title = "discord.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
