...
const SiCytoscapedotjs = React__namespace.forwardRef(function SiCytoscapedotjs2({ title = "Cytoscape.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
