...
const defaultColor = "#18A5D6";
const SiUlule = React__namespace.forwardRef(function SiUlule2({ title = "Ulule", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
