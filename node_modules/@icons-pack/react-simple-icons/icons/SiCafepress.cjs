...
const defaultColor = "#58A616";
const SiCafepress = React__namespace.forwardRef(function SiCafepress2({ title = "CafePress", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
