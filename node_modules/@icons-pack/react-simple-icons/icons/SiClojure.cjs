...
const defaultColor = "#5881D8";
const SiClojure = React__namespace.forwardRef(function SiClojure2({ title = "Clojure", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
