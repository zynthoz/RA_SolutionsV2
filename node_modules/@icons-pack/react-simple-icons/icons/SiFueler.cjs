...
const defaultColor = "#09C9E3";
const SiFueler = React__namespace.forwardRef(function SiFueler2({ title = "Fueler", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
