...
const SiWikiquote = React__namespace.forwardRef(function SiWikiquote2({ title = "Wikiquote", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
