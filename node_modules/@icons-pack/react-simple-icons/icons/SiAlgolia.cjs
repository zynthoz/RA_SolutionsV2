...
const defaultColor = "#003DFF";
const SiAlgolia = React__namespace.forwardRef(function SiAlgolia2({ title = "Algolia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
