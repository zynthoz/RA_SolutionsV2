...
const SiPretzel = React.forwardRef(function SiPretzel2({ title = "Pretzel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
