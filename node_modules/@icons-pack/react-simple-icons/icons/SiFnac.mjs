...
const SiFnac = React.forwardRef(function SiFnac2({ title = "Fnac", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
