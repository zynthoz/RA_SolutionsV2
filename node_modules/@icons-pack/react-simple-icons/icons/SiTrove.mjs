...
const SiTrove = React.forwardRef(function SiTrove2({ title = "Trove", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
