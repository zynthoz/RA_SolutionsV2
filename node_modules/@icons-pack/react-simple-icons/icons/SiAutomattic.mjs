...
const SiAutomattic = React.forwardRef(function SiAutomattic2({ title = "Automattic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
