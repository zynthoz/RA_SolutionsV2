...
const SiMullvad = React.forwardRef(function SiMullvad2({ title = "Mullvad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
