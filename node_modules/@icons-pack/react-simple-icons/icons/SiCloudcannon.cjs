...
const defaultColor = "#407AFC";
const SiCloudcannon = React__namespace.forwardRef(function SiCloudcannon2({ title = "CloudCannon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
