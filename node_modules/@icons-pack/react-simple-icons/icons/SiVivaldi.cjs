...
const SiVivaldi = React__namespace.forwardRef(function SiVivaldi2({ title = "Vivaldi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
