...
const SiLegacygames = React__namespace.forwardRef(function SiLegacygames2({ title = "Legacy Games", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
