...
const defaultColor = "#2D683D";
const SiOppo = React.forwardRef(function SiOppo2({ title = "OPPO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
export { SiOppo as default, defaultColor };
