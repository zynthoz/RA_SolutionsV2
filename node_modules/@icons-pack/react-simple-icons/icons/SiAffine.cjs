...
const defaultColor = "#1E96EB";
const SiAffine = React__namespace.forwardRef(function SiAffine2({ title = "AFFiNE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
