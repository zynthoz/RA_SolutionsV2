...
const SiTrillertv = React.forwardRef(function SiTrillertv2({ title = "TrillerTV", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
