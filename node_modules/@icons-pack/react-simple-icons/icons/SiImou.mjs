...
const SiImou = React.forwardRef(function SiImou2({ title = "Imou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
