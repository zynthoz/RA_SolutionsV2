...
const defaultColor = "#85CDF0";
const SiApachedolphinscheduler = React.forwardRef(function SiApachedolphinscheduler2({ title = "Apache DolphinScheduler", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
