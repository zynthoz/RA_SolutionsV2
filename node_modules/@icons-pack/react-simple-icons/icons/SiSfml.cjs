...
const SiSfml = React__namespace.forwardRef(function SiSfml2({ title = "SFML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
