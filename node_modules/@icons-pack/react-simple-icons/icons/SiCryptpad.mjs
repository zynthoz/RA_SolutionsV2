...
const SiCryptpad = React.forwardRef(function SiCryptpad2({ title = "CryptPad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
