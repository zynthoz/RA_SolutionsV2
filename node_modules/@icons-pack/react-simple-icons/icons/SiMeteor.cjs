...
const defaultColor = "#DE4F4F";
const SiMeteor = React__namespace.forwardRef(function SiMeteor2({ title = "Meteor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
