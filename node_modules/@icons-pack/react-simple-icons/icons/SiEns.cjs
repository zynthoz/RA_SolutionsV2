...
const defaultColor = "#0080BC";
const SiEns = React__namespace.forwardRef(function SiEns2({ title = "ENS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
