...
const SiLinphone = React__namespace.forwardRef(function SiLinphone2({ title = "Linphone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
