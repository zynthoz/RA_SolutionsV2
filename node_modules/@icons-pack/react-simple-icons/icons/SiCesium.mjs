...
const SiCesium = React.forwardRef(function SiCesium2({ title = "Cesium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
