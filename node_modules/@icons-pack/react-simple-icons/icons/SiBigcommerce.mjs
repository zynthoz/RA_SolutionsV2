...
const SiBigcommerce = React.forwardRef(function SiBigcommerce2({ title = "BigCommerce", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
