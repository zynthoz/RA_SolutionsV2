...
const SiNhl = React.forwardRef(function SiNhl2({ title = "NHL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
