...
const SiRye = React__namespace.forwardRef(function SiRye2({ title = "Rye", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
