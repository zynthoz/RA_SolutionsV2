...
const defaultColor = "#FF6D70";
const SiTalend = React__namespace.forwardRef(function SiTalend2({ title = "Talend", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
