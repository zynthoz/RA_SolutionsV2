...
const SiCoinmarketcap = React.forwardRef(function SiCoinmarketcap2({ title = "CoinMarketCap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
