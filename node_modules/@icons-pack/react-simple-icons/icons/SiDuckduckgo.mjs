...
const SiDuckduckgo = React.forwardRef(function SiDuckduckgo2({ title = "DuckDuckGo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
