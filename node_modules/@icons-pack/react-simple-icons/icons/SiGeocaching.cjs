...
const SiGeocaching = React__namespace.forwardRef(function SiGeocaching2({ title = "Geocaching", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
