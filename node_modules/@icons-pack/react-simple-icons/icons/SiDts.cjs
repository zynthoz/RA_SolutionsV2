...
const defaultColor = "#F98B2B";
const SiDts = React__namespace.forwardRef(function SiDts2({ title = "DTS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
