...
const SiRemedyentertainment = React.forwardRef(function SiRemedyentertainment2({ title = "Remedy Entertainment", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
