...
const SiAnki = React.forwardRef(function SiAnki2({ title = "Anki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
