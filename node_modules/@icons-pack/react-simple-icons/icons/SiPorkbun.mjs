...
const SiPorkbun = React.forwardRef(function SiPorkbun2({ title = "Porkbun", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
