...
const defaultColor = "#F40027";
const SiKfc = React.forwardRef(function SiKfc2({ title = "KFC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
