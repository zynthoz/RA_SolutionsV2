...
const defaultColor = "#335EEA";
const SiCyberdefenders = React__namespace.forwardRef(function SiCyberdefenders2({ title = "CyberDefenders", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
