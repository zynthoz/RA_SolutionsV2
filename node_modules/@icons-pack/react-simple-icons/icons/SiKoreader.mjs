...
const SiKoreader = React.forwardRef(function SiKoreader2({ title = "KOReader", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
