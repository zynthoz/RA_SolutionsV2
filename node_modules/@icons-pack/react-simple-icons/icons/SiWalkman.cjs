...
const SiWalkman = React__namespace.forwardRef(function SiWalkman2({ title = "WALKMAN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
