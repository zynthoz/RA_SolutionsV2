...
const SiMediafire = React__namespace.forwardRef(function SiMediafire2({ title = "MediaFire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
