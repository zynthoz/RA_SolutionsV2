...
const SiBookingdotcom = React__namespace.forwardRef(function SiBookingdotcom2({ title = "Booking.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
