...
const SiEvernote = React.forwardRef(function SiEvernote2({ title = "Evernote", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
