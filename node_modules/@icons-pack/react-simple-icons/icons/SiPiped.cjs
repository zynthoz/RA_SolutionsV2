...
const SiPiped = React__namespace.forwardRef(function SiPiped2({ title = "Piped", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
