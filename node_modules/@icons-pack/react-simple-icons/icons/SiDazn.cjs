...
const defaultColor = "#F8F8F5";
const SiDazn = React__namespace.forwardRef(function SiDazn2({ title = "DAZN", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
