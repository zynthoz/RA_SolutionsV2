...
const defaultColor = "#A22430";
const SiGnusocial = React__namespace.forwardRef(function SiGnusocial2({ title = "GNU social", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
