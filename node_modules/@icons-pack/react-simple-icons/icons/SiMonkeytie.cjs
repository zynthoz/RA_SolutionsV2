...
const defaultColor = "#1A52C2";
const SiMonkeytie = React__namespace.forwardRef(function SiMonkeytie2({ title = "monkey tie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
