...
const SiTile = React__namespace.forwardRef(function SiTile2({ title = "Tile", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
