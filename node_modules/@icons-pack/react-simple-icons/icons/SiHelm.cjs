...
const defaultColor = "#0F1689";
const SiHelm = React__namespace.forwardRef(function SiHelm2({ title = "Helm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
