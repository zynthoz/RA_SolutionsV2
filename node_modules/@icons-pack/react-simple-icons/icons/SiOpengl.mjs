...
const SiOpengl = React.forwardRef(function SiOpengl2({ title = "OpenGL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
