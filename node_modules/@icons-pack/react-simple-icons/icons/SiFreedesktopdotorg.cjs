...
const SiFreedesktopdotorg = React__namespace.forwardRef(function SiFreedesktopdotorg2({ title = "freedesktop.org", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
