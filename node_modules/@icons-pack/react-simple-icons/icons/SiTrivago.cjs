...
const SiTrivago = React__namespace.forwardRef(function SiTrivago2({ title = "trivago", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
