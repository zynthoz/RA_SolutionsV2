...
const SiFathom = React.forwardRef(function SiFathom2({ title = "Fathom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
