...
const SiQantas = React__namespace.forwardRef(function SiQantas2({ title = "Qantas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
