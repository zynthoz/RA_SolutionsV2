...
const defaultColor = "#5333ED";
const SiKinsta = React.forwardRef(function SiKinsta2({ title = "Kinsta", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
