...
const SiZingat = React.forwardRef(function SiZingat2({ title = "Zingat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
