...
const defaultColor = "#F0D722";
const SiBvg = React__namespace.forwardRef(function SiBvg2({ title = "BVG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
