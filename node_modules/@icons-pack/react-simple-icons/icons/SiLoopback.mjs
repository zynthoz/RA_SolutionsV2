...
const defaultColor = "#3F5DFF";
const SiLoopback = React.forwardRef(function SiLoopback2({ title = "LoopBack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
