...
const SiApachedruid = React.forwardRef(function SiApachedruid2({ title = "Apache Druid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
