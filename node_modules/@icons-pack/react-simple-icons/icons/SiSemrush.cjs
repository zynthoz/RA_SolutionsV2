...
const SiSemrush = React__namespace.forwardRef(function SiSemrush2({ title = "Semrush", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
