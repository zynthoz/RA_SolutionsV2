...
const SiServbay = React__namespace.forwardRef(function SiServbay2({ title = "ServBay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
