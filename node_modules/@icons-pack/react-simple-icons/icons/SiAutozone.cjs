...
const SiAutozone = React__namespace.forwardRef(function SiAutozone2({ title = "AutoZone", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
