...
const SiElsevier = React__namespace.forwardRef(function SiElsevier2({ title = "Elsevier", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
