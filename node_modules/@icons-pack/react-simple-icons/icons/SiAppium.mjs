...
const SiAppium = React.forwardRef(function SiAppium2({ title = "Appium", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
