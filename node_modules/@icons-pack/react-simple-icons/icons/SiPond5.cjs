...
const SiPond5 = React__namespace.forwardRef(function SiPond52({ title = "Pond5", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
