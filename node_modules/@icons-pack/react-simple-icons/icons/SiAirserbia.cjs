...
const defaultColor = "#0E203F";
const SiAirserbia = React__namespace.forwardRef(function SiAirserbia2({ title = "Air Serbia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
