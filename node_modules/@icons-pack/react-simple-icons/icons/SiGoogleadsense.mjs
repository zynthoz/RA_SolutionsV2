...
const SiGoogleadsense = React.forwardRef(function SiGoogleadsense2({ title = "Google AdSense", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
