...
const SiDelta = React__namespace.forwardRef(function SiDelta2({ title = "Delta", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
