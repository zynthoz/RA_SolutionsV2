...
const SiCnet = React.forwardRef(function SiCnet2({ title = "CNET", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
