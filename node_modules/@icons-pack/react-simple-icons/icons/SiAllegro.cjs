...
const SiAllegro = React__namespace.forwardRef(function SiAllegro2({ title = "Allegro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
