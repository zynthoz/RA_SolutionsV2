...
const SiQuicktype = React.forwardRef(function SiQuicktype2({ title = "quicktype", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
