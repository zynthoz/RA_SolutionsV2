...
const SiTildapublishing = React.forwardRef(function SiTildapublishing2({ title = "Tilda Publishing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
