...
const SiWebgl = React.forwardRef(function SiWebgl2({ title = "WebGL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
