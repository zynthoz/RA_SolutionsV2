...
const SiPlaystationvita = React__namespace.forwardRef(function SiPlaystationvita2({ title = "PlayStation Vita", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
