...
const defaultColor = "#F49923";
const SiBitcomet = React__namespace.forwardRef(function SiBitcomet2({ title = "BitComet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
