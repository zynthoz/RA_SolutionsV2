...
const SiKuma = React__namespace.forwardRef(function SiKuma2({ title = "Kuma", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
