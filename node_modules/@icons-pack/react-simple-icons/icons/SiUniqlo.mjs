...
const SiUniqlo = React.forwardRef(function SiUniqlo2({ title = "Uniqlo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
