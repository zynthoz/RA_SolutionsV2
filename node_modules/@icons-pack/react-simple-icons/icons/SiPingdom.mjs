...
const SiPingdom = React.forwardRef(function SiPingdom2({ title = "Pingdom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
