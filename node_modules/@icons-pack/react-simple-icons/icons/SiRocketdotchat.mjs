...
const SiRocketdotchat = React.forwardRef(function SiRocketdotchat2({ title = "Rocket.Chat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
