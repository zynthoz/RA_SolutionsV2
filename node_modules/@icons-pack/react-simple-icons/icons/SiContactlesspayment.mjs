...
const SiContactlesspayment = React.forwardRef(function SiContactlesspayment2({ title = "Contactless Payment", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
