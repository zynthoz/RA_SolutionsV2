...
const SiScan = React__namespace.forwardRef(function SiScan2({ title = "Scan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
