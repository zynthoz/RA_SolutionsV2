...
const SiTina = React.forwardRef(function SiTina2({ title = "Tina", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
