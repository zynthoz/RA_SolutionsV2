...
const SiPegasusairlines = React__namespace.forwardRef(function SiPegasusairlines2({ title = "Pegasus Airlines", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
