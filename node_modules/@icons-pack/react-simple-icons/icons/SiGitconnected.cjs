...
const SiGitconnected = React__namespace.forwardRef(function SiGitconnected2({ title = "Gitconnected", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
