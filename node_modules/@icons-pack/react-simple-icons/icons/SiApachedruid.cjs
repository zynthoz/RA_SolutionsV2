...
const defaultColor = "#29F1FB";
const SiApachedruid = React__namespace.forwardRef(function SiApachedruid2({ title = "Apache Druid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
