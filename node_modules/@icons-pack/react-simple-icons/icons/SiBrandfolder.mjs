...
const SiBrandfolder = React.forwardRef(function SiBrandfolder2({ title = "Brandfolder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
