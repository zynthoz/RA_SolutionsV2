...
const defaultColor = "#308BE3";
const SiRenovate = React__namespace.forwardRef(function SiRenovate2({ title = "Renovate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
