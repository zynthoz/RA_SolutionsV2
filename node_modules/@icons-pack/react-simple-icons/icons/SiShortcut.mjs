...
const SiShortcut = React.forwardRef(function SiShortcut2({ title = "Shortcut", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
