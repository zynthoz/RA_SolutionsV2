...
const SiUdacity = React__namespace.forwardRef(function SiUdacity2({ title = "Udacity", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
