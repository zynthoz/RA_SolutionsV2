...
const SiThunderbird = React__namespace.forwardRef(function SiThunderbird2({ title = "Thunderbird", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
