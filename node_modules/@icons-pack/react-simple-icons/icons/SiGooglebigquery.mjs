...
const SiGooglebigquery = React.forwardRef(function SiGooglebigquery2({ title = "Google BigQuery", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
