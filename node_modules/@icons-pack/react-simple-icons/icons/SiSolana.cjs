...
const defaultColor = "#9945FF";
const SiSolana = React__namespace.forwardRef(function SiSolana2({ title = "Solana", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
