...
const SiBankofamerica = React__namespace.forwardRef(function SiBankofamerica2({ title = "Bank of America", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
