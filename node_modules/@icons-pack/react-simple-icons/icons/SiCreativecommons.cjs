...
const defaultColor = "#ED592F";
const SiCreativecommons = React__namespace.forwardRef(function SiCreativecommons2({ title = "Creative Commons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
