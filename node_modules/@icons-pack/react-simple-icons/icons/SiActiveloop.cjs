...
const SiActiveloop = React__namespace.forwardRef(function SiActiveloop2({ title = "Activeloop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
