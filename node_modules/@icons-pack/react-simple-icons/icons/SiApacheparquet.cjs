...
const defaultColor = "#50ABF1";
const SiApacheparquet = React__namespace.forwardRef(function SiApacheparquet2({ title = "Apache Parquet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
