...
const defaultColor = "#FF7328";
const SiAntena3 = React__namespace.forwardRef(function SiAntena32({ title = "Antena 3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
