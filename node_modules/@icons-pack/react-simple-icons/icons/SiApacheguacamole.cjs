...
const defaultColor = "#578B34";
const SiApacheguacamole = React__namespace.forwardRef(function SiApacheguacamole2({ title = "Apache Guacamole", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
