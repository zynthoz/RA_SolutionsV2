...
const defaultColor = "#FFD100";
const SiMeituan = React__namespace.forwardRef(function SiMeituan2({ title = "Meituan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
