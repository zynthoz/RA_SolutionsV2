...
const defaultColor = "#F213A4";
const SiThirdweb = React__namespace.forwardRef(function SiThirdweb2({ title = "thirdweb", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
