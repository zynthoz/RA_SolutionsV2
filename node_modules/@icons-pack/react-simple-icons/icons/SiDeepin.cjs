...
const defaultColor = "#007CFF";
const SiDeepin = React__namespace.forwardRef(function SiDeepin2({ title = "deepin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
