...
const SiAutodeskmaya = React.forwardRef(function SiAutodeskmaya2({ title = "Autodesk Maya", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
