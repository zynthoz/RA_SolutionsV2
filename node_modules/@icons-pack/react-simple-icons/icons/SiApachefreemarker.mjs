...
const SiApachefreemarker = React.forwardRef(function SiApachefreemarker2({ title = "Apache FreeMarker", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
