...
const SiHumblebundle = React.forwardRef(function SiHumblebundle2({ title = "Humble Bundle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
