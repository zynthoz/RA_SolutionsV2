...
const defaultColor = "#00AA13";
const SiGojek = React__namespace.forwardRef(function SiGojek2({ title = "Gojek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
