...
const defaultColor = "#0371B5";
const SiUnderscoredotjs = React__namespace.forwardRef(function SiUnderscoredotjs2({ title = "Underscore.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
