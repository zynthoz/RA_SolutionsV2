...
const SiOclif = React.forwardRef(function SiOclif2({ title = "oclif", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
