...
const SiAudi = React__namespace.forwardRef(function SiAudi2({ title = "Audi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
