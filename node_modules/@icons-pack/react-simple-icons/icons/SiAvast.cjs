...
const defaultColor = "#FF7800";
const SiAvast = React__namespace.forwardRef(function SiAvast2({ title = "Avast", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
