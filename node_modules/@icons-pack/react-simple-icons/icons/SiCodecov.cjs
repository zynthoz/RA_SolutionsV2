...
const defaultColor = "#F01F7A";
const SiCodecov = React__namespace.forwardRef(function SiCodecov2({ title = "Codecov", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
