...
const SiReactquery = React.forwardRef(function SiReactquery2({ title = "React Query", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
