...
const defaultColor = "#82BC23";
const SiKik = React__namespace.forwardRef(function SiKik2({ title = "Kik", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
