...
const defaultColor = "#00B5AD";
const SiSemanticui = React__namespace.forwardRef(function SiSemanticui2({ title = "Semantic UI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
