...
const SiJoplin = React.forwardRef(function SiJoplin2({ title = "Joplin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
