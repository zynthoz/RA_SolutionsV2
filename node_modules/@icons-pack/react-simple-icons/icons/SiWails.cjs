...
const SiWails = React__namespace.forwardRef(function SiWails2({ title = "Wails", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
