...
const defaultColor = "#F3F5F5";
const SiCharles = React.forwardRef(function SiCharles2({ title = "Charles", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
