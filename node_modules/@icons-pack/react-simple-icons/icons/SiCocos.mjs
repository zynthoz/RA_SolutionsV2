...
const SiCocos = React.forwardRef(function SiCocos2({ title = "Cocos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
