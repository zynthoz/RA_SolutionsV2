...
const defaultColor = "#84B135";
const SiJunipernetworks = React__namespace.forwardRef(function SiJunipernetworks2({ title = "Juniper Networks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
