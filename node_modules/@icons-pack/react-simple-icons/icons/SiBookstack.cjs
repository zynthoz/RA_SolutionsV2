...
const SiBookstack = React__namespace.forwardRef(function SiBookstack2({ title = "BookStack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
