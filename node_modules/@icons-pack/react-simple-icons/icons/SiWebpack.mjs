...
const SiWebpack = React.forwardRef(function SiWebpack2({ title = "Webpack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
