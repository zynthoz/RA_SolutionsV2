...
const SiOxygen = React.forwardRef(function SiOxygen2({ title = "Oxygen", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
