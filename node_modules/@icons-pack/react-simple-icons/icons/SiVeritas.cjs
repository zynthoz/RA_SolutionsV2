...
const defaultColor = "#B1181E";
const SiVeritas = React__namespace.forwardRef(function SiVeritas2({ title = "Veritas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
