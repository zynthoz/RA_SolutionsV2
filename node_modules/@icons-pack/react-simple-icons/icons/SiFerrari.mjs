...
const SiFerrari = React.forwardRef(function SiFerrari2({ title = "Ferrari", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
