...
const SiLabex = React__namespace.forwardRef(function SiLabex2({ title = "LabEx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
