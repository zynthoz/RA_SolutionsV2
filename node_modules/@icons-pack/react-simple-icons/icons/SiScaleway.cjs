...
const SiScaleway = React__namespace.forwardRef(function SiScaleway2({ title = "Scaleway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
