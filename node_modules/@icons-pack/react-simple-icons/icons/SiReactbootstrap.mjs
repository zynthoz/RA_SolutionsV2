...
const SiReactbootstrap = React.forwardRef(function SiReactbootstrap2({ title = "React Bootstrap", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
