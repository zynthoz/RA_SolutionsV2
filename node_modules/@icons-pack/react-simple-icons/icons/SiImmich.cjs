...
const SiImmich = React__namespace.forwardRef(function SiImmich2({ title = "Immich", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
