...
const SiWoocommerce = React__namespace.forwardRef(function SiWoocommerce2({ title = "WooCommerce", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
