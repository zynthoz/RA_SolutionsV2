...
const SiCheckio = React.forwardRef(function SiCheckio2({ title = "CheckiO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
