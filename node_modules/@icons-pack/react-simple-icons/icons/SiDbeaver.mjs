...
const SiDbeaver = React.forwardRef(function SiDbeaver2({ title = "DBeaver", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
