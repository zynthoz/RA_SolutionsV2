...
const SiMonica = React__namespace.forwardRef(function SiMonica2({ title = "Monica", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
