...
const SiGeneralelectric = React.forwardRef(function SiGeneralelectric2({ title = "General Electric", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
