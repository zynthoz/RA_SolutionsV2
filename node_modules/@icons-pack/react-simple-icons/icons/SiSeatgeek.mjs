...
const SiSeatgeek = React.forwardRef(function SiSeatgeek2({ title = "SeatGeek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
