...
const SiQnap = React__namespace.forwardRef(function SiQnap2({ title = "QNAP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
