...
const defaultColor = "#5CAE58";
const SiGdal = React__namespace.forwardRef(function SiGdal2({ title = "GDAL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
