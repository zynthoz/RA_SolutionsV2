...
const SiQuicktype = React__namespace.forwardRef(function SiQuicktype2({ title = "quicktype", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
