...
const SiMeteor = React.forwardRef(function SiMeteor2({ title = "Meteor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
