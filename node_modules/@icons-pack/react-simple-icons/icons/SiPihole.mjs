...
const SiPihole = React.forwardRef(function SiPihole2({ title = "Pi-hole", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
