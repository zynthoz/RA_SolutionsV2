...
const defaultColor = "#40D1F5";
const SiBrandfolder = React__namespace.forwardRef(function SiBrandfolder2({ title = "Brandfolder", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
