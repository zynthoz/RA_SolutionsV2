...
const SiPhoton = React__namespace.forwardRef(function SiPhoton2({ title = "Photon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
