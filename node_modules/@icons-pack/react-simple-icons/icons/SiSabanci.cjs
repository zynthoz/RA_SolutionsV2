...
const defaultColor = "#004B93";
const SiSabanci = React__namespace.forwardRef(function SiSabanci2({ title = "Sabanci", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
