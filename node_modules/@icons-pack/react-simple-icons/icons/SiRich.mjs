...
const SiRich = React.forwardRef(function SiRich2({ title = "Rich", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
