...
const SiIndeed = React.forwardRef(function SiIndeed2({ title = "Indeed", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
