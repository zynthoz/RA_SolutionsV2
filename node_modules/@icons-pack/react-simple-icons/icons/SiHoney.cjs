...
const SiHoney = React__namespace.forwardRef(function SiHoney2({ title = "Honey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
