...
const SiGnome = React.forwardRef(function SiGnome2({ title = "GNOME", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
