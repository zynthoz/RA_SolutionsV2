...
const SiSplunk = React__namespace.forwardRef(function SiSplunk2({ title = "Splunk", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
