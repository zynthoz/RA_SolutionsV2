...
const SiMlb = React.forwardRef(function SiMlb2({ title = "MLB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
