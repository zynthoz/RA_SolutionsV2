...
const SiOctobercms = React.forwardRef(function SiOctobercms2({ title = "October CMS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
