...
const defaultColor = "#FF0D68";
const SiSanic = React__namespace.forwardRef(function SiSanic2({ title = "Sanic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
