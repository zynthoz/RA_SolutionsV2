...
const SiKnative = React.forwardRef(function SiKnative2({ title = "Knative", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
