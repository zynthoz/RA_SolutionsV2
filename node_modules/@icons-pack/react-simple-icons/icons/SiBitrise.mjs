...
const SiBitrise = React.forwardRef(function SiBitrise2({ title = "Bitrise", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
