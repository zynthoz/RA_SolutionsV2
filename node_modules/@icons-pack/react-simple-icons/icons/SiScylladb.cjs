...
const defaultColor = "#6CD5E7";
const SiScylladb = React__namespace.forwardRef(function SiScylladb2({ title = "ScyllaDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
