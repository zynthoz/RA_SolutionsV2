...
const SiHbomax = React__namespace.forwardRef(function SiHbomax2({ title = "HBO Max", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
