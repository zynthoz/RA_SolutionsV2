...
const SiDash = React.forwardRef(function SiDash2({ title = "Dash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
