...
const SiSidekiq = React__namespace.forwardRef(function SiSidekiq2({ title = "Sidekiq", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
