...
const SiMahindra = React.forwardRef(function SiMahindra2({ title = "Mahindra", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
