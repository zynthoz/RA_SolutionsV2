...
const SiWolframlanguage = React__namespace.forwardRef(function SiWolframlanguage2({ title = "Wolfram Language", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
