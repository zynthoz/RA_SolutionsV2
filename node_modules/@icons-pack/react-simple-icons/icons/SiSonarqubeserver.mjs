...
const SiSonarqubeserver = React.forwardRef(function SiSonarqubeserver2({ title = "SonarQube Server", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
