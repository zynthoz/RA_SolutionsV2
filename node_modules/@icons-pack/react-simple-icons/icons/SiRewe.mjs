...
const defaultColor = "#CC071E";
const SiRewe = React.forwardRef(function SiRewe2({ title = "REWE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
