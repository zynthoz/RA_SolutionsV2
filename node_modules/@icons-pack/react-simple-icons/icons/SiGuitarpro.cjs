...
const SiGuitarpro = React__namespace.forwardRef(function SiGuitarpro2({ title = "Guitar Pro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
