...
const SiInfoq = React.forwardRef(function SiInfoq2({ title = "InfoQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
