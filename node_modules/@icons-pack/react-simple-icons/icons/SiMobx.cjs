...
const SiMobx = React__namespace.forwardRef(function SiMobx2({ title = "MobX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
