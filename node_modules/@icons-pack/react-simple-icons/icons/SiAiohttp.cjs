...
const defaultColor = "#2C5BB4";
const SiAiohttp = React__namespace.forwardRef(function SiAiohttp2({ title = "AIOHTTP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
