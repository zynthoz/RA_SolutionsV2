...
const SiLeagueoflegends = React__namespace.forwardRef(function SiLeagueoflegends2({ title = "League of Legends", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
