...
const SiLyft = React__namespace.forwardRef(function SiLyft2({ title = "Lyft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
