...
const defaultColor = "#002E5F";
const SiNfc = React__namespace.forwardRef(function SiNfc2({ title = "NFC", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
