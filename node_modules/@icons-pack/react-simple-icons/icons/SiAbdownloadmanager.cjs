...
const defaultColor = "#897BFF";
const SiAbdownloadmanager = React__namespace.forwardRef(function SiAbdownloadmanager2({ title = "AB Download Manager", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
