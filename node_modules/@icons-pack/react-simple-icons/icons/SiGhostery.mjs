...
const defaultColor = "#00AEF0";
const SiGhostery = React.forwardRef(function SiGhostery2({ title = "Ghostery", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
