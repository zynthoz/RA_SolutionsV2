...
const defaultColor = "#80B5E3";
const SiChocolatey = React__namespace.forwardRef(function SiChocolatey2({ title = "Chocolatey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
