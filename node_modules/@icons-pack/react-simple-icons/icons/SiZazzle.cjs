...
const SiZazzle = React__namespace.forwardRef(function SiZazzle2({ title = "Zazzle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
