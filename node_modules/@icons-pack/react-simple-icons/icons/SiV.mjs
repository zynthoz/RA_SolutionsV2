...
const SiV = React.forwardRef(function SiV2({ title = "V", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
