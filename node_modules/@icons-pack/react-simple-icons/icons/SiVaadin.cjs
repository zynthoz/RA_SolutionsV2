...
const SiVaadin = React__namespace.forwardRef(function SiVaadin2({ title = "Vaadin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
