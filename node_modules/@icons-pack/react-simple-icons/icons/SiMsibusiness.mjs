...
const SiMsibusiness = React.forwardRef(function SiMsibusiness2({ title = "MSI Business", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
