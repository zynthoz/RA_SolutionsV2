...
const defaultColor = "#E03C31";
const SiNasa = React__namespace.forwardRef(function SiNasa2({ title = "NASA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
