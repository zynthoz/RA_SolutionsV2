...
const defaultColor = "#D00013";
const SiCocacola = React.forwardRef(function SiCocacola2({ title = "Coca-Cola", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
