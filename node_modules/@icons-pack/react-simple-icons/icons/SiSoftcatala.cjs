...
const defaultColor = "#BA2626";
const SiSoftcatala = React__namespace.forwardRef(function SiSoftcatala2({ title = "Softcatalà", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
