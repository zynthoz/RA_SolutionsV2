...
const Si2fas = React.forwardRef(function Si2fas2({ title = "2FAS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
