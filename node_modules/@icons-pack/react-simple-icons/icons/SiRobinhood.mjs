...
const SiRobinhood = React.forwardRef(function SiRobinhood2({ title = "Robinhood", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
