...
const SiPlangrid = React.forwardRef(function SiPlangrid2({ title = "PlanGrid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
