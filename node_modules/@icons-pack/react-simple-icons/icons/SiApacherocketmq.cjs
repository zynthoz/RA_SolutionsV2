...
const defaultColor = "#D77310";
const SiApacherocketmq = React__namespace.forwardRef(function SiApacherocketmq2({ title = "Apache RocketMQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
