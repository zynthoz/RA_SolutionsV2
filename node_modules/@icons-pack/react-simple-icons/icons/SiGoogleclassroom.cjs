...
const defaultColor = "#0F9D58";
const SiGoogleclassroom = React__namespace.forwardRef(function SiGoogleclassroom2({ title = "Google Classroom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
