...
const defaultColor = "#621773";
const SiVictoriametrics = React__namespace.forwardRef(function SiVictoriametrics2({ title = "VictoriaMetrics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
