...
const defaultColor = "#FF3850";
const SiLinkfire = React__namespace.forwardRef(function SiLinkfire2({ title = "Linkfire", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
