...
const SiPrismic = React__namespace.forwardRef(function SiPrismic2({ title = "Prismic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
