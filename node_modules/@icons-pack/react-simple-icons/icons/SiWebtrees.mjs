...
const SiWebtrees = React.forwardRef(function SiWebtrees2({ title = "webtrees", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
