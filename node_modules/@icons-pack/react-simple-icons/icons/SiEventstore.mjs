...
const SiEventstore = React.forwardRef(function SiEventstore2({ title = "Event Store", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
