...
const SiBiolink = React__namespace.forwardRef(function SiBiolink2({ title = "Bio Link", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
