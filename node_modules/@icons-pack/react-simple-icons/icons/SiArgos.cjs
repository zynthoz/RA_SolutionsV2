...
const SiArgos = React__namespace.forwardRef(function SiArgos2({ title = "Argos", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
