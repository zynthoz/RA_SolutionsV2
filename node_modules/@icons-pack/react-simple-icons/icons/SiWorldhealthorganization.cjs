...
const SiWorldhealthorganization = React__namespace.forwardRef(function SiWorldhealthorganization2({ title = "World Health Organization", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
