...
const SiAkaunting = React.forwardRef(function SiAkaunting2({ title = "Akaunting", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
