...
const SiZdf = React__namespace.forwardRef(function SiZdf2({ title = "ZDF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
