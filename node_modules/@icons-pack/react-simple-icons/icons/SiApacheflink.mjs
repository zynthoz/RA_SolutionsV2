...
const SiApacheflink = React.forwardRef(function SiApacheflink2({ title = "Apache Flink", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
