...
const SiSemanticrelease = React.forwardRef(function SiSemanticrelease2({ title = "semantic-release", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
