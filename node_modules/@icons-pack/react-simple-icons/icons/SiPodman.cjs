...
const SiPodman = React__namespace.forwardRef(function SiPodman2({ title = "Podman", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
