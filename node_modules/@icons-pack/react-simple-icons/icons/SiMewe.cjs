...
const defaultColor = "#17377F";
const SiMewe = React__namespace.forwardRef(function SiMewe2({ title = "MeWe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
