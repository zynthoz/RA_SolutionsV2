...
const SiWhat3words = React.forwardRef(function SiWhat3words2({ title = "what3words", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
