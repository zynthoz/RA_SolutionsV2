...
const SiUpstash = React__namespace.forwardRef(function SiUpstash2({ title = "Upstash", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
