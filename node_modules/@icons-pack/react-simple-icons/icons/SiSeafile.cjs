...
const SiSeafile = React__namespace.forwardRef(function SiSeafile2({ title = "Seafile", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
