...
const SiThunderbird = React.forwardRef(function SiThunderbird2({ title = "Thunderbird", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
