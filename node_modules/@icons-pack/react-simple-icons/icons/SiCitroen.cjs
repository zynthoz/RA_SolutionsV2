...
const SiCitroen = React__namespace.forwardRef(function SiCitroen2({ title = "Citroën", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
