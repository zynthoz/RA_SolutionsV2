...
const defaultColor = "#1E93D9";
const SiBlockbench = React__namespace.forwardRef(function SiBlockbench2({ title = "Blockbench", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
