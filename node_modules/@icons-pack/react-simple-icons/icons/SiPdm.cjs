...
const defaultColor = "#AC75D7";
const SiPdm = React__namespace.forwardRef(function SiPdm2({ title = "PDM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
