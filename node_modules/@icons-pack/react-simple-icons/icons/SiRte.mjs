...
const SiRte = React.forwardRef(function SiRte2({ title = "RTÉ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
