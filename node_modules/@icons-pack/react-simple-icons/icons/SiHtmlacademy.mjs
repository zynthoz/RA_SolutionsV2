...
const SiHtmlacademy = React.forwardRef(function SiHtmlacademy2({ title = "HTML Academy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
