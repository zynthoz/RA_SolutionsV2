...
const SiUservoice = React.forwardRef(function SiUservoice2({ title = "UserVoice", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
