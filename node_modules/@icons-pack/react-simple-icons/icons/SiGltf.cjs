...
const defaultColor = "#87C540";
const SiGltf = React__namespace.forwardRef(function SiGltf2({ title = "glTF", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
