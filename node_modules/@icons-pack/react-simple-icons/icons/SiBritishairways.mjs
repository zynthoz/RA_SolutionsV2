...
const SiBritishairways = React.forwardRef(function SiBritishairways2({ title = "British Airways", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
