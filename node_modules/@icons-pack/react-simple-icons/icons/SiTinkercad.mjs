...
const SiTinkercad = React.forwardRef(function SiTinkercad2({ title = "Tinkercad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
