...
const SiMediamarkt = React.forwardRef(function SiMediamarkt2({ title = "MediaMarkt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
