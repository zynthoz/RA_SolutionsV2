...
const SiPrometheus = React__namespace.forwardRef(function SiPrometheus2({ title = "Prometheus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
