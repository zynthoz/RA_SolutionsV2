...
const defaultColor = "#3E8DCC";
const SiCoderwall = React__namespace.forwardRef(function SiCoderwall2({ title = "Coderwall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
