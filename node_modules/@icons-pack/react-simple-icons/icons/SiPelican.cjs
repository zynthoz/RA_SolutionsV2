...
const defaultColor = "#14A0C4";
const SiPelican = React__namespace.forwardRef(function SiPelican2({ title = "Pelican", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
