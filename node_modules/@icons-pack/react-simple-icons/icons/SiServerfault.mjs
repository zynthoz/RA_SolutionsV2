...
const SiServerfault = React.forwardRef(function SiServerfault2({ title = "Server Fault", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
