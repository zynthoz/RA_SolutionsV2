...
const SiArgo = React.forwardRef(function SiArgo2({ title = "Argo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
