...
const SiAirasia = React.forwardRef(function SiAirasia2({ title = "AirAsia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
