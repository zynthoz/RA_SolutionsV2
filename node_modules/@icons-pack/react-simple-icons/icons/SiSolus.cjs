...
const defaultColor = "#5294E2";
const SiSolus = React__namespace.forwardRef(function SiSolus2({ title = "Solus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
