...
const defaultColor = "#F98012";
const SiMoodle = React__namespace.forwardRef(function SiMoodle2({ title = "Moodle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
