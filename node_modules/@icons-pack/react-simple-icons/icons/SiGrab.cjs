...
const defaultColor = "#00B14F";
const SiGrab = React__namespace.forwardRef(function SiGrab2({ title = "Grab", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
