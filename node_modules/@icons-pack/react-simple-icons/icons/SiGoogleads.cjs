...
const SiGoogleads = React__namespace.forwardRef(function SiGoogleads2({ title = "Google Ads", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
