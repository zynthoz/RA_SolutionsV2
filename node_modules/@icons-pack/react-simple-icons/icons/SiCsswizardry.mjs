...
const SiCsswizardry = React.forwardRef(function SiCsswizardry2({ title = "CSS Wizardry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
