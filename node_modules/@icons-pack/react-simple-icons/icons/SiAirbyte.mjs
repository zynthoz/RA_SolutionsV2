...
const SiAirbyte = React.forwardRef(function SiAirbyte2({ title = "Airbyte", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
