...
const SiAudiomack = React.forwardRef(function SiAudiomack2({ title = "Audiomack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
