...
const SiCrowdin = React.forwardRef(function SiCrowdin2({ title = "Crowdin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
