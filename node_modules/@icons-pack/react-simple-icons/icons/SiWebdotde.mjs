...
const SiWebdotde = React.forwardRef(function SiWebdotde2({ title = "WEB.DE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
