...
const SiLootcrate = React.forwardRef(function SiLootcrate2({ title = "Loot Crate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
