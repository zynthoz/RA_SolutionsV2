...
const SiSimkl = React.forwardRef(function SiSimkl2({ title = "Simkl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
