...
const SiChef = React.forwardRef(function SiChef2({ title = "Chef", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
