...
const Si3m = React.forwardRef(function Si3m2({ title = "3M", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
