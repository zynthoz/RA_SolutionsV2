...
const SiFidoalliance = React.forwardRef(function SiFidoalliance2({ title = "Fido Alliance", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
