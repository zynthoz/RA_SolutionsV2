...
const defaultColor = "#13C100";
const SiOctoprint = React__namespace.forwardRef(function SiOctoprint2({ title = "OctoPrint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
