...
const defaultColor = "#B5B5B6";
const SiSynology = React__namespace.forwardRef(function SiSynology2({ title = "Synology", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
