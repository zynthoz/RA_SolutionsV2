...
const defaultColor = "#004088";
const Si4d = React__namespace.forwardRef(function Si4d2({ title = "4D", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
