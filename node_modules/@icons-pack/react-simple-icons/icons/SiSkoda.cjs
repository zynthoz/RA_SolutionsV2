...
const defaultColor = "#0E3A2F";
const SiSkoda = React__namespace.forwardRef(function SiSkoda2({ title = "ŠKODA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
