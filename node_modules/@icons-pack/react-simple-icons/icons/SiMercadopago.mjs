...
const SiMercadopago = React.forwardRef(function SiMercadopago2({ title = "Mercado Pago", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
