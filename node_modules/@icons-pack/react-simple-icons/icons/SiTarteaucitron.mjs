...
const SiTarteaucitron = React.forwardRef(function SiTarteaucitron2({ title = "Tarteaucitron", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
