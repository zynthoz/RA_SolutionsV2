...
const SiNewgrounds = React__namespace.forwardRef(function SiNewgrounds2({ title = "Newgrounds", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
