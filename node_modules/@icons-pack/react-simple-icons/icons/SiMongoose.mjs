...
const SiMongoose = React.forwardRef(function SiMongoose2({ title = "Mongoose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
