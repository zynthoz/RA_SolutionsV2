...
const SiSurfshark = React__namespace.forwardRef(function SiSurfshark2({ title = "Surfshark", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
