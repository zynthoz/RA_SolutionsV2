...
const SiMatternet = React__namespace.forwardRef(function SiMatternet2({ title = "Matternet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
