...
const defaultColor = "#262729";
const SiEightsleep = React.forwardRef(function SiEightsleep2({ title = "Eight Sleep", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
