...
const defaultColor = "#0A0B09";
const SiTrulia = React__namespace.forwardRef(function SiTrulia2({ title = "trulia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
