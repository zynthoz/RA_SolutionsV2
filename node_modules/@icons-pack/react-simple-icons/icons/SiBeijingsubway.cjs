...
const defaultColor = "#004A9D";
const SiBeijingsubway = React__namespace.forwardRef(function SiBeijingsubway2({ title = "Beijing Subway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
