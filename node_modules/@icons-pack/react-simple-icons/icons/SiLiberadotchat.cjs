...
const SiLiberadotchat = React__namespace.forwardRef(function SiLiberadotchat2({ title = "Libera.Chat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
