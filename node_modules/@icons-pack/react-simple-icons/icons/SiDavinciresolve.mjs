...
const SiDavinciresolve = React.forwardRef(function SiDavinciresolve2({ title = "DaVinci Resolve", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
