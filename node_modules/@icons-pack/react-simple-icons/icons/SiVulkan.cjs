...
const SiVulkan = React__namespace.forwardRef(function SiVulkan2({ title = "Vulkan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
