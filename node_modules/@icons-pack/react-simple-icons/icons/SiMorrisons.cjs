...
const SiMorrisons = React__namespace.forwardRef(function SiMorrisons2({ title = "Morrisons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
