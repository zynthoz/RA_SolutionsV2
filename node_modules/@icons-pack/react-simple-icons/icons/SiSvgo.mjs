...
const SiSvgo = React.forwardRef(function SiSvgo2({ title = "SVGO", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
