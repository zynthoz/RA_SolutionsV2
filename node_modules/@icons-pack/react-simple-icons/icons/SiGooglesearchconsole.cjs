...
const SiGooglesearchconsole = React__namespace.forwardRef(function SiGooglesearchconsole2({ title = "Google Search Console", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
