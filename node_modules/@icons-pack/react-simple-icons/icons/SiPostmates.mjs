...
const SiPostmates = React.forwardRef(function SiPostmates2({ title = "Postmates", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
