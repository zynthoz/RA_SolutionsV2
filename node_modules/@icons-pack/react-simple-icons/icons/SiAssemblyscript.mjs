...
const SiAssemblyscript = React.forwardRef(function SiAssemblyscript2({ title = "AssemblyScript", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
