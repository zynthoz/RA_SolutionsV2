...
const SiQualys = React__namespace.forwardRef(function SiQualys2({ title = "Qualys", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
