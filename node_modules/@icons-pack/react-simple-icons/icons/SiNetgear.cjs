...
const SiNetgear = React__namespace.forwardRef(function SiNetgear2({ title = "NETGEAR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
