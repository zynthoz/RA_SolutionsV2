...
const SiReacttable = React__namespace.forwardRef(function SiReacttable2({ title = "React Table", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
