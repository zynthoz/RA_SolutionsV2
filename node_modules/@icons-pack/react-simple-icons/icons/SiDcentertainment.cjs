...
const SiDcentertainment = React__namespace.forwardRef(function SiDcentertainment2({ title = "DC Entertainment", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
