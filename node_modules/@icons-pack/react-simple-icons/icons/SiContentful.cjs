...
const defaultColor = "#2478CC";
const SiContentful = React__namespace.forwardRef(function SiContentful2({ title = "Contentful", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
