...
const SiPhilipshue = React.forwardRef(function SiPhilipshue2({ title = "Philips Hue", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
