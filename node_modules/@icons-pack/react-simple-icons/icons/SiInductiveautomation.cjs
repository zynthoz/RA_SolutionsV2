...
const SiInductiveautomation = React__namespace.forwardRef(function SiInductiveautomation2({ title = "Inductive Automation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
