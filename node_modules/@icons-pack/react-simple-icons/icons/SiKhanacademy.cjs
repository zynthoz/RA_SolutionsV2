...
const defaultColor = "#14BF96";
const SiKhanacademy = React__namespace.forwardRef(function SiKhanacademy2({ title = "Khan Academy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
