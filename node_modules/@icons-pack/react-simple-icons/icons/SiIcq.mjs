...
const SiIcq = React.forwardRef(function SiIcq2({ title = "ICQ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
