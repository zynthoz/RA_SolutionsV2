...
const defaultColor = "#C83D1E";
const SiFubo = React__namespace.forwardRef(function SiFubo2({ title = "Fubo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
