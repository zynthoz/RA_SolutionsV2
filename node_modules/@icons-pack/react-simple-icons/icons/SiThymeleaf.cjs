...
const SiThymeleaf = React__namespace.forwardRef(function SiThymeleaf2({ title = "Thymeleaf", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
