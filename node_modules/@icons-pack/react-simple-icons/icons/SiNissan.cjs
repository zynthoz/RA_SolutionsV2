...
const defaultColor = "#C3002F";
const SiNissan = React__namespace.forwardRef(function SiNissan2({ title = "Nissan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
