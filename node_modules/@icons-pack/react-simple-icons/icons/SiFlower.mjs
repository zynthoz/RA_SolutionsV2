...
const SiFlower = React.forwardRef(function SiFlower2({ title = "Flower", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
