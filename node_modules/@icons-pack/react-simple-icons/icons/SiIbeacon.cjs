...
const SiIbeacon = React__namespace.forwardRef(function SiIbeacon2({ title = "iBeacon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
