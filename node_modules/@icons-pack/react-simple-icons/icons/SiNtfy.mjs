...
const SiNtfy = React.forwardRef(function SiNtfy2({ title = "ntfy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
