...
const SiSpoj = React.forwardRef(function SiSpoj2({ title = "Sphere Online Judge", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
