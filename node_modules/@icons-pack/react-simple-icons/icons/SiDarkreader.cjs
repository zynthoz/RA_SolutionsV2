...
const defaultColor = "#141E24";
const SiDarkreader = React__namespace.forwardRef(function SiDarkreader2({ title = "Dark Reader", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
