...
const defaultColor = "#0C9ED5";
const SiCloudfoundry = React__namespace.forwardRef(function SiCloudfoundry2({ title = "Cloud Foundry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
