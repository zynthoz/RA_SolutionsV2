...
const SiSeatgeek = React__namespace.forwardRef(function SiSeatgeek2({ title = "SeatGeek", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
