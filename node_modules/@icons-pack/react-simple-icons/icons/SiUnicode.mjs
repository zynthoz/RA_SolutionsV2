...
const SiUnicode = React.forwardRef(function SiUnicode2({ title = "Unicode", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
