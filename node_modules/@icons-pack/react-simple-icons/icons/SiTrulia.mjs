...
const SiTrulia = React.forwardRef(function SiTrulia2({ title = "trulia", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
