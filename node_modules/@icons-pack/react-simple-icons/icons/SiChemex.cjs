...
const SiChemex = React__namespace.forwardRef(function SiChemex2({ title = "Chemex", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
