...
const SiPaperspace = React__namespace.forwardRef(function SiPaperspace2({ title = "Paperspace", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
