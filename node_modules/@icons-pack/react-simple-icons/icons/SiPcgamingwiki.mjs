...
const SiPcgamingwiki = React.forwardRef(function SiPcgamingwiki2({ title = "PCGamingWiki", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
