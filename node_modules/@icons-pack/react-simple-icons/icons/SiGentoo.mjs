...
const SiGentoo = React.forwardRef(function SiGentoo2({ title = "Gentoo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
