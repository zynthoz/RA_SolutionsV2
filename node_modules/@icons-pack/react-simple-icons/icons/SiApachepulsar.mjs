...
const SiApachepulsar = React.forwardRef(function SiApachepulsar2({ title = "Apache Pulsar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
