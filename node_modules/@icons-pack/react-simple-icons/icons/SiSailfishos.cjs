...
const defaultColor = "#053766";
const SiSailfishos = React__namespace.forwardRef(function SiSailfishos2({ title = "Sailfish OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
