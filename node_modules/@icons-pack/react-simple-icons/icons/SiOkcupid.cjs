...
const SiOkcupid = React__namespace.forwardRef(function SiOkcupid2({ title = "okcupid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
