...
const SiKodak = React.forwardRef(function SiKodak2({ title = "Kodak", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
