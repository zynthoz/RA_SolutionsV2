...
const SiTapas = React.forwardRef(function SiTapas2({ title = "Tapas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
