...
const SiTreehouse = React.forwardRef(function SiTreehouse2({ title = "Treehouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
