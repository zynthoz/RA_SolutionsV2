...
const defaultColor = "#D4AA00";
const SiCookiecutter = React__namespace.forwardRef(function SiCookiecutter2({ title = "Cookiecutter", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
