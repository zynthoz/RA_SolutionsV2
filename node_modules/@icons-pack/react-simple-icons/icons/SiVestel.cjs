...
const SiVestel = React__namespace.forwardRef(function SiVestel2({ title = "Vestel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
