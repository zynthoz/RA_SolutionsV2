...
const SiNdr = React__namespace.forwardRef(function SiNdr2({ title = "NDR", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
