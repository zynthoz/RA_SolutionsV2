...
const defaultColor = "#1B1C30";
const SiSonatype = React__namespace.forwardRef(function SiSonatype2({ title = "Sonatype", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
