...
const defaultColor = "#2D8C3C";
const SiAmeba = React__namespace.forwardRef(function SiAmeba2({ title = "Ameba", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
