...
const defaultColor = "#F39914";
const SiCairographics = React.forwardRef(function SiCairographics2({ title = "Cairo Graphics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
