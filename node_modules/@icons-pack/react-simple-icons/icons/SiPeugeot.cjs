...
const SiPeugeot = React__namespace.forwardRef(function SiPeugeot2({ title = "Peugeot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
