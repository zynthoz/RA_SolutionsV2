...
const SiPiaggiogroup = React__namespace.forwardRef(function SiPiaggiogroup2({ title = "Piaggio Group", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
