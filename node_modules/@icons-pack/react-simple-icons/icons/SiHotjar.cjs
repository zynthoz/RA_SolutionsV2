...
const SiHotjar = React__namespace.forwardRef(function SiHotjar2({ title = "Hotjar", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
