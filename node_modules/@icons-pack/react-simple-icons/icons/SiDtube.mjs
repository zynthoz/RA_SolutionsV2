...
const SiDtube = React.forwardRef(function SiDtube2({ title = "DTube", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
