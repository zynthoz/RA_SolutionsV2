...
const defaultColor = "#150400";
const SiUps = React__namespace.forwardRef(function SiUps2({ title = "UPS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
