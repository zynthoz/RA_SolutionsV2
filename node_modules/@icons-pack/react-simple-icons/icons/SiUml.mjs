...
const defaultColor = "#FABD14";
const SiUml = React.forwardRef(function SiUml2({ title = "UML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
