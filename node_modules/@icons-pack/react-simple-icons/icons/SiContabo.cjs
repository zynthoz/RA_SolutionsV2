...
const defaultColor = "#00AAEB";
const SiContabo = React__namespace.forwardRef(function SiContabo2({ title = "Contabo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
