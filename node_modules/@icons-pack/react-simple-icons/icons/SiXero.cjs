...
const defaultColor = "#13B5EA";
const SiXero = React__namespace.forwardRef(function SiXero2({ title = "Xero", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
