...
const SiXml = React__namespace.forwardRef(function SiXml2({ title = "XML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
