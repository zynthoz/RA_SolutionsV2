...
const SiPlaystation3 = React.forwardRef(function SiPlaystation32({ title = "PlayStation 3", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
