...
const SiMg = React__namespace.forwardRef(function SiMg2({ title = "MG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
