...
const SiGradle = React.forwardRef(function SiGradle2({ title = "Gradle", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
