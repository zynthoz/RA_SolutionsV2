...
const Si500px = React.forwardRef(function Si500px2({ title = "500px", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
