...
const SiJcb = React.forwardRef(function SiJcb2({ title = "JCB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
