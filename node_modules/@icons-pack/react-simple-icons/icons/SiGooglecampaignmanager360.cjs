...
const defaultColor = "#1E8E3E";
const SiGooglecampaignmanager360 = React__namespace.forwardRef(function SiGooglecampaignmanager3602({ title = "Google Campaign Manager 360", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
