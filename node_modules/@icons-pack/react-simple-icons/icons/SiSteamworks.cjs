...
const SiSteamworks = React__namespace.forwardRef(function SiSteamworks2({ title = "Steamworks", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
