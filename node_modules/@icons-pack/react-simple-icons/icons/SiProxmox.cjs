...
const defaultColor = "#E57000";
const SiProxmox = React__namespace.forwardRef(function SiProxmox2({ title = "Proxmox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
