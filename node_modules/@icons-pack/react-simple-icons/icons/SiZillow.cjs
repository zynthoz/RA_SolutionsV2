...
const SiZillow = React__namespace.forwardRef(function SiZillow2({ title = "Zillow", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
