...
const SiNuke = React.forwardRef(function SiNuke2({ title = "Nuke", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
