...
const SiTindie = React__namespace.forwardRef(function SiTindie2({ title = "Tindie", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
