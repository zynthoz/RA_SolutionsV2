...
const SiDm = React.forwardRef(function SiDm2({ title = "dm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
