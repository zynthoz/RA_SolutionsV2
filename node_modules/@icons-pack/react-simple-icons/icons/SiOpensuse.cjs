...
const SiOpensuse = React__namespace.forwardRef(function SiOpensuse2({ title = "openSUSE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
