...
const SiInterbase = React.forwardRef(function SiInterbase2({ title = "Interbase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
