...
const defaultColor = "#20336B";
const SiPaytm = React__namespace.forwardRef(function SiPaytm2({ title = "Paytm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
