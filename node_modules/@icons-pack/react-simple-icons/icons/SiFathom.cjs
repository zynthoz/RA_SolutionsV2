...
const defaultColor = "#9187FF";
const SiFathom = React__namespace.forwardRef(function SiFathom2({ title = "Fathom", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
