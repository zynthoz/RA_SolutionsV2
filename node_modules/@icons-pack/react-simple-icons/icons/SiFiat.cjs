...
const defaultColor = "#941711";
const SiFiat = React__namespace.forwardRef(function SiFiat2({ title = "Fiat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
