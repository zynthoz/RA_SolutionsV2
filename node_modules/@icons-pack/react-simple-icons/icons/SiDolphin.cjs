...
const SiDolphin = React__namespace.forwardRef(function SiDolphin2({ title = "Dolphin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
