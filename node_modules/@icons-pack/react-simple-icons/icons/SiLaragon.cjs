...
const SiLaragon = React__namespace.forwardRef(function SiLaragon2({ title = "Laragon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
