...
const SiShenzhenmetro = React.forwardRef(function SiShenzhenmetro2({ title = "Shenzhen Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
