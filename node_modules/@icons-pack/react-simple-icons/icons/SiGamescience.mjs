...
const SiGamescience = React.forwardRef(function SiGamescience2({ title = "Game Science", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
