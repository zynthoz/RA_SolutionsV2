...
const SiQi = React.forwardRef(function SiQi2({ title = "Qi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
