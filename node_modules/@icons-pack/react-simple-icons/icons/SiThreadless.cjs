...
const SiThreadless = React__namespace.forwardRef(function SiThreadless2({ title = "Threadless", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
