...
const SiLerna = React.forwardRef(function SiLerna2({ title = "Lerna", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
