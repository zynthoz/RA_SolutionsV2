...
const defaultColor = "#212C42";
const SiTryhackme = React.forwardRef(function SiTryhackme2({ title = "TryHackMe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
