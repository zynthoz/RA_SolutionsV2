...
const defaultColor = "#01B0F0";
const SiNsis = React__namespace.forwardRef(function SiNsis2({ title = "NSIS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
