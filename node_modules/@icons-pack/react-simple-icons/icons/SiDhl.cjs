...
const SiDhl = React__namespace.forwardRef(function SiDhl2({ title = "DHL", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
