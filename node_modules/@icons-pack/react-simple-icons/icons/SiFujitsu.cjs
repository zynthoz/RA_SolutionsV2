...
const SiFujitsu = React__namespace.forwardRef(function SiFujitsu2({ title = "Fujitsu", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
