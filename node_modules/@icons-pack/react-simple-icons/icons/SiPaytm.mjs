...
const SiPaytm = React.forwardRef(function SiPaytm2({ title = "Paytm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
