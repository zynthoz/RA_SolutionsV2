...
const defaultColor = "#A86454";
const SiPug = React__namespace.forwardRef(function SiPug2({ title = "Pug", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
