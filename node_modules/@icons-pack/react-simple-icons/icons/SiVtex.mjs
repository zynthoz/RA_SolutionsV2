...
const SiVtex = React.forwardRef(function SiVtex2({ title = "VTEX", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
