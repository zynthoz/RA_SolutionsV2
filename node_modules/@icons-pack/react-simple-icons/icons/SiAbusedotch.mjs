...
const SiAbusedotch = React.forwardRef(function SiAbusedotch2({ title = "abuse.ch", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
