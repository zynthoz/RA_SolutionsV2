...
const SiTemporal = React.forwardRef(function SiTemporal2({ title = "Temporal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
