...
const SiSurveymonkey = React__namespace.forwardRef(function SiSurveymonkey2({ title = "SurveyMonkey", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
