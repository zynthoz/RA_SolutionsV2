...
const SiZola = React.forwardRef(function SiZola2({ title = "Zola", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
