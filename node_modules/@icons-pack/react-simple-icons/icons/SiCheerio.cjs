...
const defaultColor = "#E88C1F";
const SiCheerio = React__namespace.forwardRef(function SiCheerio2({ title = "Cheerio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
