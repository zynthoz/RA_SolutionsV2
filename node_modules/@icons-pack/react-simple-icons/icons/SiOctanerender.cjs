...
const SiOctanerender = React__namespace.forwardRef(function SiOctanerender2({ title = "Octane Render", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
