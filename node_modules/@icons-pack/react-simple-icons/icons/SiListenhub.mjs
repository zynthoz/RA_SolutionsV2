...
const SiListenhub = React.forwardRef(function SiListenhub2({ title = "ListenHub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
