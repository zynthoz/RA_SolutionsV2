...
const SiAudible = React.forwardRef(function SiAudible2({ title = "Audible", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
