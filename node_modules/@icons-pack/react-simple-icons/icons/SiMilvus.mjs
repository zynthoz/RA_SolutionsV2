...
const SiMilvus = React.forwardRef(function SiMilvus2({ title = "Milvus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
