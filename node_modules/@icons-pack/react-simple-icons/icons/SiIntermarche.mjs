...
const SiIntermarche = React.forwardRef(function SiIntermarche2({ title = "Intermarche", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
