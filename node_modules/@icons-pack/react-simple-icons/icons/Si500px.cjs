...
const Si500px = React__namespace.forwardRef(function Si500px2({ title = "500px", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
