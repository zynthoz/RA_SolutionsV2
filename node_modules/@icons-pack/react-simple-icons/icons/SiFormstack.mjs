...
const SiFormstack = React.forwardRef(function SiFormstack2({ title = "Formstack", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
