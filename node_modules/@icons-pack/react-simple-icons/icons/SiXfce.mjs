...
const defaultColor = "#2284F2";
const SiXfce = React.forwardRef(function SiXfce2({ title = "XFCE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
