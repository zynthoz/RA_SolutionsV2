...
const SiGimp = React.forwardRef(function SiGimp2({ title = "GIMP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
