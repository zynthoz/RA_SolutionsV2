...
const defaultColor = "#D6180B";
const SiAuchan = React__namespace.forwardRef(function SiAuchan2({ title = "Auchan", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
