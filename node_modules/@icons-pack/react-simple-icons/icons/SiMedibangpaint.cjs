...
const defaultColor = "#00DBDE";
const SiMedibangpaint = React__namespace.forwardRef(function SiMedibangpaint2({ title = "MediBang Paint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
