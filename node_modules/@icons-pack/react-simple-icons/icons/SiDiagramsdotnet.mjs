...
const SiDiagramsdotnet = React.forwardRef(function SiDiagramsdotnet2({ title = "diagrams.net", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
