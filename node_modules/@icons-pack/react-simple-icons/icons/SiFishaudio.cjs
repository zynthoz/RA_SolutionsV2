...
const SiFishaudio = React__namespace.forwardRef(function SiFishaudio2({ title = "Fish Audio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
