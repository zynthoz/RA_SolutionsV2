...
const SiHarbor = React.forwardRef(function SiHarbor2({ title = "Harbor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
