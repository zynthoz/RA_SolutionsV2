...
const defaultColor = "#E05E00";
const SiNewegg = React__namespace.forwardRef(function SiNewegg2({ title = "Newegg", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
