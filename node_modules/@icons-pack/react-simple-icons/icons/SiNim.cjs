...
const SiNim = React__namespace.forwardRef(function SiNim2({ title = "Nim", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
