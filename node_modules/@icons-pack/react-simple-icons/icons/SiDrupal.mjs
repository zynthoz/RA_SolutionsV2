...
const SiDrupal = React.forwardRef(function SiDrupal2({ title = "Drupal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
