...
const SiInvoiceninja = React__namespace.forwardRef(function SiInvoiceninja2({ title = "Invoice Ninja", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
