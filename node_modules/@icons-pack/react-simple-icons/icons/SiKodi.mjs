...
const SiKodi = React.forwardRef(function SiKodi2({ title = "Kodi", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
