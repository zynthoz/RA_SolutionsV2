...
const SiLucide = React__namespace.forwardRef(function SiLucide2({ title = "Lucide", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
