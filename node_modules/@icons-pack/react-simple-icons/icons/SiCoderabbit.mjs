...
const SiCoderabbit = React.forwardRef(function SiCoderabbit2({ title = "CodeRabbit", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
