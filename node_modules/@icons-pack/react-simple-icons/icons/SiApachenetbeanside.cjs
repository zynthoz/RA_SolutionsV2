...
const defaultColor = "#1B6AC6";
const SiApachenetbeanside = React__namespace.forwardRef(function SiApachenetbeanside2({ title = "Apache NetBeans IDE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
