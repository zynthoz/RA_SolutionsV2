...
const SiBose = React__namespace.forwardRef(function SiBose2({ title = "Bose", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
