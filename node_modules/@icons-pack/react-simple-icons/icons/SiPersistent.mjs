...
const SiPersistent = React.forwardRef(function SiPersistent2({ title = "Persistent", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
