...
const SiEnterprisedb = React.forwardRef(function SiEnterprisedb2({ title = "EnterpriseDB", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
