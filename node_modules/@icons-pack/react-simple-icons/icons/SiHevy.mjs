...
const SiHevy = React.forwardRef(function SiHevy2({ title = "Hevy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
