...
const SiOpenjsfoundation = React.forwardRef(function SiOpenjsfoundation2({ title = "OpenJS Foundation", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
