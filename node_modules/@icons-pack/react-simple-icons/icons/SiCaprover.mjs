...
const SiCaprover = React.forwardRef(function SiCaprover2({ title = "CapRover", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
