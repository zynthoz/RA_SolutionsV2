...
const SiBoost = React.forwardRef(function SiBoost2({ title = "Boost", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
