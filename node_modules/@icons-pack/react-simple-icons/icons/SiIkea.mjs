...
const defaultColor = "#0058A3";
const SiIkea = React.forwardRef(function SiIkea2({ title = "IKEA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
