...
const SiNextcloud = React.forwardRef(function SiNextcloud2({ title = "Nextcloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
