...
const defaultColor = "#9E66BF";
const SiPercy = React.forwardRef(function SiPercy2({ title = "Percy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
