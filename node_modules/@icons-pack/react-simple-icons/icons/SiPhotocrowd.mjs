...
const SiPhotocrowd = React.forwardRef(function SiPhotocrowd2({ title = "Photocrowd", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
