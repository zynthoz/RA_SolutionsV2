...
const SiSailfishos = React.forwardRef(function SiSailfishos2({ title = "Sailfish OS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
