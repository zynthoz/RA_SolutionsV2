...
const SiLefthook = React.forwardRef(function SiLefthook2({ title = "Lefthook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
