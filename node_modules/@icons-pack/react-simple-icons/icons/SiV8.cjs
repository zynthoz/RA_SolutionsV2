...
const SiV8 = React__namespace.forwardRef(function SiV82({ title = "V8", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
