...
const SiQmk = React__namespace.forwardRef(function SiQmk2({ title = "QMK", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
