...
const SiAirtel = React.forwardRef(function SiAirtel2({ title = "Airtel", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
