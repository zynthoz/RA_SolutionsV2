...
const defaultColor = "#FF1E1E";
const SiLefthook = React__namespace.forwardRef(function SiLefthook2({ title = "Lefthook", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
