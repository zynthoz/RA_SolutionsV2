...
const SiNextbilliondotai = React.forwardRef(function SiNextbilliondotai2({ title = "NextBillion.ai", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
