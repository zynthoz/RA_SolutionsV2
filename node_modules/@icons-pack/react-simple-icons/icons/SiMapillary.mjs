...
const SiMapillary = React.forwardRef(function SiMapillary2({ title = "Mapillary", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
