...
const SiConvex = React.forwardRef(function SiConvex2({ title = "Convex", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
