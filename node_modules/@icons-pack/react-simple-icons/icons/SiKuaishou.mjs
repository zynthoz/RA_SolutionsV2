...
const SiKuaishou = React.forwardRef(function SiKuaishou2({ title = "Kuaishou", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
