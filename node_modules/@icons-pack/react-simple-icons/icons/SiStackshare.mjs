...
const SiStackshare = React.forwardRef(function SiStackshare2({ title = "StackShare", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
