...
const SiApachepdfbox = React.forwardRef(function SiApachepdfbox2({ title = "Apache PDFBox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
