...
const SiWalletconnect = React__namespace.forwardRef(function SiWalletconnect2({ title = "WalletConnect", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
