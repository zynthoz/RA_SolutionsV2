...
const SiBudibase = React.forwardRef(function SiBudibase2({ title = "Budibase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
