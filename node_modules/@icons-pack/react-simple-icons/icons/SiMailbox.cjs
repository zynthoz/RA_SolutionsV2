...
const SiMailbox = React__namespace.forwardRef(function SiMailbox2({ title = "mailbox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
