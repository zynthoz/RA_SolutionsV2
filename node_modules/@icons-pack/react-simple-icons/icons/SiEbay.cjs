...
const defaultColor = "#E53238";
const SiEbay = React__namespace.forwardRef(function SiEbay2({ title = "eBay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
