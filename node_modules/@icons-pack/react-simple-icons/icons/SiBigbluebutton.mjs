...
const SiBigbluebutton = React.forwardRef(function SiBigbluebutton2({ title = "BigBlueButton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
