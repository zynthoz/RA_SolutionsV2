...
const defaultColor = "#24A47F";
const SiGreenhouse = React__namespace.forwardRef(function SiGreenhouse2({ title = "Greenhouse", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
