...
const defaultColor = "#F07355";
const SiViadeo = React__namespace.forwardRef(function SiViadeo2({ title = "Viadeo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
