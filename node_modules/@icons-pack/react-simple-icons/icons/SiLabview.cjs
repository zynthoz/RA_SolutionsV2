...
const defaultColor = "#FFDB00";
const SiLabview = React__namespace.forwardRef(function SiLabview2({ title = "LabVIEW", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
