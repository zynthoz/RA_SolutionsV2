...
const defaultColor = "#00A7B3";
const SiRte = React__namespace.forwardRef(function SiRte2({ title = "RTÉ", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
