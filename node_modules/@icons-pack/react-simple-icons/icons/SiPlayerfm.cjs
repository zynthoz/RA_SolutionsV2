...
const SiPlayerfm = React__namespace.forwardRef(function SiPlayerfm2({ title = "Player FM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
