...
const defaultColor = "#2D3232";
const SiFrontify = React.forwardRef(function SiFrontify2({ title = "Frontify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
