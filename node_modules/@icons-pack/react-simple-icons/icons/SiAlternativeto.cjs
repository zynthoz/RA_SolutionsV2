...
const defaultColor = "#0289D5";
const SiAlternativeto = React__namespace.forwardRef(function SiAlternativeto2({ title = "AlternativeTo", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
