...
const SiLidl = React.forwardRef(function SiLidl2({ title = "Lidl", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
