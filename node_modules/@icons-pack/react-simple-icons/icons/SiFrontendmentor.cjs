...
const SiFrontendmentor = React__namespace.forwardRef(function SiFrontendmentor2({ title = "Frontend Mentor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
