...
const SiAparat = React__namespace.forwardRef(function SiAparat2({ title = "Aparat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
