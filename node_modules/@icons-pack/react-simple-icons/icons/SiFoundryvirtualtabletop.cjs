...
const defaultColor = "#FE6A1F";
const SiFoundryvirtualtabletop = React__namespace.forwardRef(function SiFoundryvirtualtabletop2({ title = "Foundry Virtual Tabletop", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
