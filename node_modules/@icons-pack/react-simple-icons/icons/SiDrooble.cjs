...
const SiDrooble = React__namespace.forwardRef(function SiDrooble2({ title = "Drooble", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
