...
const defaultColor = "#00DDB3";
const SiLottiefiles = React.forwardRef(function SiLottiefiles2({ title = "LottieFiles", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
