...
const SiPhpstorm = React__namespace.forwardRef(function SiPhpstorm2({ title = "PhpStorm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
