...
const defaultColor = "#0E353D";
const SiDashlane = React__namespace.forwardRef(function SiDashlane2({ title = "Dashlane", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
