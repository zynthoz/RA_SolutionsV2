...
const SiFerrarinv = React.forwardRef(function SiFerrarinv2({ title = "Ferrari N.V.", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
