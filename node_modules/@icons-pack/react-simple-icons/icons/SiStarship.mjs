...
const SiStarship = React.forwardRef(function SiStarship2({ title = "Starship", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
