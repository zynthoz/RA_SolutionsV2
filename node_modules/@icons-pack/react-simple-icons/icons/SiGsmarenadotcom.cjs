...
const defaultColor = "#D50000";
const SiGsmarenadotcom = React__namespace.forwardRef(function SiGsmarenadotcom2({ title = "GSMArena.com", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
