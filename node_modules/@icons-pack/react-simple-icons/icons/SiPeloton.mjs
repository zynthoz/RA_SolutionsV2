...
const SiPeloton = React.forwardRef(function SiPeloton2({ title = "Peloton", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
