...
const SiSemanticrelease = React__namespace.forwardRef(function SiSemanticrelease2({ title = "semantic-release", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
