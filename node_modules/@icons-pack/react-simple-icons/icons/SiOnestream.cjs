...
const SiOnestream = React__namespace.forwardRef(function SiOnestream2({ title = "OneStream", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
