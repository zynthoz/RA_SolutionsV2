...
const defaultColor = "#025E8C";
const SiDependabot = React__namespace.forwardRef(function SiDependabot2({ title = "Dependabot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
