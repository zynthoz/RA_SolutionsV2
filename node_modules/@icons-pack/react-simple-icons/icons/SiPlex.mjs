...
const defaultColor = "#EBAF00";
const SiPlex = React.forwardRef(function SiPlex2({ title = "Plex", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
