...
const SiKdeneon = React.forwardRef(function SiKdeneon2({ title = "KDE neon", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
