...
const SiPackt = React.forwardRef(function SiPackt2({ title = "Packt", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
