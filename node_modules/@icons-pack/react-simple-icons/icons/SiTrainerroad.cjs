...
const defaultColor = "#DA291C";
const SiTrainerroad = React__namespace.forwardRef(function SiTrainerroad2({ title = "TrainerRoad", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
