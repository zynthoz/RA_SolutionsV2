...
const SiKeploy = React__namespace.forwardRef(function SiKeploy2({ title = "Keploy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
