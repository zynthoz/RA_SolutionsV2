...
const SiMetabase = React__namespace.forwardRef(function SiMetabase2({ title = "Metabase", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
