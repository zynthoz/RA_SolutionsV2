...
const SiKhronosgroup = React__namespace.forwardRef(function SiKhronosgroup2({ title = "Khronos Group", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
