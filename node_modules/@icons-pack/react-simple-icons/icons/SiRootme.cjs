...
const SiRootme = React__namespace.forwardRef(function SiRootme2({ title = "Root Me", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
