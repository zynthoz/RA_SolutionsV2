...
const defaultColor = "#DB0A40";
const SiRedbull = React__namespace.forwardRef(function SiRedbull2({ title = "Red Bull", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
