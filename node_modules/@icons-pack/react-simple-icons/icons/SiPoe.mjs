...
const SiPoe = React.forwardRef(function SiPoe2({ title = "Poe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
