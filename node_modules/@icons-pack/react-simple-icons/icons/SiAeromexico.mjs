...
const SiAeromexico = React.forwardRef(function SiAeromexico2({ title = "Aeroméxico", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
