...
const SiMaze = React.forwardRef(function SiMaze2({ title = "Maze", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
