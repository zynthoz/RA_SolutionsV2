...
const SiPubg = React__namespace.forwardRef(function SiPubg2({ title = "PUBG", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
