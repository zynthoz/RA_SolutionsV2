...
const SiApachetomcat = React.forwardRef(function SiApachetomcat2({ title = "Apache Tomcat", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
