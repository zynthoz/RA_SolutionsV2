...
const SiNushell = React__namespace.forwardRef(function SiNushell2({ title = "Nushell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
