...
const SiMakerbot = React__namespace.forwardRef(function SiMakerbot2({ title = "MakerBot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
