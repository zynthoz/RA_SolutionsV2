...
const defaultColor = "#D30001";
const SiRubyonrails = React__namespace.forwardRef(function SiRubyonrails2({ title = "Ruby on Rails", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
