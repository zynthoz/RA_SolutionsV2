...
const SiSolid = React.forwardRef(function SiSolid2({ title = "Solid", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
