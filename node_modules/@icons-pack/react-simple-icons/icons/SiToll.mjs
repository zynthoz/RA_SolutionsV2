...
const SiToll = React.forwardRef(function SiToll2({ title = "Toll", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
