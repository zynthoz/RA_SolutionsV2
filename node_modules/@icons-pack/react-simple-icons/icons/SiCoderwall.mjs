...
const SiCoderwall = React.forwardRef(function SiCoderwall2({ title = "Coderwall", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
