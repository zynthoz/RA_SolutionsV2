...
const SiArcgis = React.forwardRef(function SiArcgis2({ title = "ArcGIS", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
