...
const defaultColor = "#4F0599";
const SiScaleway = React.forwardRef(function SiScaleway2({ title = "Scaleway", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
