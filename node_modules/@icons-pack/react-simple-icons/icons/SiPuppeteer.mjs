...
const defaultColor = "#40B5A4";
const SiPuppeteer = React.forwardRef(function SiPuppeteer2({ title = "Puppeteer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
