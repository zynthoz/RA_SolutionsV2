...
const Si7zip = React__namespace.forwardRef(function Si7zip2({ title = "7Zip", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
