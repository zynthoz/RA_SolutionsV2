...
const SiFloorp = React.forwardRef(function SiFloorp2({ title = "Floorp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
