...
const SiGroupme = React__namespace.forwardRef(function SiGroupme2({ title = "GroupMe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
