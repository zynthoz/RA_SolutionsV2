...
const SiComptia = React.forwardRef(function SiComptia2({ title = "CompTIA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
