...
const SiSlackware = React__namespace.forwardRef(function SiSlackware2({ title = "Slackware", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
