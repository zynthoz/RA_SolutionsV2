...
const defaultColor = "#E6830F";
const SiOshkosh = React__namespace.forwardRef(function SiOshkosh2({ title = "Oshkosh", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
