...
const SiThings = React.forwardRef(function SiThings2({ title = "Things", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
