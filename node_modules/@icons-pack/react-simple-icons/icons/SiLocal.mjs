...
const SiLocal = React.forwardRef(function SiLocal2({ title = "Local", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
