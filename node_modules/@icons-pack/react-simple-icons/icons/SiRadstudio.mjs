...
const SiRadstudio = React.forwardRef(function SiRadstudio2({ title = "RAD Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
