...
const SiEyeem = React.forwardRef(function SiEyeem2({ title = "EyeEm", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
