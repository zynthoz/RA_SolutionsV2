...
const SiDior = React__namespace.forwardRef(function SiDior2({ title = "Dior", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
