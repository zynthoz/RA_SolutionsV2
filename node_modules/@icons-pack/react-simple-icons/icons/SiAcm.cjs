...
const defaultColor = "#0085CA";
const SiAcm = React__namespace.forwardRef(function SiAcm2({ title = "ACM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
