...
const SiRekaui = React__namespace.forwardRef(function SiRekaui2({ title = "Reka UI", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
