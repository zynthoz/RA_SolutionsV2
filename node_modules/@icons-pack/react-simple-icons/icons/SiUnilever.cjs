...
const defaultColor = "#1F36C7";
const SiUnilever = React__namespace.forwardRef(function SiUnilever2({ title = "Unilever", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
