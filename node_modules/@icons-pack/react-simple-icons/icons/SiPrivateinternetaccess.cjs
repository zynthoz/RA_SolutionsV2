...
const defaultColor = "#1E811F";
const SiPrivateinternetaccess = React__namespace.forwardRef(function SiPrivateinternetaccess2({ title = "Private Internet Access", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
