...
const SiAtari = React.forwardRef(function SiAtari2({ title = "Atari", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
