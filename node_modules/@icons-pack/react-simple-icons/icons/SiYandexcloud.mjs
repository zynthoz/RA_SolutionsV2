...
const defaultColor = "#5282FF";
const SiYandexcloud = React.forwardRef(function SiYandexcloud2({ title = "Yandex Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
