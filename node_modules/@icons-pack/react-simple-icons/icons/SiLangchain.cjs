...
const SiLangchain = React__namespace.forwardRef(function SiLangchain2({ title = "LangChain", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
