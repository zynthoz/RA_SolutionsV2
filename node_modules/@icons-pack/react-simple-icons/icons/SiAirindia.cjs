...
const defaultColor = "#DA0E29";
const SiAirindia = React__namespace.forwardRef(function SiAirindia2({ title = "Air India", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
