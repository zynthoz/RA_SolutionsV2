...
const defaultColor = "#013C74";
const SiSubaru = React__namespace.forwardRef(function SiSubaru2({ title = "Subaru", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
