...
const SiSmrt = React__namespace.forwardRef(function SiSmrt2({ title = "SMRT", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
