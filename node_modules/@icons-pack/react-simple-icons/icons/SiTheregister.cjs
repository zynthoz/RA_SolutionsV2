...
const SiTheregister = React__namespace.forwardRef(function SiTheregister2({ title = "The Register", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
