...
const SiP5dotjs = React.forwardRef(function SiP5dotjs2({ title = "p5.js", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
