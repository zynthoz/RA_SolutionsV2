...
const defaultColor = "#FFCE00";
const SiTapas = React__namespace.forwardRef(function SiTapas2({ title = "Tapas", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
