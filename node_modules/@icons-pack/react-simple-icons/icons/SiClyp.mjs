...
const SiClyp = React.forwardRef(function SiClyp2({ title = "Clyp", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
