...
const SiMicroeditor = React.forwardRef(function SiMicroeditor2({ title = "Micro Editor", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
