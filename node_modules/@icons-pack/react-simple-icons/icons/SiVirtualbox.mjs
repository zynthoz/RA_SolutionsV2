...
const SiVirtualbox = React.forwardRef(function SiVirtualbox2({ title = "VirtualBox", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
