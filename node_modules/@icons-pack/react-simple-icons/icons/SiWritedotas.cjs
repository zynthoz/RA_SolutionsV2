...
const SiWritedotas = React__namespace.forwardRef(function SiWritedotas2({ title = "Write.as", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
