...
const SiApache = React.forwardRef(function SiApache2({ title = "Apache", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
