...
const SiCodersrank = React.forwardRef(function SiCodersrank2({ title = "CodersRank", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
