...
const SiGofundme = React.forwardRef(function SiGofundme2({ title = "GoFundMe", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
