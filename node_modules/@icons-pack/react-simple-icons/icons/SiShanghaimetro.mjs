...
const SiShanghaimetro = React.forwardRef(function SiShanghaimetro2({ title = "Shanghai Metro", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
