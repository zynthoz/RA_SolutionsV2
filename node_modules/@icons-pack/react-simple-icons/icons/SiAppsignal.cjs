...
const SiAppsignal = React__namespace.forwardRef(function SiAppsignal2({ title = "AppSignal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
