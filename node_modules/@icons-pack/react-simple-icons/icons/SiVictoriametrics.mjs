...
const SiVictoriametrics = React.forwardRef(function SiVictoriametrics2({ title = "VictoriaMetrics", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
