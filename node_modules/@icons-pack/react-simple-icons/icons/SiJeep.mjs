...
const SiJeep = React.forwardRef(function SiJeep2({ title = "Jeep", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
