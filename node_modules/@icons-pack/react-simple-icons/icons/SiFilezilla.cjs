...
const SiFilezilla = React__namespace.forwardRef(function SiFilezilla2({ title = "FileZilla", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
