...
const defaultColor = "#D0271D";
const SiAdp = React__namespace.forwardRef(function SiAdp2({ title = "ADP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
