...
const defaultColor = "#2072EF";
const SiZebpay = React__namespace.forwardRef(function SiZebpay2({ title = "ZebPay", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
