...
const defaultColor = "#0AE524";
const SiEmlakjet = React__namespace.forwardRef(function SiEmlakjet2({ title = "Emlakjet", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
