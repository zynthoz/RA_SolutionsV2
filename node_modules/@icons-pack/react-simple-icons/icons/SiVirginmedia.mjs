...
const SiVirginmedia = React.forwardRef(function SiVirginmedia2({ title = "Virgin Media", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
