...
const SiDlna = React.forwardRef(function SiDlna2({ title = "DLNA", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
